...
TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem, serviceAccessSwitch, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcAdminStatus=svcAdminStatus, sapIngQosSchedName=sapIngQosSchedName, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custLastMgmtChange=custLastMgmtChange, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, SdpIdType=SdpIdType, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapOperFlags=sapOperFlags, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustCompliances=prvtTMCustCompliances, prvtSdpTraps=prvtSdpTraps, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcDescription=svcDescription, custMultSvcSiteName=custMultSvcSiteName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSdpCreated=prvtSdpCreated, sapNumEntries=sapNumEntries, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSapCompliance=prvtTMSapCompliance, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcEnableSecureSaps=svcEnableSecureSaps, prvtCustNotif=prvtCustNotif, prvtSapTraps=prvtSapTraps, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpNumEntries=sdpNumEntries, prvtServicesMIB=prvtServicesMIB, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSdpCompliances=prvtTMSdpCompliances, svcId=svcId, prvtSvcNotif=prvtSvcNotif, sdpType=sdpType, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapLearnMode=sapLearnMode, sapEncapValue=sapEncapValue, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpBindVlanTag=sdpBindVlanTag, TSapIngQueueId=TSapIngQueueId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosSchedCustName=sapEgrQosSchedCustName, ServType=ServType, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueId=sapIngQosQueueId, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custPhone=custPhone, svcRevertTimer=svcRevertTimer, sdpId=sdpId, custInfoTable=custInfoTable, prvtTMServObjs=prvtTMServObjs, prvtSdpNotif=prvtSdpNotif, svcRowStatus=svcRowStatus, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpLabelSignaling=sdpLabelSignaling, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, ServiceOperStatus=ServiceOperStatus, custIngQosSchedName=custIngQosSchedName, sdpDelivery=sdpDelivery, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSdpObjs=prvtTMSdpObjs, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcNumSdps=svcNumSdps, prvtSapCreated=prvtSapCreated, sapRowStatus=sapRowStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, ServiceAdminStatus=ServiceAdminStatus, VpnId=VpnId, sapPortId=sapPortId, sdpMtu=sdpMtu, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpDescription=sdpDescription, ServObjDesc=ServObjDesc, prvtSvcCreated=prvtSvcCreated, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSapConformance=prvtTMSapConformance, svcType=svcType, sdpOperFlags=sdpOperFlags, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMCustConformance=prvtTMCustConformance, sdpOperIsBackup=sdpOperIsBackup, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapOperStatus=sapOperStatus, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcMtu=svcMtu, ServObjName=ServObjName, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpAdminIngressLabel=sdpAdminIngressLabel, custContact=custContact, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custNumEntries=custNumEntries, sapBaseInfoEntry=sapBaseInfoEntry, prvtTMServConformance=prvtTMServConformance, sdpOperStatus=sdpOperStatus, sdpVCType=sdpVCType, sdpAdminStatus=sdpAdminStatus, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtSdpDeleted=prvtSdpDeleted, custInfoEntry=custInfoEntry, prvtTMSapGroups=prvtTMSapGroups, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSapObjs=prvtTMSapObjs, prvtCustTraps=prvtCustTraps, sdpRowStatus=sdpRowStatus, svcBaseInfoTable=svcBaseInfoTable, prvtTMSvcCompliances=prvtTMSvcCompliances, custEgrQosSchedName=custEgrQosSchedName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtServNotifications=prvtServNotifications, custName=custName, svcNumEntries=svcNumEntries, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapDescription=sapDescription, sapEgrQosSchedName=sapEgrQosSchedName, sdpLastStatusChange=sdpLastStatusChange, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSvcObjs=prvtTMSvcObjs, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMCustObjs=prvtTMCustObjs, custRowStatus=custRowStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpAdminIsBackup=sdpAdminIsBackup, svcCustName=svcCustName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, TMEncapVal=TMEncapVal, sapBaseInfoTable=sapBaseInfoTable, prvtTMTstpConformance=prvtTMTstpConformance, sdpLastMgmtChange=sdpLastMgmtChange, svcBaseInfoEntry=svcBaseInfoEntry, svcVpnId=svcVpnId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosQueueId=sapEgrQosQueueId, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpInfoEntry=sdpInfoEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, PYSNMP_MODULE_ID=prvtServicesMIB, TSapEgrQueueId=TSapEgrQueueId, svcLastMgmtChange=svcLastMgmtChange, prvtSdpStatusChanged=prvtSdpStatusChanged, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVplsMode=svcVplsMode, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSapNotif=prvtSapNotif, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSdpConformance=prvtTMSdpConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpInfoTable=sdpInfoTable, sdpOutInterface=sdpOutInterface, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtCustDeleted=prvtCustDeleted, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sdpNextFreeId=sdpNextFreeId, prvtCustCreated=prvtCustCreated, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngressQosPolicyId=sapIngressQosPolicyId, sapAdminStatus=sapAdminStatus, svcOperStatus=svcOperStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapType=sapType, svcNumSaps=svcNumSaps, prvtTMSvcGroups=prvtTMSvcGroups)
