...
TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpType=sdpType, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, svcVpnId=svcVpnId, prvtTMSvcObjs=prvtTMSvcObjs, PYSNMP_MODULE_ID=prvtServicesMIB, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSdpStatusChanged=prvtSdpStatusChanged, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpAdminStatus=sdpAdminStatus, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtCustTraps=prvtCustTraps, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSapDeleted=prvtSapDeleted, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSapObjs=prvtTMSapObjs, ServObjDesc=ServObjDesc, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapIngQosSchedCustName=sapIngQosSchedCustName, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMTstpConformance=prvtTMTstpConformance, sapOperFlags=sapOperFlags, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMCustObjs=prvtTMCustObjs, sdpLastStatusChange=sdpLastStatusChange, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custContact=custContact, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosQueueId=sapEgrQosQueueId, sdpLabelSignaling=sdpLabelSignaling, prvtTMSdpGroups=prvtTMSdpGroups, sdpDelivery=sdpDelivery, svcAdminStatus=svcAdminStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcNumSaps=svcNumSaps, sapEncapValue=sapEncapValue, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSdpNotif=prvtSdpNotif, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSapCreated=prvtSapCreated, prvtTMSdpConformance=prvtTMSdpConformance, sdpNextFreeId=sdpNextFreeId, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtTMServObjs=prvtTMServObjs, prvtServicesMIB=prvtServicesMIB, sapLastMgmtChange=sapLastMgmtChange, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpVCType=sdpVCType, ServType=ServType, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custEgrQosSchedName=custEgrQosSchedName, sdpInfoTable=sdpInfoTable, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosSchedName=sapEgrQosSchedName, SdpIdType=SdpIdType, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosCustName=sapIngQosCustName, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtServNotifications=prvtServNotifications, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpInfoEntry=sdpInfoEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtSvcNotif=prvtSvcNotif, sdpNumEntries=sdpNumEntries, prvtTMSvcCompliances=prvtTMSvcCompliances, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSapConformance=prvtTMSapConformance, sdpOperStatus=sdpOperStatus, custIngQosSchedName=custIngQosSchedName, sapBaseInfoTable=sapBaseInfoTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custNumEntries=custNumEntries, ServObjName=ServObjName, svcBaseInfoEntry=svcBaseInfoEntry, prvtSapStatusChanged=prvtSapStatusChanged, sdpOperIsBackup=sdpOperIsBackup, prvtTMSvcConformance=prvtTMSvcConformance, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, svcLastStatusChange=svcLastStatusChange, prvtTMSdpObjs=prvtTMSdpObjs, sapNumEntries=sapNumEntries, prvtSvcCreated=prvtSvcCreated, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcVplsMode=svcVplsMode, prvtTMCustGroups=prvtTMCustGroups, prvtSapNotif=prvtSapNotif, sdpOutInterface=sdpOutInterface, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSapGroups=prvtTMSapGroups, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpGroupIdentifier=sdpGroupIdentifier, VpnId=VpnId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpOperFlags=sdpOperFlags, custMultSvcSiteDescription=custMultSvcSiteDescription, svcNumSdps=svcNumSdps, sapPortId=sapPortId, sapIngQosSchedName=sapIngQosSchedName, custName=custName, sdpRowStatus=sdpRowStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpDescription=sdpDescription, sapIngQosQueueId=sapIngQosQueueId, svcRevertTimer=svcRevertTimer, svcCustName=svcCustName, svcId=svcId, custPhone=custPhone, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcOperStatus=svcOperStatus, custRowStatus=custRowStatus, prvtSdpDeleted=prvtSdpDeleted, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSdpCreated=prvtSdpCreated, custLastMgmtChange=custLastMgmtChange, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpTransportTunnelName=sdpTransportTunnelName, sdpId=sdpId, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcDescription=svcDescription, sapDescription=sapDescription, prvtTMServConformance=prvtTMServConformance, svcType=svcType, TSapEgrQueueId=TSapEgrQueueId, prvtSvcTraps=prvtSvcTraps, sapAdminStatus=sapAdminStatus, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpLastMgmtChange=sdpLastMgmtChange, prvtCustDeleted=prvtCustDeleted, sapBaseInfoEntry=sapBaseInfoEntry, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapLearnMode=sapLearnMode, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, TSapIngQueueId=TSapIngQueueId, sapOperStatus=sapOperStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosCustName=sapEgrQosCustName, sapType=sapType, sapIngressQosPolicyId=sapIngressQosPolicyId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpBindVlanTag=sdpBindVlanTag, sdpMtu=sdpMtu, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcNumEntries=svcNumEntries, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtCustNotif=prvtCustNotif, prvtSapTraps=prvtSapTraps, svcRowStatus=svcRowStatus, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcMtu=svcMtu, sapRowStatus=sapRowStatus, prvtCustCreated=prvtCustCreated, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSvcGroups=prvtTMSvcGroups, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMSapCompliance=prvtTMSapCompliance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, TMEncapVal=TMEncapVal, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, ServiceAdminStatus=ServiceAdminStatus, svcBaseInfoTable=svcBaseInfoTable, custMultSvcSiteName=custMultSvcSiteName, ServiceOperStatus=ServiceOperStatus, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMCustConformance=prvtTMCustConformance, custInfoEntry=custInfoEntry, custInfoTable=custInfoTable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable)
