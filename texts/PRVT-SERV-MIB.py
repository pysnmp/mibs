...
TSapEgressPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSvcObjs=prvtTMSvcObjs, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcEnableSecureSaps=svcEnableSecureSaps, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtSapStatusChanged=prvtSapStatusChanged, prvtCustTraps=prvtCustTraps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custPhone=custPhone, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEncapValue=sapEncapValue, svcBaseInfoEntry=svcBaseInfoEntry, custMultSvcSiteName=custMultSvcSiteName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpLdpEnabled=sdpLdpEnabled, ServiceAdminStatus=ServiceAdminStatus, svcNumSaps=svcNumSaps, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpId=sdpId, PYSNMP_MODULE_ID=prvtServicesMIB, prvtCustDeleted=prvtCustDeleted, sapIngQosCustName=sapIngQosCustName, custIngQosSchedName=custIngQosSchedName, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosSchedName=sapEgrQosSchedName, svcCustName=svcCustName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtCustNotif=prvtCustNotif, custEgrQosSchedName=custEgrQosSchedName, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpOperIsBackup=sdpOperIsBackup, custName=custName, prvtTMSapConformance=prvtTMSapConformance, svcRevertTimer=svcRevertTimer, prvtSapTraps=prvtSapTraps, prvtTMSvcGroups=prvtTMSvcGroups, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcMtu=svcMtu, TSapIngQueueId=TSapIngQueueId, prvtSvcNotif=prvtSvcNotif, prvtTMServObjs=prvtTMServObjs, ServType=ServType, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgrQosCustName=sapEgrQosCustName, svcOperStatus=svcOperStatus, svcNumSdps=svcNumSdps, prvtTMSvcConformance=prvtTMSvcConformance, prvtSvcTraps=prvtSvcTraps, sapBaseInfoEntry=sapBaseInfoEntry, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapRowStatus=sapRowStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosQueueId=sapEgrQosQueueId, sdpInfoTable=sdpInfoTable, sdpRowStatus=sdpRowStatus, sdpDescription=sdpDescription, svcLastStatusChange=svcLastStatusChange, sapDescription=sapDescription, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapOperFlags=sapOperFlags, sdpVCType=sdpVCType, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSdpDeleted=prvtSdpDeleted, prvtTMCustConformance=prvtTMCustConformance, svcType=svcType, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSvcDeleted=prvtSvcDeleted, svcAdminStatus=svcAdminStatus, custInfoEntry=custInfoEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSapCreated=prvtSapCreated, custNumEntries=custNumEntries, sdpLabelSignaling=sdpLabelSignaling, sapNumEntries=sapNumEntries, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSapGroups=prvtTMSapGroups, sdpAdminIsBackup=sdpAdminIsBackup, prvtSapDeleted=prvtSapDeleted, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEgrQosSchedCustName=sapEgrQosSchedCustName, TMEncapVal=TMEncapVal, sdpFarEndIpAddress=sdpFarEndIpAddress, ServObjName=ServObjName, prvtSdpCreated=prvtSdpCreated, prvtServicesMIB=prvtServicesMIB, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSdpNotif=prvtSdpNotif, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custLastMgmtChange=custLastMgmtChange, ServObjDesc=ServObjDesc, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtServNotifications=prvtServNotifications, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpTransportTunnelName=sdpTransportTunnelName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedName=sapIngQosSchedName, svcDescription=svcDescription, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpBindVlanTag=sdpBindVlanTag, prvtTMSdpObjs=prvtTMSdpObjs, VpnId=VpnId, ServiceOperStatus=ServiceOperStatus, prvtSvcCreated=prvtSvcCreated, sdpLastStatusChange=sdpLastStatusChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpOperStatus=sdpOperStatus, sapAdminStatus=sapAdminStatus, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueId=sapIngQosQueueId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpOutInterface=sdpOutInterface, prvtTMCustObjs=prvtTMCustObjs, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpOperFlags=sdpOperFlags, sapIngressQosPolicyId=sapIngressQosPolicyId, custContact=custContact, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcNumEntries=svcNumEntries, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtCustCreated=prvtCustCreated, sdpInfoEntry=sdpInfoEntry, svcVplsMode=svcVplsMode, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custRowStatus=custRowStatus, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcId=svcId, svcLastMgmtChange=svcLastMgmtChange, sdpType=sdpType, svcVpnId=svcVpnId, SdpIdType=SdpIdType, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMSapObjs=prvtTMSapObjs, sapPortId=sapPortId, sdpAdminStatus=sdpAdminStatus, prvtSapNotif=prvtSapNotif, sapOperStatus=sapOperStatus, prvtSvcStatusChanged=prvtSvcStatusChanged, TSapEgrQueueId=TSapEgrQueueId, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMCustCompliances=prvtTMCustCompliances, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMCustGroups=prvtTMCustGroups, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpNumEntries=sdpNumEntries, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpNextFreeId=sdpNextFreeId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapCompliance=prvtTMSapCompliance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapLearnMode=sapLearnMode, custInfoTable=custInfoTable, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sapType=sapType, sapBaseInfoTable=sapBaseInfoTable, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpMtu=sdpMtu, prvtSdpTraps=prvtSdpTraps, prvtTMSapCompliances=prvtTMSapCompliances, svcRowStatus=svcRowStatus, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpDelivery=sdpDelivery, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets)
