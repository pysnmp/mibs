...
TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItem, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosSchedName=sapIngQosSchedName, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtSapNotif=prvtSapNotif, VpnId=VpnId, prvtSapCreated=prvtSapCreated, sapLearnMode=sapLearnMode, prvtTMSvcCompliance=prvtTMSvcCompliance, TMEncapVal=TMEncapVal, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custIngQosSchedName=custIngQosSchedName, svcBaseInfoTable=svcBaseInfoTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSdpGroups=prvtTMSdpGroups, prvtCustDeleted=prvtCustDeleted, sdpType=sdpType, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpInfoEntry=sdpInfoEntry, custName=custName, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpInfoTable=sdpInfoTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSapObjs=prvtTMSapObjs, prvtSdpTraps=prvtSdpTraps, svcMtu=svcMtu, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpId=sdpId, svcVplsMode=svcVplsMode, sapIngQosQueueId=sapIngQosQueueId, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpMtu=sdpMtu, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMCustObjs=prvtTMCustObjs, prvtSapTraps=prvtSapTraps, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custContact=custContact, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custLastMgmtChange=custLastMgmtChange, custMultSvcSiteName=custMultSvcSiteName, sapRowStatus=sapRowStatus, prvtTMSapConformance=prvtTMSapConformance, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcRevertTimer=svcRevertTimer, sapBaseInfoEntry=sapBaseInfoEntry, sdpDescription=sdpDescription, prvtSvcStatusChanged=prvtSvcStatusChanged, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtSvcNotif=prvtSvcNotif, ServType=ServType, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSapCompliances=prvtTMSapCompliances, custNumEntries=custNumEntries, sapOperFlags=sapOperFlags, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpNextFreeId=sdpNextFreeId, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosSchedCustName=sapEgrQosSchedCustName, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMCustConformance=prvtTMCustConformance, svcNumSdps=svcNumSdps, sapBaseInfoTable=sapBaseInfoTable, sapOperStatus=sapOperStatus, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEncapValue=sapEncapValue, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtSvcTraps=prvtSvcTraps, prvtCustCreated=prvtCustCreated, prvtTMCustGroups=prvtTMCustGroups, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, ServiceOperStatus=ServiceOperStatus, TSapEgrQueueId=TSapEgrQueueId, svcId=svcId, prvtSdpCreated=prvtSdpCreated, prvtSvcDeleted=prvtSvcDeleted, svcDescription=svcDescription, prvtServicesMIB=prvtServicesMIB, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpGroupIdentifier=sdpGroupIdentifier, sdpTransportTunnelName=sdpTransportTunnelName, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapAdminStatus=sapAdminStatus, sdpOperStatus=sdpOperStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpDelivery=sdpDelivery, prvtSdpDeleted=prvtSdpDeleted, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custMultSvcSiteDescription=custMultSvcSiteDescription, custEgrQosSchedName=custEgrQosSchedName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcEnableSecureSaps=svcEnableSecureSaps, prvtServNotifications=prvtServNotifications, prvtTMTstpConformance=prvtTMTstpConformance, ServiceAdminStatus=ServiceAdminStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcNumEntries=svcNumEntries, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapDescription=sapDescription, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSdpObjs=prvtTMSdpObjs, sdpOperFlags=sdpOperFlags, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtSvcCreated=prvtSvcCreated, svcLastMgmtChange=svcLastMgmtChange, prvtSdpStatusChanged=prvtSdpStatusChanged, svcNumSaps=svcNumSaps, sdpRowStatus=sdpRowStatus, prvtTMSvcConformance=prvtTMSvcConformance, sdpOperIsBackup=sdpOperIsBackup, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngressQosPolicyId=sapIngressQosPolicyId, custInfoTable=custInfoTable, custPhone=custPhone, svcOperStatus=svcOperStatus, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpAdminStatus=sdpAdminStatus, sapIngQosCustName=sapIngQosCustName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, TSapIngQueueId=TSapIngQueueId, prvtTMSvcGroups=prvtTMSvcGroups, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpLabelSignaling=sdpLabelSignaling, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, ServObjDesc=ServObjDesc, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpLastMgmtChange=sdpLastMgmtChange, sdpOutInterface=sdpOutInterface, prvtTMServObjs=prvtTMServObjs, sdpVCType=sdpVCType, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustCompliance=prvtTMCustCompliance, sdpNumEntries=sdpNumEntries, sdpLdpEnabled=sdpLdpEnabled, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSdpCompliance=prvtTMSdpCompliance, svcType=svcType, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapType=sapType, svcLastStatusChange=svcLastStatusChange, svcVpnId=svcVpnId, prvtCustNotif=prvtCustNotif, prvtSapStatusChanged=prvtSapStatusChanged, sdpBindVlanTag=sdpBindVlanTag, svcRowStatus=svcRowStatus, prvtTMServConformance=prvtTMServConformance, prvtTMSapGroups=prvtTMSapGroups, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapNumEntries=sapNumEntries, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapPortId=sapPortId, svcCustName=svcCustName, prvtTMSvcObjs=prvtTMSvcObjs, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtSdpNotif=prvtSdpNotif, SdpIdType=SdpIdType, sdpAdminIsBackup=sdpAdminIsBackup, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custRowStatus=custRowStatus, prvtCustTraps=prvtCustTraps, sapEgrQosCustName=sapEgrQosCustName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMSapCompliance=prvtTMSapCompliance, ServObjName=ServObjName, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets)
