...
TNamedItem, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, serviceAccessSwitch, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtServicesMIB=prvtServicesMIB, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSapCreated=prvtSapCreated, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, TSapIngQueueId=TSapIngQueueId, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpOutInterface=sdpOutInterface, sapIngressQosPolicyId=sapIngressQosPolicyId, svcAdminStatus=svcAdminStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custName=custName, ServObjDesc=ServObjDesc, sapOperFlags=sapOperFlags, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpLastMgmtChange=sdpLastMgmtChange, PYSNMP_MODULE_ID=prvtServicesMIB, svcLastStatusChange=svcLastStatusChange, svcBaseInfoEntry=svcBaseInfoEntry, sdpOperIsBackup=sdpOperIsBackup, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpMtu=sdpMtu, sdpLdpEnabled=sdpLdpEnabled, prvtTMSapConformance=prvtTMSapConformance, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpLabelSignaling=sdpLabelSignaling, prvtSvcCreated=prvtSvcCreated, ServObjName=ServObjName, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpNumEntries=sdpNumEntries, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMTstpConformance=prvtTMTstpConformance, svcRevertTimer=svcRevertTimer, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapDescription=sapDescription, svcNumSaps=svcNumSaps, sapIngQosQueueId=sapIngQosQueueId, sdpDescription=sdpDescription, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMCustCompliances=prvtTMCustCompliances, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpBindVlanTag=sdpBindVlanTag, prvtCustNotif=prvtCustNotif, sdpNextFreeId=sdpNextFreeId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosCustName=sapIngQosCustName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custInfoEntry=custInfoEntry, svcId=svcId, svcVpnId=svcVpnId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpDelivery=sdpDelivery, prvtSdpDeleted=prvtSdpDeleted, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custContact=custContact, prvtSapTraps=prvtSapTraps, prvtTMSdpGroups=prvtTMSdpGroups, custNumEntries=custNumEntries, sapOperStatus=sapOperStatus, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMCustCompliance=prvtTMCustCompliance, sapLastMgmtChange=sapLastMgmtChange, sapEncapValue=sapEncapValue, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtCustTraps=prvtCustTraps, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtCustCreated=prvtCustCreated, svcRowStatus=svcRowStatus, sapBaseInfoTable=sapBaseInfoTable, svcMtu=svcMtu, svcCustName=svcCustName, sapEgrQosSchedName=sapEgrQosSchedName, sdpAdminIngressLabel=sdpAdminIngressLabel, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custMultSvcSiteName=custMultSvcSiteName, prvtSvcTraps=prvtSvcTraps, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpId=sdpId, custRowStatus=custRowStatus, svcBaseInfoTable=svcBaseInfoTable, sdpInfoEntry=sdpInfoEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtCustDeleted=prvtCustDeleted, prvtTMCustGroups=prvtTMCustGroups, VpnId=VpnId, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, SdpIdType=SdpIdType, svcLastMgmtChange=svcLastMgmtChange, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapEgrQosCustName=sapEgrQosCustName, TMEncapVal=TMEncapVal, sdpInfoTable=sdpInfoTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpType=sdpType, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapGroups=prvtTMSapGroups, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapRowStatus=sapRowStatus, svcDescription=svcDescription, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSdpCreated=prvtSdpCreated, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMCustConformance=prvtTMCustConformance, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpLastStatusChange=sdpLastStatusChange, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustObjs=prvtTMCustObjs, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtSdpTraps=prvtSdpTraps, prvtSvcDeleted=prvtSvcDeleted, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapLearnMode=sapLearnMode, custLastMgmtChange=custLastMgmtChange, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosQueueId=sapEgrQosQueueId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMServConformance=prvtTMServConformance, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtSdpStatusChanged=prvtSdpStatusChanged, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpAdminIsBackup=sdpAdminIsBackup, svcVplsMode=svcVplsMode, svcEnableSecureSaps=svcEnableSecureSaps, prvtSvcNotif=prvtSvcNotif, custPhone=custPhone, sapNumEntries=sapNumEntries, svcNumSdps=svcNumSdps, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custIngQosSchedName=custIngQosSchedName, custEgrQosSchedName=custEgrQosSchedName, prvtTMServObjs=prvtTMServObjs, prvtSapNotif=prvtSapNotif, sdpAdminStatus=sdpAdminStatus, ServiceAdminStatus=ServiceAdminStatus, sdpOperFlags=sdpOperFlags, sdpTransportTunnelName=sdpTransportTunnelName, svcOperStatus=svcOperStatus, ServType=ServType, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, ServiceOperStatus=ServiceOperStatus, sdpGroupIdentifier=sdpGroupIdentifier, prvtSdpNotif=prvtSdpNotif, custInfoTable=custInfoTable, svcType=svcType, sdpRowStatus=sdpRowStatus, sdpOperStatus=sdpOperStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSapObjs=prvtTMSapObjs, sapType=sapType, prvtSapStatusChanged=prvtSapStatusChanged, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosSchedName=sapIngQosSchedName, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSvcConformance=prvtTMSvcConformance, custMultSvcSiteDescription=custMultSvcSiteDescription, sapAdminStatus=sapAdminStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcNumEntries=svcNumEntries, sapPortId=sapPortId, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpVCType=sdpVCType, prvtSapDeleted=prvtSapDeleted, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtServNotifications=prvtServNotifications)
