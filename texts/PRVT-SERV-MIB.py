...
TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", PYSNMP_MODULE_ID=prvtServicesMIB, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapOperStatus=sapOperStatus, ServiceOperStatus=ServiceOperStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, svcCustName=svcCustName, custPhone=custPhone, prvtTMCustGroups=prvtTMCustGroups, sapAdminStatus=sapAdminStatus, prvtSapCreated=prvtSapCreated, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpAdminStatus=sdpAdminStatus, svcBaseInfoTable=svcBaseInfoTable, sapBaseInfoTable=sapBaseInfoTable, prvtSapStatusChanged=prvtSapStatusChanged, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpNumEntries=sdpNumEntries, prvtTMCustCompliance=prvtTMCustCompliance, sdpMtu=sdpMtu, sapLastMgmtChange=sapLastMgmtChange, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custIngQosSchedName=custIngQosSchedName, TSapIngQueueId=TSapIngQueueId, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpDescription=sdpDescription, sdpAdminIsBackup=sdpAdminIsBackup, sapPortId=sapPortId, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosSchedName=sapEgrQosSchedName, prvtSvcCreated=prvtSvcCreated, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSapConformance=prvtTMSapConformance, svcId=svcId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSvcGroups=prvtTMSvcGroups, custContact=custContact, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtServNotifications=prvtServNotifications, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpBindVlanTag=sdpBindVlanTag, custNumEntries=custNumEntries, svcNumSaps=svcNumSaps, sdpOperIsBackup=sdpOperIsBackup, sdpVCType=sdpVCType, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtSvcDeleted=prvtSvcDeleted, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapRowStatus=sapRowStatus, prvtSvcTraps=prvtSvcTraps, prvtTMSapCompliances=prvtTMSapCompliances, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtCustDeleted=prvtCustDeleted, custInfoTable=custInfoTable, sapEgressQosPolicyId=sapEgressQosPolicyId, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEncapValue=sapEncapValue, VpnId=VpnId, prvtServicesMIB=prvtServicesMIB, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpId=sdpId, prvtCustTraps=prvtCustTraps, svcNumEntries=svcNumEntries, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueId=sapIngQosQueueId, prvtTMServConformance=prvtTMServConformance, sapIngQosSchedName=sapIngQosSchedName, prvtSdpNotif=prvtSdpNotif, sapNumEntries=sapNumEntries, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSdpGroups=prvtTMSdpGroups, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosSchedCustName=sapIngQosSchedCustName, svcBaseInfoEntry=svcBaseInfoEntry, SdpIdType=SdpIdType, svcRowStatus=svcRowStatus, TMEncapVal=TMEncapVal, prvtTMSdpObjs=prvtTMSdpObjs, sdpOperStatus=sdpOperStatus, svcMtu=svcMtu, custLastMgmtChange=custLastMgmtChange, sdpTransportTunnelName=sdpTransportTunnelName, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custRowStatus=custRowStatus, svcVpnId=svcVpnId, svcAdminStatus=svcAdminStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custName=custName, sdpAdminEgressLabel=sdpAdminEgressLabel, TSapEgrQueueId=TSapEgrQueueId, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcType=svcType, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpLastMgmtChange=sdpLastMgmtChange, sdpOutInterface=sdpOutInterface, sapLearnMode=sapLearnMode, custInfoEntry=custInfoEntry, sdpOperFlags=sdpOperFlags, prvtSapNotif=prvtSapNotif, custMultSvcSiteDescription=custMultSvcSiteDescription, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapDescription=sapDescription, prvtTMCustObjs=prvtTMCustObjs, svcNumSdps=svcNumSdps, prvtTMSapGroups=prvtTMSapGroups, svcRevertTimer=svcRevertTimer, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMTstpConformance=prvtTMTstpConformance, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosCustName=sapEgrQosCustName, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtSapTraps=prvtSapTraps, prvtTMSdpConformance=prvtTMSdpConformance, sdpInfoEntry=sdpInfoEntry, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapType=sapType, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMCustConformance=prvtTMCustConformance, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapOperFlags=sapOperFlags, ServObjName=ServObjName, custEgrQosSchedName=custEgrQosSchedName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpInfoTable=sdpInfoTable, svcDescription=svcDescription, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcLastStatusChange=svcLastStatusChange, sdpGroupIdentifier=sdpGroupIdentifier, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSvcCompliances=prvtTMSvcCompliances, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSdpTraps=prvtSdpTraps, ServObjDesc=ServObjDesc, prvtSdpCreated=prvtSdpCreated, prvtTMSapCompliance=prvtTMSapCompliance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custMultSvcSiteName=custMultSvcSiteName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpRowStatus=sdpRowStatus, sdpDelivery=sdpDelivery, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpLdpEnabled=sdpLdpEnabled, sdpType=sdpType, prvtTMSapObjs=prvtTMSapObjs, prvtCustNotif=prvtCustNotif, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpNextFreeId=sdpNextFreeId, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosCustName=sapIngQosCustName, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMServObjs=prvtTMServObjs, ServType=ServType, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, svcOperStatus=svcOperStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtCustCreated=prvtCustCreated, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtSdpDeleted=prvtSdpDeleted, ServiceAdminStatus=ServiceAdminStatus, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueId=sapEgrQosQueueId, prvtSvcNotif=prvtSvcNotif, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcVplsMode=svcVplsMode, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpLabelSignaling=sdpLabelSignaling, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable)
