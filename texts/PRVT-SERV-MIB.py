...
TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, serviceAccessSwitch, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpAdminIsBackup=sdpAdminIsBackup, sdpBindVlanTag=sdpBindVlanTag, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosSchedName=custIngQosSchedName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcNumSaps=svcNumSaps, sdpOperStatus=sdpOperStatus, prvtTMSapObjs=prvtTMSapObjs, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpTransportTunnelName=sdpTransportTunnelName, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSdpObjs=prvtTMSdpObjs, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpVCType=sdpVCType, sapEgrQosQueueId=sapEgrQosQueueId, svcLastMgmtChange=svcLastMgmtChange, sdpRowStatus=sdpRowStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpNextFreeId=sdpNextFreeId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpGroupIdentifier=sdpGroupIdentifier, prvtCustTraps=prvtCustTraps, ServObjDesc=ServObjDesc, SdpIdType=SdpIdType, custNumEntries=custNumEntries, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcRevertTimer=svcRevertTimer, sdpDelivery=sdpDelivery, prvtSdpCreated=prvtSdpCreated, sdpType=sdpType, ServiceAdminStatus=ServiceAdminStatus, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMCustObjs=prvtTMCustObjs, custName=custName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapType=sapType, prvtTMSapConformance=prvtTMSapConformance, sdpOperIsBackup=sdpOperIsBackup, sdpInfoTable=sdpInfoTable, svcAdminStatus=svcAdminStatus, prvtSvcDeleted=prvtSvcDeleted, sdpLastStatusChange=sdpLastStatusChange, VpnId=VpnId, sapPortId=sapPortId, sdpInfoEntry=sdpInfoEntry, custRowStatus=custRowStatus, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpLastMgmtChange=sdpLastMgmtChange, sapIngressQosPolicyId=sapIngressQosPolicyId, TMEncapVal=TMEncapVal, sdpOperFlags=sdpOperFlags, sdpLdpEnabled=sdpLdpEnabled, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapOperStatus=sapOperStatus, prvtTMSapCompliance=prvtTMSapCompliance, prvtServicesMIB=prvtServicesMIB, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMCustGroups=prvtTMCustGroups, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, sapIngQosQueueId=sapIngQosQueueId, prvtSapCreated=prvtSapCreated, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapCompliances=prvtTMSapCompliances, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEncapValue=sapEncapValue, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpMtu=sdpMtu, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, ServiceOperStatus=ServiceOperStatus, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSvcGroups=prvtTMSvcGroups, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMCustConformance=prvtTMCustConformance, svcMtu=svcMtu, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapEgrQosSchedCustName=sapEgrQosSchedCustName, svcRowStatus=svcRowStatus, custPhone=custPhone, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpOutInterface=sdpOutInterface, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosSchedName=sapIngQosSchedName, custContact=custContact, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSapGroups=prvtTMSapGroups, prvtSvcTraps=prvtSvcTraps, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcNumEntries=svcNumEntries, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSdpDeleted=prvtSdpDeleted, sapDescription=sapDescription, svcCustName=svcCustName, sapAdminStatus=sapAdminStatus, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustNotif=prvtCustNotif, prvtTMSdpConformance=prvtTMSdpConformance, svcLastStatusChange=svcLastStatusChange, sapBaseInfoTable=sapBaseInfoTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSapTraps=prvtSapTraps, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, TSapIngQueueId=TSapIngQueueId, TSapEgrQueueId=TSapEgrQueueId, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpNumEntries=sdpNumEntries, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcId=svcId, prvtTMSdpGroups=prvtTMSdpGroups, custLastMgmtChange=custLastMgmtChange, prvtTMServConformance=prvtTMServConformance, prvtSvcNotif=prvtSvcNotif, sapRowStatus=sapRowStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSdpTraps=prvtSdpTraps, svcOperStatus=svcOperStatus, svcBaseInfoTable=svcBaseInfoTable, svcVpnId=svcVpnId, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMServObjs=prvtTMServObjs, prvtServNotifications=prvtServNotifications, svcType=svcType, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpId=sdpId, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosCustName=sapIngQosCustName, sdpLabelSignaling=sdpLabelSignaling, prvtSapNotif=prvtSapNotif, sdpAdminStatus=sdpAdminStatus, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtCustCreated=prvtCustCreated, sapOperFlags=sapOperFlags, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosCustName=sapEgrQosCustName, sapNumEntries=sapNumEntries, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSdpNotif=prvtSdpNotif, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVplsMode=svcVplsMode, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, ServType=ServType, custInfoTable=custInfoTable, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtSvcCreated=prvtSvcCreated, svcNumSdps=svcNumSdps, sdpAdminIngressLabel=sdpAdminIngressLabel, ServObjName=ServObjName, svcDescription=svcDescription, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosSchedName=custEgrQosSchedName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtCustDeleted=prvtCustDeleted, sdpDescription=sdpDescription, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custInfoEntry=custInfoEntry, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapLearnMode=sapLearnMode)
