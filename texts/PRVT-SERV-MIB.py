...
TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapBaseInfoTable=sapBaseInfoTable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, ServType=ServType, sapOperStatus=sapOperStatus, svcVpnId=svcVpnId, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosCustName=sapIngQosCustName, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, svcEnableSecureSaps=svcEnableSecureSaps, sdpDelivery=sdpDelivery, custMultSvcSiteName=custMultSvcSiteName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpOperIsBackup=sdpOperIsBackup, sdpMtu=sdpMtu, TSapIngQueueId=TSapIngQueueId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapNumEntries=sapNumEntries, prvtTMSvcGroups=prvtTMSvcGroups, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSvcCreated=prvtSvcCreated, sdpDescription=sdpDescription, sapIngQosSchedName=sapIngQosSchedName, ServiceOperStatus=ServiceOperStatus, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcVplsMode=svcVplsMode, prvtServNotifications=prvtServNotifications, sapLearnMode=sapLearnMode, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpOutInterface=sdpOutInterface, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustGroups=prvtTMCustGroups, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custContact=custContact, prvtCustTraps=prvtCustTraps, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSapObjs=prvtTMSapObjs, svcNumEntries=svcNumEntries, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapCompliance=prvtTMSapCompliance, svcAdminStatus=svcAdminStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, svcRowStatus=svcRowStatus, custIngQosSchedName=custIngQosSchedName, sdpLabelSignaling=sdpLabelSignaling, prvtCustNotif=prvtCustNotif, prvtTMServConformance=prvtTMServConformance, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, ServObjDesc=ServObjDesc, sdpLdpEnabled=sdpLdpEnabled, custLastMgmtChange=custLastMgmtChange, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, svcType=svcType, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapAdminStatus=sapAdminStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSapCreated=prvtSapCreated, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpId=sdpId, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtServicesMIB=prvtServicesMIB, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSapNotif=prvtSapNotif, sapEgrQosCustName=sapEgrQosCustName, svcRevertTimer=svcRevertTimer, custInfoEntry=custInfoEntry, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcOperStatus=svcOperStatus, prvtTMCustObjs=prvtTMCustObjs, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpVCType=sdpVCType, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpAdminStatus=sdpAdminStatus, PYSNMP_MODULE_ID=prvtServicesMIB, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapType=sapType, sdpBindVlanTag=sdpBindVlanTag, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtSdpCreated=prvtSdpCreated, custName=custName, custInfoTable=custInfoTable, sapBaseInfoEntry=sapBaseInfoEntry, svcNumSaps=svcNumSaps, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtCustCreated=prvtCustCreated, ServiceAdminStatus=ServiceAdminStatus, svcBaseInfoTable=svcBaseInfoTable, VpnId=VpnId, TMEncapVal=TMEncapVal, prvtSdpNotif=prvtSdpNotif, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEncapValue=sapEncapValue, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custMultiServiceSiteTable=custMultiServiceSiteTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpType=sdpType, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSdpGroups=prvtTMSdpGroups, prvtSdpTraps=prvtSdpTraps, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosQueueId=sapEgrQosQueueId, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSapTraps=prvtSapTraps, svcCustName=svcCustName, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcLastStatusChange=svcLastStatusChange, custNumEntries=custNumEntries, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtSdpDeleted=prvtSdpDeleted, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpRowStatus=sdpRowStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpOperStatus=sdpOperStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpInfoTable=sdpInfoTable, sapOperFlags=sapOperFlags, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtSvcStatusChanged=prvtSvcStatusChanged, svcId=svcId, custMultSvcSiteDescription=custMultSvcSiteDescription, svcDescription=svcDescription, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtSvcDeleted=prvtSvcDeleted, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpGroupIdentifier=sdpGroupIdentifier, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSdpConformance=prvtTMSdpConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMServObjs=prvtTMServObjs, sapDescription=sapDescription, sapRowStatus=sapRowStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtCustDeleted=prvtCustDeleted, sdpOperFlags=sdpOperFlags, prvtTMSapConformance=prvtTMSapConformance, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapPortId=sapPortId, prvtTMTstpConformance=prvtTMTstpConformance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpLastStatusChange=sdpLastStatusChange, prvtSvcNotif=prvtSvcNotif, ServObjName=ServObjName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMCustCompliance=prvtTMCustCompliance, custPhone=custPhone, SdpIdType=SdpIdType, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosSchedName=custEgrQosSchedName, sdpNextFreeId=sdpNextFreeId, prvtTMSapGroups=prvtTMSapGroups, svcMtu=svcMtu, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpInfoEntry=sdpInfoEntry, svcLastMgmtChange=svcLastMgmtChange, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMCustConformance=prvtTMCustConformance, custRowStatus=custRowStatus, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcNumSdps=svcNumSdps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpNumEntries=sdpNumEntries, sapIngQosQueueId=sapIngQosQueueId, prvtTMSdpObjs=prvtTMSdpObjs)
