...
TNamedItemOrEmpty, TNamedItem, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNamedItem", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMSdpGroups=prvtTMSdpGroups, sdpInfoEntry=sdpInfoEntry, prvtTMSvcGroups=prvtTMSvcGroups, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcNumSdps=svcNumSdps, sapIngQosCustName=sapIngQosCustName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcVplsMode=svcVplsMode, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMServConformance=prvtTMServConformance, prvtTMCustObjs=prvtTMCustObjs, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custInfoTable=custInfoTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, SdpIdType=SdpIdType, prvtTMSapCompliance=prvtTMSapCompliance, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcAdminStatus=svcAdminStatus, prvtCustDeleted=prvtCustDeleted, sapAdminStatus=sapAdminStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custEgrQosSchedName=custEgrQosSchedName, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSdpTraps=prvtSdpTraps, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, prvtSvcTraps=prvtSvcTraps, custIngQosSchedName=custIngQosSchedName, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcRowStatus=svcRowStatus, sapLearnMode=sapLearnMode, svcType=svcType, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueId=sapIngQosQueueId, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcLastStatusChange=svcLastStatusChange, ServiceAdminStatus=ServiceAdminStatus, TSapEgrQueueId=TSapEgrQueueId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtSapDeleted=prvtSapDeleted, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpDelivery=sdpDelivery, prvtServNotifications=prvtServNotifications, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMServObjs=prvtTMServObjs, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapPortId=sapPortId, svcVpnId=svcVpnId, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapBaseInfoEntry=sapBaseInfoEntry, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSvcCompliance=prvtTMSvcCompliance, svcDescription=svcDescription, sdpOperStatus=sdpOperStatus, prvtCustCreated=prvtCustCreated, svcCustName=svcCustName, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapType=sapType, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSvcDeleted=prvtSvcDeleted, sdpAdminStatus=sdpAdminStatus, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSapNotif=prvtSapNotif, custLastMgmtChange=custLastMgmtChange, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custNumEntries=custNumEntries, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtSapCreated=prvtSapCreated, prvtTMCustConformance=prvtTMCustConformance, svcOperStatus=svcOperStatus, svcEnableSecureSaps=svcEnableSecureSaps, custInfoEntry=custInfoEntry, prvtSdpStatusChanged=prvtSdpStatusChanged, sapOperStatus=sapOperStatus, prvtCustNotif=prvtCustNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapDescription=sapDescription, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapBaseInfoTable=sapBaseInfoTable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcId=svcId, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, TMEncapVal=TMEncapVal, sdpOperFlags=sdpOperFlags, svcRevertTimer=svcRevertTimer, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSapConformance=prvtTMSapConformance, prvtServicesMIB=prvtServicesMIB, sdpLabelSignaling=sdpLabelSignaling, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpInfoTable=sdpInfoTable, svcNumSaps=svcNumSaps, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpFarEndIpAddress=sdpFarEndIpAddress, ServType=ServType, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSapObjs=prvtTMSapObjs, sdpMtu=sdpMtu, sapNumEntries=sapNumEntries, custContact=custContact, prvtSapStatusChanged=prvtSapStatusChanged, sdpOutInterface=sdpOutInterface, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpId=sdpId, prvtSvcStatusChanged=prvtSvcStatusChanged, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosCustName=sapEgrQosCustName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapRowStatus=sapRowStatus, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtSdpNotif=prvtSdpNotif, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custRowStatus=custRowStatus, ServObjName=ServObjName, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custMultSvcSiteName=custMultSvcSiteName, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSdpCreated=prvtSdpCreated, prvtTMCustGroups=prvtTMCustGroups, prvtTMSapCompliances=prvtTMSapCompliances, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcLastMgmtChange=svcLastMgmtChange, sapEncapValue=sapEncapValue, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, ServiceOperStatus=ServiceOperStatus, sapEgrQosSchedName=sapEgrQosSchedName, custName=custName, sapLastMgmtChange=sapLastMgmtChange, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSvcNotif=prvtSvcNotif, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, VpnId=VpnId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSdpDeleted=prvtSdpDeleted, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpVCType=sdpVCType, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcBaseInfoTable=svcBaseInfoTable, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosQueueId=sapEgrQosQueueId, sdpAdminIsBackup=sdpAdminIsBackup, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpLastStatusChange=sdpLastStatusChange, prvtTMTstpConformance=prvtTMTstpConformance, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpRowStatus=sdpRowStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosSchedName=sapIngQosSchedName, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSdpCompliance=prvtTMSdpCompliance, svcNumEntries=svcNumEntries, sdpLastMgmtChange=sdpLastMgmtChange, sdpLdpEnabled=sdpLdpEnabled, sdpNextFreeId=sdpNextFreeId, prvtTMCustCompliance=prvtTMCustCompliance, sdpDescription=sdpDescription, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtCustTraps=prvtCustTraps, prvtSapTraps=prvtSapTraps, prvtTMSapGroups=prvtTMSapGroups, TSapIngQueueId=TSapIngQueueId, custPhone=custPhone, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapOperFlags=sapOperFlags, prvtTMCustCompliances=prvtTMCustCompliances, PYSNMP_MODULE_ID=prvtServicesMIB, svcBaseInfoEntry=svcBaseInfoEntry, ServObjDesc=ServObjDesc, prvtTMSdpConformance=prvtTMSdpConformance, sdpType=sdpType, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcMtu=svcMtu, prvtSvcCreated=prvtSvcCreated, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpBindVlanTag=sdpBindVlanTag, sdpOperIsBackup=sdpOperIsBackup)
