...
serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMServConformance=prvtTMServConformance, sdpAdminIsBackup=sdpAdminIsBackup, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapLastMgmtChange=sapLastMgmtChange, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpBindVlanTag=sdpBindVlanTag, prvtTMCustGroups=prvtTMCustGroups, prvtTMSvcConformance=prvtTMSvcConformance, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcDescription=svcDescription, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgrQosSchedName=sapEgrQosSchedName, sdpOutInterface=sdpOutInterface, sapLearnMode=sapLearnMode, sapBaseInfoEntry=sapBaseInfoEntry, prvtSdpNotif=prvtSdpNotif, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSdpObjs=prvtTMSdpObjs, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtServNotifications=prvtServNotifications, sdpId=sdpId, custName=custName, sdpOperFlags=sdpOperFlags, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, ServiceOperStatus=ServiceOperStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custInfoEntry=custInfoEntry, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMTstpConformance=prvtTMTstpConformance, SdpIdType=SdpIdType, sapPortId=sapPortId, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosCustName=sapEgrQosCustName, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSdpGroups=prvtTMSdpGroups, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSapCompliance=prvtTMSapCompliance, prvtSvcTraps=prvtSvcTraps, sapNumEntries=sapNumEntries, custMultiServiceSiteTable=custMultiServiceSiteTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custIngQosSchedName=custIngQosSchedName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSapNotif=prvtSapNotif, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpGroupIdentifier=sdpGroupIdentifier, sapDescription=sapDescription, sapEncapValue=sapEncapValue, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSapConformance=prvtTMSapConformance, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcEnableSecureSaps=svcEnableSecureSaps, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMServObjs=prvtTMServObjs, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpRowStatus=sdpRowStatus, custLastMgmtChange=custLastMgmtChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapRowStatus=sapRowStatus, sapBaseInfoTable=sapBaseInfoTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpOperIsBackup=sdpOperIsBackup, sapIngQosSchedCustName=sapIngQosSchedCustName, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSvcStatusChanged=prvtSvcStatusChanged, svcRevertTimer=svcRevertTimer, prvtTMSvcObjs=prvtTMSvcObjs, svcRowStatus=svcRowStatus, sapType=sapType, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSdpTraps=prvtSdpTraps, prvtTMSvcGroups=prvtTMSvcGroups, prvtCustNotif=prvtCustNotif, sapEgrQosQueueId=sapEgrQosQueueId, VpnId=VpnId, custContact=custContact, svcNumSaps=svcNumSaps, svcLastMgmtChange=svcLastMgmtChange, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapOperStatus=sapOperStatus, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpInfoTable=sdpInfoTable, prvtTMCustCompliances=prvtTMCustCompliances, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcLastStatusChange=svcLastStatusChange, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custPhone=custPhone, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpNextFreeId=sdpNextFreeId, sdpVCType=sdpVCType, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtServicesMIB=prvtServicesMIB, sdpTransportTunnelName=sdpTransportTunnelName, sapAdminStatus=sapAdminStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcOperStatus=svcOperStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSvcCreated=prvtSvcCreated, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, TSapIngQueueId=TSapIngQueueId, svcVpnId=svcVpnId, sdpMtu=sdpMtu, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, TMEncapVal=TMEncapVal, prvtTMSdpCompliance=prvtTMSdpCompliance, svcAdminStatus=svcAdminStatus, svcNumSdps=svcNumSdps, TSapEgrQueueId=TSapEgrQueueId, ServiceAdminStatus=ServiceAdminStatus, ServObjName=ServObjName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosCustName=sapIngQosCustName, sdpAdminStatus=sdpAdminStatus, prvtCustDeleted=prvtCustDeleted, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSapObjs=prvtTMSapObjs, ServType=ServType, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSdpCreated=prvtSdpCreated, custRowStatus=custRowStatus, prvtCustTraps=prvtCustTraps, custNumEntries=custNumEntries, prvtSapCreated=prvtSapCreated, prvtTMSdpCompliances=prvtTMSdpCompliances, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcId=svcId, sdpOperStatus=sdpOperStatus, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcNumEntries=svcNumEntries, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpInfoEntry=sdpInfoEntry, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSvcDeleted=prvtSvcDeleted, sapIngQosSchedName=sapIngQosSchedName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMSdpConformance=prvtTMSdpConformance, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcCustName=svcCustName, sapOperFlags=sapOperFlags, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpLdpEnabled=sdpLdpEnabled, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtSapDeleted=prvtSapDeleted, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpLabelSignaling=sdpLabelSignaling, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosQueueId=sapIngQosQueueId, prvtSdpDeleted=prvtSdpDeleted, ServObjDesc=ServObjDesc, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpNumEntries=sdpNumEntries, prvtCustCreated=prvtCustCreated, sdpType=sdpType, svcType=svcType, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVplsMode=svcVplsMode, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosSchedName=custEgrQosSchedName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpDelivery=sdpDelivery, prvtSapTraps=prvtSapTraps, prvtSvcNotif=prvtSvcNotif, custMultSvcSiteName=custMultSvcSiteName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpDescription=sdpDescription, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custInfoTable=custInfoTable, svcMtu=svcMtu, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMCustObjs=prvtTMCustObjs, prvtTMSapGroups=prvtTMSapGroups)
