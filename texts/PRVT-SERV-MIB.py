...
serviceAccessSwitch, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custName=custName, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpVCType=sdpVCType, sdpBindVlanTag=sdpBindVlanTag, sdpAdminIsBackup=sdpAdminIsBackup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custPhone=custPhone, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMTstpConformance=prvtTMTstpConformance, prvtSvcTraps=prvtSvcTraps, prvtCustCreated=prvtCustCreated, svcLastStatusChange=svcLastStatusChange, prvtSvcCreated=prvtSvcCreated, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcVpnId=svcVpnId, svcOperStatus=svcOperStatus, custContact=custContact, TMEncapVal=TMEncapVal, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpLabelSignaling=sdpLabelSignaling, svcBaseInfoTable=svcBaseInfoTable, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSdpCompliance=prvtTMSdpCompliance, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcRevertTimer=svcRevertTimer, sapEncapValue=sapEncapValue, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcNumEntries=svcNumEntries, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMCustGroups=prvtTMCustGroups, sapIngQosSchedCustName=sapIngQosSchedCustName, custInfoTable=custInfoTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtServNotifications=prvtServNotifications, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSapGroups=prvtTMSapGroups, sapType=sapType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcCustName=svcCustName, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueId=sapEgrQosQueueId, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, ServObjName=ServObjName, prvtSapStatusChanged=prvtSapStatusChanged, sdpLastMgmtChange=sdpLastMgmtChange, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpType=sdpType, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, ServiceAdminStatus=ServiceAdminStatus, prvtTMSvcCompliances=prvtTMSvcCompliances, sapRowStatus=sapRowStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpOperIsBackup=sdpOperIsBackup, sdpOperFlags=sdpOperFlags, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcType=svcType, prvtTMServObjs=prvtTMServObjs, sapIngQosQueueId=sapIngQosQueueId, sdpOperStatus=sdpOperStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtSapNotif=prvtSapNotif, prvtSvcNotif=prvtSvcNotif, sdpLdpEnabled=sdpLdpEnabled, sdpOutInterface=sdpOutInterface, ServType=ServType, prvtTMSapObjs=prvtTMSapObjs, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapConformance=prvtTMSapConformance, sapLastMgmtChange=sapLastMgmtChange, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcId=svcId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtCustDeleted=prvtCustDeleted, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, TSapIngQueueId=TSapIngQueueId, sapNumEntries=sapNumEntries, prvtTMCustCompliances=prvtTMCustCompliances, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSdpCompliances=prvtTMSdpCompliances, custInfoEntry=custInfoEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcBaseInfoEntry=svcBaseInfoEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpMtu=sdpMtu, sapDescription=sapDescription, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMCustConformance=prvtTMCustConformance, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMServConformance=prvtTMServConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, PYSNMP_MODULE_ID=prvtServicesMIB, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpInfoTable=sdpInfoTable, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcLastMgmtChange=svcLastMgmtChange, svcNumSaps=svcNumSaps, custNumEntries=custNumEntries, sdpRowStatus=sdpRowStatus, custMultSvcSiteName=custMultSvcSiteName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpDelivery=sdpDelivery, prvtTMSvcGroups=prvtTMSvcGroups, prvtCustTraps=prvtCustTraps, svcMtu=svcMtu, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, TSapEgrQueueId=TSapEgrQueueId, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapOperFlags=sapOperFlags, prvtSdpDeleted=prvtSdpDeleted, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpInfoEntry=sdpInfoEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapOperStatus=sapOperStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpId=sdpId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosCustName=sapIngQosCustName, custEgrQosSchedName=custEgrQosSchedName, sapBaseInfoEntry=sapBaseInfoEntry, sapLearnMode=sapLearnMode, custRowStatus=custRowStatus, svcAdminStatus=svcAdminStatus, custIngQosSchedName=custIngQosSchedName, sapPortId=sapPortId, svcDescription=svcDescription, prvtSapDeleted=prvtSapDeleted, prvtTMSvcConformance=prvtTMSvcConformance, sdpGroupIdentifier=sdpGroupIdentifier, prvtServicesMIB=prvtServicesMIB, prvtCustNotif=prvtCustNotif, prvtTMSdpConformance=prvtTMSdpConformance, VpnId=VpnId, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custLastMgmtChange=custLastMgmtChange, prvtSdpNotif=prvtSdpNotif, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcNumSdps=svcNumSdps, sdpDescription=sdpDescription, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSapCompliance=prvtTMSapCompliance, prvtSapCreated=prvtSapCreated, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSapTraps=prvtSapTraps, SdpIdType=SdpIdType, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSdpCreated=prvtSdpCreated, svcVplsMode=svcVplsMode, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpLastStatusChange=sdpLastStatusChange, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, ServiceOperStatus=ServiceOperStatus, prvtTMCustObjs=prvtTMCustObjs, ServObjDesc=ServObjDesc, prvtSvcDeleted=prvtSvcDeleted, sapAdminStatus=sapAdminStatus, prvtTMSapCompliances=prvtTMSapCompliances, sdpAdminStatus=sdpAdminStatus, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosSchedName=sapIngQosSchedName, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpNumEntries=sdpNumEntries, prvtSdpTraps=prvtSdpTraps, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcRowStatus=svcRowStatus, svcVPLSUplinkTable=svcVPLSUplinkTable)
