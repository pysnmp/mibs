...
serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpLastMgmtChange=sdpLastMgmtChange, svcMtu=svcMtu, sapLearnMode=sapLearnMode, prvtSvcCreated=prvtSvcCreated, sapDescription=sapDescription, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMServObjs=prvtTMServObjs, prvtTMSapObjs=prvtTMSapObjs, prvtSapCreated=prvtSapCreated, prvtServNotifications=prvtServNotifications, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpLabelSignaling=sdpLabelSignaling, sdpOutInterface=sdpOutInterface, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custNumEntries=custNumEntries, sapPortId=sapPortId, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSdpGroups=prvtTMSdpGroups, svcVplsMode=svcVplsMode, prvtSdpTraps=prvtSdpTraps, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapIngQosQueueId=sapIngQosQueueId, svcOperStatus=svcOperStatus, svcNumSdps=svcNumSdps, sapBaseInfoEntry=sapBaseInfoEntry, sapType=sapType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, ServiceOperStatus=ServiceOperStatus, ServType=ServType, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtCustNotif=prvtCustNotif, svcVpnId=svcVpnId, custContact=custContact, prvtServicesMIB=prvtServicesMIB, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtCustCreated=prvtCustCreated, sapRowStatus=sapRowStatus, sdpNextFreeId=sdpNextFreeId, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custInfoTable=custInfoTable, PYSNMP_MODULE_ID=prvtServicesMIB, custInfoEntry=custInfoEntry, svcLastStatusChange=svcLastStatusChange, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcNumEntries=svcNumEntries, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcRevertTimer=svcRevertTimer, prvtSvcTraps=prvtSvcTraps, sdpOperFlags=sdpOperFlags, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpOperIsBackup=sdpOperIsBackup, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosSchedName=sapIngQosSchedName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, sdpInfoEntry=sdpInfoEntry, SdpIdType=SdpIdType, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpVCType=sdpVCType, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpOperStatus=sdpOperStatus, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpId=sdpId, TMEncapVal=TMEncapVal, svcBaseInfoEntry=svcBaseInfoEntry, sdpRowStatus=sdpRowStatus, custName=custName, sapLastMgmtChange=sapLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapOperStatus=sapOperStatus, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSapTraps=prvtSapTraps, custLastMgmtChange=custLastMgmtChange, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtTMCustGroups=prvtTMCustGroups, svcRowStatus=svcRowStatus, sapAdminStatus=sapAdminStatus, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtSdpDeleted=prvtSdpDeleted, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtCustDeleted=prvtCustDeleted, svcLastMgmtChange=svcLastMgmtChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, svcNumSaps=svcNumSaps, sdpFarEndIpAddress=sdpFarEndIpAddress, svcCustName=svcCustName, prvtSdpStatusChanged=prvtSdpStatusChanged, svcBaseInfoTable=svcBaseInfoTable, ServiceAdminStatus=ServiceAdminStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgrQosCustName=sapEgrQosCustName, prvtSapNotif=prvtSapNotif, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultSvcSiteName=custMultSvcSiteName, prvtTMServConformance=prvtTMServConformance, custIngQosSchedName=custIngQosSchedName, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSvcStatusChanged=prvtSvcStatusChanged, ServObjDesc=ServObjDesc, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, TSapIngQueueId=TSapIngQueueId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpDescription=sdpDescription, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosSchedName=custEgrQosSchedName, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSapCompliance=prvtTMSapCompliance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, prvtSdpNotif=prvtSdpNotif, prvtTMSdpObjs=prvtTMSdpObjs, sapOperFlags=sapOperFlags, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSapConformance=prvtTMSapConformance, sdpLdpEnabled=sdpLdpEnabled, sdpBindVlanTag=sdpBindVlanTag, sapEgrQosQueueId=sapEgrQosQueueId, TSapEgrQueueId=TSapEgrQueueId, prvtSapStatusChanged=prvtSapStatusChanged, sdpMtu=sdpMtu, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpLastStatusChange=sdpLastStatusChange, sdpAdminIsBackup=sdpAdminIsBackup, svcId=svcId, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSdpCreated=prvtSdpCreated, custPhone=custPhone, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpType=sdpType, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, ServObjName=ServObjName, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSdpConformance=prvtTMSdpConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpNumEntries=sdpNumEntries, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, svcAdminStatus=svcAdminStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMSapGroups=prvtTMSapGroups, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpAdminStatus=sdpAdminStatus, prvtSvcNotif=prvtSvcNotif, VpnId=VpnId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosCustName=sapIngQosCustName, sdpTransportTunnelName=sdpTransportTunnelName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustConformance=prvtTMCustConformance, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngressQosPolicyId=sapIngressQosPolicyId, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSvcObjs=prvtTMSvcObjs, sapEncapValue=sapEncapValue, custRowStatus=custRowStatus, prvtCustTraps=prvtCustTraps, prvtTMCustObjs=prvtTMCustObjs, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapNumEntries=sapNumEntries, prvtSapDeleted=prvtSapDeleted, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcType=svcType, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpInfoTable=sdpInfoTable, prvtTMCustCompliances=prvtTMCustCompliances, svcDescription=svcDescription, prvtSvcDeleted=prvtSvcDeleted, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpDelivery=sdpDelivery)
