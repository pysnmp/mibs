...
TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TNamedItem, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMSapObjs=prvtTMSapObjs, sapOperStatus=sapOperStatus, sdpType=sdpType, svcCustName=svcCustName, prvtSvcNotif=prvtSvcNotif, prvtTMSapConformance=prvtTMSapConformance, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapLearnMode=sapLearnMode, svcLastStatusChange=svcLastStatusChange, TMEncapVal=TMEncapVal, sdpAdminStatus=sdpAdminStatus, svcNumEntries=svcNumEntries, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, TSapEgrQueueId=TSapEgrQueueId, sdpDelivery=sdpDelivery, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtCustCreated=prvtCustCreated, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMCustCompliances=prvtTMCustCompliances, prvtSdpTraps=prvtSdpTraps, svcEnableSecureSaps=svcEnableSecureSaps, svcVplsMode=svcVplsMode, prvtSvcDeleted=prvtSvcDeleted, sapPortId=sapPortId, sapAdminStatus=sapAdminStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcBaseInfoTable=svcBaseInfoTable, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSapCompliance=prvtTMSapCompliance, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcNumSaps=svcNumSaps, sdpLdpEnabled=sdpLdpEnabled, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, sapNumEntries=sapNumEntries, prvtCustNotif=prvtCustNotif, sdpRowStatus=sdpRowStatus, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtServicesMIB=prvtServicesMIB, sdpVCType=sdpVCType, svcDescription=svcDescription, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosSchedName=sapIngQosSchedName, prvtTMSapGroups=prvtTMSapGroups, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapDescription=sapDescription, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcMtu=svcMtu, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpNumEntries=sdpNumEntries, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMCustGroups=prvtTMCustGroups, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSdpDeleted=prvtSdpDeleted, prvtSdpCreated=prvtSdpCreated, svcOperStatus=svcOperStatus, prvtTMSdpCompliances=prvtTMSdpCompliances, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcRevertTimer=svcRevertTimer, prvtSapDeleted=prvtSapDeleted, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSdpConformance=prvtTMSdpConformance, sdpId=sdpId, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpOperStatus=sdpOperStatus, prvtServNotifications=prvtServNotifications, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtSvcStatusChanged=prvtSvcStatusChanged, custMultiServiceSiteTable=custMultiServiceSiteTable, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpMtu=sdpMtu, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapOperFlags=sapOperFlags, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSapCompliances=prvtTMSapCompliances, svcType=svcType, custRowStatus=custRowStatus, sdpInfoEntry=sdpInfoEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSvcGroups=prvtTMSvcGroups, sapBaseInfoTable=sapBaseInfoTable, custMultSvcSiteName=custMultSvcSiteName, sdpGroupIdentifier=sdpGroupIdentifier, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtCustDeleted=prvtCustDeleted, svcVpnId=svcVpnId, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtSapCreated=prvtSapCreated, prvtTMSdpObjs=prvtTMSdpObjs, custContact=custContact, custNumEntries=custNumEntries, custEgrQosSchedName=custEgrQosSchedName, VpnId=VpnId, sapBaseInfoEntry=sapBaseInfoEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMCustConformance=prvtTMCustConformance, custLastMgmtChange=custLastMgmtChange, sapEgrQosCustName=sapEgrQosCustName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, ServObjName=ServObjName, prvtTMSvcObjs=prvtTMSvcObjs, ServiceAdminStatus=ServiceAdminStatus, ServiceOperStatus=ServiceOperStatus, SdpIdType=SdpIdType, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpNextFreeId=sdpNextFreeId, sdpDescription=sdpDescription, prvtTMServObjs=prvtTMServObjs, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custPhone=custPhone, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpLabelSignaling=sdpLabelSignaling, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSdpGroups=prvtTMSdpGroups, prvtCustTraps=prvtCustTraps, custIngQosSchedName=custIngQosSchedName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSapStatusChanged=prvtSapStatusChanged, custName=custName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, svcNumSdps=svcNumSdps, prvtTMSvcConformance=prvtTMSvcConformance, sapRowStatus=sapRowStatus, sapEncapValue=sapEncapValue, sdpTransportTunnelName=sdpTransportTunnelName, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcId=svcId, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, TSapIngQueueId=TSapIngQueueId, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueId=sapEgrQosQueueId, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpLastStatusChange=sdpLastStatusChange, custInfoEntry=custInfoEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSapNotif=prvtSapNotif, prvtTMCustObjs=prvtTMCustObjs, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapType=sapType, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapIngQosQueueId=sapIngQosQueueId, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcBaseInfoEntry=svcBaseInfoEntry, sdpOperIsBackup=sdpOperIsBackup, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, ServObjDesc=ServObjDesc, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpInfoTable=sdpInfoTable, prvtTMCustCompliance=prvtTMCustCompliance, svcRowStatus=svcRowStatus, sdpOutInterface=sdpOutInterface, prvtSdpNotif=prvtSdpNotif, prvtSvcTraps=prvtSvcTraps, prvtTMServConformance=prvtTMServConformance, sdpBindVlanTag=sdpBindVlanTag, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custIngQosAssignmentPortId=custIngQosAssignmentPortId, ServType=ServType, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgressQosPolicyId=sapEgressQosPolicyId, svcLastMgmtChange=svcLastMgmtChange, custInfoTable=custInfoTable, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtSapTraps=prvtSapTraps, PYSNMP_MODULE_ID=prvtServicesMIB, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSvcCreated=prvtSvcCreated)
