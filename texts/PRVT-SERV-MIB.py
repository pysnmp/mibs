...
TSapIngressPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSapNotif=prvtSapNotif, custContact=custContact, prvtSdpDeleted=prvtSdpDeleted, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpId=sdpId, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpInfoEntry=sdpInfoEntry, prvtTMServObjs=prvtTMServObjs, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtCustCreated=prvtCustCreated, sapIngQosQueueId=sapIngQosQueueId, sdpOperFlags=sdpOperFlags, svcCustName=svcCustName, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custInfoTable=custInfoTable, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMServConformance=prvtTMServConformance, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSvcNotif=prvtSvcNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpNextFreeId=sdpNextFreeId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapPortId=sapPortId, prvtTMSapConformance=prvtTMSapConformance, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapRowStatus=sapRowStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSvcCreated=prvtSvcCreated, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpBindVlanTag=sdpBindVlanTag, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpNumEntries=sdpNumEntries, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapBaseInfoEntry=sapBaseInfoEntry, prvtSapDeleted=prvtSapDeleted, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcBaseInfoEntry=svcBaseInfoEntry, sdpDelivery=sdpDelivery, prvtServicesMIB=prvtServicesMIB, svcNumSaps=svcNumSaps, prvtCustTraps=prvtCustTraps, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSvcGroups=prvtTMSvcGroups, custNumEntries=custNumEntries, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngressQosPolicyId=sapIngressQosPolicyId, sapOperStatus=sapOperStatus, sapLearnMode=sapLearnMode, prvtTMSdpCompliance=prvtTMSdpCompliance, svcVpnId=svcVpnId, prvtSdpNotif=prvtSdpNotif, prvtSvcTraps=prvtSvcTraps, prvtSvcDeleted=prvtSvcDeleted, sdpTransportTunnelName=sdpTransportTunnelName, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpOperStatus=sdpOperStatus, svcType=svcType, sapAdminStatus=sapAdminStatus, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapEgrQosCustName=sapEgrQosCustName, sapLastMgmtChange=sapLastMgmtChange, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMCustCompliance=prvtTMCustCompliance, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSdpGroups=prvtTMSdpGroups, svcDescription=svcDescription, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcNumSdps=svcNumSdps, prvtSvcStatusChanged=prvtSvcStatusChanged, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSvcObjs=prvtTMSvcObjs, custMultSvcSiteDescription=custMultSvcSiteDescription, ServiceAdminStatus=ServiceAdminStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpInfoTable=sdpInfoTable, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapOperFlags=sapOperFlags, prvtCustNotif=prvtCustNotif, prvtSdpStatusChanged=prvtSdpStatusChanged, sapType=sapType, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSdpCreated=prvtSdpCreated, prvtSdpTraps=prvtSdpTraps, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpOperIsBackup=sdpOperIsBackup, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, ServiceOperStatus=ServiceOperStatus, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMCustCompliances=prvtTMCustCompliances, SdpIdType=SdpIdType, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, svcRowStatus=svcRowStatus, sdpType=sdpType, sapIngQosSchedName=sapIngQosSchedName, sdpLastMgmtChange=sdpLastMgmtChange, prvtCustDeleted=prvtCustDeleted, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcRevertTimer=svcRevertTimer, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMCustObjs=prvtTMCustObjs, custInfoEntry=custInfoEntry, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpFarEndIpAddress=sdpFarEndIpAddress, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, svcNumEntries=svcNumEntries, sapBaseInfoTable=sapBaseInfoTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEncapValue=sapEncapValue, sdpDescription=sdpDescription, sdpAdminStatus=sdpAdminStatus, svcMtu=svcMtu, svcEnableSecureSaps=svcEnableSecureSaps, VpnId=VpnId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpRowStatus=sdpRowStatus, sdpOutInterface=sdpOutInterface, sapDescription=sapDescription, custEgrQosSchedName=custEgrQosSchedName, svcAdminStatus=svcAdminStatus, custLastMgmtChange=custLastMgmtChange, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMSapGroups=prvtTMSapGroups, svcId=svcId, prvtTMSapCompliances=prvtTMSapCompliances, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosSchedName=custIngQosSchedName, ServObjDesc=ServObjDesc, TMEncapVal=TMEncapVal, sdpAdminIsBackup=sdpAdminIsBackup, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueId=sapEgrQosQueueId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMSapObjs=prvtTMSapObjs, custRowStatus=custRowStatus, sdpVCType=sdpVCType, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcBaseInfoTable=svcBaseInfoTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSdpConformance=prvtTMSdpConformance, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpLabelSignaling=sdpLabelSignaling, sdpLastStatusChange=sdpLastStatusChange, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custName=custName, custMultiServiceSiteTable=custMultiServiceSiteTable, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapNumEntries=sapNumEntries, sapIngQosCustName=sapIngQosCustName, prvtTMSvcCompliances=prvtTMSvcCompliances, ServType=ServType, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMTstpConformance=prvtTMTstpConformance, prvtSapCreated=prvtSapCreated, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custPhone=custPhone, sdpLdpEnabled=sdpLdpEnabled, prvtServNotifications=prvtServNotifications, PYSNMP_MODULE_ID=prvtServicesMIB, sdpMtu=sdpMtu, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcLastStatusChange=svcLastStatusChange, prvtSapTraps=prvtSapTraps, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustGroups=prvtTMCustGroups, ServObjName=ServObjName, svcVplsMode=svcVplsMode, TSapIngQueueId=TSapIngQueueId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry)
