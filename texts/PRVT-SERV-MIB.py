...
TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtCustCreated=prvtCustCreated, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSapCompliance=prvtTMSapCompliance, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSvcTraps=prvtSvcTraps, PYSNMP_MODULE_ID=prvtServicesMIB, sdpInfoEntry=sdpInfoEntry, sdpMtu=sdpMtu, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapDescription=sapDescription, sapType=sapType, prvtTMSdpCompliance=prvtTMSdpCompliance, custRowStatus=custRowStatus, sdpLdpEnabled=sdpLdpEnabled, svcVplsMode=svcVplsMode, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapBaseInfoTable=sapBaseInfoTable, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtServNotifications=prvtServNotifications, sdpId=sdpId, svcMtu=svcMtu, prvtCustNotif=prvtCustNotif, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSdpGroups=prvtTMSdpGroups, ServType=ServType, sdpLastStatusChange=sdpLastStatusChange, svcRevertTimer=svcRevertTimer, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSapConformance=prvtTMSapConformance, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpAdminIsBackup=sdpAdminIsBackup, ServObjDesc=ServObjDesc, sapIngQosCustName=sapIngQosCustName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpDescription=sdpDescription, prvtTMServConformance=prvtTMServConformance, custLastMgmtChange=custLastMgmtChange, sdpLabelSignaling=sdpLabelSignaling, sapPortId=sapPortId, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcType=svcType, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcVpnId=svcVpnId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpType=sdpType, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapRowStatus=sapRowStatus, sapLearnMode=sapLearnMode, prvtSapCreated=prvtSapCreated, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpNumEntries=sdpNumEntries, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpOutInterface=sdpOutInterface, svcDescription=svcDescription, custName=custName, custContact=custContact, sapOperStatus=sapOperStatus, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapLastMgmtChange=sapLastMgmtChange, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSapDeleted=prvtSapDeleted, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpInfoTable=sdpInfoTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpOperStatus=sdpOperStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtSapTraps=prvtSapTraps, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcEnableSecureSaps=svcEnableSecureSaps, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMCustCompliances=prvtTMCustCompliances, sapEncapValue=sapEncapValue, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcOperStatus=svcOperStatus, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSvcObjs=prvtTMSvcObjs, sapEgrQosSchedName=sapEgrQosSchedName, svcBaseInfoEntry=svcBaseInfoEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMServObjs=prvtTMServObjs, svcCustName=svcCustName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapBaseInfoEntry=sapBaseInfoEntry, sdpVCType=sdpVCType, prvtSdpTraps=prvtSdpTraps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMCustConformance=prvtTMCustConformance, sdpGroupIdentifier=sdpGroupIdentifier, custInfoTable=custInfoTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcNumEntries=svcNumEntries, sdpRowStatus=sdpRowStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpOperFlags=sdpOperFlags, prvtTMSvcGroups=prvtTMSvcGroups, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapOperFlags=sapOperFlags, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, ServObjName=ServObjName, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtSdpCreated=prvtSdpCreated, VpnId=VpnId, prvtSvcCreated=prvtSvcCreated, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, SdpIdType=SdpIdType, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custPhone=custPhone, sdpTransportTunnelName=sdpTransportTunnelName, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpBindVlanTag=sdpBindVlanTag, prvtSapNotif=prvtSapNotif, prvtTMCustGroups=prvtTMCustGroups, sapIngQosQueueId=sapIngQosQueueId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcRowStatus=svcRowStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSapObjs=prvtTMSapObjs, sapNumEntries=sapNumEntries, sdpLastMgmtChange=sdpLastMgmtChange, custInfoEntry=custInfoEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpDelivery=sdpDelivery, sapIngQosSchedName=sapIngQosSchedName, prvtTMSapGroups=prvtTMSapGroups, ServiceOperStatus=ServiceOperStatus, prvtServicesMIB=prvtServicesMIB, svcNumSdps=svcNumSdps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, TSapIngQueueId=TSapIngQueueId, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custNumEntries=custNumEntries, svcAdminStatus=svcAdminStatus, prvtTMCustObjs=prvtTMCustObjs, prvtSdpNotif=prvtSdpNotif, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpAdminStatus=sdpAdminStatus, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcId=svcId, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtCustTraps=prvtCustTraps, sapEgrQosCustName=sapEgrQosCustName, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosSchedName=custEgrQosSchedName, prvtTMCustCompliance=prvtTMCustCompliance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, ServiceAdminStatus=ServiceAdminStatus, prvtTMSdpConformance=prvtTMSdpConformance, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosSchedCustName=sapIngQosSchedCustName, TSapEgrQueueId=TSapEgrQueueId, svcLastStatusChange=svcLastStatusChange, TMEncapVal=TMEncapVal, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMTstpConformance=prvtTMTstpConformance, prvtSdpDeleted=prvtSdpDeleted, svcNumSaps=svcNumSaps, custMultSvcSiteName=custMultSvcSiteName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpNextFreeId=sdpNextFreeId, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcBaseInfoTable=svcBaseInfoTable, sdpOperIsBackup=sdpOperIsBackup, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtSapStatusChanged=prvtSapStatusChanged, custIngQosSchedName=custIngQosSchedName, sapAdminStatus=sapAdminStatus, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSvcNotif=prvtSvcNotif)
