...
TSapIngressPolicyIdOrNone, TNamedItem, serviceAccessSwitch, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSapDeleted=prvtSapDeleted, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSapCompliances=prvtTMSapCompliances, sdpTransportTunnelName=sdpTransportTunnelName, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSapTraps=prvtSapTraps, sapEgrQosCustName=sapEgrQosCustName, prvtCustDeleted=prvtCustDeleted, sdpLastStatusChange=sdpLastStatusChange, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtSdpDeleted=prvtSdpDeleted, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custMultSvcSiteName=custMultSvcSiteName, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMSvcObjs=prvtTMSvcObjs, sdpLabelSignaling=sdpLabelSignaling, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtSvcDeleted=prvtSvcDeleted, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngressQosPolicyId=sapIngressQosPolicyId, PYSNMP_MODULE_ID=prvtServicesMIB, svcRowStatus=svcRowStatus, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSdpStatusChanged=prvtSdpStatusChanged, ServObjDesc=ServObjDesc, sdpOutInterface=sdpOutInterface, sapPortId=sapPortId, svcRevertTimer=svcRevertTimer, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMServObjs=prvtTMServObjs, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custInfoEntry=custInfoEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcOperStatus=svcOperStatus, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSapCreated=prvtSapCreated, sapEncapValue=sapEncapValue, prvtSapNotif=prvtSapNotif, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custContact=custContact, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtSdpNotif=prvtSdpNotif, svcLastStatusChange=svcLastStatusChange, svcVplsMode=svcVplsMode, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMCustGroups=prvtTMCustGroups, sdpVCType=sdpVCType, sapLearnMode=sapLearnMode, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapOperStatus=sapOperStatus, svcVpnId=svcVpnId, prvtSvcNotif=prvtSvcNotif, TMEncapVal=TMEncapVal, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custLastMgmtChange=custLastMgmtChange, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custName=custName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, ServType=ServType, sdpLdpEnabled=sdpLdpEnabled, VpnId=VpnId, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSvcGroups=prvtTMSvcGroups, custRowStatus=custRowStatus, ServiceAdminStatus=ServiceAdminStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtCustCreated=prvtCustCreated, prvtTMSapConformance=prvtTMSapConformance, SdpIdType=SdpIdType, sapType=sapType, custMultiServiceSiteTable=custMultiServiceSiteTable, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcId=svcId, sdpInfoEntry=sdpInfoEntry, sdpOperFlags=sdpOperFlags, sdpNextFreeId=sdpNextFreeId, sdpInfoTable=sdpInfoTable, prvtServicesMIB=prvtServicesMIB, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapAdminStatus=sapAdminStatus, ServObjName=ServObjName, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtCustTraps=prvtCustTraps, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSapCompliance=prvtTMSapCompliance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcBaseInfoTable=svcBaseInfoTable, svcVPLSUplinkTable=svcVPLSUplinkTable, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueId=sapIngQosQueueId, prvtTMSvcCompliances=prvtTMSvcCompliances, custIngQosSchedName=custIngQosSchedName, prvtTMSdpConformance=prvtTMSdpConformance, custMultiServiceSiteEntry=custMultiServiceSiteEntry, TSapEgrQueueId=TSapEgrQueueId, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosSchedName=sapEgrQosSchedName, sapEgrQosQueueId=sapEgrQosQueueId, sapBaseInfoTable=sapBaseInfoTable, svcMtu=svcMtu, sdpAdminStatus=sdpAdminStatus, sapRowStatus=sapRowStatus, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcType=svcType, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custEgrQosSchedName=custEgrQosSchedName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, TSapIngQueueId=TSapIngQueueId, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSapGroups=prvtTMSapGroups, custInfoTable=custInfoTable, prvtTMTstpConformance=prvtTMTstpConformance, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapOperFlags=sapOperFlags, sapNumEntries=sapNumEntries, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcNumSdps=svcNumSdps, prvtServNotifications=prvtServNotifications, custPhone=custPhone, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMCustCompliances=prvtTMCustCompliances, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpGroupIdentifier=sdpGroupIdentifier, sdpId=sdpId, prvtTMCustCompliance=prvtTMCustCompliance, svcDescription=svcDescription, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSapObjs=prvtTMSapObjs, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtCustNotif=prvtCustNotif, sapIngQosCustName=sapIngQosCustName, sdpDelivery=sdpDelivery, ServiceOperStatus=ServiceOperStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpMtu=sdpMtu, prvtTMServConformance=prvtTMServConformance, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpBindVlanTag=sdpBindVlanTag, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custNumEntries=custNumEntries, prvtSdpCreated=prvtSdpCreated, svcBaseInfoEntry=svcBaseInfoEntry, sdpAdminIsBackup=sdpAdminIsBackup, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpType=sdpType, custMultSvcSiteDescription=custMultSvcSiteDescription, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpOperIsBackup=sdpOperIsBackup, svcNumSaps=svcNumSaps, prvtSvcTraps=prvtSvcTraps, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMCustObjs=prvtTMCustObjs, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, svcNumEntries=svcNumEntries, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcAdminStatus=svcAdminStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcCustName=svcCustName, sdpRowStatus=sdpRowStatus, sapIngQosSchedName=sapIngQosSchedName, svcEnableSecureSaps=svcEnableSecureSaps, sdpDescription=sdpDescription, sapDescription=sapDescription, prvtSvcCreated=prvtSvcCreated)
