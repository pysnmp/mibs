...
serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapOperFlags=sapOperFlags, svcVpnId=svcVpnId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, ServType=ServType, VpnId=VpnId, custInfoEntry=custInfoEntry, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcRowStatus=svcRowStatus, sdpOperStatus=sdpOperStatus, prvtCustNotif=prvtCustNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpAdminIsBackup=sdpAdminIsBackup, sdpType=sdpType, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosSchedName=sapIngQosSchedName, sapPortId=sapPortId, svcRevertTimer=svcRevertTimer, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMCustCompliances=prvtTMCustCompliances, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueId=sapIngQosQueueId, ServiceOperStatus=ServiceOperStatus, TSapIngQueueId=TSapIngQueueId, custIngQosSchedName=custIngQosSchedName, svcNumSaps=svcNumSaps, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSdpObjs=prvtTMSdpObjs, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpAdminStatus=sdpAdminStatus, prvtTMSapCompliances=prvtTMSapCompliances, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, ServObjName=ServObjName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpLastMgmtChange=sdpLastMgmtChange, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSapGroups=prvtTMSapGroups, sdpInfoTable=sdpInfoTable, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcNumEntries=svcNumEntries, prvtSapCreated=prvtSapCreated, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpOperFlags=sdpOperFlags, sdpTransportTunnelName=sdpTransportTunnelName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapOperStatus=sapOperStatus, sapAdminStatus=sapAdminStatus, svcOperStatus=svcOperStatus, prvtSdpNotif=prvtSdpNotif, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custPhone=custPhone, sdpLabelSignaling=sdpLabelSignaling, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, ServiceAdminStatus=ServiceAdminStatus, prvtTMCustObjs=prvtTMCustObjs, sdpNextFreeId=sdpNextFreeId, svcLastMgmtChange=svcLastMgmtChange, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpDelivery=sdpDelivery, sdpNumEntries=sdpNumEntries, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpOutInterface=sdpOutInterface, svcId=svcId, prvtServicesMIB=prvtServicesMIB, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcVplsMode=svcVplsMode, sapIngQosCustName=sapIngQosCustName, sdpVCType=sdpVCType, prvtTMSvcCompliances=prvtTMSvcCompliances, sapNumEntries=sapNumEntries, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedName=sapEgrQosSchedName, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpBindVlanTag=sdpBindVlanTag, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSapDeleted=prvtSapDeleted, custMultSvcSiteDescription=custMultSvcSiteDescription, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtSvcStatusChanged=prvtSvcStatusChanged, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSapObjs=prvtTMSapObjs, sdpLastStatusChange=sdpLastStatusChange, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSapCompliance=prvtTMSapCompliance, prvtSdpTraps=prvtSdpTraps, SdpIdType=SdpIdType, prvtSdpStatusChanged=prvtSdpStatusChanged, TSapEgrQueueId=TSapEgrQueueId, custInfoTable=custInfoTable, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtSvcNotif=prvtSvcNotif, prvtTMServConformance=prvtTMServConformance, svcNumSdps=svcNumSdps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtTMServObjs=prvtTMServObjs, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapType=sapType, svcType=svcType, svcBaseInfoTable=svcBaseInfoTable, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSvcDeleted=prvtSvcDeleted, sdpRowStatus=sdpRowStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtServNotifications=prvtServNotifications, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMCustGroups=prvtTMCustGroups, prvtTMCustConformance=prvtTMCustConformance, sdpDescription=sdpDescription, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapLearnMode=sapLearnMode, svcLastStatusChange=svcLastStatusChange, prvtSvcTraps=prvtSvcTraps, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custName=custName, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosCustName=sapEgrQosCustName, custEgrQosSchedName=custEgrQosSchedName, svcBaseInfoEntry=svcBaseInfoEntry, prvtSapNotif=prvtSapNotif, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpOperIsBackup=sdpOperIsBackup, ServObjDesc=ServObjDesc, custRowStatus=custRowStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapDescription=sapDescription, sapEncapValue=sapEncapValue, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMTstpConformance=prvtTMTstpConformance, sdpLdpEnabled=sdpLdpEnabled, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpId=sdpId, custNumEntries=custNumEntries, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtSdpDeleted=prvtSdpDeleted, custMultSvcSiteName=custMultSvcSiteName, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapRowStatus=sapRowStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custLastMgmtChange=custLastMgmtChange, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSvcGroups=prvtTMSvcGroups, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtCustTraps=prvtCustTraps, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpInfoEntry=sdpInfoEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcMtu=svcMtu, sapEgrQosQueueId=sapEgrQosQueueId, TMEncapVal=TMEncapVal, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSvcCreated=prvtSvcCreated, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcDescription=svcDescription, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtSdpCreated=prvtSdpCreated, prvtSapTraps=prvtSapTraps, svcVPLSUplinkTable=svcVPLSUplinkTable, custContact=custContact, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMSapConformance=prvtTMSapConformance, svcCustName=svcCustName, prvtTMSvcConformance=prvtTMSvcConformance, sdpMtu=sdpMtu, prvtCustCreated=prvtCustCreated)
