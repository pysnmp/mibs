...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpDescription=sdpDescription, sdpSecuredEnable=sdpSecuredEnable, serviceBackupVlanEtherType=serviceBackupVlanEtherType, serviceType=serviceType, serviceCreated=serviceCreated, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpNextFreeId=sdpNextFreeId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapOperFlags=sapOperFlags, sapCustMultSvcSiteName=sapCustMultSvcSiteName, serviceMacAddressSapPortId=serviceMacAddressSapPortId, serviceLastMgmtChange=serviceLastMgmtChange, customerEntry=customerEntry, sapDeleted=sapDeleted, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, prvtServicesMIBNotifications=prvtServicesMIBNotifications, serviceNumSdps=serviceNumSdps, serviceVlanAction=serviceVlanAction, sdpId=sdpId, customerRowStatus=customerRowStatus, sdpLdpEnabled=sdpLdpEnabled, serviceEntry=serviceEntry, sdpAdminEgressLabel=sdpAdminEgressLabel, customerName=customerName, sdpOperFlags=sdpOperFlags, sdpLearnEnable=sdpLearnEnable, sapEncapValue=sapEncapValue, customerContact=customerContact, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceDescription=serviceDescription, serviceAdminStatus=serviceAdminStatus, prvtServicesMIB=prvtServicesMIB, serviceTable=serviceTable, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sdpEntry=sdpEntry, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, serviceMacAddressSapEntry=serviceMacAddressSapEntry, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, sdpCreated=sdpCreated, sdpTable=sdpTable, sapMacLearningProfileState=sapMacLearningProfileState, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sapProfileName=sapProfileName, sdpPwPrecedence=sdpPwPrecedence, customerCreated=customerCreated, sdpDelivery=sdpDelivery, customerDeleted=customerDeleted, sdpOperStatus=sdpOperStatus, serviceNumSaps=serviceNumSaps, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpRowStatus=sdpRowStatus, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, serviceDeleted=serviceDeleted, sdpTransportTunnelName=sdpTransportTunnelName, customerTable=customerTable, serviceOperStatus=serviceOperStatus, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sdpType=sdpType, sapEntry=sapEntry, sdpPwActivate=sdpPwActivate, serviceMtu=serviceMtu, serviceVlanEtherType=serviceVlanEtherType, sapCreated=sapCreated, sapIngressQosPolicyId=sapIngressQosPolicyId, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sdpDeleted=sdpDeleted, serviceMacAddressSdpId=serviceMacAddressSdpId, PYSNMP_MODULE_ID=prvtServicesMIB, serviceEnableSecureSaps=serviceEnableSecureSaps, sapLearnEnable=sapLearnEnable, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpLastMgmtChange=sdpLastMgmtChange, customerPhone=customerPhone, sapAdminStatus=sapAdminStatus, sapOperStatus=sapOperStatus, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sapTable=sapTable, sapType=sapType, sdpVCType=sdpVCType, sapLastMgmtChange=sapLastMgmtChange, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpOutInterface=sdpOutInterface, serviceId=serviceId, sapLearnMode=sapLearnMode, serviceRevertTimer=serviceRevertTimer, sdpAdminStatus=sdpAdminStatus, sapDescription=sapDescription, serviceCustName=serviceCustName, sdpFarEndIpAddress=sdpFarEndIpAddress, sapRowStatus=sapRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceRowStatus=serviceRowStatus, sapPortId=sapPortId, sdpMtu=sdpMtu, serviceVpnId=serviceVpnId, sdpGroupIdentifier=sdpGroupIdentifier, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sapUntaggedMode=sapUntaggedMode, sdpLabelSignaling=sdpLabelSignaling, sapCurrentMacCount=sapCurrentMacCount, sdpSignalPwStatus=sdpSignalPwStatus)
