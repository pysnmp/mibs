...
TNamedItemOrEmpty, TNamedItem, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TNamedItem", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSapObjs=prvtTMSapObjs, SdpIdType=SdpIdType, sapEncapValue=sapEncapValue, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcObjs=prvtTMSvcObjs, sdpDescription=sdpDescription, sdpOperStatus=sdpOperStatus, svcLastStatusChange=svcLastStatusChange, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcRowStatus=svcRowStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcVplsMode=svcVplsMode, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custRowStatus=custRowStatus, prvtCustCreated=prvtCustCreated, sapRowStatus=sapRowStatus, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpOperFlags=sdpOperFlags, sdpMtu=sdpMtu, prvtTMSapGroups=prvtTMSapGroups, sdpBindVlanTag=sdpBindVlanTag, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custInfoEntry=custInfoEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultSvcSiteDescription=custMultSvcSiteDescription, custContact=custContact, ServObjDesc=ServObjDesc, sapIngQosQueueId=sapIngQosQueueId, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapLearnMode=sapLearnMode, sapIngQosSchedCustName=sapIngQosSchedCustName, sapDescription=sapDescription, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpType=sdpType, prvtTMServObjs=prvtTMServObjs, sdpOutInterface=sdpOutInterface, prvtCustDeleted=prvtCustDeleted, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpLastStatusChange=sdpLastStatusChange, custIngQosSchedName=custIngQosSchedName, custNumEntries=custNumEntries, svcMtu=svcMtu, sapBaseInfoTable=sapBaseInfoTable, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtSapCreated=prvtSapCreated, prvtTMCustGroups=prvtTMCustGroups, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapType=sapType, prvtTMSdpConformance=prvtTMSdpConformance, sapBaseInfoEntry=sapBaseInfoEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, ServiceOperStatus=ServiceOperStatus, prvtTMSdpCompliance=prvtTMSdpCompliance, custPhone=custPhone, prvtSvcNotif=prvtSvcNotif, prvtSdpNotif=prvtSdpNotif, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtCustTraps=prvtCustTraps, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcCustName=svcCustName, prvtSdpCreated=prvtSdpCreated, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcNumSaps=svcNumSaps, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpNumEntries=sdpNumEntries, sdpAdminEgressLabel=sdpAdminEgressLabel, ServiceAdminStatus=ServiceAdminStatus, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpAdminStatus=sdpAdminStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtSdpTraps=prvtSdpTraps, svcOperStatus=svcOperStatus, sdpDelivery=sdpDelivery, prvtServNotifications=prvtServNotifications, custLastMgmtChange=custLastMgmtChange, sapOperStatus=sapOperStatus, prvtTMCustObjs=prvtTMCustObjs, prvtSapNotif=prvtSapNotif, svcEnableSecureSaps=svcEnableSecureSaps, custName=custName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosCustName=sapEgrQosCustName, prvtSvcCreated=prvtSvcCreated, sdpInfoEntry=sdpInfoEntry, sapEgrQosSchedName=sapEgrQosSchedName, TSapIngQueueId=TSapIngQueueId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, TMEncapVal=TMEncapVal, svcId=svcId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpVCType=sdpVCType, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapOperFlags=sapOperFlags, svcDescription=svcDescription, prvtSapDeleted=prvtSapDeleted, prvtCustNotif=prvtCustNotif, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpLastMgmtChange=sdpLastMgmtChange, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpLabelSignaling=sdpLabelSignaling, prvtTMSvcCompliances=prvtTMSvcCompliances, svcVPLSUplinkTable=svcVPLSUplinkTable, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueId=sapEgrQosQueueId, sapNumEntries=sapNumEntries, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpNextFreeId=sdpNextFreeId, TSapEgrQueueId=TSapEgrQueueId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcVpnId=svcVpnId, sdpInfoTable=sdpInfoTable, sapEgressQosPolicyId=sapEgressQosPolicyId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSapConformance=prvtTMSapConformance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, ServObjName=ServObjName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcNumEntries=svcNumEntries, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSvcTraps=prvtSvcTraps, svcBaseInfoEntry=svcBaseInfoEntry, sdpRowStatus=sdpRowStatus, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosCustName=sapIngQosCustName, prvtTMSvcGroups=prvtTMSvcGroups, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedName=sapIngQosSchedName, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustCompliances=prvtTMCustCompliances, sapAdminStatus=sapAdminStatus, VpnId=VpnId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtServicesMIB=prvtServicesMIB, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSapTraps=prvtSapTraps, sapPortId=sapPortId, svcLastMgmtChange=svcLastMgmtChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custInfoTable=custInfoTable, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpId=sdpId, svcAdminStatus=svcAdminStatus, svcNumSdps=svcNumSdps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtSdpDeleted=prvtSdpDeleted, svcType=svcType, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcBaseInfoTable=svcBaseInfoTable, custEgrQosSchedName=custEgrQosSchedName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpFarEndIpAddress=sdpFarEndIpAddress, svcRevertTimer=svcRevertTimer, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, ServType=ServType, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets)
