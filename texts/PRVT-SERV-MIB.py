...
TimeStamp, MacAddress, DisplayString, TextualConvention, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "MacAddress", "DisplayString", "TextualConvention", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapType=sapType, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapRowStatus=sapRowStatus, sdpEntry=sdpEntry, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpOperStatus=sdpOperStatus, customerTable=customerTable, serviceTable=serviceTable, serviceType=serviceType, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpLabelSignaling=sdpLabelSignaling, sapDescription=sapDescription, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpGroupIdentifier=sdpGroupIdentifier, sdpDescription=sdpDescription, serviceEnableSecureSaps=serviceEnableSecureSaps, sapCurrentMacCount=sapCurrentMacCount, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, serviceVlanAction=serviceVlanAction, sapDeleted=sapDeleted, sdpMtu=sdpMtu, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpTransportTunnelName=sdpTransportTunnelName, sdpSignalPwStatus=sdpSignalPwStatus, serviceVlanEtherType=serviceVlanEtherType, sapCreated=sapCreated, serviceNumSaps=serviceNumSaps, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpSecuredEnable=sdpSecuredEnable, prvtServicesMIB=prvtServicesMIB, serviceVpnId=serviceVpnId, serviceDescription=serviceDescription, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sdpPwPrecedence=sdpPwPrecedence, sapMacLearningProfileState=sapMacLearningProfileState, sdpOperFlags=sdpOperFlags, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpVCType=sdpVCType, customerContact=customerContact, sdpId=sdpId, serviceNumSdps=serviceNumSdps, prvtServicesMIBObjects=prvtServicesMIBObjects, sdpOutInterface=sdpOutInterface, serviceId=serviceId, sapEncapValue=sapEncapValue, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sdpLearnEnable=sdpLearnEnable, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceDeleted=serviceDeleted, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpPwActivate=sdpPwActivate, PYSNMP_MODULE_ID=prvtServicesMIB, sapOperFlags=sapOperFlags, sapProfileName=sapProfileName, sdpDeleted=sdpDeleted, sapOperStatus=sapOperStatus, sdpType=sdpType, serviceOperStatus=serviceOperStatus, sdpNextFreeId=sdpNextFreeId, sdpCreated=sdpCreated, sapLastMgmtChange=sapLastMgmtChange, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, sdpLdpEnabled=sdpLdpEnabled, sdpRowStatus=sdpRowStatus, sapAdminStatus=sapAdminStatus, serviceRowStatus=serviceRowStatus, sapTable=sapTable, customerPhone=customerPhone, sapPortId=sapPortId, serviceRevertTimer=serviceRevertTimer, customerDeleted=customerDeleted, customerCreated=customerCreated, sdpAdminStatus=sdpAdminStatus, sapLearnMode=sapLearnMode, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, customerEntry=customerEntry, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, serviceLastMgmtChange=serviceLastMgmtChange, sdpTable=sdpTable, customerName=customerName, sdpDelivery=sdpDelivery, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sapLearnEnable=sapLearnEnable, sdpLastMgmtChange=sdpLastMgmtChange, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceAdminStatus=serviceAdminStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, serviceMacAddressSdpId=serviceMacAddressSdpId, serviceEntry=serviceEntry, serviceCustName=serviceCustName, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceMacAddressSapPortId=serviceMacAddressSapPortId, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, customerRowStatus=customerRowStatus, serviceCreated=serviceCreated, serviceMtu=serviceMtu, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpBindVlanTag=sdpBindVlanTag, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEntry=sapEntry, sapUntaggedMode=sapUntaggedMode, prvtServicesMIBNotifications=prvtServicesMIBNotifications)
