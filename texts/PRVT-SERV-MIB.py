...
TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem, serviceAccessSwitch, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMCustGroups=prvtTMCustGroups, custName=custName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSapGroups=prvtTMSapGroups, prvtTMCustObjs=prvtTMCustObjs, TSapIngQueueId=TSapIngQueueId, prvtTMSdpConformance=prvtTMSdpConformance, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcLastMgmtChange=svcLastMgmtChange, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcNumEntries=svcNumEntries, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultSvcSiteName=custMultSvcSiteName, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosCustName=sapIngQosCustName, sdpRowStatus=sdpRowStatus, svcNumSaps=svcNumSaps, prvtTMSvcGroups=prvtTMSvcGroups, sdpDescription=sdpDescription, sapEgrQosQueueId=sapEgrQosQueueId, sapLearnMode=sapLearnMode, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSvcTraps=prvtSvcTraps, prvtTMSvcConformance=prvtTMSvcConformance, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedName=sapEgrQosSchedName, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpInfoEntry=sdpInfoEntry, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custEgrQosSchedName=custEgrQosSchedName, svcType=svcType, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpAdminIsBackup=sdpAdminIsBackup, sdpAdminStatus=sdpAdminStatus, svcVpnId=svcVpnId, custInfoTable=custInfoTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtSapNotif=prvtSapNotif, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sdpOutInterface=sdpOutInterface, sapDescription=sapDescription, prvtTMCustConformance=prvtTMCustConformance, sdpOperFlags=sdpOperFlags, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custIngQosSchedName=custIngQosSchedName, sapEgrQosCustName=sapEgrQosCustName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMCustCompliance=prvtTMCustCompliance, prvtCustCreated=prvtCustCreated, sapOperStatus=sapOperStatus, prvtSapCreated=prvtSapCreated, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, VpnId=VpnId, sdpAdminEgressLabel=sdpAdminEgressLabel, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtSdpDeleted=prvtSdpDeleted, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpId=sdpId, svcCustName=svcCustName, svcRevertTimer=svcRevertTimer, prvtServicesMIB=prvtServicesMIB, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtServNotifications=prvtServNotifications, prvtSvcNotif=prvtSvcNotif, prvtTMSapCompliance=prvtTMSapCompliance, svcLastStatusChange=svcLastStatusChange, ServiceAdminStatus=ServiceAdminStatus, custInfoEntry=custInfoEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcOperStatus=svcOperStatus, sapIngQosSchedName=sapIngQosSchedName, sdpDelivery=sdpDelivery, prvtSdpNotif=prvtSdpNotif, sapIngQosQueueId=sapIngQosQueueId, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcVplsMode=svcVplsMode, sdpLabelSignaling=sdpLabelSignaling, SdpIdType=SdpIdType, sdpLdpEnabled=sdpLdpEnabled, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpTransportTunnelName=sdpTransportTunnelName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapLastMgmtChange=sapLastMgmtChange, prvtTMSapObjs=prvtTMSapObjs, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMServObjs=prvtTMServObjs, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, ServType=ServType, custPhone=custPhone, prvtSvcCreated=prvtSvcCreated, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtSapStatusChanged=prvtSapStatusChanged, custLastMgmtChange=custLastMgmtChange, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, TMEncapVal=TMEncapVal, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpOperStatus=sdpOperStatus, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSapCompliances=prvtTMSapCompliances, ServObjName=ServObjName, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpInfoTable=sdpInfoTable, sapBaseInfoTable=sapBaseInfoTable, sapOperFlags=sapOperFlags, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpVCType=sdpVCType, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapType=sapType, prvtCustDeleted=prvtCustDeleted, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtCustNotif=prvtCustNotif, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSdpGroups=prvtTMSdpGroups, sapAdminStatus=sapAdminStatus, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapRowStatus=sapRowStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpNextFreeId=sdpNextFreeId, sapPortId=sapPortId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpMtu=sdpMtu, prvtTMCustCompliances=prvtTMCustCompliances, svcId=svcId, sdpNumEntries=sdpNumEntries, custMultiServiceSiteTable=custMultiServiceSiteTable, custRowStatus=custRowStatus, svcDescription=svcDescription, svcNumSdps=svcNumSdps, custNumEntries=custNumEntries, ServiceOperStatus=ServiceOperStatus, prvtSapTraps=prvtSapTraps, svcAdminStatus=svcAdminStatus, sdpLastStatusChange=sdpLastStatusChange, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpType=sdpType, prvtTMSvcCompliances=prvtTMSvcCompliances, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosSchedCustName=sapEgrQosSchedCustName, PYSNMP_MODULE_ID=prvtServicesMIB, sapEncapValue=sapEncapValue, prvtSapDeleted=prvtSapDeleted, prvtTMServConformance=prvtTMServConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMTstpConformance=prvtTMTstpConformance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSdpTraps=prvtSdpTraps, svcMtu=svcMtu, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpBindVlanTag=sdpBindVlanTag, svcBaseInfoTable=svcBaseInfoTable, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtSdpCreated=prvtSdpCreated, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custContact=custContact, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpGroupIdentifier=sdpGroupIdentifier, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcRowStatus=svcRowStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapNumEntries=sapNumEntries, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtCustTraps=prvtCustTraps, ServObjDesc=ServObjDesc, sapBaseInfoEntry=sapBaseInfoEntry, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets)
