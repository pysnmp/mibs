...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceVpnId=serviceVpnId, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sapOperStatus=sapOperStatus, serviceDeleted=serviceDeleted, sapCreated=sapCreated, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpTable=sdpTable, sdpType=sdpType, sdpNextFreeId=sdpNextFreeId, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, serviceVlanEtherType=serviceVlanEtherType, customerEntry=customerEntry, sapCurrentMacCount=sapCurrentMacCount, sdpLabelSignaling=sdpLabelSignaling, sdpAdminStatus=sdpAdminStatus, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpCreated=sdpCreated, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpLastMgmtChange=sdpLastMgmtChange, serviceLastMgmtChange=serviceLastMgmtChange, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sapDescription=sapDescription, sapUntaggedMode=sapUntaggedMode, serviceDescription=serviceDescription, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceCreated=serviceCreated, serviceNumSaps=serviceNumSaps, sdpMtu=sdpMtu, sdpLdpEnabled=sdpLdpEnabled, customerDeleted=customerDeleted, sapDeleted=sapDeleted, serviceEntry=serviceEntry, sdpDeleted=sdpDeleted, sdpSecuredEnable=sdpSecuredEnable, serviceRowStatus=serviceRowStatus, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sapProfileName=sapProfileName, sdpPwPrecedence=sdpPwPrecedence, sdpOutInterface=sdpOutInterface, sdpGroupIdentifier=sdpGroupIdentifier, sapTable=sapTable, sdpTransportTunnelName=sdpTransportTunnelName, sapType=sapType, prvtServicesMIB=prvtServicesMIB, sapEncapValue=sapEncapValue, serviceId=serviceId, sapAdminStatus=sapAdminStatus, serviceNumSdps=serviceNumSdps, sapLearnEnable=sapLearnEnable, customerCreated=customerCreated, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, serviceTable=serviceTable, sapOperFlags=sapOperFlags, sdpOperStatus=sdpOperStatus, serviceAdminStatus=serviceAdminStatus, sdpId=sdpId, serviceType=serviceType, serviceEnableSecureSaps=serviceEnableSecureSaps, sdpDescription=sdpDescription, serviceMtu=serviceMtu, sdpEntry=sdpEntry, sdpRowStatus=sdpRowStatus, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpAdminEgressLabel=sdpAdminEgressLabel, sapMacLearningProfileState=sapMacLearningProfileState, sapLearnMode=sapLearnMode, sdpLearnEnable=sdpLearnEnable, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sapEntry=sapEntry, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sapLastMgmtChange=sapLastMgmtChange, sdpFarEndIpAddress=sdpFarEndIpAddress, customerPhone=customerPhone, serviceCustName=serviceCustName, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceVlanAction=serviceVlanAction, serviceMacAddressSdpId=serviceMacAddressSdpId, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, customerTable=customerTable, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpDelivery=sdpDelivery, prvtServicesMIBObjects=prvtServicesMIBObjects, customerName=customerName, sdpSignalPwStatus=sdpSignalPwStatus, serviceRevertTimer=serviceRevertTimer, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, PYSNMP_MODULE_ID=prvtServicesMIB, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sapRowStatus=sapRowStatus, sdpPwActivate=sdpPwActivate, serviceOperStatus=serviceOperStatus, sdpOperFlags=sdpOperFlags, sdpVCType=sdpVCType, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sapCustMultSvcSiteName=sapCustMultSvcSiteName, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sapPortId=sapPortId, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, customerRowStatus=customerRowStatus, serviceMacAddressSapEntry=serviceMacAddressSapEntry, customerContact=customerContact, sapEgressQosPolicyId=sapEgressQosPolicyId)
