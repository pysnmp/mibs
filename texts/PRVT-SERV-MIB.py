...
TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNamedItem, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNamedItem", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapLastMgmtChange=sapLastMgmtChange, prvtSapStatusChanged=prvtSapStatusChanged, custLastMgmtChange=custLastMgmtChange, prvtSvcTraps=prvtSvcTraps, sapOperFlags=sapOperFlags, prvtSapNotif=prvtSapNotif, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSapObjs=prvtTMSapObjs, sapOperStatus=sapOperStatus, svcVpnId=svcVpnId, SdpIdType=SdpIdType, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEncapValue=sapEncapValue, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custInfoEntry=custInfoEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMTstpConformance=prvtTMTstpConformance, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcRowStatus=svcRowStatus, sapNumEntries=sapNumEntries, sdpVCType=sdpVCType, custNumEntries=custNumEntries, prvtTMCustCompliances=prvtTMCustCompliances, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSdpConformance=prvtTMSdpConformance, sdpNumEntries=sdpNumEntries, prvtSapTraps=prvtSapTraps, sdpFarEndIpAddress=sdpFarEndIpAddress, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpInfoEntry=sdpInfoEntry, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapEgrQosCustName=sapEgrQosCustName, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpDelivery=sdpDelivery, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMCustObjs=prvtTMCustObjs, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMServObjs=prvtTMServObjs, TMEncapVal=TMEncapVal, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcDeleted=prvtSvcDeleted, sapIngQosSchedName=sapIngQosSchedName, prvtTMSdpObjs=prvtTMSdpObjs, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtServicesMIB=prvtServicesMIB, ServiceAdminStatus=ServiceAdminStatus, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcNumEntries=svcNumEntries, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpLastStatusChange=sdpLastStatusChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpMtu=sdpMtu, sdpAdminEgressLabel=sdpAdminEgressLabel, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, prvtTMSapCompliance=prvtTMSapCompliance, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosCustName=sapIngQosCustName, sdpBindVlanTag=sdpBindVlanTag, svcLastStatusChange=svcLastStatusChange, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapAdminStatus=sapAdminStatus, custPhone=custPhone, prvtCustCreated=prvtCustCreated, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpAdminStatus=sdpAdminStatus, prvtSdpTraps=prvtSdpTraps, prvtServNotifications=prvtServNotifications, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSapConformance=prvtTMSapConformance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcBaseInfoEntry=svcBaseInfoEntry, sdpOperFlags=sdpOperFlags, prvtTMServConformance=prvtTMServConformance, prvtTMSvcConformance=prvtTMSvcConformance, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosQueueId=sapEgrQosQueueId, svcBaseInfoTable=svcBaseInfoTable, prvtSapCreated=prvtSapCreated, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, TSapIngQueueId=TSapIngQueueId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcId=svcId, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpId=sdpId, custInfoTable=custInfoTable, prvtSdpCreated=prvtSdpCreated, prvtCustTraps=prvtCustTraps, svcVPLSUplinkTable=svcVPLSUplinkTable, svcOperStatus=svcOperStatus, sapDescription=sapDescription, sapPortId=sapPortId, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpType=sdpType, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapCompliances=prvtTMSapCompliances, ServObjName=ServObjName, custEgrQosSchedName=custEgrQosSchedName, sdpOperStatus=sdpOperStatus, prvtTMCustGroups=prvtTMCustGroups, sdpDescription=sdpDescription, prvtSdpNotif=prvtSdpNotif, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSvcGroups=prvtTMSvcGroups, prvtSvcCreated=prvtSvcCreated, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcAdminStatus=svcAdminStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpOutInterface=sdpOutInterface, sdpTransportTunnelName=sdpTransportTunnelName, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMSapGroups=prvtTMSapGroups, sdpAdminIsBackup=sdpAdminIsBackup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueId=sapIngQosQueueId, svcType=svcType, custMultSvcSiteDescription=custMultSvcSiteDescription, custName=custName, custContact=custContact, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcRevertTimer=svcRevertTimer, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcNumSdps=svcNumSdps, sapRowStatus=sapRowStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcDescription=svcDescription, PYSNMP_MODULE_ID=prvtServicesMIB, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpLabelSignaling=sdpLabelSignaling, ServiceOperStatus=ServiceOperStatus, prvtCustDeleted=prvtCustDeleted, svcVplsMode=svcVplsMode, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, VpnId=VpnId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcCustName=svcCustName, prvtSvcStatusChanged=prvtSvcStatusChanged, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtCustNotif=prvtCustNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapBaseInfoEntry=sapBaseInfoEntry, sdpInfoTable=sdpInfoTable, svcEnableSecureSaps=svcEnableSecureSaps, sdpLastMgmtChange=sdpLastMgmtChange, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, ServType=ServType, prvtTMCustCompliance=prvtTMCustCompliance, svcMtu=svcMtu, sapType=sapType, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSdpGroups=prvtTMSdpGroups, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custRowStatus=custRowStatus, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpRowStatus=sdpRowStatus, sapLearnMode=sapLearnMode, svcNumSaps=svcNumSaps, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSdpDeleted=prvtSdpDeleted, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, ServObjDesc=ServObjDesc, sdpLdpEnabled=sdpLdpEnabled, custIngQosSchedName=custIngQosSchedName, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex)
