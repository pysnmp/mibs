...
TNamedItem, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpFarEndIpAddress=sdpFarEndIpAddress, prvtSdpNotif=prvtSdpNotif, custInfoTable=custInfoTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapEgrQosCustName=sapEgrQosCustName, sdpId=sdpId, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSapDeleted=prvtSapDeleted, sdpNextFreeId=sdpNextFreeId, sapIngQosQueueId=sapIngQosQueueId, prvtSdpDeleted=prvtSdpDeleted, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSapCreated=prvtSapCreated, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapBaseInfoEntry=sapBaseInfoEntry, sdpRowStatus=sdpRowStatus, svcDescription=svcDescription, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSapObjs=prvtTMSapObjs, sdpLastMgmtChange=sdpLastMgmtChange, ServType=ServType, prvtTMSvcGroups=prvtTMSvcGroups, prvtSapTraps=prvtSapTraps, sapIngQosSchedName=sapIngQosSchedName, sdpTransportTunnelName=sdpTransportTunnelName, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpVCType=sdpVCType, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSvcCompliances=prvtTMSvcCompliances, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapLearnMode=sapLearnMode, svcType=svcType, svcRevertTimer=svcRevertTimer, prvtServNotifications=prvtServNotifications, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMSvcObjs=prvtTMSvcObjs, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSapNotif=prvtSapNotif, ServObjName=ServObjName, custIngQosSchedName=custIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, sapEgrQosQueueId=sapEgrQosQueueId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcAdminStatus=svcAdminStatus, sapDescription=sapDescription, sapRowStatus=sapRowStatus, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpMtu=sdpMtu, prvtTMSapGroups=prvtTMSapGroups, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpGroupIdentifier=sdpGroupIdentifier, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpDescription=sdpDescription, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSdpCompliance=prvtTMSdpCompliance, svcBaseInfoEntry=svcBaseInfoEntry, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpAdminEgressLabel=sdpAdminEgressLabel, svcId=svcId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtCustTraps=prvtCustTraps, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpInfoTable=sdpInfoTable, prvtSvcNotif=prvtSvcNotif, sapType=sapType, sdpOperFlags=sdpOperFlags, custRowStatus=custRowStatus, sapOperFlags=sapOperFlags, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosCustName=sapIngQosCustName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custNumEntries=custNumEntries, svcOperStatus=svcOperStatus, PYSNMP_MODULE_ID=prvtServicesMIB, sdpInfoEntry=sdpInfoEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSvcDeleted=prvtSvcDeleted, sdpNumEntries=sdpNumEntries, prvtServicesMIB=prvtServicesMIB, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustGroups=prvtTMCustGroups, TSapEgrQueueId=TSapEgrQueueId, sapOperStatus=sapOperStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpBindVlanTag=sdpBindVlanTag, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEncapValue=sapEncapValue, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSdpTraps=prvtSdpTraps, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMCustConformance=prvtTMCustConformance, svcVpnId=svcVpnId, svcMtu=svcMtu, prvtTMSdpConformance=prvtTMSdpConformance, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpAdminIsBackup=sdpAdminIsBackup, sdpOperIsBackup=sdpOperIsBackup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapNumEntries=sapNumEntries, svcVplsMode=svcVplsMode, svcNumSdps=svcNumSdps, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtCustCreated=prvtCustCreated, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custLastMgmtChange=custLastMgmtChange, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMSdpObjs=prvtTMSdpObjs, custPhone=custPhone, sdpAdminStatus=sdpAdminStatus, sdpType=sdpType, sdpOperStatus=sdpOperStatus, ServiceOperStatus=ServiceOperStatus, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSapStatusChanged=prvtSapStatusChanged, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMCustCompliances=prvtTMCustCompliances, sdpOutInterface=sdpOutInterface, sapLastMgmtChange=sapLastMgmtChange, svcNumEntries=svcNumEntries, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custInfoEntry=custInfoEntry, custName=custName, custMultSvcSiteName=custMultSvcSiteName, custMultSvcSiteDescription=custMultSvcSiteDescription, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcLastMgmtChange=svcLastMgmtChange, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, ServiceAdminStatus=ServiceAdminStatus, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custEgrQosSchedName=custEgrQosSchedName, sdpDelivery=sdpDelivery, ServObjDesc=ServObjDesc, custContact=custContact, svcEnableSecureSaps=svcEnableSecureSaps, TSapIngQueueId=TSapIngQueueId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, svcBaseInfoTable=svcBaseInfoTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMCustObjs=prvtTMCustObjs, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcNumSaps=svcNumSaps, VpnId=VpnId, svcRowStatus=svcRowStatus, custMultiServiceSiteTable=custMultiServiceSiteTable, svcCustName=svcCustName, sapAdminStatus=sapAdminStatus, prvtSdpCreated=prvtSdpCreated, sdpLabelSignaling=sdpLabelSignaling, SdpIdType=SdpIdType, prvtSvcTraps=prvtSvcTraps, prvtCustNotif=prvtCustNotif, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapPortId=sapPortId, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, TMEncapVal=TMEncapVal, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtCustDeleted=prvtCustDeleted, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMSvcConformance=prvtTMSvcConformance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpLdpEnabled=sdpLdpEnabled, prvtSvcCreated=prvtSvcCreated, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMServConformance=prvtTMServConformance, sdpLastStatusChange=sdpLastStatusChange, svcLastStatusChange=svcLastStatusChange, prvtTMServObjs=prvtTMServObjs)
