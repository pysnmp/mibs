...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngressQosPolicyId=sapIngressQosPolicyId, svcDescription=svcDescription, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapGroups=prvtTMSapGroups, sdpInfoTable=sdpInfoTable, sdpLdpEnabled=sdpLdpEnabled, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapLearnMode=sapLearnMode, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSdpGroups=prvtTMSdpGroups, svcRevertTimer=svcRevertTimer, sapBaseInfoEntry=sapBaseInfoEntry, svcNumEntries=svcNumEntries, prvtServicesMIB=prvtServicesMIB, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, sdpDelivery=sdpDelivery, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpAdminStatus=sdpAdminStatus, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMServConformance=prvtTMServConformance, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtCustCreated=prvtCustCreated, sapIngQosQueueId=sapIngQosQueueId, prvtSdpNotif=prvtSdpNotif, svcNumSaps=svcNumSaps, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapAdminStatus=sapAdminStatus, sapBaseInfoTable=sapBaseInfoTable, sapIngQosSchedName=sapIngQosSchedName, ServType=ServType, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, ServiceAdminStatus=ServiceAdminStatus, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcLastMgmtChange=svcLastMgmtChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustConformance=prvtTMCustConformance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtCustDeleted=prvtCustDeleted, prvtCustTraps=prvtCustTraps, prvtTMTstpConformance=prvtTMTstpConformance, prvtSvcTraps=prvtSvcTraps, sapEgrQosQueueId=sapEgrQosQueueId, sapRowStatus=sapRowStatus, svcNumSdps=svcNumSdps, sdpLabelSignaling=sdpLabelSignaling, custName=custName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultSvcSiteName=custMultSvcSiteName, TSapEgrQueueId=TSapEgrQueueId, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, VpnId=VpnId, custLastMgmtChange=custLastMgmtChange, sapDescription=sapDescription, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapOperStatus=sapOperStatus, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpDescription=sdpDescription, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custRowStatus=custRowStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMCustObjs=prvtTMCustObjs, custNumEntries=custNumEntries, sdpOperFlags=sdpOperFlags, custEgrQosSchedName=custEgrQosSchedName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpLastStatusChange=sdpLastStatusChange, sdpType=sdpType, sdpInfoEntry=sdpInfoEntry, svcLastStatusChange=svcLastStatusChange, prvtSdpStatusChanged=prvtSdpStatusChanged, sapLastMgmtChange=sapLastMgmtChange, prvtSdpCreated=prvtSdpCreated, SdpIdType=SdpIdType, prvtSvcDeleted=prvtSvcDeleted, prvtTMSapCompliance=prvtTMSapCompliance, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcMtu=svcMtu, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMCustCompliances=prvtTMCustCompliances, ServiceOperStatus=ServiceOperStatus, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcCustName=svcCustName, prvtSapDeleted=prvtSapDeleted, svcVplsMode=svcVplsMode, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custInfoEntry=custInfoEntry, svcAdminStatus=svcAdminStatus, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpOperIsBackup=sdpOperIsBackup, sdpNextFreeId=sdpNextFreeId, prvtTMSdpCompliance=prvtTMSdpCompliance, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, ServObjDesc=ServObjDesc, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSdpTraps=prvtSdpTraps, svcRowStatus=svcRowStatus, sdpBindVlanTag=sdpBindVlanTag, svcEnableSecureSaps=svcEnableSecureSaps, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpGroupIdentifier=sdpGroupIdentifier, sdpOutInterface=sdpOutInterface, prvtTMCustGroups=prvtTMCustGroups, custContact=custContact, svcId=svcId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSapObjs=prvtTMSapObjs, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpOperStatus=sdpOperStatus, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSdpDeleted=prvtSdpDeleted, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, TSapIngQueueId=TSapIngQueueId, sapEncapValue=sapEncapValue, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosSchedName=sapEgrQosSchedName, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSapCompliances=prvtTMSapCompliances, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosCustName=sapIngQosCustName, ServObjName=ServObjName, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcOperStatus=svcOperStatus, sdpLastMgmtChange=sdpLastMgmtChange, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpId=sdpId, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapPortId=sapPortId, prvtSapStatusChanged=prvtSapStatusChanged, custMultiServiceSiteTable=custMultiServiceSiteTable, sapNumEntries=sapNumEntries, custMultSvcSiteDescription=custMultSvcSiteDescription, TMEncapVal=TMEncapVal, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMServObjs=prvtTMServObjs, svcVpnId=svcVpnId, svcType=svcType, sapOperFlags=sapOperFlags, sdpRowStatus=sdpRowStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMCustCompliance=prvtTMCustCompliance, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custPhone=custPhone, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtServNotifications=prvtServNotifications, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSvcObjs=prvtTMSvcObjs, sapEgrQosCustName=sapEgrQosCustName, prvtSvcNotif=prvtSvcNotif, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcBaseInfoEntry=svcBaseInfoEntry, sapType=sapType, prvtSapNotif=prvtSapNotif, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpMtu=sdpMtu, custInfoTable=custInfoTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custIngQosSchedName=custIngQosSchedName, prvtSapCreated=prvtSapCreated, svcBaseInfoTable=svcBaseInfoTable, prvtSapTraps=prvtSapTraps, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSdpConformance=prvtTMSdpConformance, sdpVCType=sdpVCType, svcVPLSUplinkEntry=svcVPLSUplinkEntry)
