...
mibBuilder.exportSymbols("PRVT-SERV-MIB", serviceNumSdps=serviceNumSdps, customerRowStatus=customerRowStatus, sdpVCType=sdpVCType, sdpPwPrecedence=sdpPwPrecedence, sapOperFlags=sapOperFlags, sdpFarEndIpAddress=sdpFarEndIpAddress, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpGroupIdentifier=sdpGroupIdentifier, serviceMacAddressSdpId=serviceMacAddressSdpId, customerDeleted=customerDeleted, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, customerPhone=customerPhone, serviceMacAddressSdpTable=serviceMacAddressSdpTable, sdpLabelSignaling=sdpLabelSignaling, sdpNextFreeId=sdpNextFreeId, serviceMacAddressSapPortId=serviceMacAddressSapPortId, serviceRevertTimer=serviceRevertTimer, customerCreated=customerCreated, serviceId=serviceId, sapCurrentMacCount=sapCurrentMacCount, sapType=sapType, serviceMtu=serviceMtu, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceCreated=serviceCreated, sapIngressQosPolicyId=sapIngressQosPolicyId, sapTable=sapTable, sdpId=sdpId, sdpSecuredEnable=sdpSecuredEnable, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpDeleted=sdpDeleted, serviceEntry=serviceEntry, sdpAdminStatus=sdpAdminStatus, sapLearnEnable=sapLearnEnable, sapDeleted=sapDeleted, sapAdminStatus=sapAdminStatus, prvtServicesMIB=prvtServicesMIB, serviceVlanAction=serviceVlanAction, sdpMtu=sdpMtu, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpOutInterface=sdpOutInterface, sdpDescription=sdpDescription, customerTable=customerTable, sapUntaggedMode=sapUntaggedMode, serviceEnableSecureSaps=serviceEnableSecureSaps, sapEncapValue=sapEncapValue, sdpLearnEnable=sdpLearnEnable, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sdpOperFlags=sdpOperFlags, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpCreated=sdpCreated, sapCreated=sapCreated, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sdpTransportTunnelName=sdpTransportTunnelName, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceVpnId=serviceVpnId, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, sapLearnMode=sapLearnMode, serviceVlanEtherType=serviceVlanEtherType, serviceAdminStatus=serviceAdminStatus, serviceMacAddressSapTable=serviceMacAddressSapTable, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceType=serviceType, customerContact=customerContact, customerName=customerName, sdpPwActivate=sdpPwActivate, serviceDeleted=serviceDeleted, sapEntry=sapEntry, customerEntry=customerEntry, serviceTable=serviceTable, sdpType=sdpType, sapRowStatus=sapRowStatus, serviceCustName=serviceCustName, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceLastMgmtChange=serviceLastMgmtChange, sdpDelivery=sdpDelivery, sapMacLearningProfileState=sapMacLearningProfileState, sapPortId=sapPortId, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sapProfileName=sapProfileName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpTable=sdpTable, serviceNumSaps=serviceNumSaps, prvtServicesMIBObjects=prvtServicesMIBObjects, serviceOperStatus=serviceOperStatus, sapLastMgmtChange=sapLastMgmtChange, sdpPwRedundancyEnable=sdpPwRedundancyEnable, sdpRowStatus=sdpRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpLdpEnabled=sdpLdpEnabled, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapDescription=sapDescription, sdpLastMgmtChange=sdpLastMgmtChange, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpBindVlanTag=sdpBindVlanTag, sdpSignalPwStatus=sdpSignalPwStatus, PYSNMP_MODULE_ID=prvtServicesMIB, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sdpEntry=sdpEntry, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, serviceRowStatus=serviceRowStatus, serviceDescription=serviceDescription, sapOperStatus=sapOperStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpOperStatus=sdpOperStatus)
