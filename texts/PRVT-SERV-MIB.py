...
TNamedItemOrEmpty, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, ServiceAdminStatus=ServiceAdminStatus, sapAdminStatus=sapAdminStatus, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapConformance=prvtTMSapConformance, VpnId=VpnId, ServiceOperStatus=ServiceOperStatus, prvtTMSapGroups=prvtTMSapGroups, sapDescription=sapDescription, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMCustCompliance=prvtTMCustCompliance, prvtSapNotif=prvtSapNotif, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpOperStatus=sdpOperStatus, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngressQosPolicyId=sapIngressQosPolicyId, svcNumEntries=svcNumEntries, sdpDelivery=sdpDelivery, sdpType=sdpType, prvtTMSapObjs=prvtTMSapObjs, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapType=sapType, prvtTMCustGroups=prvtTMCustGroups, sdpLastStatusChange=sdpLastStatusChange, ServObjName=ServObjName, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSvcObjs=prvtTMSvcObjs, TSapEgrQueueId=TSapEgrQueueId, sapLearnMode=sapLearnMode, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSdpConformance=prvtTMSdpConformance, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapIngQosSchedName=sapIngQosSchedName, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcEnableSecureSaps=svcEnableSecureSaps, sdpGroupIdentifier=sdpGroupIdentifier, svcVpnId=svcVpnId, svcMtu=svcMtu, prvtTMServObjs=prvtTMServObjs, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpLastMgmtChange=sdpLastMgmtChange, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMCustObjs=prvtTMCustObjs, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, svcId=svcId, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcRowStatus=svcRowStatus, sdpTransportTunnelName=sdpTransportTunnelName, sapOperStatus=sapOperStatus, custRowStatus=custRowStatus, svcLastStatusChange=svcLastStatusChange, sdpLdpEnabled=sdpLdpEnabled, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtSvcNotif=prvtSvcNotif, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpOperIsBackup=sdpOperIsBackup, sdpNextFreeId=sdpNextFreeId, sdpInfoEntry=sdpInfoEntry, prvtTMSdpGroups=prvtTMSdpGroups, sdpVCType=sdpVCType, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpBindVlanTag=sdpBindVlanTag, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcType=svcType, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSvcStatusChanged=prvtSvcStatusChanged, sapRowStatus=sapRowStatus, sdpInfoTable=sdpInfoTable, TMEncapVal=TMEncapVal, custPhone=custPhone, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtServNotifications=prvtServNotifications, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcCustName=svcCustName, svcAdminStatus=svcAdminStatus, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, custMultSvcSiteName=custMultSvcSiteName, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtSvcDeleted=prvtSvcDeleted, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custInfoTable=custInfoTable, prvtCustTraps=prvtCustTraps, PYSNMP_MODULE_ID=prvtServicesMIB, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcNumSdps=svcNumSdps, sapEgrQosCustName=sapEgrQosCustName, prvtTMCustConformance=prvtTMCustConformance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sdpMtu=sdpMtu, sdpNumEntries=sdpNumEntries, prvtSdpTraps=prvtSdpTraps, svcRevertTimer=svcRevertTimer, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosCustName=sapIngQosCustName, prvtTMSdpCompliances=prvtTMSdpCompliances, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custName=custName, prvtSdpCreated=prvtSdpCreated, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, ServObjDesc=ServObjDesc, SdpIdType=SdpIdType, prvtTMServConformance=prvtTMServConformance, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpOutInterface=sdpOutInterface, sapLastMgmtChange=sapLastMgmtChange, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueId=sapIngQosQueueId, custLastMgmtChange=custLastMgmtChange, prvtSapDeleted=prvtSapDeleted, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSdpDeleted=prvtSdpDeleted, custNumEntries=custNumEntries, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMSapCompliance=prvtTMSapCompliance, sdpId=sdpId, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtCustDeleted=prvtCustDeleted, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcBaseInfoTable=svcBaseInfoTable, TSapIngQueueId=TSapIngQueueId, svcDescription=svcDescription, prvtTMSdpCompliance=prvtTMSdpCompliance, custInfoEntry=custInfoEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSdpNotif=prvtSdpNotif, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcOperStatus=svcOperStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpAdminStatus=sdpAdminStatus, custEgrQosSchedName=custEgrQosSchedName, sapOperFlags=sapOperFlags, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtCustCreated=prvtCustCreated, ServType=ServType, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custContact=custContact, sapEgrQosSchedName=sapEgrQosSchedName, sdpRowStatus=sdpRowStatus, sdpDescription=sdpDescription, prvtTMSvcGroups=prvtTMSvcGroups, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpOperFlags=sdpOperFlags, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpLabelSignaling=sdpLabelSignaling, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapEgressQosPolicyId=sapEgressQosPolicyId, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueId=sapEgrQosQueueId, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtCustNotif=prvtCustNotif, prvtServicesMIB=prvtServicesMIB, sapNumEntries=sapNumEntries, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSapStatusChanged=prvtSapStatusChanged, sdpAdminIsBackup=sdpAdminIsBackup, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEncapValue=sapEncapValue, prvtSapCreated=prvtSapCreated, sapPortId=sapPortId, svcVplsMode=svcVplsMode, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSvcTraps=prvtSvcTraps, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtSapTraps=prvtSapTraps, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpFarEndIpAddress=sdpFarEndIpAddress)
