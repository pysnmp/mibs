...
TSapEgressPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgressQosPolicyId=sapEgressQosPolicyId, svcVplsMode=svcVplsMode, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSdpConformance=prvtTMSdpConformance, prvtSdpCreated=prvtSdpCreated, custMultSvcSiteName=custMultSvcSiteName, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpDescription=sdpDescription, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSvcDeleted=prvtSvcDeleted, prvtSapTraps=prvtSapTraps, svcVpnId=svcVpnId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtServNotifications=prvtServNotifications, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custInfoTable=custInfoTable, prvtSvcCreated=prvtSvcCreated, sdpAdminIsBackup=sdpAdminIsBackup, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSvcCompliances=prvtTMSvcCompliances, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcMtu=svcMtu, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custContact=custContact, sdpRowStatus=sdpRowStatus, sapType=sapType, custMultiServiceSiteTable=custMultiServiceSiteTable, svcDescription=svcDescription, prvtTMServConformance=prvtTMServConformance, svcRevertTimer=svcRevertTimer, prvtTMCustCompliances=prvtTMCustCompliances, svcNumSaps=svcNumSaps, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapNumEntries=sapNumEntries, custPhone=custPhone, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, ServiceOperStatus=ServiceOperStatus, prvtTMCustConformance=prvtTMCustConformance, svcId=svcId, prvtTMSapObjs=prvtTMSapObjs, svcLastStatusChange=svcLastStatusChange, svcEnableSecureSaps=svcEnableSecureSaps, prvtSapDeleted=prvtSapDeleted, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtSvcTraps=prvtSvcTraps, sdpVCType=sdpVCType, sapPortId=sapPortId, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEgrQosCustName=sapEgrQosCustName, prvtServicesMIB=prvtServicesMIB, sdpAdminStatus=sdpAdminStatus, custLastMgmtChange=custLastMgmtChange, sdpLastMgmtChange=sdpLastMgmtChange, sapAdminStatus=sapAdminStatus, prvtTMCustCompliance=prvtTMCustCompliance, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcRowStatus=svcRowStatus, sdpDelivery=sdpDelivery, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpOperStatus=sdpOperStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcType=svcType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custEgrQosSchedName=custEgrQosSchedName, prvtSvcNotif=prvtSvcNotif, ServType=ServType, sdpNumEntries=sdpNumEntries, svcOperStatus=svcOperStatus, sdpType=sdpType, sapDescription=sapDescription, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSdpNotif=prvtSdpNotif, sdpLastStatusChange=sdpLastStatusChange, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMTstpConformance=prvtTMTstpConformance, sdpOperFlags=sdpOperFlags, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSvcObjs=prvtTMSvcObjs, sdpOperIsBackup=sdpOperIsBackup, ServiceAdminStatus=ServiceAdminStatus, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, ServObjName=ServObjName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMCustGroups=prvtTMCustGroups, prvtSdpTraps=prvtSdpTraps, sapOperStatus=sapOperStatus, sdpBindVlanTag=sdpBindVlanTag, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSdpObjs=prvtTMSdpObjs, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtSapNotif=prvtSapNotif, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, TSapIngQueueId=TSapIngQueueId, VpnId=VpnId, svcBaseInfoEntry=svcBaseInfoEntry, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpOutInterface=sdpOutInterface, sapLastMgmtChange=sapLastMgmtChange, sdpInfoEntry=sdpInfoEntry, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSdpDeleted=prvtSdpDeleted, sapCustMultSvcSiteName=sapCustMultSvcSiteName, TSapEgrQueueId=TSapEgrQueueId, custNumEntries=custNumEntries, svcNumSdps=svcNumSdps, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtCustNotif=prvtCustNotif, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtCustDeleted=prvtCustDeleted, sapEncapValue=sapEncapValue, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapLearnMode=sapLearnMode, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMCustObjs=prvtTMCustObjs, sapIngQosCustName=sapIngQosCustName, custName=custName, sdpAdminEgressLabel=sdpAdminEgressLabel, svcNumEntries=svcNumEntries, custIngQosSchedName=custIngQosSchedName, sdpInfoTable=sdpInfoTable, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcBaseInfoTable=svcBaseInfoTable, prvtSapCreated=prvtSapCreated, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtCustTraps=prvtCustTraps, prvtCustCreated=prvtCustCreated, prvtSvcStatusChanged=prvtSvcStatusChanged, SdpIdType=SdpIdType, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSdpCompliance=prvtTMSdpCompliance, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcLastMgmtChange=svcLastMgmtChange, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapOperFlags=sapOperFlags, sdpGroupIdentifier=sdpGroupIdentifier, custRowStatus=custRowStatus, TMEncapVal=TMEncapVal, svcCustName=svcCustName, sapRowStatus=sapRowStatus, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSapCompliance=prvtTMSapCompliance, sdpNextFreeId=sdpNextFreeId, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpLdpEnabled=sdpLdpEnabled, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, PYSNMP_MODULE_ID=prvtServicesMIB, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpMtu=sdpMtu, prvtSapStatusChanged=prvtSapStatusChanged, sdpLabelSignaling=sdpLabelSignaling, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosSchedName=sapIngQosSchedName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosSchedName=sapEgrQosSchedName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueId=sapIngQosQueueId, sdpTransportTunnelName=sdpTransportTunnelName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sdpId=sdpId, ServObjDesc=ServObjDesc, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, svcVPLSUplinkTable=svcVPLSUplinkTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcAdminStatus=svcAdminStatus, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMServObjs=prvtTMServObjs, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry)
