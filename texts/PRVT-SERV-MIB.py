...
TNamedItemOrEmpty, serviceAccessSwitch, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSvcGroups=prvtTMSvcGroups, svcEnableSecureSaps=svcEnableSecureSaps, sapEgrQosSchedName=sapEgrQosSchedName, svcAdminStatus=svcAdminStatus, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapBaseInfoEntry=sapBaseInfoEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpBindVlanTag=sdpBindVlanTag, sdpAdminStatus=sdpAdminStatus, sdpLabelSignaling=sdpLabelSignaling, prvtSvcNotif=prvtSvcNotif, sapPortId=sapPortId, prvtTMSdpConformance=prvtTMSdpConformance, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtSdpNotif=prvtSdpNotif, prvtSdpDeleted=prvtSdpDeleted, TSapIngQueueId=TSapIngQueueId, custLastMgmtChange=custLastMgmtChange, sapIngQosSchedCustName=sapIngQosSchedCustName, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, custRowStatus=custRowStatus, sapOperStatus=sapOperStatus, sapBaseInfoTable=sapBaseInfoTable, svcVpnId=svcVpnId, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, ServType=ServType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSdpCreated=prvtSdpCreated, svcRevertTimer=svcRevertTimer, svcVPLSUplinkTable=svcVPLSUplinkTable, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtSdpTraps=prvtSdpTraps, svcCustName=svcCustName, prvtSvcDeleted=prvtSvcDeleted, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtSvcCreated=prvtSvcCreated, sapDescription=sapDescription, prvtSapNotif=prvtSapNotif, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, ServiceOperStatus=ServiceOperStatus, custPhone=custPhone, sdpOperStatus=sdpOperStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, VpnId=VpnId, prvtSvcTraps=prvtSvcTraps, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapIngQosCustName=sapIngQosCustName, sdpOutInterface=sdpOutInterface, svcBaseInfoTable=svcBaseInfoTable, prvtSapDeleted=prvtSapDeleted, svcRowStatus=svcRowStatus, sdpLastStatusChange=sdpLastStatusChange, custName=custName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, ServObjName=ServObjName, prvtTMCustObjs=prvtTMCustObjs, sdpFarEndIpAddress=sdpFarEndIpAddress, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapType=sapType, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcType=svcType, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapLearnMode=sapLearnMode, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custEgrQosSchedName=custEgrQosSchedName, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custIngQosSchedName=custIngQosSchedName, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpGroupIdentifier=sdpGroupIdentifier, sdpOperFlags=sdpOperFlags, sdpVCType=sdpVCType, sdpDescription=sdpDescription, TSapEgrQueueId=TSapEgrQueueId, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultSvcSiteDescription=custMultSvcSiteDescription, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMSvcObjs=prvtTMSvcObjs, sdpInfoTable=sdpInfoTable, sapNumEntries=sapNumEntries, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMServObjs=prvtTMServObjs, prvtCustCreated=prvtCustCreated, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpInfoEntry=sdpInfoEntry, svcId=svcId, sdpMtu=sdpMtu, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custMultiServiceSiteEntry=custMultiServiceSiteEntry, TMEncapVal=TMEncapVal, sdpType=sdpType, svcDescription=svcDescription, svcLastMgmtChange=svcLastMgmtChange, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcMtu=svcMtu, prvtTMSapObjs=prvtTMSapObjs, ServObjDesc=ServObjDesc, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSapGroups=prvtTMSapGroups, prvtCustTraps=prvtCustTraps, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpId=sdpId, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosSchedName=sapIngQosSchedName, sdpNextFreeId=sdpNextFreeId, sapRowStatus=sapRowStatus, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcNumSdps=svcNumSdps, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpLdpEnabled=sdpLdpEnabled, prvtServicesMIB=prvtServicesMIB, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosCustName=sapEgrQosCustName, sdpAdminIngressLabel=sdpAdminIngressLabel, svcOperStatus=svcOperStatus, svcVplsMode=svcVplsMode, sdpRowStatus=sdpRowStatus, prvtTMSdpGroups=prvtTMSdpGroups, sapOperFlags=sapOperFlags, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSapCompliance=prvtTMSapCompliance, svcLastStatusChange=svcLastStatusChange, sdpOperIsBackup=sdpOperIsBackup, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMServConformance=prvtTMServConformance, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpNumEntries=sdpNumEntries, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueId=sapIngQosQueueId, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSvcConformance=prvtTMSvcConformance, sdpDelivery=sdpDelivery, prvtTMCustConformance=prvtTMCustConformance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpTransportTunnelName=sdpTransportTunnelName, PYSNMP_MODULE_ID=prvtServicesMIB, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtSapTraps=prvtSapTraps, prvtSapCreated=prvtSapCreated, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, SdpIdType=SdpIdType, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapAdminStatus=sapAdminStatus, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custContact=custContact, custMultSvcSiteName=custMultSvcSiteName, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtSdpStatusChanged=prvtSdpStatusChanged, custNumEntries=custNumEntries, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custInfoTable=custInfoTable, custInfoEntry=custInfoEntry, svcNumEntries=svcNumEntries, prvtTMCustGroups=prvtTMCustGroups, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpLastMgmtChange=sdpLastMgmtChange, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtServNotifications=prvtServNotifications, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtCustDeleted=prvtCustDeleted, prvtTMSvcCompliances=prvtTMSvcCompliances, sapLastMgmtChange=sapLastMgmtChange, ServiceAdminStatus=ServiceAdminStatus, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEncapValue=sapEncapValue, prvtTMSapConformance=prvtTMSapConformance)
