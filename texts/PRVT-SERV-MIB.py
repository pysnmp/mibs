...
serviceAccessSwitch, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSapGroups=prvtTMSapGroups, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcRevertTimer=svcRevertTimer, sapOperStatus=sapOperStatus, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpOperIsBackup=sdpOperIsBackup, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSapCompliances=prvtTMSapCompliances, custIngQosSchedName=custIngQosSchedName, ServiceOperStatus=ServiceOperStatus, VpnId=VpnId, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtServicesMIB=prvtServicesMIB, prvtTMCustGroups=prvtTMCustGroups, prvtSvcNotif=prvtSvcNotif, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, custInfoTable=custInfoTable, svcMtu=svcMtu, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcId=svcId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpDescription=sdpDescription, svcAdminStatus=svcAdminStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMServObjs=prvtTMServObjs, prvtTMCustCompliances=prvtTMCustCompliances, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtSdpCreated=prvtSdpCreated, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpId=sdpId, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcType=svcType, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtCustTraps=prvtCustTraps, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtCustCreated=prvtCustCreated, prvtTMSdpObjs=prvtTMSdpObjs, sapBaseInfoTable=sapBaseInfoTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custLastMgmtChange=custLastMgmtChange, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcNumSdps=svcNumSdps, sdpLastMgmtChange=sdpLastMgmtChange, sdpMtu=sdpMtu, prvtTMCustConformance=prvtTMCustConformance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapAdminStatus=sapAdminStatus, sdpOutInterface=sdpOutInterface, prvtSapStatusChanged=prvtSapStatusChanged, prvtSdpTraps=prvtSdpTraps, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapType=sapType, sdpLastStatusChange=sdpLastStatusChange, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtSapDeleted=prvtSapDeleted, sdpType=sdpType, prvtSvcTraps=prvtSvcTraps, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMSvcObjs=prvtTMSvcObjs, sapDescription=sapDescription, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpOperStatus=sdpOperStatus, sdpVCType=sdpVCType, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpLdpEnabled=sdpLdpEnabled, sapEncapValue=sapEncapValue, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSdpConformance=prvtTMSdpConformance, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtSapTraps=prvtSapTraps, svcLastStatusChange=svcLastStatusChange, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcVpnId=svcVpnId, custPhone=custPhone, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcGroups=prvtTMSvcGroups, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSdpDeleted=prvtSdpDeleted, sapOperFlags=sapOperFlags, svcEnableSecureSaps=svcEnableSecureSaps, sdpRowStatus=sdpRowStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custName=custName, prvtSdpStatusChanged=prvtSdpStatusChanged, sapEgrQosQueueId=sapEgrQosQueueId, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSvcCompliances=prvtTMSvcCompliances, custEgrQosSchedName=custEgrQosSchedName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, svcNumEntries=svcNumEntries, sdpNextFreeId=sdpNextFreeId, prvtSdpNotif=prvtSdpNotif, sdpAdminEgressLabel=sdpAdminEgressLabel, custInfoEntry=custInfoEntry, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapCompliance=prvtTMSapCompliance, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpNumEntries=sdpNumEntries, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapIngQosSchedName=sapIngQosSchedName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcCustName=svcCustName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpOperFlags=sdpOperFlags, ServObjName=ServObjName, custRowStatus=custRowStatus, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMServConformance=prvtTMServConformance, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapBaseInfoEntry=sapBaseInfoEntry, sapLastMgmtChange=sapLastMgmtChange, svcOperStatus=svcOperStatus, prvtServNotifications=prvtServNotifications, svcBaseInfoTable=svcBaseInfoTable, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpInfoTable=sdpInfoTable, sapEgressQosPolicyId=sapEgressQosPolicyId, svcRowStatus=svcRowStatus, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapLearnMode=sapLearnMode, prvtSapNotif=prvtSapNotif, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpGroupIdentifier=sdpGroupIdentifier, TSapEgrQueueId=TSapEgrQueueId, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpBindVlanTag=sdpBindVlanTag, sapRowStatus=sapRowStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMTstpConformance=prvtTMTstpConformance, TMEncapVal=TMEncapVal, prvtSapCreated=prvtSapCreated, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custNumEntries=custNumEntries, prvtTMSapObjs=prvtTMSapObjs, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosSchedName=sapEgrQosSchedName, sdpDelivery=sdpDelivery, ServObjDesc=ServObjDesc, sdpInfoEntry=sdpInfoEntry, TSapIngQueueId=TSapIngQueueId, sdpLabelSignaling=sdpLabelSignaling, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtCustNotif=prvtCustNotif, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcNumSaps=svcNumSaps, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustObjs=prvtTMCustObjs, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSapConformance=prvtTMSapConformance, sapIngQosCustName=sapIngQosCustName, prvtSvcCreated=prvtSvcCreated, sapPortId=sapPortId, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMCustCompliance=prvtTMCustCompliance, sapIngQosQueueId=sapIngQosQueueId, ServiceAdminStatus=ServiceAdminStatus, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custContact=custContact, SdpIdType=SdpIdType, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpAdminStatus=sdpAdminStatus, sapNumEntries=sapNumEntries, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcVplsMode=svcVplsMode, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcDescription=svcDescription, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, ServType=ServType, custIngQosAssignmentPortId=custIngQosAssignmentPortId)
