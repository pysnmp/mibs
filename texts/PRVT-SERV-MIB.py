...
TNamedItem, serviceAccessSwitch, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSvcTraps=prvtSvcTraps, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpType=sdpType, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapBaseInfoTable=sapBaseInfoTable, svcCustName=svcCustName, custContact=custContact, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustObjs=prvtTMCustObjs, sdpInfoEntry=sdpInfoEntry, custMultiServiceSiteTable=custMultiServiceSiteTable, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcObjs=prvtTMSvcObjs, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSvcCompliances=prvtTMSvcCompliances, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcAdminStatus=svcAdminStatus, sapAdminStatus=sapAdminStatus, custInfoEntry=custInfoEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcNumEntries=svcNumEntries, prvtCustTraps=prvtCustTraps, svcNumSdps=svcNumSdps, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpLastMgmtChange=sdpLastMgmtChange, prvtSapCreated=prvtSapCreated, prvtTMSdpObjs=prvtTMSdpObjs, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapCompliances=prvtTMSapCompliances, svcType=svcType, PYSNMP_MODULE_ID=prvtServicesMIB, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sdpRowStatus=sdpRowStatus, prvtServicesMIB=prvtServicesMIB, prvtCustNotif=prvtCustNotif, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtSdpCreated=prvtSdpCreated, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSapObjs=prvtTMSapObjs, prvtTMTstpConformance=prvtTMTstpConformance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtSapTraps=prvtSapTraps, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapOperStatus=sapOperStatus, sdpNextFreeId=sdpNextFreeId, prvtTMSdpCompliance=prvtTMSdpCompliance, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sapRowStatus=sapRowStatus, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpDescription=sdpDescription, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custLastMgmtChange=custLastMgmtChange, prvtTMCustCompliance=prvtTMCustCompliance, VpnId=VpnId, prvtSdpNotif=prvtSdpNotif, ServiceOperStatus=ServiceOperStatus, TSapIngQueueId=TSapIngQueueId, svcId=svcId, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, ServiceAdminStatus=ServiceAdminStatus, svcMtu=svcMtu, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosQueueId=sapEgrQosQueueId, sdpInfoTable=sdpInfoTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpNumEntries=sdpNumEntries, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcRowStatus=svcRowStatus, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpTransportTunnelName=sdpTransportTunnelName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapNumEntries=sapNumEntries, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSvcGroups=prvtTMSvcGroups, TSapEgrQueueId=TSapEgrQueueId, prvtSdpStatusChanged=prvtSdpStatusChanged, svcLastStatusChange=svcLastStatusChange, prvtTMCustConformance=prvtTMCustConformance, prvtTMSapConformance=prvtTMSapConformance, svcNumSaps=svcNumSaps, custMultSvcSiteName=custMultSvcSiteName, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMServConformance=prvtTMServConformance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosSchedName=sapIngQosSchedName, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpBindVlanTag=sdpBindVlanTag, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtSapDeleted=prvtSapDeleted, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpOutInterface=sdpOutInterface, prvtSvcCreated=prvtSvcCreated, ServObjName=ServObjName, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosSchedName=sapEgrQosSchedName, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custPhone=custPhone, sdpAdminIsBackup=sdpAdminIsBackup, prvtSdpTraps=prvtSdpTraps, sapBaseInfoEntry=sapBaseInfoEntry, sapEncapValue=sapEncapValue, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, custRowStatus=custRowStatus, sdpDelivery=sdpDelivery, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpLabelSignaling=sdpLabelSignaling, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtSvcDeleted=prvtSvcDeleted, prvtServNotifications=prvtServNotifications, custInfoTable=custInfoTable, sapLearnMode=sapLearnMode, sdpMtu=sdpMtu, sapPortId=sapPortId, sdpGroupIdentifier=sdpGroupIdentifier, ServObjDesc=ServObjDesc, TMEncapVal=TMEncapVal, prvtCustDeleted=prvtCustDeleted, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSapGroups=prvtTMSapGroups, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custNumEntries=custNumEntries, custIngQosSchedName=custIngQosSchedName, prvtSapNotif=prvtSapNotif, sdpLdpEnabled=sdpLdpEnabled, svcEnableSecureSaps=svcEnableSecureSaps, prvtSdpDeleted=prvtSdpDeleted, prvtTMServObjs=prvtTMServObjs, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpOperFlags=sdpOperFlags, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustCreated=prvtCustCreated, sdpOperIsBackup=sdpOperIsBackup, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSdpGroups=prvtTMSdpGroups, sdpVCType=sdpVCType, prvtTMSapCompliance=prvtTMSapCompliance, sapIngressQosPolicyId=sapIngressQosPolicyId, sapType=sapType, sdpLastStatusChange=sdpLastStatusChange, prvtTMCustGroups=prvtTMCustGroups, svcLastMgmtChange=svcLastMgmtChange, prvtTMSdpConformance=prvtTMSdpConformance, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, SdpIdType=SdpIdType, sapLastMgmtChange=sapLastMgmtChange, svcVplsMode=svcVplsMode, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcDescription=svcDescription, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSvcNotif=prvtSvcNotif, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custEgrQosSchedName=custEgrQosSchedName, sapOperFlags=sapOperFlags, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custName=custName, svcRevertTimer=svcRevertTimer, svcOperStatus=svcOperStatus, prvtTMSvcConformance=prvtTMSvcConformance, ServType=ServType, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapDescription=sapDescription, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosQueueId=sapIngQosQueueId, sapIngQosCustName=sapIngQosCustName, svcVpnId=svcVpnId, sdpId=sdpId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpAdminStatus=sdpAdminStatus, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosCustName=sapEgrQosCustName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID)
