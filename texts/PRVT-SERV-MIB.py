...
TSapEgressPolicyIdOrNone, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TNamedItem, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TNamedItem", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapAdminStatus=sapAdminStatus, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapCompliances=prvtTMSapCompliances, sdpOperFlags=sdpOperFlags, custMultSvcSiteName=custMultSvcSiteName, custLastMgmtChange=custLastMgmtChange, PYSNMP_MODULE_ID=prvtServicesMIB, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpTransportTunnelName=sdpTransportTunnelName, sapOperFlags=sapOperFlags, prvtTMCustGroups=prvtTMCustGroups, prvtCustDeleted=prvtCustDeleted, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcOperStatus=svcOperStatus, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSdpDeleted=prvtSdpDeleted, prvtTMCustConformance=prvtTMCustConformance, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpOperStatus=sdpOperStatus, prvtServNotifications=prvtServNotifications, sapBaseInfoTable=sapBaseInfoTable, sapEgrQosQueueId=sapEgrQosQueueId, svcId=svcId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, ServObjName=ServObjName, sapDescription=sapDescription, sdpOperIsBackup=sdpOperIsBackup, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcBaseInfoTable=svcBaseInfoTable, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosCustName=sapIngQosCustName, custPhone=custPhone, TSapEgrQueueId=TSapEgrQueueId, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSapCompliance=prvtTMSapCompliance, sdpInfoTable=sdpInfoTable, prvtTMSapObjs=prvtTMSapObjs, sdpAdminStatus=sdpAdminStatus, svcLastMgmtChange=svcLastMgmtChange, prvtSvcCreated=prvtSvcCreated, custEgrQosSchedName=custEgrQosSchedName, prvtTMSapGroups=prvtTMSapGroups, svcNumSaps=svcNumSaps, sapIngQosSchedName=sapIngQosSchedName, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSapNotif=prvtSapNotif, sdpOutInterface=sdpOutInterface, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtSvcDeleted=prvtSvcDeleted, ServObjDesc=ServObjDesc, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtCustTraps=prvtCustTraps, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSapConformance=prvtTMSapConformance, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, VpnId=VpnId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpVCType=sdpVCType, prvtTMSvcObjs=prvtTMSvcObjs, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtServicesMIB=prvtServicesMIB, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSapCreated=prvtSapCreated, sdpMtu=sdpMtu, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcLastStatusChange=svcLastStatusChange, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapLastMgmtChange=sapLastMgmtChange, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSdpNotif=prvtSdpNotif, sdpLastStatusChange=sdpLastStatusChange, prvtSvcTraps=prvtSvcTraps, custIngQosSchedName=custIngQosSchedName, prvtTMSdpGroups=prvtTMSdpGroups, sdpId=sdpId, svcRowStatus=svcRowStatus, custNumEntries=custNumEntries, sapEgrQosCustName=sapEgrQosCustName, prvtSapStatusChanged=prvtSapStatusChanged, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapRowStatus=sapRowStatus, sdpType=sdpType, ServType=ServType, sapNumEntries=sapNumEntries, sapType=sapType, sdpFarEndIpAddress=sdpFarEndIpAddress, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosSchedCustName=sapIngQosSchedCustName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpNextFreeId=sdpNextFreeId, prvtSvcStatusChanged=prvtSvcStatusChanged, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustCompliance=prvtTMCustCompliance, sapIngressQosPolicyId=sapIngressQosPolicyId, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custInfoEntry=custInfoEntry, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMServObjs=prvtTMServObjs, custName=custName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custRowStatus=custRowStatus, sapIngQosQueueId=sapIngQosQueueId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, ServiceAdminStatus=ServiceAdminStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSdpObjs=prvtTMSdpObjs, svcCustName=svcCustName, svcMtu=svcMtu, sapLearnMode=sapLearnMode, sdpRowStatus=sdpRowStatus, prvtSapDeleted=prvtSapDeleted, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, SdpIdType=SdpIdType, svcVpnId=svcVpnId, sdpInfoEntry=sdpInfoEntry, svcType=svcType, sdpLdpEnabled=sdpLdpEnabled, sdpAdminIsBackup=sdpAdminIsBackup, svcAdminStatus=svcAdminStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEncapValue=sapEncapValue, prvtCustCreated=prvtCustCreated, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcDescription=svcDescription, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMServConformance=prvtTMServConformance, prvtTMSdpConformance=prvtTMSdpConformance, TMEncapVal=TMEncapVal, custInfoTable=custInfoTable, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMSdpCompliance=prvtTMSdpCompliance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcRevertTimer=svcRevertTimer, prvtSvcNotif=prvtSvcNotif, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSdpCreated=prvtSdpCreated, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcVplsMode=svcVplsMode, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMCustObjs=prvtTMCustObjs, sapPortId=sapPortId, custContact=custContact, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtSdpTraps=prvtSdpTraps, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapBaseInfoEntry=sapBaseInfoEntry, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpBindVlanTag=sdpBindVlanTag, svcNumEntries=svcNumEntries, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sdpLabelSignaling=sdpLabelSignaling, sdpGroupIdentifier=sdpGroupIdentifier, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, TSapIngQueueId=TSapIngQueueId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpDelivery=sdpDelivery, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtCustNotif=prvtCustNotif, sapEgrQosSchedName=sapEgrQosSchedName, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, ServiceOperStatus=ServiceOperStatus, svcNumSdps=svcNumSdps, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpNumEntries=sdpNumEntries, sdpDescription=sdpDescription, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSapTraps=prvtSapTraps, sapOperStatus=sapOperStatus)
