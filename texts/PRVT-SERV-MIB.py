...
TSapEgressPolicyIdOrNone, TNamedItem, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, serviceAccessSwitch, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNamedItem", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcRowStatus=svcRowStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtSdpCreated=prvtSdpCreated, prvtSdpTraps=prvtSdpTraps, prvtTMServConformance=prvtTMServConformance, prvtSvcTraps=prvtSvcTraps, prvtSapDeleted=prvtSapDeleted, sdpInfoTable=sdpInfoTable, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcLastStatusChange=svcLastStatusChange, sapPortId=sapPortId, sapType=sapType, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpAdminIsBackup=sdpAdminIsBackup, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custMultSvcSiteName=custMultSvcSiteName, prvtServNotifications=prvtServNotifications, svcLastMgmtChange=svcLastMgmtChange, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngQosCustName=sapIngQosCustName, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapConformance=prvtTMSapConformance, svcMtu=svcMtu, sapEgrQosSchedName=sapEgrQosSchedName, prvtSapStatusChanged=prvtSapStatusChanged, VpnId=VpnId, ServiceOperStatus=ServiceOperStatus, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosQueueId=sapEgrQosQueueId, sdpAdminEgressLabel=sdpAdminEgressLabel, ServType=ServType, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSapCompliance=prvtTMSapCompliance, custInfoTable=custInfoTable, sapEgrQosCustName=sapEgrQosCustName, svcAdminStatus=svcAdminStatus, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtSapCreated=prvtSapCreated, prvtSdpNotif=prvtSdpNotif, svcVpnId=svcVpnId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapBaseInfoTable=sapBaseInfoTable, sdpType=sdpType, custEgrQosSchedName=custEgrQosSchedName, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcDescription=svcDescription, prvtTMSapObjs=prvtTMSapObjs, sdpInfoEntry=sdpInfoEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpId=sdpId, sapAdminStatus=sapAdminStatus, prvtSvcCreated=prvtSvcCreated, custInfoEntry=custInfoEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custRowStatus=custRowStatus, sdpLastMgmtChange=sdpLastMgmtChange, sdpNextFreeId=sdpNextFreeId, sapNumEntries=sapNumEntries, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpTransportTunnelName=sdpTransportTunnelName, sapLearnMode=sapLearnMode, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custName=custName, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpAdminStatus=sdpAdminStatus, sdpBindVlanTag=sdpBindVlanTag, prvtSdpDeleted=prvtSdpDeleted, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtServicesMIB=prvtServicesMIB, svcOperStatus=svcOperStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, TSapEgrQueueId=TSapEgrQueueId, custNumEntries=custNumEntries, sdpOperStatus=sdpOperStatus, prvtTMCustObjs=prvtTMCustObjs, prvtTMSdpCompliances=prvtTMSdpCompliances, TMEncapVal=TMEncapVal, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapBaseInfoEntry=sapBaseInfoEntry, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtSapNotif=prvtSapNotif, sapEncapValue=sapEncapValue, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, TSapIngQueueId=TSapIngQueueId, sapDescription=sapDescription, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpVCType=sdpVCType, svcNumSdps=svcNumSdps, SdpIdType=SdpIdType, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSdpConformance=prvtTMSdpConformance, custIngQosAssignmentPortId=custIngQosAssignmentPortId, ServObjName=ServObjName, sdpOperFlags=sdpOperFlags, sdpMtu=sdpMtu, ServiceAdminStatus=ServiceAdminStatus, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, svcVplsMode=svcVplsMode, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSapGroups=prvtTMSapGroups, sdpNumEntries=sdpNumEntries, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtCustCreated=prvtCustCreated, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtCustTraps=prvtCustTraps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custPhone=custPhone, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custIngQosSchedName=custIngQosSchedName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMSvcGroups=prvtTMSvcGroups, sapOperStatus=sapOperStatus, prvtTMCustCompliance=prvtTMCustCompliance, svcRevertTimer=svcRevertTimer, sapIngQosQueueId=sapIngQosQueueId, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpOperIsBackup=sdpOperIsBackup, svcVPLSUplinkTable=svcVPLSUplinkTable, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMSvcConformance=prvtTMSvcConformance, sdpAdminIngressLabel=sdpAdminIngressLabel, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapRowStatus=sapRowStatus, svcNumEntries=svcNumEntries, custLastMgmtChange=custLastMgmtChange, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtSapTraps=prvtSapTraps, prvtCustDeleted=prvtCustDeleted, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcNumSaps=svcNumSaps, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcCustName=svcCustName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSvcCompliances=prvtTMSvcCompliances, svcBaseInfoEntry=svcBaseInfoEntry, svcType=svcType, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpRowStatus=sdpRowStatus, prvtTMCustConformance=prvtTMCustConformance, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custContact=custContact, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpDelivery=sdpDelivery, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtSdpStatusChanged=prvtSdpStatusChanged, ServObjDesc=ServObjDesc, svcId=svcId, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpDescription=sdpDescription, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosSchedName=sapIngQosSchedName, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMServObjs=prvtTMServObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpOutInterface=sdpOutInterface, sdpFarEndIpAddress=sdpFarEndIpAddress, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMSdpGroups=prvtTMSdpGroups, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMTstpConformance=prvtTMTstpConformance, PYSNMP_MODULE_ID=prvtServicesMIB, svcVPLSUplinkPortID=svcVPLSUplinkPortID, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapOperFlags=sapOperFlags, sdpLastStatusChange=sdpLastStatusChange, sdpLabelSignaling=sdpLabelSignaling, sapIngQosSchedCustName=sapIngQosSchedCustName, svcBaseInfoTable=svcBaseInfoTable, prvtSvcDeleted=prvtSvcDeleted)
