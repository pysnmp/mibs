...
serviceAccessSwitch, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", VpnId=VpnId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapConformance=prvtTMSapConformance, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapNumEntries=sapNumEntries, prvtSapStatusChanged=prvtSapStatusChanged, sdpGroupIdentifier=sdpGroupIdentifier, sdpDescription=sdpDescription, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMTstpConformance=prvtTMTstpConformance, sapIngressQosPolicyId=sapIngressQosPolicyId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtSapCreated=prvtSapCreated, prvtTMSapCompliances=prvtTMSapCompliances, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMSapObjs=prvtTMSapObjs, svcVpnId=svcVpnId, sapOperFlags=sapOperFlags, custLastMgmtChange=custLastMgmtChange, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcMtu=svcMtu, prvtTMCustConformance=prvtTMCustConformance, prvtCustCreated=prvtCustCreated, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcAdminStatus=svcAdminStatus, svcCustName=svcCustName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosCustName=sapEgrQosCustName, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sdpDelivery=sdpDelivery, prvtSapNotif=prvtSapNotif, sapDescription=sapDescription, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpRowStatus=sdpRowStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtTMSvcCompliance=prvtTMSvcCompliance, custName=custName, ServiceAdminStatus=ServiceAdminStatus, prvtSdpNotif=prvtSdpNotif, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapLearnMode=sapLearnMode, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpId=sdpId, custContact=custContact, svcNumEntries=svcNumEntries, svcBaseInfoTable=svcBaseInfoTable, sapBaseInfoEntry=sapBaseInfoEntry, sdpOperIsBackup=sdpOperIsBackup, sapAdminStatus=sapAdminStatus, prvtTMCustObjs=prvtTMCustObjs, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosCustName=sapIngQosCustName, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custNumEntries=custNumEntries, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMSapCompliance=prvtTMSapCompliance, sdpMtu=sdpMtu, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpOperFlags=sdpOperFlags, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcNumSaps=svcNumSaps, sdpType=sdpType, sapEncapValue=sapEncapValue, sdpInfoEntry=sdpInfoEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtCustDeleted=prvtCustDeleted, sdpInfoTable=sdpInfoTable, ServiceOperStatus=ServiceOperStatus, prvtTMSvcCompliances=prvtTMSvcCompliances, TMEncapVal=TMEncapVal, svcLastMgmtChange=svcLastMgmtChange, prvtSdpCreated=prvtSdpCreated, svcLastStatusChange=svcLastStatusChange, svcRevertTimer=svcRevertTimer, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, TSapIngQueueId=TSapIngQueueId, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcRowStatus=svcRowStatus, prvtSvcTraps=prvtSvcTraps, prvtTMSdpGroups=prvtTMSdpGroups, prvtSdpTraps=prvtSdpTraps, sdpLastStatusChange=sdpLastStatusChange, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpNextFreeId=sdpNextFreeId, prvtSvcNotif=prvtSvcNotif, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMServObjs=prvtTMServObjs, ServObjDesc=ServObjDesc, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, SdpIdType=SdpIdType, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcDescription=svcDescription, svcNumSdps=svcNumSdps, prvtSapDeleted=prvtSapDeleted, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, ServObjName=ServObjName, sdpAdminIsBackup=sdpAdminIsBackup, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custRowStatus=custRowStatus, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sdpLastMgmtChange=sdpLastMgmtChange, custMultSvcSiteName=custMultSvcSiteName, sdpAdminEgressLabel=sdpAdminEgressLabel, sapEgressQosPolicyId=sapEgressQosPolicyId, svcId=svcId, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSdpDeleted=prvtSdpDeleted, custPhone=custPhone, sapLastMgmtChange=sapLastMgmtChange, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, custEgrQosSchedName=custEgrQosSchedName, svcType=svcType, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapPortId=sapPortId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtSvcCreated=prvtSvcCreated, sdpNumEntries=sdpNumEntries, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMServConformance=prvtTMServConformance, prvtSapTraps=prvtSapTraps, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtSdpStatusChanged=prvtSdpStatusChanged, sapType=sapType, prvtServNotifications=prvtServNotifications, prvtTMCustGroups=prvtTMCustGroups, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapRowStatus=sapRowStatus, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custInfoEntry=custInfoEntry, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSapGroups=prvtTMSapGroups, prvtSvcDeleted=prvtSvcDeleted, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcOperStatus=svcOperStatus, svcEnableSecureSaps=svcEnableSecureSaps, sdpOperStatus=sdpOperStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtServicesMIB=prvtServicesMIB, sapBaseInfoTable=sapBaseInfoTable, prvtTMSdpObjs=prvtTMSdpObjs, svcBaseInfoEntry=svcBaseInfoEntry, prvtCustNotif=prvtCustNotif, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMSdpCompliance=prvtTMSdpCompliance, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSvcObjs=prvtTMSvcObjs, prvtCustTraps=prvtCustTraps, sdpVCType=sdpVCType, sdpBindVlanTag=sdpBindVlanTag, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngQosSchedName=sapIngQosSchedName, prvtTMSdpConformance=prvtTMSdpConformance, ServType=ServType, custInfoTable=custInfoTable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpOutInterface=sdpOutInterface, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVplsMode=svcVplsMode, sdpLabelSignaling=sdpLabelSignaling, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, PYSNMP_MODULE_ID=prvtServicesMIB, custIngQosSchedName=custIngQosSchedName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpAdminStatus=sdpAdminStatus, sapOperStatus=sapOperStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpLdpEnabled=sdpLdpEnabled, sapIngQosQueueId=sapIngQosQueueId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry)
