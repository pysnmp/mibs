...
serviceAccessSwitch, TNetworkPolicyIdOrNone, TNamedItem, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNetworkPolicyIdOrNone", "TNamedItem", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcMtu=svcMtu, sdpInfoEntry=sdpInfoEntry, svcLastStatusChange=svcLastStatusChange, custInfoTable=custInfoTable, prvtSdpStatusChanged=prvtSdpStatusChanged, sapDescription=sapDescription, custRowStatus=custRowStatus, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapEgressQosPolicyId=sapEgressQosPolicyId, custIngQosSchedName=custIngQosSchedName, prvtSvcCreated=prvtSvcCreated, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustCreated=prvtCustCreated, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcBaseInfoEntry=svcBaseInfoEntry, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcEnableSecureSaps=svcEnableSecureSaps, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpDelivery=sdpDelivery, prvtTMSvcObjs=prvtTMSvcObjs, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMSdpConformance=prvtTMSdpConformance, svcNumSdps=svcNumSdps, sdpDescription=sdpDescription, prvtSvcTraps=prvtSvcTraps, svcVpnId=svcVpnId, prvtTMSdpCompliance=prvtTMSdpCompliance, custName=custName, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpLabelSignaling=sdpLabelSignaling, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custEgrQosSchedName=custEgrQosSchedName, TSapIngQueueId=TSapIngQueueId, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapNumEntries=sapNumEntries, ServiceOperStatus=ServiceOperStatus, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustObjs=prvtTMCustObjs, prvtTMSapObjs=prvtTMSapObjs, prvtTMTstpConformance=prvtTMTstpConformance, sapRowStatus=sapRowStatus, sdpType=sdpType, prvtServNotifications=prvtServNotifications, prvtCustDeleted=prvtCustDeleted, sapIngQosSchedName=sapIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, prvtSvcStatusChanged=prvtSvcStatusChanged, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpInfoTable=sdpInfoTable, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custNumEntries=custNumEntries, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtSapCreated=prvtSapCreated, sdpAdminStatus=sdpAdminStatus, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkTable=svcVPLSUplinkTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMSvcGroups=prvtTMSvcGroups, sapIngQosQueueId=sapIngQosQueueId, prvtSapTraps=prvtSapTraps, custInfoEntry=custInfoEntry, prvtSvcDeleted=prvtSvcDeleted, sdpAdminIsBackup=sdpAdminIsBackup, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMServObjs=prvtTMServObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpNumEntries=sdpNumEntries, sdpLastStatusChange=sdpLastStatusChange, sapAdminStatus=sapAdminStatus, sdpLdpEnabled=sdpLdpEnabled, sapIngQosCustName=sapIngQosCustName, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custLastMgmtChange=custLastMgmtChange, sapEgrQosSchedCustName=sapEgrQosSchedCustName, svcLastMgmtChange=svcLastMgmtChange, prvtSapNotif=prvtSapNotif, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, prvtTMServConformance=prvtTMServConformance, prvtSdpDeleted=prvtSdpDeleted, svcCustName=svcCustName, sapLearnMode=sapLearnMode, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcType=svcType, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpLastMgmtChange=sdpLastMgmtChange, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSdpNotif=prvtSdpNotif, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custMultiServiceSiteTable=custMultiServiceSiteTable, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcRevertTimer=svcRevertTimer, svcDescription=svcDescription, prvtTMSdpObjs=prvtTMSdpObjs, sdpMtu=sdpMtu, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapIngQosSchedCustName=sapIngQosSchedCustName, custContact=custContact, custPhone=custPhone, prvtCustNotif=prvtCustNotif, SdpIdType=SdpIdType, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, TSapEgrQueueId=TSapEgrQueueId, ServObjDesc=ServObjDesc, ServiceAdminStatus=ServiceAdminStatus, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcNumSaps=svcNumSaps, sdpFarEndIpAddress=sdpFarEndIpAddress, svcBaseInfoTable=svcBaseInfoTable, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpOutInterface=sdpOutInterface, svcNumEntries=svcNumEntries, PYSNMP_MODULE_ID=prvtServicesMIB, sdpNextFreeId=sdpNextFreeId, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, ServType=ServType, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, ServObjName=ServObjName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtSdpTraps=prvtSdpTraps, sdpRowStatus=sdpRowStatus, sdpOperFlags=sdpOperFlags, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgrQosSchedName=sapEgrQosSchedName, sapEgrQosCustName=sapEgrQosCustName, prvtSvcNotif=prvtSvcNotif, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapLastMgmtChange=sapLastMgmtChange, prvtServicesMIB=prvtServicesMIB, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sdpId=sdpId, prvtTMCustCompliances=prvtTMCustCompliances, svcRowStatus=svcRowStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, VpnId=VpnId, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpOperStatus=sdpOperStatus, sapOperFlags=sapOperFlags, sapBaseInfoEntry=sapBaseInfoEntry, sdpBindVlanTag=sdpBindVlanTag, prvtTMSapGroups=prvtTMSapGroups, svcAdminStatus=svcAdminStatus, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtCustTraps=prvtCustTraps, custMultSvcSiteName=custMultSvcSiteName, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEncapValue=sapEncapValue, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapCompliances=prvtTMSapCompliances, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMCustConformance=prvtTMCustConformance, prvtTMSapConformance=prvtTMSapConformance, sdpVCType=sdpVCType, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapPortId=sapPortId, sapBaseInfoTable=sapBaseInfoTable, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpTransportTunnelName=sdpTransportTunnelName, sapType=sapType, sapOperStatus=sapOperStatus, sapEgrQosQueueId=sapEgrQosQueueId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcId=svcId, prvtSapDeleted=prvtSapDeleted, prvtSdpCreated=prvtSdpCreated, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVplsMode=svcVplsMode, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, TMEncapVal=TMEncapVal, prvtTMCustGroups=prvtTMCustGroups, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange)
