...
TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtCustCreated=prvtCustCreated, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpAdminStatus=sdpAdminStatus, custNumEntries=custNumEntries, custMultiServiceSiteTable=custMultiServiceSiteTable, svcLastStatusChange=svcLastStatusChange, sdpLabelSignaling=sdpLabelSignaling, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, ServiceAdminStatus=ServiceAdminStatus, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtTMSvcConformance=prvtTMSvcConformance, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custName=custName, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpLdpEnabled=sdpLdpEnabled, custInfoTable=custInfoTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpGroupIdentifier=sdpGroupIdentifier, svcCustName=svcCustName, prvtTMSdpCompliance=prvtTMSdpCompliance, sdpTransportTunnelName=sdpTransportTunnelName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, ServiceOperStatus=ServiceOperStatus, ServObjDesc=ServObjDesc, sdpInfoEntry=sdpInfoEntry, custMultSvcSiteName=custMultSvcSiteName, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapAdminStatus=sapAdminStatus, prvtSapTraps=prvtSapTraps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSdpConformance=prvtTMSdpConformance, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtSapDeleted=prvtSapDeleted, svcType=svcType, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSdpGroups=prvtTMSdpGroups, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtCustNotif=prvtCustNotif, PYSNMP_MODULE_ID=prvtServicesMIB, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtCustTraps=prvtCustTraps, sdpLastStatusChange=sdpLastStatusChange, custContact=custContact, sdpNumEntries=sdpNumEntries, sdpOperFlags=sdpOperFlags, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSdpObjs=prvtTMSdpObjs, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcEnableSecureSaps=svcEnableSecureSaps, svcLastMgmtChange=svcLastMgmtChange, svcDescription=svcDescription, prvtSdpNotif=prvtSdpNotif, prvtSdpDeleted=prvtSdpDeleted, prvtTMSvcObjs=prvtTMSvcObjs, sapNumEntries=sapNumEntries, sapEgrQosQueueId=sapEgrQosQueueId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapDescription=sapDescription, TSapEgrQueueId=TSapEgrQueueId, sapIngQosSchedName=sapIngQosSchedName, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcOperStatus=svcOperStatus, prvtTMSapConformance=prvtTMSapConformance, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpAdminIsBackup=sdpAdminIsBackup, prvtSapStatusChanged=prvtSapStatusChanged, prvtSdpCreated=prvtSdpCreated, sdpType=sdpType, sapBaseInfoEntry=sapBaseInfoEntry, svcVplsMode=svcVplsMode, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sdpFarEndIpAddress=sdpFarEndIpAddress, svcRowStatus=svcRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpNextFreeId=sdpNextFreeId, sdpLastMgmtChange=sdpLastMgmtChange, sapPortId=sapPortId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSvcGroups=prvtTMSvcGroups, prvtServicesMIB=prvtServicesMIB, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpInfoTable=sdpInfoTable, prvtSapCreated=prvtSapCreated, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcId=svcId, custRowStatus=custRowStatus, custLastMgmtChange=custLastMgmtChange, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtTMCustCompliance=prvtTMCustCompliance, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcNumSdps=svcNumSdps, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, SdpIdType=SdpIdType, ServType=ServType, sapEgrQosCustName=sapEgrQosCustName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSapGroups=prvtTMSapGroups, sdpVCType=sdpVCType, sdpMtu=sdpMtu, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, svcMtu=svcMtu, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSvcCompliances=prvtTMSvcCompliances, sapBaseInfoTable=sapBaseInfoTable, prvtTMSapCompliance=prvtTMSapCompliance, sdpAdminIngressLabel=sdpAdminIngressLabel, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, svcNumEntries=svcNumEntries, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSvcNotif=prvtSvcNotif, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpBindVlanTag=sdpBindVlanTag, sdpOperIsBackup=sdpOperIsBackup, svcNumSaps=svcNumSaps, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapLearnMode=sapLearnMode, prvtTMCustConformance=prvtTMCustConformance, sdpOutInterface=sdpOutInterface, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMCustGroups=prvtTMCustGroups, prvtSvcDeleted=prvtSvcDeleted, prvtTMCustCompliances=prvtTMCustCompliances, sdpOperStatus=sdpOperStatus, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgrQosSchedName=sapEgrQosSchedName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSvcCreated=prvtSvcCreated, custIngQosSchedName=custIngQosSchedName, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcRevertTimer=svcRevertTimer, custPhone=custPhone, sapRowStatus=sapRowStatus, TSapIngQueueId=TSapIngQueueId, prvtSvcTraps=prvtSvcTraps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosSchedCustName=sapIngQosSchedCustName, svcVpnId=svcVpnId, sdpDescription=sdpDescription, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtSdpTraps=prvtSdpTraps, sapIngQosQueueId=sapIngQosQueueId, sapLastMgmtChange=sapLastMgmtChange, sapOperStatus=sapOperStatus, TMEncapVal=TMEncapVal, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, custEgrQosSchedName=custEgrQosSchedName, prvtTMServObjs=prvtTMServObjs, prvtServNotifications=prvtServNotifications, sapOperFlags=sapOperFlags, prvtCustDeleted=prvtCustDeleted, sdpDelivery=sdpDelivery, sapEncapValue=sapEncapValue, prvtSapNotif=prvtSapNotif, sdpId=sdpId, svcAdminStatus=svcAdminStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpRowStatus=sdpRowStatus, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMSapObjs=prvtTMSapObjs, ServObjName=ServObjName, prvtSdpStatusChanged=prvtSdpStatusChanged, VpnId=VpnId, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMServConformance=prvtTMServConformance, sapType=sapType, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosCustName=sapIngQosCustName, prvtTMCustObjs=prvtTMCustObjs, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry)
