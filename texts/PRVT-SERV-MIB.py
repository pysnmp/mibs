...
TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", TMEncapVal=TMEncapVal, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, TSapIngQueueId=TSapIngQueueId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtSvcNotif=prvtSvcNotif, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcAdminStatus=svcAdminStatus, prvtServicesMIB=prvtServicesMIB, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEgrQosSchedName=sapEgrQosSchedName, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtSapCreated=prvtSapCreated, prvtTMCustGroups=prvtTMCustGroups, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpLdpEnabled=sdpLdpEnabled, sdpOperFlags=sdpOperFlags, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSdpCompliance=prvtTMSdpCompliance, TSapEgrQueueId=TSapEgrQueueId, svcLastMgmtChange=svcLastMgmtChange, svcDescription=svcDescription, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSapNotif=prvtSapNotif, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpNumEntries=sdpNumEntries, svcId=svcId, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMCustCompliances=prvtTMCustCompliances, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, ServObjDesc=ServObjDesc, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapBaseInfoTable=sapBaseInfoTable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcRowStatus=svcRowStatus, sapType=sapType, sdpOperIsBackup=sdpOperIsBackup, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custLastMgmtChange=custLastMgmtChange, svcVplsMode=svcVplsMode, sdpInfoTable=sdpInfoTable, sdpAdminIsBackup=sdpAdminIsBackup, ServiceOperStatus=ServiceOperStatus, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSvcDeleted=prvtSvcDeleted, sapLastMgmtChange=sapLastMgmtChange, sdpAdminStatus=sdpAdminStatus, sdpInfoEntry=sdpInfoEntry, prvtTMSvcGroups=prvtTMSvcGroups, custMultSvcSiteName=custMultSvcSiteName, prvtCustDeleted=prvtCustDeleted, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custIngQosSchedName=custIngQosSchedName, sdpFarEndIpAddress=sdpFarEndIpAddress, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sdpLastMgmtChange=sdpLastMgmtChange, sdpLastStatusChange=sdpLastStatusChange, custEgrQosSchedName=custEgrQosSchedName, prvtTMSapCompliances=prvtTMSapCompliances, svcBaseInfoTable=svcBaseInfoTable, sdpId=sdpId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcCustName=svcCustName, sdpRowStatus=sdpRowStatus, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapAdminStatus=sapAdminStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpVCType=sdpVCType, sdpNextFreeId=sdpNextFreeId, custInfoTable=custInfoTable, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtTMSvcConformance=prvtTMSvcConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtTMSapCompliance=prvtTMSapCompliance, svcMtu=svcMtu, sapIngQosSchedName=sapIngQosSchedName, custPhone=custPhone, svcNumSdps=svcNumSdps, sapPortId=sapPortId, sapOperFlags=sapOperFlags, svcNumSaps=svcNumSaps, sapIngQosQueueId=sapIngQosQueueId, custInfoEntry=custInfoEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtSdpNotif=prvtSdpNotif, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, ServiceAdminStatus=ServiceAdminStatus, custRowStatus=custRowStatus, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapBaseInfoEntry=sapBaseInfoEntry, prvtCustNotif=prvtCustNotif, prvtSvcCreated=prvtSvcCreated, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, VpnId=VpnId, prvtTMSapConformance=prvtTMSapConformance, prvtTMSdpConformance=prvtTMSdpConformance, prvtSdpDeleted=prvtSdpDeleted, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpLabelSignaling=sdpLabelSignaling, prvtSdpCreated=prvtSdpCreated, sapEncapValue=sapEncapValue, sapRowStatus=sapRowStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtCustTraps=prvtCustTraps, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, ServObjName=ServObjName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMCustConformance=prvtTMCustConformance, svcType=svcType, sdpOutInterface=sdpOutInterface, sapEgressQosPolicyId=sapEgressQosPolicyId, svcBaseInfoEntry=svcBaseInfoEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sdpDescription=sdpDescription, prvtTMSvcCompliances=prvtTMSvcCompliances, custName=custName, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpOperStatus=sdpOperStatus, sdpMtu=sdpMtu, svcEnableSecureSaps=svcEnableSecureSaps, prvtTMServConformance=prvtTMServConformance, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapGroups=prvtTMSapGroups, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSapObjs=prvtTMSapObjs, sapLearnMode=sapLearnMode, SdpIdType=SdpIdType, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcVpnId=svcVpnId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcRevertTimer=svcRevertTimer, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSdpTraps=prvtSdpTraps, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpDelivery=sdpDelivery, sdpType=sdpType, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcNumEntries=svcNumEntries, sapEgrQosCustName=sapEgrQosCustName, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtCustCreated=prvtCustCreated, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMCustObjs=prvtTMCustObjs, prvtTMSdpObjs=prvtTMSdpObjs, custContact=custContact, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpTransportTunnelName=sdpTransportTunnelName, prvtTMTstpConformance=prvtTMTstpConformance, prvtSvcTraps=prvtSvcTraps, svcOperStatus=svcOperStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMSvcObjs=prvtTMSvcObjs, prvtSapTraps=prvtSapTraps, sapDescription=sapDescription, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapNumEntries=sapNumEntries, sapOperStatus=sapOperStatus, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapEgrQosQueueId=sapEgrQosQueueId, prvtSapDeleted=prvtSapDeleted, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSdpCompliances=prvtTMSdpCompliances, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, ServType=ServType, prvtTMCustCompliance=prvtTMCustCompliance, svcLastStatusChange=svcLastStatusChange, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMServObjs=prvtTMServObjs, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpBindVlanTag=sdpBindVlanTag, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, custNumEntries=custNumEntries, prvtServNotifications=prvtServNotifications)
