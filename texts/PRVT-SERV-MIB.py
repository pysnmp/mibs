...
TruthValue, TimeStamp, TextualConvention, RowStatus, DisplayString, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "MacAddress")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpBindVlanTag=sdpBindVlanTag, sapTable=sapTable, customerCreated=customerCreated, sdpAdminEgressLabel=sdpAdminEgressLabel, sapLearnEnable=sapLearnEnable, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, serviceMtu=serviceMtu, serviceEnableSecureSaps=serviceEnableSecureSaps, sdpPwRedundancyEnable=sdpPwRedundancyEnable, customerDeleted=customerDeleted, sapRowStatus=sapRowStatus, sdpLabelSignaling=sdpLabelSignaling, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, prvtServicesMIBObjects=prvtServicesMIBObjects, sdpOperFlags=sdpOperFlags, serviceNumSdps=serviceNumSdps, sdpPwActivate=sdpPwActivate, serviceNumSaps=serviceNumSaps, customerName=customerName, sapLearnMode=sapLearnMode, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpId=sdpId, sdpType=sdpType, customerPhone=customerPhone, sapOperFlags=sapOperFlags, serviceType=serviceType, sapDeleted=sapDeleted, customerTable=customerTable, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, serviceVpnId=serviceVpnId, sapPortId=sapPortId, sapType=sapType, sdpPwPrecedence=sdpPwPrecedence, PYSNMP_MODULE_ID=prvtServicesMIB, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceMacAddressSapTable=serviceMacAddressSapTable, sapDescription=sapDescription, sdpLearnEnable=sdpLearnEnable, serviceVlanEtherType=serviceVlanEtherType, sapEntry=sapEntry, sapAdminStatus=sapAdminStatus, serviceVlanAction=serviceVlanAction, customerRowStatus=customerRowStatus, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpTable=sdpTable, sdpNextFreeId=sdpNextFreeId, serviceDescription=serviceDescription, serviceMacAddressSdpId=serviceMacAddressSdpId, sdpOutInterface=sdpOutInterface, sdpVCType=sdpVCType, sapCreated=sapCreated, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, sdpGroupIdentifier=sdpGroupIdentifier, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sdpDeleted=sdpDeleted, sdpRowStatus=sdpRowStatus, sdpDelivery=sdpDelivery, serviceCreated=serviceCreated, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpTransportTunnelName=sdpTransportTunnelName, serviceMacAddressSapPortId=serviceMacAddressSapPortId, sdpEntry=sdpEntry, serviceMacAddressSdpTable=serviceMacAddressSdpTable, customerEntry=customerEntry, serviceCustName=serviceCustName, sdpOperStatus=sdpOperStatus, sdpCreated=sdpCreated, prvtServicesMIB=prvtServicesMIB, serviceOperStatus=serviceOperStatus, customerContact=customerContact, serviceLastMgmtChange=serviceLastMgmtChange, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sdpLdpEnabled=sdpLdpEnabled, serviceRowStatus=serviceRowStatus, serviceRevertTimer=serviceRevertTimer, sdpSecuredEnable=sdpSecuredEnable, sapProfileName=sapProfileName, sapEncapValue=sapEncapValue, sdpLastMgmtChange=sdpLastMgmtChange, serviceEntry=serviceEntry, sapLastMgmtChange=sapLastMgmtChange, sapMacLearningProfileState=sapMacLearningProfileState, sapUntaggedMode=sapUntaggedMode, sapCurrentMacCount=sapCurrentMacCount, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, sdpMtu=sdpMtu, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, serviceTable=serviceTable, serviceDeleted=serviceDeleted, sdpDescription=sdpDescription, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, serviceAdminStatus=serviceAdminStatus, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, sdpSignalPwStatus=sdpSignalPwStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpAdminStatus=sdpAdminStatus, serviceId=serviceId, sapOperStatus=sapOperStatus, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, sapIngressQosPolicyId=sapIngressQosPolicyId)
