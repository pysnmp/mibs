...
MacAddress, TextualConvention, RowStatus, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", PYSNMP_MODULE_ID=prvtServicesMIB, sdpLastMgmtChange=sdpLastMgmtChange, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpAdminEgressLabel=sdpAdminEgressLabel, serviceAdminStatus=serviceAdminStatus, sdpBindVlanTag=sdpBindVlanTag, serviceMacAddressSapPriority=serviceMacAddressSapPriority, sdpRowStatus=sdpRowStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, serviceId=serviceId, sdpCreated=sdpCreated, serviceDescription=serviceDescription, sapLastMgmtChange=sapLastMgmtChange, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpPwActivate=sdpPwActivate, serviceMacAddressSdpEntry=serviceMacAddressSdpEntry, sdpOperFlags=sdpOperFlags, sdpDeleted=sdpDeleted, serviceBackupVlanEtherType=serviceBackupVlanEtherType, sapProfileName=sapProfileName, sapDeleted=sapDeleted, serviceDeleted=serviceDeleted, serviceMacAddressSdpMacAddress=serviceMacAddressSdpMacAddress, sdpOutInterface=sdpOutInterface, prvtServicesMIBNotifications=prvtServicesMIBNotifications, sdpEntry=sdpEntry, sapOperStatus=sapOperStatus, serviceCustName=serviceCustName, sapEntry=sapEntry, sdpDynamicVcEgressLabel=sdpDynamicVcEgressLabel, sdpDynamicVcIngressLabel=sdpDynamicVcIngressLabel, serviceMacAddressSapPortId=serviceMacAddressSapPortId, servicePwRedundOperModeMesh=servicePwRedundOperModeMesh, serviceType=serviceType, sapCurrentMacCount=sapCurrentMacCount, sapPortId=sapPortId, sapType=sapType, sdpSecuredEnable=sdpSecuredEnable, sapCustMultSvcSiteName=sapCustMultSvcSiteName, customerContact=customerContact, sdpAdminStatus=sdpAdminStatus, serviceRevertTimer=serviceRevertTimer, sapRowStatus=sapRowStatus, sapLearnEnable=sapLearnEnable, sdpNextFreeId=sdpNextFreeId, serviceMacAddressSapTable=serviceMacAddressSapTable, serviceMacAddressSdpId=serviceMacAddressSdpId, prvtSapEventPropagationProfile=prvtSapEventPropagationProfile, sdpMtu=sdpMtu, serviceCreated=serviceCreated, sdpGroupIdentifier=sdpGroupIdentifier, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, serviceMacAddressSdpRowStatus=serviceMacAddressSdpRowStatus, sapAdminStatus=sapAdminStatus, customerDeleted=customerDeleted, sdpType=sdpType, serviceNumSdps=serviceNumSdps, sapDescription=sapDescription, prvtServicesMIB=prvtServicesMIB, customerTable=customerTable, sapUntaggedMode=sapUntaggedMode, serviceMacAddressSapEntry=serviceMacAddressSapEntry, sapCreated=sapCreated, sdpFarEndIpAddress=sdpFarEndIpAddress, customerCreated=customerCreated, serviceMacAddressSapServiceId=serviceMacAddressSapServiceId, customerRowStatus=customerRowStatus, customerPhone=customerPhone, sapMacLearningProfileState=sapMacLearningProfileState, serviceMacAddressSapMacAddress=serviceMacAddressSapMacAddress, serviceMacAddressSapRowStatus=serviceMacAddressSapRowStatus, serviceEnableSecureSaps=serviceEnableSecureSaps, serviceRowStatus=serviceRowStatus, serviceVpnId=serviceVpnId, sdpTransportTunnelName=sdpTransportTunnelName, customerName=customerName, sdpDescription=sdpDescription, sapTable=sapTable, sapOperFlags=sapOperFlags, serviceTable=serviceTable, serviceMacAddressSdpTable=serviceMacAddressSdpTable, customerEntry=customerEntry, serviceVlanEtherType=serviceVlanEtherType, prvtServicesMIBObjects=prvtServicesMIBObjects, sdpId=sdpId, serviceEntry=serviceEntry, sdpDelivery=sdpDelivery, sdpPwPrecedence=sdpPwPrecedence, sdpLdpEnabled=sdpLdpEnabled, sdpSignalPwStatus=sdpSignalPwStatus, sdpTable=sdpTable, sdpLearnEnable=sdpLearnEnable, serviceMtu=serviceMtu, sapLearnMode=sapLearnMode, servicePwRedundOperModeSpoke=servicePwRedundOperModeSpoke, serviceMacAddressSapEncapValue=serviceMacAddressSapEncapValue, serviceNumSaps=serviceNumSaps, serviceLastMgmtChange=serviceLastMgmtChange, sapEncapValue=sapEncapValue, sdpLabelSignaling=sdpLabelSignaling, sdpPwRedundancyEnable=sdpPwRedundancyEnable, serviceMacAddressSdpPriority=serviceMacAddressSdpPriority, serviceOperStatus=serviceOperStatus, prvtTlsSapEventPropagationProfile=prvtTlsSapEventPropagationProfile, sdpOperStatus=sdpOperStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, serviceVlanAction=serviceVlanAction, serviceMacAddressSdpServiceId=serviceMacAddressSdpServiceId, sdpVCType=sdpVCType)
