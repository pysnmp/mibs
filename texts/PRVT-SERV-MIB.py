...
TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sdpAdminStatus=sdpAdminStatus, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcVPLSUplinkTable=svcVPLSUplinkTable, sapIngQosCustName=sapIngQosCustName, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMSdpConformance=prvtTMSdpConformance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSdpNotif=prvtSdpNotif, svcBaseInfoEntry=svcBaseInfoEntry, sapType=sapType, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpDelivery=sdpDelivery, sdpDescription=sdpDescription, prvtTMSapGroups=prvtTMSapGroups, prvtServNotifications=prvtServNotifications, svcEnableSecureSaps=svcEnableSecureSaps, sapOperFlags=sapOperFlags, sdpAdminIsBackup=sdpAdminIsBackup, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, sapBaseInfoEntry=sapBaseInfoEntry, sapLastMgmtChange=sapLastMgmtChange, prvtTMSdpCompliance=prvtTMSdpCompliance, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtSvcNotif=prvtSvcNotif, svcNumSaps=svcNumSaps, prvtSapTraps=prvtSapTraps, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapNumEntries=sapNumEntries, prvtTMSapCompliance=prvtTMSapCompliance, svcCustName=svcCustName, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, TSapIngQueueId=TSapIngQueueId, svcLastStatusChange=svcLastStatusChange, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custInfoTable=custInfoTable, ServType=ServType, svcOperStatus=svcOperStatus, PYSNMP_MODULE_ID=prvtServicesMIB, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtCustCreated=prvtCustCreated, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMTstpConformance=prvtTMTstpConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtTMServConformance=prvtTMServConformance, sdpVCType=sdpVCType, svcVpnId=svcVpnId, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMCustConformance=prvtTMCustConformance, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtSapDeleted=prvtSapDeleted, ServiceAdminStatus=ServiceAdminStatus, sapOperStatus=sapOperStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, ServObjName=ServObjName, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSdpGroups=prvtTMSdpGroups, custInfoEntry=custInfoEntry, prvtTMSvcConformance=prvtTMSvcConformance, ServiceOperStatus=ServiceOperStatus, svcDescription=svcDescription, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custNumEntries=custNumEntries, prvtSapCreated=prvtSapCreated, sdpOperStatus=sdpOperStatus, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, TMEncapVal=TMEncapVal, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcMtu=svcMtu, custContact=custContact, prvtTMSvcObjs=prvtTMSvcObjs, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpId=sdpId, sdpLabelSignaling=sdpLabelSignaling, sdpTransportTunnelName=sdpTransportTunnelName, sapRowStatus=sapRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, custMultSvcSiteDescription=custMultSvcSiteDescription, svcRevertTimer=svcRevertTimer, ServObjDesc=ServObjDesc, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMCustGroups=prvtTMCustGroups, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sdpNextFreeId=sdpNextFreeId, custMultSvcSiteName=custMultSvcSiteName, sdpAdminIngressLabel=sdpAdminIngressLabel, custRowStatus=custRowStatus, sdpInfoTable=sdpInfoTable, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcAdminStatus=svcAdminStatus, svcRowStatus=svcRowStatus, SdpIdType=SdpIdType, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtSdpCreated=prvtSdpCreated, sdpLastStatusChange=sdpLastStatusChange, prvtSvcDeleted=prvtSvcDeleted, sapDescription=sapDescription, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpType=sdpType, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSvcGroups=prvtTMSvcGroups, sdpOutInterface=sdpOutInterface, custLastMgmtChange=custLastMgmtChange, svcVplsMode=svcVplsMode, sapAdminStatus=sapAdminStatus, prvtSdpTraps=prvtSdpTraps, prvtTMSapCompliances=prvtTMSapCompliances, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpInfoEntry=sdpInfoEntry, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpRowStatus=sdpRowStatus, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosQueueId=sapIngQosQueueId, prvtTMCustCompliance=prvtTMCustCompliance, prvtServicesMIB=prvtServicesMIB, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcLastMgmtChange=svcLastMgmtChange, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtSapNotif=prvtSapNotif, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcType=svcType, sapBaseInfoTable=sapBaseInfoTable, sdpLdpEnabled=sdpLdpEnabled, prvtTMServObjs=prvtTMServObjs, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMCustObjs=prvtTMCustObjs, sapPortId=sapPortId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, custEgrQosSchedName=custEgrQosSchedName, sapIngQosSchedName=sapIngQosSchedName, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSdpDeleted=prvtSdpDeleted, svcId=svcId, prvtTMCustCompliances=prvtTMCustCompliances, svcBaseInfoTable=svcBaseInfoTable, custIngQosSchedName=custIngQosSchedName, svcNumSdps=svcNumSdps, sapEncapValue=sapEncapValue, sdpBindVlanTag=sdpBindVlanTag, sapLearnMode=sapLearnMode, custPhone=custPhone, prvtSvcCreated=prvtSvcCreated, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSapObjs=prvtTMSapObjs, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSapStatusChanged=prvtSapStatusChanged, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, VpnId=VpnId, sdpNumEntries=sdpNumEntries, sdpOperFlags=sdpOperFlags, sapEgressQosPolicyId=sapEgressQosPolicyId, custName=custName, svcNumEntries=svcNumEntries, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpLastMgmtChange=sdpLastMgmtChange, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSapConformance=prvtTMSapConformance, TSapEgrQueueId=TSapEgrQueueId, prvtCustNotif=prvtCustNotif, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sdpMtu=sdpMtu, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSdpCompliances=prvtTMSdpCompliances, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosCustName=sapEgrQosCustName, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custIngQosPortIdSchedName=custIngQosPortIdSchedName)
