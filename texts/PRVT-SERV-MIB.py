...
TSapEgressPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TNamedItemOrEmpty, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TNamedItemOrEmpty", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapPortId=sapPortId, prvtSapStatusChanged=prvtSapStatusChanged, prvtSapDeleted=prvtSapDeleted, prvtSdpCreated=prvtSdpCreated, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, TSapEgrQueueId=TSapEgrQueueId, svcMtu=svcMtu, sapOperFlags=sapOperFlags, ServiceOperStatus=ServiceOperStatus, sapRowStatus=sapRowStatus, prvtTMServObjs=prvtTMServObjs, ServType=ServType, prvtTMCustGroups=prvtTMCustGroups, svcId=svcId, svcVPLSUplinkTable=svcVPLSUplinkTable, svcBaseInfoTable=svcBaseInfoTable, svcAdminStatus=svcAdminStatus, sapLearnMode=sapLearnMode, sdpNextFreeId=sdpNextFreeId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpBindVlanTag=sdpBindVlanTag, sdpDelivery=sdpDelivery, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, SdpIdType=SdpIdType, prvtSdpNotif=prvtSdpNotif, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtSdpTraps=prvtSdpTraps, prvtTMSapGroups=prvtTMSapGroups, sdpType=sdpType, sapEgrQosCustName=sapEgrQosCustName, sapNumEntries=sapNumEntries, sapEncapValue=sapEncapValue, sapOperStatus=sapOperStatus, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, svcOperStatus=svcOperStatus, prvtTMTstpConformance=prvtTMTstpConformance, custMultSvcSiteDescription=custMultSvcSiteDescription, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, svcCustName=svcCustName, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custRowStatus=custRowStatus, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMCustObjs=prvtTMCustObjs, prvtTMSvcObjs=prvtTMSvcObjs, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtSvcNotif=prvtSvcNotif, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSapConformance=prvtTMSapConformance, prvtTMServConformance=prvtTMServConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSapTraps=prvtSapTraps, sdpVCType=sdpVCType, svcType=svcType, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, svcVPLSUplinkPortID=svcVPLSUplinkPortID, VpnId=VpnId, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosSchedName=sapEgrQosSchedName, TSapIngQueueId=TSapIngQueueId, sapType=sapType, sdpInfoEntry=sdpInfoEntry, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, svcVpnId=svcVpnId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMCustConformance=prvtTMCustConformance, custContact=custContact, sapIngQosSchedName=sapIngQosSchedName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, svcRevertTimer=svcRevertTimer, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapCustMultSvcSiteName=sapCustMultSvcSiteName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcLastStatusChange=svcLastStatusChange, sapBaseInfoTable=sapBaseInfoTable, prvtTMCustCompliance=prvtTMCustCompliance, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custPhone=custPhone, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpDescription=sdpDescription, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpNumEntries=sdpNumEntries, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSdpGroups=prvtTMSdpGroups, svcNumEntries=svcNumEntries, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtCustCreated=prvtCustCreated, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcNumSaps=svcNumSaps, prvtSvcCreated=prvtSvcCreated, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcVplsMode=svcVplsMode, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, ServObjName=ServObjName, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpAdminIsBackup=sdpAdminIsBackup, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, prvtTMSapObjs=prvtTMSapObjs, sapBaseInfoEntry=sapBaseInfoEntry, sapAdminStatus=sapAdminStatus, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpLastStatusChange=sdpLastStatusChange, prvtTMSapCompliances=prvtTMSapCompliances, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpInfoTable=sdpInfoTable, custNumEntries=custNumEntries, custInfoTable=custInfoTable, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpLastMgmtChange=sdpLastMgmtChange, prvtServNotifications=prvtServNotifications, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custMultSvcSiteName=custMultSvcSiteName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, custInfoEntry=custInfoEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgrQosQueueId=sapEgrQosQueueId, sdpOperStatus=sdpOperStatus, prvtTMSvcGroups=prvtTMSvcGroups, sdpOutInterface=sdpOutInterface, sdpOperFlags=sdpOperFlags, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, TMEncapVal=TMEncapVal, custMultiServiceSiteTable=custMultiServiceSiteTable, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSdpConformance=prvtTMSdpConformance, sdpTransportTunnelName=sdpTransportTunnelName, custName=custName, svcEnableSecureSaps=svcEnableSecureSaps, sdpId=sdpId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpFarEndIpAddress=sdpFarEndIpAddress, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcLastMgmtChange=svcLastMgmtChange, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcBaseInfoEntry=svcBaseInfoEntry, custEgrQosSchedName=custEgrQosSchedName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosSchedCustName=sapIngQosSchedCustName, custLastMgmtChange=custLastMgmtChange, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpAdminStatus=sdpAdminStatus, prvtTMSapCompliance=prvtTMSapCompliance, svcNumSdps=svcNumSdps, prvtSdpDeleted=prvtSdpDeleted, custIngQosSchedName=custIngQosSchedName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcRowStatus=svcRowStatus, sdpLdpEnabled=sdpLdpEnabled, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueId=sapIngQosQueueId, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtCustNotif=prvtCustNotif, svcDescription=svcDescription, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, ServiceAdminStatus=ServiceAdminStatus, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtCustDeleted=prvtCustDeleted, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtServicesMIB=prvtServicesMIB, prvtSapNotif=prvtSapNotif, prvtTMCustCompliances=prvtTMCustCompliances, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMSdpObjs=prvtTMSdpObjs, sapDescription=sapDescription, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpLabelSignaling=sdpLabelSignaling, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSapCreated=prvtSapCreated, ServObjDesc=ServObjDesc, sdpOperIsBackup=sdpOperIsBackup, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpMtu=sdpMtu, sapIngQosCustName=sapIngQosCustName, sapLastMgmtChange=sapLastMgmtChange, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpRowStatus=sdpRowStatus, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry)
