...
serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcBaseInfoEntry=svcBaseInfoEntry, sapBaseInfoTable=sapBaseInfoTable, prvtSapNotif=prvtSapNotif, sapOperFlags=sapOperFlags, svcNumSaps=svcNumSaps, prvtTMSapConformance=prvtTMSapConformance, svcNumSdps=svcNumSdps, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpInfoTable=sdpInfoTable, sdpAdminIsBackup=sdpAdminIsBackup, sdpMtu=sdpMtu, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMSvcCompliance=prvtTMSvcCompliance, custNumEntries=custNumEntries, svcBaseInfoTable=svcBaseInfoTable, prvtCustNotif=prvtCustNotif, sapDescription=sapDescription, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custLastMgmtChange=custLastMgmtChange, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, TSapEgrQueueId=TSapEgrQueueId, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtServicesMIB=prvtServicesMIB, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcAdminStatus=svcAdminStatus, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, svcOperStatus=svcOperStatus, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custMultiServiceSiteTable=custMultiServiceSiteTable, svcId=svcId, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustGroups=prvtTMCustGroups, prvtTMSapGroups=prvtTMSapGroups, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcLastStatusChange=svcLastStatusChange, sdpNumEntries=sdpNumEntries, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcObjs=prvtTMSvcObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtCustDeleted=prvtCustDeleted, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtSdpTraps=prvtSdpTraps, prvtTMSvcConformance=prvtTMSvcConformance, ServType=ServType, svcCustName=svcCustName, prvtSvcStatusChanged=prvtSvcStatusChanged, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosCustName=sapIngQosCustName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtSdpDeleted=prvtSdpDeleted, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapPortId=sapPortId, sapIngQosQueueId=sapIngQosQueueId, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sapEgressQosPolicyId=sapEgressQosPolicyId, sdpInfoEntry=sdpInfoEntry, prvtTMSdpGroups=prvtTMSdpGroups, SdpIdType=SdpIdType, sdpRowStatus=sdpRowStatus, sapNumEntries=sapNumEntries, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpDescription=sdpDescription, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, ServObjName=ServObjName, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapAdminStatus=sapAdminStatus, sdpOperIsBackup=sdpOperIsBackup, sdpAdminEgressLabel=sdpAdminEgressLabel, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapRowStatus=sapRowStatus, svcVplsMode=svcVplsMode, sdpId=sdpId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, ServiceOperStatus=ServiceOperStatus, prvtSvcTraps=prvtSvcTraps, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapLearnMode=sapLearnMode, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcMtu=svcMtu, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpGroupIdentifier=sdpGroupIdentifier, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sdpOperStatus=sdpOperStatus, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcLastMgmtChange=svcLastMgmtChange, prvtSdpNotif=prvtSdpNotif, sdpLastMgmtChange=sdpLastMgmtChange, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMCustObjs=prvtTMCustObjs, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpOutInterface=sdpOutInterface, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapEncapValue=sapEncapValue, prvtCustTraps=prvtCustTraps, custName=custName, svcEnableSecureSaps=svcEnableSecureSaps, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtSapCreated=prvtSapCreated, prvtTMSapObjs=prvtTMSapObjs, prvtSapDeleted=prvtSapDeleted, prvtTMSapCompliance=prvtTMSapCompliance, prvtSapTraps=prvtSapTraps, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custRowStatus=custRowStatus, prvtSapStatusChanged=prvtSapStatusChanged, sapLastMgmtChange=sapLastMgmtChange, sdpTransportTunnelName=sdpTransportTunnelName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, svcVPLSUplinkTable=svcVPLSUplinkTable, svcType=svcType, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSvcGroups=prvtTMSvcGroups, PYSNMP_MODULE_ID=prvtServicesMIB, sdpAdminStatus=sdpAdminStatus, sdpVCType=sdpVCType, svcDescription=svcDescription, prvtSvcNotif=prvtSvcNotif, svcNumEntries=svcNumEntries, sdpFarEndIpAddress=sdpFarEndIpAddress, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sdpLdpEnabled=sdpLdpEnabled, ServObjDesc=ServObjDesc, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMServObjs=prvtTMServObjs, prvtTMCustCompliance=prvtTMCustCompliance, svcVpnId=svcVpnId, TMEncapVal=TMEncapVal, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpNextFreeId=sdpNextFreeId, prvtTMCustConformance=prvtTMCustConformance, svcRevertTimer=svcRevertTimer, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, VpnId=VpnId, sdpDelivery=sdpDelivery, prvtSvcDeleted=prvtSvcDeleted, sapIngQosSchedName=sapIngQosSchedName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custInfoEntry=custInfoEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapType=sapType, prvtTMSdpObjs=prvtTMSdpObjs, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custPhone=custPhone, custEgrQosSchedName=custEgrQosSchedName, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapOperStatus=sapOperStatus, sapEgrQosCustName=sapEgrQosCustName, sdpType=sdpType, prvtSdpCreated=prvtSdpCreated, custInfoTable=custInfoTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpLastStatusChange=sdpLastStatusChange, prvtTMServConformance=prvtTMServConformance, ServiceAdminStatus=ServiceAdminStatus, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMTstpConformance=prvtTMTstpConformance, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtServNotifications=prvtServNotifications, svcRowStatus=svcRowStatus, prvtSdpStatusChanged=prvtSdpStatusChanged, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpLabelSignaling=sdpLabelSignaling, custContact=custContact, sdpBindVlanTag=sdpBindVlanTag, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtCustCreated=prvtCustCreated, sapBaseInfoEntry=sapBaseInfoEntry, prvtSvcCreated=prvtSvcCreated, TSapIngQueueId=TSapIngQueueId, custIngQosSchedName=custIngQosSchedName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapCustMultSvcSiteName=sapCustMultSvcSiteName)
