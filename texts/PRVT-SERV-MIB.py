...
TNetworkPolicyIdOrNone, TNamedItemOrEmpty, serviceAccessSwitch, TSapIngressPolicyIdOrNone, TNamedItem, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "serviceAccessSwitch", "TSapIngressPolicyIdOrNone", "TNamedItem", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpVCType=sdpVCType, sapAdminStatus=sapAdminStatus, prvtTMCustCompliances=prvtTMCustCompliances, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapBaseInfoEntry=sapBaseInfoEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custContact=custContact, prvtCustDeleted=prvtCustDeleted, svcRowStatus=svcRowStatus, sapType=sapType, sdpTransportTunnelName=sdpTransportTunnelName, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpLabelSignaling=sdpLabelSignaling, VpnId=VpnId, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sdpBindVlanTag=sdpBindVlanTag, sapEgrQosQueueId=sapEgrQosQueueId, prvtTMSvcObjs=prvtTMSvcObjs, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapPortId=sapPortId, ServType=ServType, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMCustGroups=prvtTMCustGroups, svcNumSdps=svcNumSdps, prvtSdpDeleted=prvtSdpDeleted, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcRevertTimer=svcRevertTimer, svcAdminStatus=svcAdminStatus, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcNumEntries=svcNumEntries, sdpRowStatus=sdpRowStatus, PYSNMP_MODULE_ID=prvtServicesMIB, custMultSvcSiteName=custMultSvcSiteName, sapIngressQosPolicyId=sapIngressQosPolicyId, prvtTMSvcGroups=prvtTMSvcGroups, svcId=svcId, prvtTMCustCompliance=prvtTMCustCompliance, TMEncapVal=TMEncapVal, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtTMSapGroups=prvtTMSapGroups, sdpId=sdpId, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, ServiceAdminStatus=ServiceAdminStatus, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, prvtTMSapCompliances=prvtTMSapCompliances, custNumEntries=custNumEntries, prvtTMSvcCompliances=prvtTMSvcCompliances, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpMtu=sdpMtu, ServiceOperStatus=ServiceOperStatus, svcEnableSecureSaps=svcEnableSecureSaps, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMSdpGroups=prvtTMSdpGroups, sapLastMgmtChange=sapLastMgmtChange, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtTMSapObjs=prvtTMSapObjs, prvtSdpNotif=prvtSdpNotif, svcVpnId=svcVpnId, prvtCustCreated=prvtCustCreated, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpNumEntries=sdpNumEntries, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapBaseInfoTable=sapBaseInfoTable, custMultiServiceSiteEntry=custMultiServiceSiteEntry, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosCustName=sapIngQosCustName, prvtTMSdpCompliances=prvtTMSdpCompliances, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, ServObjName=ServObjName, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapEgrQosCustName=sapEgrQosCustName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custIngQosSchedName=custIngQosSchedName, sdpAdminIsBackup=sdpAdminIsBackup, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpLdpEnabled=sdpLdpEnabled, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpNextFreeId=sdpNextFreeId, sapEncapValue=sapEncapValue, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcMtu=svcMtu, prvtSapDeleted=prvtSapDeleted, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSvcConformance=prvtTMSvcConformance, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custRowStatus=custRowStatus, sdpType=sdpType, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosSchedName=sapIngQosSchedName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpOperIsBackup=sdpOperIsBackup, custEgrQosSchedName=custEgrQosSchedName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtSdpCreated=prvtSdpCreated, prvtTMSdpCompliance=prvtTMSdpCompliance, sapOperStatus=sapOperStatus, custName=custName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcType=svcType, sapLearnMode=sapLearnMode, sapNumEntries=sapNumEntries, SdpIdType=SdpIdType, svcDescription=svcDescription, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtSapStatusChanged=prvtSapStatusChanged, sdpDescription=sdpDescription, prvtSapCreated=prvtSapCreated, svcLastStatusChange=svcLastStatusChange, sdpDelivery=sdpDelivery, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkTable=svcVPLSUplinkTable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtCustNotif=prvtCustNotif, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, TSapEgrQueueId=TSapEgrQueueId, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, prvtTMServConformance=prvtTMServConformance, svcBaseInfoTable=svcBaseInfoTable, custPhone=custPhone, sdpLastStatusChange=sdpLastStatusChange, sapOperFlags=sapOperFlags, custMultiServiceSiteTable=custMultiServiceSiteTable, svcOperStatus=svcOperStatus, prvtTMCustConformance=prvtTMCustConformance, prvtTMSapCompliance=prvtTMSapCompliance, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMSdpConformance=prvtTMSdpConformance, svcVplsMode=svcVplsMode, sapDescription=sapDescription, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custLastMgmtChange=custLastMgmtChange, ServObjDesc=ServObjDesc, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpOperFlags=sdpOperFlags, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtSvcCreated=prvtSvcCreated, sapRowStatus=sapRowStatus, sdpAdminEgressLabel=sdpAdminEgressLabel, svcNumSaps=svcNumSaps, sdpLastMgmtChange=sdpLastMgmtChange, custInfoEntry=custInfoEntry, svcLastMgmtChange=svcLastMgmtChange, prvtTMServObjs=prvtTMServObjs, sdpAdminStatus=sdpAdminStatus, sapIngQosQueueId=sapIngQosQueueId, prvtTMCustObjs=prvtTMCustObjs, prvtServicesMIB=prvtServicesMIB, prvtServNotifications=prvtServNotifications, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpInfoTable=sdpInfoTable, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSapNotif=prvtSapNotif, sdpInfoEntry=sdpInfoEntry, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtSvcTraps=prvtSvcTraps, sdpOutInterface=sdpOutInterface, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtSvcNotif=prvtSvcNotif, TSapIngQueueId=TSapIngQueueId, prvtTMTstpConformance=prvtTMTstpConformance, svcCustName=svcCustName, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custInfoTable=custInfoTable, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpOperStatus=sdpOperStatus, sapIngQosSchedCustName=sapIngQosSchedCustName, prvtSdpTraps=prvtSdpTraps, prvtSapTraps=prvtSapTraps, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSvcCompliance=prvtTMSvcCompliance, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpAdminIngressLabel=sdpAdminIngressLabel, sapCustMultSvcSiteName=sapCustMultSvcSiteName)
