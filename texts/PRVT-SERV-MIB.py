...
TSapEgressPolicyIdOrNone, TNamedItemOrEmpty, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItem, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TSapEgressPolicyIdOrNone", "TNamedItemOrEmpty", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItem", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtSapTraps=prvtSapTraps, prvtSapNotif=prvtSapNotif, sdpLastStatusChange=sdpLastStatusChange, sapRowStatus=sapRowStatus, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapBaseInfoTable=sapBaseInfoTable, sdpLabelSignaling=sdpLabelSignaling, prvtTMSdpConformance=prvtTMSdpConformance, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosQueueId=sapIngQosQueueId, ServObjDesc=ServObjDesc, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtSvcStatusChanged=prvtSvcStatusChanged, prvtSvcCreated=prvtSvcCreated, prvtSvcDeleted=prvtSvcDeleted, sapBaseInfoEntry=sapBaseInfoEntry, sdpBindVlanTag=sdpBindVlanTag, svcBaseInfoTable=svcBaseInfoTable, custInfoEntry=custInfoEntry, sdpAdminIngressLabel=sdpAdminIngressLabel, svcCustName=svcCustName, custNumEntries=custNumEntries, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sdpAdminStatus=sdpAdminStatus, custIngQosSchedName=custIngQosSchedName, prvtTMServObjs=prvtTMServObjs, ServType=ServType, sapOperFlags=sapOperFlags, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtCustTraps=prvtCustTraps, sdpOutInterface=sdpOutInterface, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcId=svcId, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custLastMgmtChange=custLastMgmtChange, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapEncapValue=sapEncapValue, sapAdminStatus=sapAdminStatus, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custPhone=custPhone, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, svcOperStatus=svcOperStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcLastMgmtChange=svcLastMgmtChange, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkTable=svcVPLSUplinkTable, svcNumSaps=svcNumSaps, svcRevertTimer=svcRevertTimer, prvtTMSapConformance=prvtTMSapConformance, prvtTMCustCompliance=prvtTMCustCompliance, TSapIngQueueId=TSapIngQueueId, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, sdpId=sdpId, svcNumSdps=svcNumSdps, prvtSvcNotif=prvtSvcNotif, svcType=svcType, custInfoTable=custInfoTable, sapLearnMode=sapLearnMode, prvtSapDeleted=prvtSapDeleted, sdpLastMgmtChange=sdpLastMgmtChange, sdpAdminIsBackup=sdpAdminIsBackup, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapNumEntries=sapNumEntries, svcVplsMode=svcVplsMode, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpNextFreeId=sdpNextFreeId, sapType=sapType, sdpNumEntries=sdpNumEntries, sdpDescription=sdpDescription, prvtSdpNotif=prvtSdpNotif, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sdpTransportTunnelName=sdpTransportTunnelName, sdpOperIsBackup=sdpOperIsBackup, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMSapGroups=prvtTMSapGroups, prvtSdpTraps=prvtSdpTraps, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, TSapEgrQueueId=TSapEgrQueueId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sdpGroupIdentifier=sdpGroupIdentifier, PYSNMP_MODULE_ID=prvtServicesMIB, TMEncapVal=TMEncapVal, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpMtu=sdpMtu, sdpType=sdpType, prvtServicesMIB=prvtServicesMIB, prvtSdpCreated=prvtSdpCreated, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtTMSvcGroups=prvtTMSvcGroups, sapIngQosCustName=sapIngQosCustName, custMultSvcSiteDescription=custMultSvcSiteDescription, svcVpnId=svcVpnId, sapEgrQosQueueId=sapEgrQosQueueId, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSapCreated=prvtSapCreated, sapLastMgmtChange=sapLastMgmtChange, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, prvtSapStatusChanged=prvtSapStatusChanged, prvtTMSvcCompliance=prvtTMSvcCompliance, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMTstpConformance=prvtTMTstpConformance, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcDescription=svcDescription, sdpInfoEntry=sdpInfoEntry, sapEgrQosCustName=sapEgrQosCustName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSdpDeleted=prvtSdpDeleted, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, ServObjName=ServObjName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, prvtCustNotif=prvtCustNotif, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sdpDelivery=sdpDelivery, svcAdminStatus=svcAdminStatus, prvtSvcTraps=prvtSvcTraps, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosSchedName=sapIngQosSchedName, prvtTMSapCompliance=prvtTMSapCompliance, prvtServNotifications=prvtServNotifications, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpRowStatus=sdpRowStatus, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSapCompliances=prvtTMSapCompliances, sapOperStatus=sapOperStatus, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpLdpEnabled=sdpLdpEnabled, prvtTMSapObjs=prvtTMSapObjs, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpInfoTable=sdpInfoTable, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtTMSdpGroups=prvtTMSdpGroups, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapDescription=sapDescription, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, prvtTMServConformance=prvtTMServConformance, sapEgrQosSchedName=sapEgrQosSchedName, sapIngressQosPolicyId=sapIngressQosPolicyId, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, ServiceAdminStatus=ServiceAdminStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sdpOperStatus=sdpOperStatus, svcNumEntries=svcNumEntries, custMultSvcSiteName=custMultSvcSiteName, prvtTMSdpObjs=prvtTMSdpObjs, prvtCustDeleted=prvtCustDeleted, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custName=custName, svcMtu=svcMtu, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtCustCreated=prvtCustCreated, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMSvcObjs=prvtTMSvcObjs, custContact=custContact, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sdpVCType=sdpVCType, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custIngQosPortIdSchedName=custIngQosPortIdSchedName, VpnId=VpnId, svcEnableSecureSaps=svcEnableSecureSaps, svcBaseInfoEntry=svcBaseInfoEntry, svcRowStatus=svcRowStatus, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosSchedName=custEgrQosSchedName, sapPortId=sapPortId, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMCustGroups=prvtTMCustGroups, SdpIdType=SdpIdType, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, custRowStatus=custRowStatus, prvtTMCustObjs=prvtTMCustObjs, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, ServiceOperStatus=ServiceOperStatus)
