...
TNamedItem, TSapIngressPolicyIdOrNone, TNetworkPolicyIdOrNone, serviceAccessSwitch, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNamedItem", "TSapIngressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "serviceAccessSwitch", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", prvtServicesMIB=prvtServicesMIB, prvtServNotifications=prvtServNotifications, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, prvtSapCreated=prvtSapCreated, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpNextFreeId=sdpNextFreeId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpTransportTunnelName=sdpTransportTunnelName, SdpIdType=SdpIdType, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMSdpCompliance=prvtTMSdpCompliance, svcLastStatusChange=svcLastStatusChange, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustGroups=prvtTMCustGroups, prvtSdpNotif=prvtSdpNotif, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, svcLastMgmtChange=svcLastMgmtChange, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, custIngQosSchedName=custIngQosSchedName, svcDescription=svcDescription, prvtSvcCreated=prvtSvcCreated, VpnId=VpnId, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custEgrQosSchedName=custEgrQosSchedName, prvtTMSvcCompliances=prvtTMSvcCompliances, sapBaseInfoTable=sapBaseInfoTable, svcNumEntries=svcNumEntries, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMCustObjs=prvtTMCustObjs, sdpBindVlanTag=sdpBindVlanTag, svcType=svcType, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpType=sdpType, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custContact=custContact, svcEnableSecureSaps=svcEnableSecureSaps, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpLastStatusChange=sdpLastStatusChange, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtSvcDeleted=prvtSvcDeleted, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, svcCustName=svcCustName, sdpOperIsBackup=sdpOperIsBackup, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMSdpCompliances=prvtTMSdpCompliances, ServType=ServType, ServObjDesc=ServObjDesc, svcBaseInfoEntry=svcBaseInfoEntry, sdpMtu=sdpMtu, svcNumSdps=svcNumSdps, TMEncapVal=TMEncapVal, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtSapNotif=prvtSapNotif, prvtSdpDeleted=prvtSdpDeleted, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpDescription=sdpDescription, sapIngQosSchedName=sapIngQosSchedName, sapNumEntries=sapNumEntries, prvtSdpCreated=prvtSdpCreated, prvtTMSapObjs=prvtTMSapObjs, prvtTMCustConformance=prvtTMCustConformance, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpRowStatus=sdpRowStatus, custInfoTable=custInfoTable, sdpInfoTable=sdpInfoTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapLastMgmtChange=sapLastMgmtChange, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSvcCompliance=prvtTMSvcCompliance, svcVPLSUplinkTable=svcVPLSUplinkTable, sapBaseInfoEntry=sapBaseInfoEntry, sapAdminStatus=sapAdminStatus, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpAdminIsBackup=sdpAdminIsBackup, sapRowStatus=sapRowStatus, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcAdminStatus=svcAdminStatus, prvtTMSvcConformance=prvtTMSvcConformance, sapIngQosSchedCustName=sapIngQosSchedCustName, svcId=svcId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapIngQosCustName=sapIngQosCustName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, svcVplsMode=svcVplsMode, prvtCustDeleted=prvtCustDeleted, prvtSvcNotif=prvtSvcNotif, sdpInfoEntry=sdpInfoEntry, prvtCustCreated=prvtCustCreated, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, custName=custName, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapType=sapType, svcMtu=svcMtu, sapEgrQosCustName=sapEgrQosCustName, custRowStatus=custRowStatus, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMSdpObjs=prvtTMSdpObjs, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcBaseInfoTable=svcBaseInfoTable, custLastMgmtChange=custLastMgmtChange, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcOperStatus=svcOperStatus, sapOperStatus=sapOperStatus, prvtTMSdpGroups=prvtTMSdpGroups, prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, svcVpnId=svcVpnId, sdpAdminIngressLabel=sdpAdminIngressLabel, sapEncapValue=sapEncapValue, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSapStatusChanged=prvtSapStatusChanged, custMultSvcSiteName=custMultSvcSiteName, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, svcNumSaps=svcNumSaps, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, prvtTMSapGroups=prvtTMSapGroups, custIngQosAssignmentPortId=custIngQosAssignmentPortId, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSvcObjs=prvtTMSvcObjs, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sdpAdminStatus=sdpAdminStatus, sapLearnMode=sapLearnMode, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpNumEntries=sdpNumEntries, sapDescription=sapDescription, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpLabelSignaling=sdpLabelSignaling, prvtTMServObjs=prvtTMServObjs, sapOperFlags=sapOperFlags, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcRevertTimer=svcRevertTimer, TSapIngQueueId=TSapIngQueueId, sdpVCType=sdpVCType, prvtSapDeleted=prvtSapDeleted, svcRowStatus=svcRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSapCompliance=prvtTMSapCompliance, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpDelivery=sdpDelivery, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, ServObjName=ServObjName, sdpLastMgmtChange=sdpLastMgmtChange, sdpId=sdpId, sdpLdpEnabled=sdpLdpEnabled, prvtSapTraps=prvtSapTraps, prvtSvcTraps=prvtSvcTraps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, ServiceAdminStatus=ServiceAdminStatus, custNumEntries=custNumEntries, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtSvcStatusChanged=prvtSvcStatusChanged, custPhone=custPhone, prvtTMCustCompliances=prvtTMCustCompliances, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSvcGroups=prvtTMSvcGroups, prvtSdpTraps=prvtSdpTraps, sdpOutInterface=sdpOutInterface, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMSapCompliances=prvtTMSapCompliances, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapPortId=sapPortId, sdpOperStatus=sdpOperStatus, ServiceOperStatus=ServiceOperStatus, sapIngQosQueueId=sapIngQosQueueId, prvtSdpStatusChanged=prvtSdpStatusChanged, custInfoEntry=custInfoEntry, sapEgrQosQueueId=sapEgrQosQueueId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, TSapEgrQueueId=TSapEgrQueueId, custMultiServiceSiteEntry=custMultiServiceSiteEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName)
