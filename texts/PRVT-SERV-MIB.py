...
serviceAccessSwitch, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, TNetworkPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "TNetworkPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", svcOperStatus=svcOperStatus, prvtTMSvcGroups=prvtTMSvcGroups, svcLastStatusChange=svcLastStatusChange, sapIngressQosPolicyId=sapIngressQosPolicyId, sapEgressQosPolicyId=sapEgressQosPolicyId, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosCustName=sapIngQosCustName, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSvcConformance=prvtTMSvcConformance, svcLastMgmtChange=svcLastMgmtChange, prvtSvcNotif=prvtSvcNotif, prvtSdpNotif=prvtSdpNotif, sapOperFlags=sapOperFlags, sdpLastMgmtChange=sdpLastMgmtChange, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMCustConformance=prvtTMCustConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custEgrQosSchedName=custEgrQosSchedName, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosSchedCustName=sapIngQosSchedCustName, custInfoTable=custInfoTable, prvtTMServObjs=prvtTMServObjs, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtSvcTraps=prvtSvcTraps, prvtSvcCreated=prvtSvcCreated, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, svcType=svcType, svcRowStatus=svcRowStatus, sapRowStatus=sapRowStatus, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpTransportTunnelName=sdpTransportTunnelName, prvtServicesMIB=prvtServicesMIB, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, ServObjDesc=ServObjDesc, sdpInfoTable=sdpInfoTable, prvtSvcStatusChanged=prvtSvcStatusChanged, TMEncapVal=TMEncapVal, custRowStatus=custRowStatus, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapType=sapType, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSapDeleted=prvtSapDeleted, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, svcVpnId=svcVpnId, prvtTMTstpConformance=prvtTMTstpConformance, prvtCustCreated=prvtCustCreated, prvtTMSdpConformance=prvtTMSdpConformance, ServObjName=ServObjName, TSapIngQueueId=TSapIngQueueId, svcNumSaps=svcNumSaps, prvtSapCreated=prvtSapCreated, sapIngQosSchedName=sapIngQosSchedName, sdpDescription=sdpDescription, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sdpBindVlanTag=sdpBindVlanTag, sdpGroupIdentifier=sdpGroupIdentifier, sapPortId=sapPortId, svcNumEntries=svcNumEntries, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpAdminIsBackup=sdpAdminIsBackup, custIngQosSchedName=custIngQosSchedName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtCustDeleted=prvtCustDeleted, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custContact=custContact, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapNumEntries=sapNumEntries, ServType=ServType, prvtTMCustObjs=prvtTMCustObjs, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtTMCustGroups=prvtTMCustGroups, prvtCustTraps=prvtCustTraps, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtTMSdpCompliances=prvtTMSdpCompliances, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSapCompliance=prvtTMSapCompliance, prvtSapStatusChanged=prvtSapStatusChanged, TSapEgrQueueId=TSapEgrQueueId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapBaseInfoTable=sapBaseInfoTable, svcRevertTimer=svcRevertTimer, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultSvcSiteDescription=custMultSvcSiteDescription, sapEgrQosQueueId=sapEgrQosQueueId, prvtSdpTraps=prvtSdpTraps, svcNumSdps=svcNumSdps, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapLastMgmtChange=sapLastMgmtChange, custName=custName, custLastMgmtChange=custLastMgmtChange, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sdpMtu=sdpMtu, sapBaseInfoEntry=sapBaseInfoEntry, sdpInfoEntry=sdpInfoEntry, sdpVCType=sdpVCType, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtSapTraps=prvtSapTraps, sdpOperIsBackup=sdpOperIsBackup, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpLastStatusChange=sdpLastStatusChange, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapOperStatus=sapOperStatus, prvtSdpCreated=prvtSdpCreated, svcId=svcId, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, svcMtu=svcMtu, prvtTMServConformance=prvtTMServConformance, sdpFarEndIpAddress=sdpFarEndIpAddress, prvtTMCustCompliance=prvtTMCustCompliance, prvtServNotifications=prvtServNotifications, sdpType=sdpType, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVPLSUplinkPortID=svcVPLSUplinkPortID, prvtTMSapObjs=prvtTMSapObjs, prvtSdpDeleted=prvtSdpDeleted, ServiceOperStatus=ServiceOperStatus, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpDelivery=sdpDelivery, prvtSvcDeleted=prvtSvcDeleted, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, ServiceAdminStatus=ServiceAdminStatus, sdpRowStatus=sdpRowStatus, sdpId=sdpId, sdpAdminEgressLabel=sdpAdminEgressLabel, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpNextFreeId=sdpNextFreeId, sdpLabelSignaling=sdpLabelSignaling, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcVplsMode=svcVplsMode, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapEncapValue=sapEncapValue, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sdpLdpEnabled=sdpLdpEnabled, prvtCustNotif=prvtCustNotif, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosQueueId=sapIngQosQueueId, svcBaseInfoTable=svcBaseInfoTable, svcEnableSecureSaps=svcEnableSecureSaps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpOperStatus=sdpOperStatus, sapLearnMode=sapLearnMode, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSdpCompliance=prvtTMSdpCompliance, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpOperFlags=sdpOperFlags, prvtTMSapGroups=prvtTMSapGroups, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sdpNumEntries=sdpNumEntries, custInfoEntry=custInfoEntry, prvtTMSvcObjs=prvtTMSvcObjs, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapDescription=sapDescription, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapAdminStatus=sapAdminStatus, custNumEntries=custNumEntries, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpAdminStatus=sdpAdminStatus, PYSNMP_MODULE_ID=prvtServicesMIB, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, VpnId=VpnId, sapEgrQosCustName=sapEgrQosCustName, prvtTMSdpObjs=prvtTMSdpObjs, prvtTMSapConformance=prvtTMSapConformance, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, custPhone=custPhone, SdpIdType=SdpIdType, sdpOutInterface=sdpOutInterface, svcAdminStatus=svcAdminStatus, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcDescription=svcDescription, svcCustName=svcCustName, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sapEgrQosSchedName=sapEgrQosSchedName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSapNotif=prvtSapNotif)
