...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapBaseInfoEntry=sapBaseInfoEntry, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMTstpConformance=prvtTMTstpConformance, sdpDescription=sdpDescription, prvtTMSdpCompliances=prvtTMSdpCompliances, svcNumSdps=svcNumSdps, prvtServNotifications=prvtServNotifications, svcOperStatus=svcOperStatus, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpOutInterface=sdpOutInterface, ServiceAdminStatus=ServiceAdminStatus, TSapEgrQueueId=TSapEgrQueueId, prvtCustDeleted=prvtCustDeleted, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custPhone=custPhone, prvtSvcDeleted=prvtSvcDeleted, sapRowStatus=sapRowStatus, sdpAdminStatus=sdpAdminStatus, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, custInfoEntry=custInfoEntry, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sapIngQosCustName=sapIngQosCustName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, svcDescription=svcDescription, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpNumEntries=sdpNumEntries, prvtTMSapCompliances=prvtTMSapCompliances, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtTMCustGroups=prvtTMCustGroups, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapType=sapType, SdpIdType=SdpIdType, sdpOperFlags=sdpOperFlags, prvtCustTraps=prvtCustTraps, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpLabelSignaling=sdpLabelSignaling, ServObjDesc=ServObjDesc, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, custName=custName, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMServObjs=prvtTMServObjs, sapIngQosQueueId=sapIngQosQueueId, prvtSapDeleted=prvtSapDeleted, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sdpInfoTable=sdpInfoTable, sdpOperIsBackup=sdpOperIsBackup, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpOperStatus=sdpOperStatus, prvtTMCustObjs=prvtTMCustObjs, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, ServObjName=ServObjName, sdpFarEndIpAddress=sdpFarEndIpAddress, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpType=sdpType, custIngQosPortIdSchedName=custIngQosPortIdSchedName, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapOperStatus=sapOperStatus, sdpLdpEnabled=sdpLdpEnabled, sdpAdminIsBackup=sdpAdminIsBackup, sdpMtu=sdpMtu, prvtSapStatusChanged=prvtSapStatusChanged, custIngQosSchedName=custIngQosSchedName, sapEncapValue=sapEncapValue, sapNumEntries=sapNumEntries, ServiceOperStatus=ServiceOperStatus, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgrQosCustName=sapEgrQosCustName, prvtTMSapGroups=prvtTMSapGroups, custContact=custContact, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpDelivery=sdpDelivery, custMultSvcSiteName=custMultSvcSiteName, sdpNextFreeId=sdpNextFreeId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtSvcCreated=prvtSvcCreated, prvtSdpTraps=prvtSdpTraps, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpInfoEntry=sdpInfoEntry, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpId=sdpId, custLastMgmtChange=custLastMgmtChange, svcVplsMode=svcVplsMode, prvtTMSapObjs=prvtTMSapObjs, PYSNMP_MODULE_ID=prvtServicesMIB, prvtTMSdpObjs=prvtTMSdpObjs, svcMtu=svcMtu, prvtCustNotif=prvtCustNotif, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcRowStatus=svcRowStatus, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, TMEncapVal=TMEncapVal, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, custMultSvcSiteDescription=custMultSvcSiteDescription, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapEgrQosSchedName=sapEgrQosSchedName, svcLastMgmtChange=svcLastMgmtChange, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSapTraps=prvtSapTraps, prvtSvcNotif=prvtSvcNotif, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMSdpConformance=prvtTMSdpConformance, prvtTMSdpGroups=prvtTMSdpGroups, svcId=svcId, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, prvtTMSvcCompliance=prvtTMSvcCompliance, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcEnableSecureSaps=svcEnableSecureSaps, sdpGroupIdentifier=sdpGroupIdentifier, svcVpnId=svcVpnId, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapBaseInfoTable=sapBaseInfoTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMSvcObjs=prvtTMSvcObjs, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sdpBindVlanTag=sdpBindVlanTag, custEgrQosSchedName=custEgrQosSchedName, sapLearnMode=sapLearnMode, sapAdminStatus=sapAdminStatus, prvtSdpDeleted=prvtSdpDeleted, custRowStatus=custRowStatus, prvtSdpNotif=prvtSdpNotif, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapLastMgmtChange=sapLastMgmtChange, prvtTMCustCompliances=prvtTMCustCompliances, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMCustConformance=prvtTMCustConformance, prvtCustCreated=prvtCustCreated, sapOperFlags=sapOperFlags, custInfoTable=custInfoTable, VpnId=VpnId, prvtSdpCreated=prvtSdpCreated, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, prvtTMSdpCompliance=prvtTMSdpCompliance, ServType=ServType, sapIngQosSchedName=sapIngQosSchedName, sdpVCType=sdpVCType, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSvcConformance=prvtTMSvcConformance, svcLastStatusChange=svcLastStatusChange, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapIngQosSchedCustName=sapIngQosSchedCustName, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSapConformance=prvtTMSapConformance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpTransportTunnelName=sdpTransportTunnelName, svcType=svcType, custNumEntries=custNumEntries, TSapIngQueueId=TSapIngQueueId, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcNumSaps=svcNumSaps, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapDescription=sapDescription, prvtServicesMIB=prvtServicesMIB, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, sdpLastStatusChange=sdpLastStatusChange, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMCustCompliance=prvtTMCustCompliance, prvtTMSapCompliance=prvtTMSapCompliance, prvtSapNotif=prvtSapNotif, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, svcNumEntries=svcNumEntries, svcAdminStatus=svcAdminStatus, prvtSapCreated=prvtSapCreated, sapPortId=sapPortId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMServConformance=prvtTMServConformance, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapIngressQosPolicyId=sapIngressQosPolicyId, svcRevertTimer=svcRevertTimer, sdpRowStatus=sdpRowStatus, svcCustName=svcCustName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sapEgrQosQueueId=sapEgrQosQueueId)
