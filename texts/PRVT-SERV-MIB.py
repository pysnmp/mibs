...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapNumEntries=sapNumEntries, SdpIdType=SdpIdType, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, svcLastStatusChange=svcLastStatusChange, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sapDescription=sapDescription, sapPortId=sapPortId, sapAdminStatus=sapAdminStatus, sdpDelivery=sdpDelivery, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, prvtSdpDeleted=prvtSdpDeleted, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpOperStatus=sdpOperStatus, sdpMtu=sdpMtu, sapEgrQosSchedName=sapEgrQosSchedName, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtTMCustCompliance=prvtTMCustCompliance, prvtSapStatusChanged=prvtSapStatusChanged, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapBaseInfoEntry=sapBaseInfoEntry, svcVplsMode=svcVplsMode, custPhone=custPhone, prvtSdpNotif=prvtSdpNotif, svcMtu=svcMtu, prvtTMSdpCompliance=prvtTMSdpCompliance, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcAdminStatus=svcAdminStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, svcRevertTimer=svcRevertTimer, prvtSdpTraps=prvtSdpTraps, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapIngQosCustName=sapIngQosCustName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpRowStatus=sdpRowStatus, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, custInfoTable=custInfoTable, TMEncapVal=TMEncapVal, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtCustDeleted=prvtCustDeleted, svcNumSaps=svcNumSaps, prvtCustNotif=prvtCustNotif, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpInfoEntry=sdpInfoEntry, prvtTMSdpCompliances=prvtTMSdpCompliances, sapBaseInfoTable=sapBaseInfoTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpDescription=sdpDescription, sdpAdminIngressLabel=sdpAdminIngressLabel, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, prvtTMSvcObjs=prvtTMSvcObjs, svcOperStatus=svcOperStatus, prvtTMSdpObjs=prvtTMSdpObjs, custContact=custContact, prvtTMSapGroups=prvtTMSapGroups, custMultSvcSiteName=custMultSvcSiteName, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custMultiServiceSiteTable=custMultiServiceSiteTable, sapLastMgmtChange=sapLastMgmtChange, prvtSapDeleted=prvtSapDeleted, prvtSdpCreated=prvtSdpCreated, prvtCustCreated=prvtCustCreated, VpnId=VpnId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, TSapEgrQueueId=TSapEgrQueueId, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, sdpOperIsBackup=sdpOperIsBackup, prvtTMSvcGroups=prvtTMSvcGroups, svcDescription=svcDescription, prvtSapNotif=prvtSapNotif, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, prvtTMSapObjs=prvtTMSapObjs, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtTMServObjs=prvtTMServObjs, sdpOperFlags=sdpOperFlags, sdpBindVlanTag=sdpBindVlanTag, sdpNumEntries=sdpNumEntries, sapLearnMode=sapLearnMode, sapIngQosQueueId=sapIngQosQueueId, prvtServicesMIB=prvtServicesMIB, custMultiServiceSiteEntry=custMultiServiceSiteEntry, ServiceOperStatus=ServiceOperStatus, TSapIngQueueId=TSapIngQueueId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custLastMgmtChange=custLastMgmtChange, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtSvcNotif=prvtSvcNotif, svcVPLSUplinkTable=svcVPLSUplinkTable, prvtTMSapCompliance=prvtTMSapCompliance, svcNumEntries=svcNumEntries, sapIngressQosPolicyId=sapIngressQosPolicyId, svcBaseInfoEntry=svcBaseInfoEntry, sapEncapValue=sapEncapValue, sdpInfoTable=sdpInfoTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custRowStatus=custRowStatus, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMTstpConformance=prvtTMTstpConformance, sdpId=sdpId, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpLabelSignaling=sdpLabelSignaling, custInfoEntry=custInfoEntry, svcEnableSecureSaps=svcEnableSecureSaps, custIngQosSchedName=custIngQosSchedName, sdpVCType=sdpVCType, custName=custName, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, prvtTMCustConformance=prvtTMCustConformance, sapOperFlags=sapOperFlags, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueId=sapEgrQosQueueId, sdpLdpEnabled=sdpLdpEnabled, sdpLastMgmtChange=sdpLastMgmtChange, sdpAdminEgressLabel=sdpAdminEgressLabel, sapOperStatus=sapOperStatus, svcRowStatus=svcRowStatus, sapRowStatus=sapRowStatus, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapCustMultSvcSiteName=sapCustMultSvcSiteName, ServiceAdminStatus=ServiceAdminStatus, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, svcType=svcType, sdpAdminStatus=sdpAdminStatus, prvtTMSapConformance=prvtTMSapConformance, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSvcConformance=prvtTMSvcConformance, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, prvtTMSdpGroups=prvtTMSdpGroups, ServObjDesc=ServObjDesc, prvtSvcCreated=prvtSvcCreated, prvtTMSapCompliances=prvtTMSapCompliances, svcId=svcId, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtCustTraps=prvtCustTraps, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtServNotifications=prvtServNotifications, sdpOutInterface=sdpOutInterface, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpAdminIsBackup=sdpAdminIsBackup, ServType=ServType, ServObjName=ServObjName, svcNumSdps=svcNumSdps, sapIngQosSchedName=sapIngQosSchedName, svcCustName=svcCustName, sdpType=sdpType, custEgrQosSchedName=custEgrQosSchedName, svcVPLSUplinkEntry=svcVPLSUplinkEntry, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtTMSdpConformance=prvtTMSdpConformance, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtSvcTraps=prvtSvcTraps, prvtTMCustObjs=prvtTMCustObjs, sdpNextFreeId=sdpNextFreeId, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, svcLastMgmtChange=svcLastMgmtChange, prvtSapCreated=prvtSapCreated, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sdpLastStatusChange=sdpLastStatusChange, svcBaseInfoTable=svcBaseInfoTable, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, prvtTMCustCompliances=prvtTMCustCompliances, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, sapIngQosSchedCustName=sapIngQosSchedCustName, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSvcDeleted=prvtSvcDeleted, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, svcVpnId=svcVpnId, sdpGroupIdentifier=sdpGroupIdentifier, sapType=sapType, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpTransportTunnelName=sdpTransportTunnelName, custNumEntries=custNumEntries, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtTMServConformance=prvtTMServConformance, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtTMCustGroups=prvtTMCustGroups, prvtSapTraps=prvtSapTraps, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable)
