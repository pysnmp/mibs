...
serviceAccessSwitch, TNamedItem, TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TSapEgressPolicyIdOrNone, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNamedItem", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TSapEgressPolicyIdOrNone", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sdpAdminEgressLabel=sdpAdminEgressLabel, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, svcVPLSUplinkTable=svcVPLSUplinkTable, sdpFarEndIpAddress=sdpFarEndIpAddress, sdpInfoEntry=sdpInfoEntry, sapType=sapType, custName=custName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtCustCreated=prvtCustCreated, sdpAdminStatus=sdpAdminStatus, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, prvtSdpDeleted=prvtSdpDeleted, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, VpnId=VpnId, prvtTMSapObjs=prvtTMSapObjs, sdpTransportTunnelName=sdpTransportTunnelName, svcRevertTimer=svcRevertTimer, sapOperStatus=sapOperStatus, prvtTMSapCompliances=prvtTMSapCompliances, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMSvcCompliance=prvtTMSvcCompliance, sdpLastStatusChange=sdpLastStatusChange, PYSNMP_MODULE_ID=prvtServicesMIB, prvtSvcTraps=prvtSvcTraps, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, svcBaseInfoEntry=svcBaseInfoEntry, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpOperStatus=sdpOperStatus, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, prvtTMCustGroups=prvtTMCustGroups, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpBindVlanTag=sdpBindVlanTag, sapLearnMode=sapLearnMode, sapOperFlags=sapOperFlags, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSdpNotif=prvtSdpNotif, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, TMEncapVal=TMEncapVal, custContact=custContact, prvtTMSdpConformance=prvtTMSdpConformance, custEgrQosSchedName=custEgrQosSchedName, prvtCustDeleted=prvtCustDeleted, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, prvtTMServObjs=prvtTMServObjs, sdpDelivery=sdpDelivery, prvtTMSdpGroups=prvtTMSdpGroups, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sdpType=sdpType, sdpLdpEnabled=sdpLdpEnabled, sdpLabelSignaling=sdpLabelSignaling, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpGroupIdentifier=sdpGroupIdentifier, prvtTMServConformance=prvtTMServConformance, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sapAdminStatus=sapAdminStatus, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapEgrQosCustName=sapEgrQosCustName, sdpLastMgmtChange=sdpLastMgmtChange, prvtServicesMIB=prvtServicesMIB, svcRowStatus=svcRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, prvtSapDeleted=prvtSapDeleted, prvtTMCustCompliances=prvtTMCustCompliances, svcLastStatusChange=svcLastStatusChange, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, svcCustName=svcCustName, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtSapNotif=prvtSapNotif, sapIngQosCustName=sapIngQosCustName, prvtTMCustConformance=prvtTMCustConformance, sapPortId=sapPortId, sapDescription=sapDescription, svcVplsMode=svcVplsMode, custInfoEntry=custInfoEntry, svcNumSdps=svcNumSdps, sapLastMgmtChange=sapLastMgmtChange, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sdpOperIsBackup=sdpOperIsBackup, svcAdminStatus=svcAdminStatus, sapBaseInfoTable=sapBaseInfoTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, custRowStatus=custRowStatus, svcBaseInfoTable=svcBaseInfoTable, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMSapCompliance=prvtTMSapCompliance, prvtSvcDeleted=prvtSvcDeleted, prvtSapCreated=prvtSapCreated, svcVpnId=svcVpnId, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtCustNotif=prvtCustNotif, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sapEgrQosSchedCustName=sapEgrQosSchedCustName, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosSchedName=sapIngQosSchedName, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, SdpIdType=SdpIdType, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtTMSapConformance=prvtTMSapConformance, prvtSdpTraps=prvtSdpTraps, sdpDescription=sdpDescription, sapRowStatus=sapRowStatus, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpInfoTable=sdpInfoTable, prvtTMSvcCompliances=prvtTMSvcCompliances, prvtCustTraps=prvtCustTraps, ServiceOperStatus=ServiceOperStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMSdpObjs=prvtTMSdpObjs, svcId=svcId, custIngQosAssignmentPortId=custIngQosAssignmentPortId, prvtSdpCreated=prvtSdpCreated, svcLastMgmtChange=svcLastMgmtChange, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, ServObjName=ServObjName, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custMultSvcSiteName=custMultSvcSiteName, prvtServNotifications=prvtServNotifications, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSapGroups=prvtTMSapGroups, sdpVCType=sdpVCType, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, sdpMtu=sdpMtu, prvtTMSvcObjs=prvtTMSvcObjs, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custIngQosSchedName=custIngQosSchedName, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSdpCompliance=prvtTMSdpCompliance, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, sapIngQosSchedCustName=sapIngQosSchedCustName, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custMultiServiceSiteTable=custMultiServiceSiteTable, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpOperFlags=sdpOperFlags, prvtSapTraps=prvtSapTraps, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, prvtTMCustCompliance=prvtTMCustCompliance, svcNumSaps=svcNumSaps, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, sdpNumEntries=sdpNumEntries, prvtSdpStatusChanged=prvtSdpStatusChanged, svcNumEntries=svcNumEntries, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, custInfoTable=custInfoTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, sdpRowStatus=sdpRowStatus, TSapEgrQueueId=TSapEgrQueueId, svcOperStatus=svcOperStatus, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMTstpConformance=prvtTMTstpConformance, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, ServObjDesc=ServObjDesc, sdpNextFreeId=sdpNextFreeId, sapBaseInfoEntry=sapBaseInfoEntry, custNumEntries=custNumEntries, prvtSvcCreated=prvtSvcCreated, sapNumEntries=sapNumEntries, custLastMgmtChange=custLastMgmtChange, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, prvtSvcStatusChanged=prvtSvcStatusChanged, sapIngressQosPolicyId=sapIngressQosPolicyId, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtSvcNotif=prvtSvcNotif, sapEncapValue=sapEncapValue, svcMtu=svcMtu, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, svcType=svcType, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sdpId=sdpId, sapIngQosQueueId=sapIngQosQueueId, svcDescription=svcDescription, ServiceAdminStatus=ServiceAdminStatus, ServType=ServType, prvtSapStatusChanged=prvtSapStatusChanged, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sapEgrQosQueueId=sapEgrQosQueueId, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, prvtTMCustObjs=prvtTMCustObjs, TSapIngQueueId=TSapIngQueueId, custPhone=custPhone, sdpOutInterface=sdpOutInterface, sapEgrQosSchedName=sapEgrQosSchedName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup)
