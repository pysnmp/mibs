...
serviceAccessSwitch, TNamedItemOrEmpty, TNamedItem, TSapEgressPolicyIdOrNone, TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "serviceAccessSwitch", "TNamedItemOrEmpty", "TNamedItem", "TSapEgressPolicyIdOrNone", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, prvtSapNotif=prvtSapNotif, svcNumEntries=svcNumEntries, svcLastMgmtChange=svcLastMgmtChange, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, sdpInfoTable=sdpInfoTable, sdpDelivery=sdpDelivery, prvtServNotifications=prvtServNotifications, sapEgressQosPolicyId=sapEgressQosPolicyId, sapPortId=sapPortId, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, svcVpnId=svcVpnId, prvtCustTraps=prvtCustTraps, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapOperFlags=sapOperFlags, prvtCustCreated=prvtCustCreated, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, sapCustMultSvcSiteName=sapCustMultSvcSiteName, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngressQosPolicyId=sapIngressQosPolicyId, custIngQosPortIdSchedName=custIngQosPortIdSchedName, custInfoTable=custInfoTable, sdpRowStatus=sdpRowStatus, svcLastStatusChange=svcLastStatusChange, prvtTMSvcCompliance=prvtTMSvcCompliance, prvtSdpCreated=prvtSdpCreated, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sdpId=sdpId, svcVplsMode=svcVplsMode, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sapEgrQosSchedCustName=sapEgrQosSchedCustName, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtSapCreated=prvtSapCreated, prvtTMSdpConformance=prvtTMSdpConformance, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, prvtSapDeleted=prvtSapDeleted, prvtTMCustCompliances=prvtTMCustCompliances, svcVPLSUplinkPortID=svcVPLSUplinkPortID, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, custContact=custContact, custRowStatus=custRowStatus, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sdpNextFreeId=sdpNextFreeId, prvtSdpNotif=prvtSdpNotif, prvtTMSdpObjs=prvtTMSdpObjs, prvtCustDeleted=prvtCustDeleted, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sapAdminStatus=sapAdminStatus, sdpNumEntries=sdpNumEntries, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, svcRevertTimer=svcRevertTimer, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, ServObjDesc=ServObjDesc, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sdpFarEndIpAddress=sdpFarEndIpAddress, sapOperStatus=sapOperStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, sapIngQosSchedCustName=sapIngQosSchedCustName, VpnId=VpnId, sapType=sapType, ServObjName=ServObjName, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtTMSdpCompliance=prvtTMSdpCompliance, custMultSvcSiteDescription=custMultSvcSiteDescription, sapBaseInfoEntry=sapBaseInfoEntry, svcAdminStatus=svcAdminStatus, prvtTMSapConformance=prvtTMSapConformance, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtSapStatusChanged=prvtSapStatusChanged, sapIngQosQueueId=sapIngQosQueueId, svcDescription=svcDescription, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, sdpLastMgmtChange=sdpLastMgmtChange, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSapGroups=prvtTMSapGroups, prvtTMSapObjs=prvtTMSapObjs, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, svcBaseInfoTable=svcBaseInfoTable, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapIngQosSchedName=sapIngQosSchedName, svcNumSdps=svcNumSdps, custMultiServiceSiteTable=custMultiServiceSiteTable, sapEgrQosCustName=sapEgrQosCustName, svcOperStatus=svcOperStatus, sdpOperStatus=sdpOperStatus, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, prvtTMSapCompliances=prvtTMSapCompliances, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapRowStatus=sapRowStatus, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sapLearnMode=sapLearnMode, sdpOperFlags=sdpOperFlags, prvtTMCustCompliance=prvtTMCustCompliance, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, sdpTransportTunnelName=sdpTransportTunnelName, prvtSvcCreated=prvtSvcCreated, sapLastMgmtChange=sapLastMgmtChange, prvtTMSvcObjs=prvtTMSvcObjs, prvtSdpDeleted=prvtSdpDeleted, sapEgrQosQueueId=sapEgrQosQueueId, prvtSvcDeleted=prvtSvcDeleted, prvtTMCustGroups=prvtTMCustGroups, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpBindVlanTag=sdpBindVlanTag, sdpInfoEntry=sdpInfoEntry, sdpAdminEgressLabel=sdpAdminEgressLabel, prvtServicesMIB=prvtServicesMIB, svcVPLSUplinkTable=svcVPLSUplinkTable, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpLastStatusChange=sdpLastStatusChange, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, sapEgrQosSchedName=sapEgrQosSchedName, sapIngQosCustName=sapIngQosCustName, sdpLabelSignaling=sdpLabelSignaling, sdpOperIsBackup=sdpOperIsBackup, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcStatusChanged=prvtSvcStatusChanged, sdpOutInterface=sdpOutInterface, custIngQosSchedName=custIngQosSchedName, sdpGroupIdentifier=sdpGroupIdentifier, custInfoEntry=custInfoEntry, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcRowStatus=svcRowStatus, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, sdpLdpEnabled=sdpLdpEnabled, custPhone=custPhone, sdpType=sdpType, svcId=svcId, prvtSdpTraps=prvtSdpTraps, sapDescription=sapDescription, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custName=custName, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, sdpMtu=sdpMtu, TSapIngQueueId=TSapIngQueueId, ServiceOperStatus=ServiceOperStatus, svcType=svcType, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMServObjs=prvtTMServObjs, sapEncapValue=sapEncapValue, custMultSvcSiteName=custMultSvcSiteName, prvtTMSvcGroups=prvtTMSvcGroups, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMServConformance=prvtTMServConformance, prvtTMSapCompliance=prvtTMSapCompliance, sdpDescription=sdpDescription, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpAdminIsBackup=sdpAdminIsBackup, sdpVCType=sdpVCType, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, prvtSapTraps=prvtSapTraps, prvtSvcTraps=prvtSvcTraps, svcMtu=svcMtu, SdpIdType=SdpIdType, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, ServiceAdminStatus=ServiceAdminStatus, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcNumSaps=svcNumSaps, sapNumEntries=sapNumEntries, prvtSvcNotif=prvtSvcNotif, prvtTMSvcConformance=prvtTMSvcConformance, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcEnableSecureSaps=svcEnableSecureSaps, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, svcBaseInfoEntry=svcBaseInfoEntry, prvtCustNotif=prvtCustNotif, custEgrQosSchedName=custEgrQosSchedName, prvtTMSvcCompliances=prvtTMSvcCompliances, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, prvtTMCustObjs=prvtTMCustObjs, TSapEgrQueueId=TSapEgrQueueId, TMEncapVal=TMEncapVal, svcCustName=svcCustName, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, ServType=ServType, prvtTMCustConformance=prvtTMCustConformance, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpAdminStatus=sdpAdminStatus, prvtTMSdpGroups=prvtTMSdpGroups, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtSdpStatusChanged=prvtSdpStatusChanged, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custNumEntries=custNumEntries, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, custLastMgmtChange=custLastMgmtChange, sapBaseInfoTable=sapBaseInfoTable, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy)
