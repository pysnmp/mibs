...
TNetworkPolicyIdOrNone, TSapIngressPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, serviceAccessSwitch, TSapEgressPolicyIdOrNone = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TSapIngressPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "serviceAccessSwitch", "TSapEgressPolicyIdOrNone")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosSchedCustName=sapIngQosSchedCustName, custInfoTable=custInfoTable, prvtSvcNotif=prvtSvcNotif, prvtCustDeleted=prvtCustDeleted, prvtTMSapCompliance=prvtTMSapCompliance, sdpOperFlags=sdpOperFlags, prvtTMSvcCompliance=prvtTMSvcCompliance, svcVPLSUplinkEntry=svcVPLSUplinkEntry, prvtTMSapGroups=prvtTMSapGroups, prvtCustNotif=prvtCustNotif, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, prvtSapDeleted=prvtSapDeleted, sapRowStatus=sapRowStatus, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, sdpGroupIdentifier=sdpGroupIdentifier, sapDescription=sapDescription, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapAdminStatus=sapAdminStatus, sdpTransportTunnelName=sdpTransportTunnelName, sdpVCType=sdpVCType, PYSNMP_MODULE_ID=prvtServicesMIB, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, prvtTMCustGroups=prvtTMCustGroups, sdpLdpEnabled=sdpLdpEnabled, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapEncapValue=sapEncapValue, sdpMtu=sdpMtu, prvtTMSdpGroups=prvtTMSdpGroups, TSapIngQueueId=TSapIngQueueId, prvtTMSapCompliances=prvtTMSapCompliances, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpDescription=sdpDescription, prvtTMSdpCompliance=prvtTMSdpCompliance, ServType=ServType, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, sapOperStatus=sapOperStatus, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, prvtSapStatusChanged=prvtSapStatusChanged, prvtSdpCreated=prvtSdpCreated, prvtSdpDeleted=prvtSdpDeleted, prvtTMServConformance=prvtTMServConformance, sapEgrQosQueueId=sapEgrQosQueueId, sapEgrQosSchedName=sapEgrQosSchedName, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, svcNumEntries=svcNumEntries, custContact=custContact, prvtCustCreated=prvtCustCreated, sapIngQosSchedName=sapIngQosSchedName, sdpNumEntries=sdpNumEntries, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, TSapEgrQueueId=TSapEgrQueueId, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, SdpIdType=SdpIdType, prvtServNotifications=prvtServNotifications, sapCustMultSvcSiteName=sapCustMultSvcSiteName, svcVplsMode=svcVplsMode, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, sdpType=sdpType, sdpOperIsBackup=sdpOperIsBackup, svcVpnId=svcVpnId, svcCustName=svcCustName, sdpInfoTable=sdpInfoTable, sdpRowStatus=sdpRowStatus, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, prvtTMSapConformance=prvtTMSapConformance, sapOperFlags=sapOperFlags, prvtTMTstpConformance=prvtTMTstpConformance, prvtTMSvcConformance=prvtTMSvcConformance, svcRevertTimer=svcRevertTimer, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcDescription=svcDescription, svcLastMgmtChange=svcLastMgmtChange, prvtSvcCreated=prvtSvcCreated, sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, sdpLastStatusChange=sdpLastStatusChange, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtSapCreated=prvtSapCreated, TMEncapVal=TMEncapVal, prvtTMCustCompliances=prvtTMCustCompliances, prvtTMCustCompliance=prvtTMCustCompliance, svcVPLSUplinkTable=svcVPLSUplinkTable, svcRowStatus=svcRowStatus, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, VpnId=VpnId, custPhone=custPhone, custLastMgmtChange=custLastMgmtChange, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, sdpId=sdpId, sapEgressQosPolicyId=sapEgressQosPolicyId, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, sdpBindVlanTag=sdpBindVlanTag, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, sdpAdminEgressLabel=sdpAdminEgressLabel, sapLearnMode=sapLearnMode, prvtTMCustObjs=prvtTMCustObjs, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sdpAdminStatus=sdpAdminStatus, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, prvtTMSvcGroups=prvtTMSvcGroups, custEgrQosSchedName=custEgrQosSchedName, sapBaseInfoTable=sapBaseInfoTable, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, svcMtu=svcMtu, prvtSapNotif=prvtSapNotif, sapType=sapType, svcAdminStatus=svcAdminStatus, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, prvtTMSvcObjs=prvtTMSvcObjs, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, sapPortId=sapPortId, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, custName=custName, prvtSdpStatusChanged=prvtSdpStatusChanged, sdpLabelSignaling=sdpLabelSignaling, sdpLastMgmtChange=sdpLastMgmtChange, svcBaseInfoEntry=svcBaseInfoEntry, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, custMultiServiceSiteTable=custMultiServiceSiteTable, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, sdpAdminIsBackup=sdpAdminIsBackup, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, prvtTMSapObjs=prvtTMSapObjs, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, ServObjDesc=ServObjDesc, prvtSvcTraps=prvtSvcTraps, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, svcOperStatus=svcOperStatus, prvtSvcStatusChanged=prvtSvcStatusChanged, ServiceOperStatus=ServiceOperStatus, custIngQosSchedName=custIngQosSchedName, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, prvtServicesMIB=prvtServicesMIB, prvtSdpTraps=prvtSdpTraps, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sapNumEntries=sapNumEntries, prvtTMSdpConformance=prvtTMSdpConformance, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcId=svcId, svcEnableSecureSaps=svcEnableSecureSaps, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, prvtCustTraps=prvtCustTraps, prvtTMCustConformance=prvtTMCustConformance, svcNumSaps=svcNumSaps, sapEgrQosSchedCustName=sapEgrQosSchedCustName, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, sdpOutInterface=sdpOutInterface, svcLastStatusChange=svcLastStatusChange, prvtTMServObjs=prvtTMServObjs, sdpNextFreeId=sdpNextFreeId, custInfoEntry=custInfoEntry, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, sdpFarEndIpAddress=sdpFarEndIpAddress, ServiceAdminStatus=ServiceAdminStatus, sdpOperStatus=sdpOperStatus, prvtSapTraps=prvtSapTraps, svcType=svcType, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, sapIngressQosPolicyId=sapIngressQosPolicyId, custRowStatus=custRowStatus, custMultSvcSiteDescription=custMultSvcSiteDescription, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, sdpInfoEntry=sdpInfoEntry, prvtTMSdpCompliances=prvtTMSdpCompliances, prvtSdpNotif=prvtSdpNotif, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets, custMultSvcSiteName=custMultSvcSiteName, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtSvcDeleted=prvtSvcDeleted, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, sapBaseInfoEntry=sapBaseInfoEntry, sdpDelivery=sdpDelivery, sapEgrQosCustName=sapEgrQosCustName, sapLastMgmtChange=sapLastMgmtChange, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, custNumEntries=custNumEntries, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, svcBaseInfoTable=svcBaseInfoTable, prvtTMSvcCompliances=prvtTMSvcCompliances, sapIngQosCustName=sapIngQosCustName, ServObjName=ServObjName, sapIngQosQueueId=sapIngQosQueueId, svcNumSdps=svcNumSdps)
