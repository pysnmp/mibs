...
TNetworkPolicyIdOrNone, TNamedItemOrEmpty, TNamedItem, TSapIngressPolicyIdOrNone, TSapEgressPolicyIdOrNone, serviceAccessSwitch = mibBuilder.importSymbols("PRVT-QOS-MIB", "TNetworkPolicyIdOrNone", "TNamedItemOrEmpty", "TNamedItem", "TSapIngressPolicyIdOrNone", "TSapEgressPolicyIdOrNone", "serviceAccessSwitch")
...
mibBuilder.exportSymbols("PRVT-SERV-MIB", sapIngQosQueueStatsForwardedInProfPackets=sapIngQosQueueStatsForwardedInProfPackets, svcType=svcType, custInfoTable=custInfoTable, prvtTMSdpGroups=prvtTMSdpGroups, prvtTMCustCompliances=prvtTMCustCompliances, ServiceOperStatus=ServiceOperStatus, prvtServNotifications=prvtServNotifications, sdpId=sdpId, sapIngQosQueueStatsOfferedLoPrioPackets=sapIngQosQueueStatsOfferedLoPrioPackets, TSapIngQueueId=TSapIngQueueId, svcOperStatus=svcOperStatus, sapEgrQosQueueStatsEntry=sapEgrQosQueueStatsEntry, sapEgrQosQueueStatsDroppedOctets=sapEgrQosQueueStatsDroppedOctets, sapOperFlags=sapOperFlags, prvtTMSapConformance=prvtTMSapConformance, sapIngressQosSchedulerPolicy=sapIngressQosSchedulerPolicy, sdpInfoTable=sdpInfoTable, VpnId=VpnId, custMultSvcSiteIngressSchedulerPolicy=custMultSvcSiteIngressSchedulerPolicy, sdpLastMgmtChange=sdpLastMgmtChange, custRowStatus=custRowStatus, prvtTMSdpObjs=prvtTMSdpObjs, custEgrQosPortIdSchedStatsEntry=custEgrQosPortIdSchedStatsEntry, svcLastMgmtChange=svcLastMgmtChange, sdpInfoEntry=sdpInfoEntry, sdpIsPwStatusSignalingEnable=sdpIsPwStatusSignalingEnable, prvtSvcDeleted=prvtSvcDeleted, sdpLastStatusChange=sdpLastStatusChange, prvtTMSapObjs=prvtTMSapObjs, sapBaseInfoEntry=sapBaseInfoEntry, sapEgrQosQueueStatsDroppedPackets=sapEgrQosQueueStatsDroppedPackets, sdpOperFlags=sdpOperFlags, sapIngQosQueueStatsOfferedHiPrioOctets=sapIngQosQueueStatsOfferedHiPrioOctets, sapEgrQosQueueId=sapEgrQosQueueId, prvtSvcNotif=prvtSvcNotif, sapIngQosQueueStatsDroppedOctets=sapIngQosQueueStatsDroppedOctets, sdpLabelSignaling=sdpLabelSignaling, svcVPLSUplinkNetworkQueueEgressPolicy=svcVPLSUplinkNetworkQueueEgressPolicy, prvtTMSapGroups=prvtTMSapGroups, prvtTMCustConformance=prvtTMCustConformance, svcVPLSUplinkIfIndex=svcVPLSUplinkIfIndex, sapNumEntries=sapNumEntries, sapEgrQosSchedCustName=sapEgrQosSchedCustName, prvtSvcCreated=prvtSvcCreated, svcDescription=svcDescription, svcEnableSecureSaps=svcEnableSecureSaps, custPhone=custPhone, custEgrQosAssignmentPortId=custEgrQosAssignmentPortId, custNumEntries=custNumEntries, custMultSvcSiteName=custMultSvcSiteName, custMultiSvcSiteIngQosSchedStatsTable=custMultiSvcSiteIngQosSchedStatsTable, sdpOperStatus=sdpOperStatus, prvtCustCreated=prvtCustCreated, sapIngQosSchedStatsForwardedPackets=sapIngQosSchedStatsForwardedPackets, sapIngQosQueueStatsOfferedLoPrioOctets=sapIngQosQueueStatsOfferedLoPrioOctets, sapIngQosSchedName=sapIngQosSchedName, custMultSvcSiteRowStatus=custMultSvcSiteRowStatus, sdpDelivery=sdpDelivery, sapRowStatus=sapRowStatus, sdpDescription=sdpDescription, svcMtu=svcMtu, custIngQosPortIdSchedStatsEntry=custIngQosPortIdSchedStatsEntry, svcNumSaps=svcNumSaps, sapEgrQosSchedStatsForwardedPackets=sapEgrQosSchedStatsForwardedPackets, svcVPLSUplinkShaperProfile=svcVPLSUplinkShaperProfile, prvtSdpStatusChanged=prvtSdpStatusChanged, prvtSapNotif=prvtSapNotif, sapIngressQosPolicyId=sapIngressQosPolicyId, sdpEpsAdminIsSecondary=sdpEpsAdminIsSecondary, sapEgrQosQueueStatsForwardedOutProfPackets=sapEgrQosQueueStatsForwardedOutProfPackets, prvtSapStatusChanged=prvtSapStatusChanged, custContact=custContact, sdpFarEndIpAddress=sdpFarEndIpAddress, PYSNMP_MODULE_ID=prvtServicesMIB, sapIngQosQueueStatsOfferedHiPrioPackets=sapIngQosQueueStatsOfferedHiPrioPackets, custEgrQosPortSchedFwdPkts=custEgrQosPortSchedFwdPkts, custIngQosSchedName=custIngQosSchedName, sdpRowStatus=sdpRowStatus, sapEgressQosPolicyId=sapEgressQosPolicyId, sapIngQosSchedStatsTable=sapIngQosSchedStatsTable, prvtTMSvcGlobalGroup=prvtTMSvcGlobalGroup, prvtTMServObjs=prvtTMServObjs, sdpAdminEgressLabel=sdpAdminEgressLabel, custIngQosPortSchedFwdPkts=custIngQosPortSchedFwdPkts, prvtSapTraps=prvtSapTraps, prvtCustDeleted=prvtCustDeleted, custEgrQosSchedName=custEgrQosSchedName, TMEncapVal=TMEncapVal, sapEgressQosSchedulerPolicy=sapEgressQosSchedulerPolicy, prvtTMSdpCompliance=prvtTMSdpCompliance, custIngQosAssignmentPortId=custIngQosAssignmentPortId, sapPortId=sapPortId, svcRowStatus=svcRowStatus, svcVPLSUplinkNetworkPolicy=svcVPLSUplinkNetworkPolicy, prvtTMCustGroups=prvtTMCustGroups, custIngQosSchedStatsForwardedPackets=custIngQosSchedStatsForwardedPackets, prvtSdpNotif=prvtSdpNotif, prvtSvcStatusChanged=prvtSvcStatusChanged, custIngQosSchedStatsForwardedOctets=custIngQosSchedStatsForwardedOctets, sapIngQosSchedCustName=sapIngQosSchedCustName, sdpType=sdpType, sapIngQosCustName=sapIngQosCustName, custName=custName, sdpVCType=sdpVCType, prvtTMSapGlobalGroup=prvtTMSapGlobalGroup, prvtTMServConformance=prvtTMServConformance, custIngQosPortSchedFwdOctets=custIngQosPortSchedFwdOctets, svcVPLSUplinkTable=svcVPLSUplinkTable, sapType=sapType, sapIngQosQueueStatsForwardedOutProfOctets=sapIngQosQueueStatsForwardedOutProfOctets, TSapEgrQueueId=TSapEgrQueueId, prvtSapCreated=prvtSapCreated, custMultiServiceSiteEntry=custMultiServiceSiteEntry, sapDescription=sapDescription, ServObjName=ServObjName, prvtServicesMIB=prvtServicesMIB, sapAdminStatus=sapAdminStatus, custMultiSvcSiteEgrQosSchedStatsTable=custMultiSvcSiteEgrQosSchedStatsTable, svcBaseInfoTable=svcBaseInfoTable, prvtTMSvcObjs=prvtTMSvcObjs, prvtSdpCreated=prvtSdpCreated, SdpIdType=SdpIdType, sapEgrQosQueueStatsForwardedInProfOctets=sapEgrQosQueueStatsForwardedInProfOctets, sdpGroupIdentifier=sdpGroupIdentifier, sapIngQosQueueStatsTable=sapIngQosQueueStatsTable, custEgrQosPortSchedFwdOctets=custEgrQosPortSchedFwdOctets, prvtTMServVPLSGlobals=prvtTMServVPLSGlobals, prvtCustNotif=prvtCustNotif, sapIngQosQueueId=sapIngQosQueueId, prvtTMSdpCompliances=prvtTMSdpCompliances, sdpNumEntries=sdpNumEntries, svcAdminStatus=svcAdminStatus, sdpOutInterface=sdpOutInterface, prvtTMSapCompliance=prvtTMSapCompliance, prvtSapDeleted=prvtSapDeleted, prvtTMSvcGroups=prvtTMSvcGroups, prvtTMCustGlobalGroup=prvtTMCustGlobalGroup, svcVplsMode=svcVplsMode, custMultSvcSiteDescription=custMultSvcSiteDescription, sdpNextFreeId=sdpNextFreeId, prvtCustTraps=prvtCustTraps, svcNumSdps=svcNumSdps, svcRevertTimer=svcRevertTimer, prvtTMSvcNotificationGroup=prvtTMSvcNotificationGroup, prvtTMCustObjs=prvtTMCustObjs, svcLastStatusChange=svcLastStatusChange, sapEgrQosQueueStatsTable=sapEgrQosQueueStatsTable, custEgrQosPortIdSchedStatsTable=custEgrQosPortIdSchedStatsTable, sapEgrQosQueueStatsForwardedOutProfOctets=sapEgrQosQueueStatsForwardedOutProfOctets, svcVPLSUplinkPortID=svcVPLSUplinkPortID, sapLastMgmtChange=sapLastMgmtChange, sapEgrQosCustName=sapEgrQosCustName, prvtTMSvcConformance=prvtTMSvcConformance, custIngQosPortIdSchedName=custIngQosPortIdSchedName, sapOperStatus=sapOperStatus, sdpAdminIngressLabel=sdpAdminIngressLabel, prvtTMSapCompliances=prvtTMSapCompliances, sapIngQosSchedStatsForwardedOctets=sapIngQosSchedStatsForwardedOctets, prvtTMSvcCompliances=prvtTMSvcCompliances, ServObjDesc=ServObjDesc, sdpTransportTunnelName=sdpTransportTunnelName, sdpLdpEnabled=sdpLdpEnabled, sdpEpsAdminIsPrimary=sdpEpsAdminIsPrimary, custEgrQosSchedStatsForwardedOctets=custEgrQosSchedStatsForwardedOctets, svcVpnId=svcVpnId, sapEgrQosQueueStatsForwardedInProfPackets=sapEgrQosQueueStatsForwardedInProfPackets, ServiceAdminStatus=ServiceAdminStatus, custIngQosPortIdSchedStatsTable=custIngQosPortIdSchedStatsTable, custEgrQosSchedStatsForwardedPackets=custEgrQosSchedStatsForwardedPackets, svcCustName=svcCustName, custLastMgmtChange=custLastMgmtChange, sdpBindVlanTag=sdpBindVlanTag, sapIngQosQueueStatsDroppedPackets=sapIngQosQueueStatsDroppedPackets, ServType=ServType, sapEgrQosSchedName=sapEgrQosSchedName, prvtSvcTraps=prvtSvcTraps, svcVPLSUplinkEntry=svcVPLSUplinkEntry, sapLearnMode=sapLearnMode, prvtSdpDeleted=prvtSdpDeleted, sdpMtu=sdpMtu, sdpAdminStatus=sdpAdminStatus, custInfoEntry=custInfoEntry, sapIngQosQueueStatsEntry=sapIngQosQueueStatsEntry, custMultiServiceSiteTable=custMultiServiceSiteTable, prvtTMSdpConformance=prvtTMSdpConformance, custMultSvcSiteLastMgmtChange=custMultSvcSiteLastMgmtChange, sapIngQosQueueStatsForwardedOutProfPackets=sapIngQosQueueStatsForwardedOutProfPackets, sapEncapValue=sapEncapValue, sdpOperIsBackup=sdpOperIsBackup, svcNumEntries=svcNumEntries, prvtTMSapNotificationGroup=prvtTMSapNotificationGroup, prvtSdpTraps=prvtSdpTraps, sapEgrQosSchedStatsForwardedOctets=sapEgrQosSchedStatsForwardedOctets, svcId=svcId, sapBaseInfoTable=sapBaseInfoTable, prvtTMSvcCompliance=prvtTMSvcCompliance, custMultiSvcSiteEgrQosSchedStatsEntry=custMultiSvcSiteEgrQosSchedStatsEntry, svcBaseInfoEntry=svcBaseInfoEntry, sapIngQosSchedStatsEntry=sapIngQosSchedStatsEntry, custEgrQosPortIdSchedName=custEgrQosPortIdSchedName, sapEgrQosSchedStatsEntry=sapEgrQosSchedStatsEntry, sdpAdminIsBackup=sdpAdminIsBackup, prvtTMCustCompliance=prvtTMCustCompliance, sapEgrQosSchedStatsTable=sapEgrQosSchedStatsTable, prvtTMSdpGlobalGroup=prvtTMSdpGlobalGroup, prvtTMTstpConformance=prvtTMTstpConformance, custMultiSvcSiteIngQosSchedStatsEntry=custMultiSvcSiteIngQosSchedStatsEntry, custMultSvcSiteEgressSchedulerPolicy=custMultSvcSiteEgressSchedulerPolicy, sapCustMultSvcSiteName=sapCustMultSvcSiteName, sapIngQosQueueStatsForwardedInProfOctets=sapIngQosQueueStatsForwardedInProfOctets)
