...
mibBuilder.exportSymbols("STE2-MIB", UnitType=UnitType, SensorSN=SensorSN, x390=x390, SensorString=SensorString, inpIndex=inpIndex, inpAlarmState=inpAlarmState, SensorName=SensorName, inpValue=inpValue, PositiveInteger=PositiveInteger, info=info, sensIndex=sensIndex, sensSN=sensSN, sensValue=sensValue, inpEntry=inpEntry, sensState=sensState, sensEntry=sensEntry, sensUnit=sensUnit, SensorState=SensorState, sensTable=sensTable, SensorID=SensorID, InputAlarmState=InputAlarmState, hwgroup=hwgroup, infoAddressMAC=infoAddressMAC, sensID=sensID, IOName=IOName, inpName=inpName, sensString=sensString, sensName=sensName, OnOff=OnOff, SensorValue=SensorValue, inpTable=inpTable, ste2=ste2)
