...
mibBuilder.exportSymbols("STE2-MIB", hwgroup=hwgroup, sensEntry=sensEntry, SensorState=SensorState, SensorSN=SensorSN, sensString=sensString, SensorID=SensorID, inpName=inpName, sensValue=sensValue, SensorValue=SensorValue, info=info, PositiveInteger=PositiveInteger, x390=x390, sensUnit=sensUnit, infoAddressMAC=infoAddressMAC, SensorString=SensorString, SensorName=SensorName, inpIndex=inpIndex, sensTable=sensTable, inpAlarmState=inpAlarmState, sensIndex=sensIndex, sensSN=sensSN, IOName=IOName, inpTable=inpTable, sensName=sensName, UnitType=UnitType, inpValue=inpValue, inpEntry=inpEntry, OnOff=OnOff, ste2=ste2, sensState=sensState, InputAlarmState=InputAlarmState, sensID=sensID)
