...
mibBuilder.exportSymbols("STE2-MIB", infoAddressMAC=infoAddressMAC, SensorString=SensorString, OnOff=OnOff, IOName=IOName, sensString=sensString, SensorSN=SensorSN, inpAlarmState=inpAlarmState, InputAlarmState=InputAlarmState, SensorID=SensorID, inpValue=inpValue, inpIndex=inpIndex, sensIndex=sensIndex, ste2=ste2, x390=x390, sensTable=sensTable, sensUnit=sensUnit, info=info, inpName=inpName, sensName=sensName, sensID=sensID, SensorState=SensorState, sensValue=sensValue, SensorValue=SensorValue, PositiveInteger=PositiveInteger, sensSN=sensSN, hwgroup=hwgroup, inpTable=inpTable, sensState=sensState, UnitType=UnitType, inpEntry=inpEntry, SensorName=SensorName, sensEntry=sensEntry)
