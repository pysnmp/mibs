...
mibBuilder.exportSymbols("STE2-MIB", sensEntry=sensEntry, UnitType=UnitType, IOName=IOName, sensState=sensState, sensName=sensName, inpValue=inpValue, SensorValue=SensorValue, sensIndex=sensIndex, InputAlarmState=InputAlarmState, inpTable=inpTable, inpEntry=inpEntry, SensorState=SensorState, sensString=sensString, inpIndex=inpIndex, info=info, SensorSN=SensorSN, PositiveInteger=PositiveInteger, sensValue=sensValue, OnOff=OnOff, SensorName=SensorName, sensUnit=sensUnit, SensorString=SensorString, sensSN=sensSN, x390=x390, hwgroup=hwgroup, sensTable=sensTable, ste2=ste2, inpName=inpName, sensID=sensID, SensorID=SensorID, infoAddressMAC=infoAddressMAC, inpAlarmState=inpAlarmState)
