...
mibBuilder.exportSymbols("STE2-MIB", SensorID=SensorID, SensorSN=SensorSN, IOName=IOName, OnOff=OnOff, inpIndex=inpIndex, sensID=sensID, inpName=inpName, SensorValue=SensorValue, hwgroup=hwgroup, sensIndex=sensIndex, InputAlarmState=InputAlarmState, inpEntry=inpEntry, sensSN=sensSN, sensName=sensName, UnitType=UnitType, ste2=ste2, SensorState=SensorState, sensString=sensString, inpValue=inpValue, sensUnit=sensUnit, SensorString=SensorString, x390=x390, sensEntry=sensEntry, sensState=sensState, sensValue=sensValue, SensorName=SensorName, sensTable=sensTable, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, info=info, infoAddressMAC=infoAddressMAC, inpTable=inpTable)
