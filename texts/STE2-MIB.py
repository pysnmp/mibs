...
mibBuilder.exportSymbols("STE2-MIB", SensorID=SensorID, sensValue=sensValue, sensName=sensName, inpIndex=inpIndex, UnitType=UnitType, sensState=sensState, sensString=sensString, ste2=ste2, sensIndex=sensIndex, sensTable=sensTable, SensorState=SensorState, x390=x390, sensSN=sensSN, InputAlarmState=InputAlarmState, inpEntry=inpEntry, SensorValue=SensorValue, SensorString=SensorString, inpAlarmState=inpAlarmState, PositiveInteger=PositiveInteger, inpValue=inpValue, sensID=sensID, infoAddressMAC=infoAddressMAC, sensEntry=sensEntry, sensUnit=sensUnit, inpTable=inpTable, hwgroup=hwgroup, IOName=IOName, SensorSN=SensorSN, info=info, SensorName=SensorName, inpName=inpName, OnOff=OnOff)
