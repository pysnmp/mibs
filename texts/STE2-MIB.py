...
mibBuilder.exportSymbols("STE2-MIB", sensIndex=sensIndex, sensName=sensName, SensorValue=SensorValue, inpAlarmState=inpAlarmState, info=info, inpName=inpName, inpIndex=inpIndex, PositiveInteger=PositiveInteger, ste2=ste2, x390=x390, sensID=sensID, sensUnit=sensUnit, SensorState=SensorState, sensSN=sensSN, InputAlarmState=InputAlarmState, SensorID=SensorID, sensEntry=sensEntry, sensTable=sensTable, OnOff=OnOff, UnitType=UnitType, inpValue=inpValue, hwgroup=hwgroup, sensString=sensString, sensValue=sensValue, inpEntry=inpEntry, IOName=IOName, SensorSN=SensorSN, SensorString=SensorString, infoAddressMAC=infoAddressMAC, inpTable=inpTable, sensState=sensState, SensorName=SensorName)
