...
# ASN.1 source MDS-SERVICES-MIB
# Source digest sha256:13ed54f6393b26cf68cd0b1e2bdb65fed02525b383c341edb637c53cc8edeb1f
...
if mibBuilder.loadTexts: mdsServicesMIB.setLastUpdated('2018-05-16 00:00')
...
mServStatusTable = MibTable((1, 3, 6, 1, 4, 1, 4130, 10, 3, 1, 1, 2, 1), ).setMaxAccess("notaccessible")
...
mServStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 4130, 10, 3, 1, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "MDS-SERVICES-MIB", "mServServiceName"))
...
mibBuilder.exportSymbols("MDS-SERVICES-MIB", PYSNMP_MODULE_ID=mdsServicesMIB, mServCompliance=mServCompliance, mServConfig=mServConfig, mServMIBObjects=mServMIBObjects, mServServiceName=mServServiceName, mServServiceStatus=mServServiceStatus, mServStatus=mServStatus, mServStatusEntry=mServStatusEntry, mServStatusGroup=mServStatusGroup, mServStatusTable=mServStatusTable, mdsServMIBCompliances=mdsServMIBCompliances, mdsServMIBConformance=mdsServMIBConformance, mdsServMIBGroups=mdsServMIBGroups, mdsServicesMIB=mdsServicesMIB)
