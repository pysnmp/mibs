...
# ASN.1 source CISCO-DMN-DSG-IPV4V6-MIB
# Source digest sha256:5d9c79fe68b68583967ccb1d0e10a67a70d4f47cca06ba287e7ae2f6e5d592aa
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: ciscoDSGIPv4v6.setRevisionsDescriptions(('V01.00.05 2012-03-20\n                    Updated for D9854 R4 Release.', 'V01.00.04 2010-08-30\n                   Updated for adherence to SNMPv2 format.', 'V01.00.03 2010-04-30\n                    The access type of ipConfigV4V6Flag is changed to\n                    read-only.\n                    IPV6 settings objects are commented.', 'V01.00.02 2010-04-12\n                    New IP config (IPV6) objects are added.', 'V01.00.01 2010-03-22\n                    The Syntax of Unsigned32 MIB objects whose range is\n                    within the range of Integer32, is updated to\n                    Integer32.', 'V01.00.00 2009-12-20\n                    Initial Version.',))
if mibBuilder.loadTexts: ciscoDSGIPv4v6.setLastUpdated('2012-03-20 11:00')
if mibBuilder.loadTexts: ciscoDSGIPv4v6.setOrganization('Cisco Systems, Inc.')
if mibBuilder.loadTexts: ciscoDSGIPv4v6.setContactInfo('Cisco Systems, Inc.\n        Customer Service\n        Postal: 170 W Tasman Drive\n        San Jose, CA 95134\n        USA\n        Tel: +1 800 553 NETS\n\n        E-mail: cs-ipsla@cisco.com')
...
macInfoTable = MibTable((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 1), ).setMaxAccess("notaccessible")
...
macInfoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DMN-DSG-IPV4V6-MIB", "macInfoMacIndex"))
...
ipConfigTable = MibTable((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 2), ).setMaxAccess("notaccessible")
...
ipConfigEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DMN-DSG-IPV4V6-MIB", "ipConfigPortIdKey"))
...
if mibBuilder.loadTexts: ipConfigCurIPAddressV4.setDescription('The decoder IPv4 address.\n          Format: ###.###.###.###, Range of ### is 0 to 255.')
...
if mibBuilder.loadTexts: ipConfigCurDefaultGatewayV4.setDescription('The default gateway IPv4 address.\n          Format: ###.###.###.###, Range of ### is 0 to 255.')
...
ethBackupTable = MibTable((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 3), ).setMaxAccess("notaccessible")
...
ethBackupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DMN-DSG-IPV4V6-MIB", "ethBackupIndex"))
...
ethBackupStatusTable = MibTable((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 4), ).setMaxAccess("notaccessible")
...
ethBackupStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 1429, 2, 2, 5, 25, 2, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-DMN-DSG-IPV4V6-MIB", "ethBackupStatusIndex"))
...
mibBuilder.exportSymbols("CISCO-DMN-DSG-IPV4V6-MIB", PYSNMP_MODULE_ID=ciscoDSGIPv4v6, ciscoDSGIPv4v6=ciscoDSGIPv4v6, ethBackupDelayBack=ethBackupDelayBack, ethBackupDelayForward=ethBackupDelayForward, ethBackupDirection=ethBackupDirection, ethBackupEntry=ethBackupEntry, ethBackupIndex=ethBackupIndex, ethBackupMode=ethBackupMode, ethBackupStatusChangeDateTime=ethBackupStatusChangeDateTime, ethBackupStatusChangeReason=ethBackupStatusChangeReason, ethBackupStatusEntry=ethBackupStatusEntry, ethBackupStatusIndex=ethBackupStatusIndex, ethBackupStatusPortsInUse=ethBackupStatusPortsInUse, ethBackupStatusTable=ethBackupStatusTable, ethBackupTable=ethBackupTable, ethStatusDuplex=ethStatusDuplex, ethStatusLink=ethStatusLink, ethStatusSpeed=ethStatusSpeed, ethStatusXover=ethStatusXover, ipConfigCurDefaultGatewayV4=ipConfigCurDefaultGatewayV4, ipConfigCurIPAddressV4=ipConfigCurIPAddressV4, ipConfigCurNetworkMaskV4=ipConfigCurNetworkMaskV4, ipConfigEntry=ipConfigEntry, ipConfigName=ipConfigName, ipConfigPortIdKey=ipConfigPortIdKey, ipConfigPortMode=ipConfigPortMode, ipConfigTable=ipConfigTable, ipConfigV4V6Flag=ipConfigV4V6Flag, ipV4v6Table=ipV4v6Table, macInfoEntry=macInfoEntry, macInfoMacAddr=macInfoMacAddr, macInfoMacIndex=macInfoMacIndex, macInfoTable=macInfoTable)
