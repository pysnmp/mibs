...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:08:26 2023
...
ModuleIdentity, Gauge32, Counter32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, NotificationType, enterprises, TimeTicks, iso, IpAddress, Unsigned32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Counter32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "NotificationType", "enterprises", "TimeTicks", "iso", "IpAddress", "Unsigned32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", siteName=siteName, version=version, portIndex=portIndex, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrap=snmpTrap, slaveIPport=slaveIPport, nbParStop=nbParStop, snmpTrapAddr1=snmpTrapAddr1, ipServer=ipServer, txIdle=txIdle, secondIpAddress=secondIpAddress, nameServer1=nameServer1, tcpPort=tcpPort, radiusSecret2=radiusSecret2, acctRad1=acctRad1, portStatsEntry=portStatsEntry, ethernetAddress=ethernetAddress, dtrUp=dtrUp, nameResolution=nameResolution, baudRate=baudRate, ipNetmask=ipNetmask, snmpdService=snmpdService, resetByButton=resetByButton, dtrDown=dtrDown, portStatsTable=portStatsTable, formFeed=formFeed, system=system, authRad1=authRad1, aliasIpNetmask=aliasIpNetmask, portTable=portTable, radiusSecret1=radiusSecret1, cxr=cxr, slaveIPaddr=slaveIPaddr, httpdService=httpdService, remoteIpAddress=remoteIpAddress, modbusEntry=modbusEntry, telnetdService=telnetdService, terminalType=terminalType, beforeSend=beforeSend, reset=reset, rxIdle=rxIdle, acctRad2=acctRad2, mainIpAddress=mainIpAddress, productName=productName, gatewayToRemote=gatewayToRemote, remoteTcpPort=remoteTcpPort, portEntry=portEntry, ipGateway=ipGateway, bytesSendToV24=bytesSendToV24, aliasIpAddress=aliasIpAddress, afterSend=afterSend, slaveHexaAddress=slaveHexaAddress, radiusServer2=radiusServer2, radiusServer1=radiusServer1, modbusTable=modbusTable, authType=authType, snmpTrapAddr2=snmpTrapAddr2, modbusMode=modbusMode, statusDTR=statusDTR, bootp=bootp, timeoutRxTx=timeoutRxTx, ts=ts, sessionStarted=sessionStarted, authRad2=authRad2, secondGateway=secondGateway, flowControl=flowControl, secondTcpPort=secondTcpPort, ftpdService=ftpdService, sessionStopped=sessionStopped, multiSession=multiSession, interFrame=interFrame, modbusType=modbusType, endMsg=endMsg, mode=mode, timeoutPAD=timeoutPAD, portReset=portReset, nameServer2=nameServer2)
