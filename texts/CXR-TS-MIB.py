...
Counter32, Unsigned32, NotificationType, Integer32, Gauge32, Counter64, Bits, IpAddress, enterprises, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "NotificationType", "Integer32", "Gauge32", "Counter64", "Bits", "IpAddress", "enterprises", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusTable=modbusTable, timeoutRxTx=timeoutRxTx, ethernetAddress=ethernetAddress, ts=ts, authType=authType, txIdle=txIdle, snmpTrap=snmpTrap, nameServer2=nameServer2, system=system, authRad1=authRad1, timeoutPAD=timeoutPAD, version=version, dtrDown=dtrDown, siteName=siteName, multiSession=multiSession, sessionStopped=sessionStopped, cxr=cxr, authRad2=authRad2, beforeSend=beforeSend, statusDTR=statusDTR, ftpdService=ftpdService, resetByButton=resetByButton, tcpPort=tcpPort, afterSend=afterSend, snmpdService=snmpdService, nameResolution=nameResolution, radiusServer2=radiusServer2, remoteTcpPort=remoteTcpPort, modbusType=modbusType, mainIpAddress=mainIpAddress, slaveIPaddr=slaveIPaddr, ipGateway=ipGateway, portStatsTable=portStatsTable, productName=productName, flowControl=flowControl, portReset=portReset, baudRate=baudRate, rxIdle=rxIdle, terminalType=terminalType, acctRad2=acctRad2, bytesSendToV24=bytesSendToV24, aliasIpNetmask=aliasIpNetmask, portTable=portTable, portStatsEntry=portStatsEntry, httpdService=httpdService, endMsg=endMsg, modbusEntry=modbusEntry, slaveIPport=slaveIPport, bytesReceiveFromV24=bytesReceiveFromV24, secondTcpPort=secondTcpPort, snmpTrapAddr1=snmpTrapAddr1, gatewayToRemote=gatewayToRemote, formFeed=formFeed, slaveHexaAddress=slaveHexaAddress, sessionStarted=sessionStarted, modbusMode=modbusMode, dtrUp=dtrUp, ipNetmask=ipNetmask, mode=mode, ipServer=ipServer, telnetdService=telnetdService, portIndex=portIndex, aliasIpAddress=aliasIpAddress, radiusSecret1=radiusSecret1, nbParStop=nbParStop, secondIpAddress=secondIpAddress, radiusServer1=radiusServer1, remoteIpAddress=remoteIpAddress, bootp=bootp, nameServer1=nameServer1, reset=reset, radiusSecret2=radiusSecret2, portEntry=portEntry, acctRad1=acctRad1, secondGateway=secondGateway, interFrame=interFrame, snmpTrapAddr2=snmpTrapAddr2)
