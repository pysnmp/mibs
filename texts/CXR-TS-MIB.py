...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:33:48 2024
...
Integer32, Unsigned32, IpAddress, Counter32, iso, ModuleIdentity, MibIdentifier, Bits, Counter64, NotificationType, Gauge32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "IpAddress", "Counter32", "iso", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "NotificationType", "Gauge32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", aliasIpAddress=aliasIpAddress, sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, endMsg=endMsg, remoteIpAddress=remoteIpAddress, nbParStop=nbParStop, acctRad2=acctRad2, gatewayToRemote=gatewayToRemote, radiusServer2=radiusServer2, modbusType=modbusType, secondGateway=secondGateway, dtrDown=dtrDown, multiSession=multiSession, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrap=snmpTrap, afterSend=afterSend, slaveIPaddr=slaveIPaddr, portIndex=portIndex, mode=mode, system=system, resetByButton=resetByButton, baudRate=baudRate, version=version, authType=authType, timeoutRxTx=timeoutRxTx, radiusServer1=radiusServer1, statusDTR=statusDTR, mainIpAddress=mainIpAddress, sessionStopped=sessionStopped, siteName=siteName, nameServer2=nameServer2, ipGateway=ipGateway, tcpPort=tcpPort, ftpdService=ftpdService, rxIdle=rxIdle, interFrame=interFrame, modbusEntry=modbusEntry, modbusTable=modbusTable, timeoutPAD=timeoutPAD, authRad2=authRad2, formFeed=formFeed, telnetdService=telnetdService, acctRad1=acctRad1, secondIpAddress=secondIpAddress, ts=ts, flowControl=flowControl, snmpTrapAddr2=snmpTrapAddr2, beforeSend=beforeSend, secondTcpPort=secondTcpPort, bytesSendToV24=bytesSendToV24, portStatsEntry=portStatsEntry, productName=productName, snmpdService=snmpdService, nameServer1=nameServer1, terminalType=terminalType, portEntry=portEntry, txIdle=txIdle, nameResolution=nameResolution, authRad1=authRad1, httpdService=httpdService, slaveIPport=slaveIPport, reset=reset, ipServer=ipServer, portStatsTable=portStatsTable, radiusSecret1=radiusSecret1, portReset=portReset, portTable=portTable, snmpTrapAddr1=snmpTrapAddr1, modbusMode=modbusMode, cxr=cxr, ethernetAddress=ethernetAddress, remoteTcpPort=remoteTcpPort, bootp=bootp, dtrUp=dtrUp, slaveHexaAddress=slaveHexaAddress, ipNetmask=ipNetmask, aliasIpNetmask=aliasIpNetmask)
