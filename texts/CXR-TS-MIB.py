...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:03:43 2024
...
enterprises, Counter32, Gauge32, Bits, TimeTicks, ObjectIdentity, ModuleIdentity, Integer32, MibIdentifier, Unsigned32, Counter64, iso, NotificationType, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Gauge32", "Bits", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Integer32", "MibIdentifier", "Unsigned32", "Counter64", "iso", "NotificationType", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", aliasIpNetmask=aliasIpNetmask, acctRad1=acctRad1, txIdle=txIdle, ts=ts, authType=authType, siteName=siteName, bytesReceiveFromV24=bytesReceiveFromV24, mode=mode, bootp=bootp, remoteIpAddress=remoteIpAddress, version=version, portIndex=portIndex, ftpdService=ftpdService, slaveIPaddr=slaveIPaddr, nameServer1=nameServer1, tcpPort=tcpPort, timeoutRxTx=timeoutRxTx, rxIdle=rxIdle, afterSend=afterSend, beforeSend=beforeSend, formFeed=formFeed, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, portTable=portTable, interFrame=interFrame, ipServer=ipServer, radiusServer1=radiusServer1, secondIpAddress=secondIpAddress, portStatsEntry=portStatsEntry, portStatsTable=portStatsTable, modbusTable=modbusTable, statusDTR=statusDTR, httpdService=httpdService, modbusType=modbusType, dtrDown=dtrDown, telnetdService=telnetdService, radiusSecret2=radiusSecret2, modbusMode=modbusMode, snmpTrap=snmpTrap, gatewayToRemote=gatewayToRemote, nameResolution=nameResolution, reset=reset, multiSession=multiSession, secondTcpPort=secondTcpPort, portEntry=portEntry, radiusSecret1=radiusSecret1, bytesSendToV24=bytesSendToV24, nbParStop=nbParStop, aliasIpAddress=aliasIpAddress, portReset=portReset, sessionStarted=sessionStarted, radiusServer2=radiusServer2, dtrUp=dtrUp, productName=productName, endMsg=endMsg, secondGateway=secondGateway, authRad2=authRad2, ipGateway=ipGateway, cxr=cxr, system=system, modbusEntry=modbusEntry, authRad1=authRad1, sessionStopped=sessionStopped, resetByButton=resetByButton, snmpdService=snmpdService, snmpTrapAddr1=snmpTrapAddr1, ethernetAddress=ethernetAddress, remoteTcpPort=remoteTcpPort, ipNetmask=ipNetmask, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, flowControl=flowControl, acctRad2=acctRad2, baudRate=baudRate, terminalType=terminalType, slaveIPport=slaveIPport, snmpTrapAddr2=snmpTrapAddr2)
