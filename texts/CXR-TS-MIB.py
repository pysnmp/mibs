...
# Produced by pysmi-1.1.8 at Tue Feb  1 20:59:46 2022
...
Counter32, enterprises, IpAddress, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Integer32, TimeTicks, NotificationType, ObjectIdentity, Unsigned32, Counter64, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "IpAddress", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Integer32", "TimeTicks", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter64", "iso", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", productName=productName, snmpTrapAddr2=snmpTrapAddr2, endMsg=endMsg, system=system, snmpTrapAddr1=snmpTrapAddr1, secondIpAddress=secondIpAddress, sessionStarted=sessionStarted, telnetdService=telnetdService, reset=reset, authRad2=authRad2, dtrUp=dtrUp, ipGateway=ipGateway, cxr=cxr, portIndex=portIndex, beforeSend=beforeSend, tcpPort=tcpPort, timeoutRxTx=timeoutRxTx, terminalType=terminalType, nameResolution=nameResolution, nbParStop=nbParStop, remoteTcpPort=remoteTcpPort, mode=mode, portReset=portReset, modbusMode=modbusMode, acctRad2=acctRad2, radiusServer1=radiusServer1, nameServer1=nameServer1, ipNetmask=ipNetmask, modbusEntry=modbusEntry, siteName=siteName, modbusTable=modbusTable, httpdService=httpdService, ts=ts, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, acctRad1=acctRad1, aliasIpAddress=aliasIpAddress, modbusType=modbusType, radiusServer2=radiusServer2, formFeed=formFeed, afterSend=afterSend, version=version, slaveIPport=slaveIPport, interFrame=interFrame, dtrDown=dtrDown, authRad1=authRad1, portEntry=portEntry, snmpdService=snmpdService, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, portStatsTable=portStatsTable, mainIpAddress=mainIpAddress, baudRate=baudRate, gatewayToRemote=gatewayToRemote, multiSession=multiSession, sessionStopped=sessionStopped, txIdle=txIdle, slaveHexaAddress=slaveHexaAddress, flowControl=flowControl, ethernetAddress=ethernetAddress, statusDTR=statusDTR, radiusSecret2=radiusSecret2, portStatsEntry=portStatsEntry, bootp=bootp, rxIdle=rxIdle, portTable=portTable, nameServer2=nameServer2, secondTcpPort=secondTcpPort, snmpTrap=snmpTrap, ftpdService=ftpdService, secondGateway=secondGateway, authType=authType, timeoutPAD=timeoutPAD, bytesReceiveFromV24=bytesReceiveFromV24, remoteIpAddress=remoteIpAddress, slaveIPaddr=slaveIPaddr, radiusSecret1=radiusSecret1)
