...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:33:42 2023
...
Counter64, ModuleIdentity, iso, Bits, enterprises, MibIdentifier, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Unsigned32, IpAddress, ObjectIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "iso", "Bits", "enterprises", "MibIdentifier", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Unsigned32", "IpAddress", "ObjectIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", telnetdService=telnetdService, remoteIpAddress=remoteIpAddress, httpdService=httpdService, ftpdService=ftpdService, nbParStop=nbParStop, endMsg=endMsg, mode=mode, snmpTrapAddr1=snmpTrapAddr1, acctRad2=acctRad2, snmpdService=snmpdService, radiusServer1=radiusServer1, portTable=portTable, bytesSendToV24=bytesSendToV24, reset=reset, portStatsEntry=portStatsEntry, system=system, aliasIpNetmask=aliasIpNetmask, flowControl=flowControl, nameServer2=nameServer2, secondTcpPort=secondTcpPort, beforeSend=beforeSend, bootp=bootp, aliasIpAddress=aliasIpAddress, acctRad1=acctRad1, version=version, ipServer=ipServer, slaveIPaddr=slaveIPaddr, ethernetAddress=ethernetAddress, statusDTR=statusDTR, modbusTable=modbusTable, authRad2=authRad2, secondGateway=secondGateway, radiusServer2=radiusServer2, dtrDown=dtrDown, authRad1=authRad1, formFeed=formFeed, multiSession=multiSession, dtrUp=dtrUp, portReset=portReset, slaveIPport=slaveIPport, snmpTrapAddr2=snmpTrapAddr2, txIdle=txIdle, modbusMode=modbusMode, portEntry=portEntry, ipGateway=ipGateway, terminalType=terminalType, portIndex=portIndex, rxIdle=rxIdle, sessionStopped=sessionStopped, nameServer1=nameServer1, snmpTrap=snmpTrap, portStatsTable=portStatsTable, cxr=cxr, sessionStarted=sessionStarted, afterSend=afterSend, productName=productName, radiusSecret2=radiusSecret2, tcpPort=tcpPort, slaveHexaAddress=slaveHexaAddress, timeoutPAD=timeoutPAD, modbusType=modbusType, baudRate=baudRate, mainIpAddress=mainIpAddress, timeoutRxTx=timeoutRxTx, secondIpAddress=secondIpAddress, ipNetmask=ipNetmask, remoteTcpPort=remoteTcpPort, nameResolution=nameResolution, radiusSecret1=radiusSecret1, authType=authType, bytesReceiveFromV24=bytesReceiveFromV24, interFrame=interFrame, siteName=siteName, modbusEntry=modbusEntry, resetByButton=resetByButton, gatewayToRemote=gatewayToRemote, ts=ts)
