...
ObjectIdentity, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, TimeTicks, Unsigned32, MibIdentifier, NotificationType, iso, IpAddress, Integer32, Counter32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "NotificationType", "iso", "IpAddress", "Integer32", "Counter32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", terminalType=terminalType, ts=ts, slaveIPport=slaveIPport, mode=mode, ftpdService=ftpdService, authRad2=authRad2, sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, beforeSend=beforeSend, remoteIpAddress=remoteIpAddress, sessionStopped=sessionStopped, gatewayToRemote=gatewayToRemote, nameServer2=nameServer2, endMsg=endMsg, ethernetAddress=ethernetAddress, multiSession=multiSession, timeoutRxTx=timeoutRxTx, siteName=siteName, formFeed=formFeed, statusDTR=statusDTR, modbusMode=modbusMode, radiusServer1=radiusServer1, ipGateway=ipGateway, nameResolution=nameResolution, ipNetmask=ipNetmask, bytesSendToV24=bytesSendToV24, aliasIpAddress=aliasIpAddress, authType=authType, acctRad1=acctRad1, dtrUp=dtrUp, tcpPort=tcpPort, portIndex=portIndex, secondIpAddress=secondIpAddress, productName=productName, dtrDown=dtrDown, slaveIPaddr=slaveIPaddr, txIdle=txIdle, acctRad2=acctRad2, modbusEntry=modbusEntry, bootp=bootp, nbParStop=nbParStop, modbusType=modbusType, rxIdle=rxIdle, aliasIpNetmask=aliasIpNetmask, flowControl=flowControl, version=version, mainIpAddress=mainIpAddress, portTable=portTable, snmpTrap=snmpTrap, snmpTrapAddr2=snmpTrapAddr2, nameServer1=nameServer1, authRad1=authRad1, afterSend=afterSend, radiusSecret1=radiusSecret1, slaveHexaAddress=slaveHexaAddress, resetByButton=resetByButton, telnetdService=telnetdService, radiusServer2=radiusServer2, timeoutPAD=timeoutPAD, system=system, portReset=portReset, interFrame=interFrame, portEntry=portEntry, modbusTable=modbusTable, cxr=cxr, portStatsTable=portStatsTable, secondTcpPort=secondTcpPort, reset=reset, bytesReceiveFromV24=bytesReceiveFromV24, snmpdService=snmpdService, remoteTcpPort=remoteTcpPort, baudRate=baudRate, ipServer=ipServer, httpdService=httpdService, snmpTrapAddr1=snmpTrapAddr1, portStatsEntry=portStatsEntry, secondGateway=secondGateway)
