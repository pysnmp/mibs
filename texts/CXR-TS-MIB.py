...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, NotificationType, NotificationType, IpAddress, Counter32, ModuleIdentity, iso, Counter64, ObjectIdentity, Gauge32, Bits, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "NotificationType", "NotificationType", "IpAddress", "Counter32", "ModuleIdentity", "iso", "Counter64", "ObjectIdentity", "Gauge32", "Bits", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mainIpAddress=mainIpAddress, nbParStop=nbParStop, telnetdService=telnetdService, bytesReceiveFromV24=bytesReceiveFromV24, productName=productName, ethernetAddress=ethernetAddress, snmpTrap=snmpTrap, gatewayToRemote=gatewayToRemote, secondIpAddress=secondIpAddress, terminalType=terminalType, httpdService=httpdService, portReset=portReset, slaveHexaAddress=slaveHexaAddress, acctRad1=acctRad1, sessionStarted=sessionStarted, afterSend=afterSend, snmpTrapAddr2=snmpTrapAddr2, portTable=portTable, modbusEntry=modbusEntry, nameServer2=nameServer2, formFeed=formFeed, resetByButton=resetByButton, remoteIpAddress=remoteIpAddress, radiusServer2=radiusServer2, dtrDown=dtrDown, aliasIpAddress=aliasIpAddress, authRad1=authRad1, snmpTrapAddr1=snmpTrapAddr1, ipServer=ipServer, bytesSendToV24=bytesSendToV24, endMsg=endMsg, ipNetmask=ipNetmask, baudRate=baudRate, flowControl=flowControl, modbusTable=modbusTable, acctRad2=acctRad2, nameServer1=nameServer1, modbusMode=modbusMode, timeoutRxTx=timeoutRxTx, version=version, secondGateway=secondGateway, modbusType=modbusType, ts=ts, statusDTR=statusDTR, mode=mode, siteName=siteName, beforeSend=beforeSend, tcpPort=tcpPort, aliasIpNetmask=aliasIpNetmask, slaveIPaddr=slaveIPaddr, system=system, bootp=bootp, ftpdService=ftpdService, portStatsTable=portStatsTable, timeoutPAD=timeoutPAD, authRad2=authRad2, sessionStopped=sessionStopped, radiusSecret1=radiusSecret1, rxIdle=rxIdle, radiusServer1=radiusServer1, portEntry=portEntry, remoteTcpPort=remoteTcpPort, cxr=cxr, portIndex=portIndex, ipGateway=ipGateway, txIdle=txIdle, authType=authType, radiusSecret2=radiusSecret2, reset=reset, portStatsEntry=portStatsEntry, dtrUp=dtrUp, interFrame=interFrame, nameResolution=nameResolution, slaveIPport=slaveIPport, secondTcpPort=secondTcpPort, multiSession=multiSession, snmpdService=snmpdService)
