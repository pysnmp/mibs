...
NotificationType, TimeTicks, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Bits, Counter32, Unsigned32, MibIdentifier, Gauge32, ModuleIdentity, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "Gauge32", "ModuleIdentity", "Counter64", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpdService=snmpdService, radiusServer2=radiusServer2, bytesSendToV24=bytesSendToV24, authType=authType, ipGateway=ipGateway, nbParStop=nbParStop, mainIpAddress=mainIpAddress, authRad2=authRad2, sessionStopped=sessionStopped, radiusSecret1=radiusSecret1, ipServer=ipServer, snmpTrap=snmpTrap, secondTcpPort=secondTcpPort, slaveHexaAddress=slaveHexaAddress, slaveIPaddr=slaveIPaddr, productName=productName, ipNetmask=ipNetmask, remoteTcpPort=remoteTcpPort, resetByButton=resetByButton, httpdService=httpdService, rxIdle=rxIdle, ftpdService=ftpdService, modbusEntry=modbusEntry, cxr=cxr, multiSession=multiSession, aliasIpAddress=aliasIpAddress, endMsg=endMsg, dtrUp=dtrUp, mode=mode, nameResolution=nameResolution, timeoutPAD=timeoutPAD, statusDTR=statusDTR, portEntry=portEntry, secondIpAddress=secondIpAddress, portTable=portTable, bootp=bootp, nameServer1=nameServer1, secondGateway=secondGateway, nameServer2=nameServer2, slaveIPport=slaveIPport, modbusTable=modbusTable, version=version, portStatsTable=portStatsTable, aliasIpNetmask=aliasIpNetmask, tcpPort=tcpPort, baudRate=baudRate, modbusMode=modbusMode, reset=reset, remoteIpAddress=remoteIpAddress, system=system, flowControl=flowControl, radiusServer1=radiusServer1, snmpTrapAddr2=snmpTrapAddr2, modbusType=modbusType, radiusSecret2=radiusSecret2, authRad1=authRad1, sessionStarted=sessionStarted, portStatsEntry=portStatsEntry, txIdle=txIdle, siteName=siteName, dtrDown=dtrDown, portReset=portReset, acctRad1=acctRad1, snmpTrapAddr1=snmpTrapAddr1, acctRad2=acctRad2, telnetdService=telnetdService, interFrame=interFrame, beforeSend=beforeSend, gatewayToRemote=gatewayToRemote, formFeed=formFeed, timeoutRxTx=timeoutRxTx, ethernetAddress=ethernetAddress, ts=ts, terminalType=terminalType, portIndex=portIndex, bytesReceiveFromV24=bytesReceiveFromV24, afterSend=afterSend)
