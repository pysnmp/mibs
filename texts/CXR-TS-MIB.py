...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:10:42 2022
...
iso, Integer32, Bits, Gauge32, ObjectIdentity, IpAddress, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, TimeTicks, NotificationType, NotificationType, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Bits", "Gauge32", "ObjectIdentity", "IpAddress", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "TimeTicks", "NotificationType", "NotificationType", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", telnetdService=telnetdService, remoteIpAddress=remoteIpAddress, cxr=cxr, afterSend=afterSend, formFeed=formFeed, gatewayToRemote=gatewayToRemote, portIndex=portIndex, baudRate=baudRate, mode=mode, secondIpAddress=secondIpAddress, statusDTR=statusDTR, portStatsEntry=portStatsEntry, radiusServer1=radiusServer1, bytesSendToV24=bytesSendToV24, rxIdle=rxIdle, slaveHexaAddress=slaveHexaAddress, bootp=bootp, ipServer=ipServer, snmpTrap=snmpTrap, aliasIpNetmask=aliasIpNetmask, productName=productName, slaveIPport=slaveIPport, ipGateway=ipGateway, timeoutRxTx=timeoutRxTx, version=version, interFrame=interFrame, portStatsTable=portStatsTable, reset=reset, ts=ts, radiusServer2=radiusServer2, flowControl=flowControl, ftpdService=ftpdService, ipNetmask=ipNetmask, snmpTrapAddr2=snmpTrapAddr2, portTable=portTable, modbusEntry=modbusEntry, dtrDown=dtrDown, httpdService=httpdService, multiSession=multiSession, snmpdService=snmpdService, mainIpAddress=mainIpAddress, acctRad1=acctRad1, ethernetAddress=ethernetAddress, radiusSecret2=radiusSecret2, secondGateway=secondGateway, siteName=siteName, tcpPort=tcpPort, terminalType=terminalType, resetByButton=resetByButton, secondTcpPort=secondTcpPort, snmpTrapAddr1=snmpTrapAddr1, endMsg=endMsg, slaveIPaddr=slaveIPaddr, nbParStop=nbParStop, bytesReceiveFromV24=bytesReceiveFromV24, sessionStopped=sessionStopped, nameServer1=nameServer1, modbusTable=modbusTable, txIdle=txIdle, radiusSecret1=radiusSecret1, aliasIpAddress=aliasIpAddress, modbusMode=modbusMode, authType=authType, dtrUp=dtrUp, acctRad2=acctRad2, nameResolution=nameResolution, remoteTcpPort=remoteTcpPort, beforeSend=beforeSend, sessionStarted=sessionStarted, authRad1=authRad1, portEntry=portEntry, portReset=portReset, timeoutPAD=timeoutPAD, nameServer2=nameServer2, modbusType=modbusType, system=system, authRad2=authRad2)
