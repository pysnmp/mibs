...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:34:00 2024
...
ObjectIdentity, Counter64, Bits, iso, enterprises, Unsigned32, Gauge32, NotificationType, TimeTicks, ModuleIdentity, MibIdentifier, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Bits", "iso", "enterprises", "Unsigned32", "Gauge32", "NotificationType", "TimeTicks", "ModuleIdentity", "MibIdentifier", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", secondTcpPort=secondTcpPort, acctRad2=acctRad2, terminalType=terminalType, ipNetmask=ipNetmask, modbusTable=modbusTable, rxIdle=rxIdle, slaveHexaAddress=slaveHexaAddress, slaveIPport=slaveIPport, mode=mode, authRad1=authRad1, tcpPort=tcpPort, bootp=bootp, secondIpAddress=secondIpAddress, remoteTcpPort=remoteTcpPort, nameResolution=nameResolution, endMsg=endMsg, nameServer2=nameServer2, mainIpAddress=mainIpAddress, system=system, aliasIpNetmask=aliasIpNetmask, bytesReceiveFromV24=bytesReceiveFromV24, formFeed=formFeed, siteName=siteName, timeoutRxTx=timeoutRxTx, ipServer=ipServer, radiusSecret2=radiusSecret2, ts=ts, snmpTrap=snmpTrap, version=version, ipGateway=ipGateway, timeoutPAD=timeoutPAD, portReset=portReset, slaveIPaddr=slaveIPaddr, authType=authType, snmpTrapAddr2=snmpTrapAddr2, resetByButton=resetByButton, modbusEntry=modbusEntry, gatewayToRemote=gatewayToRemote, acctRad1=acctRad1, portTable=portTable, modbusMode=modbusMode, txIdle=txIdle, flowControl=flowControl, aliasIpAddress=aliasIpAddress, nameServer1=nameServer1, ethernetAddress=ethernetAddress, snmpdService=snmpdService, dtrDown=dtrDown, secondGateway=secondGateway, radiusServer1=radiusServer1, radiusSecret1=radiusSecret1, portIndex=portIndex, authRad2=authRad2, portStatsTable=portStatsTable, nbParStop=nbParStop, productName=productName, remoteIpAddress=remoteIpAddress, portStatsEntry=portStatsEntry, reset=reset, beforeSend=beforeSend, multiSession=multiSession, interFrame=interFrame, telnetdService=telnetdService, snmpTrapAddr1=snmpTrapAddr1, modbusType=modbusType, portEntry=portEntry, sessionStarted=sessionStarted, cxr=cxr, radiusServer2=radiusServer2, bytesSendToV24=bytesSendToV24, httpdService=httpdService, afterSend=afterSend, sessionStopped=sessionStopped, baudRate=baudRate, ftpdService=ftpdService, dtrUp=dtrUp, statusDTR=statusDTR)
