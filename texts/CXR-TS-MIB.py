...
Gauge32, TimeTicks, IpAddress, ObjectIdentity, Unsigned32, Counter64, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, NotificationType, Counter32, Bits, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "IpAddress", "ObjectIdentity", "Unsigned32", "Counter64", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "NotificationType", "Counter32", "Bits", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", timeoutPAD=timeoutPAD, aliasIpNetmask=aliasIpNetmask, sessionStopped=sessionStopped, flowControl=flowControl, multiSession=multiSession, productName=productName, mode=mode, ipServer=ipServer, timeoutRxTx=timeoutRxTx, radiusSecret2=radiusSecret2, nameResolution=nameResolution, afterSend=afterSend, authRad2=authRad2, modbusType=modbusType, portTable=portTable, radiusSecret1=radiusSecret1, portStatsEntry=portStatsEntry, secondIpAddress=secondIpAddress, ts=ts, ftpdService=ftpdService, remoteTcpPort=remoteTcpPort, reset=reset, statusDTR=statusDTR, remoteIpAddress=remoteIpAddress, snmpTrapAddr2=snmpTrapAddr2, sessionStarted=sessionStarted, snmpdService=snmpdService, tcpPort=tcpPort, interFrame=interFrame, bytesSendToV24=bytesSendToV24, telnetdService=telnetdService, version=version, resetByButton=resetByButton, baudRate=baudRate, portEntry=portEntry, modbusEntry=modbusEntry, terminalType=terminalType, beforeSend=beforeSend, radiusServer1=radiusServer1, system=system, mainIpAddress=mainIpAddress, nbParStop=nbParStop, siteName=siteName, radiusServer2=radiusServer2, snmpTrapAddr1=snmpTrapAddr1, ethernetAddress=ethernetAddress, formFeed=formFeed, nameServer1=nameServer1, bytesReceiveFromV24=bytesReceiveFromV24, txIdle=txIdle, modbusTable=modbusTable, rxIdle=rxIdle, aliasIpAddress=aliasIpAddress, ipNetmask=ipNetmask, portReset=portReset, secondGateway=secondGateway, dtrDown=dtrDown, slaveIPport=slaveIPport, modbusMode=modbusMode, bootp=bootp, gatewayToRemote=gatewayToRemote, slaveHexaAddress=slaveHexaAddress, secondTcpPort=secondTcpPort, slaveIPaddr=slaveIPaddr, portStatsTable=portStatsTable, authRad1=authRad1, endMsg=endMsg, nameServer2=nameServer2, portIndex=portIndex, acctRad1=acctRad1, ipGateway=ipGateway, acctRad2=acctRad2, dtrUp=dtrUp, httpdService=httpdService, cxr=cxr, authType=authType, snmpTrap=snmpTrap)
