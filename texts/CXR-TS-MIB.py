...
enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Counter64, MibIdentifier, Bits, ObjectIdentity, Unsigned32, NotificationType, ModuleIdentity, TimeTicks, IpAddress, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Counter64", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "NotificationType", "ModuleIdentity", "TimeTicks", "IpAddress", "Integer32", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrapAddr2=snmpTrapAddr2, acctRad1=acctRad1, ipGateway=ipGateway, nbParStop=nbParStop, txIdle=txIdle, terminalType=terminalType, slaveIPport=slaveIPport, ipServer=ipServer, radiusServer1=radiusServer1, siteName=siteName, dtrDown=dtrDown, beforeSend=beforeSend, secondIpAddress=secondIpAddress, version=version, snmpdService=snmpdService, bytesReceiveFromV24=bytesReceiveFromV24, productName=productName, flowControl=flowControl, remoteTcpPort=remoteTcpPort, sessionStopped=sessionStopped, authRad1=authRad1, remoteIpAddress=remoteIpAddress, portStatsTable=portStatsTable, modbusType=modbusType, slaveHexaAddress=slaveHexaAddress, secondGateway=secondGateway, snmpTrapAddr1=snmpTrapAddr1, authType=authType, ts=ts, mode=mode, secondTcpPort=secondTcpPort, nameResolution=nameResolution, aliasIpAddress=aliasIpAddress, dtrUp=dtrUp, multiSession=multiSession, modbusEntry=modbusEntry, ethernetAddress=ethernetAddress, resetByButton=resetByButton, slaveIPaddr=slaveIPaddr, rxIdle=rxIdle, sessionStarted=sessionStarted, portReset=portReset, interFrame=interFrame, portStatsEntry=portStatsEntry, tcpPort=tcpPort, baudRate=baudRate, statusDTR=statusDTR, gatewayToRemote=gatewayToRemote, bootp=bootp, acctRad2=acctRad2, telnetdService=telnetdService, cxr=cxr, reset=reset, ftpdService=ftpdService, mainIpAddress=mainIpAddress, timeoutRxTx=timeoutRxTx, timeoutPAD=timeoutPAD, radiusSecret2=radiusSecret2, bytesSendToV24=bytesSendToV24, snmpTrap=snmpTrap, formFeed=formFeed, afterSend=afterSend, radiusSecret1=radiusSecret1, ipNetmask=ipNetmask, portTable=portTable, system=system, nameServer2=nameServer2, httpdService=httpdService, portEntry=portEntry, radiusServer2=radiusServer2, nameServer1=nameServer1, endMsg=endMsg, authRad2=authRad2, portIndex=portIndex, modbusMode=modbusMode, modbusTable=modbusTable, aliasIpNetmask=aliasIpNetmask)
