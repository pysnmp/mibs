...
IpAddress, enterprises, ObjectIdentity, ModuleIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, MibIdentifier, Unsigned32, Counter64, Integer32, NotificationType, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "MibIdentifier", "Unsigned32", "Counter64", "Integer32", "NotificationType", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusEntry=modbusEntry, portTable=portTable, remoteIpAddress=remoteIpAddress, snmpTrapAddr2=snmpTrapAddr2, authRad1=authRad1, reset=reset, secondTcpPort=secondTcpPort, radiusServer1=radiusServer1, ipGateway=ipGateway, remoteTcpPort=remoteTcpPort, multiSession=multiSession, interFrame=interFrame, bytesSendToV24=bytesSendToV24, radiusServer2=radiusServer2, aliasIpAddress=aliasIpAddress, telnetdService=telnetdService, nbParStop=nbParStop, acctRad1=acctRad1, dtrDown=dtrDown, ftpdService=ftpdService, ethernetAddress=ethernetAddress, siteName=siteName, mode=mode, portStatsTable=portStatsTable, slaveIPaddr=slaveIPaddr, secondIpAddress=secondIpAddress, portEntry=portEntry, gatewayToRemote=gatewayToRemote, sessionStopped=sessionStopped, baudRate=baudRate, acctRad2=acctRad2, terminalType=terminalType, nameResolution=nameResolution, slaveHexaAddress=slaveHexaAddress, authType=authType, portStatsEntry=portStatsEntry, snmpTrapAddr1=snmpTrapAddr1, modbusType=modbusType, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret1=radiusSecret1, nameServer2=nameServer2, productName=productName, tcpPort=tcpPort, aliasIpNetmask=aliasIpNetmask, bootp=bootp, httpdService=httpdService, dtrUp=dtrUp, authRad2=authRad2, snmpdService=snmpdService, ts=ts, afterSend=afterSend, txIdle=txIdle, secondGateway=secondGateway, ipServer=ipServer, nameServer1=nameServer1, sessionStarted=sessionStarted, slaveIPport=slaveIPport, portReset=portReset, snmpTrap=snmpTrap, timeoutRxTx=timeoutRxTx, formFeed=formFeed, version=version, radiusSecret2=radiusSecret2, rxIdle=rxIdle, portIndex=portIndex, beforeSend=beforeSend, modbusMode=modbusMode, mainIpAddress=mainIpAddress, flowControl=flowControl, endMsg=endMsg, system=system, statusDTR=statusDTR, ipNetmask=ipNetmask, timeoutPAD=timeoutPAD, modbusTable=modbusTable, cxr=cxr, resetByButton=resetByButton)
