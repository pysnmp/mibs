...
iso, Unsigned32, Counter64, Bits, IpAddress, Integer32, TimeTicks, MibIdentifier, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, Counter32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter64", "Bits", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Counter32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret2=radiusSecret2, sessionStopped=sessionStopped, sessionStarted=sessionStarted, snmpTrap=snmpTrap, nameServer1=nameServer1, modbusMode=modbusMode, mainIpAddress=mainIpAddress, bootp=bootp, remoteTcpPort=remoteTcpPort, modbusType=modbusType, version=version, slaveHexaAddress=slaveHexaAddress, baudRate=baudRate, mode=mode, authType=authType, afterSend=afterSend, nbParStop=nbParStop, gatewayToRemote=gatewayToRemote, radiusServer1=radiusServer1, telnetdService=telnetdService, timeoutPAD=timeoutPAD, terminalType=terminalType, timeoutRxTx=timeoutRxTx, dtrUp=dtrUp, authRad2=authRad2, dtrDown=dtrDown, cxr=cxr, ipGateway=ipGateway, bytesReceiveFromV24=bytesReceiveFromV24, ethernetAddress=ethernetAddress, portReset=portReset, slaveIPport=slaveIPport, ftpdService=ftpdService, radiusSecret1=radiusSecret1, siteName=siteName, portStatsTable=portStatsTable, statusDTR=statusDTR, system=system, snmpdService=snmpdService, secondTcpPort=secondTcpPort, formFeed=formFeed, secondIpAddress=secondIpAddress, reset=reset, modbusTable=modbusTable, acctRad1=acctRad1, portIndex=portIndex, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, secondGateway=secondGateway, multiSession=multiSession, ts=ts, endMsg=endMsg, nameServer2=nameServer2, httpdService=httpdService, bytesSendToV24=bytesSendToV24, radiusServer2=radiusServer2, snmpTrapAddr1=snmpTrapAddr1, resetByButton=resetByButton, flowControl=flowControl, modbusEntry=modbusEntry, interFrame=interFrame, slaveIPaddr=slaveIPaddr, productName=productName, txIdle=txIdle, nameResolution=nameResolution, portStatsEntry=portStatsEntry, snmpTrapAddr2=snmpTrapAddr2, aliasIpAddress=aliasIpAddress, tcpPort=tcpPort, portEntry=portEntry, ipNetmask=ipNetmask, portTable=portTable, authRad1=authRad1, remoteIpAddress=remoteIpAddress, acctRad2=acctRad2, rxIdle=rxIdle, beforeSend=beforeSend)
