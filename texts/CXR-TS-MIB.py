...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:32:49 2024
...
ModuleIdentity, Counter32, ObjectIdentity, NotificationType, iso, Bits, Counter64, IpAddress, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, TimeTicks, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "ObjectIdentity", "NotificationType", "iso", "Bits", "Counter64", "IpAddress", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "TimeTicks", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", productName=productName, version=version, secondIpAddress=secondIpAddress, remoteIpAddress=remoteIpAddress, portEntry=portEntry, baudRate=baudRate, bootp=bootp, snmpTrapAddr2=snmpTrapAddr2, siteName=siteName, flowControl=flowControl, nbParStop=nbParStop, mode=mode, dtrUp=dtrUp, ipServer=ipServer, portTable=portTable, nameServer1=nameServer1, sessionStarted=sessionStarted, endMsg=endMsg, beforeSend=beforeSend, portStatsEntry=portStatsEntry, radiusServer2=radiusServer2, slaveIPport=slaveIPport, slaveHexaAddress=slaveHexaAddress, ftpdService=ftpdService, radiusServer1=radiusServer1, ts=ts, authRad1=authRad1, radiusSecret2=radiusSecret2, timeoutRxTx=timeoutRxTx, portIndex=portIndex, authType=authType, portStatsTable=portStatsTable, dtrDown=dtrDown, secondGateway=secondGateway, formFeed=formFeed, snmpTrap=snmpTrap, gatewayToRemote=gatewayToRemote, sessionStopped=sessionStopped, snmpTrapAddr1=snmpTrapAddr1, authRad2=authRad2, modbusEntry=modbusEntry, modbusTable=modbusTable, nameServer2=nameServer2, terminalType=terminalType, multiSession=multiSession, aliasIpNetmask=aliasIpNetmask, portReset=portReset, slaveIPaddr=slaveIPaddr, snmpdService=snmpdService, aliasIpAddress=aliasIpAddress, modbusMode=modbusMode, system=system, ipGateway=ipGateway, nameResolution=nameResolution, remoteTcpPort=remoteTcpPort, cxr=cxr, interFrame=interFrame, reset=reset, mainIpAddress=mainIpAddress, timeoutPAD=timeoutPAD, telnetdService=telnetdService, tcpPort=tcpPort, ipNetmask=ipNetmask, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, bytesSendToV24=bytesSendToV24, httpdService=httpdService, secondTcpPort=secondTcpPort, acctRad1=acctRad1, statusDTR=statusDTR, modbusType=modbusType, txIdle=txIdle, rxIdle=rxIdle, radiusSecret1=radiusSecret1, ethernetAddress=ethernetAddress, resetByButton=resetByButton, afterSend=afterSend)
