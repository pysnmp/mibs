...
Counter32, Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ModuleIdentity, Counter64, Bits, NotificationType, TimeTicks, IpAddress, iso, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter64", "Bits", "NotificationType", "TimeTicks", "IpAddress", "iso", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", afterSend=afterSend, portEntry=portEntry, modbusType=modbusType, remoteTcpPort=remoteTcpPort, sessionStopped=sessionStopped, portReset=portReset, radiusSecret2=radiusSecret2, dtrUp=dtrUp, portIndex=portIndex, terminalType=terminalType, baudRate=baudRate, bytesSendToV24=bytesSendToV24, authType=authType, radiusServer2=radiusServer2, radiusServer1=radiusServer1, dtrDown=dtrDown, mainIpAddress=mainIpAddress, authRad1=authRad1, acctRad1=acctRad1, bootp=bootp, portStatsTable=portStatsTable, acctRad2=acctRad2, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, ts=ts, sessionStarted=sessionStarted, slaveIPport=slaveIPport, authRad2=authRad2, ipServer=ipServer, ipGateway=ipGateway, aliasIpAddress=aliasIpAddress, radiusSecret1=radiusSecret1, mode=mode, portTable=portTable, interFrame=interFrame, txIdle=txIdle, resetByButton=resetByButton, modbusMode=modbusMode, gatewayToRemote=gatewayToRemote, rxIdle=rxIdle, snmpTrapAddr2=snmpTrapAddr2, endMsg=endMsg, ethernetAddress=ethernetAddress, modbusEntry=modbusEntry, system=system, timeoutRxTx=timeoutRxTx, ftpdService=ftpdService, secondTcpPort=secondTcpPort, nameServer2=nameServer2, portStatsEntry=portStatsEntry, cxr=cxr, secondIpAddress=secondIpAddress, snmpTrapAddr1=snmpTrapAddr1, secondGateway=secondGateway, multiSession=multiSession, tcpPort=tcpPort, timeoutPAD=timeoutPAD, statusDTR=statusDTR, snmpdService=snmpdService, remoteIpAddress=remoteIpAddress, reset=reset, beforeSend=beforeSend, formFeed=formFeed, aliasIpNetmask=aliasIpNetmask, productName=productName, ipNetmask=ipNetmask, nameResolution=nameResolution, siteName=siteName, flowControl=flowControl, snmpTrap=snmpTrap, telnetdService=telnetdService, modbusTable=modbusTable, version=version, httpdService=httpdService, slaveIPaddr=slaveIPaddr, bytesReceiveFromV24=bytesReceiveFromV24, nameServer1=nameServer1)
