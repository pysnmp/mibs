...
# Produced by pysmi-1.1.12 at Tue Jun  4 09:28:20 2024
...
Counter32, Bits, TimeTicks, NotificationType, MibIdentifier, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, ModuleIdentity, ObjectIdentity, Integer32, Gauge32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "TimeTicks", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "ModuleIdentity", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", secondIpAddress=secondIpAddress, ipGateway=ipGateway, dtrDown=dtrDown, productName=productName, remoteTcpPort=remoteTcpPort, snmpTrap=snmpTrap, ipNetmask=ipNetmask, modbusEntry=modbusEntry, ipServer=ipServer, multiSession=multiSession, authRad2=authRad2, acctRad1=acctRad1, portIndex=portIndex, beforeSend=beforeSend, aliasIpAddress=aliasIpAddress, slaveHexaAddress=slaveHexaAddress, slaveIPaddr=slaveIPaddr, portStatsTable=portStatsTable, modbusMode=modbusMode, mode=mode, secondTcpPort=secondTcpPort, remoteIpAddress=remoteIpAddress, portReset=portReset, statusDTR=statusDTR, slaveIPport=slaveIPport, nbParStop=nbParStop, radiusServer2=radiusServer2, radiusServer1=radiusServer1, nameResolution=nameResolution, snmpdService=snmpdService, authRad1=authRad1, nameServer2=nameServer2, endMsg=endMsg, tcpPort=tcpPort, secondGateway=secondGateway, sessionStarted=sessionStarted, modbusType=modbusType, afterSend=afterSend, sessionStopped=sessionStopped, portStatsEntry=portStatsEntry, ftpdService=ftpdService, baudRate=baudRate, acctRad2=acctRad2, system=system, bytesReceiveFromV24=bytesReceiveFromV24, portTable=portTable, radiusSecret2=radiusSecret2, snmpTrapAddr2=snmpTrapAddr2, gatewayToRemote=gatewayToRemote, dtrUp=dtrUp, cxr=cxr, terminalType=terminalType, ethernetAddress=ethernetAddress, portEntry=portEntry, aliasIpNetmask=aliasIpNetmask, httpdService=httpdService, siteName=siteName, mainIpAddress=mainIpAddress, ts=ts, flowControl=flowControl, modbusTable=modbusTable, radiusSecret1=radiusSecret1, telnetdService=telnetdService, interFrame=interFrame, bytesSendToV24=bytesSendToV24, timeoutRxTx=timeoutRxTx, snmpTrapAddr1=snmpTrapAddr1, authType=authType, resetByButton=resetByButton, bootp=bootp, rxIdle=rxIdle, reset=reset, nameServer1=nameServer1, timeoutPAD=timeoutPAD, formFeed=formFeed, version=version, txIdle=txIdle)
