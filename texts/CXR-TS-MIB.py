...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:41:44 2023
...
Integer32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Bits, Unsigned32, Gauge32, ObjectIdentity, Counter32, enterprises, NotificationType, TimeTicks, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Bits", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "enterprises", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", gatewayToRemote=gatewayToRemote, aliasIpAddress=aliasIpAddress, sessionStarted=sessionStarted, ftpdService=ftpdService, ipGateway=ipGateway, productName=productName, aliasIpNetmask=aliasIpNetmask, slaveIPport=slaveIPport, authRad2=authRad2, resetByButton=resetByButton, afterSend=afterSend, siteName=siteName, cxr=cxr, baudRate=baudRate, radiusSecret2=radiusSecret2, system=system, interFrame=interFrame, secondIpAddress=secondIpAddress, mainIpAddress=mainIpAddress, authRad1=authRad1, portStatsTable=portStatsTable, terminalType=terminalType, timeoutRxTx=timeoutRxTx, bytesSendToV24=bytesSendToV24, portIndex=portIndex, slaveIPaddr=slaveIPaddr, radiusSecret1=radiusSecret1, acctRad2=acctRad2, rxIdle=rxIdle, nameServer1=nameServer1, timeoutPAD=timeoutPAD, modbusEntry=modbusEntry, authType=authType, bytesReceiveFromV24=bytesReceiveFromV24, nameServer2=nameServer2, formFeed=formFeed, ipNetmask=ipNetmask, modbusTable=modbusTable, modbusMode=modbusMode, acctRad1=acctRad1, secondTcpPort=secondTcpPort, snmpdService=snmpdService, endMsg=endMsg, portReset=portReset, snmpTrapAddr2=snmpTrapAddr2, beforeSend=beforeSend, radiusServer2=radiusServer2, multiSession=multiSession, telnetdService=telnetdService, dtrUp=dtrUp, portStatsEntry=portStatsEntry, snmpTrapAddr1=snmpTrapAddr1, tcpPort=tcpPort, snmpTrap=snmpTrap, bootp=bootp, secondGateway=secondGateway, nameResolution=nameResolution, httpdService=httpdService, ipServer=ipServer, portEntry=portEntry, radiusServer1=radiusServer1, remoteIpAddress=remoteIpAddress, flowControl=flowControl, txIdle=txIdle, slaveHexaAddress=slaveHexaAddress, nbParStop=nbParStop, remoteTcpPort=remoteTcpPort, ethernetAddress=ethernetAddress, statusDTR=statusDTR, reset=reset, modbusType=modbusType, dtrDown=dtrDown, mode=mode, portTable=portTable, ts=ts, sessionStopped=sessionStopped, version=version)
