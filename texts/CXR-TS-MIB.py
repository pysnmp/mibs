...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:09:31 2024
...
ObjectIdentity, IpAddress, TimeTicks, MibIdentifier, Counter64, Unsigned32, NotificationType, enterprises, Gauge32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "TimeTicks", "MibIdentifier", "Counter64", "Unsigned32", "NotificationType", "enterprises", "Gauge32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", timeoutRxTx=timeoutRxTx, aliasIpNetmask=aliasIpNetmask, version=version, secondTcpPort=secondTcpPort, slaveIPport=slaveIPport, portEntry=portEntry, modbusEntry=modbusEntry, portStatsEntry=portStatsEntry, authType=authType, cxr=cxr, bytesSendToV24=bytesSendToV24, terminalType=terminalType, siteName=siteName, baudRate=baudRate, flowControl=flowControl, reset=reset, ethernetAddress=ethernetAddress, ftpdService=ftpdService, endMsg=endMsg, acctRad2=acctRad2, rxIdle=rxIdle, slaveIPaddr=slaveIPaddr, snmpTrap=snmpTrap, mode=mode, formFeed=formFeed, telnetdService=telnetdService, mainIpAddress=mainIpAddress, resetByButton=resetByButton, snmpTrapAddr1=snmpTrapAddr1, radiusSecret1=radiusSecret1, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, remoteIpAddress=remoteIpAddress, txIdle=txIdle, snmpTrapAddr2=snmpTrapAddr2, sessionStarted=sessionStarted, multiSession=multiSession, gatewayToRemote=gatewayToRemote, modbusMode=modbusMode, bytesReceiveFromV24=bytesReceiveFromV24, sessionStopped=sessionStopped, nameResolution=nameResolution, remoteTcpPort=remoteTcpPort, portStatsTable=portStatsTable, beforeSend=beforeSend, modbusType=modbusType, productName=productName, radiusServer2=radiusServer2, secondGateway=secondGateway, authRad2=authRad2, ipServer=ipServer, system=system, dtrDown=dtrDown, httpdService=httpdService, bootp=bootp, nameServer2=nameServer2, timeoutPAD=timeoutPAD, dtrUp=dtrUp, radiusSecret2=radiusSecret2, statusDTR=statusDTR, acctRad1=acctRad1, ts=ts, portTable=portTable, afterSend=afterSend, snmpdService=snmpdService, portReset=portReset, interFrame=interFrame, radiusServer1=radiusServer1, nameServer1=nameServer1, nbParStop=nbParStop, authRad1=authRad1, aliasIpAddress=aliasIpAddress, tcpPort=tcpPort, secondIpAddress=secondIpAddress, ipGateway=ipGateway, ipNetmask=ipNetmask, portIndex=portIndex)
