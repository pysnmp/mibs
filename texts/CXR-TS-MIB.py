...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity, Gauge32, iso, ModuleIdentity, NotificationType, Integer32, Unsigned32, NotificationType, IpAddress, Bits, MibIdentifier, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity", "Gauge32", "iso", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "NotificationType", "IpAddress", "Bits", "MibIdentifier", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", statusDTR=statusDTR, secondIpAddress=secondIpAddress, tcpPort=tcpPort, portStatsTable=portStatsTable, snmpTrapAddr2=snmpTrapAddr2, sessionStopped=sessionStopped, mainIpAddress=mainIpAddress, slaveIPaddr=slaveIPaddr, slaveIPport=slaveIPport, siteName=siteName, radiusSecret2=radiusSecret2, radiusServer2=radiusServer2, ipServer=ipServer, modbusMode=modbusMode, timeoutRxTx=timeoutRxTx, afterSend=afterSend, ftpdService=ftpdService, multiSession=multiSession, terminalType=terminalType, dtrUp=dtrUp, bytesSendToV24=bytesSendToV24, ethernetAddress=ethernetAddress, ipNetmask=ipNetmask, secondGateway=secondGateway, secondTcpPort=secondTcpPort, acctRad1=acctRad1, aliasIpAddress=aliasIpAddress, remoteTcpPort=remoteTcpPort, radiusServer1=radiusServer1, ts=ts, gatewayToRemote=gatewayToRemote, system=system, nameResolution=nameResolution, aliasIpNetmask=aliasIpNetmask, slaveHexaAddress=slaveHexaAddress, modbusEntry=modbusEntry, productName=productName, portTable=portTable, portStatsEntry=portStatsEntry, flowControl=flowControl, modbusTable=modbusTable, acctRad2=acctRad2, txIdle=txIdle, nameServer1=nameServer1, remoteIpAddress=remoteIpAddress, portReset=portReset, snmpdService=snmpdService, radiusSecret1=radiusSecret1, portIndex=portIndex, ipGateway=ipGateway, snmpTrapAddr1=snmpTrapAddr1, modbusType=modbusType, resetByButton=resetByButton, baudRate=baudRate, bytesReceiveFromV24=bytesReceiveFromV24, mode=mode, beforeSend=beforeSend, rxIdle=rxIdle, nbParStop=nbParStop, snmpTrap=snmpTrap, timeoutPAD=timeoutPAD, portEntry=portEntry, authType=authType, cxr=cxr, interFrame=interFrame, formFeed=formFeed, nameServer2=nameServer2, reset=reset, httpdService=httpdService, version=version, endMsg=endMsg, bootp=bootp, authRad1=authRad1, authRad2=authRad2, dtrDown=dtrDown, sessionStarted=sessionStarted, telnetdService=telnetdService)
