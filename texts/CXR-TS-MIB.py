...
# Produced by pysmi-1.1.12 at Mon Sep 16 14:52:46 2024
...
ModuleIdentity, MibIdentifier, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, NotificationType, Unsigned32, IpAddress, Gauge32, TimeTicks, NotificationType, enterprises, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "Gauge32", "TimeTicks", "NotificationType", "enterprises", "iso", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", terminalType=terminalType, productName=productName, sessionStarted=sessionStarted, radiusServer1=radiusServer1, aliasIpAddress=aliasIpAddress, nameServer1=nameServer1, remoteTcpPort=remoteTcpPort, portIndex=portIndex, ipNetmask=ipNetmask, nbParStop=nbParStop, ipServer=ipServer, gatewayToRemote=gatewayToRemote, bytesReceiveFromV24=bytesReceiveFromV24, flowControl=flowControl, interFrame=interFrame, slaveHexaAddress=slaveHexaAddress, cxr=cxr, mainIpAddress=mainIpAddress, multiSession=multiSession, modbusTable=modbusTable, timeoutRxTx=timeoutRxTx, radiusServer2=radiusServer2, portStatsTable=portStatsTable, portTable=portTable, aliasIpNetmask=aliasIpNetmask, secondGateway=secondGateway, ipGateway=ipGateway, ftpdService=ftpdService, nameServer2=nameServer2, slaveIPport=slaveIPport, reset=reset, secondIpAddress=secondIpAddress, system=system, snmpTrapAddr1=snmpTrapAddr1, snmpTrap=snmpTrap, siteName=siteName, timeoutPAD=timeoutPAD, beforeSend=beforeSend, remoteIpAddress=remoteIpAddress, ts=ts, acctRad1=acctRad1, portReset=portReset, secondTcpPort=secondTcpPort, nameResolution=nameResolution, rxIdle=rxIdle, formFeed=formFeed, modbusEntry=modbusEntry, snmpdService=snmpdService, resetByButton=resetByButton, afterSend=afterSend, sessionStopped=sessionStopped, authType=authType, radiusSecret1=radiusSecret1, dtrDown=dtrDown, portStatsEntry=portStatsEntry, endMsg=endMsg, bootp=bootp, authRad1=authRad1, slaveIPaddr=slaveIPaddr, baudRate=baudRate, version=version, snmpTrapAddr2=snmpTrapAddr2, bytesSendToV24=bytesSendToV24, tcpPort=tcpPort, statusDTR=statusDTR, txIdle=txIdle, portEntry=portEntry, httpdService=httpdService, modbusType=modbusType, mode=mode, dtrUp=dtrUp, telnetdService=telnetdService, radiusSecret2=radiusSecret2, acctRad2=acctRad2, authRad2=authRad2, modbusMode=modbusMode, ethernetAddress=ethernetAddress)
