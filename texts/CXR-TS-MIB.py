...
Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, IpAddress, Counter64, Gauge32, ModuleIdentity, Unsigned32, ObjectIdentity, NotificationType, enterprises, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "IpAddress", "Counter64", "Gauge32", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "NotificationType", "enterprises", "iso", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mainIpAddress=mainIpAddress, mode=mode, nbParStop=nbParStop, authType=authType, portStatsEntry=portStatsEntry, nameServer2=nameServer2, dtrDown=dtrDown, remoteTcpPort=remoteTcpPort, authRad1=authRad1, sessionStopped=sessionStopped, ipServer=ipServer, gatewayToRemote=gatewayToRemote, remoteIpAddress=remoteIpAddress, terminalType=terminalType, flowControl=flowControl, secondIpAddress=secondIpAddress, slaveIPport=slaveIPport, radiusSecret1=radiusSecret1, acctRad1=acctRad1, ftpdService=ftpdService, cxr=cxr, portEntry=portEntry, httpdService=httpdService, tcpPort=tcpPort, modbusEntry=modbusEntry, nameResolution=nameResolution, secondTcpPort=secondTcpPort, rxIdle=rxIdle, bootp=bootp, productName=productName, txIdle=txIdle, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, dtrUp=dtrUp, timeoutPAD=timeoutPAD, sessionStarted=sessionStarted, reset=reset, formFeed=formFeed, aliasIpNetmask=aliasIpNetmask, snmpdService=snmpdService, portIndex=portIndex, bytesSendToV24=bytesSendToV24, multiSession=multiSession, bytesReceiveFromV24=bytesReceiveFromV24, acctRad2=acctRad2, nameServer1=nameServer1, statusDTR=statusDTR, radiusSecret2=radiusSecret2, authRad2=authRad2, beforeSend=beforeSend, afterSend=afterSend, snmpTrapAddr1=snmpTrapAddr1, aliasIpAddress=aliasIpAddress, radiusServer2=radiusServer2, radiusServer1=radiusServer1, endMsg=endMsg, ethernetAddress=ethernetAddress, snmpTrap=snmpTrap, timeoutRxTx=timeoutRxTx, secondGateway=secondGateway, ipNetmask=ipNetmask, portTable=portTable, interFrame=interFrame, ipGateway=ipGateway, slaveIPaddr=slaveIPaddr, version=version, modbusType=modbusType, siteName=siteName, snmpTrapAddr2=snmpTrapAddr2, resetByButton=resetByButton, modbusMode=modbusMode, system=system, portReset=portReset, baudRate=baudRate, telnetdService=telnetdService, ts=ts, portStatsTable=portStatsTable)
