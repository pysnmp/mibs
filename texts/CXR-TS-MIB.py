...
# Produced by pysmi-1.1.8 at Fri Oct 13 13:59:12 2023
...
MibIdentifier, iso, NotificationType, Gauge32, Bits, ObjectIdentity, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Counter64, IpAddress, Integer32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "Gauge32", "Bits", "ObjectIdentity", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Counter64", "IpAddress", "Integer32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portStatsTable=portStatsTable, sessionStopped=sessionStopped, ipNetmask=ipNetmask, remoteIpAddress=remoteIpAddress, slaveIPport=slaveIPport, nameServer1=nameServer1, radiusSecret2=radiusSecret2, terminalType=terminalType, secondIpAddress=secondIpAddress, productName=productName, afterSend=afterSend, aliasIpAddress=aliasIpAddress, gatewayToRemote=gatewayToRemote, aliasIpNetmask=aliasIpNetmask, modbusMode=modbusMode, ftpdService=ftpdService, portEntry=portEntry, interFrame=interFrame, timeoutPAD=timeoutPAD, timeoutRxTx=timeoutRxTx, telnetdService=telnetdService, portReset=portReset, authRad2=authRad2, rxIdle=rxIdle, slaveIPaddr=slaveIPaddr, httpdService=httpdService, reset=reset, endMsg=endMsg, radiusSecret1=radiusSecret1, version=version, resetByButton=resetByButton, statusDTR=statusDTR, portIndex=portIndex, nbParStop=nbParStop, bytesReceiveFromV24=bytesReceiveFromV24, radiusServer2=radiusServer2, snmpTrapAddr1=snmpTrapAddr1, radiusServer1=radiusServer1, remoteTcpPort=remoteTcpPort, secondTcpPort=secondTcpPort, acctRad1=acctRad1, ipServer=ipServer, acctRad2=acctRad2, slaveHexaAddress=slaveHexaAddress, txIdle=txIdle, multiSession=multiSession, authRad1=authRad1, sessionStarted=sessionStarted, snmpTrapAddr2=snmpTrapAddr2, ipGateway=ipGateway, bootp=bootp, mainIpAddress=mainIpAddress, tcpPort=tcpPort, beforeSend=beforeSend, portStatsEntry=portStatsEntry, dtrDown=dtrDown, formFeed=formFeed, nameServer2=nameServer2, modbusEntry=modbusEntry, portTable=portTable, authType=authType, mode=mode, nameResolution=nameResolution, system=system, baudRate=baudRate, snmpTrap=snmpTrap, flowControl=flowControl, bytesSendToV24=bytesSendToV24, modbusType=modbusType, snmpdService=snmpdService, ethernetAddress=ethernetAddress, modbusTable=modbusTable, siteName=siteName, secondGateway=secondGateway, ts=ts, dtrUp=dtrUp, cxr=cxr)
