...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter32, Integer32, Counter64, ObjectIdentity, Bits, IpAddress, iso, enterprises, MibIdentifier, ModuleIdentity, TimeTicks, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter32", "Integer32", "Counter64", "ObjectIdentity", "Bits", "IpAddress", "iso", "enterprises", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", aliasIpAddress=aliasIpAddress, radiusSecret2=radiusSecret2, slaveIPaddr=slaveIPaddr, authType=authType, acctRad1=acctRad1, ts=ts, ethernetAddress=ethernetAddress, bytesSendToV24=bytesSendToV24, siteName=siteName, remoteIpAddress=remoteIpAddress, authRad2=authRad2, portStatsTable=portStatsTable, formFeed=formFeed, ipServer=ipServer, modbusMode=modbusMode, radiusServer2=radiusServer2, secondGateway=secondGateway, slaveHexaAddress=slaveHexaAddress, bytesReceiveFromV24=bytesReceiveFromV24, acctRad2=acctRad2, aliasIpNetmask=aliasIpNetmask, secondTcpPort=secondTcpPort, dtrDown=dtrDown, portReset=portReset, statusDTR=statusDTR, system=system, endMsg=endMsg, mainIpAddress=mainIpAddress, baudRate=baudRate, timeoutPAD=timeoutPAD, snmpdService=snmpdService, sessionStopped=sessionStopped, ftpdService=ftpdService, modbusType=modbusType, ipGateway=ipGateway, modbusEntry=modbusEntry, cxr=cxr, reset=reset, flowControl=flowControl, radiusSecret1=radiusSecret1, portStatsEntry=portStatsEntry, sessionStarted=sessionStarted, bootp=bootp, txIdle=txIdle, interFrame=interFrame, resetByButton=resetByButton, slaveIPport=slaveIPport, multiSession=multiSession, authRad1=authRad1, mode=mode, nameServer1=nameServer1, telnetdService=telnetdService, productName=productName, snmpTrapAddr1=snmpTrapAddr1, snmpTrap=snmpTrap, modbusTable=modbusTable, nameServer2=nameServer2, portTable=portTable, gatewayToRemote=gatewayToRemote, remoteTcpPort=remoteTcpPort, nameResolution=nameResolution, tcpPort=tcpPort, timeoutRxTx=timeoutRxTx, httpdService=httpdService, ipNetmask=ipNetmask, afterSend=afterSend, terminalType=terminalType, snmpTrapAddr2=snmpTrapAddr2, portIndex=portIndex, rxIdle=rxIdle, beforeSend=beforeSend, secondIpAddress=secondIpAddress, nbParStop=nbParStop, radiusServer1=radiusServer1, portEntry=portEntry, version=version, dtrUp=dtrUp)
