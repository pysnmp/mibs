...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:50:04 2023
...
Gauge32, MibIdentifier, NotificationType, ModuleIdentity, enterprises, IpAddress, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso, ObjectIdentity, Counter32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "NotificationType", "ModuleIdentity", "enterprises", "IpAddress", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso", "ObjectIdentity", "Counter32", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer2=radiusServer2, version=version, portTable=portTable, authType=authType, nameServer1=nameServer1, txIdle=txIdle, tcpPort=tcpPort, dtrDown=dtrDown, radiusServer1=radiusServer1, radiusSecret1=radiusSecret1, resetByButton=resetByButton, slaveHexaAddress=slaveHexaAddress, radiusSecret2=radiusSecret2, gatewayToRemote=gatewayToRemote, sessionStopped=sessionStopped, productName=productName, reset=reset, authRad1=authRad1, afterSend=afterSend, ftpdService=ftpdService, acctRad2=acctRad2, bytesSendToV24=bytesSendToV24, secondTcpPort=secondTcpPort, modbusTable=modbusTable, nbParStop=nbParStop, aliasIpAddress=aliasIpAddress, telnetdService=telnetdService, acctRad1=acctRad1, portIndex=portIndex, remoteTcpPort=remoteTcpPort, rxIdle=rxIdle, modbusType=modbusType, slaveIPaddr=slaveIPaddr, dtrUp=dtrUp, ipGateway=ipGateway, system=system, slaveIPport=slaveIPport, sessionStarted=sessionStarted, modbusMode=modbusMode, snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, bootp=bootp, portStatsTable=portStatsTable, multiSession=multiSession, mode=mode, portStatsEntry=portStatsEntry, ts=ts, remoteIpAddress=remoteIpAddress, ethernetAddress=ethernetAddress, statusDTR=statusDTR, snmpdService=snmpdService, secondIpAddress=secondIpAddress, siteName=siteName, flowControl=flowControl, interFrame=interFrame, portEntry=portEntry, snmpTrap=snmpTrap, authRad2=authRad2, bytesReceiveFromV24=bytesReceiveFromV24, terminalType=terminalType, mainIpAddress=mainIpAddress, httpdService=httpdService, cxr=cxr, formFeed=formFeed, endMsg=endMsg, portReset=portReset, snmpTrapAddr1=snmpTrapAddr1, beforeSend=beforeSend, timeoutRxTx=timeoutRxTx, nameResolution=nameResolution, modbusEntry=modbusEntry, secondGateway=secondGateway, nameServer2=nameServer2, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, ipNetmask=ipNetmask, timeoutPAD=timeoutPAD)
