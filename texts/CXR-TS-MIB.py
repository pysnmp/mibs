...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:23:04 2022
...
IpAddress, Gauge32, Counter64, iso, NotificationType, Counter32, MibIdentifier, enterprises, Integer32, TimeTicks, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter64", "iso", "NotificationType", "Counter32", "MibIdentifier", "enterprises", "Integer32", "TimeTicks", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpdService=snmpdService, acctRad2=acctRad2, portStatsTable=portStatsTable, remoteIpAddress=remoteIpAddress, sessionStarted=sessionStarted, secondTcpPort=secondTcpPort, portTable=portTable, nameResolution=nameResolution, sessionStopped=sessionStopped, interFrame=interFrame, portIndex=portIndex, nbParStop=nbParStop, beforeSend=beforeSend, slaveIPport=slaveIPport, ipGateway=ipGateway, flowControl=flowControl, portEntry=portEntry, cxr=cxr, ftpdService=ftpdService, secondGateway=secondGateway, ipNetmask=ipNetmask, modbusEntry=modbusEntry, radiusSecret1=radiusSecret1, bootp=bootp, productName=productName, system=system, nameServer2=nameServer2, slaveIPaddr=slaveIPaddr, slaveHexaAddress=slaveHexaAddress, telnetdService=telnetdService, dtrDown=dtrDown, baudRate=baudRate, bytesSendToV24=bytesSendToV24, snmpTrapAddr2=snmpTrapAddr2, gatewayToRemote=gatewayToRemote, authType=authType, txIdle=txIdle, rxIdle=rxIdle, secondIpAddress=secondIpAddress, mode=mode, version=version, ethernetAddress=ethernetAddress, tcpPort=tcpPort, reset=reset, ipServer=ipServer, snmpTrapAddr1=snmpTrapAddr1, multiSession=multiSession, ts=ts, httpdService=httpdService, remoteTcpPort=remoteTcpPort, siteName=siteName, nameServer1=nameServer1, resetByButton=resetByButton, endMsg=endMsg, modbusMode=modbusMode, timeoutPAD=timeoutPAD, terminalType=terminalType, statusDTR=statusDTR, radiusServer1=radiusServer1, snmpTrap=snmpTrap, portStatsEntry=portStatsEntry, radiusSecret2=radiusSecret2, radiusServer2=radiusServer2, modbusType=modbusType, bytesReceiveFromV24=bytesReceiveFromV24, modbusTable=modbusTable, afterSend=afterSend, timeoutRxTx=timeoutRxTx, dtrUp=dtrUp, authRad2=authRad2, aliasIpAddress=aliasIpAddress, authRad1=authRad1, formFeed=formFeed, portReset=portReset, mainIpAddress=mainIpAddress, acctRad1=acctRad1, aliasIpNetmask=aliasIpNetmask)
