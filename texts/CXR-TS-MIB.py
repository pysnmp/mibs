...
NotificationType, IpAddress, Integer32, Counter32, TimeTicks, ObjectIdentity, MibIdentifier, enterprises, ModuleIdentity, iso, NotificationType, Bits, Counter64, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Integer32", "Counter32", "TimeTicks", "ObjectIdentity", "MibIdentifier", "enterprises", "ModuleIdentity", "iso", "NotificationType", "Bits", "Counter64", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", endMsg=endMsg, snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, telnetdService=telnetdService, ipServer=ipServer, secondIpAddress=secondIpAddress, remoteTcpPort=remoteTcpPort, modbusMode=modbusMode, portEntry=portEntry, beforeSend=beforeSend, aliasIpNetmask=aliasIpNetmask, slaveIPaddr=slaveIPaddr, sessionStopped=sessionStopped, afterSend=afterSend, terminalType=terminalType, nbParStop=nbParStop, remoteIpAddress=remoteIpAddress, slaveIPport=slaveIPport, ipGateway=ipGateway, portIndex=portIndex, authRad2=authRad2, secondTcpPort=secondTcpPort, ipNetmask=ipNetmask, radiusServer2=radiusServer2, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr1=snmpTrapAddr1, modbusType=modbusType, aliasIpAddress=aliasIpAddress, gatewayToRemote=gatewayToRemote, multiSession=multiSession, httpdService=httpdService, bytesSendToV24=bytesSendToV24, txIdle=txIdle, ts=ts, mode=mode, productName=productName, authType=authType, sessionStarted=sessionStarted, statusDTR=statusDTR, siteName=siteName, interFrame=interFrame, snmpdService=snmpdService, radiusSecret2=radiusSecret2, radiusSecret1=radiusSecret1, flowControl=flowControl, mainIpAddress=mainIpAddress, modbusTable=modbusTable, acctRad1=acctRad1, cxr=cxr, resetByButton=resetByButton, authRad1=authRad1, nameResolution=nameResolution, acctRad2=acctRad2, ftpdService=ftpdService, portStatsEntry=portStatsEntry, portTable=portTable, nameServer1=nameServer1, timeoutPAD=timeoutPAD, dtrDown=dtrDown, ethernetAddress=ethernetAddress, modbusEntry=modbusEntry, bootp=bootp, rxIdle=rxIdle, portStatsTable=portStatsTable, nameServer2=nameServer2, snmpTrap=snmpTrap, system=system, radiusServer1=radiusServer1, version=version, timeoutRxTx=timeoutRxTx, formFeed=formFeed, reset=reset, portReset=portReset, dtrUp=dtrUp, secondGateway=secondGateway, slaveHexaAddress=slaveHexaAddress, tcpPort=tcpPort)
