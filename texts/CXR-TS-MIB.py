...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:55:03 2023
...
NotificationType, TimeTicks, iso, ModuleIdentity, Unsigned32, IpAddress, Counter32, NotificationType, Bits, Gauge32, Counter64, enterprises, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "Bits", "Gauge32", "Counter64", "enterprises", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", endMsg=endMsg, snmpTrapAddr1=snmpTrapAddr1, baudRate=baudRate, secondGateway=secondGateway, portReset=portReset, remoteIpAddress=remoteIpAddress, snmpdService=snmpdService, sessionStarted=sessionStarted, statusDTR=statusDTR, slaveIPaddr=slaveIPaddr, telnetdService=telnetdService, ipNetmask=ipNetmask, snmpTrap=snmpTrap, slaveHexaAddress=slaveHexaAddress, version=version, portStatsTable=portStatsTable, nameServer2=nameServer2, httpdService=httpdService, reset=reset, remoteTcpPort=remoteTcpPort, flowControl=flowControl, dtrDown=dtrDown, timeoutPAD=timeoutPAD, portIndex=portIndex, portEntry=portEntry, interFrame=interFrame, bootp=bootp, modbusTable=modbusTable, rxIdle=rxIdle, sessionStopped=sessionStopped, ipGateway=ipGateway, timeoutRxTx=timeoutRxTx, acctRad2=acctRad2, authRad2=authRad2, bytesSendToV24=bytesSendToV24, modbusMode=modbusMode, ftpdService=ftpdService, resetByButton=resetByButton, gatewayToRemote=gatewayToRemote, formFeed=formFeed, nameServer1=nameServer1, slaveIPport=slaveIPport, secondTcpPort=secondTcpPort, mode=mode, ipServer=ipServer, txIdle=txIdle, authType=authType, multiSession=multiSession, portTable=portTable, tcpPort=tcpPort, acctRad1=acctRad1, radiusSecret2=radiusSecret2, radiusServer1=radiusServer1, snmpTrapAddr2=snmpTrapAddr2, bytesReceiveFromV24=bytesReceiveFromV24, secondIpAddress=secondIpAddress, cxr=cxr, aliasIpNetmask=aliasIpNetmask, productName=productName, system=system, portStatsEntry=portStatsEntry, ts=ts, modbusType=modbusType, dtrUp=dtrUp, mainIpAddress=mainIpAddress, terminalType=terminalType, aliasIpAddress=aliasIpAddress, ethernetAddress=ethernetAddress, radiusSecret1=radiusSecret1, nameResolution=nameResolution, afterSend=afterSend, modbusEntry=modbusEntry, authRad1=authRad1, nbParStop=nbParStop, beforeSend=beforeSend, siteName=siteName, radiusServer2=radiusServer2)
