...
iso, Counter32, TimeTicks, NotificationType, IpAddress, ObjectIdentity, Unsigned32, Integer32, MibIdentifier, Gauge32, NotificationType, Counter64, ModuleIdentity, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity", "Unsigned32", "Integer32", "MibIdentifier", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameResolution=nameResolution, portStatsTable=portStatsTable, version=version, secondTcpPort=secondTcpPort, tcpPort=tcpPort, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, slaveIPport=slaveIPport, snmpTrap=snmpTrap, nbParStop=nbParStop, authType=authType, acctRad1=acctRad1, portEntry=portEntry, portTable=portTable, modbusEntry=modbusEntry, dtrDown=dtrDown, portStatsEntry=portStatsEntry, dtrUp=dtrUp, cxr=cxr, afterSend=afterSend, radiusSecret2=radiusSecret2, statusDTR=statusDTR, txIdle=txIdle, baudRate=baudRate, slaveHexaAddress=slaveHexaAddress, telnetdService=telnetdService, portIndex=portIndex, gatewayToRemote=gatewayToRemote, radiusServer2=radiusServer2, siteName=siteName, ipGateway=ipGateway, ethernetAddress=ethernetAddress, flowControl=flowControl, modbusMode=modbusMode, nameServer1=nameServer1, bootp=bootp, rxIdle=rxIdle, ipServer=ipServer, productName=productName, authRad1=authRad1, timeoutPAD=timeoutPAD, ipNetmask=ipNetmask, secondGateway=secondGateway, ftpdService=ftpdService, resetByButton=resetByButton, formFeed=formFeed, remoteIpAddress=remoteIpAddress, radiusServer1=radiusServer1, portReset=portReset, bytesSendToV24=bytesSendToV24, secondIpAddress=secondIpAddress, sessionStopped=sessionStopped, slaveIPaddr=slaveIPaddr, beforeSend=beforeSend, reset=reset, mainIpAddress=mainIpAddress, modbusType=modbusType, acctRad2=acctRad2, modbusTable=modbusTable, httpdService=httpdService, mode=mode, aliasIpNetmask=aliasIpNetmask, system=system, ts=ts, snmpTrapAddr2=snmpTrapAddr2, snmpTrapAddr1=snmpTrapAddr1, remoteTcpPort=remoteTcpPort, authRad2=authRad2, endMsg=endMsg, sessionStarted=sessionStarted, snmpdService=snmpdService, multiSession=multiSession, radiusSecret1=radiusSecret1, timeoutRxTx=timeoutRxTx, interFrame=interFrame, nameServer2=nameServer2, aliasIpAddress=aliasIpAddress)
