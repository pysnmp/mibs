...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:19:38 2023
...
MibIdentifier, enterprises, Counter64, iso, Bits, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, IpAddress, Counter32, NotificationType, ObjectIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "Counter64", "iso", "Bits", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "IpAddress", "Counter32", "NotificationType", "ObjectIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bytesSendToV24=bytesSendToV24, afterSend=afterSend, txIdle=txIdle, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, multiSession=multiSession, authRad1=authRad1, bytesReceiveFromV24=bytesReceiveFromV24, httpdService=httpdService, mode=mode, endMsg=endMsg, secondTcpPort=secondTcpPort, slaveIPaddr=slaveIPaddr, portStatsEntry=portStatsEntry, portTable=portTable, slaveHexaAddress=slaveHexaAddress, radiusSecret1=radiusSecret1, secondIpAddress=secondIpAddress, ftpdService=ftpdService, telnetdService=telnetdService, slaveIPport=slaveIPport, snmpTrapAddr2=snmpTrapAddr2, nameServer2=nameServer2, ethernetAddress=ethernetAddress, portReset=portReset, authType=authType, snmpdService=snmpdService, modbusMode=modbusMode, interFrame=interFrame, gatewayToRemote=gatewayToRemote, sessionStopped=sessionStopped, secondGateway=secondGateway, dtrDown=dtrDown, baudRate=baudRate, ipGateway=ipGateway, modbusType=modbusType, portStatsTable=portStatsTable, rxIdle=rxIdle, portIndex=portIndex, mainIpAddress=mainIpAddress, tcpPort=tcpPort, timeoutPAD=timeoutPAD, snmpTrapAddr1=snmpTrapAddr1, nbParStop=nbParStop, productName=productName, radiusSecret2=radiusSecret2, sessionStarted=sessionStarted, version=version, siteName=siteName, aliasIpNetmask=aliasIpNetmask, aliasIpAddress=aliasIpAddress, resetByButton=resetByButton, acctRad2=acctRad2, beforeSend=beforeSend, radiusServer1=radiusServer1, portEntry=portEntry, nameServer1=nameServer1, authRad2=authRad2, cxr=cxr, system=system, nameResolution=nameResolution, terminalType=terminalType, remoteTcpPort=remoteTcpPort, bootp=bootp, modbusTable=modbusTable, flowControl=flowControl, snmpTrap=snmpTrap, ipServer=ipServer, ts=ts, ipNetmask=ipNetmask, dtrUp=dtrUp, radiusServer2=radiusServer2, timeoutRxTx=timeoutRxTx, formFeed=formFeed, modbusEntry=modbusEntry, reset=reset, statusDTR=statusDTR)
