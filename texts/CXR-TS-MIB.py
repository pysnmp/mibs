...
IpAddress, ModuleIdentity, MibIdentifier, enterprises, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64, NotificationType, Gauge32, NotificationType, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibIdentifier", "enterprises", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64", "NotificationType", "Gauge32", "NotificationType", "Integer32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", system=system, nameResolution=nameResolution, portStatsTable=portStatsTable, snmpTrapAddr1=snmpTrapAddr1, ethernetAddress=ethernetAddress, portTable=portTable, modbusType=modbusType, baudRate=baudRate, nbParStop=nbParStop, acctRad2=acctRad2, modbusMode=modbusMode, radiusSecret2=radiusSecret2, aliasIpAddress=aliasIpAddress, bytesSendToV24=bytesSendToV24, radiusServer2=radiusServer2, timeoutPAD=timeoutPAD, authType=authType, portReset=portReset, authRad1=authRad1, telnetdService=telnetdService, modbusTable=modbusTable, snmpTrapAddr2=snmpTrapAddr2, radiusSecret1=radiusSecret1, ipNetmask=ipNetmask, portEntry=portEntry, slaveHexaAddress=slaveHexaAddress, snmpdService=snmpdService, secondGateway=secondGateway, txIdle=txIdle, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, version=version, productName=productName, siteName=siteName, timeoutRxTx=timeoutRxTx, reset=reset, aliasIpNetmask=aliasIpNetmask, terminalType=terminalType, slaveIPport=slaveIPport, slaveIPaddr=slaveIPaddr, resetByButton=resetByButton, radiusServer1=radiusServer1, gatewayToRemote=gatewayToRemote, httpdService=httpdService, bytesReceiveFromV24=bytesReceiveFromV24, tcpPort=tcpPort, dtrDown=dtrDown, ftpdService=ftpdService, endMsg=endMsg, ts=ts, portStatsEntry=portStatsEntry, remoteTcpPort=remoteTcpPort, interFrame=interFrame, nameServer2=nameServer2, portIndex=portIndex, sessionStarted=sessionStarted, afterSend=afterSend, authRad2=authRad2, beforeSend=beforeSend, statusDTR=statusDTR, secondIpAddress=secondIpAddress, flowControl=flowControl, mode=mode, nameServer1=nameServer1, modbusEntry=modbusEntry, rxIdle=rxIdle, ipServer=ipServer, sessionStopped=sessionStopped, dtrUp=dtrUp, secondTcpPort=secondTcpPort, snmpTrap=snmpTrap, multiSession=multiSession, mainIpAddress=mainIpAddress, ipGateway=ipGateway, formFeed=formFeed, bootp=bootp, cxr=cxr)
