...
Bits, MibIdentifier, Counter32, Unsigned32, Gauge32, Counter64, enterprises, ObjectIdentity, NotificationType, NotificationType, ModuleIdentity, Integer32, iso, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Counter32", "Unsigned32", "Gauge32", "Counter64", "enterprises", "ObjectIdentity", "NotificationType", "NotificationType", "ModuleIdentity", "Integer32", "iso", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer1=radiusServer1, secondIpAddress=secondIpAddress, snmpdService=snmpdService, radiusServer2=radiusServer2, siteName=siteName, system=system, timeoutPAD=timeoutPAD, rxIdle=rxIdle, bytesReceiveFromV24=bytesReceiveFromV24, dtrDown=dtrDown, ftpdService=ftpdService, snmpTrapAddr2=snmpTrapAddr2, dtrUp=dtrUp, productName=productName, bootp=bootp, nameResolution=nameResolution, resetByButton=resetByButton, flowControl=flowControl, ethernetAddress=ethernetAddress, afterSend=afterSend, sessionStarted=sessionStarted, nameServer2=nameServer2, snmpTrap=snmpTrap, aliasIpNetmask=aliasIpNetmask, sessionStopped=sessionStopped, tcpPort=tcpPort, ts=ts, remoteTcpPort=remoteTcpPort, secondTcpPort=secondTcpPort, nameServer1=nameServer1, modbusEntry=modbusEntry, interFrame=interFrame, slaveIPport=slaveIPport, reset=reset, multiSession=multiSession, modbusTable=modbusTable, acctRad2=acctRad2, mode=mode, ipGateway=ipGateway, statusDTR=statusDTR, portReset=portReset, endMsg=endMsg, txIdle=txIdle, ipNetmask=ipNetmask, mainIpAddress=mainIpAddress, terminalType=terminalType, secondGateway=secondGateway, portTable=portTable, acctRad1=acctRad1, snmpTrapAddr1=snmpTrapAddr1, radiusSecret2=radiusSecret2, aliasIpAddress=aliasIpAddress, authRad1=authRad1, authRad2=authRad2, remoteIpAddress=remoteIpAddress, modbusType=modbusType, portStatsEntry=portStatsEntry, modbusMode=modbusMode, httpdService=httpdService, ipServer=ipServer, timeoutRxTx=timeoutRxTx, formFeed=formFeed, telnetdService=telnetdService, baudRate=baudRate, portEntry=portEntry, version=version, portIndex=portIndex, radiusSecret1=radiusSecret1, bytesSendToV24=bytesSendToV24, gatewayToRemote=gatewayToRemote, authType=authType, nbParStop=nbParStop, portStatsTable=portStatsTable, slaveHexaAddress=slaveHexaAddress, cxr=cxr, beforeSend=beforeSend, slaveIPaddr=slaveIPaddr)
