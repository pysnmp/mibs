...
enterprises, Integer32, MibIdentifier, IpAddress, Bits, NotificationType, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, ModuleIdentity, TimeTicks, Counter64, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "MibIdentifier", "IpAddress", "Bits", "NotificationType", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Counter64", "iso", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrap=snmpTrap, snmpdService=snmpdService, reset=reset, bytesReceiveFromV24=bytesReceiveFromV24, resetByButton=resetByButton, aliasIpNetmask=aliasIpNetmask, portIndex=portIndex, interFrame=interFrame, ipNetmask=ipNetmask, portStatsTable=portStatsTable, modbusEntry=modbusEntry, rxIdle=rxIdle, timeoutPAD=timeoutPAD, endMsg=endMsg, modbusType=modbusType, portTable=portTable, ethernetAddress=ethernetAddress, dtrDown=dtrDown, acctRad2=acctRad2, ts=ts, nameServer1=nameServer1, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, portStatsEntry=portStatsEntry, productName=productName, radiusSecret2=radiusSecret2, secondGateway=secondGateway, sessionStopped=sessionStopped, portEntry=portEntry, modbusMode=modbusMode, terminalType=terminalType, telnetdService=telnetdService, remoteIpAddress=remoteIpAddress, multiSession=multiSession, modbusTable=modbusTable, ftpdService=ftpdService, statusDTR=statusDTR, authRad1=authRad1, radiusSecret1=radiusSecret1, slaveIPport=slaveIPport, afterSend=afterSend, timeoutRxTx=timeoutRxTx, radiusServer1=radiusServer1, sessionStarted=sessionStarted, gatewayToRemote=gatewayToRemote, nameResolution=nameResolution, httpdService=httpdService, snmpTrapAddr2=snmpTrapAddr2, slaveIPaddr=slaveIPaddr, txIdle=txIdle, dtrUp=dtrUp, authType=authType, ipGateway=ipGateway, snmpTrapAddr1=snmpTrapAddr1, beforeSend=beforeSend, cxr=cxr, flowControl=flowControl, remoteTcpPort=remoteTcpPort, formFeed=formFeed, mode=mode, acctRad1=acctRad1, radiusServer2=radiusServer2, mainIpAddress=mainIpAddress, tcpPort=tcpPort, aliasIpAddress=aliasIpAddress, bytesSendToV24=bytesSendToV24, authRad2=authRad2, bootp=bootp, secondTcpPort=secondTcpPort, siteName=siteName, ipServer=ipServer, secondIpAddress=secondIpAddress, system=system, nameServer2=nameServer2, baudRate=baudRate, version=version, portReset=portReset)
