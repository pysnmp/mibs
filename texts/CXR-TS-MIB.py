...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:15:56 2023
...
MibIdentifier, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, TimeTicks, ModuleIdentity, enterprises, ObjectIdentity, IpAddress, Bits, Integer32, Gauge32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "TimeTicks", "ModuleIdentity", "enterprises", "ObjectIdentity", "IpAddress", "Bits", "Integer32", "Gauge32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", slaveIPaddr=slaveIPaddr, portEntry=portEntry, ipGateway=ipGateway, ftpdService=ftpdService, ts=ts, remoteTcpPort=remoteTcpPort, system=system, radiusServer2=radiusServer2, authRad1=authRad1, secondTcpPort=secondTcpPort, nameServer2=nameServer2, beforeSend=beforeSend, portStatsEntry=portStatsEntry, authType=authType, dtrUp=dtrUp, secondIpAddress=secondIpAddress, bytesReceiveFromV24=bytesReceiveFromV24, gatewayToRemote=gatewayToRemote, baudRate=baudRate, terminalType=terminalType, resetByButton=resetByButton, modbusMode=modbusMode, nameServer1=nameServer1, snmpTrap=snmpTrap, ipServer=ipServer, modbusTable=modbusTable, modbusEntry=modbusEntry, cxr=cxr, httpdService=httpdService, aliasIpNetmask=aliasIpNetmask, ethernetAddress=ethernetAddress, acctRad1=acctRad1, dtrDown=dtrDown, secondGateway=secondGateway, reset=reset, portReset=portReset, radiusServer1=radiusServer1, modbusType=modbusType, authRad2=authRad2, endMsg=endMsg, mainIpAddress=mainIpAddress, timeoutRxTx=timeoutRxTx, siteName=siteName, timeoutPAD=timeoutPAD, aliasIpAddress=aliasIpAddress, sessionStopped=sessionStopped, nbParStop=nbParStop, formFeed=formFeed, slaveHexaAddress=slaveHexaAddress, remoteIpAddress=remoteIpAddress, interFrame=interFrame, snmpdService=snmpdService, tcpPort=tcpPort, flowControl=flowControl, bytesSendToV24=bytesSendToV24, radiusSecret1=radiusSecret1, slaveIPport=slaveIPport, productName=productName, acctRad2=acctRad2, telnetdService=telnetdService, mode=mode, statusDTR=statusDTR, nameResolution=nameResolution, afterSend=afterSend, txIdle=txIdle, snmpTrapAddr1=snmpTrapAddr1, portIndex=portIndex, bootp=bootp, radiusSecret2=radiusSecret2, version=version, ipNetmask=ipNetmask, portStatsTable=portStatsTable, snmpTrapAddr2=snmpTrapAddr2, sessionStarted=sessionStarted, multiSession=multiSession, rxIdle=rxIdle, portTable=portTable)
