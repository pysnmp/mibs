...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:46:50 2022
...
ModuleIdentity, ObjectIdentity, Counter32, NotificationType, IpAddress, Integer32, TimeTicks, NotificationType, enterprises, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "IpAddress", "Integer32", "TimeTicks", "NotificationType", "enterprises", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mainIpAddress=mainIpAddress, radiusSecret1=radiusSecret1, ipGateway=ipGateway, bootp=bootp, productName=productName, slaveHexaAddress=slaveHexaAddress, tcpPort=tcpPort, txIdle=txIdle, radiusServer2=radiusServer2, acctRad1=acctRad1, modbusType=modbusType, snmpTrap=snmpTrap, aliasIpAddress=aliasIpAddress, remoteIpAddress=remoteIpAddress, gatewayToRemote=gatewayToRemote, flowControl=flowControl, portTable=portTable, radiusSecret2=radiusSecret2, ipServer=ipServer, nameResolution=nameResolution, authType=authType, multiSession=multiSession, ts=ts, cxr=cxr, sessionStarted=sessionStarted, telnetdService=telnetdService, authRad2=authRad2, ethernetAddress=ethernetAddress, portIndex=portIndex, acctRad2=acctRad2, portReset=portReset, httpdService=httpdService, timeoutPAD=timeoutPAD, aliasIpNetmask=aliasIpNetmask, secondTcpPort=secondTcpPort, secondIpAddress=secondIpAddress, sessionStopped=sessionStopped, authRad1=authRad1, modbusMode=modbusMode, ftpdService=ftpdService, endMsg=endMsg, slaveIPaddr=slaveIPaddr, snmpTrapAddr1=snmpTrapAddr1, modbusEntry=modbusEntry, dtrDown=dtrDown, timeoutRxTx=timeoutRxTx, ipNetmask=ipNetmask, mode=mode, slaveIPport=slaveIPport, modbusTable=modbusTable, afterSend=afterSend, snmpdService=snmpdService, nameServer2=nameServer2, radiusServer1=radiusServer1, reset=reset, nbParStop=nbParStop, portStatsTable=portStatsTable, terminalType=terminalType, resetByButton=resetByButton, snmpTrapAddr2=snmpTrapAddr2, remoteTcpPort=remoteTcpPort, dtrUp=dtrUp, portStatsEntry=portStatsEntry, interFrame=interFrame, formFeed=formFeed, system=system, baudRate=baudRate, bytesReceiveFromV24=bytesReceiveFromV24, statusDTR=statusDTR, nameServer1=nameServer1, siteName=siteName, secondGateway=secondGateway, version=version, portEntry=portEntry, beforeSend=beforeSend, rxIdle=rxIdle, bytesSendToV24=bytesSendToV24)
