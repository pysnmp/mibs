...
NotificationType, IpAddress, Counter64, Gauge32, enterprises, Counter32, iso, ModuleIdentity, Integer32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter64", "Gauge32", "enterprises", "Counter32", "iso", "ModuleIdentity", "Integer32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpdService=snmpdService, timeoutPAD=timeoutPAD, terminalType=terminalType, flowControl=flowControl, secondIpAddress=secondIpAddress, modbusType=modbusType, afterSend=afterSend, version=version, gatewayToRemote=gatewayToRemote, slaveHexaAddress=slaveHexaAddress, nameServer2=nameServer2, portStatsTable=portStatsTable, sessionStopped=sessionStopped, ethernetAddress=ethernetAddress, resetByButton=resetByButton, portIndex=portIndex, authRad2=authRad2, acctRad2=acctRad2, ts=ts, authRad1=authRad1, nameResolution=nameResolution, nbParStop=nbParStop, authType=authType, snmpTrapAddr1=snmpTrapAddr1, ftpdService=ftpdService, timeoutRxTx=timeoutRxTx, bytesReceiveFromV24=bytesReceiveFromV24, nameServer1=nameServer1, slaveIPport=slaveIPport, modbusEntry=modbusEntry, ipGateway=ipGateway, snmpTrap=snmpTrap, ipServer=ipServer, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, radiusSecret2=radiusSecret2, mode=mode, multiSession=multiSession, bytesSendToV24=bytesSendToV24, bootp=bootp, formFeed=formFeed, portStatsEntry=portStatsEntry, dtrDown=dtrDown, sessionStarted=sessionStarted, rxIdle=rxIdle, dtrUp=dtrUp, reset=reset, endMsg=endMsg, beforeSend=beforeSend, mainIpAddress=mainIpAddress, remoteIpAddress=remoteIpAddress, telnetdService=telnetdService, radiusServer1=radiusServer1, interFrame=interFrame, tcpPort=tcpPort, portTable=portTable, radiusServer2=radiusServer2, portReset=portReset, snmpTrapAddr2=snmpTrapAddr2, remoteTcpPort=remoteTcpPort, modbusMode=modbusMode, acctRad1=acctRad1, secondGateway=secondGateway, httpdService=httpdService, ipNetmask=ipNetmask, portEntry=portEntry, slaveIPaddr=slaveIPaddr, secondTcpPort=secondTcpPort, siteName=siteName, productName=productName, cxr=cxr, statusDTR=statusDTR, baudRate=baudRate, aliasIpAddress=aliasIpAddress, modbusTable=modbusTable, system=system, radiusSecret1=radiusSecret1)
