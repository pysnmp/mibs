...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:57:35 2023
...
ModuleIdentity, Integer32, enterprises, TimeTicks, ObjectIdentity, Unsigned32, iso, MibIdentifier, Gauge32, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "enterprises", "TimeTicks", "ObjectIdentity", "Unsigned32", "iso", "MibIdentifier", "Gauge32", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr1=snmpTrapAddr1, baudRate=baudRate, portStatsTable=portStatsTable, radiusSecret2=radiusSecret2, snmpdService=snmpdService, aliasIpAddress=aliasIpAddress, modbusEntry=modbusEntry, tcpPort=tcpPort, ethernetAddress=ethernetAddress, nameResolution=nameResolution, productName=productName, secondTcpPort=secondTcpPort, radiusServer2=radiusServer2, timeoutPAD=timeoutPAD, multiSession=multiSession, bootp=bootp, ts=ts, modbusMode=modbusMode, portStatsEntry=portStatsEntry, modbusType=modbusType, radiusServer1=radiusServer1, reset=reset, remoteIpAddress=remoteIpAddress, telnetdService=telnetdService, snmpTrap=snmpTrap, portEntry=portEntry, authRad1=authRad1, ipServer=ipServer, snmpTrapAddr2=snmpTrapAddr2, ipGateway=ipGateway, interFrame=interFrame, portIndex=portIndex, formFeed=formFeed, radiusSecret1=radiusSecret1, nameServer1=nameServer1, nbParStop=nbParStop, slaveIPport=slaveIPport, rxIdle=rxIdle, authType=authType, mode=mode, afterSend=afterSend, ftpdService=ftpdService, httpdService=httpdService, slaveHexaAddress=slaveHexaAddress, timeoutRxTx=timeoutRxTx, ipNetmask=ipNetmask, portTable=portTable, siteName=siteName, statusDTR=statusDTR, beforeSend=beforeSend, dtrUp=dtrUp, txIdle=txIdle, secondIpAddress=secondIpAddress, endMsg=endMsg, authRad2=authRad2, remoteTcpPort=remoteTcpPort, terminalType=terminalType, nameServer2=nameServer2, mainIpAddress=mainIpAddress, portReset=portReset, dtrDown=dtrDown, gatewayToRemote=gatewayToRemote, bytesSendToV24=bytesSendToV24, version=version, secondGateway=secondGateway, flowControl=flowControl, acctRad1=acctRad1, aliasIpNetmask=aliasIpNetmask, acctRad2=acctRad2, sessionStopped=sessionStopped, system=system, modbusTable=modbusTable, slaveIPaddr=slaveIPaddr, resetByButton=resetByButton, cxr=cxr, sessionStarted=sessionStarted)
