...
# Produced by pysmi-1.1.12 at Tue Jun  4 10:06:53 2024
...
IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, MibIdentifier, Counter64, Counter32, NotificationType, TimeTicks, iso, enterprises, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "TimeTicks", "iso", "enterprises", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", tcpPort=tcpPort, terminalType=terminalType, nbParStop=nbParStop, mode=mode, cxr=cxr, acctRad2=acctRad2, portStatsTable=portStatsTable, remoteTcpPort=remoteTcpPort, snmpTrapAddr2=snmpTrapAddr2, modbusMode=modbusMode, afterSend=afterSend, snmpTrap=snmpTrap, baudRate=baudRate, telnetdService=telnetdService, radiusServer2=radiusServer2, modbusType=modbusType, remoteIpAddress=remoteIpAddress, nameServer2=nameServer2, portEntry=portEntry, mainIpAddress=mainIpAddress, rxIdle=rxIdle, aliasIpAddress=aliasIpAddress, authType=authType, endMsg=endMsg, secondTcpPort=secondTcpPort, sessionStarted=sessionStarted, bytesSendToV24=bytesSendToV24, slaveHexaAddress=slaveHexaAddress, siteName=siteName, authRad1=authRad1, formFeed=formFeed, slaveIPport=slaveIPport, snmpdService=snmpdService, acctRad1=acctRad1, gatewayToRemote=gatewayToRemote, ethernetAddress=ethernetAddress, productName=productName, portReset=portReset, aliasIpNetmask=aliasIpNetmask, portStatsEntry=portStatsEntry, ftpdService=ftpdService, dtrDown=dtrDown, ipNetmask=ipNetmask, portTable=portTable, snmpTrapAddr1=snmpTrapAddr1, resetByButton=resetByButton, radiusSecret2=radiusSecret2, ipGateway=ipGateway, secondIpAddress=secondIpAddress, secondGateway=secondGateway, nameResolution=nameResolution, ipServer=ipServer, reset=reset, ts=ts, flowControl=flowControl, httpdService=httpdService, version=version, nameServer1=nameServer1, txIdle=txIdle, bootp=bootp, multiSession=multiSession, sessionStopped=sessionStopped, timeoutPAD=timeoutPAD, beforeSend=beforeSend, statusDTR=statusDTR, modbusTable=modbusTable, dtrUp=dtrUp, radiusSecret1=radiusSecret1, system=system, interFrame=interFrame, modbusEntry=modbusEntry, authRad2=authRad2, bytesReceiveFromV24=bytesReceiveFromV24, timeoutRxTx=timeoutRxTx, portIndex=portIndex, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1)
