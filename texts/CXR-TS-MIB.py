...
# Produced by pysmi-1.1.12 at Tue Jun  4 12:00:53 2024
...
Bits, IpAddress, NotificationType, ModuleIdentity, MibIdentifier, ObjectIdentity, Counter64, iso, Counter32, Gauge32, Unsigned32, enterprises, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "NotificationType", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Counter64", "iso", "Counter32", "Gauge32", "Unsigned32", "enterprises", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteIpAddress=remoteIpAddress, timeoutPAD=timeoutPAD, txIdle=txIdle, slaveIPport=slaveIPport, aliasIpNetmask=aliasIpNetmask, terminalType=terminalType, ts=ts, productName=productName, portReset=portReset, modbusTable=modbusTable, reset=reset, portStatsTable=portStatsTable, aliasIpAddress=aliasIpAddress, dtrDown=dtrDown, formFeed=formFeed, resetByButton=resetByButton, portStatsEntry=portStatsEntry, slaveIPaddr=slaveIPaddr, rxIdle=rxIdle, ipNetmask=ipNetmask, ethernetAddress=ethernetAddress, version=version, siteName=siteName, secondGateway=secondGateway, snmpTrapAddr1=snmpTrapAddr1, bytesSendToV24=bytesSendToV24, secondIpAddress=secondIpAddress, portIndex=portIndex, mainIpAddress=mainIpAddress, snmpTrapAddr2=snmpTrapAddr2, sessionStopped=sessionStopped, timeoutRxTx=timeoutRxTx, telnetdService=telnetdService, remoteTcpPort=remoteTcpPort, multiSession=multiSession, portEntry=portEntry, gatewayToRemote=gatewayToRemote, dtrUp=dtrUp, radiusSecret2=radiusSecret2, flowControl=flowControl, ipServer=ipServer, portTable=portTable, ipGateway=ipGateway, acctRad2=acctRad2, endMsg=endMsg, mode=mode, tcpPort=tcpPort, bytesReceiveFromV24=bytesReceiveFromV24, ftpdService=ftpdService, cxr=cxr, nameServer2=nameServer2, baudRate=baudRate, nbParStop=nbParStop, sessionStarted=sessionStarted, modbusType=modbusType, radiusServer1=radiusServer1, snmpTrap=snmpTrap, authRad2=authRad2, bootp=bootp, authRad1=authRad1, system=system, afterSend=afterSend, statusDTR=statusDTR, modbusMode=modbusMode, slaveHexaAddress=slaveHexaAddress, radiusServer2=radiusServer2, httpdService=httpdService, beforeSend=beforeSend, snmpdService=snmpdService, secondTcpPort=secondTcpPort, nameResolution=nameResolution, radiusSecret1=radiusSecret1, nameServer1=nameServer1, authType=authType, interFrame=interFrame, acctRad1=acctRad1, modbusEntry=modbusEntry)
