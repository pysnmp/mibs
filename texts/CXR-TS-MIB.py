...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:22:42 2023
...
Counter32, ObjectIdentity, Bits, Unsigned32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, iso, Integer32, Counter64, Gauge32, NotificationType, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Bits", "Unsigned32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "iso", "Integer32", "Counter64", "Gauge32", "NotificationType", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusMode=modbusMode, multiSession=multiSession, statusDTR=statusDTR, portReset=portReset, txIdle=txIdle, slaveIPport=slaveIPport, rxIdle=rxIdle, terminalType=terminalType, snmpdService=snmpdService, ftpdService=ftpdService, portEntry=portEntry, aliasIpNetmask=aliasIpNetmask, bytesReceiveFromV24=bytesReceiveFromV24, telnetdService=telnetdService, nameResolution=nameResolution, mode=mode, formFeed=formFeed, httpdService=httpdService, ipNetmask=ipNetmask, ethernetAddress=ethernetAddress, endMsg=endMsg, portIndex=portIndex, nameServer1=nameServer1, afterSend=afterSend, snmpTrapAddr2=snmpTrapAddr2, acctRad1=acctRad1, flowControl=flowControl, authRad2=authRad2, nameServer2=nameServer2, version=version, sessionStopped=sessionStopped, reset=reset, portStatsEntry=portStatsEntry, radiusSecret2=radiusSecret2, system=system, radiusServer2=radiusServer2, beforeSend=beforeSend, authType=authType, baudRate=baudRate, acctRad2=acctRad2, portStatsTable=portStatsTable, radiusSecret1=radiusSecret1, sessionStarted=sessionStarted, timeoutRxTx=timeoutRxTx, secondGateway=secondGateway, ipServer=ipServer, bootp=bootp, timeoutPAD=timeoutPAD, productName=productName, dtrUp=dtrUp, portTable=portTable, snmpTrap=snmpTrap, snmpTrapAddr1=snmpTrapAddr1, nbParStop=nbParStop, interFrame=interFrame, siteName=siteName, modbusType=modbusType, remoteTcpPort=remoteTcpPort, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, mainIpAddress=mainIpAddress, aliasIpAddress=aliasIpAddress, slaveHexaAddress=slaveHexaAddress, tcpPort=tcpPort, cxr=cxr, remoteIpAddress=remoteIpAddress, gatewayToRemote=gatewayToRemote, bytesSendToV24=bytesSendToV24, modbusTable=modbusTable, slaveIPaddr=slaveIPaddr, resetByButton=resetByButton, secondIpAddress=secondIpAddress, authRad1=authRad1, radiusServer1=radiusServer1, ts=ts, dtrDown=dtrDown, ipGateway=ipGateway)
