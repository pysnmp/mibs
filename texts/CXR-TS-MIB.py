...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:09:39 2024
...
TimeTicks, Gauge32, Bits, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, MibIdentifier, ObjectIdentity, Counter32, enterprises, NotificationType, NotificationType, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Bits", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Counter32", "enterprises", "NotificationType", "NotificationType", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", telnetdService=telnetdService, terminalType=terminalType, sessionStarted=sessionStarted, bootp=bootp, httpdService=httpdService, sessionStopped=sessionStopped, aliasIpAddress=aliasIpAddress, mainIpAddress=mainIpAddress, productName=productName, snmpTrapAddr2=snmpTrapAddr2, interFrame=interFrame, secondGateway=secondGateway, remoteTcpPort=remoteTcpPort, secondIpAddress=secondIpAddress, acctRad2=acctRad2, ethernetAddress=ethernetAddress, ts=ts, acctRad1=acctRad1, statusDTR=statusDTR, radiusSecret1=radiusSecret1, system=system, version=version, siteName=siteName, authRad2=authRad2, gatewayToRemote=gatewayToRemote, txIdle=txIdle, authType=authType, formFeed=formFeed, authRad1=authRad1, portTable=portTable, secondTcpPort=secondTcpPort, nbParStop=nbParStop, dtrDown=dtrDown, rxIdle=rxIdle, modbusEntry=modbusEntry, timeoutPAD=timeoutPAD, cxr=cxr, ipServer=ipServer, modbusType=modbusType, bytesSendToV24=bytesSendToV24, modbusTable=modbusTable, snmpdService=snmpdService, ipNetmask=ipNetmask, resetByButton=resetByButton, ipGateway=ipGateway, flowControl=flowControl, portStatsTable=portStatsTable, timeoutRxTx=timeoutRxTx, endMsg=endMsg, ftpdService=ftpdService, radiusServer1=radiusServer1, dtrUp=dtrUp, portIndex=portIndex, portEntry=portEntry, nameResolution=nameResolution, mode=mode, snmpTrapAddr1=snmpTrapAddr1, aliasIpNetmask=aliasIpNetmask, slaveIPaddr=slaveIPaddr, portReset=portReset, multiSession=multiSession, remoteIpAddress=remoteIpAddress, bytesReceiveFromV24=bytesReceiveFromV24, baudRate=baudRate, beforeSend=beforeSend, afterSend=afterSend, reset=reset, nameServer1=nameServer1, radiusServer2=radiusServer2, modbusMode=modbusMode, snmpTrap=snmpTrap, tcpPort=tcpPort, slaveIPport=slaveIPport, portStatsEntry=portStatsEntry, radiusSecret2=radiusSecret2, slaveHexaAddress=slaveHexaAddress, nameServer2=nameServer2)
