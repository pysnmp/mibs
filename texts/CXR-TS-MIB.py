...
Gauge32, NotificationType, ModuleIdentity, Counter32, Bits, MibIdentifier, iso, Integer32, NotificationType, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "MibIdentifier", "iso", "Integer32", "NotificationType", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portStatsEntry=portStatsEntry, radiusServer1=radiusServer1, portReset=portReset, sessionStarted=sessionStarted, acctRad1=acctRad1, version=version, dtrDown=dtrDown, secondGateway=secondGateway, resetByButton=resetByButton, radiusSecret1=radiusSecret1, authType=authType, terminalType=terminalType, aliasIpNetmask=aliasIpNetmask, modbusMode=modbusMode, sessionStopped=sessionStopped, productName=productName, bytesSendToV24=bytesSendToV24, snmpdService=snmpdService, mainIpAddress=mainIpAddress, timeoutPAD=timeoutPAD, ipNetmask=ipNetmask, telnetdService=telnetdService, gatewayToRemote=gatewayToRemote, txIdle=txIdle, afterSend=afterSend, remoteTcpPort=remoteTcpPort, acctRad2=acctRad2, multiSession=multiSession, ts=ts, flowControl=flowControl, nameServer1=nameServer1, reset=reset, portTable=portTable, timeoutRxTx=timeoutRxTx, ipGateway=ipGateway, interFrame=interFrame, mode=mode, bytesReceiveFromV24=bytesReceiveFromV24, nameServer2=nameServer2, modbusTable=modbusTable, rxIdle=rxIdle, ethernetAddress=ethernetAddress, cxr=cxr, portStatsTable=portStatsTable, beforeSend=beforeSend, ftpdService=ftpdService, secondIpAddress=secondIpAddress, ipServer=ipServer, bootp=bootp, httpdService=httpdService, endMsg=endMsg, modbusEntry=modbusEntry, siteName=siteName, authRad1=authRad1, authRad2=authRad2, portEntry=portEntry, portIndex=portIndex, radiusServer2=radiusServer2, slaveHexaAddress=slaveHexaAddress, nbParStop=nbParStop, nameResolution=nameResolution, secondTcpPort=secondTcpPort, aliasIpAddress=aliasIpAddress, modbusType=modbusType, snmpTrapAddr2=snmpTrapAddr2, formFeed=formFeed, remoteIpAddress=remoteIpAddress, slaveIPaddr=slaveIPaddr, dtrUp=dtrUp, snmpTrapAddr1=snmpTrapAddr1, slaveIPport=slaveIPport, snmpTrap=snmpTrap, radiusSecret2=radiusSecret2, system=system, tcpPort=tcpPort, statusDTR=statusDTR, baudRate=baudRate)
