...
NotificationType, Gauge32, Counter32, IpAddress, iso, ModuleIdentity, Unsigned32, Counter64, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, ObjectIdentity, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter32", "IpAddress", "iso", "ModuleIdentity", "Unsigned32", "Counter64", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "ObjectIdentity", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", cxr=cxr, modbusType=modbusType, timeoutRxTx=timeoutRxTx, portStatsEntry=portStatsEntry, ipGateway=ipGateway, beforeSend=beforeSend, modbusEntry=modbusEntry, remoteIpAddress=remoteIpAddress, timeoutPAD=timeoutPAD, bytesSendToV24=bytesSendToV24, system=system, aliasIpNetmask=aliasIpNetmask, sessionStarted=sessionStarted, slaveHexaAddress=slaveHexaAddress, sessionStopped=sessionStopped, portTable=portTable, radiusServer1=radiusServer1, baudRate=baudRate, httpdService=httpdService, mode=mode, version=version, tcpPort=tcpPort, nameServer1=nameServer1, secondGateway=secondGateway, bytesReceiveFromV24=bytesReceiveFromV24, rxIdle=rxIdle, slaveIPaddr=slaveIPaddr, productName=productName, resetByButton=resetByButton, afterSend=afterSend, snmpdService=snmpdService, ts=ts, telnetdService=telnetdService, authRad2=authRad2, mainIpAddress=mainIpAddress, bootp=bootp, modbusTable=modbusTable, statusDTR=statusDTR, remoteTcpPort=remoteTcpPort, authType=authType, acctRad2=acctRad2, snmpTrapAddr1=snmpTrapAddr1, radiusSecret1=radiusSecret1, formFeed=formFeed, flowControl=flowControl, radiusServer2=radiusServer2, aliasIpAddress=aliasIpAddress, nameServer2=nameServer2, secondTcpPort=secondTcpPort, nameResolution=nameResolution, ipServer=ipServer, portEntry=portEntry, radiusSecret2=radiusSecret2, gatewayToRemote=gatewayToRemote, interFrame=interFrame, ipNetmask=ipNetmask, acctRad1=acctRad1, portIndex=portIndex, nbParStop=nbParStop, siteName=siteName, slaveIPport=slaveIPport, terminalType=terminalType, endMsg=endMsg, snmpTrap=snmpTrap, secondIpAddress=secondIpAddress, dtrUp=dtrUp, txIdle=txIdle, ethernetAddress=ethernetAddress, multiSession=multiSession, ftpdService=ftpdService, portStatsTable=portStatsTable, dtrDown=dtrDown, reset=reset, portReset=portReset, modbusMode=modbusMode, authRad1=authRad1, snmpTrapAddr2=snmpTrapAddr2)
