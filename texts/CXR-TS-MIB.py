...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:47:17 2024
...
Counter32, MibIdentifier, Integer32, IpAddress, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, enterprises, Bits, TimeTicks, NotificationType, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "IpAddress", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "enterprises", "Bits", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, interFrame=interFrame, modbusEntry=modbusEntry, flowControl=flowControl, beforeSend=beforeSend, portTable=portTable, portReset=portReset, slaveIPaddr=slaveIPaddr, multiSession=multiSession, ipNetmask=ipNetmask, authRad2=authRad2, statusDTR=statusDTR, dtrUp=dtrUp, siteName=siteName, authRad1=authRad1, radiusSecret2=radiusSecret2, secondGateway=secondGateway, remoteTcpPort=remoteTcpPort, modbusTable=modbusTable, nameServer2=nameServer2, sessionStopped=sessionStopped, system=system, portIndex=portIndex, secondTcpPort=secondTcpPort, acctRad2=acctRad2, portStatsTable=portStatsTable, productName=productName, ipServer=ipServer, radiusServer1=radiusServer1, ts=ts, aliasIpAddress=aliasIpAddress, gatewayToRemote=gatewayToRemote, afterSend=afterSend, mode=mode, baudRate=baudRate, acctRad1=acctRad1, version=version, timeoutRxTx=timeoutRxTx, radiusServer2=radiusServer2, snmpTrapAddr2=snmpTrapAddr2, terminalType=terminalType, snmpTrapAddr1=snmpTrapAddr1, slaveHexaAddress=slaveHexaAddress, ethernetAddress=ethernetAddress, txIdle=txIdle, nameResolution=nameResolution, slaveIPport=slaveIPport, authType=authType, httpdService=httpdService, snmpdService=snmpdService, modbusMode=modbusMode, tcpPort=tcpPort, dtrDown=dtrDown, nbParStop=nbParStop, snmpTrap=snmpTrap, bootp=bootp, timeoutPAD=timeoutPAD, formFeed=formFeed, ftpdService=ftpdService, remoteIpAddress=remoteIpAddress, ipGateway=ipGateway, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, endMsg=endMsg, portStatsEntry=portStatsEntry, portEntry=portEntry, telnetdService=telnetdService, modbusType=modbusType, radiusSecret1=radiusSecret1, mainIpAddress=mainIpAddress, sessionStarted=sessionStarted, reset=reset, aliasIpNetmask=aliasIpNetmask, cxr=cxr, bytesReceiveFromV24=bytesReceiveFromV24, secondIpAddress=secondIpAddress, rxIdle=rxIdle)
