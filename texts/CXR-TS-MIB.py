...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:02:10 2022
...
NotificationType, NotificationType, Unsigned32, ModuleIdentity, Counter32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Bits, IpAddress, TimeTicks, MibIdentifier, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Bits", "IpAddress", "TimeTicks", "MibIdentifier", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", version=version, timeoutPAD=timeoutPAD, nameResolution=nameResolution, modbusType=modbusType, nameServer1=nameServer1, rxIdle=rxIdle, flowControl=flowControl, radiusServer1=radiusServer1, portIndex=portIndex, bytesReceiveFromV24=bytesReceiveFromV24, portStatsEntry=portStatsEntry, nameServer2=nameServer2, afterSend=afterSend, authRad1=authRad1, sessionStopped=sessionStopped, resetByButton=resetByButton, bootp=bootp, snmpdService=snmpdService, acctRad2=acctRad2, ipNetmask=ipNetmask, nbParStop=nbParStop, secondIpAddress=secondIpAddress, multiSession=multiSession, mode=mode, portStatsTable=portStatsTable, portTable=portTable, ipGateway=ipGateway, snmpTrap=snmpTrap, slaveIPaddr=slaveIPaddr, remoteIpAddress=remoteIpAddress, modbusMode=modbusMode, slaveIPport=slaveIPport, formFeed=formFeed, ethernetAddress=ethernetAddress, aliasIpAddress=aliasIpAddress, telnetdService=telnetdService, acctRad1=acctRad1, httpdService=httpdService, cxr=cxr, mainIpAddress=mainIpAddress, modbusEntry=modbusEntry, portReset=portReset, sessionStarted=sessionStarted, authRad2=authRad2, baudRate=baudRate, siteName=siteName, authType=authType, bytesSendToV24=bytesSendToV24, radiusSecret2=radiusSecret2, txIdle=txIdle, terminalType=terminalType, slaveHexaAddress=slaveHexaAddress, system=system, modbusTable=modbusTable, secondGateway=secondGateway, interFrame=interFrame, reset=reset, ipServer=ipServer, ts=ts, snmpTrapAddr2=snmpTrapAddr2, dtrUp=dtrUp, radiusServer2=radiusServer2, gatewayToRemote=gatewayToRemote, statusDTR=statusDTR, endMsg=endMsg, dtrDown=dtrDown, secondTcpPort=secondTcpPort, snmpTrapAddr1=snmpTrapAddr1, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, timeoutRxTx=timeoutRxTx, remoteTcpPort=remoteTcpPort, radiusSecret1=radiusSecret1, productName=productName, tcpPort=tcpPort, portEntry=portEntry, ftpdService=ftpdService)
