...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:09:33 2022
...
ObjectIdentity, MibIdentifier, Unsigned32, IpAddress, Counter64, enterprises, Bits, NotificationType, iso, TimeTicks, Integer32, NotificationType, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "Counter64", "enterprises", "Bits", "NotificationType", "iso", "TimeTicks", "Integer32", "NotificationType", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameResolution=nameResolution, portStatsTable=portStatsTable, modbusEntry=modbusEntry, formFeed=formFeed, radiusSecret2=radiusSecret2, bootp=bootp, afterSend=afterSend, productName=productName, snmpTrap=snmpTrap, aliasIpNetmask=aliasIpNetmask, endMsg=endMsg, ts=ts, snmpTrapAddr1=snmpTrapAddr1, telnetdService=telnetdService, authType=authType, portIndex=portIndex, resetByButton=resetByButton, modbusTable=modbusTable, bytesSendToV24=bytesSendToV24, modbusMode=modbusMode, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, snmpdService=snmpdService, nbParStop=nbParStop, rxIdle=rxIdle, tcpPort=tcpPort, beforeSend=beforeSend, authRad2=authRad2, siteName=siteName, dtrUp=dtrUp, radiusServer2=radiusServer2, authRad1=authRad1, dtrDown=dtrDown, timeoutRxTx=timeoutRxTx, portStatsEntry=portStatsEntry, gatewayToRemote=gatewayToRemote, nameServer1=nameServer1, secondTcpPort=secondTcpPort, sessionStopped=sessionStopped, aliasIpAddress=aliasIpAddress, baudRate=baudRate, modbusType=modbusType, secondIpAddress=secondIpAddress, reset=reset, remoteTcpPort=remoteTcpPort, statusDTR=statusDTR, portEntry=portEntry, slaveIPaddr=slaveIPaddr, radiusSecret1=radiusSecret1, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, slaveHexaAddress=slaveHexaAddress, terminalType=terminalType, txIdle=txIdle, portTable=portTable, system=system, nameServer2=nameServer2, slaveIPport=slaveIPport, cxr=cxr, timeoutPAD=timeoutPAD, secondGateway=secondGateway, version=version, ethernetAddress=ethernetAddress, ipGateway=ipGateway, flowControl=flowControl, acctRad1=acctRad1, snmpTrapAddr2=snmpTrapAddr2, multiSession=multiSession, ipServer=ipServer, radiusServer1=radiusServer1, interFrame=interFrame, mainIpAddress=mainIpAddress, httpdService=httpdService, ipNetmask=ipNetmask, mode=mode, sessionStarted=sessionStarted, portReset=portReset)
