...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:22:33 2022
...
NotificationType, ObjectIdentity, TimeTicks, ModuleIdentity, Unsigned32, NotificationType, iso, Counter32, Gauge32, enterprises, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "Counter32", "Gauge32", "enterprises", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer1=radiusServer1, version=version, acctRad2=acctRad2, remoteTcpPort=remoteTcpPort, timeoutRxTx=timeoutRxTx, cxr=cxr, ipNetmask=ipNetmask, terminalType=terminalType, mode=mode, httpdService=httpdService, dtrUp=dtrUp, nameServer2=nameServer2, nameServer1=nameServer1, sessionStarted=sessionStarted, statusDTR=statusDTR, modbusType=modbusType, portEntry=portEntry, reset=reset, modbusEntry=modbusEntry, aliasIpNetmask=aliasIpNetmask, portStatsEntry=portStatsEntry, snmpTrap=snmpTrap, dtrDown=dtrDown, productName=productName, ethernetAddress=ethernetAddress, portTable=portTable, telnetdService=telnetdService, modbusMode=modbusMode, sessionStopped=sessionStopped, gatewayToRemote=gatewayToRemote, secondTcpPort=secondTcpPort, slaveIPport=slaveIPport, snmpTrapAddr1=snmpTrapAddr1, snmpTrapAddr2=snmpTrapAddr2, ipGateway=ipGateway, system=system, ts=ts, afterSend=afterSend, ftpdService=ftpdService, timeoutPAD=timeoutPAD, flowControl=flowControl, snmpdService=snmpdService, bytesReceiveFromV24=bytesReceiveFromV24, nameResolution=nameResolution, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, multiSession=multiSession, radiusServer2=radiusServer2, radiusSecret1=radiusSecret1, interFrame=interFrame, nbParStop=nbParStop, aliasIpAddress=aliasIpAddress, ipServer=ipServer, rxIdle=rxIdle, authType=authType, authRad1=authRad1, acctRad1=acctRad1, modbusTable=modbusTable, endMsg=endMsg, portIndex=portIndex, formFeed=formFeed, tcpPort=tcpPort, portStatsTable=portStatsTable, slaveHexaAddress=slaveHexaAddress, txIdle=txIdle, siteName=siteName, baudRate=baudRate, radiusSecret2=radiusSecret2, bootp=bootp, mainIpAddress=mainIpAddress, slaveIPaddr=slaveIPaddr, authRad2=authRad2, portReset=portReset, secondGateway=secondGateway, remoteIpAddress=remoteIpAddress, beforeSend=beforeSend, secondIpAddress=secondIpAddress)
