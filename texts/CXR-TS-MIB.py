...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:27:14 2023
...
ModuleIdentity, ObjectIdentity, IpAddress, Bits, NotificationType, TimeTicks, Gauge32, Unsigned32, MibIdentifier, iso, Counter64, NotificationType, Integer32, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "IpAddress", "Bits", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "MibIdentifier", "iso", "Counter64", "NotificationType", "Integer32", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", authRad2=authRad2, ipNetmask=ipNetmask, nameResolution=nameResolution, secondTcpPort=secondTcpPort, snmpTrapAddr1=snmpTrapAddr1, aliasIpAddress=aliasIpAddress, siteName=siteName, portTable=portTable, resetByButton=resetByButton, modbusTable=modbusTable, remoteIpAddress=remoteIpAddress, sessionStopped=sessionStopped, radiusSecret2=radiusSecret2, snmpTrapAddr2=snmpTrapAddr2, httpdService=httpdService, acctRad1=acctRad1, portStatsTable=portStatsTable, radiusServer2=radiusServer2, version=version, ftpdService=ftpdService, ipServer=ipServer, tcpPort=tcpPort, terminalType=terminalType, system=system, dtrDown=dtrDown, formFeed=formFeed, radiusServer1=radiusServer1, dtrUp=dtrUp, ts=ts, secondGateway=secondGateway, ethernetAddress=ethernetAddress, productName=productName, portReset=portReset, acctRad2=acctRad2, endMsg=endMsg, txIdle=txIdle, snmpTrap=snmpTrap, afterSend=afterSend, portIndex=portIndex, rxIdle=rxIdle, slaveIPport=slaveIPport, modbusMode=modbusMode, portStatsEntry=portStatsEntry, mode=mode, timeoutPAD=timeoutPAD, gatewayToRemote=gatewayToRemote, radiusSecret1=radiusSecret1, statusDTR=statusDTR, baudRate=baudRate, bytesSendToV24=bytesSendToV24, nameServer2=nameServer2, portEntry=portEntry, telnetdService=telnetdService, modbusEntry=modbusEntry, slaveIPaddr=slaveIPaddr, ipGateway=ipGateway, beforeSend=beforeSend, nameServer1=nameServer1, remoteTcpPort=remoteTcpPort, authType=authType, bootp=bootp, snmpdService=snmpdService, flowControl=flowControl, nbParStop=nbParStop, authRad1=authRad1, multiSession=multiSession, reset=reset, interFrame=interFrame, bytesReceiveFromV24=bytesReceiveFromV24, secondIpAddress=secondIpAddress, slaveHexaAddress=slaveHexaAddress, cxr=cxr, sessionStarted=sessionStarted, timeoutRxTx=timeoutRxTx, modbusType=modbusType, mainIpAddress=mainIpAddress, aliasIpNetmask=aliasIpNetmask)
