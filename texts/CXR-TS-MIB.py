...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:00:02 2022
...
Counter32, ModuleIdentity, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, IpAddress, NotificationType, Gauge32, ObjectIdentity, Unsigned32, iso, enterprises, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "IpAddress", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "iso", "enterprises", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret2=radiusSecret2, snmpTrapAddr1=snmpTrapAddr1, modbusTable=modbusTable, nameServer1=nameServer1, multiSession=multiSession, baudRate=baudRate, dtrDown=dtrDown, radiusServer1=radiusServer1, mainIpAddress=mainIpAddress, slaveHexaAddress=slaveHexaAddress, snmpTrap=snmpTrap, timeoutPAD=timeoutPAD, secondIpAddress=secondIpAddress, resetByButton=resetByButton, productName=productName, acctRad2=acctRad2, ethernetAddress=ethernetAddress, terminalType=terminalType, nameServer2=nameServer2, ipGateway=ipGateway, modbusMode=modbusMode, slaveIPaddr=slaveIPaddr, remoteTcpPort=remoteTcpPort, bytesSendToV24=bytesSendToV24, secondTcpPort=secondTcpPort, authType=authType, rxIdle=rxIdle, snmpTrapAddr2=snmpTrapAddr2, sessionStarted=sessionStarted, beforeSend=beforeSend, radiusServer2=radiusServer2, sessionStopped=sessionStopped, portReset=portReset, ipNetmask=ipNetmask, slaveIPport=slaveIPport, portTable=portTable, portIndex=portIndex, interFrame=interFrame, reset=reset, ts=ts, modbusEntry=modbusEntry, timeoutRxTx=timeoutRxTx, cxr=cxr, bootp=bootp, ftpdService=ftpdService, statusDTR=statusDTR, txIdle=txIdle, radiusSecret1=radiusSecret1, flowControl=flowControl, ipServer=ipServer, gatewayToRemote=gatewayToRemote, portStatsTable=portStatsTable, bytesReceiveFromV24=bytesReceiveFromV24, system=system, aliasIpAddress=aliasIpAddress, portStatsEntry=portStatsEntry, tcpPort=tcpPort, secondGateway=secondGateway, mode=mode, portEntry=portEntry, remoteIpAddress=remoteIpAddress, snmpdService=snmpdService, nbParStop=nbParStop, nameResolution=nameResolution, modbusType=modbusType, authRad1=authRad1, formFeed=formFeed, telnetdService=telnetdService, httpdService=httpdService, afterSend=afterSend, version=version, acctRad1=acctRad1, aliasIpNetmask=aliasIpNetmask, dtrUp=dtrUp, siteName=siteName, endMsg=endMsg, authRad2=authRad2)
