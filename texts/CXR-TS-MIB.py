...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:22:32 2023
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, NotificationType, Integer32, NotificationType, Unsigned32, ObjectIdentity, ModuleIdentity, iso, Counter32, enterprises, MibIdentifier, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "NotificationType", "Integer32", "NotificationType", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "iso", "Counter32", "enterprises", "MibIdentifier", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", terminalType=terminalType, tcpPort=tcpPort, secondTcpPort=secondTcpPort, txIdle=txIdle, radiusServer2=radiusServer2, ipGateway=ipGateway, snmpTrap=snmpTrap, modbusType=modbusType, siteName=siteName, ts=ts, secondIpAddress=secondIpAddress, portTable=portTable, aliasIpAddress=aliasIpAddress, secondGateway=secondGateway, remoteTcpPort=remoteTcpPort, mainIpAddress=mainIpAddress, modbusTable=modbusTable, timeoutRxTx=timeoutRxTx, nameServer1=nameServer1, sessionStopped=sessionStopped, telnetdService=telnetdService, portStatsTable=portStatsTable, slaveIPport=slaveIPport, acctRad2=acctRad2, multiSession=multiSession, modbusEntry=modbusEntry, sessionStarted=sessionStarted, slaveIPaddr=slaveIPaddr, portEntry=portEntry, radiusServer1=radiusServer1, version=version, endMsg=endMsg, authRad2=authRad2, ethernetAddress=ethernetAddress, gatewayToRemote=gatewayToRemote, nameServer2=nameServer2, resetByButton=resetByButton, ftpdService=ftpdService, nameResolution=nameResolution, mode=mode, authRad1=authRad1, system=system, portStatsEntry=portStatsEntry, snmpTrapAddr2=snmpTrapAddr2, dtrUp=dtrUp, baudRate=baudRate, rxIdle=rxIdle, nbParStop=nbParStop, flowControl=flowControl, snmpdService=snmpdService, authType=authType, cxr=cxr, acctRad1=acctRad1, productName=productName, ipNetmask=ipNetmask, reset=reset, radiusSecret2=radiusSecret2, formFeed=formFeed, remoteIpAddress=remoteIpAddress, interFrame=interFrame, slaveHexaAddress=slaveHexaAddress, ipServer=ipServer, afterSend=afterSend, portIndex=portIndex, portReset=portReset, bytesReceiveFromV24=bytesReceiveFromV24, bootp=bootp, timeoutPAD=timeoutPAD, modbusMode=modbusMode, statusDTR=statusDTR, aliasIpNetmask=aliasIpNetmask, dtrDown=dtrDown, snmpTrapAddr1=snmpTrapAddr1, httpdService=httpdService, beforeSend=beforeSend, radiusSecret1=radiusSecret1, bytesSendToV24=bytesSendToV24)
