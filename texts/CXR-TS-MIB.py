...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:51:55 2022
...
NotificationType, Integer32, Counter64, IpAddress, Bits, Gauge32, ModuleIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, NotificationType, MibIdentifier, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Counter64", "IpAddress", "Bits", "Gauge32", "ModuleIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bytesSendToV24=bytesSendToV24, tcpPort=tcpPort, afterSend=afterSend, modbusMode=modbusMode, siteName=siteName, reset=reset, radiusServer1=radiusServer1, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, nameResolution=nameResolution, modbusEntry=modbusEntry, rxIdle=rxIdle, nameServer1=nameServer1, portStatsEntry=portStatsEntry, interFrame=interFrame, productName=productName, mainIpAddress=mainIpAddress, snmpTrapAddr2=snmpTrapAddr2, ipNetmask=ipNetmask, ipServer=ipServer, snmpTrapAddr1=snmpTrapAddr1, acctRad2=acctRad2, nameServer2=nameServer2, radiusSecret1=radiusSecret1, portTable=portTable, gatewayToRemote=gatewayToRemote, ethernetAddress=ethernetAddress, authRad1=authRad1, ipGateway=ipGateway, portReset=portReset, slaveHexaAddress=slaveHexaAddress, secondIpAddress=secondIpAddress, snmpdService=snmpdService, flowControl=flowControl, endMsg=endMsg, acctRad1=acctRad1, portEntry=portEntry, secondTcpPort=secondTcpPort, snmpTrap=snmpTrap, bootp=bootp, sessionStarted=sessionStarted, modbusType=modbusType, dtrDown=dtrDown, system=system, beforeSend=beforeSend, portStatsTable=portStatsTable, multiSession=multiSession, aliasIpAddress=aliasIpAddress, timeoutPAD=timeoutPAD, aliasIpNetmask=aliasIpNetmask, slaveIPaddr=slaveIPaddr, cxr=cxr, sessionStopped=sessionStopped, dtrUp=dtrUp, httpdService=httpdService, statusDTR=statusDTR, slaveIPport=slaveIPport, radiusSecret2=radiusSecret2, ftpdService=ftpdService, formFeed=formFeed, radiusServer2=radiusServer2, authType=authType, authRad2=authRad2, telnetdService=telnetdService, secondGateway=secondGateway, portIndex=portIndex, txIdle=txIdle, modbusTable=modbusTable, nbParStop=nbParStop, timeoutRxTx=timeoutRxTx, mode=mode, ts=ts, version=version, remoteTcpPort=remoteTcpPort, resetByButton=resetByButton, baudRate=baudRate, remoteIpAddress=remoteIpAddress)
