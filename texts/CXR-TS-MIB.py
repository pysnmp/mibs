...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:44:36 2022
...
Bits, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Unsigned32, MibIdentifier, TimeTicks, ObjectIdentity, Counter64, IpAddress, Gauge32, iso, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Counter64", "IpAddress", "Gauge32", "iso", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", authType=authType, ts=ts, telnetdService=telnetdService, portEntry=portEntry, reset=reset, tcpPort=tcpPort, dtrUp=dtrUp, txIdle=txIdle, ipServer=ipServer, timeoutRxTx=timeoutRxTx, snmpdService=snmpdService, rxIdle=rxIdle, beforeSend=beforeSend, sessionStopped=sessionStopped, nbParStop=nbParStop, ftpdService=ftpdService, slaveIPport=slaveIPport, snmpTrapAddr2=snmpTrapAddr2, dtrDown=dtrDown, nameServer2=nameServer2, modbusMode=modbusMode, modbusType=modbusType, nameServer1=nameServer1, system=system, acctRad1=acctRad1, siteName=siteName, radiusSecret2=radiusSecret2, timeoutPAD=timeoutPAD, authRad1=authRad1, nameResolution=nameResolution, secondIpAddress=secondIpAddress, aliasIpAddress=aliasIpAddress, radiusSecret1=radiusSecret1, portStatsEntry=portStatsEntry, radiusServer1=radiusServer1, bootp=bootp, multiSession=multiSession, acctRad2=acctRad2, baudRate=baudRate, ipNetmask=ipNetmask, interFrame=interFrame, slaveHexaAddress=slaveHexaAddress, ipGateway=ipGateway, portIndex=portIndex, httpdService=httpdService, snmpTrap=snmpTrap, portStatsTable=portStatsTable, terminalType=terminalType, modbusTable=modbusTable, endMsg=endMsg, bytesReceiveFromV24=bytesReceiveFromV24, mode=mode, sessionStarted=sessionStarted, productName=productName, portReset=portReset, flowControl=flowControl, version=version, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, ethernetAddress=ethernetAddress, statusDTR=statusDTR, secondGateway=secondGateway, gatewayToRemote=gatewayToRemote, remoteIpAddress=remoteIpAddress, afterSend=afterSend, remoteTcpPort=remoteTcpPort, aliasIpNetmask=aliasIpNetmask, resetByButton=resetByButton, snmpTrapAddr1=snmpTrapAddr1, cxr=cxr, formFeed=formFeed, mainIpAddress=mainIpAddress, radiusServer2=radiusServer2, portTable=portTable, authRad2=authRad2, bytesSendToV24=bytesSendToV24, slaveIPaddr=slaveIPaddr)
