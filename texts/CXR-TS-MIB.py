...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:32:39 2023
...
Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, TimeTicks, NotificationType, Integer32, iso, NotificationType, ModuleIdentity, Counter32, enterprises, IpAddress, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "TimeTicks", "NotificationType", "Integer32", "iso", "NotificationType", "ModuleIdentity", "Counter32", "enterprises", "IpAddress", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", slaveIPaddr=slaveIPaddr, authRad2=authRad2, aliasIpAddress=aliasIpAddress, bytesSendToV24=bytesSendToV24, remoteTcpPort=remoteTcpPort, sessionStarted=sessionStarted, nameServer1=nameServer1, interFrame=interFrame, acctRad2=acctRad2, portReset=portReset, terminalType=terminalType, formFeed=formFeed, modbusEntry=modbusEntry, radiusSecret2=radiusSecret2, snmpTrapAddr1=snmpTrapAddr1, mainIpAddress=mainIpAddress, telnetdService=telnetdService, portEntry=portEntry, acctRad1=acctRad1, authType=authType, endMsg=endMsg, radiusSecret1=radiusSecret1, snmpTrap=snmpTrap, flowControl=flowControl, slaveHexaAddress=slaveHexaAddress, slaveIPport=slaveIPport, snmpdService=snmpdService, nameResolution=nameResolution, resetByButton=resetByButton, portStatsEntry=portStatsEntry, gatewayToRemote=gatewayToRemote, ipNetmask=ipNetmask, portIndex=portIndex, txIdle=txIdle, secondTcpPort=secondTcpPort, statusDTR=statusDTR, authRad1=authRad1, dtrUp=dtrUp, sessionStopped=sessionStopped, ipGateway=ipGateway, radiusServer1=radiusServer1, version=version, modbusMode=modbusMode, system=system, aliasIpNetmask=aliasIpNetmask, dtrDown=dtrDown, multiSession=multiSession, secondIpAddress=secondIpAddress, nbParStop=nbParStop, portStatsTable=portStatsTable, httpdService=httpdService, modbusType=modbusType, productName=productName, siteName=siteName, portTable=portTable, baudRate=baudRate, remoteIpAddress=remoteIpAddress, bootp=bootp, nameServer2=nameServer2, cxr=cxr, afterSend=afterSend, ts=ts, ipServer=ipServer, snmpTrapAddr2=snmpTrapAddr2, secondGateway=secondGateway, bytesReceiveFromV24=bytesReceiveFromV24, modbusTable=modbusTable, tcpPort=tcpPort, timeoutPAD=timeoutPAD, reset=reset, ftpdService=ftpdService, ethernetAddress=ethernetAddress, mode=mode, rxIdle=rxIdle, radiusServer2=radiusServer2, beforeSend=beforeSend, timeoutRxTx=timeoutRxTx)
