...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:28:46 2022
...
NotificationType, ObjectIdentity, NotificationType, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Gauge32, MibIdentifier, enterprises, ModuleIdentity, Unsigned32, iso, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "NotificationType", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "enterprises", "ModuleIdentity", "Unsigned32", "iso", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer2=nameServer2, resetByButton=resetByButton, portTable=portTable, remoteTcpPort=remoteTcpPort, statusDTR=statusDTR, slaveIPport=slaveIPport, radiusSecret1=radiusSecret1, snmpTrapAddr1=snmpTrapAddr1, mode=mode, gatewayToRemote=gatewayToRemote, portEntry=portEntry, portReset=portReset, radiusSecret2=radiusSecret2, ipServer=ipServer, nameResolution=nameResolution, txIdle=txIdle, ts=ts, timeoutPAD=timeoutPAD, secondTcpPort=secondTcpPort, endMsg=endMsg, snmpTrap=snmpTrap, siteName=siteName, interFrame=interFrame, acctRad1=acctRad1, modbusEntry=modbusEntry, httpdService=httpdService, modbusMode=modbusMode, secondIpAddress=secondIpAddress, formFeed=formFeed, telnetdService=telnetdService, authRad2=authRad2, secondGateway=secondGateway, snmpdService=snmpdService, snmpTrapAddr2=snmpTrapAddr2, nameServer1=nameServer1, aliasIpAddress=aliasIpAddress, flowControl=flowControl, remoteIpAddress=remoteIpAddress, baudRate=baudRate, dtrUp=dtrUp, acctRad2=acctRad2, sessionStopped=sessionStopped, portIndex=portIndex, ethernetAddress=ethernetAddress, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1, modbusType=modbusType, slaveHexaAddress=slaveHexaAddress, portStatsTable=portStatsTable, bytesReceiveFromV24=bytesReceiveFromV24, aliasIpNetmask=aliasIpNetmask, mainIpAddress=mainIpAddress, radiusServer2=radiusServer2, timeoutRxTx=timeoutRxTx, portStatsEntry=portStatsEntry, beforeSend=beforeSend, rxIdle=rxIdle, afterSend=afterSend, tcpPort=tcpPort, version=version, sessionStarted=sessionStarted, dtrDown=dtrDown, ipNetmask=ipNetmask, nbParStop=nbParStop, productName=productName, terminalType=terminalType, authType=authType, cxr=cxr, ipGateway=ipGateway, reset=reset, bootp=bootp, system=system, modbusTable=modbusTable, ftpdService=ftpdService, multiSession=multiSession, bytesSendToV24=bytesSendToV24, authRad1=authRad1)
