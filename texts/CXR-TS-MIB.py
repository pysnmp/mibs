...
iso, Gauge32, Bits, Unsigned32, MibIdentifier, IpAddress, ObjectIdentity, TimeTicks, NotificationType, Counter64, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Bits", "Unsigned32", "MibIdentifier", "IpAddress", "ObjectIdentity", "TimeTicks", "NotificationType", "Counter64", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", rxIdle=rxIdle, timeoutPAD=timeoutPAD, reset=reset, mainIpAddress=mainIpAddress, acctRad1=acctRad1, acctRad2=acctRad2, remoteIpAddress=remoteIpAddress, radiusServer1=radiusServer1, portStatsEntry=portStatsEntry, authRad2=authRad2, cxr=cxr, secondGateway=secondGateway, snmpTrap=snmpTrap, ts=ts, bytesSendToV24=bytesSendToV24, gatewayToRemote=gatewayToRemote, telnetdService=telnetdService, dtrDown=dtrDown, productName=productName, bytesReceiveFromV24=bytesReceiveFromV24, aliasIpNetmask=aliasIpNetmask, mode=mode, portTable=portTable, portReset=portReset, tcpPort=tcpPort, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, remoteTcpPort=remoteTcpPort, interFrame=interFrame, ipNetmask=ipNetmask, endMsg=endMsg, siteName=siteName, radiusServer2=radiusServer2, authRad1=authRad1, formFeed=formFeed, sessionStopped=sessionStopped, snmpTrapAddr1=snmpTrapAddr1, beforeSend=beforeSend, statusDTR=statusDTR, ftpdService=ftpdService, nameServer1=nameServer1, radiusSecret1=radiusSecret1, terminalType=terminalType, version=version, modbusType=modbusType, dtrUp=dtrUp, modbusTable=modbusTable, slaveIPport=slaveIPport, ipGateway=ipGateway, sessionStarted=sessionStarted, nameResolution=nameResolution, radiusSecret2=radiusSecret2, afterSend=afterSend, multiSession=multiSession, secondIpAddress=secondIpAddress, ethernetAddress=ethernetAddress, modbusMode=modbusMode, portEntry=portEntry, baudRate=baudRate, secondTcpPort=secondTcpPort, bootp=bootp, portStatsTable=portStatsTable, flowControl=flowControl, slaveIPaddr=slaveIPaddr, system=system, txIdle=txIdle, authType=authType, resetByButton=resetByButton, aliasIpAddress=aliasIpAddress, ipServer=ipServer, httpdService=httpdService, timeoutRxTx=timeoutRxTx, snmpdService=snmpdService, modbusEntry=modbusEntry, snmpTrapAddr2=snmpTrapAddr2, portIndex=portIndex, nameServer2=nameServer2)
