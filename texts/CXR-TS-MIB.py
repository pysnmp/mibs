...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Counter32, NotificationType, Integer32, Unsigned32, iso, Bits, TimeTicks, ModuleIdentity, Gauge32, IpAddress, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Counter32", "NotificationType", "Integer32", "Unsigned32", "iso", "Bits", "TimeTicks", "ModuleIdentity", "Gauge32", "IpAddress", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bootp=bootp, bytesReceiveFromV24=bytesReceiveFromV24, portTable=portTable, secondTcpPort=secondTcpPort, beforeSend=beforeSend, multiSession=multiSession, productName=productName, mainIpAddress=mainIpAddress, secondIpAddress=secondIpAddress, portStatsEntry=portStatsEntry, snmpTrapAddr1=snmpTrapAddr1, reset=reset, statusDTR=statusDTR, baudRate=baudRate, acctRad1=acctRad1, authRad2=authRad2, system=system, txIdle=txIdle, modbusMode=modbusMode, sessionStopped=sessionStopped, portReset=portReset, slaveIPaddr=slaveIPaddr, modbusEntry=modbusEntry, gatewayToRemote=gatewayToRemote, nameServer2=nameServer2, nameResolution=nameResolution, timeoutRxTx=timeoutRxTx, portIndex=portIndex, dtrDown=dtrDown, nbParStop=nbParStop, radiusSecret2=radiusSecret2, remoteTcpPort=remoteTcpPort, slaveHexaAddress=slaveHexaAddress, aliasIpAddress=aliasIpAddress, mode=mode, snmpTrap=snmpTrap, sessionStarted=sessionStarted, resetByButton=resetByButton, authRad1=authRad1, rxIdle=rxIdle, dtrUp=dtrUp, portEntry=portEntry, telnetdService=telnetdService, formFeed=formFeed, remoteIpAddress=remoteIpAddress, tcpPort=tcpPort, endMsg=endMsg, bytesSendToV24=bytesSendToV24, radiusSecret1=radiusSecret1, ts=ts, interFrame=interFrame, cxr=cxr, modbusType=modbusType, nameServer1=nameServer1, version=version, aliasIpNetmask=aliasIpNetmask, ipGateway=ipGateway, httpdService=httpdService, snmpdService=snmpdService, afterSend=afterSend, flowControl=flowControl, authType=authType, radiusServer1=radiusServer1, timeoutPAD=timeoutPAD, modbusTable=modbusTable, slaveIPport=slaveIPport, terminalType=terminalType, portStatsTable=portStatsTable, secondGateway=secondGateway, ethernetAddress=ethernetAddress, snmpTrapAddr2=snmpTrapAddr2, radiusServer2=radiusServer2, siteName=siteName, ipNetmask=ipNetmask, ipServer=ipServer, acctRad2=acctRad2, ftpdService=ftpdService)
