...
# Produced by pysmi-1.1.12 at Fri Jul 19 08:53:01 2024
...
NotificationType, Counter32, Counter64, enterprises, Integer32, TimeTicks, NotificationType, IpAddress, ModuleIdentity, iso, Bits, Unsigned32, ObjectIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "enterprises", "Integer32", "TimeTicks", "NotificationType", "IpAddress", "ModuleIdentity", "iso", "Bits", "Unsigned32", "ObjectIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portTable=portTable, authRad2=authRad2, terminalType=terminalType, portStatsTable=portStatsTable, baudRate=baudRate, authType=authType, snmpTrap=snmpTrap, slaveHexaAddress=slaveHexaAddress, aliasIpAddress=aliasIpAddress, resetByButton=resetByButton, slaveIPport=slaveIPport, rxIdle=rxIdle, ipServer=ipServer, flowControl=flowControl, modbusMode=modbusMode, siteName=siteName, nbParStop=nbParStop, secondGateway=secondGateway, portStatsEntry=portStatsEntry, ethernetAddress=ethernetAddress, acctRad1=acctRad1, ipGateway=ipGateway, radiusServer2=radiusServer2, slaveIPaddr=slaveIPaddr, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, ftpdService=ftpdService, nameServer2=nameServer2, nameServer1=nameServer1, afterSend=afterSend, authRad1=authRad1, remoteIpAddress=remoteIpAddress, productName=productName, snmpTrapAddr2=snmpTrapAddr2, sessionStopped=sessionStopped, radiusSecret2=radiusSecret2, secondIpAddress=secondIpAddress, reset=reset, gatewayToRemote=gatewayToRemote, aliasIpNetmask=aliasIpNetmask, snmpdService=snmpdService, radiusServer1=radiusServer1, mainIpAddress=mainIpAddress, portReset=portReset, formFeed=formFeed, modbusType=modbusType, tcpPort=tcpPort, beforeSend=beforeSend, modbusTable=modbusTable, bootp=bootp, modbusEntry=modbusEntry, httpdService=httpdService, interFrame=interFrame, portIndex=portIndex, system=system, remoteTcpPort=remoteTcpPort, acctRad2=acctRad2, endMsg=endMsg, cxr=cxr, radiusSecret1=radiusSecret1, timeoutRxTx=timeoutRxTx, secondTcpPort=secondTcpPort, txIdle=txIdle, sessionStarted=sessionStarted, dtrDown=dtrDown, bytesSendToV24=bytesSendToV24, dtrUp=dtrUp, ipNetmask=ipNetmask, mode=mode, telnetdService=telnetdService, timeoutPAD=timeoutPAD, portEntry=portEntry, multiSession=multiSession, ts=ts, nameResolution=nameResolution, bytesReceiveFromV24=bytesReceiveFromV24, version=version)
