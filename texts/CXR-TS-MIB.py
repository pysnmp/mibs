...
# Produced by pysmi-1.1.8 at Wed Oct 11 07:50:19 2023
...
Unsigned32, enterprises, Integer32, TimeTicks, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, iso, ModuleIdentity, Counter32, Gauge32, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Integer32", "TimeTicks", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "iso", "ModuleIdentity", "Counter32", "Gauge32", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", productName=productName, txIdle=txIdle, ipServer=ipServer, slaveIPaddr=slaveIPaddr, nbParStop=nbParStop, portEntry=portEntry, modbusMode=modbusMode, ipNetmask=ipNetmask, acctRad2=acctRad2, statusDTR=statusDTR, slaveIPport=slaveIPport, reset=reset, terminalType=terminalType, siteName=siteName, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, remoteTcpPort=remoteTcpPort, resetByButton=resetByButton, dtrUp=dtrUp, snmpTrapAddr1=snmpTrapAddr1, flowControl=flowControl, aliasIpNetmask=aliasIpNetmask, bytesSendToV24=bytesSendToV24, bytesReceiveFromV24=bytesReceiveFromV24, mainIpAddress=mainIpAddress, remoteIpAddress=remoteIpAddress, secondTcpPort=secondTcpPort, gatewayToRemote=gatewayToRemote, nameServer1=nameServer1, endMsg=endMsg, portTable=portTable, dtrDown=dtrDown, formFeed=formFeed, secondGateway=secondGateway, bootp=bootp, radiusServer2=radiusServer2, cxr=cxr, ts=ts, sessionStarted=sessionStarted, multiSession=multiSession, tcpPort=tcpPort, httpdService=httpdService, sessionStopped=sessionStopped, ftpdService=ftpdService, acctRad1=acctRad1, portStatsEntry=portStatsEntry, nameResolution=nameResolution, ethernetAddress=ethernetAddress, radiusServer1=radiusServer1, rxIdle=rxIdle, beforeSend=beforeSend, portStatsTable=portStatsTable, aliasIpAddress=aliasIpAddress, radiusSecret1=radiusSecret1, portReset=portReset, system=system, timeoutRxTx=timeoutRxTx, telnetdService=telnetdService, authRad2=authRad2, portIndex=portIndex, mode=mode, authRad1=authRad1, snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, snmpdService=snmpdService, interFrame=interFrame, snmpTrap=snmpTrap, secondIpAddress=secondIpAddress, nameServer2=nameServer2, modbusType=modbusType, radiusSecret2=radiusSecret2, authType=authType, modbusEntry=modbusEntry, timeoutPAD=timeoutPAD, afterSend=afterSend, version=version, ipGateway=ipGateway)
