...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:00:33 2023
...
ModuleIdentity, Unsigned32, enterprises, Integer32, MibIdentifier, ObjectIdentity, iso, Counter32, Gauge32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "enterprises", "Integer32", "MibIdentifier", "ObjectIdentity", "iso", "Counter32", "Gauge32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipServer=ipServer, rxIdle=rxIdle, remoteTcpPort=remoteTcpPort, terminalType=terminalType, portTable=portTable, bytesReceiveFromV24=bytesReceiveFromV24, beforeSend=beforeSend, secondGateway=secondGateway, authRad1=authRad1, modbusType=modbusType, afterSend=afterSend, mode=mode, formFeed=formFeed, flowControl=flowControl, portIndex=portIndex, modbusMode=modbusMode, productName=productName, slaveIPaddr=slaveIPaddr, ftpdService=ftpdService, radiusServer1=radiusServer1, statusDTR=statusDTR, nameServer1=nameServer1, multiSession=multiSession, snmpTrap=snmpTrap, ipNetmask=ipNetmask, nameResolution=nameResolution, remoteIpAddress=remoteIpAddress, ethernetAddress=ethernetAddress, acctRad2=acctRad2, resetByButton=resetByButton, mainIpAddress=mainIpAddress, snmpdService=snmpdService, modbusTable=modbusTable, bootp=bootp, baudRate=baudRate, txIdle=txIdle, siteName=siteName, endMsg=endMsg, portReset=portReset, slaveIPport=slaveIPport, portEntry=portEntry, aliasIpNetmask=aliasIpNetmask, interFrame=interFrame, acctRad1=acctRad1, radiusSecret1=radiusSecret1, cxr=cxr, nbParStop=nbParStop, sessionStarted=sessionStarted, sessionStopped=sessionStopped, reset=reset, aliasIpAddress=aliasIpAddress, timeoutRxTx=timeoutRxTx, slaveHexaAddress=slaveHexaAddress, portStatsEntry=portStatsEntry, authRad2=authRad2, httpdService=httpdService, radiusSecret2=radiusSecret2, gatewayToRemote=gatewayToRemote, ipGateway=ipGateway, radiusServer2=radiusServer2, portStatsTable=portStatsTable, authType=authType, snmpTrapAddr2=snmpTrapAddr2, dtrUp=dtrUp, version=version, dtrDown=dtrDown, system=system, secondIpAddress=secondIpAddress, telnetdService=telnetdService, nameServer2=nameServer2, ts=ts, tcpPort=tcpPort, snmpTrapAddr1=snmpTrapAddr1, bytesSendToV24=bytesSendToV24, timeoutPAD=timeoutPAD, secondTcpPort=secondTcpPort, modbusEntry=modbusEntry)
