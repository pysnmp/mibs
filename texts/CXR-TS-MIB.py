...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:11:08 2024
...
ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Gauge32, IpAddress, TimeTicks, Counter32, Bits, MibIdentifier, enterprises, NotificationType, NotificationType, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Gauge32", "IpAddress", "TimeTicks", "Counter32", "Bits", "MibIdentifier", "enterprises", "NotificationType", "NotificationType", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret1=radiusSecret1, portStatsTable=portStatsTable, txIdle=txIdle, slaveIPport=slaveIPport, nameServer1=nameServer1, ipServer=ipServer, version=version, authRad1=authRad1, mode=mode, statusDTR=statusDTR, ftpdService=ftpdService, radiusSecret2=radiusSecret2, snmpdService=snmpdService, remoteTcpPort=remoteTcpPort, nameServer2=nameServer2, baudRate=baudRate, endMsg=endMsg, rxIdle=rxIdle, slaveIPaddr=slaveIPaddr, nameResolution=nameResolution, httpdService=httpdService, bytesReceiveFromV24=bytesReceiveFromV24, ts=ts, portReset=portReset, authRad2=authRad2, multiSession=multiSession, cxr=cxr, productName=productName, system=system, ethernetAddress=ethernetAddress, timeoutPAD=timeoutPAD, timeoutRxTx=timeoutRxTx, radiusServer2=radiusServer2, portEntry=portEntry, sessionStopped=sessionStopped, modbusType=modbusType, snmpTrapAddr1=snmpTrapAddr1, beforeSend=beforeSend, portIndex=portIndex, dtrUp=dtrUp, formFeed=formFeed, gatewayToRemote=gatewayToRemote, interFrame=interFrame, aliasIpAddress=aliasIpAddress, mainIpAddress=mainIpAddress, authType=authType, remoteIpAddress=remoteIpAddress, flowControl=flowControl, ipNetmask=ipNetmask, modbusMode=modbusMode, secondTcpPort=secondTcpPort, portStatsEntry=portStatsEntry, snmpTrap=snmpTrap, afterSend=afterSend, sessionStarted=sessionStarted, acctRad1=acctRad1, ipGateway=ipGateway, acctRad2=acctRad2, siteName=siteName, tcpPort=tcpPort, modbusTable=modbusTable, dtrDown=dtrDown, modbusEntry=modbusEntry, reset=reset, telnetdService=telnetdService, secondGateway=secondGateway, resetByButton=resetByButton, nbParStop=nbParStop, terminalType=terminalType, snmpTrapAddr2=snmpTrapAddr2, portTable=portTable, radiusServer1=radiusServer1, aliasIpNetmask=aliasIpNetmask, bootp=bootp, slaveHexaAddress=slaveHexaAddress, secondIpAddress=secondIpAddress, bytesSendToV24=bytesSendToV24)
