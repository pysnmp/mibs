...
# Produced by pysmi-1.1.11 at Wed Apr  3 15:12:50 2024
...
Counter32, Bits, enterprises, iso, Integer32, ObjectIdentity, IpAddress, TimeTicks, Gauge32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "enterprises", "iso", "Integer32", "ObjectIdentity", "IpAddress", "TimeTicks", "Gauge32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", system=system, aliasIpAddress=aliasIpAddress, mode=mode, gatewayToRemote=gatewayToRemote, sessionStarted=sessionStarted, aliasIpNetmask=aliasIpNetmask, snmpTrap=snmpTrap, ipGateway=ipGateway, endMsg=endMsg, portStatsEntry=portStatsEntry, interFrame=interFrame, snmpTrapAddr2=snmpTrapAddr2, ts=ts, ipNetmask=ipNetmask, acctRad2=acctRad2, version=version, reset=reset, sessionStopped=sessionStopped, portStatsTable=portStatsTable, snmpdService=snmpdService, rxIdle=rxIdle, multiSession=multiSession, dtrUp=dtrUp, authRad2=authRad2, telnetdService=telnetdService, secondTcpPort=secondTcpPort, beforeSend=beforeSend, siteName=siteName, modbusMode=modbusMode, flowControl=flowControl, baudRate=baudRate, ftpdService=ftpdService, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, productName=productName, dtrDown=dtrDown, nbParStop=nbParStop, tcpPort=tcpPort, radiusServer2=radiusServer2, portReset=portReset, ipServer=ipServer, modbusType=modbusType, radiusServer1=radiusServer1, cxr=cxr, resetByButton=resetByButton, txIdle=txIdle, mainIpAddress=mainIpAddress, radiusSecret1=radiusSecret1, timeoutPAD=timeoutPAD, ethernetAddress=ethernetAddress, bytesReceiveFromV24=bytesReceiveFromV24, formFeed=formFeed, timeoutRxTx=timeoutRxTx, authRad1=authRad1, httpdService=httpdService, afterSend=afterSend, statusDTR=statusDTR, modbusEntry=modbusEntry, nameServer1=nameServer1, portIndex=portIndex, authType=authType, bootp=bootp, slaveIPaddr=slaveIPaddr, remoteTcpPort=remoteTcpPort, modbusTable=modbusTable, nameResolution=nameResolution, bytesSendToV24=bytesSendToV24, slaveIPport=slaveIPport, terminalType=terminalType, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, portEntry=portEntry, snmpTrapAddr1=snmpTrapAddr1, secondGateway=secondGateway, portTable=portTable, radiusSecret2=radiusSecret2, secondIpAddress=secondIpAddress)
