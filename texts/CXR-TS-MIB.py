...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:12:45 2023
...
iso, MibIdentifier, IpAddress, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Integer32, Counter64, NotificationType, Unsigned32, Gauge32, ObjectIdentity, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "IpAddress", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Integer32", "Counter64", "NotificationType", "Unsigned32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusType=modbusType, tcpPort=tcpPort, remoteIpAddress=remoteIpAddress, portTable=portTable, cxr=cxr, interFrame=interFrame, secondGateway=secondGateway, txIdle=txIdle, ftpdService=ftpdService, flowControl=flowControl, httpdService=httpdService, snmpdService=snmpdService, snmpTrap=snmpTrap, aliasIpAddress=aliasIpAddress, modbusMode=modbusMode, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, portIndex=portIndex, portStatsEntry=portStatsEntry, ipNetmask=ipNetmask, terminalType=terminalType, multiSession=multiSession, sessionStarted=sessionStarted, dtrUp=dtrUp, productName=productName, authType=authType, beforeSend=beforeSend, formFeed=formFeed, portReset=portReset, statusDTR=statusDTR, radiusServer2=radiusServer2, version=version, nbParStop=nbParStop, gatewayToRemote=gatewayToRemote, baudRate=baudRate, rxIdle=rxIdle, nameResolution=nameResolution, acctRad1=acctRad1, slaveIPport=slaveIPport, system=system, ethernetAddress=ethernetAddress, acctRad2=acctRad2, bytesSendToV24=bytesSendToV24, authRad1=authRad1, aliasIpNetmask=aliasIpNetmask, slaveIPaddr=slaveIPaddr, ipServer=ipServer, resetByButton=resetByButton, radiusSecret1=radiusSecret1, bootp=bootp, timeoutPAD=timeoutPAD, radiusServer1=radiusServer1, nameServer1=nameServer1, portStatsTable=portStatsTable, endMsg=endMsg, nameServer2=nameServer2, snmpTrapAddr1=snmpTrapAddr1, secondIpAddress=secondIpAddress, portEntry=portEntry, secondTcpPort=secondTcpPort, mainIpAddress=mainIpAddress, ipGateway=ipGateway, snmpTrapAddr2=snmpTrapAddr2, sessionStopped=sessionStopped, reset=reset, bytesReceiveFromV24=bytesReceiveFromV24, timeoutRxTx=timeoutRxTx, remoteTcpPort=remoteTcpPort, ts=ts, radiusSecret2=radiusSecret2, dtrDown=dtrDown, telnetdService=telnetdService, authRad2=authRad2, afterSend=afterSend, mode=mode, modbusEntry=modbusEntry, siteName=siteName)
