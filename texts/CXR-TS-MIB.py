...
Gauge32, ModuleIdentity, Counter32, Bits, MibIdentifier, ObjectIdentity, Unsigned32, iso, IpAddress, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "Bits", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", endMsg=endMsg, modbusMode=modbusMode, remoteIpAddress=remoteIpAddress, bytesSendToV24=bytesSendToV24, httpdService=httpdService, statusDTR=statusDTR, timeoutPAD=timeoutPAD, nameResolution=nameResolution, authType=authType, aliasIpAddress=aliasIpAddress, snmpTrap=snmpTrap, nameServer1=nameServer1, radiusServer1=radiusServer1, ipNetmask=ipNetmask, version=version, remoteTcpPort=remoteTcpPort, productName=productName, siteName=siteName, authRad1=authRad1, tcpPort=tcpPort, acctRad2=acctRad2, ftpdService=ftpdService, afterSend=afterSend, authRad2=authRad2, rxIdle=rxIdle, secondGateway=secondGateway, telnetdService=telnetdService, interFrame=interFrame, gatewayToRemote=gatewayToRemote, portStatsEntry=portStatsEntry, snmpTrapAddr1=snmpTrapAddr1, ipGateway=ipGateway, ts=ts, txIdle=txIdle, acctRad1=acctRad1, portStatsTable=portStatsTable, dtrDown=dtrDown, ipServer=ipServer, portTable=portTable, multiSession=multiSession, nbParStop=nbParStop, portReset=portReset, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, slaveIPaddr=slaveIPaddr, radiusServer2=radiusServer2, snmpTrapAddr2=snmpTrapAddr2, cxr=cxr, aliasIpNetmask=aliasIpNetmask, portEntry=portEntry, mainIpAddress=mainIpAddress, snmpdService=snmpdService, modbusTable=modbusTable, flowControl=flowControl, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret1=radiusSecret1, nameServer2=nameServer2, reset=reset, slaveIPport=slaveIPport, beforeSend=beforeSend, bootp=bootp, sessionStarted=sessionStarted, portIndex=portIndex, system=system, sessionStopped=sessionStopped, terminalType=terminalType, formFeed=formFeed, modbusType=modbusType, resetByButton=resetByButton, timeoutRxTx=timeoutRxTx, dtrUp=dtrUp, slaveHexaAddress=slaveHexaAddress, baudRate=baudRate, secondIpAddress=secondIpAddress, ethernetAddress=ethernetAddress, mode=mode, radiusSecret2=radiusSecret2)
