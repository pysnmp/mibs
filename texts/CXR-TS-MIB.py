...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:14:09 2022
...
enterprises, ObjectIdentity, TimeTicks, iso, Gauge32, IpAddress, Counter32, Counter64, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, MibIdentifier, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "TimeTicks", "iso", "Gauge32", "IpAddress", "Counter32", "Counter64", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrap=snmpTrap, formFeed=formFeed, radiusSecret2=radiusSecret2, dtrUp=dtrUp, authType=authType, slaveIPport=slaveIPport, portTable=portTable, timeoutPAD=timeoutPAD, telnetdService=telnetdService, portStatsTable=portStatsTable, authRad1=authRad1, modbusType=modbusType, system=system, ipServer=ipServer, acctRad1=acctRad1, flowControl=flowControl, resetByButton=resetByButton, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, secondIpAddress=secondIpAddress, baudRate=baudRate, ftpdService=ftpdService, portIndex=portIndex, portEntry=portEntry, bytesReceiveFromV24=bytesReceiveFromV24, sessionStopped=sessionStopped, statusDTR=statusDTR, productName=productName, snmpTrapAddr2=snmpTrapAddr2, cxr=cxr, secondTcpPort=secondTcpPort, aliasIpAddress=aliasIpAddress, nbParStop=nbParStop, mode=mode, nameResolution=nameResolution, rxIdle=rxIdle, siteName=siteName, reset=reset, ipGateway=ipGateway, gatewayToRemote=gatewayToRemote, mainIpAddress=mainIpAddress, multiSession=multiSession, timeoutRxTx=timeoutRxTx, ethernetAddress=ethernetAddress, modbusMode=modbusMode, remoteTcpPort=remoteTcpPort, modbusEntry=modbusEntry, radiusServer2=radiusServer2, endMsg=endMsg, afterSend=afterSend, httpdService=httpdService, beforeSend=beforeSend, portStatsEntry=portStatsEntry, nameServer1=nameServer1, secondGateway=secondGateway, bootp=bootp, version=version, ipNetmask=ipNetmask, interFrame=interFrame, snmpTrapAddr1=snmpTrapAddr1, radiusServer1=radiusServer1, bytesSendToV24=bytesSendToV24, terminalType=terminalType, authRad2=authRad2, modbusTable=modbusTable, snmpdService=snmpdService, dtrDown=dtrDown, tcpPort=tcpPort, sessionStarted=sessionStarted, portReset=portReset, slaveHexaAddress=slaveHexaAddress, radiusSecret1=radiusSecret1, nameServer2=nameServer2, remoteIpAddress=remoteIpAddress, ts=ts, slaveIPaddr=slaveIPaddr, acctRad2=acctRad2)
