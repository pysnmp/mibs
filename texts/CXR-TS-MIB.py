...
# Produced by pysmi-1.1.8 at Mon Jan  9 11:00:35 2023
...
MibIdentifier, IpAddress, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, ModuleIdentity, NotificationType, NotificationType, Unsigned32, Counter64, Gauge32, Bits, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "ModuleIdentity", "NotificationType", "NotificationType", "Unsigned32", "Counter64", "Gauge32", "Bits", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", secondGateway=secondGateway, reset=reset, portEntry=portEntry, portIndex=portIndex, snmpTrapAddr2=snmpTrapAddr2, bootp=bootp, system=system, ethernetAddress=ethernetAddress, snmpTrap=snmpTrap, radiusSecret1=radiusSecret1, authRad1=authRad1, rxIdle=rxIdle, multiSession=multiSession, tcpPort=tcpPort, remoteTcpPort=remoteTcpPort, ipNetmask=ipNetmask, formFeed=formFeed, bytesSendToV24=bytesSendToV24, ts=ts, radiusServer2=radiusServer2, mode=mode, authType=authType, ftpdService=ftpdService, secondIpAddress=secondIpAddress, slaveHexaAddress=slaveHexaAddress, snmpTrapAddr1=snmpTrapAddr1, secondTcpPort=secondTcpPort, modbusEntry=modbusEntry, radiusServer1=radiusServer1, txIdle=txIdle, cxr=cxr, dtrDown=dtrDown, beforeSend=beforeSend, terminalType=terminalType, nbParStop=nbParStop, modbusTable=modbusTable, afterSend=afterSend, slaveIPaddr=slaveIPaddr, timeoutRxTx=timeoutRxTx, authRad2=authRad2, statusDTR=statusDTR, baudRate=baudRate, acctRad2=acctRad2, telnetdService=telnetdService, portStatsTable=portStatsTable, nameResolution=nameResolution, mainIpAddress=mainIpAddress, nameServer2=nameServer2, httpdService=httpdService, bytesReceiveFromV24=bytesReceiveFromV24, remoteIpAddress=remoteIpAddress, resetByButton=resetByButton, version=version, flowControl=flowControl, siteName=siteName, portReset=portReset, ipGateway=ipGateway, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, sessionStopped=sessionStopped, dtrUp=dtrUp, portStatsEntry=portStatsEntry, modbusType=modbusType, endMsg=endMsg, snmpdService=snmpdService, modbusMode=modbusMode, sessionStarted=sessionStarted, interFrame=interFrame, nameServer1=nameServer1, productName=productName, acctRad1=acctRad1, slaveIPport=slaveIPport, radiusSecret2=radiusSecret2, gatewayToRemote=gatewayToRemote, portTable=portTable, timeoutPAD=timeoutPAD, aliasIpAddress=aliasIpAddress)
