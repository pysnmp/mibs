...
ObjectIdentity, ModuleIdentity, Counter64, Unsigned32, MibIdentifier, NotificationType, Counter32, IpAddress, Bits, NotificationType, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter64", "Unsigned32", "MibIdentifier", "NotificationType", "Counter32", "IpAddress", "Bits", "NotificationType", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bootp=bootp, nameResolution=nameResolution, portStatsEntry=portStatsEntry, gatewayToRemote=gatewayToRemote, slaveIPport=slaveIPport, slaveHexaAddress=slaveHexaAddress, acctRad1=acctRad1, interFrame=interFrame, authRad1=authRad1, portStatsTable=portStatsTable, nameServer1=nameServer1, statusDTR=statusDTR, siteName=siteName, aliasIpAddress=aliasIpAddress, txIdle=txIdle, ipNetmask=ipNetmask, beforeSend=beforeSend, nbParStop=nbParStop, radiusSecret2=radiusSecret2, modbusMode=modbusMode, cxr=cxr, remoteTcpPort=remoteTcpPort, bytesReceiveFromV24=bytesReceiveFromV24, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, snmpdService=snmpdService, aliasIpNetmask=aliasIpNetmask, nameServer2=nameServer2, timeoutRxTx=timeoutRxTx, authRad2=authRad2, mode=mode, authType=authType, dtrUp=dtrUp, portIndex=portIndex, terminalType=terminalType, sessionStarted=sessionStarted, timeoutPAD=timeoutPAD, ftpdService=ftpdService, productName=productName, ipGateway=ipGateway, portTable=portTable, acctRad2=acctRad2, secondTcpPort=secondTcpPort, formFeed=formFeed, portEntry=portEntry, ipServer=ipServer, portReset=portReset, snmpTrapAddr1=snmpTrapAddr1, mainIpAddress=mainIpAddress, ethernetAddress=ethernetAddress, modbusEntry=modbusEntry, sessionStopped=sessionStopped, modbusType=modbusType, tcpPort=tcpPort, rxIdle=rxIdle, secondIpAddress=secondIpAddress, endMsg=endMsg, snmpTrap=snmpTrap, radiusServer2=radiusServer2, ts=ts, multiSession=multiSession, snmpTrapAddr2=snmpTrapAddr2, dtrDown=dtrDown, slaveIPaddr=slaveIPaddr, telnetdService=telnetdService, modbusTable=modbusTable, system=system, reset=reset, radiusSecret1=radiusSecret1, baudRate=baudRate, radiusServer1=radiusServer1, version=version, flowControl=flowControl, afterSend=afterSend, secondGateway=secondGateway, remoteIpAddress=remoteIpAddress, httpdService=httpdService)
