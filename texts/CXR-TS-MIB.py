...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:04:36 2022
...
NotificationType, IpAddress, Bits, Counter32, Unsigned32, Integer32, ObjectIdentity, enterprises, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Bits", "Counter32", "Unsigned32", "Integer32", "ObjectIdentity", "enterprises", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, radiusServer1=radiusServer1, slaveHexaAddress=slaveHexaAddress, portEntry=portEntry, authRad1=authRad1, authType=authType, ethernetAddress=ethernetAddress, slaveIPaddr=slaveIPaddr, authRad2=authRad2, aliasIpNetmask=aliasIpNetmask, modbusEntry=modbusEntry, nbParStop=nbParStop, snmpTrap=snmpTrap, mainIpAddress=mainIpAddress, version=version, portTable=portTable, secondIpAddress=secondIpAddress, gatewayToRemote=gatewayToRemote, afterSend=afterSend, bytesSendToV24=bytesSendToV24, ipServer=ipServer, productName=productName, secondGateway=secondGateway, radiusServer2=radiusServer2, reset=reset, statusDTR=statusDTR, resetByButton=resetByButton, timeoutPAD=timeoutPAD, acctRad1=acctRad1, ipNetmask=ipNetmask, interFrame=interFrame, mode=mode, sessionStopped=sessionStopped, secondTcpPort=secondTcpPort, ts=ts, bootp=bootp, multiSession=multiSession, acctRad2=acctRad2, snmpdService=snmpdService, snmpTrapAddr2=snmpTrapAddr2, aliasIpAddress=aliasIpAddress, remoteTcpPort=remoteTcpPort, baudRate=baudRate, bytesReceiveFromV24=bytesReceiveFromV24, modbusType=modbusType, radiusSecret1=radiusSecret1, remoteIpAddress=remoteIpAddress, terminalType=terminalType, nameResolution=nameResolution, portIndex=portIndex, flowControl=flowControl, portStatsEntry=portStatsEntry, txIdle=txIdle, dtrUp=dtrUp, nameServer1=nameServer1, nameServer2=nameServer2, ipGateway=ipGateway, snmpTrapAddr1=snmpTrapAddr1, portReset=portReset, rxIdle=rxIdle, endMsg=endMsg, tcpPort=tcpPort, siteName=siteName, modbusMode=modbusMode, system=system, telnetdService=telnetdService, cxr=cxr, beforeSend=beforeSend, ftpdService=ftpdService, slaveIPport=slaveIPport, modbusTable=modbusTable, httpdService=httpdService, timeoutRxTx=timeoutRxTx, formFeed=formFeed, dtrDown=dtrDown, portStatsTable=portStatsTable)
