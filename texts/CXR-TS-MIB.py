...
# Produced by pysmi-1.1.8 at Wed Feb  2 17:54:38 2022
...
enterprises, MibIdentifier, Integer32, Unsigned32, ModuleIdentity, iso, Counter32, Bits, Gauge32, ObjectIdentity, TimeTicks, Counter64, NotificationType, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "iso", "Counter32", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bootp=bootp, ipGateway=ipGateway, interFrame=interFrame, slaveHexaAddress=slaveHexaAddress, txIdle=txIdle, gatewayToRemote=gatewayToRemote, remoteIpAddress=remoteIpAddress, portReset=portReset, dtrUp=dtrUp, nameResolution=nameResolution, snmpTrapAddr2=snmpTrapAddr2, formFeed=formFeed, remoteTcpPort=remoteTcpPort, terminalType=terminalType, ftpdService=ftpdService, authRad1=authRad1, httpdService=httpdService, resetByButton=resetByButton, rxIdle=rxIdle, modbusTable=modbusTable, radiusSecret1=radiusSecret1, radiusServer2=radiusServer2, sessionStopped=sessionStopped, bytesReceiveFromV24=bytesReceiveFromV24, aliasIpNetmask=aliasIpNetmask, sessionStarted=sessionStarted, radiusSecret2=radiusSecret2, slaveIPaddr=slaveIPaddr, slaveIPport=slaveIPport, acctRad1=acctRad1, mainIpAddress=mainIpAddress, portStatsEntry=portStatsEntry, snmpTrapAddr1=snmpTrapAddr1, nameServer1=nameServer1, snmpTrap=snmpTrap, ts=ts, authRad2=authRad2, modbusEntry=modbusEntry, flowControl=flowControl, productName=productName, nbParStop=nbParStop, tcpPort=tcpPort, portEntry=portEntry, timeoutPAD=timeoutPAD, ethernetAddress=ethernetAddress, ipNetmask=ipNetmask, beforeSend=beforeSend, portTable=portTable, reset=reset, nameServer2=nameServer2, multiSession=multiSession, modbusType=modbusType, baudRate=baudRate, version=version, secondGateway=secondGateway, cxr=cxr, portIndex=portIndex, bytesSendToV24=bytesSendToV24, authType=authType, ipServer=ipServer, telnetdService=telnetdService, aliasIpAddress=aliasIpAddress, system=system, siteName=siteName, portStatsTable=portStatsTable, endMsg=endMsg, radiusServer1=radiusServer1, afterSend=afterSend, secondTcpPort=secondTcpPort, snmpdService=snmpdService, statusDTR=statusDTR, dtrDown=dtrDown, acctRad2=acctRad2, timeoutRxTx=timeoutRxTx, secondIpAddress=secondIpAddress, modbusMode=modbusMode, mode=mode)
