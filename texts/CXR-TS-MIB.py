...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:32:21 2023
...
TimeTicks, Gauge32, Counter64, NotificationType, NotificationType, ObjectIdentity, IpAddress, enterprises, Integer32, iso, Counter32, Unsigned32, Bits, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter64", "NotificationType", "NotificationType", "ObjectIdentity", "IpAddress", "enterprises", "Integer32", "iso", "Counter32", "Unsigned32", "Bits", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipServer=ipServer, remoteTcpPort=remoteTcpPort, nbParStop=nbParStop, slaveIPport=slaveIPport, version=version, authType=authType, baudRate=baudRate, authRad1=authRad1, secondTcpPort=secondTcpPort, sessionStarted=sessionStarted, mode=mode, modbusType=modbusType, portStatsEntry=portStatsEntry, radiusServer1=radiusServer1, statusDTR=statusDTR, radiusServer2=radiusServer2, dtrDown=dtrDown, slaveHexaAddress=slaveHexaAddress, aliasIpNetmask=aliasIpNetmask, radiusSecret2=radiusSecret2, ipNetmask=ipNetmask, cxr=cxr, acctRad1=acctRad1, modbusMode=modbusMode, bytesSendToV24=bytesSendToV24, endMsg=endMsg, slaveIPaddr=slaveIPaddr, afterSend=afterSend, timeoutPAD=timeoutPAD, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, formFeed=formFeed, tcpPort=tcpPort, rxIdle=rxIdle, system=system, telnetdService=telnetdService, interFrame=interFrame, ts=ts, reset=reset, multiSession=multiSession, authRad2=authRad2, mainIpAddress=mainIpAddress, siteName=siteName, txIdle=txIdle, aliasIpAddress=aliasIpAddress, productName=productName, snmpdService=snmpdService, portEntry=portEntry, nameServer2=nameServer2, nameResolution=nameResolution, ftpdService=ftpdService, beforeSend=beforeSend, radiusSecret1=radiusSecret1, secondIpAddress=secondIpAddress, portIndex=portIndex, portReset=portReset, portTable=portTable, nameServer1=nameServer1, gatewayToRemote=gatewayToRemote, snmpTrap=snmpTrap, modbusEntry=modbusEntry, secondGateway=secondGateway, timeoutRxTx=timeoutRxTx, resetByButton=resetByButton, httpdService=httpdService, sessionStopped=sessionStopped, snmpTrapAddr2=snmpTrapAddr2, portStatsTable=portStatsTable, modbusTable=modbusTable, remoteIpAddress=remoteIpAddress, snmpTrapAddr1=snmpTrapAddr1, ipGateway=ipGateway, flowControl=flowControl, dtrUp=dtrUp, ethernetAddress=ethernetAddress, terminalType=terminalType, bootp=bootp)
