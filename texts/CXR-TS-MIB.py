...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:00:45 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, iso, TimeTicks, ModuleIdentity, Counter64, Unsigned32, Bits, MibIdentifier, Gauge32, Integer32, enterprises, ObjectIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "iso", "TimeTicks", "ModuleIdentity", "Counter64", "Unsigned32", "Bits", "MibIdentifier", "Gauge32", "Integer32", "enterprises", "ObjectIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipGateway=ipGateway, txIdle=txIdle, radiusSecret2=radiusSecret2, modbusType=modbusType, multiSession=multiSession, interFrame=interFrame, remoteIpAddress=remoteIpAddress, snmpTrapAddr2=snmpTrapAddr2, rxIdle=rxIdle, snmpTrap=snmpTrap, radiusSecret1=radiusSecret1, authRad1=authRad1, nameServer2=nameServer2, ipServer=ipServer, snmpTrapAddr1=snmpTrapAddr1, portIndex=portIndex, reset=reset, bootp=bootp, nameResolution=nameResolution, ts=ts, portReset=portReset, secondTcpPort=secondTcpPort, slaveIPport=slaveIPport, radiusServer2=radiusServer2, ipNetmask=ipNetmask, portEntry=portEntry, snmpdService=snmpdService, modbusEntry=modbusEntry, endMsg=endMsg, terminalType=terminalType, authRad2=authRad2, bytesSendToV24=bytesSendToV24, nameServer1=nameServer1, aliasIpAddress=aliasIpAddress, secondIpAddress=secondIpAddress, sessionStarted=sessionStarted, portTable=portTable, nbParStop=nbParStop, flowControl=flowControl, version=version, aliasIpNetmask=aliasIpNetmask, acctRad1=acctRad1, authType=authType, system=system, tcpPort=tcpPort, mainIpAddress=mainIpAddress, radiusServer1=radiusServer1, dtrUp=dtrUp, slaveHexaAddress=slaveHexaAddress, ethernetAddress=ethernetAddress, resetByButton=resetByButton, slaveIPaddr=slaveIPaddr, timeoutRxTx=timeoutRxTx, bytesReceiveFromV24=bytesReceiveFromV24, mode=mode, beforeSend=beforeSend, remoteTcpPort=remoteTcpPort, cxr=cxr, siteName=siteName, modbusTable=modbusTable, modbusMode=modbusMode, telnetdService=telnetdService, productName=productName, secondGateway=secondGateway, baudRate=baudRate, statusDTR=statusDTR, dtrDown=dtrDown, afterSend=afterSend, acctRad2=acctRad2, portStatsTable=portStatsTable, formFeed=formFeed, sessionStopped=sessionStopped, gatewayToRemote=gatewayToRemote, timeoutPAD=timeoutPAD, httpdService=httpdService, portStatsEntry=portStatsEntry, ftpdService=ftpdService)
