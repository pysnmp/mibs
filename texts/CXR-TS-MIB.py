...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:55:15 2023
...
ModuleIdentity, Counter32, MibIdentifier, Counter64, Gauge32, iso, IpAddress, Integer32, TimeTicks, Bits, Unsigned32, ObjectIdentity, NotificationType, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "MibIdentifier", "Counter64", "Gauge32", "iso", "IpAddress", "Integer32", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "NotificationType", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bootp=bootp, ethernetAddress=ethernetAddress, modbusType=modbusType, aliasIpAddress=aliasIpAddress, snmpTrapAddr1=snmpTrapAddr1, portIndex=portIndex, ipServer=ipServer, ftpdService=ftpdService, timeoutPAD=timeoutPAD, radiusSecret1=radiusSecret1, gatewayToRemote=gatewayToRemote, mainIpAddress=mainIpAddress, bytesReceiveFromV24=bytesReceiveFromV24, afterSend=afterSend, siteName=siteName, slaveIPaddr=slaveIPaddr, authType=authType, radiusServer1=radiusServer1, bytesSendToV24=bytesSendToV24, interFrame=interFrame, remoteTcpPort=remoteTcpPort, tcpPort=tcpPort, mode=mode, sessionStopped=sessionStopped, portReset=portReset, multiSession=multiSession, resetByButton=resetByButton, portTable=portTable, portEntry=portEntry, radiusSecret2=radiusSecret2, portStatsTable=portStatsTable, flowControl=flowControl, authRad1=authRad1, modbusTable=modbusTable, sessionStarted=sessionStarted, terminalType=terminalType, aliasIpNetmask=aliasIpNetmask, snmpdService=snmpdService, ts=ts, txIdle=txIdle, formFeed=formFeed, secondIpAddress=secondIpAddress, nameServer1=nameServer1, ipGateway=ipGateway, modbusMode=modbusMode, ipNetmask=ipNetmask, slaveIPport=slaveIPport, baudRate=baudRate, authRad2=authRad2, snmpTrapAddr2=snmpTrapAddr2, snmpTrap=snmpTrap, productName=productName, dtrDown=dtrDown, version=version, telnetdService=telnetdService, secondGateway=secondGateway, acctRad1=acctRad1, remoteIpAddress=remoteIpAddress, beforeSend=beforeSend, httpdService=httpdService, system=system, secondTcpPort=secondTcpPort, acctRad2=acctRad2, slaveHexaAddress=slaveHexaAddress, endMsg=endMsg, radiusServer2=radiusServer2, rxIdle=rxIdle, nameServer2=nameServer2, reset=reset, timeoutRxTx=timeoutRxTx, portStatsEntry=portStatsEntry, modbusEntry=modbusEntry, nameResolution=nameResolution, statusDTR=statusDTR, dtrUp=dtrUp, cxr=cxr, nbParStop=nbParStop)
