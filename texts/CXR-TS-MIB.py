...
iso, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Counter64, MibIdentifier, Integer32, Counter32, Bits, ModuleIdentity, enterprises, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "Integer32", "Counter32", "Bits", "ModuleIdentity", "enterprises", "TimeTicks", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer2=radiusServer2, authType=authType, ipServer=ipServer, portEntry=portEntry, nbParStop=nbParStop, secondGateway=secondGateway, acctRad2=acctRad2, formFeed=formFeed, acctRad1=acctRad1, slaveIPaddr=slaveIPaddr, tcpPort=tcpPort, gatewayToRemote=gatewayToRemote, nameServer1=nameServer1, modbusTable=modbusTable, productName=productName, snmpTrap=snmpTrap, sessionStarted=sessionStarted, remoteTcpPort=remoteTcpPort, terminalType=terminalType, portStatsTable=portStatsTable, secondTcpPort=secondTcpPort, radiusServer1=radiusServer1, radiusSecret1=radiusSecret1, nameResolution=nameResolution, ethernetAddress=ethernetAddress, snmpdService=snmpdService, system=system, mainIpAddress=mainIpAddress, authRad1=authRad1, bytesSendToV24=bytesSendToV24, afterSend=afterSend, slaveHexaAddress=slaveHexaAddress, remoteIpAddress=remoteIpAddress, portIndex=portIndex, dtrUp=dtrUp, aliasIpAddress=aliasIpAddress, portStatsEntry=portStatsEntry, modbusMode=modbusMode, portReset=portReset, modbusType=modbusType, snmpTrapAddr1=snmpTrapAddr1, authRad2=authRad2, bytesReceiveFromV24=bytesReceiveFromV24, httpdService=httpdService, modbusEntry=modbusEntry, reset=reset, portTable=portTable, nameServer2=nameServer2, timeoutPAD=timeoutPAD, resetByButton=resetByButton, statusDTR=statusDTR, cxr=cxr, secondIpAddress=secondIpAddress, version=version, telnetdService=telnetdService, radiusSecret2=radiusSecret2, bootp=bootp, baudRate=baudRate, slaveIPport=slaveIPport, dtrDown=dtrDown, siteName=siteName, interFrame=interFrame, endMsg=endMsg, ts=ts, ipNetmask=ipNetmask, mode=mode, flowControl=flowControl, sessionStopped=sessionStopped, snmpTrapAddr2=snmpTrapAddr2, ipGateway=ipGateway, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, timeoutRxTx=timeoutRxTx, multiSession=multiSession, beforeSend=beforeSend, rxIdle=rxIdle, ftpdService=ftpdService)
