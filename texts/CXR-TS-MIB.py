...
Integer32, Unsigned32, Counter32, Gauge32, NotificationType, ModuleIdentity, ObjectIdentity, iso, NotificationType, IpAddress, Counter64, enterprises, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "iso", "NotificationType", "IpAddress", "Counter64", "enterprises", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrap=snmpTrap, acctRad2=acctRad2, gatewayToRemote=gatewayToRemote, ts=ts, authRad2=authRad2, flowControl=flowControl, secondGateway=secondGateway, version=version, endMsg=endMsg, telnetdService=telnetdService, nbParStop=nbParStop, ipNetmask=ipNetmask, snmpTrapAddr2=snmpTrapAddr2, aliasIpNetmask=aliasIpNetmask, snmpTrapAddr1=snmpTrapAddr1, mainIpAddress=mainIpAddress, remoteTcpPort=remoteTcpPort, bytesReceiveFromV24=bytesReceiveFromV24, beforeSend=beforeSend, terminalType=terminalType, portStatsEntry=portStatsEntry, sessionStarted=sessionStarted, cxr=cxr, productName=productName, statusDTR=statusDTR, slaveIPport=slaveIPport, nameServer2=nameServer2, slaveIPaddr=slaveIPaddr, httpdService=httpdService, modbusMode=modbusMode, modbusTable=modbusTable, mode=mode, bytesSendToV24=bytesSendToV24, tcpPort=tcpPort, radiusSecret2=radiusSecret2, secondIpAddress=secondIpAddress, baudRate=baudRate, sessionStopped=sessionStopped, dtrDown=dtrDown, siteName=siteName, formFeed=formFeed, portEntry=portEntry, timeoutRxTx=timeoutRxTx, reset=reset, system=system, authType=authType, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, nameServer1=nameServer1, ipServer=ipServer, authRad1=authRad1, slaveHexaAddress=slaveHexaAddress, radiusSecret1=radiusSecret1, portIndex=portIndex, rxIdle=rxIdle, resetByButton=resetByButton, portTable=portTable, ipGateway=ipGateway, bootp=bootp, ethernetAddress=ethernetAddress, snmpdService=snmpdService, secondTcpPort=secondTcpPort, portStatsTable=portStatsTable, txIdle=txIdle, nameResolution=nameResolution, portReset=portReset, acctRad1=acctRad1, multiSession=multiSession, aliasIpAddress=aliasIpAddress, interFrame=interFrame, radiusServer2=radiusServer2, modbusType=modbusType, modbusEntry=modbusEntry, afterSend=afterSend, dtrUp=dtrUp, timeoutPAD=timeoutPAD, radiusServer1=radiusServer1)
