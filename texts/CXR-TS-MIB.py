...
Gauge32, NotificationType, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Counter64, Unsigned32, MibIdentifier, Counter32, enterprises, ModuleIdentity, iso, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Counter64", "Unsigned32", "MibIdentifier", "Counter32", "enterprises", "ModuleIdentity", "iso", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", flowControl=flowControl, ethernetAddress=ethernetAddress, statusDTR=statusDTR, nameServer2=nameServer2, baudRate=baudRate, rxIdle=rxIdle, slaveIPport=slaveIPport, radiusSecret2=radiusSecret2, bytesReceiveFromV24=bytesReceiveFromV24, authRad2=authRad2, authRad1=authRad1, modbusEntry=modbusEntry, telnetdService=telnetdService, ts=ts, snmpdService=snmpdService, productName=productName, siteName=siteName, formFeed=formFeed, portTable=portTable, authType=authType, portEntry=portEntry, bootp=bootp, radiusSecret1=radiusSecret1, bytesSendToV24=bytesSendToV24, timeoutPAD=timeoutPAD, txIdle=txIdle, portStatsTable=portStatsTable, nameServer1=nameServer1, remoteIpAddress=remoteIpAddress, acctRad1=acctRad1, ipServer=ipServer, modbusMode=modbusMode, aliasIpAddress=aliasIpAddress, slaveIPaddr=slaveIPaddr, dtrUp=dtrUp, secondIpAddress=secondIpAddress, system=system, sessionStarted=sessionStarted, snmpTrapAddr1=snmpTrapAddr1, reset=reset, secondGateway=secondGateway, gatewayToRemote=gatewayToRemote, version=version, portReset=portReset, snmpTrapAddr2=snmpTrapAddr2, portStatsEntry=portStatsEntry, snmpTrap=snmpTrap, beforeSend=beforeSend, secondTcpPort=secondTcpPort, mainIpAddress=mainIpAddress, radiusServer2=radiusServer2, interFrame=interFrame, radiusServer1=radiusServer1, terminalType=terminalType, dtrDown=dtrDown, tcpPort=tcpPort, cxr=cxr, mode=mode, afterSend=afterSend, modbusTable=modbusTable, multiSession=multiSession, ftpdService=ftpdService, remoteTcpPort=remoteTcpPort, portIndex=portIndex, ipGateway=ipGateway, aliasIpNetmask=aliasIpNetmask, nameResolution=nameResolution, modbusType=modbusType, ipNetmask=ipNetmask, httpdService=httpdService, nbParStop=nbParStop, slaveHexaAddress=slaveHexaAddress, resetByButton=resetByButton, endMsg=endMsg, sessionStopped=sessionStopped, timeoutRxTx=timeoutRxTx, acctRad2=acctRad2)
