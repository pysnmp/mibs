...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:00:45 2023
...
Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, NotificationType, IpAddress, NotificationType, ModuleIdentity, Counter64, ObjectIdentity, iso, enterprises, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "NotificationType", "IpAddress", "NotificationType", "ModuleIdentity", "Counter64", "ObjectIdentity", "iso", "enterprises", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nbParStop=nbParStop, bytesReceiveFromV24=bytesReceiveFromV24, portStatsTable=portStatsTable, baudRate=baudRate, slaveHexaAddress=slaveHexaAddress, slaveIPport=slaveIPport, system=system, ipServer=ipServer, nameResolution=nameResolution, flowControl=flowControl, aliasIpNetmask=aliasIpNetmask, httpdService=httpdService, tcpPort=tcpPort, modbusEntry=modbusEntry, mode=mode, ipNetmask=ipNetmask, beforeSend=beforeSend, snmpTrap=snmpTrap, nameServer1=nameServer1, telnetdService=telnetdService, siteName=siteName, portIndex=portIndex, remoteIpAddress=remoteIpAddress, authRad2=authRad2, aliasIpAddress=aliasIpAddress, modbusTable=modbusTable, mainIpAddress=mainIpAddress, dtrUp=dtrUp, statusDTR=statusDTR, secondGateway=secondGateway, endMsg=endMsg, dtrDown=dtrDown, portReset=portReset, radiusSecret1=radiusSecret1, timeoutPAD=timeoutPAD, snmpdService=snmpdService, bootp=bootp, nameServer2=nameServer2, cxr=cxr, slaveIPaddr=slaveIPaddr, acctRad2=acctRad2, ftpdService=ftpdService, version=version, terminalType=terminalType, radiusSecret2=radiusSecret2, modbusType=modbusType, productName=productName, portTable=portTable, bytesSendToV24=bytesSendToV24, formFeed=formFeed, snmpTrapAddr2=snmpTrapAddr2, resetByButton=resetByButton, ipGateway=ipGateway, portStatsEntry=portStatsEntry, gatewayToRemote=gatewayToRemote, radiusServer1=radiusServer1, interFrame=interFrame, ts=ts, afterSend=afterSend, portEntry=portEntry, timeoutRxTx=timeoutRxTx, modbusMode=modbusMode, ethernetAddress=ethernetAddress, authType=authType, authRad1=authRad1, multiSession=multiSession, reset=reset, acctRad1=acctRad1, sessionStarted=sessionStarted, secondIpAddress=secondIpAddress, radiusServer2=radiusServer2, sessionStopped=sessionStopped, remoteTcpPort=remoteTcpPort, secondTcpPort=secondTcpPort, snmpTrapAddr1=snmpTrapAddr1, rxIdle=rxIdle, txIdle=txIdle)
