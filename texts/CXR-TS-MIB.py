...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:41:13 2024
...
IpAddress, Bits, iso, ModuleIdentity, enterprises, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Unsigned32, ObjectIdentity, MibIdentifier, Counter32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "iso", "ModuleIdentity", "enterprises", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Counter32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStarted=sessionStarted, slaveIPaddr=slaveIPaddr, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr1=snmpTrapAddr1, portStatsEntry=portStatsEntry, modbusTable=modbusTable, snmpTrap=snmpTrap, statusDTR=statusDTR, portTable=portTable, ts=ts, snmpTrapAddr2=snmpTrapAddr2, authRad2=authRad2, formFeed=formFeed, afterSend=afterSend, resetByButton=resetByButton, authRad1=authRad1, reset=reset, secondIpAddress=secondIpAddress, multiSession=multiSession, nameServer2=nameServer2, terminalType=terminalType, remoteIpAddress=remoteIpAddress, dtrUp=dtrUp, radiusSecret1=radiusSecret1, system=system, mode=mode, siteName=siteName, ipServer=ipServer, modbusEntry=modbusEntry, flowControl=flowControl, authType=authType, acctRad1=acctRad1, radiusServer2=radiusServer2, ipNetmask=ipNetmask, endMsg=endMsg, version=version, productName=productName, acctRad2=acctRad2, nameResolution=nameResolution, txIdle=txIdle, timeoutPAD=timeoutPAD, timeoutRxTx=timeoutRxTx, bootp=bootp, rxIdle=rxIdle, modbusMode=modbusMode, cxr=cxr, secondTcpPort=secondTcpPort, secondGateway=secondGateway, httpdService=httpdService, radiusServer1=radiusServer1, slaveHexaAddress=slaveHexaAddress, dtrDown=dtrDown, ipGateway=ipGateway, snmpdService=snmpdService, nbParStop=nbParStop, modbusType=modbusType, portEntry=portEntry, baudRate=baudRate, portReset=portReset, portStatsTable=portStatsTable, mainIpAddress=mainIpAddress, portIndex=portIndex, radiusSecret2=radiusSecret2, ftpdService=ftpdService, aliasIpAddress=aliasIpAddress, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, bytesSendToV24=bytesSendToV24, sessionStopped=sessionStopped, nameServer1=nameServer1, ethernetAddress=ethernetAddress, telnetdService=telnetdService, slaveIPport=slaveIPport, gatewayToRemote=gatewayToRemote, interFrame=interFrame, remoteTcpPort=remoteTcpPort, tcpPort=tcpPort)
