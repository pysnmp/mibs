...
# Produced by pysmi-1.1.8 at Fri Dec  2 16:42:08 2022
...
Counter64, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks, Bits, Counter32, Unsigned32, MibIdentifier, Integer32, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "Integer32", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", dtrDown=dtrDown, formFeed=formFeed, ethernetAddress=ethernetAddress, ipNetmask=ipNetmask, slaveIPport=slaveIPport, nameServer2=nameServer2, snmpTrapAddr1=snmpTrapAddr1, remoteTcpPort=remoteTcpPort, modbusEntry=modbusEntry, rxIdle=rxIdle, ftpdService=ftpdService, multiSession=multiSession, sessionStarted=sessionStarted, tcpPort=tcpPort, productName=productName, authRad2=authRad2, resetByButton=resetByButton, snmpTrapAddr2=snmpTrapAddr2, statusDTR=statusDTR, slaveHexaAddress=slaveHexaAddress, sessionStopped=sessionStopped, siteName=siteName, dtrUp=dtrUp, reset=reset, nbParStop=nbParStop, portEntry=portEntry, portStatsTable=portStatsTable, gatewayToRemote=gatewayToRemote, aliasIpAddress=aliasIpAddress, portTable=portTable, ts=ts, radiusSecret2=radiusSecret2, modbusType=modbusType, authRad1=authRad1, cxr=cxr, mainIpAddress=mainIpAddress, timeoutRxTx=timeoutRxTx, slaveIPaddr=slaveIPaddr, httpdService=httpdService, snmpTrap=snmpTrap, acctRad1=acctRad1, beforeSend=beforeSend, timeoutPAD=timeoutPAD, radiusSecret1=radiusSecret1, afterSend=afterSend, endMsg=endMsg, secondGateway=secondGateway, telnetdService=telnetdService, modbusMode=modbusMode, nameServer1=nameServer1, interFrame=interFrame, radiusServer1=radiusServer1, secondTcpPort=secondTcpPort, baudRate=baudRate, mode=mode, bootp=bootp, secondIpAddress=secondIpAddress, ipServer=ipServer, modbusTable=modbusTable, bytesSendToV24=bytesSendToV24, txIdle=txIdle, authType=authType, bytesReceiveFromV24=bytesReceiveFromV24, nameResolution=nameResolution, portIndex=portIndex, ipGateway=ipGateway, system=system, terminalType=terminalType, flowControl=flowControl, remoteIpAddress=remoteIpAddress, portReset=portReset, acctRad2=acctRad2, version=version, radiusServer2=radiusServer2, snmpdService=snmpdService, aliasIpNetmask=aliasIpNetmask, portStatsEntry=portStatsEntry)
