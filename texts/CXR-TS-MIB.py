...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:28:26 2023
...
TimeTicks, ModuleIdentity, Gauge32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Integer32, enterprises, Counter32, MibIdentifier, Unsigned32, Bits, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Gauge32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Integer32", "enterprises", "Counter32", "MibIdentifier", "Unsigned32", "Bits", "IpAddress", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", acctRad1=acctRad1, productName=productName, secondIpAddress=secondIpAddress, slaveIPaddr=slaveIPaddr, ethernetAddress=ethernetAddress, nameServer1=nameServer1, statusDTR=statusDTR, tcpPort=tcpPort, dtrDown=dtrDown, txIdle=txIdle, ftpdService=ftpdService, radiusServer1=radiusServer1, sessionStarted=sessionStarted, portStatsEntry=portStatsEntry, snmpTrap=snmpTrap, slaveHexaAddress=slaveHexaAddress, aliasIpNetmask=aliasIpNetmask, endMsg=endMsg, acctRad2=acctRad2, slaveIPport=slaveIPport, portTable=portTable, secondGateway=secondGateway, system=system, remoteTcpPort=remoteTcpPort, multiSession=multiSession, mainIpAddress=mainIpAddress, mode=mode, portStatsTable=portStatsTable, terminalType=terminalType, timeoutRxTx=timeoutRxTx, ts=ts, authType=authType, remoteIpAddress=remoteIpAddress, authRad2=authRad2, snmpdService=snmpdService, version=version, cxr=cxr, nbParStop=nbParStop, modbusTable=modbusTable, bytesReceiveFromV24=bytesReceiveFromV24, timeoutPAD=timeoutPAD, afterSend=afterSend, portReset=portReset, httpdService=httpdService, rxIdle=rxIdle, portIndex=portIndex, modbusType=modbusType, sessionStopped=sessionStopped, siteName=siteName, ipGateway=ipGateway, authRad1=authRad1, dtrUp=dtrUp, bootp=bootp, resetByButton=resetByButton, bytesSendToV24=bytesSendToV24, reset=reset, ipServer=ipServer, interFrame=interFrame, modbusEntry=modbusEntry, gatewayToRemote=gatewayToRemote, snmpTrapAddr1=snmpTrapAddr1, baudRate=baudRate, snmpTrapAddr2=snmpTrapAddr2, formFeed=formFeed, aliasIpAddress=aliasIpAddress, beforeSend=beforeSend, portEntry=portEntry, modbusMode=modbusMode, radiusSecret2=radiusSecret2, flowControl=flowControl, nameResolution=nameResolution, radiusSecret1=radiusSecret1, secondTcpPort=secondTcpPort, radiusServer2=radiusServer2, ipNetmask=ipNetmask, nameServer2=nameServer2, telnetdService=telnetdService)
