...
NotificationType, Gauge32, MibIdentifier, Integer32, ModuleIdentity, IpAddress, Counter64, ObjectIdentity, Bits, Unsigned32, NotificationType, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "ModuleIdentity", "IpAddress", "Counter64", "ObjectIdentity", "Bits", "Unsigned32", "NotificationType", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", formFeed=formFeed, sessionStarted=sessionStarted, authRad1=authRad1, sessionStopped=sessionStopped, secondGateway=secondGateway, timeoutRxTx=timeoutRxTx, httpdService=httpdService, snmpdService=snmpdService, ipGateway=ipGateway, telnetdService=telnetdService, mode=mode, radiusServer2=radiusServer2, portStatsTable=portStatsTable, aliasIpNetmask=aliasIpNetmask, baudRate=baudRate, ethernetAddress=ethernetAddress, slaveIPport=slaveIPport, secondTcpPort=secondTcpPort, ftpdService=ftpdService, remoteTcpPort=remoteTcpPort, acctRad1=acctRad1, snmpTrapAddr2=snmpTrapAddr2, authType=authType, modbusMode=modbusMode, nbParStop=nbParStop, bootp=bootp, terminalType=terminalType, resetByButton=resetByButton, remoteIpAddress=remoteIpAddress, portTable=portTable, flowControl=flowControl, tcpPort=tcpPort, dtrDown=dtrDown, gatewayToRemote=gatewayToRemote, radiusSecret2=radiusSecret2, bytesSendToV24=bytesSendToV24, ipServer=ipServer, timeoutPAD=timeoutPAD, beforeSend=beforeSend, system=system, aliasIpAddress=aliasIpAddress, slaveHexaAddress=slaveHexaAddress, mainIpAddress=mainIpAddress, cxr=cxr, multiSession=multiSession, radiusSecret1=radiusSecret1, authRad2=authRad2, secondIpAddress=secondIpAddress, nameServer1=nameServer1, siteName=siteName, interFrame=interFrame, snmpTrap=snmpTrap, afterSend=afterSend, reset=reset, portIndex=portIndex, snmpTrapAddr1=snmpTrapAddr1, rxIdle=rxIdle, modbusType=modbusType, portStatsEntry=portStatsEntry, portEntry=portEntry, radiusServer1=radiusServer1, statusDTR=statusDTR, txIdle=txIdle, nameServer2=nameServer2, portReset=portReset, slaveIPaddr=slaveIPaddr, acctRad2=acctRad2, nameResolution=nameResolution, version=version, modbusTable=modbusTable, productName=productName, dtrUp=dtrUp, bytesReceiveFromV24=bytesReceiveFromV24, ts=ts, modbusEntry=modbusEntry, endMsg=endMsg, ipNetmask=ipNetmask)
