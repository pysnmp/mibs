...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:23:06 2023
...
Bits, ModuleIdentity, enterprises, Gauge32, TimeTicks, Counter32, IpAddress, iso, NotificationType, Unsigned32, MibIdentifier, Integer32, NotificationType, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "enterprises", "Gauge32", "TimeTicks", "Counter32", "IpAddress", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", tcpPort=tcpPort, secondIpAddress=secondIpAddress, interFrame=interFrame, radiusSecret2=radiusSecret2, aliasIpAddress=aliasIpAddress, mode=mode, aliasIpNetmask=aliasIpNetmask, terminalType=terminalType, portStatsEntry=portStatsEntry, mainIpAddress=mainIpAddress, modbusEntry=modbusEntry, authRad1=authRad1, modbusTable=modbusTable, ethernetAddress=ethernetAddress, endMsg=endMsg, secondGateway=secondGateway, nameResolution=nameResolution, version=version, cxr=cxr, slaveHexaAddress=slaveHexaAddress, radiusServer2=radiusServer2, rxIdle=rxIdle, sessionStarted=sessionStarted, radiusSecret1=radiusSecret1, nameServer2=nameServer2, flowControl=flowControl, modbusType=modbusType, dtrDown=dtrDown, resetByButton=resetByButton, baudRate=baudRate, siteName=siteName, ipNetmask=ipNetmask, authType=authType, sessionStopped=sessionStopped, portEntry=portEntry, bootp=bootp, portTable=portTable, system=system, slaveIPport=slaveIPport, gatewayToRemote=gatewayToRemote, bytesReceiveFromV24=bytesReceiveFromV24, timeoutPAD=timeoutPAD, authRad2=authRad2, snmpTrapAddr2=snmpTrapAddr2, productName=productName, ftpdService=ftpdService, acctRad2=acctRad2, slaveIPaddr=slaveIPaddr, portReset=portReset, dtrUp=dtrUp, secondTcpPort=secondTcpPort, portIndex=portIndex, bytesSendToV24=bytesSendToV24, statusDTR=statusDTR, portStatsTable=portStatsTable, snmpdService=snmpdService, modbusMode=modbusMode, txIdle=txIdle, multiSession=multiSession, timeoutRxTx=timeoutRxTx, formFeed=formFeed, telnetdService=telnetdService, remoteTcpPort=remoteTcpPort, radiusServer1=radiusServer1, httpdService=httpdService, ipServer=ipServer, ts=ts, afterSend=afterSend, snmpTrap=snmpTrap, nbParStop=nbParStop, beforeSend=beforeSend, nameServer1=nameServer1, remoteIpAddress=remoteIpAddress, reset=reset, ipGateway=ipGateway, snmpTrapAddr1=snmpTrapAddr1, acctRad1=acctRad1)
