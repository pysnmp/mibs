...
# Produced by pysmi-1.1.12 at Mon Jul  1 10:52:27 2024
...
ObjectIdentity, ModuleIdentity, Unsigned32, MibIdentifier, IpAddress, iso, TimeTicks, Counter32, Gauge32, NotificationType, Integer32, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "iso", "TimeTicks", "Counter32", "Gauge32", "NotificationType", "Integer32", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStopped=sessionStopped, ipNetmask=ipNetmask, ftpdService=ftpdService, snmpTrapAddr2=snmpTrapAddr2, slaveHexaAddress=slaveHexaAddress, rxIdle=rxIdle, radiusServer2=radiusServer2, gatewayToRemote=gatewayToRemote, snmpdService=snmpdService, multiSession=multiSession, nameServer1=nameServer1, afterSend=afterSend, reset=reset, snmpTrapAddr1=snmpTrapAddr1, endMsg=endMsg, aliasIpNetmask=aliasIpNetmask, txIdle=txIdle, timeoutPAD=timeoutPAD, portEntry=portEntry, secondIpAddress=secondIpAddress, ethernetAddress=ethernetAddress, dtrUp=dtrUp, sessionStarted=sessionStarted, modbusEntry=modbusEntry, slaveIPaddr=slaveIPaddr, portStatsEntry=portStatsEntry, portReset=portReset, aliasIpAddress=aliasIpAddress, dtrDown=dtrDown, authRad1=authRad1, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, timeoutRxTx=timeoutRxTx, ts=ts, beforeSend=beforeSend, statusDTR=statusDTR, cxr=cxr, bytesSendToV24=bytesSendToV24, mode=mode, formFeed=formFeed, secondGateway=secondGateway, portIndex=portIndex, system=system, snmpTrap=snmpTrap, modbusTable=modbusTable, interFrame=interFrame, terminalType=terminalType, productName=productName, portTable=portTable, nameResolution=nameResolution, modbusMode=modbusMode, tcpPort=tcpPort, siteName=siteName, slaveIPport=slaveIPport, modbusType=modbusType, httpdService=httpdService, nbParStop=nbParStop, remoteTcpPort=remoteTcpPort, nameServer2=nameServer2, flowControl=flowControl, radiusSecret1=radiusSecret1, ipServer=ipServer, portStatsTable=portStatsTable, radiusSecret2=radiusSecret2, authType=authType, mainIpAddress=mainIpAddress, telnetdService=telnetdService, acctRad1=acctRad1, resetByButton=resetByButton, secondTcpPort=secondTcpPort, baudRate=baudRate, remoteIpAddress=remoteIpAddress, authRad2=authRad2, bootp=bootp, version=version, radiusServer1=radiusServer1, ipGateway=ipGateway)
