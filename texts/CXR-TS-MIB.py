...
IpAddress, iso, Counter32, ModuleIdentity, NotificationType, Integer32, Counter64, Bits, Gauge32, Unsigned32, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Counter32", "ModuleIdentity", "NotificationType", "Integer32", "Counter64", "Bits", "Gauge32", "Unsigned32", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("CXR-TS-MIB", version=version, flowControl=flowControl, ethernetAddress=ethernetAddress, terminalType=terminalType, radiusServer2=radiusServer2, snmpTrap=snmpTrap, authRad2=authRad2, modbusEntry=modbusEntry, remoteTcpPort=remoteTcpPort, txIdle=txIdle, timeoutRxTx=timeoutRxTx, authType=authType, radiusSecret2=radiusSecret2, snmpTrapAddr2=snmpTrapAddr2, baudRate=baudRate, slaveIPaddr=slaveIPaddr, ipServer=ipServer, secondIpAddress=secondIpAddress, radiusServer1=radiusServer1, nameServer1=nameServer1, afterSend=afterSend, portIndex=portIndex, dtrDown=dtrDown, acctRad1=acctRad1, system=system, bytesSendToV24=bytesSendToV24, ipNetmask=ipNetmask, radiusSecret1=radiusSecret1, modbusMode=modbusMode, rxIdle=rxIdle, secondGateway=secondGateway, slaveIPport=slaveIPport, portTable=portTable, tcpPort=tcpPort, snmpTrapAddr1=snmpTrapAddr1, portReset=portReset, siteName=siteName, multiSession=multiSession, portEntry=portEntry, timeoutPAD=timeoutPAD, sessionStarted=sessionStarted, bytesReceiveFromV24=bytesReceiveFromV24, gatewayToRemote=gatewayToRemote, ts=ts, portStatsEntry=portStatsEntry, beforeSend=beforeSend, cxr=cxr, authRad1=authRad1, telnetdService=telnetdService, nameResolution=nameResolution, mode=mode, portStatsTable=portStatsTable, dtrUp=dtrUp, sessionStopped=sessionStopped, bootp=bootp, formFeed=formFeed, mainIpAddress=mainIpAddress, statusDTR=statusDTR, aliasIpNetmask=aliasIpNetmask, nameServer2=nameServer2, modbusTable=modbusTable, nbParStop=nbParStop, modbusType=modbusType, interFrame=interFrame, remoteIpAddress=remoteIpAddress, endMsg=endMsg, resetByButton=resetByButton, aliasIpAddress=aliasIpAddress, snmpdService=snmpdService, secondTcpPort=secondTcpPort, ipGateway=ipGateway, slaveHexaAddress=slaveHexaAddress, acctRad2=acctRad2, httpdService=httpdService, ftpdService=ftpdService, reset=reset, productName=productName)
