...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:16:07 2024
...
enterprises, Integer32, ModuleIdentity, Gauge32, ObjectIdentity, Unsigned32, IpAddress, NotificationType, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, iso, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Unsigned32", "IpAddress", "NotificationType", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "iso", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusType=modbusType, remoteTcpPort=remoteTcpPort, terminalType=terminalType, tcpPort=tcpPort, portStatsTable=portStatsTable, radiusSecret1=radiusSecret1, remoteIpAddress=remoteIpAddress, timeoutRxTx=timeoutRxTx, aliasIpAddress=aliasIpAddress, portStatsEntry=portStatsEntry, mainIpAddress=mainIpAddress, ipGateway=ipGateway, authRad1=authRad1, acctRad2=acctRad2, bootp=bootp, snmpTrapAddr2=snmpTrapAddr2, acctRad1=acctRad1, flowControl=flowControl, authRad2=authRad2, portIndex=portIndex, ipServer=ipServer, nameServer2=nameServer2, portEntry=portEntry, version=version, httpdService=httpdService, aliasIpNetmask=aliasIpNetmask, portReset=portReset, slaveIPaddr=slaveIPaddr, mode=mode, nameServer1=nameServer1, nameResolution=nameResolution, resetByButton=resetByButton, timeoutPAD=timeoutPAD, radiusSecret2=radiusSecret2, radiusServer2=radiusServer2, afterSend=afterSend, formFeed=formFeed, productName=productName, ftpdService=ftpdService, slaveIPport=slaveIPport, reset=reset, siteName=siteName, telnetdService=telnetdService, txIdle=txIdle, ts=ts, modbusEntry=modbusEntry, multiSession=multiSession, sessionStopped=sessionStopped, secondTcpPort=secondTcpPort, secondIpAddress=secondIpAddress, sessionStarted=sessionStarted, endMsg=endMsg, bytesSendToV24=bytesSendToV24, cxr=cxr, system=system, slaveHexaAddress=slaveHexaAddress, snmpTrap=snmpTrap, nbParStop=nbParStop, ipNetmask=ipNetmask, secondGateway=secondGateway, interFrame=interFrame, modbusTable=modbusTable, ethernetAddress=ethernetAddress, dtrDown=dtrDown, snmpdService=snmpdService, statusDTR=statusDTR, beforeSend=beforeSend, rxIdle=rxIdle, portTable=portTable, dtrUp=dtrUp, snmpTrapAddr1=snmpTrapAddr1, baudRate=baudRate, radiusServer1=radiusServer1, bytesReceiveFromV24=bytesReceiveFromV24, gatewayToRemote=gatewayToRemote, modbusMode=modbusMode, authType=authType)
