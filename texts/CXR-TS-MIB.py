...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:39:27 2023
...
IpAddress, Unsigned32, NotificationType, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Counter32, iso, MibIdentifier, Integer32, Counter64, TimeTicks, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "NotificationType", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Counter32", "iso", "MibIdentifier", "Integer32", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrapAddr2=snmpTrapAddr2, aliasIpNetmask=aliasIpNetmask, snmpTrapAddr1=snmpTrapAddr1, timeoutRxTx=timeoutRxTx, acctRad2=acctRad2, radiusServer2=radiusServer2, formFeed=formFeed, snmpTrap=snmpTrap, terminalType=terminalType, ethernetAddress=ethernetAddress, dtrUp=dtrUp, rxIdle=rxIdle, authRad1=authRad1, ipNetmask=ipNetmask, ts=ts, snmpdService=snmpdService, timeoutPAD=timeoutPAD, portIndex=portIndex, ipServer=ipServer, nameResolution=nameResolution, radiusSecret2=radiusSecret2, portStatsTable=portStatsTable, gatewayToRemote=gatewayToRemote, modbusEntry=modbusEntry, endMsg=endMsg, authType=authType, modbusType=modbusType, beforeSend=beforeSend, productName=productName, reset=reset, resetByButton=resetByButton, dtrDown=dtrDown, bootp=bootp, httpdService=httpdService, modbusMode=modbusMode, secondGateway=secondGateway, tcpPort=tcpPort, flowControl=flowControl, afterSend=afterSend, radiusSecret1=radiusSecret1, txIdle=txIdle, ftpdService=ftpdService, aliasIpAddress=aliasIpAddress, sessionStarted=sessionStarted, mainIpAddress=mainIpAddress, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, remoteIpAddress=remoteIpAddress, authRad2=authRad2, acctRad1=acctRad1, secondTcpPort=secondTcpPort, portStatsEntry=portStatsEntry, interFrame=interFrame, multiSession=multiSession, modbusTable=modbusTable, secondIpAddress=secondIpAddress, version=version, statusDTR=statusDTR, nbParStop=nbParStop, siteName=siteName, radiusServer1=radiusServer1, slaveIPaddr=slaveIPaddr, slaveIPport=slaveIPport, bytesSendToV24=bytesSendToV24, baudRate=baudRate, portReset=portReset, remoteTcpPort=remoteTcpPort, portTable=portTable, portEntry=portEntry, system=system, bytesReceiveFromV24=bytesReceiveFromV24, cxr=cxr, nameServer1=nameServer1, mode=mode, ipGateway=ipGateway, sessionStopped=sessionStopped, telnetdService=telnetdService)
