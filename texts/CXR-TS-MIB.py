...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:12:07 2024
...
Integer32, Counter64, MibIdentifier, NotificationType, Unsigned32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Bits, Counter32, TimeTicks, ObjectIdentity, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "Unsigned32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Bits", "Counter32", "TimeTicks", "ObjectIdentity", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portIndex=portIndex, authRad2=authRad2, portStatsEntry=portStatsEntry, ipNetmask=ipNetmask, remoteTcpPort=remoteTcpPort, resetByButton=resetByButton, nameResolution=nameResolution, mainIpAddress=mainIpAddress, remoteIpAddress=remoteIpAddress, slaveIPport=slaveIPport, sessionStopped=sessionStopped, secondIpAddress=secondIpAddress, system=system, statusDTR=statusDTR, sessionStarted=sessionStarted, baudRate=baudRate, dtrDown=dtrDown, multiSession=multiSession, formFeed=formFeed, flowControl=flowControl, siteName=siteName, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, portTable=portTable, radiusServer2=radiusServer2, nameServer1=nameServer1, nbParStop=nbParStop, endMsg=endMsg, ftpdService=ftpdService, radiusSecret2=radiusSecret2, ipServer=ipServer, tcpPort=tcpPort, dtrUp=dtrUp, radiusServer1=radiusServer1, acctRad2=acctRad2, radiusSecret1=radiusSecret1, ethernetAddress=ethernetAddress, productName=productName, portEntry=portEntry, snmpTrapAddr1=snmpTrapAddr1, timeoutPAD=timeoutPAD, nameServer2=nameServer2, snmpdService=snmpdService, txIdle=txIdle, timeoutRxTx=timeoutRxTx, aliasIpAddress=aliasIpAddress, bootp=bootp, slaveIPaddr=slaveIPaddr, snmpTrap=snmpTrap, ts=ts, secondGateway=secondGateway, acctRad1=acctRad1, ipGateway=ipGateway, secondTcpPort=secondTcpPort, version=version, bytesReceiveFromV24=bytesReceiveFromV24, modbusTable=modbusTable, modbusEntry=modbusEntry, rxIdle=rxIdle, slaveHexaAddress=slaveHexaAddress, authRad1=authRad1, mode=mode, gatewayToRemote=gatewayToRemote, telnetdService=telnetdService, cxr=cxr, reset=reset, portStatsTable=portStatsTable, afterSend=afterSend, authType=authType, modbusMode=modbusMode, modbusType=modbusType, bytesSendToV24=bytesSendToV24, terminalType=terminalType, httpdService=httpdService, portReset=portReset, interFrame=interFrame, snmpTrapAddr2=snmpTrapAddr2)
