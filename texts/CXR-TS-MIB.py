...
Unsigned32, TimeTicks, Bits, NotificationType, ModuleIdentity, Integer32, Counter64, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, enterprises, NotificationType, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Bits", "NotificationType", "ModuleIdentity", "Integer32", "Counter64", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "enterprises", "NotificationType", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusSecret1=radiusSecret1, modbusTable=modbusTable, bytesSendToV24=bytesSendToV24, aliasIpNetmask=aliasIpNetmask, remoteTcpPort=remoteTcpPort, statusDTR=statusDTR, secondGateway=secondGateway, cxr=cxr, timeoutPAD=timeoutPAD, modbusMode=modbusMode, mainIpAddress=mainIpAddress, sessionStarted=sessionStarted, multiSession=multiSession, httpdService=httpdService, ipNetmask=ipNetmask, radiusSecret2=radiusSecret2, nbParStop=nbParStop, siteName=siteName, flowControl=flowControl, terminalType=terminalType, authRad2=authRad2, ftpdService=ftpdService, aliasIpAddress=aliasIpAddress, tcpPort=tcpPort, slaveIPport=slaveIPport, ethernetAddress=ethernetAddress, snmpTrapAddr1=snmpTrapAddr1, acctRad2=acctRad2, snmpTrap=snmpTrap, reset=reset, bootp=bootp, resetByButton=resetByButton, portTable=portTable, portEntry=portEntry, timeoutRxTx=timeoutRxTx, nameResolution=nameResolution, portReset=portReset, nameServer2=nameServer2, txIdle=txIdle, endMsg=endMsg, afterSend=afterSend, beforeSend=beforeSend, version=version, portIndex=portIndex, modbusType=modbusType, sessionStopped=sessionStopped, rxIdle=rxIdle, portStatsEntry=portStatsEntry, authType=authType, snmpdService=snmpdService, acctRad1=acctRad1, formFeed=formFeed, remoteIpAddress=remoteIpAddress, telnetdService=telnetdService, baudRate=baudRate, ipServer=ipServer, system=system, mode=mode, authRad1=authRad1, interFrame=interFrame, secondTcpPort=secondTcpPort, productName=productName, gatewayToRemote=gatewayToRemote, portStatsTable=portStatsTable, ts=ts, dtrDown=dtrDown, secondIpAddress=secondIpAddress, slaveIPaddr=slaveIPaddr, slaveHexaAddress=slaveHexaAddress, modbusEntry=modbusEntry, radiusServer1=radiusServer1, dtrUp=dtrUp, ipGateway=ipGateway, radiusServer2=radiusServer2, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr2=snmpTrapAddr2, nameServer1=nameServer1)
