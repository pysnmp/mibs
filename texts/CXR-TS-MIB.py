...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:21:34 2022
...
ObjectIdentity, enterprises, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, NotificationType, Integer32, Counter32, Counter64, NotificationType, Unsigned32, Bits, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "NotificationType", "Integer32", "Counter32", "Counter64", "NotificationType", "Unsigned32", "Bits", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer1=radiusServer1, snmpTrapAddr1=snmpTrapAddr1, acctRad1=acctRad1, authRad2=authRad2, aliasIpNetmask=aliasIpNetmask, tcpPort=tcpPort, txIdle=txIdle, portIndex=portIndex, telnetdService=telnetdService, dtrDown=dtrDown, version=version, multiSession=multiSession, ipNetmask=ipNetmask, slaveIPaddr=slaveIPaddr, httpdService=httpdService, modbusType=modbusType, snmpTrapAddr2=snmpTrapAddr2, secondGateway=secondGateway, acctRad2=acctRad2, formFeed=formFeed, portReset=portReset, authType=authType, cxr=cxr, beforeSend=beforeSend, sessionStarted=sessionStarted, bootp=bootp, radiusSecret1=radiusSecret1, reset=reset, nameServer2=nameServer2, afterSend=afterSend, portStatsTable=portStatsTable, system=system, dtrUp=dtrUp, nameServer1=nameServer1, modbusEntry=modbusEntry, ipServer=ipServer, ftpdService=ftpdService, bytesSendToV24=bytesSendToV24, aliasIpAddress=aliasIpAddress, baudRate=baudRate, portStatsEntry=portStatsEntry, remoteTcpPort=remoteTcpPort, ipGateway=ipGateway, mainIpAddress=mainIpAddress, ts=ts, flowControl=flowControl, productName=productName, sessionStopped=sessionStopped, snmpTrap=snmpTrap, siteName=siteName, portTable=portTable, timeoutPAD=timeoutPAD, authRad1=authRad1, modbusMode=modbusMode, radiusSecret2=radiusSecret2, ethernetAddress=ethernetAddress, radiusServer2=radiusServer2, bytesReceiveFromV24=bytesReceiveFromV24, slaveHexaAddress=slaveHexaAddress, portEntry=portEntry, secondIpAddress=secondIpAddress, slaveIPport=slaveIPport, nameResolution=nameResolution, nbParStop=nbParStop, resetByButton=resetByButton, statusDTR=statusDTR, gatewayToRemote=gatewayToRemote, snmpdService=snmpdService, remoteIpAddress=remoteIpAddress, terminalType=terminalType, rxIdle=rxIdle, interFrame=interFrame, secondTcpPort=secondTcpPort, endMsg=endMsg, modbusTable=modbusTable, mode=mode, timeoutRxTx=timeoutRxTx)
