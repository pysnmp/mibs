...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:31:57 2023
...
Bits, IpAddress, NotificationType, Integer32, ModuleIdentity, enterprises, Counter32, Unsigned32, Gauge32, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "NotificationType", "Integer32", "ModuleIdentity", "enterprises", "Counter32", "Unsigned32", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portReset=portReset, bytesSendToV24=bytesSendToV24, modbusType=modbusType, beforeSend=beforeSend, secondTcpPort=secondTcpPort, secondGateway=secondGateway, acctRad2=acctRad2, portTable=portTable, modbusEntry=modbusEntry, ethernetAddress=ethernetAddress, authRad2=authRad2, sessionStarted=sessionStarted, nbParStop=nbParStop, aliasIpNetmask=aliasIpNetmask, slaveIPaddr=slaveIPaddr, txIdle=txIdle, remoteIpAddress=remoteIpAddress, mode=mode, nameServer2=nameServer2, radiusServer1=radiusServer1, radiusSecret2=radiusSecret2, ipNetmask=ipNetmask, version=version, remoteTcpPort=remoteTcpPort, ts=ts, siteName=siteName, cxr=cxr, portEntry=portEntry, timeoutRxTx=timeoutRxTx, dtrUp=dtrUp, ipGateway=ipGateway, portStatsEntry=portStatsEntry, radiusSecret1=radiusSecret1, rxIdle=rxIdle, productName=productName, slaveHexaAddress=slaveHexaAddress, terminalType=terminalType, acctRad1=acctRad1, radiusServer2=radiusServer2, ftpdService=ftpdService, bytesReceiveFromV24=bytesReceiveFromV24, interFrame=interFrame, modbusTable=modbusTable, formFeed=formFeed, telnetdService=telnetdService, multiSession=multiSession, aliasIpAddress=aliasIpAddress, snmpTrap=snmpTrap, resetByButton=resetByButton, sessionStopped=sessionStopped, endMsg=endMsg, statusDTR=statusDTR, bootp=bootp, mainIpAddress=mainIpAddress, slaveIPport=slaveIPport, httpdService=httpdService, snmpdService=snmpdService, snmpTrapAddr1=snmpTrapAddr1, ipServer=ipServer, snmpTrapAddr2=snmpTrapAddr2, gatewayToRemote=gatewayToRemote, dtrDown=dtrDown, modbusMode=modbusMode, portStatsTable=portStatsTable, timeoutPAD=timeoutPAD, tcpPort=tcpPort, nameServer1=nameServer1, afterSend=afterSend, authType=authType, authRad1=authRad1, portIndex=portIndex, nameResolution=nameResolution, secondIpAddress=secondIpAddress, flowControl=flowControl, system=system, reset=reset, baudRate=baudRate)
