...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:05:52 2023
...
IpAddress, ObjectIdentity, NotificationType, Counter32, Counter64, MibIdentifier, ModuleIdentity, enterprises, iso, Bits, TimeTicks, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "NotificationType", "Counter32", "Counter64", "MibIdentifier", "ModuleIdentity", "enterprises", "iso", "Bits", "TimeTicks", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, productName=productName, timeoutPAD=timeoutPAD, beforeSend=beforeSend, gatewayToRemote=gatewayToRemote, secondIpAddress=secondIpAddress, telnetdService=telnetdService, bytesSendToV24=bytesSendToV24, nameResolution=nameResolution, baudRate=baudRate, snmpTrapAddr2=snmpTrapAddr2, radiusSecret2=radiusSecret2, slaveIPaddr=slaveIPaddr, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret1=radiusSecret1, acctRad1=acctRad1, secondTcpPort=secondTcpPort, formFeed=formFeed, version=version, cxr=cxr, nbParStop=nbParStop, secondGateway=secondGateway, portReset=portReset, endMsg=endMsg, ethernetAddress=ethernetAddress, slaveIPport=slaveIPport, system=system, aliasIpAddress=aliasIpAddress, ipServer=ipServer, ts=ts, dtrUp=dtrUp, flowControl=flowControl, rxIdle=rxIdle, timeoutRxTx=timeoutRxTx, siteName=siteName, multiSession=multiSession, terminalType=terminalType, ipGateway=ipGateway, authRad2=authRad2, snmpTrapAddr1=snmpTrapAddr1, portIndex=portIndex, modbusMode=modbusMode, txIdle=txIdle, radiusServer1=radiusServer1, mode=mode, modbusType=modbusType, portTable=portTable, portStatsTable=portStatsTable, modbusTable=modbusTable, remoteIpAddress=remoteIpAddress, modbusEntry=modbusEntry, authRad1=authRad1, ipNetmask=ipNetmask, bootp=bootp, acctRad2=acctRad2, statusDTR=statusDTR, afterSend=afterSend, dtrDown=dtrDown, mainIpAddress=mainIpAddress, authType=authType, tcpPort=tcpPort, snmpdService=snmpdService, resetByButton=resetByButton, sessionStarted=sessionStarted, httpdService=httpdService, portStatsEntry=portStatsEntry, aliasIpNetmask=aliasIpNetmask, nameServer2=nameServer2, interFrame=interFrame, portEntry=portEntry, slaveHexaAddress=slaveHexaAddress, remoteTcpPort=remoteTcpPort, sessionStopped=sessionStopped, ftpdService=ftpdService, reset=reset, radiusServer2=radiusServer2, snmpTrap=snmpTrap)
