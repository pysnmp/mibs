...
# Produced by pysmi-1.1.10 at Thu Apr  4 03:04:54 2024
...
iso, IpAddress, Bits, NotificationType, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, TimeTicks, enterprises, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Bits", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "TimeTicks", "enterprises", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nbParStop=nbParStop, slaveIPport=slaveIPport, portEntry=portEntry, acctRad2=acctRad2, telnetdService=telnetdService, formFeed=formFeed, rxIdle=rxIdle, system=system, interFrame=interFrame, aliasIpAddress=aliasIpAddress, multiSession=multiSession, version=version, timeoutPAD=timeoutPAD, slaveHexaAddress=slaveHexaAddress, remoteTcpPort=remoteTcpPort, snmpTrapAddr1=snmpTrapAddr1, tcpPort=tcpPort, nameServer2=nameServer2, terminalType=terminalType, productName=productName, ipGateway=ipGateway, nameResolution=nameResolution, modbusType=modbusType, bootp=bootp, mainIpAddress=mainIpAddress, beforeSend=beforeSend, bytesReceiveFromV24=bytesReceiveFromV24, bytesSendToV24=bytesSendToV24, dtrUp=dtrUp, authRad2=authRad2, cxr=cxr, radiusSecret2=radiusSecret2, modbusEntry=modbusEntry, afterSend=afterSend, portStatsTable=portStatsTable, resetByButton=resetByButton, baudRate=baudRate, ipServer=ipServer, statusDTR=statusDTR, aliasIpNetmask=aliasIpNetmask, ethernetAddress=ethernetAddress, portStatsEntry=portStatsEntry, sessionStarted=sessionStarted, snmpTrap=snmpTrap, authType=authType, nameServer1=nameServer1, httpdService=httpdService, endMsg=endMsg, radiusServer1=radiusServer1, slaveIPaddr=slaveIPaddr, modbusMode=modbusMode, authRad1=authRad1, secondGateway=secondGateway, gatewayToRemote=gatewayToRemote, remoteIpAddress=remoteIpAddress, ftpdService=ftpdService, modbusTable=modbusTable, radiusServer2=radiusServer2, portTable=portTable, flowControl=flowControl, secondIpAddress=secondIpAddress, secondTcpPort=secondTcpPort, timeoutRxTx=timeoutRxTx, ts=ts, sessionStopped=sessionStopped, txIdle=txIdle, siteName=siteName, snmpdService=snmpdService, radiusSecret1=radiusSecret1, portReset=portReset, reset=reset, ipNetmask=ipNetmask, dtrDown=dtrDown, portIndex=portIndex, snmpTrapAddr2=snmpTrapAddr2, acctRad1=acctRad1, mode=mode)
