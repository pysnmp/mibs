...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:16:31 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, Integer32, Counter32, IpAddress, Gauge32, ObjectIdentity, NotificationType, TimeTicks, Counter64, ModuleIdentity, Bits, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "IpAddress", "Gauge32", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter64", "ModuleIdentity", "Bits", "enterprises", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", flowControl=flowControl, ipNetmask=ipNetmask, modbusType=modbusType, nameServer2=nameServer2, telnetdService=telnetdService, modbusTable=modbusTable, timeoutRxTx=timeoutRxTx, slaveIPaddr=slaveIPaddr, modbusEntry=modbusEntry, mainIpAddress=mainIpAddress, acctRad1=acctRad1, aliasIpNetmask=aliasIpNetmask, slaveHexaAddress=slaveHexaAddress, portTable=portTable, nameServer1=nameServer1, baudRate=baudRate, endMsg=endMsg, version=version, secondGateway=secondGateway, rxIdle=rxIdle, dtrUp=dtrUp, multiSession=multiSession, ts=ts, secondIpAddress=secondIpAddress, bytesSendToV24=bytesSendToV24, bootp=bootp, ipServer=ipServer, portIndex=portIndex, formFeed=formFeed, portStatsTable=portStatsTable, nameResolution=nameResolution, radiusSecret1=radiusSecret1, httpdService=httpdService, acctRad2=acctRad2, reset=reset, nbParStop=nbParStop, modbusMode=modbusMode, snmpdService=snmpdService, system=system, radiusServer2=radiusServer2, txIdle=txIdle, snmpTrapAddr1=snmpTrapAddr1, siteName=siteName, mode=mode, interFrame=interFrame, remoteIpAddress=remoteIpAddress, remoteTcpPort=remoteTcpPort, radiusServer1=radiusServer1, radiusSecret2=radiusSecret2, authType=authType, timeoutPAD=timeoutPAD, secondTcpPort=secondTcpPort, slaveIPport=slaveIPport, ethernetAddress=ethernetAddress, snmpTrapAddr2=snmpTrapAddr2, gatewayToRemote=gatewayToRemote, ftpdService=ftpdService, portEntry=portEntry, portStatsEntry=portStatsEntry, aliasIpAddress=aliasIpAddress, authRad2=authRad2, resetByButton=resetByButton, authRad1=authRad1, productName=productName, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrap=snmpTrap, afterSend=afterSend, sessionStopped=sessionStopped, terminalType=terminalType, cxr=cxr, portReset=portReset, tcpPort=tcpPort, dtrDown=dtrDown, sessionStarted=sessionStarted, ipGateway=ipGateway, beforeSend=beforeSend, statusDTR=statusDTR)
