...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:03:18 2022
...
ModuleIdentity, Counter32, ObjectIdentity, enterprises, Integer32, iso, NotificationType, TimeTicks, Gauge32, IpAddress, Unsigned32, Counter64, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "ObjectIdentity", "enterprises", "Integer32", "iso", "NotificationType", "TimeTicks", "Gauge32", "IpAddress", "Unsigned32", "Counter64", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", nameServer1=nameServer1, authRad2=authRad2, secondTcpPort=secondTcpPort, siteName=siteName, aliasIpAddress=aliasIpAddress, ethernetAddress=ethernetAddress, dtrDown=dtrDown, afterSend=afterSend, formFeed=formFeed, aliasIpNetmask=aliasIpNetmask, portIndex=portIndex, remoteTcpPort=remoteTcpPort, portStatsEntry=portStatsEntry, portEntry=portEntry, bytesReceiveFromV24=bytesReceiveFromV24, tcpPort=tcpPort, flowControl=flowControl, ipGateway=ipGateway, portTable=portTable, nbParStop=nbParStop, productName=productName, secondGateway=secondGateway, modbusType=modbusType, httpdService=httpdService, ts=ts, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, version=version, slaveHexaAddress=slaveHexaAddress, terminalType=terminalType, secondIpAddress=secondIpAddress, system=system, statusDTR=statusDTR, snmpTrap=snmpTrap, sessionStopped=sessionStopped, nameServer2=nameServer2, radiusSecret2=radiusSecret2, acctRad2=acctRad2, slaveIPport=slaveIPport, modbusEntry=modbusEntry, cxr=cxr, authType=authType, snmpTrapAddr1=snmpTrapAddr1, reset=reset, radiusServer2=radiusServer2, authRad1=authRad1, snmpTrapAddr2=snmpTrapAddr2, bootp=bootp, sessionStarted=sessionStarted, resetByButton=resetByButton, txIdle=txIdle, timeoutRxTx=timeoutRxTx, gatewayToRemote=gatewayToRemote, endMsg=endMsg, multiSession=multiSession, snmpdService=snmpdService, nameResolution=nameResolution, rxIdle=rxIdle, portStatsTable=portStatsTable, baudRate=baudRate, beforeSend=beforeSend, mode=mode, ipServer=ipServer, acctRad1=acctRad1, ftpdService=ftpdService, slaveIPaddr=slaveIPaddr, remoteIpAddress=remoteIpAddress, interFrame=interFrame, bytesSendToV24=bytesSendToV24, telnetdService=telnetdService, radiusServer1=radiusServer1, modbusTable=modbusTable, ipNetmask=ipNetmask, portReset=portReset, dtrUp=dtrUp, radiusSecret1=radiusSecret1, modbusMode=modbusMode)
