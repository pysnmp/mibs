...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:54:21 2023
...
MibIdentifier, Bits, Gauge32, ObjectIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Counter32, Counter64, IpAddress, ModuleIdentity, iso, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Counter32", "Counter64", "IpAddress", "ModuleIdentity", "iso", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrap=snmpTrap, bytesReceiveFromV24=bytesReceiveFromV24, dtrUp=dtrUp, ipGateway=ipGateway, siteName=siteName, portTable=portTable, secondTcpPort=secondTcpPort, nameServer1=nameServer1, remoteTcpPort=remoteTcpPort, ipNetmask=ipNetmask, modbusTable=modbusTable, resetByButton=resetByButton, radiusSecret1=radiusSecret1, slaveIPport=slaveIPport, secondGateway=secondGateway, mainIpAddress=mainIpAddress, radiusServer1=radiusServer1, ftpdService=ftpdService, modbusType=modbusType, nbParStop=nbParStop, statusDTR=statusDTR, aliasIpNetmask=aliasIpNetmask, beforeSend=beforeSend, sessionStopped=sessionStopped, rxIdle=rxIdle, authType=authType, radiusServer2=radiusServer2, ipServer=ipServer, authRad2=authRad2, portStatsEntry=portStatsEntry, snmpdService=snmpdService, endMsg=endMsg, sessionStarted=sessionStarted, dtrDown=dtrDown, reset=reset, authRad1=authRad1, afterSend=afterSend, bytesSendToV24=bytesSendToV24, bootp=bootp, interFrame=interFrame, portStatsTable=portStatsTable, modbusMode=modbusMode, multiSession=multiSession, ts=ts, snmpTrapAddr1=snmpTrapAddr1, timeoutRxTx=timeoutRxTx, baudRate=baudRate, mode=mode, ethernetAddress=ethernetAddress, portReset=portReset, version=version, gatewayToRemote=gatewayToRemote, timeoutPAD=timeoutPAD, snmpTrapAddr2=snmpTrapAddr2, remoteIpAddress=remoteIpAddress, tcpPort=tcpPort, httpdService=httpdService, system=system, acctRad1=acctRad1, nameResolution=nameResolution, cxr=cxr, formFeed=formFeed, slaveIPaddr=slaveIPaddr, modbusEntry=modbusEntry, acctRad2=acctRad2, nameServer2=nameServer2, telnetdService=telnetdService, productName=productName, radiusSecret2=radiusSecret2, flowControl=flowControl, secondIpAddress=secondIpAddress, txIdle=txIdle, portIndex=portIndex, portEntry=portEntry, slaveHexaAddress=slaveHexaAddress, aliasIpAddress=aliasIpAddress, terminalType=terminalType)
