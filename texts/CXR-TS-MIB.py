...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:15:27 2022
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Counter32, NotificationType, ObjectIdentity, MibIdentifier, ModuleIdentity, Gauge32, IpAddress, Counter64, Unsigned32, TimeTicks, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Counter32", "NotificationType", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Gauge32", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "iso", "Integer32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", system=system, acctRad2=acctRad2, statusDTR=statusDTR, flowControl=flowControl, formFeed=formFeed, snmpTrap=snmpTrap, nameResolution=nameResolution, modbusEntry=modbusEntry, modbusTable=modbusTable, version=version, siteName=siteName, ipNetmask=ipNetmask, timeoutPAD=timeoutPAD, terminalType=terminalType, bytesSendToV24=bytesSendToV24, acctRad1=acctRad1, radiusSecret2=radiusSecret2, tcpPort=tcpPort, ftpdService=ftpdService, ipServer=ipServer, slaveHexaAddress=slaveHexaAddress, rxIdle=rxIdle, telnetdService=telnetdService, portStatsEntry=portStatsEntry, portTable=portTable, httpdService=httpdService, interFrame=interFrame, remoteIpAddress=remoteIpAddress, dtrDown=dtrDown, productName=productName, dtrUp=dtrUp, ipGateway=ipGateway, secondIpAddress=secondIpAddress, afterSend=afterSend, radiusSecret1=radiusSecret1, remoteTcpPort=remoteTcpPort, timeoutRxTx=timeoutRxTx, ts=ts, endMsg=endMsg, aliasIpNetmask=aliasIpNetmask, reset=reset, portReset=portReset, nameServer2=nameServer2, aliasIpAddress=aliasIpAddress, snmpTrapAddr2=snmpTrapAddr2, slaveIPaddr=slaveIPaddr, portEntry=portEntry, radiusServer1=radiusServer1, mode=mode, beforeSend=beforeSend, radiusServer2=radiusServer2, baudRate=baudRate, ethernetAddress=ethernetAddress, sessionStopped=sessionStopped, portStatsTable=portStatsTable, multiSession=multiSession, portIndex=portIndex, snmpdService=snmpdService, nbParStop=nbParStop, nameServer1=nameServer1, secondTcpPort=secondTcpPort, modbusMode=modbusMode, sessionStarted=sessionStarted, mainIpAddress=mainIpAddress, secondGateway=secondGateway, bytesReceiveFromV24=bytesReceiveFromV24, authType=authType, authRad2=authRad2, bootp=bootp, resetByButton=resetByButton, slaveIPport=slaveIPport, authRad1=authRad1, modbusType=modbusType, txIdle=txIdle, gatewayToRemote=gatewayToRemote, snmpTrapAddr1=snmpTrapAddr1, cxr=cxr)
