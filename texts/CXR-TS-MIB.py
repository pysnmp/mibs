...
# Produced by pysmi-1.1.10 at Fri Oct 27 06:59:41 2023
...
NotificationType, ObjectIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Gauge32, MibIdentifier, Integer32, ModuleIdentity, TimeTicks, Counter64, enterprises, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks", "Counter64", "enterprises", "iso", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", terminalType=terminalType, ts=ts, gatewayToRemote=gatewayToRemote, beforeSend=beforeSend, rxIdle=rxIdle, mainIpAddress=mainIpAddress, aliasIpAddress=aliasIpAddress, ipGateway=ipGateway, authRad1=authRad1, ftpdService=ftpdService, radiusServer2=radiusServer2, endMsg=endMsg, telnetdService=telnetdService, remoteIpAddress=remoteIpAddress, bytesSendToV24=bytesSendToV24, snmpdService=snmpdService, portStatsTable=portStatsTable, nameServer2=nameServer2, bootp=bootp, tcpPort=tcpPort, portStatsEntry=portStatsEntry, system=system, modbusType=modbusType, slaveHexaAddress=slaveHexaAddress, reset=reset, cxr=cxr, secondTcpPort=secondTcpPort, acctRad1=acctRad1, txIdle=txIdle, secondIpAddress=secondIpAddress, snmpTrapAddr1=snmpTrapAddr1, dtrUp=dtrUp, aliasIpNetmask=aliasIpNetmask, slaveIPport=slaveIPport, portEntry=portEntry, portReset=portReset, siteName=siteName, interFrame=interFrame, modbusEntry=modbusEntry, radiusSecret2=radiusSecret2, multiSession=multiSession, portTable=portTable, nameServer1=nameServer1, resetByButton=resetByButton, flowControl=flowControl, sessionStopped=sessionStopped, formFeed=formFeed, radiusSecret1=radiusSecret1, ipServer=ipServer, productName=productName, timeoutRxTx=timeoutRxTx, version=version, snmpTrapAddr2=snmpTrapAddr2, modbusTable=modbusTable, mode=mode, sessionStarted=sessionStarted, ethernetAddress=ethernetAddress, radiusServer1=radiusServer1, slaveIPaddr=slaveIPaddr, remoteTcpPort=remoteTcpPort, bytesReceiveFromV24=bytesReceiveFromV24, baudRate=baudRate, secondGateway=secondGateway, afterSend=afterSend, dtrDown=dtrDown, nbParStop=nbParStop, portIndex=portIndex, authRad2=authRad2, snmpTrap=snmpTrap, httpdService=httpdService, statusDTR=statusDTR, ipNetmask=ipNetmask, authType=authType, modbusMode=modbusMode, nameResolution=nameResolution, acctRad2=acctRad2, timeoutPAD=timeoutPAD)
