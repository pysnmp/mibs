...
# Produced by pysmi-1.1.12 at Sat Jul  6 01:06:48 2024
...
TimeTicks, enterprises, NotificationType, iso, Integer32, Bits, MibIdentifier, NotificationType, Unsigned32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "NotificationType", "iso", "Integer32", "Bits", "MibIdentifier", "NotificationType", "Unsigned32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipNetmask=ipNetmask, tcpPort=tcpPort, aliasIpAddress=aliasIpAddress, timeoutRxTx=timeoutRxTx, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, afterSend=afterSend, modbusType=modbusType, version=version, secondTcpPort=secondTcpPort, nameServer2=nameServer2, snmpdService=snmpdService, modbusMode=modbusMode, terminalType=terminalType, radiusServer2=radiusServer2, modbusEntry=modbusEntry, portTable=portTable, nameServer1=nameServer1, portIndex=portIndex, remoteTcpPort=remoteTcpPort, httpdService=httpdService, dtrUp=dtrUp, portReset=portReset, ftpdService=ftpdService, formFeed=formFeed, portEntry=portEntry, beforeSend=beforeSend, slaveIPport=slaveIPport, authType=authType, bytesSendToV24=bytesSendToV24, ts=ts, gatewayToRemote=gatewayToRemote, multiSession=multiSession, sessionStarted=sessionStarted, bytesReceiveFromV24=bytesReceiveFromV24, radiusServer1=radiusServer1, dtrDown=dtrDown, telnetdService=telnetdService, rxIdle=rxIdle, timeoutPAD=timeoutPAD, mainIpAddress=mainIpAddress, nameResolution=nameResolution, ipServer=ipServer, acctRad2=acctRad2, cxr=cxr, nbParStop=nbParStop, authRad2=authRad2, acctRad1=acctRad1, baudRate=baudRate, authRad1=authRad1, reset=reset, portStatsEntry=portStatsEntry, siteName=siteName, resetByButton=resetByButton, secondGateway=secondGateway, snmpTrapAddr2=snmpTrapAddr2, flowControl=flowControl, aliasIpNetmask=aliasIpNetmask, snmpTrap=snmpTrap, portStatsTable=portStatsTable, endMsg=endMsg, ipGateway=ipGateway, bootp=bootp, system=system, radiusSecret1=radiusSecret1, slaveIPaddr=slaveIPaddr, txIdle=txIdle, ethernetAddress=ethernetAddress, sessionStopped=sessionStopped, productName=productName, secondIpAddress=secondIpAddress, modbusTable=modbusTable, radiusSecret2=radiusSecret2, mode=mode, interFrame=interFrame, remoteIpAddress=remoteIpAddress, slaveHexaAddress=slaveHexaAddress)
