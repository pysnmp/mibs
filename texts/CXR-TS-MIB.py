...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:30:44 2023
...
Unsigned32, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, ModuleIdentity, Counter32, IpAddress, MibIdentifier, enterprises, TimeTicks, Integer32, Counter64, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "MibIdentifier", "enterprises", "TimeTicks", "Integer32", "Counter64", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", tcpPort=tcpPort, statusDTR=statusDTR, portTable=portTable, txIdle=txIdle, formFeed=formFeed, ipGateway=ipGateway, slaveHexaAddress=slaveHexaAddress, gatewayToRemote=gatewayToRemote, mainIpAddress=mainIpAddress, portIndex=portIndex, snmpdService=snmpdService, timeoutPAD=timeoutPAD, nbParStop=nbParStop, beforeSend=beforeSend, portEntry=portEntry, bytesReceiveFromV24=bytesReceiveFromV24, ipNetmask=ipNetmask, secondTcpPort=secondTcpPort, modbusType=modbusType, bytesSendToV24=bytesSendToV24, portReset=portReset, multiSession=multiSession, modbusEntry=modbusEntry, radiusSecret1=radiusSecret1, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1, version=version, remoteIpAddress=remoteIpAddress, mode=mode, snmpTrapAddr2=snmpTrapAddr2, reset=reset, baudRate=baudRate, snmpTrap=snmpTrap, siteName=siteName, secondGateway=secondGateway, system=system, dtrUp=dtrUp, nameServer2=nameServer2, authRad1=authRad1, radiusServer2=radiusServer2, sessionStopped=sessionStopped, aliasIpNetmask=aliasIpNetmask, bootp=bootp, endMsg=endMsg, ts=ts, authRad2=authRad2, acctRad1=acctRad1, rxIdle=rxIdle, authType=authType, radiusSecret2=radiusSecret2, modbusTable=modbusTable, cxr=cxr, ethernetAddress=ethernetAddress, httpdService=httpdService, resetByButton=resetByButton, nameResolution=nameResolution, interFrame=interFrame, terminalType=terminalType, portStatsTable=portStatsTable, slaveIPport=slaveIPport, dtrDown=dtrDown, portStatsEntry=portStatsEntry, ftpdService=ftpdService, timeoutRxTx=timeoutRxTx, sessionStarted=sessionStarted, snmpTrapAddr1=snmpTrapAddr1, aliasIpAddress=aliasIpAddress, remoteTcpPort=remoteTcpPort, modbusMode=modbusMode, acctRad2=acctRad2, nameServer1=nameServer1, productName=productName, secondIpAddress=secondIpAddress, afterSend=afterSend, flowControl=flowControl, ipServer=ipServer, telnetdService=telnetdService)
