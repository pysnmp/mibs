...
# Produced by pysmi-1.1.8 at Mon Sep 19 07:24:09 2022
...
Integer32, NotificationType, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, TimeTicks, Counter64, iso, enterprises, Bits, ObjectIdentity, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "TimeTicks", "Counter64", "iso", "enterprises", "Bits", "ObjectIdentity", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", aliasIpAddress=aliasIpAddress, system=system, gatewayToRemote=gatewayToRemote, radiusSecret1=radiusSecret1, radiusSecret2=radiusSecret2, slaveIPaddr=slaveIPaddr, remoteIpAddress=remoteIpAddress, authRad1=authRad1, telnetdService=telnetdService, dtrUp=dtrUp, afterSend=afterSend, portStatsTable=portStatsTable, multiSession=multiSession, ts=ts, slaveHexaAddress=slaveHexaAddress, flowControl=flowControl, timeoutPAD=timeoutPAD, mode=mode, ethernetAddress=ethernetAddress, radiusServer1=radiusServer1, reset=reset, snmpTrap=snmpTrap, portTable=portTable, terminalType=terminalType, mainIpAddress=mainIpAddress, nameServer1=nameServer1, secondGateway=secondGateway, beforeSend=beforeSend, dtrDown=dtrDown, ipGateway=ipGateway, snmpdService=snmpdService, authRad2=authRad2, version=version, ftpdService=ftpdService, nbParStop=nbParStop, modbusEntry=modbusEntry, acctRad2=acctRad2, siteName=siteName, slaveIPport=slaveIPport, rxIdle=rxIdle, acctRad1=acctRad1, portReset=portReset, ipNetmask=ipNetmask, timeoutRxTx=timeoutRxTx, bytesReceiveFromV24=bytesReceiveFromV24, bytesSendToV24=bytesSendToV24, aliasIpNetmask=aliasIpNetmask, modbusMode=modbusMode, productName=productName, httpdService=httpdService, nameServer2=nameServer2, portIndex=portIndex, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, sessionStopped=sessionStopped, radiusServer2=radiusServer2, modbusTable=modbusTable, ipServer=ipServer, baudRate=baudRate, formFeed=formFeed, snmpTrapAddr2=snmpTrapAddr2, portEntry=portEntry, nameResolution=nameResolution, bootp=bootp, sessionStarted=sessionStarted, modbusType=modbusType, remoteTcpPort=remoteTcpPort, secondTcpPort=secondTcpPort, interFrame=interFrame, endMsg=endMsg, cxr=cxr, txIdle=txIdle, resetByButton=resetByButton, tcpPort=tcpPort, portStatsEntry=portStatsEntry, authType=authType, secondIpAddress=secondIpAddress)
