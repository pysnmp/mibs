...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:58:08 2023
...
Unsigned32, enterprises, Gauge32, Integer32, NotificationType, iso, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter64, ModuleIdentity, ObjectIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Gauge32", "Integer32", "NotificationType", "iso", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "ObjectIdentity", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusEntry=modbusEntry, ethernetAddress=ethernetAddress, productName=productName, slaveIPaddr=slaveIPaddr, slaveIPport=slaveIPport, flowControl=flowControl, modbusTable=modbusTable, snmpTrapAddr1=snmpTrapAddr1, snmpTrapAddr2=snmpTrapAddr2, beforeSend=beforeSend, ipNetmask=ipNetmask, resetByButton=resetByButton, formFeed=formFeed, portStatsTable=portStatsTable, bytesReceiveFromV24=bytesReceiveFromV24, telnetdService=telnetdService, dtrDown=dtrDown, gatewayToRemote=gatewayToRemote, secondGateway=secondGateway, dtrUp=dtrUp, interFrame=interFrame, baudRate=baudRate, snmpdService=snmpdService, statusDTR=statusDTR, multiSession=multiSession, nameServer1=nameServer1, timeoutPAD=timeoutPAD, acctRad1=acctRad1, remoteTcpPort=remoteTcpPort, terminalType=terminalType, portReset=portReset, ipGateway=ipGateway, tcpPort=tcpPort, nbParStop=nbParStop, afterSend=afterSend, ftpdService=ftpdService, snmpTrap=snmpTrap, sessionStopped=sessionStopped, authType=authType, mainIpAddress=mainIpAddress, portStatsEntry=portStatsEntry, reset=reset, nameResolution=nameResolution, nameServer2=nameServer2, aliasIpAddress=aliasIpAddress, bootp=bootp, radiusServer2=radiusServer2, mode=mode, modbusMode=modbusMode, cxr=cxr, authRad2=authRad2, ts=ts, system=system, ipServer=ipServer, radiusSecret1=radiusSecret1, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, endMsg=endMsg, secondTcpPort=secondTcpPort, portTable=portTable, slaveHexaAddress=slaveHexaAddress, timeoutRxTx=timeoutRxTx, radiusServer1=radiusServer1, httpdService=httpdService, version=version, portEntry=portEntry, siteName=siteName, modbusType=modbusType, authRad1=authRad1, portIndex=portIndex, sessionStarted=sessionStarted, remoteIpAddress=remoteIpAddress, rxIdle=rxIdle, bytesSendToV24=bytesSendToV24, acctRad2=acctRad2, radiusSecret2=radiusSecret2, secondIpAddress=secondIpAddress)
