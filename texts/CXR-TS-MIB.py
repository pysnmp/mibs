...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:06:15 2024
...
Integer32, NotificationType, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, enterprises, Counter64, IpAddress, ObjectIdentity, Unsigned32, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "enterprises", "Counter64", "IpAddress", "ObjectIdentity", "Unsigned32", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", sessionStopped=sessionStopped, timeoutPAD=timeoutPAD, authType=authType, multiSession=multiSession, mode=mode, portIndex=portIndex, snmpdService=snmpdService, gatewayToRemote=gatewayToRemote, dtrDown=dtrDown, flowControl=flowControl, formFeed=formFeed, modbusMode=modbusMode, snmpTrapAddr2=snmpTrapAddr2, mainIpAddress=mainIpAddress, acctRad1=acctRad1, siteName=siteName, productName=productName, timeoutRxTx=timeoutRxTx, modbusTable=modbusTable, endMsg=endMsg, remoteTcpPort=remoteTcpPort, radiusSecret1=radiusSecret1, rxIdle=rxIdle, snmpTrap=snmpTrap, bytesSendToV24=bytesSendToV24, resetByButton=resetByButton, authRad2=authRad2, secondIpAddress=secondIpAddress, ts=ts, ipServer=ipServer, nameServer2=nameServer2, interFrame=interFrame, portEntry=portEntry, ipGateway=ipGateway, txIdle=txIdle, authRad1=authRad1, version=version, portStatsEntry=portStatsEntry, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, slaveIPport=slaveIPport, radiusSecret2=radiusSecret2, ethernetAddress=ethernetAddress, afterSend=afterSend, httpdService=httpdService, secondGateway=secondGateway, modbusEntry=modbusEntry, slaveIPaddr=slaveIPaddr, bootp=bootp, beforeSend=beforeSend, acctRad2=acctRad2, tcpPort=tcpPort, ftpdService=ftpdService, dtrUp=dtrUp, nameResolution=nameResolution, slaveHexaAddress=slaveHexaAddress, nbParStop=nbParStop, aliasIpAddress=aliasIpAddress, ipNetmask=ipNetmask, reset=reset, cxr=cxr, modbusType=modbusType, remoteIpAddress=remoteIpAddress, secondTcpPort=secondTcpPort, system=system, radiusServer1=radiusServer1, radiusServer2=radiusServer2, terminalType=terminalType, portStatsTable=portStatsTable, sessionStarted=sessionStarted, portTable=portTable, portReset=portReset, telnetdService=telnetdService, aliasIpNetmask=aliasIpNetmask, bytesReceiveFromV24=bytesReceiveFromV24, baudRate=baudRate, nameServer1=nameServer1)
