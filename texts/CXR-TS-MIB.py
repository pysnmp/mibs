...
Counter64, NotificationType, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, NotificationType, ObjectIdentity, Unsigned32, enterprises, MibIdentifier, Gauge32, IpAddress, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Unsigned32", "enterprises", "MibIdentifier", "Gauge32", "IpAddress", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", ipServer=ipServer, radiusSecret2=radiusSecret2, baudRate=baudRate, radiusServer2=radiusServer2, telnetdService=telnetdService, bytesReceiveFromV24=bytesReceiveFromV24, sessionStopped=sessionStopped, reset=reset, endMsg=endMsg, nameServer2=nameServer2, radiusSecret1=radiusSecret1, modbusType=modbusType, afterSend=afterSend, ethernetAddress=ethernetAddress, terminalType=terminalType, txIdle=txIdle, snmpTrapAddr1=snmpTrapAddr1, aliasIpAddress=aliasIpAddress, ftpdService=ftpdService, beforeSend=beforeSend, portTable=portTable, modbusTable=modbusTable, slaveHexaAddress=slaveHexaAddress, authType=authType, radiusServer1=radiusServer1, ts=ts, gatewayToRemote=gatewayToRemote, system=system, snmpTrapAddr2=snmpTrapAddr2, interFrame=interFrame, slaveIPport=slaveIPport, version=version, remoteIpAddress=remoteIpAddress, authRad1=authRad1, sessionStarted=sessionStarted, formFeed=formFeed, httpdService=httpdService, slaveIPaddr=slaveIPaddr, acctRad2=acctRad2, cxr=cxr, remoteTcpPort=remoteTcpPort, secondGateway=secondGateway, authRad2=authRad2, portReset=portReset, nameResolution=nameResolution, portStatsTable=portStatsTable, timeoutPAD=timeoutPAD, portEntry=portEntry, secondTcpPort=secondTcpPort, flowControl=flowControl, timeoutRxTx=timeoutRxTx, multiSession=multiSession, mainIpAddress=mainIpAddress, bootp=bootp, snmpdService=snmpdService, siteName=siteName, ipNetmask=ipNetmask, secondIpAddress=secondIpAddress, dtrDown=dtrDown, acctRad1=acctRad1, ipGateway=ipGateway, resetByButton=resetByButton, modbusMode=modbusMode, nbParStop=nbParStop, nameServer1=nameServer1, dtrUp=dtrUp, statusDTR=statusDTR, mode=mode, rxIdle=rxIdle, tcpPort=tcpPort, modbusEntry=modbusEntry, aliasIpNetmask=aliasIpNetmask, portStatsEntry=portStatsEntry, bytesSendToV24=bytesSendToV24, snmpTrap=snmpTrap, portIndex=portIndex, productName=productName)
