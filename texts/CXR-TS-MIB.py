...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:20:19 2024
...
NotificationType, ModuleIdentity, ObjectIdentity, Integer32, Unsigned32, Counter32, Gauge32, TimeTicks, enterprises, Counter64, Bits, MibIdentifier, IpAddress, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Integer32", "Unsigned32", "Counter32", "Gauge32", "TimeTicks", "enterprises", "Counter64", "Bits", "MibIdentifier", "IpAddress", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", siteName=siteName, slaveIPport=slaveIPport, tcpPort=tcpPort, beforeSend=beforeSend, snmpTrap=snmpTrap, nbParStop=nbParStop, interFrame=interFrame, secondGateway=secondGateway, portReset=portReset, endMsg=endMsg, dtrUp=dtrUp, radiusSecret2=radiusSecret2, httpdService=httpdService, snmpTrapAddr1=snmpTrapAddr1, remoteIpAddress=remoteIpAddress, multiSession=multiSession, portEntry=portEntry, afterSend=afterSend, slaveIPaddr=slaveIPaddr, telnetdService=telnetdService, authType=authType, portStatsTable=portStatsTable, nameServer1=nameServer1, ftpdService=ftpdService, timeoutRxTx=timeoutRxTx, authRad2=authRad2, statusDTR=statusDTR, ipGateway=ipGateway, portStatsEntry=portStatsEntry, portTable=portTable, gatewayToRemote=gatewayToRemote, txIdle=txIdle, bootp=bootp, baudRate=baudRate, version=version, remoteTcpPort=remoteTcpPort, radiusSecret1=radiusSecret1, modbusType=modbusType, productName=productName, portIndex=portIndex, nameResolution=nameResolution, system=system, acctRad1=acctRad1, nameServer2=nameServer2, slaveHexaAddress=slaveHexaAddress, terminalType=terminalType, timeoutPAD=timeoutPAD, secondTcpPort=secondTcpPort, sessionStopped=sessionStopped, cxr=cxr, mainIpAddress=mainIpAddress, mode=mode, resetByButton=resetByButton, modbusMode=modbusMode, reset=reset, secondIpAddress=secondIpAddress, ipServer=ipServer, formFeed=formFeed, snmpTrapAddr2=snmpTrapAddr2, aliasIpAddress=aliasIpAddress, bytesSendToV24=bytesSendToV24, ts=ts, aliasIpNetmask=aliasIpNetmask, ipNetmask=ipNetmask, modbusEntry=modbusEntry, flowControl=flowControl, snmpdService=snmpdService, authRad1=authRad1, ethernetAddress=ethernetAddress, modbusTable=modbusTable, radiusServer1=radiusServer1, rxIdle=rxIdle, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, radiusServer2=radiusServer2, dtrDown=dtrDown, sessionStarted=sessionStarted)
