...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:44:42 2022
...
Gauge32, Unsigned32, enterprises, iso, NotificationType, Integer32, NotificationType, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "enterprises", "iso", "NotificationType", "Integer32", "NotificationType", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrapAddr2=snmpTrapAddr2, authRad1=authRad1, radiusSecret1=radiusSecret1, baudRate=baudRate, snmpTrapAddr1=snmpTrapAddr1, slaveIPaddr=slaveIPaddr, snmpdService=snmpdService, ethernetAddress=ethernetAddress, secondGateway=secondGateway, nameResolution=nameResolution, slaveHexaAddress=slaveHexaAddress, sessionStarted=sessionStarted, ts=ts, productName=productName, rxIdle=rxIdle, acctRad1=acctRad1, resetByButton=resetByButton, portTable=portTable, bytesSendToV24=bytesSendToV24, remoteTcpPort=remoteTcpPort, modbusMode=modbusMode, slaveIPport=slaveIPport, secondTcpPort=secondTcpPort, beforeSend=beforeSend, reset=reset, portStatsTable=portStatsTable, interFrame=interFrame, portReset=portReset, authType=authType, formFeed=formFeed, version=version, tcpPort=tcpPort, ipNetmask=ipNetmask, telnetdService=telnetdService, dtrUp=dtrUp, modbusType=modbusType, radiusSecret2=radiusSecret2, snmpTrap=snmpTrap, ftpdService=ftpdService, system=system, portEntry=portEntry, timeoutRxTx=timeoutRxTx, radiusServer1=radiusServer1, portIndex=portIndex, flowControl=flowControl, httpdService=httpdService, ipGateway=ipGateway, radiusServer2=radiusServer2, acctRad2=acctRad2, nameServer1=nameServer1, cxr=cxr, statusDTR=statusDTR, ipServer=ipServer, authRad2=authRad2, multiSession=multiSession, txIdle=txIdle, aliasIpNetmask=aliasIpNetmask, nameServer2=nameServer2, siteName=siteName, timeoutPAD=timeoutPAD, modbusEntry=modbusEntry, remoteIpAddress=remoteIpAddress, sessionStopped=sessionStopped, portStatsEntry=portStatsEntry, bootp=bootp, secondIpAddress=secondIpAddress, mainIpAddress=mainIpAddress, mode=mode, bytesReceiveFromV24=bytesReceiveFromV24, nbParStop=nbParStop, afterSend=afterSend, modbusTable=modbusTable, aliasIpAddress=aliasIpAddress, endMsg=endMsg, terminalType=terminalType, dtrDown=dtrDown, gatewayToRemote=gatewayToRemote)
