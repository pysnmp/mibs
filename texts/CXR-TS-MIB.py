...
Integer32, ModuleIdentity, Unsigned32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, TimeTicks, Counter64, Bits, Counter32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "TimeTicks", "Counter64", "Bits", "Counter32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portTable=portTable, ipGateway=ipGateway, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, modbusEntry=modbusEntry, ts=ts, nbParStop=nbParStop, telnetdService=telnetdService, dtrUp=dtrUp, siteName=siteName, aliasIpNetmask=aliasIpNetmask, interFrame=interFrame, reset=reset, authType=authType, portStatsTable=portStatsTable, nameServer2=nameServer2, system=system, mode=mode, baudRate=baudRate, txIdle=txIdle, modbusMode=modbusMode, resetByButton=resetByButton, ipServer=ipServer, remoteTcpPort=remoteTcpPort, radiusSecret1=radiusSecret1, sessionStopped=sessionStopped, endMsg=endMsg, beforeSend=beforeSend, remoteIpAddress=remoteIpAddress, tcpPort=tcpPort, modbusType=modbusType, slaveIPport=slaveIPport, snmpTrapAddr2=snmpTrapAddr2, terminalType=terminalType, mainIpAddress=mainIpAddress, timeoutRxTx=timeoutRxTx, secondTcpPort=secondTcpPort, httpdService=httpdService, productName=productName, modbusTable=modbusTable, radiusSecret2=radiusSecret2, portEntry=portEntry, secondIpAddress=secondIpAddress, snmpTrap=snmpTrap, cxr=cxr, gatewayToRemote=gatewayToRemote, portReset=portReset, acctRad1=acctRad1, slaveHexaAddress=slaveHexaAddress, bytesSendToV24=bytesSendToV24, portIndex=portIndex, aliasIpAddress=aliasIpAddress, formFeed=formFeed, authRad1=authRad1, ipNetmask=ipNetmask, snmpdService=snmpdService, timeoutPAD=timeoutPAD, ethernetAddress=ethernetAddress, snmpTrapAddr1=snmpTrapAddr1, statusDTR=statusDTR, multiSession=multiSession, sessionStarted=sessionStarted, nameServer1=nameServer1, authRad2=authRad2, nameResolution=nameResolution, rxIdle=rxIdle, radiusServer2=radiusServer2, afterSend=afterSend, dtrDown=dtrDown, portStatsEntry=portStatsEntry, bootp=bootp, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1, secondGateway=secondGateway, flowControl=flowControl, ftpdService=ftpdService, version=version)
