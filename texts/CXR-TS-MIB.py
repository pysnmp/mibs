...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:36:23 2024
...
MibIdentifier, Integer32, NotificationType, Gauge32, iso, TimeTicks, NotificationType, Bits, Unsigned32, IpAddress, ModuleIdentity, ObjectIdentity, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "NotificationType", "Gauge32", "iso", "TimeTicks", "NotificationType", "Bits", "Unsigned32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", mode=mode, modbusType=modbusType, interFrame=interFrame, productName=productName, gatewayToRemote=gatewayToRemote, slaveIPaddr=slaveIPaddr, resetByButton=resetByButton, nbParStop=nbParStop, flowControl=flowControl, snmpTrap=snmpTrap, authType=authType, acctRad2=acctRad2, snmpTrapAddr1=snmpTrapAddr1, nameServer2=nameServer2, radiusServer2=radiusServer2, modbusEntry=modbusEntry, modbusMode=modbusMode, beforeSend=beforeSend, slaveHexaAddress=slaveHexaAddress, sessionStarted=sessionStarted, ftpdService=ftpdService, reset=reset, ts=ts, ipNetmask=ipNetmask, sessionStopped=sessionStopped, endMsg=endMsg, remoteIpAddress=remoteIpAddress, telnetdService=telnetdService, radiusSecret1=radiusSecret1, cxr=cxr, secondIpAddress=secondIpAddress, ipGateway=ipGateway, snmpdService=snmpdService, aliasIpNetmask=aliasIpNetmask, secondTcpPort=secondTcpPort, formFeed=formFeed, portStatsTable=portStatsTable, radiusSecret2=radiusSecret2, secondGateway=secondGateway, authRad1=authRad1, nameServer1=nameServer1, timeoutPAD=timeoutPAD, dtrUp=dtrUp, bytesReceiveFromV24=bytesReceiveFromV24, siteName=siteName, ipServer=ipServer, modbusTable=modbusTable, afterSend=afterSend, baudRate=baudRate, mainIpAddress=mainIpAddress, portIndex=portIndex, timeoutRxTx=timeoutRxTx, authRad2=authRad2, aliasIpAddress=aliasIpAddress, portReset=portReset, acctRad1=acctRad1, snmpTrapAddr2=snmpTrapAddr2, terminalType=terminalType, tcpPort=tcpPort, version=version, slaveIPport=slaveIPport, radiusServer1=radiusServer1, nameResolution=nameResolution, portTable=portTable, statusDTR=statusDTR, portStatsEntry=portStatsEntry, system=system, multiSession=multiSession, portEntry=portEntry, txIdle=txIdle, bootp=bootp, ethernetAddress=ethernetAddress, httpdService=httpdService, bytesSendToV24=bytesSendToV24, rxIdle=rxIdle, remoteTcpPort=remoteTcpPort, dtrDown=dtrDown)
