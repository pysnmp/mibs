...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:25:19 2022
...
TimeTicks, MibIdentifier, Gauge32, ModuleIdentity, enterprises, NotificationType, IpAddress, iso, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Integer32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Gauge32", "ModuleIdentity", "enterprises", "NotificationType", "IpAddress", "iso", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Integer32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("CXR-TS-MIB", remoteIpAddress=remoteIpAddress, gatewayToRemote=gatewayToRemote, ts=ts, nbParStop=nbParStop, nameServer2=nameServer2, ipGateway=ipGateway, bootp=bootp, snmpTrap=snmpTrap, statusDTR=statusDTR, modbusEntry=modbusEntry, radiusServer1=radiusServer1, dtrDown=dtrDown, ipNetmask=ipNetmask, authType=authType, beforeSend=beforeSend, ipServer=ipServer, httpdService=httpdService, sessionStopped=sessionStopped, snmpTrapAddr1=snmpTrapAddr1, snmpTrapAddr2=snmpTrapAddr2, bytesReceiveFromV24=bytesReceiveFromV24, authRad1=authRad1, slaveIPport=slaveIPport, portStatsTable=portStatsTable, bytesSendToV24=bytesSendToV24, txIdle=txIdle, version=version, aliasIpNetmask=aliasIpNetmask, terminalType=terminalType, slaveHexaAddress=slaveHexaAddress, secondGateway=secondGateway, mode=mode, acctRad1=acctRad1, modbusTable=modbusTable, portReset=portReset, modbusMode=modbusMode, system=system, remoteTcpPort=remoteTcpPort, telnetdService=telnetdService, cxr=cxr, ftpdService=ftpdService, siteName=siteName, interFrame=interFrame, radiusServer2=radiusServer2, productName=productName, portTable=portTable, authRad2=authRad2, acctRad2=acctRad2, radiusSecret2=radiusSecret2, endMsg=endMsg, secondIpAddress=secondIpAddress, ethernetAddress=ethernetAddress, aliasIpAddress=aliasIpAddress, dtrUp=dtrUp, modbusType=modbusType, timeoutPAD=timeoutPAD, formFeed=formFeed, flowControl=flowControl, timeoutRxTx=timeoutRxTx, reset=reset, rxIdle=rxIdle, tcpPort=tcpPort, portStatsEntry=portStatsEntry, sessionStarted=sessionStarted, nameResolution=nameResolution, radiusSecret1=radiusSecret1, multiSession=multiSession, afterSend=afterSend, portEntry=portEntry, baudRate=baudRate, resetByButton=resetByButton, slaveIPaddr=slaveIPaddr, secondTcpPort=secondTcpPort, nameServer1=nameServer1, snmpdService=snmpdService, mainIpAddress=mainIpAddress, portIndex=portIndex)
