...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:20:04 2023
...
Integer32, iso, TimeTicks, Counter64, Bits, NotificationType, ObjectIdentity, Gauge32, IpAddress, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "Counter64", "Bits", "NotificationType", "ObjectIdentity", "Gauge32", "IpAddress", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", modbusMode=modbusMode, ipGateway=ipGateway, radiusSecret1=radiusSecret1, radiusSecret2=radiusSecret2, snmpTrapAddr2=snmpTrapAddr2, system=system, reset=reset, authType=authType, resetByButton=resetByButton, ftpdService=ftpdService, baudRate=baudRate, portReset=portReset, ipNetmask=ipNetmask, tcpPort=tcpPort, authRad1=authRad1, sessionStopped=sessionStopped, modbusTable=modbusTable, mode=mode, afterSend=afterSend, secondIpAddress=secondIpAddress, version=version, remoteTcpPort=remoteTcpPort, acctRad1=acctRad1, mainIpAddress=mainIpAddress, modbusEntry=modbusEntry, productName=productName, bytesReceiveFromV24=bytesReceiveFromV24, slaveIPaddr=slaveIPaddr, sessionStarted=sessionStarted, secondGateway=secondGateway, snmpdService=snmpdService, radiusServer2=radiusServer2, bootp=bootp, rxIdle=rxIdle, ethernetAddress=ethernetAddress, timeoutPAD=timeoutPAD, ipServer=ipServer, endMsg=endMsg, nbParStop=nbParStop, httpdService=httpdService, nameServer1=nameServer1, modbusType=modbusType, telnetdService=telnetdService, nameResolution=nameResolution, snmpTrapAddr1=snmpTrapAddr1, nameServer2=nameServer2, authRad2=authRad2, acctRad2=acctRad2, flowControl=flowControl, portEntry=portEntry, snmpTrap=snmpTrap, txIdle=txIdle, portStatsEntry=portStatsEntry, ts=ts, terminalType=terminalType, formFeed=formFeed, aliasIpNetmask=aliasIpNetmask, dtrDown=dtrDown, interFrame=interFrame, portStatsTable=portStatsTable, beforeSend=beforeSend, timeoutRxTx=timeoutRxTx, cxr=cxr, portIndex=portIndex, secondTcpPort=secondTcpPort, statusDTR=statusDTR, bytesSendToV24=bytesSendToV24, siteName=siteName, slaveIPport=slaveIPport, dtrUp=dtrUp, radiusServer1=radiusServer1, aliasIpAddress=aliasIpAddress, gatewayToRemote=gatewayToRemote, multiSession=multiSession, slaveHexaAddress=slaveHexaAddress, portTable=portTable, remoteIpAddress=remoteIpAddress)
