...
# Produced by pysmi-1.1.12 at Tue Sep 17 09:58:26 2024
...
MibIdentifier, TimeTicks, NotificationType, Counter64, Counter32, ModuleIdentity, iso, enterprises, Bits, NotificationType, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "Counter32", "ModuleIdentity", "iso", "enterprises", "Bits", "NotificationType", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("CXR-TS-MIB", slaveIPport=slaveIPport, nameResolution=nameResolution, siteName=siteName, nameServer1=nameServer1, portEntry=portEntry, resetByButton=resetByButton, portStatsTable=portStatsTable, aliasIpNetmask=aliasIpNetmask, ipServer=ipServer, system=system, multiSession=multiSession, baudRate=baudRate, remoteTcpPort=remoteTcpPort, bytesSendToV24=bytesSendToV24, radiusSecret1=radiusSecret1, flowControl=flowControl, telnetdService=telnetdService, bytesReceiveFromV24=bytesReceiveFromV24, ipGateway=ipGateway, interFrame=interFrame, snmpdService=snmpdService, snmpTrap=snmpTrap, acctRad1=acctRad1, afterSend=afterSend, dtrDown=dtrDown, radiusServer1=radiusServer1, ts=ts, radiusSecret2=radiusSecret2, endMsg=endMsg, formFeed=formFeed, aliasIpAddress=aliasIpAddress, beforeSend=beforeSend, timeoutPAD=timeoutPAD, authRad1=authRad1, txIdle=txIdle, modbusTable=modbusTable, authRad2=authRad2, slaveIPaddr=slaveIPaddr, statusDTR=statusDTR, radiusServer2=radiusServer2, ftpdService=ftpdService, sessionStopped=sessionStopped, productName=productName, snmpTrapAddr2=snmpTrapAddr2, slaveHexaAddress=slaveHexaAddress, mode=mode, secondGateway=secondGateway, version=version, snmpTrapAddr1=snmpTrapAddr1, terminalType=terminalType, remoteIpAddress=remoteIpAddress, secondIpAddress=secondIpAddress, modbusType=modbusType, portIndex=portIndex, ipNetmask=ipNetmask, portTable=portTable, sessionStarted=sessionStarted, secondTcpPort=secondTcpPort, authType=authType, acctRad2=acctRad2, mainIpAddress=mainIpAddress, bootp=bootp, cxr=cxr, modbusMode=modbusMode, httpdService=httpdService, portStatsEntry=portStatsEntry, ethernetAddress=ethernetAddress, tcpPort=tcpPort, dtrUp=dtrUp, gatewayToRemote=gatewayToRemote, reset=reset, nameServer2=nameServer2, nbParStop=nbParStop, timeoutRxTx=timeoutRxTx, rxIdle=rxIdle, portReset=portReset, modbusEntry=modbusEntry)
