...
# Produced by pysmi-1.1.12 at Tue Dec  3 12:13:48 2024
...
Integer32, ObjectIdentity, iso, IpAddress, MibIdentifier, Gauge32, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, enterprises, Counter32, Counter64, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "iso", "IpAddress", "MibIdentifier", "Gauge32", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "enterprises", "Counter32", "Counter64", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrap=snmpTrap, interFrame=interFrame, tcpPort=tcpPort, authType=authType, modbusEntry=modbusEntry, authRad2=authRad2, portTable=portTable, timeoutPAD=timeoutPAD, version=version, bytesSendToV24=bytesSendToV24, gatewayToRemote=gatewayToRemote, secondTcpPort=secondTcpPort, nameResolution=nameResolution, aliasIpNetmask=aliasIpNetmask, portStatsEntry=portStatsEntry, timeoutRxTx=timeoutRxTx, modbusMode=modbusMode, nameServer2=nameServer2, acctRad2=acctRad2, ethernetAddress=ethernetAddress, slaveIPaddr=slaveIPaddr, nameServer1=nameServer1, formFeed=formFeed, authRad1=authRad1, sessionStarted=sessionStarted, portIndex=portIndex, bootp=bootp, remoteIpAddress=remoteIpAddress, dtrUp=dtrUp, portStatsTable=portStatsTable, secondIpAddress=secondIpAddress, dtrDown=dtrDown, telnetdService=telnetdService, statusDTR=statusDTR, slaveHexaAddress=slaveHexaAddress, radiusSecret1=radiusSecret1, flowControl=flowControl, snmpTrapAddr1=snmpTrapAddr1, siteName=siteName, remoteTcpPort=remoteTcpPort, ipGateway=ipGateway, modbusType=modbusType, beforeSend=beforeSend, productName=productName, mainIpAddress=mainIpAddress, terminalType=terminalType, radiusServer2=radiusServer2, ts=ts, mode=mode, resetByButton=resetByButton, nbParStop=nbParStop, bytesReceiveFromV24=bytesReceiveFromV24, radiusSecret2=radiusSecret2, portReset=portReset, afterSend=afterSend, endMsg=endMsg, secondGateway=secondGateway, ipServer=ipServer, aliasIpAddress=aliasIpAddress, multiSession=multiSession, portEntry=portEntry, cxr=cxr, slaveIPport=slaveIPport, ftpdService=ftpdService, rxIdle=rxIdle, baudRate=baudRate, acctRad1=acctRad1, reset=reset, snmpTrapAddr2=snmpTrapAddr2, httpdService=httpdService, radiusServer1=radiusServer1, system=system, snmpdService=snmpdService, ipNetmask=ipNetmask, txIdle=txIdle, sessionStopped=sessionStopped, modbusTable=modbusTable)
