...
# Produced by pysmi-1.1.12 at Wed May 29 10:53:40 2024
...
Unsigned32, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Counter64, Bits, MibIdentifier, Integer32, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Counter64", "Bits", "MibIdentifier", "Integer32", "iso", "enterprises")
...
mibBuilder.exportSymbols("CXR-TS-MIB", rxIdle=rxIdle, remoteIpAddress=remoteIpAddress, version=version, dtrDown=dtrDown, resetByButton=resetByButton, snmpTrap=snmpTrap, flowControl=flowControl, snmpTrapAddr2=snmpTrapAddr2, aliasIpAddress=aliasIpAddress, nbParStop=nbParStop, modbusType=modbusType, bytesSendToV24=bytesSendToV24, statusDTR=statusDTR, snmpTrapAddr1=snmpTrapAddr1, radiusSecret2=radiusSecret2, bootp=bootp, afterSend=afterSend, ipNetmask=ipNetmask, portStatsTable=portStatsTable, txIdle=txIdle, modbusTable=modbusTable, tcpPort=tcpPort, portTable=portTable, acctRad1=acctRad1, secondGateway=secondGateway, system=system, radiusServer1=radiusServer1, timeoutRxTx=timeoutRxTx, remoteTcpPort=remoteTcpPort, snmpdService=snmpdService, reset=reset, secondIpAddress=secondIpAddress, authType=authType, portStatsEntry=portStatsEntry, mainIpAddress=mainIpAddress, authRad2=authRad2, productName=productName, nameResolution=nameResolution, gatewayToRemote=gatewayToRemote, cxr=cxr, slaveIPaddr=slaveIPaddr, interFrame=interFrame, ts=ts, telnetdService=telnetdService, siteName=siteName, sessionStarted=sessionStarted, modbusEntry=modbusEntry, portEntry=portEntry, baudRate=baudRate, slaveIPport=slaveIPport, portIndex=portIndex, timeoutPAD=timeoutPAD, terminalType=terminalType, bytesReceiveFromV24=bytesReceiveFromV24, ethernetAddress=ethernetAddress, secondTcpPort=secondTcpPort, acctRad2=acctRad2, ftpdService=ftpdService, radiusServer2=radiusServer2, modbusMode=modbusMode, ipGateway=ipGateway, formFeed=formFeed, authRad1=authRad1, aliasIpNetmask=aliasIpNetmask, nameServer1=nameServer1, slaveHexaAddress=slaveHexaAddress, sessionStopped=sessionStopped, nameServer2=nameServer2, ipServer=ipServer, radiusSecret1=radiusSecret1, beforeSend=beforeSend, endMsg=endMsg, dtrUp=dtrUp, portReset=portReset, multiSession=multiSession, mode=mode, httpdService=httpdService)
