...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:15:41 2023
...
Counter32, IpAddress, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Gauge32, NotificationType, iso, Counter64, Integer32, ObjectIdentity, enterprises, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Gauge32", "NotificationType", "iso", "Counter64", "Integer32", "ObjectIdentity", "enterprises", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", radiusServer1=radiusServer1, httpdService=httpdService, portTable=portTable, aliasIpNetmask=aliasIpNetmask, mode=mode, secondIpAddress=secondIpAddress, statusDTR=statusDTR, snmpTrapAddr2=snmpTrapAddr2, nameServer1=nameServer1, modbusType=modbusType, portStatsTable=portStatsTable, acctRad1=acctRad1, version=version, beforeSend=beforeSend, productName=productName, dtrUp=dtrUp, modbusMode=modbusMode, secondTcpPort=secondTcpPort, bytesSendToV24=bytesSendToV24, portIndex=portIndex, mainIpAddress=mainIpAddress, secondGateway=secondGateway, ftpdService=ftpdService, nameServer2=nameServer2, slaveIPport=slaveIPport, timeoutPAD=timeoutPAD, portReset=portReset, system=system, endMsg=endMsg, rxIdle=rxIdle, remoteIpAddress=remoteIpAddress, ipServer=ipServer, authRad1=authRad1, snmpTrapAddr1=snmpTrapAddr1, sessionStopped=sessionStopped, interFrame=interFrame, modbusEntry=modbusEntry, tcpPort=tcpPort, timeoutRxTx=timeoutRxTx, cxr=cxr, ipNetmask=ipNetmask, baudRate=baudRate, resetByButton=resetByButton, remoteTcpPort=remoteTcpPort, terminalType=terminalType, txIdle=txIdle, authType=authType, multiSession=multiSession, ethernetAddress=ethernetAddress, telnetdService=telnetdService, ipGateway=ipGateway, siteName=siteName, reset=reset, slaveIPaddr=slaveIPaddr, bytesReceiveFromV24=bytesReceiveFromV24, gatewayToRemote=gatewayToRemote, flowControl=flowControl, ts=ts, slaveHexaAddress=slaveHexaAddress, radiusServer2=radiusServer2, authRad2=authRad2, afterSend=afterSend, radiusSecret2=radiusSecret2, acctRad2=acctRad2, dtrDown=dtrDown, formFeed=formFeed, nameResolution=nameResolution, modbusTable=modbusTable, snmpTrap=snmpTrap, snmpdService=snmpdService, nbParStop=nbParStop, radiusSecret1=radiusSecret1, sessionStarted=sessionStarted, aliasIpAddress=aliasIpAddress, portStatsEntry=portStatsEntry, portEntry=portEntry, bootp=bootp)
