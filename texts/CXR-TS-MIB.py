...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:54:46 2023
...
Counter64, enterprises, Bits, TimeTicks, NotificationType, NotificationType, Gauge32, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter32, MibIdentifier, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Bits", "TimeTicks", "NotificationType", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter32", "MibIdentifier", "Integer32", "iso")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portEntry=portEntry, sessionStarted=sessionStarted, secondTcpPort=secondTcpPort, nbParStop=nbParStop, txIdle=txIdle, secondIpAddress=secondIpAddress, cxr=cxr, flowControl=flowControl, timeoutRxTx=timeoutRxTx, interFrame=interFrame, mode=mode, nameServer2=nameServer2, gatewayToRemote=gatewayToRemote, statusDTR=statusDTR, bootp=bootp, mainIpAddress=mainIpAddress, sessionStopped=sessionStopped, authRad2=authRad2, slaveIPport=slaveIPport, aliasIpAddress=aliasIpAddress, nameResolution=nameResolution, aliasIpNetmask=aliasIpNetmask, portStatsTable=portStatsTable, authRad1=authRad1, snmpTrapAddr1=snmpTrapAddr1, modbusType=modbusType, acctRad2=acctRad2, baudRate=baudRate, slaveIPaddr=slaveIPaddr, dtrUp=dtrUp, modbusEntry=modbusEntry, portReset=portReset, slaveHexaAddress=slaveHexaAddress, endMsg=endMsg, remoteIpAddress=remoteIpAddress, remoteTcpPort=remoteTcpPort, secondGateway=secondGateway, formFeed=formFeed, ftpdService=ftpdService, resetByButton=resetByButton, terminalType=terminalType, nameServer1=nameServer1, modbusTable=modbusTable, snmpTrap=snmpTrap, httpdService=httpdService, ipServer=ipServer, productName=productName, ipNetmask=ipNetmask, tcpPort=tcpPort, snmpdService=snmpdService, siteName=siteName, rxIdle=rxIdle, dtrDown=dtrDown, authType=authType, radiusServer2=radiusServer2, radiusSecret2=radiusSecret2, ethernetAddress=ethernetAddress, timeoutPAD=timeoutPAD, beforeSend=beforeSend, portTable=portTable, system=system, telnetdService=telnetdService, ts=ts, reset=reset, afterSend=afterSend, multiSession=multiSession, modbusMode=modbusMode, radiusServer1=radiusServer1, bytesReceiveFromV24=bytesReceiveFromV24, snmpTrapAddr2=snmpTrapAddr2, portStatsEntry=portStatsEntry, acctRad1=acctRad1, version=version, bytesSendToV24=bytesSendToV24, portIndex=portIndex, ipGateway=ipGateway, radiusSecret1=radiusSecret1)
