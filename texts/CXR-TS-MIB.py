...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:34:59 2023
...
IpAddress, TimeTicks, Bits, MibIdentifier, Counter32, Integer32, Counter64, iso, NotificationType, NotificationType, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Bits", "MibIdentifier", "Counter32", "Integer32", "Counter64", "iso", "NotificationType", "NotificationType", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrap=snmpTrap, modbusMode=modbusMode, portTable=portTable, portEntry=portEntry, sessionStarted=sessionStarted, txIdle=txIdle, remoteIpAddress=remoteIpAddress, radiusServer1=radiusServer1, timeoutPAD=timeoutPAD, productName=productName, authRad2=authRad2, sessionStopped=sessionStopped, snmpdService=snmpdService, httpdService=httpdService, nameServer1=nameServer1, formFeed=formFeed, endMsg=endMsg, cxr=cxr, statusDTR=statusDTR, radiusSecret2=radiusSecret2, acctRad2=acctRad2, bytesReceiveFromV24=bytesReceiveFromV24, interFrame=interFrame, remoteTcpPort=remoteTcpPort, secondTcpPort=secondTcpPort, dtrUp=dtrUp, aliasIpNetmask=aliasIpNetmask, afterSend=afterSend, mainIpAddress=mainIpAddress, portIndex=portIndex, siteName=siteName, authRad1=authRad1, gatewayToRemote=gatewayToRemote, ethernetAddress=ethernetAddress, flowControl=flowControl, modbusType=modbusType, reset=reset, slaveHexaAddress=slaveHexaAddress, snmpTrapAddr2=snmpTrapAddr2, radiusServer2=radiusServer2, resetByButton=resetByButton, rxIdle=rxIdle, secondGateway=secondGateway, nameServer2=nameServer2, portStatsTable=portStatsTable, snmpTrapAddr1=snmpTrapAddr1, bootp=bootp, slaveIPaddr=slaveIPaddr, timeoutRxTx=timeoutRxTx, ipServer=ipServer, ipNetmask=ipNetmask, authType=authType, ftpdService=ftpdService, slaveIPport=slaveIPport, beforeSend=beforeSend, multiSession=multiSession, baudRate=baudRate, nameResolution=nameResolution, mode=mode, portReset=portReset, terminalType=terminalType, telnetdService=telnetdService, version=version, acctRad1=acctRad1, radiusSecret1=radiusSecret1, aliasIpAddress=aliasIpAddress, nbParStop=nbParStop, dtrDown=dtrDown, ipGateway=ipGateway, tcpPort=tcpPort, modbusTable=modbusTable, portStatsEntry=portStatsEntry, bytesSendToV24=bytesSendToV24, modbusEntry=modbusEntry, secondIpAddress=secondIpAddress, ts=ts, system=system)
