...
# Produced by pysmi-1.1.12 at Tue May 28 11:45:08 2024
...
Counter64, Unsigned32, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, NotificationType, TimeTicks, Counter32, enterprises, IpAddress, MibIdentifier, iso, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "NotificationType", "TimeTicks", "Counter32", "enterprises", "IpAddress", "MibIdentifier", "iso", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CXR-TS-MIB", portStatsTable=portStatsTable, nameServer1=nameServer1, slaveIPaddr=slaveIPaddr, nameResolution=nameResolution, gatewayToRemote=gatewayToRemote, tcpPort=tcpPort, radiusServer2=radiusServer2, ts=ts, portIndex=portIndex, ethernetAddress=ethernetAddress, modbusTable=modbusTable, portTable=portTable, aliasIpNetmask=aliasIpNetmask, snmpTrapAddr1=snmpTrapAddr1, slaveIPport=slaveIPport, slaveHexaAddress=slaveHexaAddress, system=system, endMsg=endMsg, productName=productName, authRad2=authRad2, secondGateway=secondGateway, radiusSecret2=radiusSecret2, radiusServer1=radiusServer1, portReset=portReset, terminalType=terminalType, remoteTcpPort=remoteTcpPort, telnetdService=telnetdService, dtrDown=dtrDown, afterSend=afterSend, version=version, modbusType=modbusType, ftpdService=ftpdService, reset=reset, modbusMode=modbusMode, sessionStarted=sessionStarted, formFeed=formFeed, beforeSend=beforeSend, timeoutPAD=timeoutPAD, secondIpAddress=secondIpAddress, siteName=siteName, ipServer=ipServer, bootp=bootp, statusDTR=statusDTR, acctRad1=acctRad1, timeoutRxTx=timeoutRxTx, secondTcpPort=secondTcpPort, ipNetmask=ipNetmask, modbusEntry=modbusEntry, bytesReceiveFromV24=bytesReceiveFromV24, acctRad2=acctRad2, cxr=cxr, resetByButton=resetByButton, snmpdService=snmpdService, multiSession=multiSession, nameServer2=nameServer2, rxIdle=rxIdle, mainIpAddress=mainIpAddress, ipGateway=ipGateway, aliasIpAddress=aliasIpAddress, nbParStop=nbParStop, portStatsEntry=portStatsEntry, authRad1=authRad1, bytesSendToV24=bytesSendToV24, authType=authType, portEntry=portEntry, interFrame=interFrame, httpdService=httpdService, remoteIpAddress=remoteIpAddress, flowControl=flowControl, radiusSecret1=radiusSecret1, dtrUp=dtrUp, baudRate=baudRate, txIdle=txIdle, snmpTrap=snmpTrap, snmpTrapAddr2=snmpTrapAddr2, sessionStopped=sessionStopped, mode=mode)
