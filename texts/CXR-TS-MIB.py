...
Unsigned32, ObjectIdentity, Counter64, Gauge32, NotificationType, MibIdentifier, IpAddress, iso, ModuleIdentity, Bits, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Counter64", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress", "iso", "ModuleIdentity", "Bits", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("CXR-TS-MIB", aliasIpNetmask=aliasIpNetmask, timeoutPAD=timeoutPAD, radiusSecret1=radiusSecret1, dtrDown=dtrDown, siteName=siteName, authRad1=authRad1, ipGateway=ipGateway, ethernetAddress=ethernetAddress, sessionStopped=sessionStopped, authRad2=authRad2, ts=ts, modbusEntry=modbusEntry, secondTcpPort=secondTcpPort, modbusMode=modbusMode, remoteTcpPort=remoteTcpPort, nbParStop=nbParStop, secondIpAddress=secondIpAddress, ftpdService=ftpdService, acctRad1=acctRad1, tcpPort=tcpPort, slaveIPaddr=slaveIPaddr, radiusServer1=radiusServer1, modbusTable=modbusTable, snmpTrapAddr1=snmpTrapAddr1, timeoutRxTx=timeoutRxTx, bytesSendToV24=bytesSendToV24, system=system, productName=productName, ipServer=ipServer, portReset=portReset, gatewayToRemote=gatewayToRemote, multiSession=multiSession, interFrame=interFrame, txIdle=txIdle, aliasIpAddress=aliasIpAddress, snmpdService=snmpdService, resetByButton=resetByButton, sessionStarted=sessionStarted, mode=mode, telnetdService=telnetdService, flowControl=flowControl, snmpTrap=snmpTrap, formFeed=formFeed, slaveHexaAddress=slaveHexaAddress, ipNetmask=ipNetmask, beforeSend=beforeSend, secondGateway=secondGateway, baudRate=baudRate, slaveIPport=slaveIPport, bytesReceiveFromV24=bytesReceiveFromV24, dtrUp=dtrUp, endMsg=endMsg, portStatsEntry=portStatsEntry, nameServer1=nameServer1, portIndex=portIndex, portTable=portTable, afterSend=afterSend, modbusType=modbusType, portEntry=portEntry, authType=authType, portStatsTable=portStatsTable, rxIdle=rxIdle, terminalType=terminalType, nameResolution=nameResolution, mainIpAddress=mainIpAddress, nameServer2=nameServer2, version=version, snmpTrapAddr2=snmpTrapAddr2, radiusServer2=radiusServer2, bootp=bootp, statusDTR=statusDTR, remoteIpAddress=remoteIpAddress, reset=reset, httpdService=httpdService, cxr=cxr, acctRad2=acctRad2, radiusSecret2=radiusSecret2)
