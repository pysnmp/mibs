...
# Produced by pysmi-1.1.12 at Tue May 28 13:34:14 2024
...
Gauge32, Counter64, NotificationType, IpAddress, TimeTicks, Unsigned32, ObjectIdentity, iso, Counter32, Integer32, ModuleIdentity, Bits, enterprises, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "NotificationType", "IpAddress", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "Counter32", "Integer32", "ModuleIdentity", "Bits", "enterprises", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CXR-TS-MIB", productName=productName, interFrame=interFrame, ipGateway=ipGateway, secondGateway=secondGateway, radiusSecret1=radiusSecret1, nbParStop=nbParStop, slaveIPport=slaveIPport, modbusTable=modbusTable, ipServer=ipServer, baudRate=baudRate, endMsg=endMsg, snmpTrap=snmpTrap, siteName=siteName, sessionStopped=sessionStopped, portEntry=portEntry, reset=reset, aliasIpNetmask=aliasIpNetmask, acctRad2=acctRad2, secondTcpPort=secondTcpPort, acctRad1=acctRad1, authRad2=authRad2, dtrUp=dtrUp, nameServer1=nameServer1, mode=mode, bootp=bootp, timeoutPAD=timeoutPAD, remoteIpAddress=remoteIpAddress, snmpdService=snmpdService, multiSession=multiSession, telnetdService=telnetdService, radiusServer2=radiusServer2, terminalType=terminalType, system=system, version=version, dtrDown=dtrDown, ethernetAddress=ethernetAddress, flowControl=flowControl, bytesSendToV24=bytesSendToV24, secondIpAddress=secondIpAddress, portStatsTable=portStatsTable, authType=authType, radiusSecret2=radiusSecret2, tcpPort=tcpPort, httpdService=httpdService, modbusEntry=modbusEntry, portStatsEntry=portStatsEntry, bytesReceiveFromV24=bytesReceiveFromV24, ipNetmask=ipNetmask, ts=ts, portReset=portReset, mainIpAddress=mainIpAddress, snmpTrapAddr2=snmpTrapAddr2, aliasIpAddress=aliasIpAddress, statusDTR=statusDTR, cxr=cxr, formFeed=formFeed, gatewayToRemote=gatewayToRemote, snmpTrapAddr1=snmpTrapAddr1, modbusType=modbusType, remoteTcpPort=remoteTcpPort, authRad1=authRad1, nameServer2=nameServer2, timeoutRxTx=timeoutRxTx, resetByButton=resetByButton, rxIdle=rxIdle, beforeSend=beforeSend, ftpdService=ftpdService, txIdle=txIdle, afterSend=afterSend, slaveIPaddr=slaveIPaddr, nameResolution=nameResolution, portIndex=portIndex, radiusServer1=radiusServer1, modbusMode=modbusMode, slaveHexaAddress=slaveHexaAddress, sessionStarted=sessionStarted, portTable=portTable)
