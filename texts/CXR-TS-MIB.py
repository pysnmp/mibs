...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:40:12 2022
...
ModuleIdentity, MibIdentifier, Counter32, NotificationType, Gauge32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, NotificationType, Counter64, IpAddress, ObjectIdentity, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Counter32", "NotificationType", "Gauge32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", snmpTrapAddr1=snmpTrapAddr1, reset=reset, beforeSend=beforeSend, secondGateway=secondGateway, aliasIpNetmask=aliasIpNetmask, portTable=portTable, snmpTrapAddr2=snmpTrapAddr2, portStatsTable=portStatsTable, snmpTrap=snmpTrap, mode=mode, dtrUp=dtrUp, authType=authType, nameServer2=nameServer2, afterSend=afterSend, secondTcpPort=secondTcpPort, nameServer1=nameServer1, snmpdService=snmpdService, modbusTable=modbusTable, version=version, terminalType=terminalType, slaveIPport=slaveIPport, gatewayToRemote=gatewayToRemote, ipNetmask=ipNetmask, remoteTcpPort=remoteTcpPort, modbusType=modbusType, secondIpAddress=secondIpAddress, formFeed=formFeed, ethernetAddress=ethernetAddress, aliasIpAddress=aliasIpAddress, modbusEntry=modbusEntry, flowControl=flowControl, bootp=bootp, bytesReceiveFromV24=bytesReceiveFromV24, statusDTR=statusDTR, endMsg=endMsg, sessionStopped=sessionStopped, portEntry=portEntry, txIdle=txIdle, nameResolution=nameResolution, slaveHexaAddress=slaveHexaAddress, baudRate=baudRate, acctRad1=acctRad1, portStatsEntry=portStatsEntry, ipServer=ipServer, productName=productName, system=system, httpdService=httpdService, modbusMode=modbusMode, portIndex=portIndex, authRad1=authRad1, telnetdService=telnetdService, mainIpAddress=mainIpAddress, portReset=portReset, tcpPort=tcpPort, radiusServer1=radiusServer1, rxIdle=rxIdle, bytesSendToV24=bytesSendToV24, timeoutPAD=timeoutPAD, acctRad2=acctRad2, nbParStop=nbParStop, remoteIpAddress=remoteIpAddress, timeoutRxTx=timeoutRxTx, slaveIPaddr=slaveIPaddr, resetByButton=resetByButton, ipGateway=ipGateway, cxr=cxr, radiusSecret2=radiusSecret2, ftpdService=ftpdService, radiusServer2=radiusServer2, siteName=siteName, authRad2=authRad2, interFrame=interFrame, multiSession=multiSession, sessionStarted=sessionStarted, ts=ts, dtrDown=dtrDown, radiusSecret1=radiusSecret1)
