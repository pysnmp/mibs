...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:43:25 2022
...
Bits, iso, Unsigned32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, NotificationType, ObjectIdentity, NotificationType, Counter32, IpAddress, ModuleIdentity, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Unsigned32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "NotificationType", "ObjectIdentity", "NotificationType", "Counter32", "IpAddress", "ModuleIdentity", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("CXR-TS-MIB", bytesReceiveFromV24=bytesReceiveFromV24, beforeSend=beforeSend, remoteTcpPort=remoteTcpPort, slaveIPport=slaveIPport, version=version, tcpPort=tcpPort, modbusMode=modbusMode, secondIpAddress=secondIpAddress, remoteIpAddress=remoteIpAddress, nbParStop=nbParStop, resetByButton=resetByButton, httpdService=httpdService, ipNetmask=ipNetmask, aliasIpAddress=aliasIpAddress, portStatsTable=portStatsTable, nameServer1=nameServer1, portEntry=portEntry, statusDTR=statusDTR, radiusSecret2=radiusSecret2, reset=reset, baudRate=baudRate, formFeed=formFeed, ethernetAddress=ethernetAddress, authType=authType, authRad1=authRad1, system=system, radiusServer2=radiusServer2, ftpdService=ftpdService, gatewayToRemote=gatewayToRemote, multiSession=multiSession, portStatsEntry=portStatsEntry, acctRad1=acctRad1, portTable=portTable, afterSend=afterSend, snmpTrapAddr2=snmpTrapAddr2, timeoutRxTx=timeoutRxTx, secondGateway=secondGateway, interFrame=interFrame, modbusTable=modbusTable, bytesSendToV24=bytesSendToV24, aliasIpNetmask=aliasIpNetmask, telnetdService=telnetdService, ipServer=ipServer, dtrDown=dtrDown, radiusServer1=radiusServer1, portReset=portReset, timeoutPAD=timeoutPAD, slaveHexaAddress=slaveHexaAddress, rxIdle=rxIdle, txIdle=txIdle, sessionStopped=sessionStopped, modbusType=modbusType, acctRad2=acctRad2, sessionStarted=sessionStarted, endMsg=endMsg, siteName=siteName, dtrUp=dtrUp, portIndex=portIndex, mainIpAddress=mainIpAddress, terminalType=terminalType, snmpTrap=snmpTrap, snmpdService=snmpdService, secondTcpPort=secondTcpPort, ts=ts, authRad2=authRad2, nameServer2=nameServer2, radiusSecret1=radiusSecret1, nameResolution=nameResolution, cxr=cxr, mode=mode, bootp=bootp, slaveIPaddr=slaveIPaddr, ipGateway=ipGateway, flowControl=flowControl, productName=productName, snmpTrapAddr1=snmpTrapAddr1, modbusEntry=modbusEntry)
