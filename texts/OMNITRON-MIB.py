...
OstModeType, OstPortList, omnitron, icAgent, OstVlanId, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstPortList", "omnitron", "icAgent", "OstVlanId", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", portSFPTable=portSFPTable, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modPcbRev=modPcbRev, chassis=chassis, moduleVLANEntry=moduleVLANEntry, txOctets64=txOctets64, ahEnabled=ahEnabled, ostEnvironmentalTemperature=ostEnvironmentalTemperature, dhcpPortNumber=dhcpPortNumber, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, serialnum=serialnum, index=index, portSfpDateCode=portSfpDateCode, snmpv3SecurityLevel=snmpv3SecurityLevel, portingresssecurity=portingresssecurity, PYSNMP_MODULE_ID=omnitronMIB, portEgressQosPolicy=portEgressQosPolicy, snmpv3UserType=snmpv3UserType, traphost8=traphost8, gateway=gateway, ostProtocolStatusState=ostProtocolStatusState, portSFPpageA0=portSFPpageA0, omnitronProducts=omnitronProducts, snmpv3AuthPassword=snmpv3AuthPassword, modswbuildnum=modswbuildnum, rxFCSErrors=rxFCSErrors, ahLpbkMode=ahLpbkMode, rxOctets64=rxOctets64, omnitronSFPGroup=omnitronSFPGroup, extended6=extended6, wrswitch=wrswitch, ahRemoteMode=ahRemoteMode, modslotnum=modslotnum, rxDropPkts=rxDropPkts, portSfpBiasCurrent=portSfpBiasCurrent, modextfeaturebits=modextfeaturebits, selfSlot=selfSlot, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, portSfpVendorSerialNumber=portSfpVendorSerialNumber, rxSymbolErrors=rxSymbolErrors, portFwdCpuList=portFwdCpuList, portSfpRxPower=portSfpRxPower, portStatsEntry=portStatsEntry, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, macAddr=macAddr, nmmIpProtocolState=nmmIpProtocolState, modname=modname, modulePortsTable=modulePortsTable, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, modvlanTableClear=modvlanTableClear, extended1=extended1, portSfpVendorPartNumber=portSfpVendorPartNumber, portAccessType=portAccessType, muxGroupDefaults=muxGroupDefaults, modreset=modreset, ahFramePeriodEventTotal=ahFramePeriodEventTotal, defaultForwardingMap=defaultForwardingMap, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portMacAddress=portMacAddress, dhcpIpAddr=dhcpIpAddr, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, writeCommunity=writeCommunity, ahCriticalEventTrapList=ahCriticalEventTrapList, traphost1=traphost1, subnetmask=subnetmask, serialpass=serialpass, portDuplex=portDuplex, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ipaddr2EVCassociation=ipaddr2EVCassociation, txCollisions=txCollisions, rxOversizePkts=rxOversizePkts, portIngressRate=portIngressRate, portLinkState=portLinkState, rxPackets1024to1518=rxPackets1024to1518, txMultipleCollision=txMultipleCollision, dhcpTagVid=dhcpTagVid, rxPausePkts=rxPausePkts, ipaddrEVCassociation=ipaddrEVCassociation, traphost4=traphost4, chassisTable=chassisTable, modeType=modeType, rxPackets256to511=rxPackets256to511, rxOctets=rxOctets, moduleEntry=moduleEntry, tftpEnable=tftpEnable, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, modulePortsEntry=modulePortsEntry, traphost2=traphost2, modLM80misc=modLM80misc, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portStatsClear=portStatsClear, slaveWrite=slaveWrite, txDeferedTransmit=txDeferedTransmit, portegresspolicy=portegresspolicy, slaveTrapsForward=slaveTrapsForward, switchstat=switchstat, traphost6=traphost6, chassistype=chassistype, ahRemoteLinkPort=ahRemoteLinkPort, nmmOAMmgmtMode=nmmOAMmgmtMode, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, validityflag=validityflag, txDropPkts=txDropPkts, ahLocalSupportVar=ahLocalSupportVar, modHwRev=modHwRev, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, userEntry=userEntry, dhcptftpServerIpAddress=dhcptftpServerIpAddress, txMulticastPkts=txMulticastPkts, cnodeControl=cnodeControl, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, modenable802dot1qProcessing=modenable802dot1qProcessing, slotnum=slotnum, ostProtocolStatusTable=ostProtocolStatusTable, ahLocalOUI=ahLocalOUI, omnitronMIB=omnitronMIB, extended5=extended5, modpartnum=modpartnum, ahLocalMuxState=ahLocalMuxState, chassisname=chassisname, extended2=extended2, modmanufdate=modmanufdate, traphost7=traphost7, modchassname=modchassname, modprodrev=modprodrev, portAHEntry=portAHEntry, omnitronCompliances=omnitronCompliances, traphost3=traphost3, cnodeCIR=cnodeCIR, portSfpTxPower=portSfpTxPower, port2Membership=port2Membership, enableSNMPFunction=enableSNMPFunction, portSFPEntry=portSFPEntry, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ahErroredFrameThreshold=ahErroredFrameThreshold, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portpriority=portpriority, omnitronCompliance=omnitronCompliance, rxMulticastPkts=rxMulticastPkts, keepAliveInterval=keepAliveInterval, port3Membership=port3Membership, vlanIdOst=vlanIdOst, portmlistcriteria=portmlistcriteria, ingressPolicingType=ingressPolicingType, ahErroredFrameWindow=ahErroredFrameWindow, txPausePkts=txPausePkts, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ledstat=ledstat, txBroadcastPkts=txBroadcastPkts, ahFrameErrorEventTotal=ahFrameErrorEventTotal, txErrorPkts=txErrorPkts, portEgressRate=portEgressRate, dhcpSubnetmask=dhcpSubnetmask, extended3=extended3, rxCRCAlignErrors=rxCRCAlignErrors, txLateCollision=txLateCollision, modserialnum=modserialnum, txExcessiveCollision=txExcessiveCollision, ahLocalMode=ahLocalMode, gateway2=gateway2, txGoodPkts=txGoodPkts, rxTotalPkts=rxTotalPkts, modsoftrev=modsoftrev, ostProtocolStatusIndex=ostProtocolStatusIndex, nmmCfgState=nmmCfgState, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portvlanidentifier=portvlanidentifier, ahLocalParserState=ahLocalParserState, rxPackets512to1023=rxPackets512to1023, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, enabledFunctions=enabledFunctions, modprodtype=modprodtype, trapSrcIpSelect=trapSrcIpSelect, modExpSoftwareRev=modExpSoftwareRev, prodrev=prodrev, portSfpBitRate=portSfpBitRate, txOctets=txOctets, manufdate=manufdate, sysloc=sysloc, ftppasswrd=ftppasswrd, txSingleCollision=txSingleCollision, nmmSecureConnState=nmmSecureConnState, moduleMgtCfgEntry=moduleMgtCfgEntry, prodtype=prodtype, ostProtocolStatusType=ostProtocolStatusType, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, userIndex=userIndex, portSfpTemperature=portSfpTemperature, modulename=modulename, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portFwdCpu=portFwdCpu, vlanidentifier=vlanidentifier, telnetpass=telnetpass, modportvlan=modportvlan, ahRemoteOUI=ahRemoteOUI, port4Membership=port4Membership, nmmIpDisabled=nmmIpDisabled, portcanonicalformatIndicator=portcanonicalformatIndicator, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, servicetag=servicetag, portSpeed=portSpeed, rxUnicastPkts=rxUnicastPkts, modFpgaRev=modFpgaRev, port5Membership=port5Membership, modtagsubstitution=modtagsubstitution, enhancedchassisTable=enhancedchassisTable, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, modchasstype=modchasstype, readCommunity=readCommunity, capsMask=capsMask, portAHTable=portAHTable, port6Membership=port6Membership, extended4=extended4, ahTransmissionRate=ahTransmissionRate, portIngressRateCBS=portIngressRateCBS, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, slaveTraps=slaveTraps, ostProtocoManagementPort=ostProtocoManagementPort, traphost5=traphost5, cpuTemperature=cpuTemperature, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, bootpEnable=bootpEnable, portSFPpageA2=portSFPpageA2, rxPackets65to127=rxPackets65to127, portIngressRateDropOrPause=portIngressRateDropOrPause, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, coreStatusOnly=coreStatusOnly, partnum=partnum, dhcpGateway=dhcpGateway, rxGoodPkts=rxGoodPkts, cpuVoltageIn=cpuVoltageIn, nmmSecureMode=nmmSecureMode, mychassnum=mychassnum, omnitronGroups=omnitronGroups, rxFragments=rxFragments, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahLocalLinkFlags=ahLocalLinkFlags, rxPackets128to255=rxPackets128to255, portSfpVendorName=portSfpVendorName, portStatsTable=portStatsTable, portnum=portnum, modLM80currents=modLM80currents, enableSNMPWrites=enableSNMPWrites, chassisEntry=chassisEntry, modcommitVLANchanges=modcommitVLANchanges, resetmod=resetmod, snmpTrapType=snmpTrapType, ostProtocolStatusEntry=ostProtocolStatusEntry, portState=portState, rxUndersizePkts=rxUndersizePkts, tftpServerIpAddress=tftpServerIpAddress, sysDateTime=sysDateTime, subnetmask2=subnetmask2)
mibBuilder.exportSymbols("OMNITRON-MIB", ipAddr2=ipAddr2, moduleMgtCfgTable=moduleMgtCfgTable, txUnicastPkts=txUnicastPkts, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, snmpv3UserName=snmpv3UserName, mmname=mmname, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, moduleVLANTable=moduleVLANTable, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portL2CPmgntProcessing=portL2CPmgntProcessing, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, modnumports=modnumports, omnitronGroup=omnitronGroup, chassisnum=chassisnum, moduleCount=moduleCount, softrev=softrev, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ahRemoteLinkFlags=ahRemoteLinkFlags, managementModule=managementModule, userTable=userTable, ahRemoteSupportVar=ahRemoteSupportVar, modExpLedStatus=modExpLedStatus, enableSNMPv3Function=enableSNMPv3Function, vlanservicetag=vlanservicetag, modExpPartNumber=modExpPartNumber, portSFPstatus=portSFPstatus, ahCriticalEventMode=ahCriticalEventMode, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, customertag=customertag, ahClearStatistics=ahClearStatistics, modRestoreFactoryDefaults=modRestoreFactoryDefaults, cpuVoltageOut=cpuVoltageOut, txDroppedEvents=txDroppedEvents, omnitronConformance=omnitronConformance, ahRemoteParserState=ahRemoteParserState, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portSfpVcc=portSfpVcc, rxErrorPkts=rxErrorPkts, sysAdminStatus=sysAdminStatus, ahRemoteMuxState=ahRemoteMuxState, moduleTable=moduleTable, snmpv3PrivPassword=snmpv3PrivPassword, vlanPri=vlanPri, modchassnum=modchassnum, tftpFileName=tftpFileName, rxBroadcastPkts=rxBroadcastPkts, syscon=syscon, ipAddr=ipAddr, rxAlignmentErrors=rxAlignmentErrors, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modLM80volts=modLM80volts, rxJabbers=rxJabbers, port1Membership=port1Membership, rxPackets64=rxPackets64, prodAgent=prodAgent)
