...
mibBuilder.exportSymbols("OMNITRON-MIB", muxGroupDefaults=muxGroupDefaults, ipAddr=ipAddr, ostEnvironmentalTemperature=ostEnvironmentalTemperature, telnetpass=telnetpass, modportvlan=modportvlan, extended2=extended2, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, moduleMgtCfgTable=moduleMgtCfgTable, rxGoodPkts=rxGoodPkts, portIngressRateCBS=portIngressRateCBS, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, softrev=softrev, ipaddrEVCassociation=ipaddrEVCassociation, portcanonicalformatIndicator=portcanonicalformatIndicator, rxPackets64=rxPackets64, ahCriticalEventTrapList=ahCriticalEventTrapList, modLM80currents=modLM80currents, rxDropPkts=rxDropPkts, portLinkState=portLinkState, port4Membership=port4Membership, ftppasswrd=ftppasswrd, modHwRev=modHwRev, modLM80misc=modLM80misc, modtagsubstitution=modtagsubstitution, enableSNMPWrites=enableSNMPWrites, rxPackets512to1023=rxPackets512to1023, modenable802dot1qProcessing=modenable802dot1qProcessing, portingresssecurity=portingresssecurity, txMultipleCollision=txMultipleCollision, portSFPEntry=portSFPEntry, port5Membership=port5Membership, portnum=portnum, moduleVLANTable=moduleVLANTable, port3Membership=port3Membership, txOctets64=txOctets64, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, switchstat=switchstat, vlanPri=vlanPri, slaveTraps=slaveTraps, portStatsClear=portStatsClear, rxFragments=rxFragments, slaveTrapsForward=slaveTrapsForward, portSfpTemperature=portSfpTemperature, rxPackets1024to1518=rxPackets1024to1518, modchassnum=modchassnum, serialpass=serialpass, partnum=partnum, portSFPpageA2=portSFPpageA2, moduleEntry=moduleEntry, ahLocalParserState=ahLocalParserState, PYSNMP_MODULE_ID=omnitronMIB, txDroppedEvents=txDroppedEvents, cpuVoltageOut=cpuVoltageOut, modreset=modreset, extended4=extended4, gateway=gateway, snmpv3PrivPassword=snmpv3PrivPassword, tftpEnable=tftpEnable, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, rxUndersizePkts=rxUndersizePkts, txDropPkts=txDropPkts, ostProtocolStatusEntry=ostProtocolStatusEntry, modExpLedStatus=modExpLedStatus, cnodeControl=cnodeControl, dhcpTagVid=dhcpTagVid, omnitronCompliance=omnitronCompliance, portAHTable=portAHTable, dhcpIpAddr=dhcpIpAddr, ingressPolicingType=ingressPolicingType, chassisname=chassisname, enhancedchassisTable=enhancedchassisTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ahRemoteLinkPort=ahRemoteLinkPort, manufdate=manufdate, modExpPartNumber=modExpPartNumber, ahFrameErrorEventTotal=ahFrameErrorEventTotal, managementModule=managementModule, sysloc=sysloc, bootpEnable=bootpEnable, rxPackets256to511=rxPackets256to511, ostProtocolStatusIndex=ostProtocolStatusIndex, portL2CPmgntProcessing=portL2CPmgntProcessing, capsMask=capsMask, portSfpRxPower=portSfpRxPower, modRestoreFactoryDefaults=modRestoreFactoryDefaults, resetmod=resetmod, traphost4=traphost4, portSfpBiasCurrent=portSfpBiasCurrent, portpriority=portpriority, prodtype=prodtype, modprodtype=modprodtype, gateway2=gateway2, modcommitVLANchanges=modcommitVLANchanges, portIngressRateDropOrPause=portIngressRateDropOrPause, chassistype=chassistype, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahRemoteMode=ahRemoteMode, txErrorPkts=txErrorPkts, snmpTrapType=snmpTrapType, sysAdminStatus=sysAdminStatus, modextfeaturebits=modextfeaturebits, ostProtocolStatusTable=ostProtocolStatusTable, rxOctets64=rxOctets64, prodrev=prodrev, vlanservicetag=vlanservicetag, nmmIpDisabled=nmmIpDisabled, extended6=extended6, txBroadcastPkts=txBroadcastPkts, modvlanTableClear=modvlanTableClear, enableSNMPv3Function=enableSNMPv3Function, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, rxErrorPkts=rxErrorPkts, portAHEntry=portAHEntry, ahLocalLinkFlags=ahLocalLinkFlags, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahRemoteLinkFlags=ahRemoteLinkFlags, ostProtocolStatusType=ostProtocolStatusType, rxMulticastPkts=rxMulticastPkts, portStatsEntry=portStatsEntry, subnetmask2=subnetmask2, ostProtocolStatusState=ostProtocolStatusState, rxFCSErrors=rxFCSErrors, txSingleCollision=txSingleCollision, tftpServerIpAddress=tftpServerIpAddress, rxUnicastPkts=rxUnicastPkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, nmmSecureSlaveSlot=nmmSecureSlaveSlot, writeCommunity=writeCommunity, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ipAddr2=ipAddr2, enableSNMPFunction=enableSNMPFunction, moduleCount=moduleCount, ipaddr2EVCassociation=ipaddr2EVCassociation, trapSrcIpSelect=trapSrcIpSelect, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, modsoftrev=modsoftrev, defaultForwardingMap=defaultForwardingMap, nmmSecureMode=nmmSecureMode, index=index, omnitronConformance=omnitronConformance, traphost2=traphost2, txUnicastPkts=txUnicastPkts, modprodrev=modprodrev, cnodeCIR=cnodeCIR, modmanufdate=modmanufdate, ledstat=ledstat, txExcessiveCollision=txExcessiveCollision, ahRemoteParserState=ahRemoteParserState, ahErroredFrameWindow=ahErroredFrameWindow, modcommitNMMCfgChanges=modcommitNMMCfgChanges, nmmCfgState=nmmCfgState, userTable=userTable, ahEnabled=ahEnabled, omnitronGroups=omnitronGroups, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, modExpSoftwareRev=modExpSoftwareRev, rxJabbers=rxJabbers, rxPausePkts=rxPausePkts, keepAliveInterval=keepAliveInterval, cpuTemperature=cpuTemperature, ahRemoteMuxState=ahRemoteMuxState, slaveWrite=slaveWrite, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, chassisnum=chassisnum, coreStatusOnly=coreStatusOnly, modeType=modeType, ahLocalMuxState=ahLocalMuxState, customertag=customertag, modLM80volts=modLM80volts, portSfpVendorName=portSfpVendorName, snmpv3SecurityLevel=snmpv3SecurityLevel, portSfpBitRate=portSfpBitRate, userIndex=userIndex, portEgressRate=portEgressRate, snmpv3UserName=snmpv3UserName, validityflag=validityflag, snmpv3UserType=snmpv3UserType, ostProtocoManagementPort=ostProtocoManagementPort, modPcbRev=modPcbRev, snmpv3AuthPassword=snmpv3AuthPassword, portMacAddress=portMacAddress, rxPackets65to127=rxPackets65to127, omnitronMIB=omnitronMIB, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, port1Membership=port1Membership, port2Membership=port2Membership, portSfpDateCode=portSfpDateCode, mmname=mmname, vlanIdOst=vlanIdOst, txGoodPkts=txGoodPkts, traphost5=traphost5, chassisTable=chassisTable, tftpFileName=tftpFileName, portEgressQosPolicy=portEgressQosPolicy, slotnum=slotnum, ahLocalSupportVar=ahLocalSupportVar, txPausePkts=txPausePkts, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, selfSlot=selfSlot, portSfpVendorPartNumber=portSfpVendorPartNumber, modchasstype=modchasstype, servicetag=servicetag, modnumports=modnumports, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, modulePortsEntry=modulePortsEntry, traphost6=traphost6, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahErroredFrameThreshold=ahErroredFrameThreshold, vlanidentifier=vlanidentifier, omnitronProducts=omnitronProducts, traphost1=traphost1, modslotnum=modslotnum, readCommunity=readCommunity, txDeferedTransmit=txDeferedTransmit, txMulticastPkts=txMulticastPkts, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, port6Membership=port6Membership, rxAlignmentErrors=rxAlignmentErrors, portSfpVcc=portSfpVcc, modname=modname, portSFPstatus=portSFPstatus, ahTransmissionRate=ahTransmissionRate, moduleVLANEntry=moduleVLANEntry, portSpeed=portSpeed, syscon=syscon, prodAgent=prodAgent, modchassname=modchassname, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, rxSymbolErrors=rxSymbolErrors, portStatsTable=portStatsTable, ahCriticalEventMode=ahCriticalEventMode, portSFPTable=portSFPTable, dhcpSubnetmask=dhcpSubnetmask, extended5=extended5, dhcpPortNumber=dhcpPortNumber, modserialnum=modserialnum, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ahClearStatistics=ahClearStatistics, rxOversizePkts=rxOversizePkts, rxCRCAlignErrors=rxCRCAlignErrors, modFpgaRev=modFpgaRev, omnitronCompliances=omnitronCompliances, portFwdCpu=portFwdCpu, portSfpTxPower=portSfpTxPower, ahLocalOUI=ahLocalOUI, rxOctets=rxOctets, modswbuildnum=modswbuildnum, nmmSecureConnState=nmmSecureConnState, extended3=extended3)
mibBuilder.exportSymbols("OMNITRON-MIB", modpartnum=modpartnum, nmmOAMmgmtMode=nmmOAMmgmtMode, traphost3=traphost3, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, cpuVoltageIn=cpuVoltageIn, traphost8=traphost8, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahLpbkMode=ahLpbkMode, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portState=portState, userEntry=userEntry, portmlistcriteria=portmlistcriteria, nmmIpProtocolState=nmmIpProtocolState, portIngressRate=portIngressRate, txOctets=txOctets, portDuplex=portDuplex, ahRemoteOUI=ahRemoteOUI, subnetmask=subnetmask, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ahLocalMode=ahLocalMode, mychassnum=mychassnum, rxTotalPkts=rxTotalPkts, modulePortsTable=modulePortsTable, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portSFPpageA0=portSFPpageA0, rxBroadcastPkts=rxBroadcastPkts, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, chassisEntry=chassisEntry, traphost7=traphost7, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, serialnum=serialnum, portvlanidentifier=portvlanidentifier, portAccessType=portAccessType, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, dhcpGateway=dhcpGateway, modulename=modulename, enabledFunctions=enabledFunctions, portFwdCpuList=portFwdCpuList, rxPackets128to255=rxPackets128to255, moduleTable=moduleTable, macAddr=macAddr, wrswitch=wrswitch, txLateCollision=txLateCollision, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, omnitronGroup=omnitronGroup, sysDateTime=sysDateTime, chassis=chassis, moduleMgtCfgEntry=moduleMgtCfgEntry, ahRemoteSupportVar=ahRemoteSupportVar, txCollisions=txCollisions, portegresspolicy=portegresspolicy, ahLocalLpbkTimeout=ahLocalLpbkTimeout, extended1=extended1, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, omnitronSFPGroup=omnitronSFPGroup)
