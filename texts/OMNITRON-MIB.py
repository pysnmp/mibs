...
OstVlanId, OstModeType, OstPortList, OstPortNumber, icAgent, omnitron = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "OstModeType", "OstPortList", "OstPortNumber", "icAgent", "omnitron")
...
mibBuilder.exportSymbols("OMNITRON-MIB", chassisTable=chassisTable, txGoodPkts=txGoodPkts, ahLocalParserState=ahLocalParserState, nmmCfgState=nmmCfgState, omnitronCompliances=omnitronCompliances, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, rxFragments=rxFragments, switchstat=switchstat, modname=modname, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, rxOctets=rxOctets, portSFPpageA2=portSFPpageA2, rxFCSErrors=rxFCSErrors, slaveWrite=slaveWrite, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, enabledFunctions=enabledFunctions, portSfpVendorSerialNumber=portSfpVendorSerialNumber, moduleMgtCfgEntry=moduleMgtCfgEntry, cpuVoltageIn=cpuVoltageIn, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ftppasswrd=ftppasswrd, rxPackets65to127=rxPackets65to127, modtagsubstitution=modtagsubstitution, ostProtocolStatusIndex=ostProtocolStatusIndex, ostEnvironmentalTemperature=ostEnvironmentalTemperature, vlanservicetag=vlanservicetag, txOctets=txOctets, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, txLateCollision=txLateCollision, portFwdCpu=portFwdCpu, port2Membership=port2Membership, portSfpDateCode=portSfpDateCode, prodtype=prodtype, snmpv3SecurityLevel=snmpv3SecurityLevel, txDroppedEvents=txDroppedEvents, chassisname=chassisname, ipAddr2=ipAddr2, traphost8=traphost8, cnodeCIR=cnodeCIR, sysDateTime=sysDateTime, ahRemoteMuxState=ahRemoteMuxState, modnumports=modnumports, ahLocalMuxState=ahLocalMuxState, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, muxGroupDefaults=muxGroupDefaults, slaveTraps=slaveTraps, ahLocalSupportVar=ahLocalSupportVar, ahRemoteLinkPort=ahRemoteLinkPort, capsMask=capsMask, modPcbRev=modPcbRev, port5Membership=port5Membership, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, txUnicastPkts=txUnicastPkts, ostProtocoManagementPort=ostProtocoManagementPort, omnitronProducts=omnitronProducts, ipaddrEVCassociation=ipaddrEVCassociation, sysAdminStatus=sysAdminStatus, traphost2=traphost2, moduleVLANTable=moduleVLANTable, ahRemoteOUI=ahRemoteOUI, port6Membership=port6Membership, rxDropPkts=rxDropPkts, modslotnum=modslotnum, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, omnitronSFPGroup=omnitronSFPGroup, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, rxOctets64=rxOctets64, modulePortsEntry=modulePortsEntry, portLinkState=portLinkState, subnetmask2=subnetmask2, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ahErroredFrameThreshold=ahErroredFrameThreshold, modExpSoftwareRev=modExpSoftwareRev, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portmlistcriteria=portmlistcriteria, nmmSecureMode=nmmSecureMode, ahLocalOUI=ahLocalOUI, portL2CPmgntProcessing=portL2CPmgntProcessing, portDuplex=portDuplex, rxUnicastPkts=rxUnicastPkts, portSfpBiasCurrent=portSfpBiasCurrent, enableSNMPv3Function=enableSNMPv3Function, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, portEgressQosPolicy=portEgressQosPolicy, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, nmmIpProtocolState=nmmIpProtocolState, subnetmask=subnetmask, extended4=extended4, modenable802dot1qProcessing=modenable802dot1qProcessing, traphost1=traphost1, txDropPkts=txDropPkts, rxJabbers=rxJabbers, txBroadcastPkts=txBroadcastPkts, gateway2=gateway2, enhancedchassisTable=enhancedchassisTable, port4Membership=port4Membership, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portFwdCpuList=portFwdCpuList, resetmod=resetmod, ahErroredFrameWindow=ahErroredFrameWindow, ledstat=ledstat, mmname=mmname, portSfpRxPower=portSfpRxPower, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modLM80currents=modLM80currents, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, omnitronConformance=omnitronConformance, modcommitVLANchanges=modcommitVLANchanges, vlanidentifier=vlanidentifier, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portSFPstatus=portSFPstatus, omnitronGroups=omnitronGroups, traphost4=traphost4, modcommitNMMCfgChanges=modcommitNMMCfgChanges, txOctets64=txOctets64, modFpgaRev=modFpgaRev, txSingleCollision=txSingleCollision, dhcpTagVid=dhcpTagVid, portStatsEntry=portStatsEntry, portSfpVendorPartNumber=portSfpVendorPartNumber, serialpass=serialpass, txDeferedTransmit=txDeferedTransmit, txMultipleCollision=txMultipleCollision, rxCRCAlignErrors=rxCRCAlignErrors, dhcpGateway=dhcpGateway, portcanonicalformatIndicator=portcanonicalformatIndicator, portpriority=portpriority, customertag=customertag, rxPackets256to511=rxPackets256to511, vlanIdOst=vlanIdOst, ahLpbkMode=ahLpbkMode, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxPackets512to1023=rxPackets512to1023, ingressPolicingType=ingressPolicingType, nmmSecureSlaveSlot=nmmSecureSlaveSlot, modExpLedStatus=modExpLedStatus, moduleCount=moduleCount, readCommunity=readCommunity, port1Membership=port1Membership, portAHTable=portAHTable, ahLocalLinkFlags=ahLocalLinkFlags, ahRemoteMode=ahRemoteMode, portStatsClear=portStatsClear, traphost7=traphost7, enableSNMPFunction=enableSNMPFunction, gateway=gateway, moduleMgtCfgTable=moduleMgtCfgTable, keepAliveInterval=keepAliveInterval, ipaddr2EVCassociation=ipaddr2EVCassociation, extended3=extended3, modportvlan=modportvlan, dhcpIpAddr=dhcpIpAddr, ahFrameErrorEventTotal=ahFrameErrorEventTotal, index=index, txPausePkts=txPausePkts, snmpv3AuthPassword=snmpv3AuthPassword, modchassnum=modchassnum, port3Membership=port3Membership, chassisEntry=chassisEntry, modsoftrev=modsoftrev, servicetag=servicetag, rxAlignmentErrors=rxAlignmentErrors, portEgressRate=portEgressRate, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portSfpTxPower=portSfpTxPower, ahClearStatistics=ahClearStatistics, tftpEnable=tftpEnable, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, txErrorPkts=txErrorPkts, rxOversizePkts=rxOversizePkts, modswbuildnum=modswbuildnum, portingresssecurity=portingresssecurity, extended1=extended1, omnitronCompliance=omnitronCompliance, PYSNMP_MODULE_ID=omnitronMIB, portSfpTemperature=portSfpTemperature, coreStatusOnly=coreStatusOnly, portSFPTable=portSFPTable, omnitronGroup=omnitronGroup, ostProtocolStatusEntry=ostProtocolStatusEntry, rxPackets64=rxPackets64, rxPausePkts=rxPausePkts, serialnum=serialnum, txCollisions=txCollisions, ahCriticalEventMode=ahCriticalEventMode, rxGoodPkts=rxGoodPkts, modExpPartNumber=modExpPartNumber, managementModule=managementModule, rxMulticastPkts=rxMulticastPkts, tftpServerIpAddress=tftpServerIpAddress, traphost3=traphost3, txMulticastPkts=txMulticastPkts, portSFPEntry=portSFPEntry, tftpFileName=tftpFileName, portStatsTable=portStatsTable, userEntry=userEntry, modHwRev=modHwRev, portIngressRate=portIngressRate, modLM80volts=modLM80volts, trapSrcIpSelect=trapSrcIpSelect, traphost6=traphost6, cnodeControl=cnodeControl, modchasstype=modchasstype, rxTotalPkts=rxTotalPkts, userTable=userTable, macAddr=macAddr, defaultForwardingMap=defaultForwardingMap, txExcessiveCollision=txExcessiveCollision, portSfpVendorName=portSfpVendorName, modprodrev=modprodrev, rxSymbolErrors=rxSymbolErrors, portvlanidentifier=portvlanidentifier, rxPackets128to255=rxPackets128to255, selfSlot=selfSlot, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modchassname=modchassname, nmmSecureConnState=nmmSecureConnState, omnitronMIB=omnitronMIB, sysloc=sysloc, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ostProtocolStatusState=ostProtocolStatusState, cpuVoltageOut=cpuVoltageOut, extended5=extended5, snmpv3PrivPassword=snmpv3PrivPassword, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, writeCommunity=writeCommunity, modulePortsTable=modulePortsTable, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSFPpageA0=portSFPpageA0, modeType=modeType, ahRemoteSupportVar=ahRemoteSupportVar, validityflag=validityflag, vlanPri=vlanPri, modRestoreFactoryDefaults=modRestoreFactoryDefaults, moduleEntry=moduleEntry, portIngressRateCBS=portIngressRateCBS, modpartnum=modpartnum, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modmanufdate=modmanufdate, nmmIpDisabled=nmmIpDisabled, portSpeed=portSpeed, extended6=extended6, portAHEntry=portAHEntry, rxUndersizePkts=rxUndersizePkts, ahEnabled=ahEnabled, portSfpVcc=portSfpVcc, portAccessType=portAccessType, modserialnum=modserialnum, partnum=partnum, modLM80misc=modLM80misc, modextfeaturebits=modextfeaturebits)
mibBuilder.exportSymbols("OMNITRON-MIB", softrev=softrev, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahCriticalEventTrapList=ahCriticalEventTrapList, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, traphost5=traphost5, chassistype=chassistype, portState=portState, enableSNMPWrites=enableSNMPWrites, ostProtocolStatusType=ostProtocolStatusType, rxBroadcastPkts=rxBroadcastPkts, userIndex=userIndex, rxErrorPkts=rxErrorPkts, extended2=extended2, ahLocalMode=ahLocalMode, snmpTrapType=snmpTrapType, modulename=modulename, bootpEnable=bootpEnable, chassisnum=chassisnum, ahRemoteLinkFlags=ahRemoteLinkFlags, snmpv3UserType=snmpv3UserType, rxPackets1024to1518=rxPackets1024to1518, nmmOAMmgmtMode=nmmOAMmgmtMode, modprodtype=modprodtype, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, mychassnum=mychassnum, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portegresspolicy=portegresspolicy, telnetpass=telnetpass, moduleVLANEntry=moduleVLANEntry, chassis=chassis, prodrev=prodrev, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, portIngressRateDropOrPause=portIngressRateDropOrPause, portnum=portnum, wrswitch=wrswitch, modvlanTableClear=modvlanTableClear, dhcpPortNumber=dhcpPortNumber, syscon=syscon, ahRemoteParserState=ahRemoteParserState, cpuTemperature=cpuTemperature, modreset=modreset, dhcpSubnetmask=dhcpSubnetmask, prodAgent=prodAgent, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, manufdate=manufdate, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, slotnum=slotnum, ipAddr=ipAddr, ostProtocolStatusTable=ostProtocolStatusTable, portSfpBitRate=portSfpBitRate, ahTransmissionRate=ahTransmissionRate, portMacAddress=portMacAddress, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, moduleTable=moduleTable, snmpv3UserName=snmpv3UserName, slaveTrapsForward=slaveTrapsForward)
