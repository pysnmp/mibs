...
OstVlanId, OstModeType, omnitron, OstPortNumber, icAgent, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "OstModeType", "omnitron", "OstPortNumber", "icAgent", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", rxJabbers=rxJabbers, modserialnum=modserialnum, portpriority=portpriority, ostProtocolStatusState=ostProtocolStatusState, port1Membership=port1Membership, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ipaddr2EVCassociation=ipaddr2EVCassociation, portSFPEntry=portSFPEntry, slaveWrite=slaveWrite, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, txPausePkts=txPausePkts, enableSNMPv3Function=enableSNMPv3Function, port6Membership=port6Membership, managementModule=managementModule, ahEnabled=ahEnabled, ahLocalMode=ahLocalMode, txCollisions=txCollisions, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, txMulticastPkts=txMulticastPkts, extended2=extended2, chassisnum=chassisnum, portSfpVendorPartNumber=portSfpVendorPartNumber, defaultForwardingMap=defaultForwardingMap, rxOversizePkts=rxOversizePkts, portSfpTxPower=portSfpTxPower, omnitronProducts=omnitronProducts, txBroadcastPkts=txBroadcastPkts, ahErroredFrameWindow=ahErroredFrameWindow, txUnicastPkts=txUnicastPkts, modulePortsEntry=modulePortsEntry, userIndex=userIndex, dhcpPortNumber=dhcpPortNumber, nmmIpProtocolState=nmmIpProtocolState, txDeferedTransmit=txDeferedTransmit, serialnum=serialnum, PYSNMP_MODULE_ID=omnitronMIB, portSfpVendorSerialNumber=portSfpVendorSerialNumber, telnetpass=telnetpass, port4Membership=port4Membership, extended1=extended1, portSfpVcc=portSfpVcc, tftpFileName=tftpFileName, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portFwdCpuList=portFwdCpuList, ingressPolicingType=ingressPolicingType, slaveTraps=slaveTraps, modulePortsTable=modulePortsTable, cnodeCIR=cnodeCIR, modmanufdate=modmanufdate, ipAddr=ipAddr, prodrev=prodrev, ahClearStatistics=ahClearStatistics, partnum=partnum, wrswitch=wrswitch, traphost5=traphost5, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portSFPstatus=portSFPstatus, nmmSecureConnState=nmmSecureConnState, extended4=extended4, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostProtocolStatusIndex=ostProtocolStatusIndex, modPcbRev=modPcbRev, vlanPri=vlanPri, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portSfpDateCode=portSfpDateCode, rxTotalPkts=rxTotalPkts, moduleCount=moduleCount, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portSFPTable=portSFPTable, tftpEnable=tftpEnable, readCommunity=readCommunity, txOctets=txOctets, ostProtocoManagementPort=ostProtocoManagementPort, snmpv3UserType=snmpv3UserType, sysAdminStatus=sysAdminStatus, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modname=modname, portState=portState, moduleVLANEntry=moduleVLANEntry, gateway=gateway, port5Membership=port5Membership, modExpPartNumber=modExpPartNumber, rxCRCAlignErrors=rxCRCAlignErrors, userEntry=userEntry, omnitronGroup=omnitronGroup, ahLocalLpbkTimeout=ahLocalLpbkTimeout, moduleMgtCfgTable=moduleMgtCfgTable, ostEnvironmentalTemperature=ostEnvironmentalTemperature, subnetmask2=subnetmask2, portIngressRate=portIngressRate, portEgressQosPolicy=portEgressQosPolicy, traphost7=traphost7, modFpgaRev=modFpgaRev, rxPackets64=rxPackets64, sysDateTime=sysDateTime, ahRemoteLinkFlags=ahRemoteLinkFlags, portSfpBitRate=portSfpBitRate, rxPackets512to1023=rxPackets512to1023, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portcanonicalformatIndicator=portcanonicalformatIndicator, enableSNMPWrites=enableSNMPWrites, manufdate=manufdate, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ahLocalLinkFlags=ahLocalLinkFlags, ipaddrEVCassociation=ipaddrEVCassociation, modvlanTableClear=modvlanTableClear, nmmIpDisabled=nmmIpDisabled, rxFCSErrors=rxFCSErrors, portMacAddress=portMacAddress, extended6=extended6, modchassnum=modchassnum, modtagsubstitution=modtagsubstitution, chassisname=chassisname, rxGoodPkts=rxGoodPkts, omnitronCompliances=omnitronCompliances, snmpTrapType=snmpTrapType, moduleEntry=moduleEntry, rxBroadcastPkts=rxBroadcastPkts, dhcpTagVid=dhcpTagVid, gateway2=gateway2, ahRemoteParserState=ahRemoteParserState, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, chassisEntry=chassisEntry, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, modLM80misc=modLM80misc, txOctets64=txOctets64, customertag=customertag, ostProtocolStatusType=ostProtocolStatusType, traphost4=traphost4, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modportvlan=modportvlan, ahRemoteLinkPort=ahRemoteLinkPort, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, cpuVoltageIn=cpuVoltageIn, extended5=extended5, rxPausePkts=rxPausePkts, dhcpGateway=dhcpGateway, chassis=chassis, userTable=userTable, ahRemoteMode=ahRemoteMode, macAddr=macAddr, rxDropPkts=rxDropPkts, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modchassname=modchassname, portSfpTemperature=portSfpTemperature, vlanIdOst=vlanIdOst, ahLocalSupportVar=ahLocalSupportVar, portDuplex=portDuplex, txDropPkts=txDropPkts, resetmod=resetmod, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, enableSNMPFunction=enableSNMPFunction, dhcptftpServerIpAddress=dhcptftpServerIpAddress, trapSrcIpSelect=trapSrcIpSelect, omnitronGroups=omnitronGroups, ahCriticalEventMode=ahCriticalEventMode, portegresspolicy=portegresspolicy, rxOctets64=rxOctets64, portStatsClear=portStatsClear, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, port2Membership=port2Membership, ahRemoteSupportVar=ahRemoteSupportVar, portIngressRateDropOrPause=portIngressRateDropOrPause, sysloc=sysloc, traphost6=traphost6, omnitronCompliance=omnitronCompliance, ahLocalMuxState=ahLocalMuxState, validityflag=validityflag, ahTransmissionRate=ahTransmissionRate, ahLocalOUI=ahLocalOUI, ahCriticalEventTrapList=ahCriticalEventTrapList, portIngressRateCBS=portIngressRateCBS, mychassnum=mychassnum, portAHTable=portAHTable, portStatsEntry=portStatsEntry, modprodrev=modprodrev, servicetag=servicetag, vlanidentifier=vlanidentifier, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, cpuTemperature=cpuTemperature, mmname=mmname, ahErroredFrameThreshold=ahErroredFrameThreshold, modenable802dot1qProcessing=modenable802dot1qProcessing, muxGroupDefaults=muxGroupDefaults, modswbuildnum=modswbuildnum, enabledFunctions=enabledFunctions, snmpv3UserName=snmpv3UserName, chassisTable=chassisTable, subnetmask=subnetmask, rxSymbolErrors=rxSymbolErrors, portFwdCpu=portFwdCpu, rxErrorPkts=rxErrorPkts, ipAddr2=ipAddr2, nmmCfgState=nmmCfgState, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portvlanidentifier=portvlanidentifier, omnitronSFPGroup=omnitronSFPGroup, serialpass=serialpass, modLM80currents=modLM80currents, rxFragments=rxFragments, portSfpBiasCurrent=portSfpBiasCurrent, ahRemoteMuxState=ahRemoteMuxState, rxUndersizePkts=rxUndersizePkts, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, dhcpSubnetmask=dhcpSubnetmask, modHwRev=modHwRev, ostProtocolStatusTable=ostProtocolStatusTable, txMultipleCollision=txMultipleCollision, rxUnicastPkts=rxUnicastPkts, capsMask=capsMask, modExpSoftwareRev=modExpSoftwareRev, snmpv3AuthPassword=snmpv3AuthPassword, portLinkState=portLinkState, slaveTrapsForward=slaveTrapsForward, ostProtocolStatusEntry=ostProtocolStatusEntry, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahFramePeriodEventTotal=ahFramePeriodEventTotal, txExcessiveCollision=txExcessiveCollision, switchstat=switchstat, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxPackets65to127=rxPackets65to127, traphost8=traphost8, txLateCollision=txLateCollision, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, writeCommunity=writeCommunity, enhancedchassisTable=enhancedchassisTable, ahLocalParserState=ahLocalParserState, rxPackets128to255=rxPackets128to255, moduleVLANTable=moduleVLANTable, modulename=modulename, rxPackets1024to1518=rxPackets1024to1518, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portSfpVendorName=portSfpVendorName, rxPackets256to511=rxPackets256to511, nmmSecureMode=nmmSecureMode, ahRemoteOUI=ahRemoteOUI, modeType=modeType, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, cpuVoltageOut=cpuVoltageOut, extended3=extended3, prodAgent=prodAgent, ftppasswrd=ftppasswrd, txGoodPkts=txGoodPkts, snmpv3SecurityLevel=snmpv3SecurityLevel, txErrorPkts=txErrorPkts, portAccessType=portAccessType, ahLpbkMode=ahLpbkMode, portEgressRate=portEgressRate, cnodeControl=cnodeControl, rxOctets=rxOctets)
mibBuilder.exportSymbols("OMNITRON-MIB", keepAliveInterval=keepAliveInterval, dhcpIpAddr=dhcpIpAddr, nmmOAMmgmtMode=nmmOAMmgmtMode, moduleMgtCfgEntry=moduleMgtCfgEntry, portAHEntry=portAHEntry, bootpEnable=bootpEnable, chassistype=chassistype, traphost1=traphost1, modslotnum=modslotnum, tftpServerIpAddress=tftpServerIpAddress, portnum=portnum, modsoftrev=modsoftrev, portL2CPmgntProcessing=portL2CPmgntProcessing, portSFPpageA2=portSFPpageA2, selfSlot=selfSlot, index=index, txSingleCollision=txSingleCollision, omnitronConformance=omnitronConformance, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portSFPpageA0=portSFPpageA0, modchasstype=modchasstype, ledstat=ledstat, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, traphost3=traphost3, modLM80volts=modLM80volts, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, slotnum=slotnum, modreset=modreset, snmpv3PrivPassword=snmpv3PrivPassword, prodtype=prodtype, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, txDroppedEvents=txDroppedEvents, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, modnumports=modnumports, vlanservicetag=vlanservicetag, modcommitVLANchanges=modcommitVLANchanges, modpartnum=modpartnum, portingresssecurity=portingresssecurity, traphost2=traphost2, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, rxAlignmentErrors=rxAlignmentErrors, modprodtype=modprodtype, portmlistcriteria=portmlistcriteria, moduleTable=moduleTable, port3Membership=port3Membership, omnitronMIB=omnitronMIB, rxMulticastPkts=rxMulticastPkts, modextfeaturebits=modextfeaturebits, portStatsTable=portStatsTable, softrev=softrev, portSpeed=portSpeed, coreStatusOnly=coreStatusOnly, modExpLedStatus=modExpLedStatus, portSfpRxPower=portSfpRxPower, syscon=syscon)
