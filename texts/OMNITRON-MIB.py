...
OstPortList, OstModeType, icAgent, omnitron, OstVlanId, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortList", "OstModeType", "icAgent", "omnitron", "OstVlanId", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ahFramePeriodEventTotal=ahFramePeriodEventTotal, ipaddr2EVCassociation=ipaddr2EVCassociation, extended5=extended5, validityflag=validityflag, vlanidentifier=vlanidentifier, portSfpDateCode=portSfpDateCode, readCommunity=readCommunity, ahRemoteMuxState=ahRemoteMuxState, cnodeControl=cnodeControl, moduleMgtCfgEntry=moduleMgtCfgEntry, portL2CPmgntProcessing=portL2CPmgntProcessing, portSFPTable=portSFPTable, ahCriticalEventMode=ahCriticalEventMode, ostProtocolStatusTable=ostProtocolStatusTable, rxPackets64=rxPackets64, rxErrorPkts=rxErrorPkts, dhcpIpAddr=dhcpIpAddr, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, dhcpTagVid=dhcpTagVid, bootpEnable=bootpEnable, portIngressRateDropOrPause=portIngressRateDropOrPause, extended2=extended2, txBroadcastPkts=txBroadcastPkts, traphost6=traphost6, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxOversizePkts=rxOversizePkts, rxDropPkts=rxDropPkts, muxGroupDefaults=muxGroupDefaults, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, enabledFunctions=enabledFunctions, portAccessType=portAccessType, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, omnitronCompliances=omnitronCompliances, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, modvlanTableClear=modvlanTableClear, omnitronGroup=omnitronGroup, moduleCount=moduleCount, capsMask=capsMask, txOctets=txOctets, modcommitVLANchanges=modcommitVLANchanges, extended6=extended6, enableSNMPWrites=enableSNMPWrites, ahRemoteOUI=ahRemoteOUI, portState=portState, modprodtype=modprodtype, modRestoreFactoryDefaults=modRestoreFactoryDefaults, slaveTrapsForward=slaveTrapsForward, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahRemoteLinkFlags=ahRemoteLinkFlags, txDroppedEvents=txDroppedEvents, ingressPolicingType=ingressPolicingType, omnitronProducts=omnitronProducts, ahRemoteLinkPort=ahRemoteLinkPort, subnetmask2=subnetmask2, txPausePkts=txPausePkts, rxFCSErrors=rxFCSErrors, syscon=syscon, modextfeaturebits=modextfeaturebits, vlanPri=vlanPri, dhcpSubnetmask=dhcpSubnetmask, ahErroredFrameThreshold=ahErroredFrameThreshold, macAddr=macAddr, prodAgent=prodAgent, portingresssecurity=portingresssecurity, rxSymbolErrors=rxSymbolErrors, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, modtagsubstitution=modtagsubstitution, ahLocalMuxState=ahLocalMuxState, dhcptftpServerIpAddress=dhcptftpServerIpAddress, snmpv3AuthPassword=snmpv3AuthPassword, mmname=mmname, rxPackets65to127=rxPackets65to127, ahLpbkMode=ahLpbkMode, cpuVoltageIn=cpuVoltageIn, telnetpass=telnetpass, portStatsEntry=portStatsEntry, portStatsTable=portStatsTable, txErrorPkts=txErrorPkts, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, switchstat=switchstat, portStatsClear=portStatsClear, rxUnicastPkts=rxUnicastPkts, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modLM80misc=modLM80misc, traphost5=traphost5, gateway=gateway, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ftppasswrd=ftppasswrd, rxBroadcastPkts=rxBroadcastPkts, nmmSecureMode=nmmSecureMode, manufdate=manufdate, sysAdminStatus=sysAdminStatus, gateway2=gateway2, modchassnum=modchassnum, snmpv3SecurityLevel=snmpv3SecurityLevel, rxFragments=rxFragments, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ipaddrEVCassociation=ipaddrEVCassociation, tftpEnable=tftpEnable, userTable=userTable, portnum=portnum, modenable802dot1qProcessing=modenable802dot1qProcessing, modsoftrev=modsoftrev, moduleVLANEntry=moduleVLANEntry, modHwRev=modHwRev, rxPackets512to1023=rxPackets512to1023, slotnum=slotnum, ostProtocolStatusEntry=ostProtocolStatusEntry, wrswitch=wrswitch, portAHTable=portAHTable, chassisTable=chassisTable, coreStatusOnly=coreStatusOnly, ahLocalLinkFlags=ahLocalLinkFlags, portSfpTxPower=portSfpTxPower, modname=modname, port5Membership=port5Membership, ipAddr=ipAddr, ahLocalSupportVar=ahLocalSupportVar, cpuVoltageOut=cpuVoltageOut, userIndex=userIndex, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, port1Membership=port1Membership, chassisname=chassisname, nmmIpDisabled=nmmIpDisabled, txSingleCollision=txSingleCollision, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, modPcbRev=modPcbRev, portEgressQosPolicy=portEgressQosPolicy, port4Membership=port4Membership, ahLocalParserState=ahLocalParserState, portLinkState=portLinkState, omnitronSFPGroup=omnitronSFPGroup, dhcpGateway=dhcpGateway, portSfpVendorName=portSfpVendorName, extended3=extended3, chassisEntry=chassisEntry, ahErroredFrameWindow=ahErroredFrameWindow, portpriority=portpriority, index=index, omnitronCompliance=omnitronCompliance, modLM80volts=modLM80volts, ostProtocoManagementPort=ostProtocoManagementPort, softrev=softrev, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modswbuildnum=modswbuildnum, portAHEntry=portAHEntry, selfSlot=selfSlot, modExpLedStatus=modExpLedStatus, prodrev=prodrev, portSfpBiasCurrent=portSfpBiasCurrent, txMulticastPkts=txMulticastPkts, rxUndersizePkts=rxUndersizePkts, serialnum=serialnum, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ahLocalOUI=ahLocalOUI, portSfpBitRate=portSfpBitRate, servicetag=servicetag, txOctets64=txOctets64, modmanufdate=modmanufdate, trapSrcIpSelect=trapSrcIpSelect, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, partnum=partnum, portSfpTemperature=portSfpTemperature, extended1=extended1, portDuplex=portDuplex, modchassname=modchassname, portSfpRxPower=portSfpRxPower, enhancedchassisTable=enhancedchassisTable, tftpFileName=tftpFileName, ahClearStatistics=ahClearStatistics, traphost3=traphost3, ahRemoteParserState=ahRemoteParserState, modcommitNMMCfgChanges=modcommitNMMCfgChanges, rxAlignmentErrors=rxAlignmentErrors, resetmod=resetmod, ostProtocolStatusState=ostProtocolStatusState, portSfpVcc=portSfpVcc, ahCriticalEventTrapList=ahCriticalEventTrapList, modFpgaRev=modFpgaRev, moduleMgtCfgTable=moduleMgtCfgTable, ostProtocolStatusType=ostProtocolStatusType, modpartnum=modpartnum, modLM80currents=modLM80currents, snmpv3UserType=snmpv3UserType, portIngressRate=portIngressRate, portIngressRateCBS=portIngressRateCBS, txMultipleCollision=txMultipleCollision, enableSNMPv3Function=enableSNMPv3Function, portmlistcriteria=portmlistcriteria, rxGoodPkts=rxGoodPkts, portvlanidentifier=portvlanidentifier, portEgressRate=portEgressRate, omnitronMIB=omnitronMIB, subnetmask=subnetmask, omnitronConformance=omnitronConformance, vlanservicetag=vlanservicetag, ipAddr2=ipAddr2, txGoodPkts=txGoodPkts, keepAliveInterval=keepAliveInterval, chassis=chassis, ahFrameErrorEventTotal=ahFrameErrorEventTotal, PYSNMP_MODULE_ID=omnitronMIB, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, moduleTable=moduleTable, portMacAddress=portMacAddress, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portFwdCpuList=portFwdCpuList, portegresspolicy=portegresspolicy, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, customertag=customertag, ahEnabled=ahEnabled, ahRemoteSupportVar=ahRemoteSupportVar, chassisnum=chassisnum, nmmCfgState=nmmCfgState, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portSfpVendorPartNumber=portSfpVendorPartNumber, ahRemoteMode=ahRemoteMode, portSpeed=portSpeed, portSFPstatus=portSFPstatus, ahTransmissionRate=ahTransmissionRate, port2Membership=port2Membership, portSfpVendorSerialNumber=portSfpVendorSerialNumber, chassistype=chassistype, modulename=modulename, modExpSoftwareRev=modExpSoftwareRev, serialpass=serialpass, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modprodrev=modprodrev, sysDateTime=sysDateTime, enableSNMPFunction=enableSNMPFunction, moduleEntry=moduleEntry, portSFPEntry=portSFPEntry, dhcpPortNumber=dhcpPortNumber, traphost2=traphost2, prodtype=prodtype, cpuTemperature=cpuTemperature, rxPackets128to255=rxPackets128to255, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, writeCommunity=writeCommunity, mychassnum=mychassnum, modslotnum=modslotnum, sysloc=sysloc, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, txDeferedTransmit=txDeferedTransmit, port3Membership=port3Membership, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ledstat=ledstat, modulePortsEntry=modulePortsEntry, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, traphost7=traphost7)
mibBuilder.exportSymbols("OMNITRON-MIB", modnumports=modnumports, txCollisions=txCollisions, txDropPkts=txDropPkts, nmmSecureConnState=nmmSecureConnState, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, txUnicastPkts=txUnicastPkts, snmpTrapType=snmpTrapType, modeType=modeType, slaveWrite=slaveWrite, snmpv3UserName=snmpv3UserName, traphost8=traphost8, rxOctets=rxOctets, omnitronGroups=omnitronGroups, tftpServerIpAddress=tftpServerIpAddress, modulePortsTable=modulePortsTable, rxOctets64=rxOctets64, rxPackets256to511=rxPackets256to511, moduleVLANTable=moduleVLANTable, managementModule=managementModule, ostProtocolStatusIndex=ostProtocolStatusIndex, rxTotalPkts=rxTotalPkts, modportvlan=modportvlan, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, traphost1=traphost1, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, rxMulticastPkts=rxMulticastPkts, userEntry=userEntry, cnodeCIR=cnodeCIR, portcanonicalformatIndicator=portcanonicalformatIndicator, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahLocalMode=ahLocalMode, rxJabbers=rxJabbers, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portSFPpageA2=portSFPpageA2, portFwdCpu=portFwdCpu, extended4=extended4, nmmIpProtocolState=nmmIpProtocolState, snmpv3PrivPassword=snmpv3PrivPassword, nmmOAMmgmtMode=nmmOAMmgmtMode, defaultForwardingMap=defaultForwardingMap, slaveTraps=slaveTraps, rxPausePkts=rxPausePkts, rxCRCAlignErrors=rxCRCAlignErrors, portSFPpageA0=portSFPpageA0, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, traphost4=traphost4, modreset=modreset, modserialnum=modserialnum, vlanIdOst=vlanIdOst, modExpPartNumber=modExpPartNumber, modchasstype=modchasstype, txLateCollision=txLateCollision, port6Membership=port6Membership, rxPackets1024to1518=rxPackets1024to1518, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, txExcessiveCollision=txExcessiveCollision)
