...
OstVlanId, omnitron, OstModeType, icAgent, OstPortNumber, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "omnitron", "OstModeType", "icAgent", "OstPortNumber", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", omnitronCompliances=omnitronCompliances, rxOctets=rxOctets, ahLocalLinkFlags=ahLocalLinkFlags, ostEnvironmentalTemperature=ostEnvironmentalTemperature, txUnicastPkts=txUnicastPkts, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, slotnum=slotnum, modLM80misc=modLM80misc, nmmIpDisabled=nmmIpDisabled, dhcpPortNumber=dhcpPortNumber, ipAddr2=ipAddr2, chassis=chassis, modprodrev=modprodrev, modchasstype=modchasstype, txMulticastPkts=txMulticastPkts, nmmSecureSlaveSlot=nmmSecureSlaveSlot, prodAgent=prodAgent, rxPausePkts=rxPausePkts, serialpass=serialpass, port3Membership=port3Membership, portSfpVendorPartNumber=portSfpVendorPartNumber, ahErroredFrameThreshold=ahErroredFrameThreshold, txOctets=txOctets, portAHEntry=portAHEntry, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modname=modname, ipAddr=ipAddr, rxOctets64=rxOctets64, ipaddr2EVCassociation=ipaddr2EVCassociation, ahLocalOUI=ahLocalOUI, rxFCSErrors=rxFCSErrors, subnetmask2=subnetmask2, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, cnodeControl=cnodeControl, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ostProtocolStatusEntry=ostProtocolStatusEntry, portcanonicalformatIndicator=portcanonicalformatIndicator, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, modsoftrev=modsoftrev, portEgressRate=portEgressRate, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, omnitronGroups=omnitronGroups, modnumports=modnumports, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portAHTable=portAHTable, slaveWrite=slaveWrite, portStatsClear=portStatsClear, moduleVLANEntry=moduleVLANEntry, traphost5=traphost5, cpuVoltageOut=cpuVoltageOut, ahErroredFrameWindow=ahErroredFrameWindow, rxAlignmentErrors=rxAlignmentErrors, ahLocalMuxState=ahLocalMuxState, managementModule=managementModule, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portIngressRate=portIngressRate, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, moduleVLANTable=moduleVLANTable, rxErrorPkts=rxErrorPkts, modportvlan=modportvlan, txDropPkts=txDropPkts, ostProtocolStatusIndex=ostProtocolStatusIndex, modLM80currents=modLM80currents, rxUnicastPkts=rxUnicastPkts, modcommitVLANchanges=modcommitVLANchanges, modchassname=modchassname, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, PYSNMP_MODULE_ID=omnitronMIB, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portStatsEntry=portStatsEntry, slaveTraps=slaveTraps, txDeferedTransmit=txDeferedTransmit, muxGroupDefaults=muxGroupDefaults, rxFragments=rxFragments, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, ahRemoteLinkFlags=ahRemoteLinkFlags, ahCriticalEventMode=ahCriticalEventMode, serialnum=serialnum, nmmSecureConnState=nmmSecureConnState, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahLocalParserState=ahLocalParserState, portSFPpageA2=portSFPpageA2, snmpv3PrivPassword=snmpv3PrivPassword, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modslotnum=modslotnum, portL2CPmgntProcessing=portL2CPmgntProcessing, keepAliveInterval=keepAliveInterval, index=index, portSfpRxPower=portSfpRxPower, port6Membership=port6Membership, chassisname=chassisname, prodrev=prodrev, modprodtype=modprodtype, ostProtocoManagementPort=ostProtocoManagementPort, modenable802dot1qProcessing=modenable802dot1qProcessing, chassisnum=chassisnum, portpriority=portpriority, port4Membership=port4Membership, rxJabbers=rxJabbers, traphost3=traphost3, customertag=customertag, portFwdCpuList=portFwdCpuList, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, portEgressQosPolicy=portEgressQosPolicy, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, traphost6=traphost6, rxUndersizePkts=rxUndersizePkts, portSfpTemperature=portSfpTemperature, selfSlot=selfSlot, cpuVoltageIn=cpuVoltageIn, rxPackets128to255=rxPackets128to255, telnetpass=telnetpass, extended1=extended1, chassistype=chassistype, ahLocalMode=ahLocalMode, rxSymbolErrors=rxSymbolErrors, portLinkState=portLinkState, tftpEnable=tftpEnable, servicetag=servicetag, rxGoodPkts=rxGoodPkts, snmpv3UserType=snmpv3UserType, ostProtocolStatusType=ostProtocolStatusType, gateway=gateway, vlanIdOst=vlanIdOst, userTable=userTable, traphost1=traphost1, extended6=extended6, modulePortsTable=modulePortsTable, writeCommunity=writeCommunity, enhancedchassisTable=enhancedchassisTable, rxPackets65to127=rxPackets65to127, softrev=softrev, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modExpPartNumber=modExpPartNumber, enabledFunctions=enabledFunctions, sysAdminStatus=sysAdminStatus, dhcpSubnetmask=dhcpSubnetmask, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, nmmOAMmgmtMode=nmmOAMmgmtMode, omnitronGroup=omnitronGroup, wrswitch=wrswitch, portSfpBiasCurrent=portSfpBiasCurrent, manufdate=manufdate, modreset=modreset, omnitronConformance=omnitronConformance, rxTotalPkts=rxTotalPkts, port2Membership=port2Membership, snmpv3UserName=snmpv3UserName, ostProtocolStatusState=ostProtocolStatusState, rxDropPkts=rxDropPkts, portStatsTable=portStatsTable, modextfeaturebits=modextfeaturebits, vlanPri=vlanPri, ahCriticalEventTrapList=ahCriticalEventTrapList, ahClearStatistics=ahClearStatistics, txSingleCollision=txSingleCollision, validityflag=validityflag, traphost7=traphost7, trapSrcIpSelect=trapSrcIpSelect, gateway2=gateway2, txCollisions=txCollisions, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, dhcpTagVid=dhcpTagVid, vlanidentifier=vlanidentifier, tftpFileName=tftpFileName, extended3=extended3, moduleMgtCfgEntry=moduleMgtCfgEntry, resetmod=resetmod, slaveTrapsForward=slaveTrapsForward, rxBroadcastPkts=rxBroadcastPkts, ahRemoteOUI=ahRemoteOUI, omnitronMIB=omnitronMIB, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, enableSNMPWrites=enableSNMPWrites, omnitronProducts=omnitronProducts, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, capsMask=capsMask, ahEnabled=ahEnabled, prodtype=prodtype, snmpv3AuthPassword=snmpv3AuthPassword, sysloc=sysloc, modeType=modeType, portmlistcriteria=portmlistcriteria, omnitronCompliance=omnitronCompliance, ledstat=ledstat, ftppasswrd=ftppasswrd, mychassnum=mychassnum, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxPackets512to1023=rxPackets512to1023, extended2=extended2, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, txLateCollision=txLateCollision, tftpServerIpAddress=tftpServerIpAddress, port1Membership=port1Membership, subnetmask=subnetmask, modcommitNMMCfgChanges=modcommitNMMCfgChanges, txExcessiveCollision=txExcessiveCollision, portMacAddress=portMacAddress, portSFPpageA0=portSFPpageA0, cnodeCIR=cnodeCIR, portIngressRateDropOrPause=portIngressRateDropOrPause, txMultipleCollision=txMultipleCollision, ahRemoteParserState=ahRemoteParserState, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, coreStatusOnly=coreStatusOnly, ostProtocolStatusTable=ostProtocolStatusTable, portSfpBitRate=portSfpBitRate, modulePortsEntry=modulePortsEntry, portFwdCpu=portFwdCpu, dhcptftpServerIpAddress=dhcptftpServerIpAddress, modmanufdate=modmanufdate, portvlanidentifier=portvlanidentifier, txOctets64=txOctets64, moduleMgtCfgTable=moduleMgtCfgTable, traphost2=traphost2, switchstat=switchstat, portDuplex=portDuplex, portSpeed=portSpeed, sysDateTime=sysDateTime, cpuTemperature=cpuTemperature, portSfpVcc=portSfpVcc, chassisTable=chassisTable, mmname=mmname, modHwRev=modHwRev, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modLM80volts=modLM80volts, ahRemoteSupportVar=ahRemoteSupportVar, snmpTrapType=snmpTrapType, rxPackets64=rxPackets64, userEntry=userEntry, nmmIpProtocolState=nmmIpProtocolState, ahRemoteMuxState=ahRemoteMuxState, moduleCount=moduleCount, defaultForwardingMap=defaultForwardingMap, moduleEntry=moduleEntry, vlanservicetag=vlanservicetag, userIndex=userIndex, portState=portState, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modExpSoftwareRev=modExpSoftwareRev, portAccessType=portAccessType, txPausePkts=txPausePkts, ahRemoteMode=ahRemoteMode, modserialnum=modserialnum, txGoodPkts=txGoodPkts, portIngressRateCBS=portIngressRateCBS, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portSfpDateCode=portSfpDateCode, syscon=syscon, ahLocalSupportVar=ahLocalSupportVar, enableSNMPv3Function=enableSNMPv3Function)
mibBuilder.exportSymbols("OMNITRON-MIB", modpartnum=modpartnum, modPcbRev=modPcbRev, modvlanTableClear=modvlanTableClear, txBroadcastPkts=txBroadcastPkts, portnum=portnum, txErrorPkts=txErrorPkts, enableSNMPFunction=enableSNMPFunction, moduleTable=moduleTable, partnum=partnum, ahRemoteLinkPort=ahRemoteLinkPort, bootpEnable=bootpEnable, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, dhcpGateway=dhcpGateway, modswbuildnum=modswbuildnum, ahLpbkMode=ahLpbkMode, traphost8=traphost8, ahTransmissionRate=ahTransmissionRate, traphost4=traphost4, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modtagsubstitution=modtagsubstitution, rxPackets1024to1518=rxPackets1024to1518, extended4=extended4, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSFPEntry=portSFPEntry, rxCRCAlignErrors=rxCRCAlignErrors, modFpgaRev=modFpgaRev, modulename=modulename, snmpv3SecurityLevel=snmpv3SecurityLevel, modExpLedStatus=modExpLedStatus, rxMulticastPkts=rxMulticastPkts, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, txDroppedEvents=txDroppedEvents, rxOversizePkts=rxOversizePkts, portingresssecurity=portingresssecurity, ingressPolicingType=ingressPolicingType, extended5=extended5, portegresspolicy=portegresspolicy, modRestoreFactoryDefaults=modRestoreFactoryDefaults, macAddr=macAddr, port5Membership=port5Membership, portSfpTxPower=portSfpTxPower, dhcpIpAddr=dhcpIpAddr, nmmCfgState=nmmCfgState, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, modchassnum=modchassnum, nmmSecureMode=nmmSecureMode, chassisEntry=chassisEntry, portSfpVendorName=portSfpVendorName, ipaddrEVCassociation=ipaddrEVCassociation, portSFPTable=portSFPTable, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, rxPackets256to511=rxPackets256to511, readCommunity=readCommunity, omnitronSFPGroup=omnitronSFPGroup, portSFPstatus=portSFPstatus)
