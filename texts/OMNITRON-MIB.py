...
mibBuilder.exportSymbols("OMNITRON-MIB", ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahRemoteMode=ahRemoteMode, txDropPkts=txDropPkts, ipAddr=ipAddr, portIngressRateCBS=portIngressRateCBS, extended3=extended3, rxOctets64=rxOctets64, omnitronProducts=omnitronProducts, modPcbRev=modPcbRev, writeCommunity=writeCommunity, snmpv3PrivPassword=snmpv3PrivPassword, gateway2=gateway2, switchstat=switchstat, modslotnum=modslotnum, portSfpRxPower=portSfpRxPower, omnitronConformance=omnitronConformance, coreStatusOnly=coreStatusOnly, rxFCSErrors=rxFCSErrors, modExpSoftwareRev=modExpSoftwareRev, chassisname=chassisname, ostProtocoManagementPort=ostProtocoManagementPort, rxTotalPkts=rxTotalPkts, traphost7=traphost7, nmmSecureMode=nmmSecureMode, moduleMgtCfgEntry=moduleMgtCfgEntry, modHwRev=modHwRev, nmmCfgState=nmmCfgState, txDeferedTransmit=txDeferedTransmit, rxUnicastPkts=rxUnicastPkts, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, sysloc=sysloc, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portStatsTable=portStatsTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modulePortsEntry=modulePortsEntry, modeType=modeType, txPausePkts=txPausePkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, dhcpIpAddr=dhcpIpAddr, modExpPartNumber=modExpPartNumber, modchassname=modchassname, portSFPpageA2=portSFPpageA2, enhancedchassisTable=enhancedchassisTable, tftpServerIpAddress=tftpServerIpAddress, rxAlignmentErrors=rxAlignmentErrors, syscon=syscon, modnumports=modnumports, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portnum=portnum, portEgressQosPolicy=portEgressQosPolicy, slaveTraps=slaveTraps, modportvlan=modportvlan, ostProtocolStatusIndex=ostProtocolStatusIndex, ahLocalSupportVar=ahLocalSupportVar, vlanidentifier=vlanidentifier, cnodeControl=cnodeControl, telnetpass=telnetpass, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portegresspolicy=portegresspolicy, omnitronGroup=omnitronGroup, rxDropPkts=rxDropPkts, ahLocalLinkFlags=ahLocalLinkFlags, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, traphost3=traphost3, mmname=mmname, portLinkState=portLinkState, chassistype=chassistype, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, traphost6=traphost6, enableSNMPFunction=enableSNMPFunction, modLM80misc=modLM80misc, dhcpTagVid=dhcpTagVid, userTable=userTable, ahCriticalEventMode=ahCriticalEventMode, PYSNMP_MODULE_ID=omnitronMIB, ahLocalMode=ahLocalMode, ahClearStatistics=ahClearStatistics, portSfpBitRate=portSfpBitRate, txErrorPkts=txErrorPkts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, rxGoodPkts=rxGoodPkts, ahLpbkMode=ahLpbkMode, portStatsClear=portStatsClear, portStatsEntry=portStatsEntry, dhcpSubnetmask=dhcpSubnetmask, trapSrcIpSelect=trapSrcIpSelect, txOctets64=txOctets64, nmmIpDisabled=nmmIpDisabled, omnitronMIB=omnitronMIB, modserialnum=modserialnum, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, prodrev=prodrev, cpuVoltageIn=cpuVoltageIn, enabledFunctions=enabledFunctions, rxFragments=rxFragments, modtagsubstitution=modtagsubstitution, cnodeCIR=cnodeCIR, portSfpVcc=portSfpVcc, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portSpeed=portSpeed, subnetmask2=subnetmask2, port1Membership=port1Membership, wrswitch=wrswitch, dhcpGateway=dhcpGateway, portmlistcriteria=portmlistcriteria, modchassnum=modchassnum, userEntry=userEntry, moduleCount=moduleCount, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, rxPackets64=rxPackets64, rxJabbers=rxJabbers, portAHEntry=portAHEntry, snmpv3UserType=snmpv3UserType, moduleEntry=moduleEntry, txOctets=txOctets, ahFramePeriodEventTotal=ahFramePeriodEventTotal, muxGroupDefaults=muxGroupDefaults, ahLocalOUI=ahLocalOUI, portSFPEntry=portSFPEntry, modmanufdate=modmanufdate, manufdate=manufdate, portvlanidentifier=portvlanidentifier, portL2CPmgntProcessing=portL2CPmgntProcessing, port5Membership=port5Membership, ostProtocolStatusTable=ostProtocolStatusTable, portingresssecurity=portingresssecurity, slaveTrapsForward=slaveTrapsForward, extended2=extended2, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portIngressRate=portIngressRate, validityflag=validityflag, port2Membership=port2Membership, rxBroadcastPkts=rxBroadcastPkts, ahErroredFrameWindow=ahErroredFrameWindow, defaultForwardingMap=defaultForwardingMap, nmmSecureConnState=nmmSecureConnState, txUnicastPkts=txUnicastPkts, portAccessType=portAccessType, snmpv3UserName=snmpv3UserName, chassisnum=chassisnum, partnum=partnum, extended1=extended1, ahTransmissionRate=ahTransmissionRate, portAHTable=portAHTable, traphost1=traphost1, modchasstype=modchasstype, txCollisions=txCollisions, traphost4=traphost4, extended6=extended6, rxPackets1024to1518=rxPackets1024to1518, modname=modname, omnitronSFPGroup=omnitronSFPGroup, ftppasswrd=ftppasswrd, bootpEnable=bootpEnable, ostProtocolStatusType=ostProtocolStatusType, portSfpVendorName=portSfpVendorName, portSfpVendorSerialNumber=portSfpVendorSerialNumber, serialnum=serialnum, ledstat=ledstat, modLM80currents=modLM80currents, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ingressPolicingType=ingressPolicingType, rxPausePkts=rxPausePkts, portSFPstatus=portSFPstatus, modprodtype=modprodtype, extended5=extended5, traphost8=traphost8, txExcessiveCollision=txExcessiveCollision, portSfpVendorPartNumber=portSfpVendorPartNumber, ahLocalMuxState=ahLocalMuxState, managementModule=managementModule, portState=portState, txMultipleCollision=txMultipleCollision, portSFPpageA0=portSFPpageA0, cpuVoltageOut=cpuVoltageOut, traphost2=traphost2, moduleVLANEntry=moduleVLANEntry, modFpgaRev=modFpgaRev, ahCriticalEventTrapList=ahCriticalEventTrapList, ipAddr2=ipAddr2, moduleMgtCfgTable=moduleMgtCfgTable, capsMask=capsMask, portDuplex=portDuplex, modenable802dot1qProcessing=modenable802dot1qProcessing, portFwdCpu=portFwdCpu, modcommitVLANchanges=modcommitVLANchanges, serialpass=serialpass, chassisEntry=chassisEntry, txLateCollision=txLateCollision, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, moduleTable=moduleTable, moduleVLANTable=moduleVLANTable, extended4=extended4, softrev=softrev, ahRemoteLinkFlags=ahRemoteLinkFlags, modvlanTableClear=modvlanTableClear, modswbuildnum=modswbuildnum, ahLocalParserState=ahLocalParserState, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, tftpEnable=tftpEnable, vlanPri=vlanPri, portSfpDateCode=portSfpDateCode, txMulticastPkts=txMulticastPkts, txSingleCollision=txSingleCollision, rxPackets128to255=rxPackets128to255, modulePortsTable=modulePortsTable, readCommunity=readCommunity, rxPackets256to511=rxPackets256to511, slotnum=slotnum, port3Membership=port3Membership, portEgressRate=portEgressRate, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahRemoteMuxState=ahRemoteMuxState, nmmOAMmgmtMode=nmmOAMmgmtMode, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, enableSNMPWrites=enableSNMPWrites, rxPackets65to127=rxPackets65to127, modExpLedStatus=modExpLedStatus, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, rxCRCAlignErrors=rxCRCAlignErrors, slaveWrite=slaveWrite, chassis=chassis, portSfpTemperature=portSfpTemperature, ahRemoteParserState=ahRemoteParserState, ostProtocolStatusState=ostProtocolStatusState, txDroppedEvents=txDroppedEvents, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portcanonicalformatIndicator=portcanonicalformatIndicator, modulename=modulename, traphost5=traphost5, ostProtocolStatusEntry=ostProtocolStatusEntry, omnitronCompliances=omnitronCompliances, ahEnabled=ahEnabled, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modsoftrev=modsoftrev, index=index, gateway=gateway, ahErroredFrameThreshold=ahErroredFrameThreshold, tftpFileName=tftpFileName, modLM80volts=modLM80volts, portFwdCpuList=portFwdCpuList, modextfeaturebits=modextfeaturebits, rxSymbolErrors=rxSymbolErrors, modreset=modreset, vlanservicetag=vlanservicetag, vlanIdOst=vlanIdOst, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahRemoteOUI=ahRemoteOUI)
mibBuilder.exportSymbols("OMNITRON-MIB", omnitronCompliance=omnitronCompliance, rxPackets512to1023=rxPackets512to1023, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, servicetag=servicetag, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, chassisTable=chassisTable, macAddr=macAddr, nmmIpProtocolState=nmmIpProtocolState, selfSlot=selfSlot, prodtype=prodtype, txGoodPkts=txGoodPkts, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, mychassnum=mychassnum, modRestoreFactoryDefaults=modRestoreFactoryDefaults, sysAdminStatus=sysAdminStatus, cpuTemperature=cpuTemperature, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, portSFPTable=portSFPTable, subnetmask=subnetmask, rxUndersizePkts=rxUndersizePkts, ipaddrEVCassociation=ipaddrEVCassociation, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ipaddr2EVCassociation=ipaddr2EVCassociation, dhcpPortNumber=dhcpPortNumber, port6Membership=port6Membership, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, keepAliveInterval=keepAliveInterval, resetmod=resetmod, rxOversizePkts=rxOversizePkts, portSfpBiasCurrent=portSfpBiasCurrent, port4Membership=port4Membership, modpartnum=modpartnum, snmpTrapType=snmpTrapType, sysDateTime=sysDateTime, portSfpTxPower=portSfpTxPower, modprodrev=modprodrev, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, omnitronGroups=omnitronGroups, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, prodAgent=prodAgent, modcommitNMMCfgChanges=modcommitNMMCfgChanges, userIndex=userIndex, portIngressRateDropOrPause=portIngressRateDropOrPause, txBroadcastPkts=txBroadcastPkts, snmpv3SecurityLevel=snmpv3SecurityLevel, rxOctets=rxOctets, portMacAddress=portMacAddress, rxMulticastPkts=rxMulticastPkts, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, customertag=customertag, portpriority=portpriority, snmpv3AuthPassword=snmpv3AuthPassword, rxErrorPkts=rxErrorPkts, enableSNMPv3Function=enableSNMPv3Function, ahRemoteLinkPort=ahRemoteLinkPort, ahRemoteSupportVar=ahRemoteSupportVar)
