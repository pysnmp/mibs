...
icAgent, omnitron, OstPortList, OstModeType, OstPortNumber, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "omnitron", "OstPortList", "OstModeType", "OstPortNumber", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", portSpeed=portSpeed, snmpv3AuthPassword=snmpv3AuthPassword, port4Membership=port4Membership, ahTransmissionRate=ahTransmissionRate, macAddr=macAddr, extended5=extended5, modreset=modreset, chassisname=chassisname, ledstat=ledstat, txDeferedTransmit=txDeferedTransmit, modchassnum=modchassnum, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modLM80volts=modLM80volts, cnodeControl=cnodeControl, rxDropPkts=rxDropPkts, omnitronCompliance=omnitronCompliance, serialpass=serialpass, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, txOctets=txOctets, enhancedchassisTable=enhancedchassisTable, ahErroredFrameThreshold=ahErroredFrameThreshold, ahEnabled=ahEnabled, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSFPpageA2=portSFPpageA2, dhcpPortNumber=dhcpPortNumber, modchassname=modchassname, portingresssecurity=portingresssecurity, nmmSecureConnState=nmmSecureConnState, prodrev=prodrev, txMulticastPkts=txMulticastPkts, tftpFileName=tftpFileName, nmmCfgState=nmmCfgState, snmpv3PrivPassword=snmpv3PrivPassword, portIngressRateCBS=portIngressRateCBS, slaveWrite=slaveWrite, dhcpIpAddr=dhcpIpAddr, moduleTable=moduleTable, portEgressRate=portEgressRate, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portvlanidentifier=portvlanidentifier, rxFragments=rxFragments, modPcbRev=modPcbRev, ostProtocolStatusType=ostProtocolStatusType, modLM80currents=modLM80currents, traphost3=traphost3, ahCriticalEventTrapList=ahCriticalEventTrapList, port5Membership=port5Membership, rxFCSErrors=rxFCSErrors, modFpgaRev=modFpgaRev, enableSNMPFunction=enableSNMPFunction, ahLocalParserState=ahLocalParserState, sysAdminStatus=sysAdminStatus, portSfpDateCode=portSfpDateCode, rxJabbers=rxJabbers, portAHTable=portAHTable, txOctets64=txOctets64, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portcanonicalformatIndicator=portcanonicalformatIndicator, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, traphost2=traphost2, portSFPstatus=portSFPstatus, txLateCollision=txLateCollision, rxCRCAlignErrors=rxCRCAlignErrors, modsoftrev=modsoftrev, ahRemoteLinkPort=ahRemoteLinkPort, nmmOAMmgmtMode=nmmOAMmgmtMode, omnitronGroup=omnitronGroup, omnitronCompliances=omnitronCompliances, ahLocalLinkFlags=ahLocalLinkFlags, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, userTable=userTable, chassisnum=chassisnum, rxPackets65to127=rxPackets65to127, modulePortsTable=modulePortsTable, portAHEntry=portAHEntry, port6Membership=port6Membership, rxUnicastPkts=rxUnicastPkts, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, traphost7=traphost7, partnum=partnum, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, traphost4=traphost4, dhcpSubnetmask=dhcpSubnetmask, modprodrev=modprodrev, validityflag=validityflag, traphost8=traphost8, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portFwdCpu=portFwdCpu, txPausePkts=txPausePkts, txBroadcastPkts=txBroadcastPkts, sysDateTime=sysDateTime, nmmSecureMode=nmmSecureMode, wrswitch=wrswitch, portStatsClear=portStatsClear, ahRemoteLinkFlags=ahRemoteLinkFlags, moduleVLANTable=moduleVLANTable, modenable802dot1qProcessing=modenable802dot1qProcessing, txDroppedEvents=txDroppedEvents, slaveTrapsForward=slaveTrapsForward, txGoodPkts=txGoodPkts, port2Membership=port2Membership, modExpPartNumber=modExpPartNumber, modchasstype=modchasstype, ostProtocolStatusTable=ostProtocolStatusTable, modmanufdate=modmanufdate, portSfpVendorName=portSfpVendorName, ipaddr2EVCassociation=ipaddr2EVCassociation, traphost1=traphost1, omnitronSFPGroup=omnitronSFPGroup, extended2=extended2, rxAlignmentErrors=rxAlignmentErrors, ahFramePeriodEventTotal=ahFramePeriodEventTotal, keepAliveInterval=keepAliveInterval, chassis=chassis, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, chassistype=chassistype, rxTotalPkts=rxTotalPkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portIngressRateDropOrPause=portIngressRateDropOrPause, customertag=customertag, extended4=extended4, dhcpTagVid=dhcpTagVid, vlanservicetag=vlanservicetag, coreStatusOnly=coreStatusOnly, modLM80misc=modLM80misc, portmlistcriteria=portmlistcriteria, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portSFPTable=portSFPTable, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahLpbkMode=ahLpbkMode, dhcpGateway=dhcpGateway, rxOctets=rxOctets, rxErrorPkts=rxErrorPkts, ahLocalSupportVar=ahLocalSupportVar, selfSlot=selfSlot, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, cpuTemperature=cpuTemperature, subnetmask2=subnetmask2, enableSNMPv3Function=enableSNMPv3Function, portIngressRate=portIngressRate, ahLocalLpbkTimeout=ahLocalLpbkTimeout, mmname=mmname, portpriority=portpriority, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, txUnicastPkts=txUnicastPkts, ahRemoteOUI=ahRemoteOUI, omnitronMIB=omnitronMIB, ipAddr2=ipAddr2, portL2CPmgntProcessing=portL2CPmgntProcessing, cnodeCIR=cnodeCIR, modportvlan=modportvlan, defaultForwardingMap=defaultForwardingMap, ipaddrEVCassociation=ipaddrEVCassociation, userIndex=userIndex, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, moduleCount=moduleCount, ahClearStatistics=ahClearStatistics, modcommitVLANchanges=modcommitVLANchanges, modslotnum=modslotnum, ostProtocoManagementPort=ostProtocoManagementPort, slotnum=slotnum, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portSfpRxPower=portSfpRxPower, ahLocalMuxState=ahLocalMuxState, portSfpBiasCurrent=portSfpBiasCurrent, softrev=softrev, modulename=modulename, resetmod=resetmod, modswbuildnum=modswbuildnum, ingressPolicingType=ingressPolicingType, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portSfpBitRate=portSfpBitRate, modulePortsEntry=modulePortsEntry, rxPausePkts=rxPausePkts, portMacAddress=portMacAddress, txMultipleCollision=txMultipleCollision, bootpEnable=bootpEnable, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, tftpServerIpAddress=tftpServerIpAddress, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, prodAgent=prodAgent, moduleEntry=moduleEntry, modHwRev=modHwRev, trapSrcIpSelect=trapSrcIpSelect, extended6=extended6, mychassnum=mychassnum, snmpv3UserType=snmpv3UserType, modserialnum=modserialnum, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, manufdate=manufdate, portDuplex=portDuplex, vlanIdOst=vlanIdOst, gateway=gateway, snmpTrapType=snmpTrapType, gateway2=gateway2, enabledFunctions=enabledFunctions, readCommunity=readCommunity, ahFrameErrorEventTotal=ahFrameErrorEventTotal, rxPackets64=rxPackets64, modprodtype=modprodtype, ahRemoteMuxState=ahRemoteMuxState, extended3=extended3, writeCommunity=writeCommunity, txExcessiveCollision=txExcessiveCollision, ahRemoteParserState=ahRemoteParserState, portState=portState, index=index, modExpLedStatus=modExpLedStatus, cpuVoltageOut=cpuVoltageOut, slaveTraps=slaveTraps, rxPackets1024to1518=rxPackets1024to1518, managementModule=managementModule, chassisEntry=chassisEntry, ahCriticalEventMode=ahCriticalEventMode, portSfpVendorPartNumber=portSfpVendorPartNumber, rxPackets128to255=rxPackets128to255, ahLocalMode=ahLocalMode, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, servicetag=servicetag, rxOctets64=rxOctets64, serialnum=serialnum, omnitronGroups=omnitronGroups, modnumports=modnumports, portAccessType=portAccessType, telnetpass=telnetpass, ahRemoteMode=ahRemoteMode, txErrorPkts=txErrorPkts, nmmSecureSlaveSlot=nmmSecureSlaveSlot, modname=modname, rxBroadcastPkts=rxBroadcastPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, moduleVLANEntry=moduleVLANEntry, rxOversizePkts=rxOversizePkts, ostProtocolStatusEntry=ostProtocolStatusEntry, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ftppasswrd=ftppasswrd, omnitronProducts=omnitronProducts, portEgressQosPolicy=portEgressQosPolicy, switchstat=switchstat, rxGoodPkts=rxGoodPkts, traphost6=traphost6, portStatsTable=portStatsTable, chassisTable=chassisTable, extended1=extended1, ostProtocolStatusIndex=ostProtocolStatusIndex, modeType=modeType, omnitronConformance=omnitronConformance, portegresspolicy=portegresspolicy, portSFPEntry=portSFPEntry, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, enableSNMPWrites=enableSNMPWrites)
mibBuilder.exportSymbols("OMNITRON-MIB", txSingleCollision=txSingleCollision, nmmIpProtocolState=nmmIpProtocolState, rxPackets256to511=rxPackets256to511, ipAddr=ipAddr, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostProtocolStatusState=ostProtocolStatusState, modextfeaturebits=modextfeaturebits, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahLocalOUI=ahLocalOUI, txCollisions=txCollisions, portSfpVcc=portSfpVcc, syscon=syscon, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxPackets512to1023=rxPackets512to1023, moduleMgtCfgEntry=moduleMgtCfgEntry, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, sysloc=sysloc, rxUndersizePkts=rxUndersizePkts, userEntry=userEntry, cpuVoltageIn=cpuVoltageIn, port3Membership=port3Membership, modtagsubstitution=modtagsubstitution, vlanidentifier=vlanidentifier, rxSymbolErrors=rxSymbolErrors, muxGroupDefaults=muxGroupDefaults, vlanPri=vlanPri, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portFwdCpuList=portFwdCpuList, tftpEnable=tftpEnable, ahRemoteSupportVar=ahRemoteSupportVar, PYSNMP_MODULE_ID=omnitronMIB, portnum=portnum, modExpSoftwareRev=modExpSoftwareRev, snmpv3SecurityLevel=snmpv3SecurityLevel, modpartnum=modpartnum, ahErroredFrameWindow=ahErroredFrameWindow, snmpv3UserName=snmpv3UserName, prodtype=prodtype, portLinkState=portLinkState, modvlanTableClear=modvlanTableClear, portSFPpageA0=portSFPpageA0, rxMulticastPkts=rxMulticastPkts, capsMask=capsMask, portSfpTemperature=portSfpTemperature, txDropPkts=txDropPkts, port1Membership=port1Membership, nmmIpDisabled=nmmIpDisabled, moduleMgtCfgTable=moduleMgtCfgTable, portStatsEntry=portStatsEntry, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, traphost5=traphost5, portSfpTxPower=portSfpTxPower, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, subnetmask=subnetmask)
