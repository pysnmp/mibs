...
OstModeType, OstPortNumber, icAgent, OstPortList, omnitron, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstPortNumber", "icAgent", "OstPortList", "omnitron", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", txOctets64=txOctets64, rxMulticastPkts=rxMulticastPkts, ostProtocolStatusIndex=ostProtocolStatusIndex, rxPackets1024to1518=rxPackets1024to1518, softrev=softrev, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modeType=modeType, portSfpRxPower=portSfpRxPower, rxOversizePkts=rxOversizePkts, moduleMgtCfgTable=moduleMgtCfgTable, prodAgent=prodAgent, capsMask=capsMask, portMacAddress=portMacAddress, rxUnicastPkts=rxUnicastPkts, userTable=userTable, modcommitVLANchanges=modcommitVLANchanges, ipaddr2EVCassociation=ipaddr2EVCassociation, chassisTable=chassisTable, portAHTable=portAHTable, modprodtype=modprodtype, bootpEnable=bootpEnable, port5Membership=port5Membership, muxGroupDefaults=muxGroupDefaults, rxOctets=rxOctets, portSFPTable=portSFPTable, dhcpIpAddr=dhcpIpAddr, PYSNMP_MODULE_ID=omnitronMIB, rxTotalPkts=rxTotalPkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, txErrorPkts=txErrorPkts, ahRemoteSupportVar=ahRemoteSupportVar, ahLpbkMode=ahLpbkMode, mychassnum=mychassnum, ostProtocolStatusType=ostProtocolStatusType, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, txDroppedEvents=txDroppedEvents, ahLocalOUI=ahLocalOUI, ipAddr=ipAddr, modulePortsEntry=modulePortsEntry, index=index, validityflag=validityflag, extended1=extended1, portcanonicalformatIndicator=portcanonicalformatIndicator, ostProtocolStatusState=ostProtocolStatusState, portLinkState=portLinkState, rxDropPkts=rxDropPkts, portStatsTable=portStatsTable, chassis=chassis, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, rxErrorPkts=rxErrorPkts, resetmod=resetmod, rxPausePkts=rxPausePkts, ahErroredFrameThreshold=ahErroredFrameThreshold, tftpFileName=tftpFileName, ftppasswrd=ftppasswrd, prodtype=prodtype, dhcpSubnetmask=dhcpSubnetmask, omnitronConformance=omnitronConformance, txSingleCollision=txSingleCollision, txMultipleCollision=txMultipleCollision, port6Membership=port6Membership, modLM80currents=modLM80currents, modulePortsTable=modulePortsTable, ingressPolicingType=ingressPolicingType, rxJabbers=rxJabbers, ahRemoteParserState=ahRemoteParserState, txMulticastPkts=txMulticastPkts, rxOctets64=rxOctets64, snmpv3AuthPassword=snmpv3AuthPassword, portFwdCpuList=portFwdCpuList, modulename=modulename, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, portSfpDateCode=portSfpDateCode, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, extended4=extended4, traphost6=traphost6, modcommitNMMCfgChanges=modcommitNMMCfgChanges, chassisEntry=chassisEntry, ahRemoteMuxState=ahRemoteMuxState, modnumports=modnumports, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, slaveTrapsForward=slaveTrapsForward, rxPackets64=rxPackets64, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modchassnum=modchassnum, extended6=extended6, modHwRev=modHwRev, extended3=extended3, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portegresspolicy=portegresspolicy, portFwdCpu=portFwdCpu, snmpTrapType=snmpTrapType, omnitronCompliances=omnitronCompliances, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, cpuTemperature=cpuTemperature, portL2CPmgntProcessing=portL2CPmgntProcessing, portSFPstatus=portSFPstatus, modpartnum=modpartnum, snmpv3SecurityLevel=snmpv3SecurityLevel, gateway2=gateway2, subnetmask=subnetmask, portIngressRate=portIngressRate, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ahCriticalEventMode=ahCriticalEventMode, customertag=customertag, portSfpVendorName=portSfpVendorName, ahRemoteMode=ahRemoteMode, snmpv3PrivPassword=snmpv3PrivPassword, modExpLedStatus=modExpLedStatus, trapSrcIpSelect=trapSrcIpSelect, enhancedchassisTable=enhancedchassisTable, txDropPkts=txDropPkts, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, dhcpTagVid=dhcpTagVid, tftpEnable=tftpEnable, portSfpVendorPartNumber=portSfpVendorPartNumber, txUnicastPkts=txUnicastPkts, chassistype=chassistype, modLM80misc=modLM80misc, modprodrev=modprodrev, cpuVoltageIn=cpuVoltageIn, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, traphost3=traphost3, extended2=extended2, enabledFunctions=enabledFunctions, txBroadcastPkts=txBroadcastPkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, modPcbRev=modPcbRev, portStatsClear=portStatsClear, dhcpGateway=dhcpGateway, subnetmask2=subnetmask2, manufdate=manufdate, portingresssecurity=portingresssecurity, vlanPri=vlanPri, partnum=partnum, rxPackets256to511=rxPackets256to511, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portmlistcriteria=portmlistcriteria, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ahLocalSupportVar=ahLocalSupportVar, ostProtocolStatusEntry=ostProtocolStatusEntry, rxPackets128to255=rxPackets128to255, mmname=mmname, nmmSecureMode=nmmSecureMode, traphost2=traphost2, ahTransmissionRate=ahTransmissionRate, telnetpass=telnetpass, sysloc=sysloc, serialpass=serialpass, sysAdminStatus=sysAdminStatus, portSFPpageA2=portSFPpageA2, rxSymbolErrors=rxSymbolErrors, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ahLocalParserState=ahLocalParserState, serialnum=serialnum, modextfeaturebits=modextfeaturebits, syscon=syscon, modportvlan=modportvlan, modFpgaRev=modFpgaRev, rxGoodPkts=rxGoodPkts, rxFragments=rxFragments, modtagsubstitution=modtagsubstitution, cnodeControl=cnodeControl, portSfpBiasCurrent=portSfpBiasCurrent, nmmIpProtocolState=nmmIpProtocolState, managementModule=managementModule, servicetag=servicetag, modExpPartNumber=modExpPartNumber, modvlanTableClear=modvlanTableClear, port3Membership=port3Membership, modserialnum=modserialnum, rxCRCAlignErrors=rxCRCAlignErrors, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ostProtocolStatusTable=ostProtocolStatusTable, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portSfpTemperature=portSfpTemperature, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, switchstat=switchstat, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, chassisname=chassisname, vlanservicetag=vlanservicetag, macAddr=macAddr, portSFPEntry=portSFPEntry, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahEnabled=ahEnabled, moduleTable=moduleTable, dhcpPortNumber=dhcpPortNumber, ahLocalMuxState=ahLocalMuxState, portEgressRate=portEgressRate, ahRemoteLinkPort=ahRemoteLinkPort, portSFPpageA0=portSFPpageA0, enableSNMPv3Function=enableSNMPv3Function, ledstat=ledstat, readCommunity=readCommunity, ahErroredFrameWindow=ahErroredFrameWindow, selfSlot=selfSlot, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, extended5=extended5, cpuVoltageOut=cpuVoltageOut, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, traphost5=traphost5, moduleMgtCfgEntry=moduleMgtCfgEntry, moduleVLANTable=moduleVLANTable, txCollisions=txCollisions, omnitronMIB=omnitronMIB, rxUndersizePkts=rxUndersizePkts, traphost7=traphost7, portSfpBitRate=portSfpBitRate, omnitronSFPGroup=omnitronSFPGroup, ipAddr2=ipAddr2, ahRemoteOUI=ahRemoteOUI, moduleEntry=moduleEntry, rxBroadcastPkts=rxBroadcastPkts, txOctets=txOctets, vlanidentifier=vlanidentifier, port2Membership=port2Membership, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modchasstype=modchasstype, vlanIdOst=vlanIdOst, txDeferedTransmit=txDeferedTransmit, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, slaveWrite=slaveWrite, modLM80volts=modLM80volts, modname=modname, enableSNMPFunction=enableSNMPFunction, modmanufdate=modmanufdate, modExpSoftwareRev=modExpSoftwareRev, cnodeCIR=cnodeCIR, modenable802dot1qProcessing=modenable802dot1qProcessing, rxPackets65to127=rxPackets65to127, portState=portState, txGoodPkts=txGoodPkts, portIngressRateDropOrPause=portIngressRateDropOrPause, enableSNMPWrites=enableSNMPWrites, modslotnum=modslotnum, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portvlanidentifier=portvlanidentifier, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, slaveTraps=slaveTraps, nmmOAMmgmtMode=nmmOAMmgmtMode, omnitronGroup=omnitronGroup, portSfpTxPower=portSfpTxPower, snmpv3UserName=snmpv3UserName, moduleVLANEntry=moduleVLANEntry, ahFrameErrorEventTotal=ahFrameErrorEventTotal, txExcessiveCollision=txExcessiveCollision, ahLocalLinkFlags=ahLocalLinkFlags, gateway=gateway, nmmSecureSlaveSlot=nmmSecureSlaveSlot, txLateCollision=txLateCollision)
mibBuilder.exportSymbols("OMNITRON-MIB", portEgressQosPolicy=portEgressQosPolicy, nmmIpDisabled=nmmIpDisabled, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portIngressRateCBS=portIngressRateCBS, modchassname=modchassname, prodrev=prodrev, nmmCfgState=nmmCfgState, portDuplex=portDuplex, omnitronGroups=omnitronGroups, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portnum=portnum, modRestoreFactoryDefaults=modRestoreFactoryDefaults, modsoftrev=modsoftrev, ipaddrEVCassociation=ipaddrEVCassociation, userIndex=userIndex, modswbuildnum=modswbuildnum, moduleCount=moduleCount, portSfpVcc=portSfpVcc, slotnum=slotnum, port4Membership=port4Membership, nmmSecureConnState=nmmSecureConnState, portpriority=portpriority, portSpeed=portSpeed, chassisnum=chassisnum, wrswitch=wrswitch, txPausePkts=txPausePkts, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ostProtocoManagementPort=ostProtocoManagementPort, omnitronCompliance=omnitronCompliance, rxFCSErrors=rxFCSErrors, ahClearStatistics=ahClearStatistics, traphost1=traphost1, rxAlignmentErrors=rxAlignmentErrors, ahRemoteLinkFlags=ahRemoteLinkFlags, traphost4=traphost4, snmpv3UserType=snmpv3UserType, traphost8=traphost8, tftpServerIpAddress=tftpServerIpAddress, portStatsEntry=portStatsEntry, defaultForwardingMap=defaultForwardingMap, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, coreStatusOnly=coreStatusOnly, rxPackets512to1023=rxPackets512to1023, writeCommunity=writeCommunity, portAccessType=portAccessType, userEntry=userEntry, sysDateTime=sysDateTime, port1Membership=port1Membership, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, omnitronProducts=omnitronProducts, modreset=modreset, ahLocalMode=ahLocalMode, portAHEntry=portAHEntry, keepAliveInterval=keepAliveInterval, ahCriticalEventTrapList=ahCriticalEventTrapList)
