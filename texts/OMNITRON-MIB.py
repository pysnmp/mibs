...
icAgent, OstPortList, omnitron, OstModeType, OstPortNumber, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstPortList", "omnitron", "OstModeType", "OstPortNumber", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ahClearStatistics=ahClearStatistics, modvlanTableClear=modvlanTableClear, omnitronGroup=omnitronGroup, ahRemoteMode=ahRemoteMode, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, rxPackets128to255=rxPackets128to255, rxFCSErrors=rxFCSErrors, chassisname=chassisname, portmlistcriteria=portmlistcriteria, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ftppasswrd=ftppasswrd, portSFPstatus=portSFPstatus, ingressPolicingType=ingressPolicingType, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portSfpVendorSerialNumber=portSfpVendorSerialNumber, manufdate=manufdate, portFwdCpuList=portFwdCpuList, portStatsEntry=portStatsEntry, txOctets64=txOctets64, ahErroredFrameWindow=ahErroredFrameWindow, txBroadcastPkts=txBroadcastPkts, omnitronCompliances=omnitronCompliances, ahFrameErrorEventTotal=ahFrameErrorEventTotal, modcommitVLANchanges=modcommitVLANchanges, cnodeControl=cnodeControl, portIngressRate=portIngressRate, ahRemoteOUI=ahRemoteOUI, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, moduleMgtCfgTable=moduleMgtCfgTable, omnitronSFPGroup=omnitronSFPGroup, rxCRCAlignErrors=rxCRCAlignErrors, modtagsubstitution=modtagsubstitution, dhcpGateway=dhcpGateway, portvlanidentifier=portvlanidentifier, rxPackets65to127=rxPackets65to127, cpuVoltageOut=cpuVoltageOut, ostProtocolStatusEntry=ostProtocolStatusEntry, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portAccessType=portAccessType, omnitronMIB=omnitronMIB, rxAlignmentErrors=rxAlignmentErrors, moduleMgtCfgEntry=moduleMgtCfgEntry, portSpeed=portSpeed, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, servicetag=servicetag, ahErroredFrameThreshold=ahErroredFrameThreshold, portIngressRateCBS=portIngressRateCBS, modprodtype=modprodtype, ostProtocolStatusIndex=ostProtocolStatusIndex, ipaddrEVCassociation=ipaddrEVCassociation, modeType=modeType, ledstat=ledstat, rxPackets512to1023=rxPackets512to1023, portnum=portnum, modHwRev=modHwRev, extended3=extended3, omnitronConformance=omnitronConformance, ahLocalMuxState=ahLocalMuxState, enabledFunctions=enabledFunctions, portSFPpageA2=portSFPpageA2, portSfpRxPower=portSfpRxPower, modulename=modulename, traphost8=traphost8, chassisEntry=chassisEntry, rxGoodPkts=rxGoodPkts, moduleTable=moduleTable, vlanservicetag=vlanservicetag, portSfpTemperature=portSfpTemperature, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, selfSlot=selfSlot, modLM80misc=modLM80misc, modLM80currents=modLM80currents, keepAliveInterval=keepAliveInterval, snmpv3UserName=snmpv3UserName, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, slaveTraps=slaveTraps, ostProtocolStatusTable=ostProtocolStatusTable, vlanIdOst=vlanIdOst, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ipaddr2EVCassociation=ipaddr2EVCassociation, omnitronGroups=omnitronGroups, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portpriority=portpriority, enableSNMPWrites=enableSNMPWrites, ahRemoteLinkFlags=ahRemoteLinkFlags, modLM80volts=modLM80volts, moduleEntry=moduleEntry, validityflag=validityflag, portEgressQosPolicy=portEgressQosPolicy, nmmCfgState=nmmCfgState, portStatsClear=portStatsClear, userTable=userTable, snmpv3PrivPassword=snmpv3PrivPassword, portEgressRate=portEgressRate, portSfpVendorName=portSfpVendorName, ahRemoteLinkPort=ahRemoteLinkPort, modExpSoftwareRev=modExpSoftwareRev, sysloc=sysloc, nmmIpProtocolState=nmmIpProtocolState, switchstat=switchstat, ipAddr=ipAddr, slotnum=slotnum, modprodrev=modprodrev, dhcpSubnetmask=dhcpSubnetmask, portAHEntry=portAHEntry, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portSfpVcc=portSfpVcc, cpuVoltageIn=cpuVoltageIn, modPcbRev=modPcbRev, modchassname=modchassname, traphost2=traphost2, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portSfpDateCode=portSfpDateCode, moduleCount=moduleCount, macAddr=macAddr, rxPackets1024to1518=rxPackets1024to1518, port3Membership=port3Membership, modRestoreFactoryDefaults=modRestoreFactoryDefaults, txCollisions=txCollisions, nmmIpDisabled=nmmIpDisabled, portStatsTable=portStatsTable, txMulticastPkts=txMulticastPkts, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, rxBroadcastPkts=rxBroadcastPkts, rxUnicastPkts=rxUnicastPkts, rxErrorPkts=rxErrorPkts, trapSrcIpSelect=trapSrcIpSelect, modmanufdate=modmanufdate, rxFragments=rxFragments, vlanPri=vlanPri, txDeferedTransmit=txDeferedTransmit, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, defaultForwardingMap=defaultForwardingMap, rxPackets64=rxPackets64, nmmSecureConnState=nmmSecureConnState, moduleVLANTable=moduleVLANTable, subnetmask2=subnetmask2, modswbuildnum=modswbuildnum, gateway2=gateway2, txOctets=txOctets, ostProtocoManagementPort=ostProtocoManagementPort, extended2=extended2, enableSNMPv3Function=enableSNMPv3Function, userIndex=userIndex, modportvlan=modportvlan, prodAgent=prodAgent, rxUndersizePkts=rxUndersizePkts, port1Membership=port1Membership, index=index, ahLocalMode=ahLocalMode, chassistype=chassistype, portegresspolicy=portegresspolicy, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ahEnabled=ahEnabled, ahCriticalEventTrapList=ahCriticalEventTrapList, nmmSecureMode=nmmSecureMode, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portL2CPmgntProcessing=portL2CPmgntProcessing, serialpass=serialpass, extended4=extended4, rxTotalPkts=rxTotalPkts, softrev=softrev, port4Membership=port4Membership, muxGroupDefaults=muxGroupDefaults, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, tftpServerIpAddress=tftpServerIpAddress, managementModule=managementModule, rxMulticastPkts=rxMulticastPkts, txExcessiveCollision=txExcessiveCollision, portSFPEntry=portSFPEntry, snmpTrapType=snmpTrapType, mychassnum=mychassnum, ahLocalParserState=ahLocalParserState, txErrorPkts=txErrorPkts, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, traphost4=traphost4, rxSymbolErrors=rxSymbolErrors, modsoftrev=modsoftrev, traphost5=traphost5, userEntry=userEntry, bootpEnable=bootpEnable, portDuplex=portDuplex, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, traphost6=traphost6, moduleVLANEntry=moduleVLANEntry, portSfpVendorPartNumber=portSfpVendorPartNumber, prodtype=prodtype, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, txUnicastPkts=txUnicastPkts, modExpLedStatus=modExpLedStatus, ahLocalSupportVar=ahLocalSupportVar, rxDropPkts=rxDropPkts, chassisTable=chassisTable, dhcpTagVid=dhcpTagVid, rxPackets256to511=rxPackets256to511, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, sysAdminStatus=sysAdminStatus, ahLocalLinkFlags=ahLocalLinkFlags, capsMask=capsMask, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ipAddr2=ipAddr2, modulePortsTable=modulePortsTable, portMacAddress=portMacAddress, portSfpBiasCurrent=portSfpBiasCurrent, txGoodPkts=txGoodPkts, rxPausePkts=rxPausePkts, portSFPpageA0=portSFPpageA0, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portAHTable=portAHTable, wrswitch=wrswitch, modserialnum=modserialnum, cpuTemperature=cpuTemperature, nmmOAMmgmtMode=nmmOAMmgmtMode, ahLocalOUI=ahLocalOUI, snmpv3AuthPassword=snmpv3AuthPassword, writeCommunity=writeCommunity, nmmSecureSlaveSlot=nmmSecureSlaveSlot, cnodeCIR=cnodeCIR, enhancedchassisTable=enhancedchassisTable, modextfeaturebits=modextfeaturebits, modenable802dot1qProcessing=modenable802dot1qProcessing, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, txLateCollision=txLateCollision, portLinkState=portLinkState, ahRemoteMuxState=ahRemoteMuxState, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, modpartnum=modpartnum, mmname=mmname, modFpgaRev=modFpgaRev, subnetmask=subnetmask, sysDateTime=sysDateTime, port5Membership=port5Membership, portSFPTable=portSFPTable, extended1=extended1, portSfpTxPower=portSfpTxPower, modulePortsEntry=modulePortsEntry, readCommunity=readCommunity, modchasstype=modchasstype, partnum=partnum, extended6=extended6, syscon=syscon, enableSNMPFunction=enableSNMPFunction, rxOctets64=rxOctets64, ostProtocolStatusType=ostProtocolStatusType, ahLpbkMode=ahLpbkMode, snmpv3UserType=snmpv3UserType, PYSNMP_MODULE_ID=omnitronMIB, ahCriticalEventMode=ahCriticalEventMode, customertag=customertag, txDropPkts=txDropPkts)
mibBuilder.exportSymbols("OMNITRON-MIB", chassisnum=chassisnum, txDroppedEvents=txDroppedEvents, serialnum=serialnum, chassis=chassis, portSfpBitRate=portSfpBitRate, modslotnum=modslotnum, tftpFileName=tftpFileName, telnetpass=telnetpass, modExpPartNumber=modExpPartNumber, coreStatusOnly=coreStatusOnly, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, traphost7=traphost7, omnitronCompliance=omnitronCompliance, port6Membership=port6Membership, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modnumports=modnumports, omnitronProducts=omnitronProducts, rxOctets=rxOctets, txMultipleCollision=txMultipleCollision, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, vlanidentifier=vlanidentifier, tftpEnable=tftpEnable, ostEnvironmentalTemperature=ostEnvironmentalTemperature, snmpv3SecurityLevel=snmpv3SecurityLevel, portFwdCpu=portFwdCpu, portingresssecurity=portingresssecurity, gateway=gateway, extended5=extended5, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, rxOversizePkts=rxOversizePkts, resetmod=resetmod, txPausePkts=txPausePkts, modreset=modreset, dhcpIpAddr=dhcpIpAddr, prodrev=prodrev, modname=modname, traphost1=traphost1, slaveTrapsForward=slaveTrapsForward, ahRemoteParserState=ahRemoteParserState, port2Membership=port2Membership, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, traphost3=traphost3, portIngressRateDropOrPause=portIngressRateDropOrPause, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, txSingleCollision=txSingleCollision, ahRemoteSupportVar=ahRemoteSupportVar, ahTransmissionRate=ahTransmissionRate, modchassnum=modchassnum, portState=portState, portcanonicalformatIndicator=portcanonicalformatIndicator, ostProtocolStatusState=ostProtocolStatusState, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxJabbers=rxJabbers, dhcpPortNumber=dhcpPortNumber, slaveWrite=slaveWrite)
