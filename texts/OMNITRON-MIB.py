...
icAgent, OstModeType, omnitron, OstPortNumber, OstVlanId, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstModeType", "omnitron", "OstPortNumber", "OstVlanId", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ahRemoteSupportVar=ahRemoteSupportVar, ahRemoteOUI=ahRemoteOUI, cpuTemperature=cpuTemperature, ostProtocolStatusEntry=ostProtocolStatusEntry, ahRemoteMode=ahRemoteMode, chassisname=chassisname, modnumports=modnumports, modportvlan=modportvlan, portSfpVendorSerialNumber=portSfpVendorSerialNumber, omnitronGroup=omnitronGroup, nmmSecureMode=nmmSecureMode, portSFPstatus=portSFPstatus, modpartnum=modpartnum, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, partnum=partnum, modLM80currents=modLM80currents, ostProtocolStatusState=ostProtocolStatusState, modExpPartNumber=modExpPartNumber, rxJabbers=rxJabbers, moduleEntry=moduleEntry, rxDropPkts=rxDropPkts, txMultipleCollision=txMultipleCollision, ahEnabled=ahEnabled, portFwdCpu=portFwdCpu, enabledFunctions=enabledFunctions, rxPackets512to1023=rxPackets512to1023, slaveTrapsForward=slaveTrapsForward, modmanufdate=modmanufdate, portLinkState=portLinkState, omnitronSFPGroup=omnitronSFPGroup, rxFCSErrors=rxFCSErrors, portStatsClear=portStatsClear, rxAlignmentErrors=rxAlignmentErrors, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, enhancedchassisTable=enhancedchassisTable, txGoodPkts=txGoodPkts, txMulticastPkts=txMulticastPkts, serialpass=serialpass, snmpv3SecurityLevel=snmpv3SecurityLevel, readCommunity=readCommunity, portIngressRateDropOrPause=portIngressRateDropOrPause, nmmIpDisabled=nmmIpDisabled, modchassname=modchassname, traphost1=traphost1, portState=portState, prodtype=prodtype, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portSfpDateCode=portSfpDateCode, portSfpBiasCurrent=portSfpBiasCurrent, portSpeed=portSpeed, modslotnum=modslotnum, omnitronGroups=omnitronGroups, modExpSoftwareRev=modExpSoftwareRev, rxTotalPkts=rxTotalPkts, txDropPkts=txDropPkts, resetmod=resetmod, portSfpBitRate=portSfpBitRate, traphost4=traphost4, manufdate=manufdate, txDroppedEvents=txDroppedEvents, modLM80misc=modLM80misc, bootpEnable=bootpEnable, portEgressRate=portEgressRate, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ftppasswrd=ftppasswrd, subnetmask=subnetmask, portStatsTable=portStatsTable, portSFPpageA0=portSFPpageA0, userIndex=userIndex, customertag=customertag, modtagsubstitution=modtagsubstitution, txUnicastPkts=txUnicastPkts, ledstat=ledstat, port6Membership=port6Membership, validityflag=validityflag, cpuVoltageOut=cpuVoltageOut, txExcessiveCollision=txExcessiveCollision, portSfpTxPower=portSfpTxPower, subnetmask2=subnetmask2, moduleVLANEntry=moduleVLANEntry, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, snmpv3UserType=snmpv3UserType, index=index, ipaddrEVCassociation=ipaddrEVCassociation, modextfeaturebits=modextfeaturebits, port3Membership=port3Membership, rxBroadcastPkts=rxBroadcastPkts, modsoftrev=modsoftrev, portSFPEntry=portSFPEntry, modchasstype=modchasstype, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portFwdCpuList=portFwdCpuList, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxPackets64=rxPackets64, ahLocalMuxState=ahLocalMuxState, ahLocalParserState=ahLocalParserState, userTable=userTable, ostProtocolStatusType=ostProtocolStatusType, moduleVLANTable=moduleVLANTable, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ahFramePeriodEventTotal=ahFramePeriodEventTotal, wrswitch=wrswitch, modprodtype=modprodtype, nmmSecureConnState=nmmSecureConnState, portSfpVendorName=portSfpVendorName, portvlanidentifier=portvlanidentifier, traphost2=traphost2, portL2CPmgntProcessing=portL2CPmgntProcessing, trapSrcIpSelect=trapSrcIpSelect, portAHEntry=portAHEntry, dhcptftpServerIpAddress=dhcptftpServerIpAddress, serialnum=serialnum, ostEnvironmentalTemperature=ostEnvironmentalTemperature, omnitronCompliance=omnitronCompliance, servicetag=servicetag, rxUndersizePkts=rxUndersizePkts, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portcanonicalformatIndicator=portcanonicalformatIndicator, syscon=syscon, writeCommunity=writeCommunity, modprodrev=modprodrev, cnodeCIR=cnodeCIR, chassisnum=chassisnum, moduleMgtCfgTable=moduleMgtCfgTable, enableSNMPWrites=enableSNMPWrites, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ostProtocolStatusTable=ostProtocolStatusTable, omnitronConformance=omnitronConformance, tftpFileName=tftpFileName, portingresssecurity=portingresssecurity, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, txLateCollision=txLateCollision, rxPackets1024to1518=rxPackets1024to1518, modname=modname, cpuVoltageIn=cpuVoltageIn, modulePortsEntry=modulePortsEntry, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, muxGroupDefaults=muxGroupDefaults, portMacAddress=portMacAddress, ostProtocolStatusIndex=ostProtocolStatusIndex, rxGoodPkts=rxGoodPkts, sysDateTime=sysDateTime, slotnum=slotnum, rxSymbolErrors=rxSymbolErrors, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ipaddr2EVCassociation=ipaddr2EVCassociation, omnitronCompliances=omnitronCompliances, ahErroredFrameWindow=ahErroredFrameWindow, portpriority=portpriority, portegresspolicy=portegresspolicy, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, mmname=mmname, modulePortsTable=modulePortsTable, dhcpGateway=dhcpGateway, tftpServerIpAddress=tftpServerIpAddress, traphost7=traphost7, extended6=extended6, keepAliveInterval=keepAliveInterval, extended5=extended5, moduleMgtCfgEntry=moduleMgtCfgEntry, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, modcommitVLANchanges=modcommitVLANchanges, ahTransmissionRate=ahTransmissionRate, txDeferedTransmit=txDeferedTransmit, tftpEnable=tftpEnable, modreset=modreset, ahRemoteLinkPort=ahRemoteLinkPort, port1Membership=port1Membership, rxUnicastPkts=rxUnicastPkts, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, gateway=gateway, macAddr=macAddr, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, portSFPTable=portSFPTable, nmmIpProtocolState=nmmIpProtocolState, portDuplex=portDuplex, portIngressRate=portIngressRate, ahRemoteLinkFlags=ahRemoteLinkFlags, portmlistcriteria=portmlistcriteria, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, snmpv3PrivPassword=snmpv3PrivPassword, ahCriticalEventMode=ahCriticalEventMode, ahCriticalEventTrapList=ahCriticalEventTrapList, portnum=portnum, slaveTraps=slaveTraps, dhcpTagVid=dhcpTagVid, rxPackets65to127=rxPackets65to127, traphost5=traphost5, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, modFpgaRev=modFpgaRev, portEgressQosPolicy=portEgressQosPolicy, snmpv3AuthPassword=snmpv3AuthPassword, chassis=chassis, txErrorPkts=txErrorPkts, txPausePkts=txPausePkts, portSfpTemperature=portSfpTemperature, cnodeControl=cnodeControl, ahLocalOUI=ahLocalOUI, vlanservicetag=vlanservicetag, portIngressRateCBS=portIngressRateCBS, traphost8=traphost8, modserialnum=modserialnum, ahRemoteMuxState=ahRemoteMuxState, enableSNMPFunction=enableSNMPFunction, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, modLM80volts=modLM80volts, chassistype=chassistype, defaultForwardingMap=defaultForwardingMap, vlanidentifier=vlanidentifier, mychassnum=mychassnum, portSfpRxPower=portSfpRxPower, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, rxPackets256to511=rxPackets256to511, modExpLedStatus=modExpLedStatus, traphost6=traphost6, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ipAddr2=ipAddr2, sysAdminStatus=sysAdminStatus, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ahLocalMode=ahLocalMode, extended1=extended1, txCollisions=txCollisions, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, moduleCount=moduleCount, port5Membership=port5Membership, dhcpSubnetmask=dhcpSubnetmask, omnitronMIB=omnitronMIB, telnetpass=telnetpass, slaveWrite=slaveWrite, rxOctets64=rxOctets64, txOctets=txOctets, modenable802dot1qProcessing=modenable802dot1qProcessing, omnitronProducts=omnitronProducts, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, portAHTable=portAHTable, txBroadcastPkts=txBroadcastPkts, portSfpVendorPartNumber=portSfpVendorPartNumber, extended2=extended2, vlanPri=vlanPri, modeType=modeType, modchassnum=modchassnum, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, dhcpPortNumber=dhcpPortNumber, ahLocalSupportVar=ahLocalSupportVar, rxMulticastPkts=rxMulticastPkts, gateway2=gateway2, ingressPolicingType=ingressPolicingType, ahLpbkMode=ahLpbkMode, rxOctets=rxOctets)
mibBuilder.exportSymbols("OMNITRON-MIB", ahRemoteParserState=ahRemoteParserState, coreStatusOnly=coreStatusOnly, extended3=extended3, nmmOAMmgmtMode=nmmOAMmgmtMode, port4Membership=port4Membership, prodAgent=prodAgent, switchstat=switchstat, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portSfpVcc=portSfpVcc, ipAddr=ipAddr, ahLocalLinkFlags=ahLocalLinkFlags, snmpTrapType=snmpTrapType, ahErroredFrameThreshold=ahErroredFrameThreshold, selfSlot=selfSlot, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxPausePkts=rxPausePkts, nmmCfgState=nmmCfgState, modHwRev=modHwRev, portStatsEntry=portStatsEntry, userEntry=userEntry, modPcbRev=modPcbRev, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, softrev=softrev, modvlanTableClear=modvlanTableClear, port2Membership=port2Membership, portAccessType=portAccessType, rxOversizePkts=rxOversizePkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ahClearStatistics=ahClearStatistics, sysloc=sysloc, ostProtocoManagementPort=ostProtocoManagementPort, txSingleCollision=txSingleCollision, modswbuildnum=modswbuildnum, capsMask=capsMask, chassisEntry=chassisEntry, dhcpIpAddr=dhcpIpAddr, rxFragments=rxFragments, moduleTable=moduleTable, PYSNMP_MODULE_ID=omnitronMIB, modulename=modulename, managementModule=managementModule, vlanIdOst=vlanIdOst, enableSNMPv3Function=enableSNMPv3Function, rxErrorPkts=rxErrorPkts, prodrev=prodrev, rxCRCAlignErrors=rxCRCAlignErrors, snmpv3UserName=snmpv3UserName, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, traphost3=traphost3, portSFPpageA2=portSFPpageA2, extended4=extended4, chassisTable=chassisTable, rxPackets128to255=rxPackets128to255, txOctets64=txOctets64)
