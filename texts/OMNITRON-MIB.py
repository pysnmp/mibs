...
OstModeType, icAgent, OstPortList, omnitron, OstVlanId, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "icAgent", "OstPortList", "omnitron", "OstVlanId", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", chassisTable=chassisTable, chassistype=chassistype, customertag=customertag, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahRemoteOUI=ahRemoteOUI, modreset=modreset, port1Membership=port1Membership, modtagsubstitution=modtagsubstitution, chassisnum=chassisnum, port2Membership=port2Membership, modulePortsEntry=modulePortsEntry, ahCriticalEventTrapList=ahCriticalEventTrapList, dhcpSubnetmask=dhcpSubnetmask, modFpgaRev=modFpgaRev, ahLocalMode=ahLocalMode, vlanservicetag=vlanservicetag, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portSFPTable=portSFPTable, traphost3=traphost3, snmpv3PrivPassword=snmpv3PrivPassword, nmmSecureConnState=nmmSecureConnState, omnitronCompliances=omnitronCompliances, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, cpuTemperature=cpuTemperature, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modExpLedStatus=modExpLedStatus, slaveWrite=slaveWrite, modnumports=modnumports, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, rxUndersizePkts=rxUndersizePkts, extended5=extended5, index=index, telnetpass=telnetpass, enableSNMPWrites=enableSNMPWrites, rxFCSErrors=rxFCSErrors, port5Membership=port5Membership, bootpEnable=bootpEnable, ahLocalMuxState=ahLocalMuxState, sysloc=sysloc, userEntry=userEntry, modchasstype=modchasstype, cnodeControl=cnodeControl, portState=portState, modextfeaturebits=modextfeaturebits, portAHTable=portAHTable, ostProtocolStatusType=ostProtocolStatusType, enhancedchassisTable=enhancedchassisTable, dhcpTagVid=dhcpTagVid, modRestoreFactoryDefaults=modRestoreFactoryDefaults, portmlistcriteria=portmlistcriteria, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, prodrev=prodrev, portSfpVendorName=portSfpVendorName, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portSpeed=portSpeed, portEgressRate=portEgressRate, modmanufdate=modmanufdate, modLM80currents=modLM80currents, modprodtype=modprodtype, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, manufdate=manufdate, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modpartnum=modpartnum, sysDateTime=sysDateTime, extended2=extended2, portSfpBitRate=portSfpBitRate, omnitronConformance=omnitronConformance, serialnum=serialnum, moduleTable=moduleTable, rxPausePkts=rxPausePkts, portIngressRate=portIngressRate, cpuVoltageIn=cpuVoltageIn, traphost2=traphost2, modLM80volts=modLM80volts, cpuVoltageOut=cpuVoltageOut, portDuplex=portDuplex, traphost1=traphost1, muxGroupDefaults=muxGroupDefaults, ostProtocoManagementPort=ostProtocoManagementPort, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, extended1=extended1, portIngressRateCBS=portIngressRateCBS, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ipaddrEVCassociation=ipaddrEVCassociation, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahLocalLinkFlags=ahLocalLinkFlags, modulePortsTable=modulePortsTable, portEgressQosPolicy=portEgressQosPolicy, nmmCfgState=nmmCfgState, modvlanTableClear=modvlanTableClear, extended6=extended6, ahCriticalEventMode=ahCriticalEventMode, readCommunity=readCommunity, portLinkState=portLinkState, chassisname=chassisname, moduleEntry=moduleEntry, portSFPEntry=portSFPEntry, rxBroadcastPkts=rxBroadcastPkts, macAddr=macAddr, rxFragments=rxFragments, gateway2=gateway2, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portcanonicalformatIndicator=portcanonicalformatIndicator, rxCRCAlignErrors=rxCRCAlignErrors, traphost5=traphost5, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, servicetag=servicetag, moduleCount=moduleCount, portMacAddress=portMacAddress, portStatsTable=portStatsTable, ostEnvironmentalTemperature=ostEnvironmentalTemperature, traphost4=traphost4, rxAlignmentErrors=rxAlignmentErrors, ahLocalSupportVar=ahLocalSupportVar, syscon=syscon, ahLocalParserState=ahLocalParserState, slaveTraps=slaveTraps, ledstat=ledstat, rxPackets1024to1518=rxPackets1024to1518, port4Membership=port4Membership, portAccessType=portAccessType, portSfpRxPower=portSfpRxPower, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, userTable=userTable, managementModule=managementModule, portStatsEntry=portStatsEntry, keepAliveInterval=keepAliveInterval, moduleMgtCfgEntry=moduleMgtCfgEntry, rxOctets64=rxOctets64, modslotnum=modslotnum, extended4=extended4, modchassname=modchassname, ostProtocolStatusState=ostProtocolStatusState, modswbuildnum=modswbuildnum, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portpriority=portpriority, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, nmmSecureMode=nmmSecureMode, nmmIpDisabled=nmmIpDisabled, rxPackets256to511=rxPackets256to511, softrev=softrev, prodAgent=prodAgent, omnitronGroups=omnitronGroups, enableSNMPFunction=enableSNMPFunction, vlanidentifier=vlanidentifier, ostProtocolStatusTable=ostProtocolStatusTable, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, rxMulticastPkts=rxMulticastPkts, modLM80misc=modLM80misc, modchassnum=modchassnum, moduleVLANTable=moduleVLANTable, gateway=gateway, portAHEntry=portAHEntry, mychassnum=mychassnum, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, txOctets=txOctets, nmmIpProtocolState=nmmIpProtocolState, nmmOAMmgmtMode=nmmOAMmgmtMode, txErrorPkts=txErrorPkts, portSfpVendorPartNumber=portSfpVendorPartNumber, moduleMgtCfgTable=moduleMgtCfgTable, vlanIdOst=vlanIdOst, wrswitch=wrswitch, txUnicastPkts=txUnicastPkts, port3Membership=port3Membership, modprodrev=modprodrev, portFwdCpu=portFwdCpu, writeCommunity=writeCommunity, serialpass=serialpass, txBroadcastPkts=txBroadcastPkts, ahRemoteParserState=ahRemoteParserState, portSFPpageA2=portSFPpageA2, subnetmask=subnetmask, enableSNMPv3Function=enableSNMPv3Function, txPausePkts=txPausePkts, moduleVLANEntry=moduleVLANEntry, omnitronGroup=omnitronGroup, ostProtocolStatusIndex=ostProtocolStatusIndex, ipaddr2EVCassociation=ipaddr2EVCassociation, rxGoodPkts=rxGoodPkts, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, dhcpPortNumber=dhcpPortNumber, snmpv3AuthPassword=snmpv3AuthPassword, portL2CPmgntProcessing=portL2CPmgntProcessing, ahTransmissionRate=ahTransmissionRate, ahRemoteMuxState=ahRemoteMuxState, modcommitVLANchanges=modcommitVLANchanges, rxPackets64=rxPackets64, rxPackets65to127=rxPackets65to127, ahRemoteSupportVar=ahRemoteSupportVar, txMultipleCollision=txMultipleCollision, userIndex=userIndex, ahErroredFrameThreshold=ahErroredFrameThreshold, ipAddr2=ipAddr2, omnitronCompliance=omnitronCompliance, txGoodPkts=txGoodPkts, modserialnum=modserialnum, modportvlan=modportvlan, extended3=extended3, trapSrcIpSelect=trapSrcIpSelect, dhcpGateway=dhcpGateway, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, rxJabbers=rxJabbers, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahLocalOUI=ahLocalOUI, rxOctets=rxOctets, rxOversizePkts=rxOversizePkts, slotnum=slotnum, ingressPolicingType=ingressPolicingType, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxPackets512to1023=rxPackets512to1023, rxPackets128to255=rxPackets128to255, portnum=portnum, omnitronMIB=omnitronMIB, txLateCollision=txLateCollision, partnum=partnum, tftpServerIpAddress=tftpServerIpAddress, rxErrorPkts=rxErrorPkts, vlanPri=vlanPri, rxTotalPkts=rxTotalPkts, tftpEnable=tftpEnable, mmname=mmname, snmpTrapType=snmpTrapType, portSfpVcc=portSfpVcc, ahEnabled=ahEnabled, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modExpPartNumber=modExpPartNumber, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ftppasswrd=ftppasswrd, sysAdminStatus=sysAdminStatus, ostProtocolStatusEntry=ostProtocolStatusEntry, ahRemoteMode=ahRemoteMode, modExpSoftwareRev=modExpSoftwareRev, portvlanidentifier=portvlanidentifier, ahClearStatistics=ahClearStatistics, modsoftrev=modsoftrev, chassis=chassis, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portStatsClear=portStatsClear, snmpv3SecurityLevel=snmpv3SecurityLevel, slaveTrapsForward=slaveTrapsForward, chassisEntry=chassisEntry, PYSNMP_MODULE_ID=omnitronMIB, rxDropPkts=rxDropPkts, validityflag=validityflag, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, txMulticastPkts=txMulticastPkts)
mibBuilder.exportSymbols("OMNITRON-MIB", portSFPstatus=portSFPstatus, txSingleCollision=txSingleCollision, subnetmask2=subnetmask2, defaultForwardingMap=defaultForwardingMap, txOctets64=txOctets64, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, txDropPkts=txDropPkts, rxUnicastPkts=rxUnicastPkts, ahLpbkMode=ahLpbkMode, ahRemoteLinkFlags=ahRemoteLinkFlags, traphost8=traphost8, portSfpBiasCurrent=portSfpBiasCurrent, txDroppedEvents=txDroppedEvents, dhcpIpAddr=dhcpIpAddr, modenable802dot1qProcessing=modenable802dot1qProcessing, resetmod=resetmod, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portSfpDateCode=portSfpDateCode, modHwRev=modHwRev, traphost7=traphost7, tftpFileName=tftpFileName, modname=modname, modulename=modulename, txExcessiveCollision=txExcessiveCollision, port6Membership=port6Membership, portegresspolicy=portegresspolicy, selfSlot=selfSlot, portSFPpageA0=portSFPpageA0, modPcbRev=modPcbRev, portIngressRateDropOrPause=portIngressRateDropOrPause, switchstat=switchstat, omnitronProducts=omnitronProducts, omnitronSFPGroup=omnitronSFPGroup, cnodeCIR=cnodeCIR, modeType=modeType, ahErroredFrameWindow=ahErroredFrameWindow, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, txCollisions=txCollisions, enabledFunctions=enabledFunctions, snmpv3UserType=snmpv3UserType, portSfpTxPower=portSfpTxPower, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ipAddr=ipAddr, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, capsMask=capsMask, prodtype=prodtype, coreStatusOnly=coreStatusOnly, snmpv3UserName=snmpv3UserName, txDeferedTransmit=txDeferedTransmit, portFwdCpuList=portFwdCpuList, portSfpTemperature=portSfpTemperature, rxSymbolErrors=rxSymbolErrors, ahRemoteLinkPort=ahRemoteLinkPort, traphost6=traphost6, portingresssecurity=portingresssecurity, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow)
