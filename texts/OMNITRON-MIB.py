...
OstModeType, OstPortList, omnitron, OstVlanId, icAgent, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstPortList", "omnitron", "OstVlanId", "icAgent", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", portIngressRate=portIngressRate, dhcpGateway=dhcpGateway, subnetmask=subnetmask, slaveTraps=slaveTraps, portSfpVendorPartNumber=portSfpVendorPartNumber, slaveWrite=slaveWrite, customertag=customertag, portSFPEntry=portSFPEntry, chassis=chassis, portSfpDateCode=portSfpDateCode, omnitronGroups=omnitronGroups, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, portIngressRateCBS=portIngressRateCBS, portStatsClear=portStatsClear, ahLocalMuxState=ahLocalMuxState, port1Membership=port1Membership, serialnum=serialnum, portingresssecurity=portingresssecurity, omnitronCompliance=omnitronCompliance, modmanufdate=modmanufdate, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, muxGroupDefaults=muxGroupDefaults, port4Membership=port4Membership, traphost5=traphost5, txDropPkts=txDropPkts, ahLpbkMode=ahLpbkMode, omnitronProducts=omnitronProducts, ostProtocolStatusIndex=ostProtocolStatusIndex, nmmSecureSlaveSlot=nmmSecureSlaveSlot, snmpv3UserType=snmpv3UserType, port6Membership=port6Membership, moduleVLANEntry=moduleVLANEntry, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, modportvlan=modportvlan, chassisnum=chassisnum, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, dhcpSubnetmask=dhcpSubnetmask, ipaddr2EVCassociation=ipaddr2EVCassociation, switchstat=switchstat, rxPackets1024to1518=rxPackets1024to1518, rxUndersizePkts=rxUndersizePkts, nmmIpDisabled=nmmIpDisabled, traphost7=traphost7, txDroppedEvents=txDroppedEvents, modpartnum=modpartnum, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ahRemoteMuxState=ahRemoteMuxState, enabledFunctions=enabledFunctions, moduleMgtCfgTable=moduleMgtCfgTable, userEntry=userEntry, snmpv3AuthPassword=snmpv3AuthPassword, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, sysDateTime=sysDateTime, cpuVoltageOut=cpuVoltageOut, rxOctets64=rxOctets64, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, portSFPpageA0=portSFPpageA0, rxGoodPkts=rxGoodPkts, rxPackets64=rxPackets64, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, defaultForwardingMap=defaultForwardingMap, txOctets=txOctets, portSfpRxPower=portSfpRxPower, bootpEnable=bootpEnable, txGoodPkts=txGoodPkts, modtagsubstitution=modtagsubstitution, rxOversizePkts=rxOversizePkts, modExpPartNumber=modExpPartNumber, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portAHTable=portAHTable, sysloc=sysloc, enableSNMPFunction=enableSNMPFunction, ipAddr=ipAddr, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modHwRev=modHwRev, portSfpTxPower=portSfpTxPower, vlanidentifier=vlanidentifier, subnetmask2=subnetmask2, rxAlignmentErrors=rxAlignmentErrors, managementModule=managementModule, mychassnum=mychassnum, rxPausePkts=rxPausePkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ledstat=ledstat, coreStatusOnly=coreStatusOnly, dhcpTagVid=dhcpTagVid, vlanPri=vlanPri, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, tftpServerIpAddress=tftpServerIpAddress, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, traphost4=traphost4, portFwdCpuList=portFwdCpuList, portEgressQosPolicy=portEgressQosPolicy, ahCriticalEventTrapList=ahCriticalEventTrapList, modcommitNMMCfgChanges=modcommitNMMCfgChanges, extended5=extended5, modcommitVLANchanges=modcommitVLANchanges, modslotnum=modslotnum, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, softrev=softrev, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, manufdate=manufdate, index=index, userTable=userTable, extended3=extended3, wrswitch=wrswitch, modreset=modreset, portL2CPmgntProcessing=portL2CPmgntProcessing, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, modLM80misc=modLM80misc, mmname=mmname, partnum=partnum, dhcpPortNumber=dhcpPortNumber, writeCommunity=writeCommunity, dhcptftpServerIpAddress=dhcptftpServerIpAddress, vlanservicetag=vlanservicetag, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxErrorPkts=rxErrorPkts, port2Membership=port2Membership, portDuplex=portDuplex, modLM80currents=modLM80currents, moduleEntry=moduleEntry, modchassnum=modchassnum, modextfeaturebits=modextfeaturebits, txSingleCollision=txSingleCollision, ahErroredFrameWindow=ahErroredFrameWindow, portSpeed=portSpeed, ostProtocolStatusState=ostProtocolStatusState, ahLocalParserState=ahLocalParserState, rxBroadcastPkts=rxBroadcastPkts, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxUnicastPkts=rxUnicastPkts, modenable802dot1qProcessing=modenable802dot1qProcessing, ahFramePeriodEventTotal=ahFramePeriodEventTotal, modExpSoftwareRev=modExpSoftwareRev, txMultipleCollision=txMultipleCollision, extended1=extended1, portSFPpageA2=portSFPpageA2, extended6=extended6, portStatsTable=portStatsTable, ahRemoteOUI=ahRemoteOUI, moduleMgtCfgEntry=moduleMgtCfgEntry, ahRemoteLinkPort=ahRemoteLinkPort, portSfpVendorName=portSfpVendorName, omnitronGroup=omnitronGroup, modFpgaRev=modFpgaRev, ahRemoteMode=ahRemoteMode, portegresspolicy=portegresspolicy, ahTransmissionRate=ahTransmissionRate, rxSymbolErrors=rxSymbolErrors, portSfpVcc=portSfpVcc, port5Membership=port5Membership, modserialnum=modserialnum, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahRemoteSupportVar=ahRemoteSupportVar, tftpFileName=tftpFileName, servicetag=servicetag, portLinkState=portLinkState, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portState=portState, snmpv3SecurityLevel=snmpv3SecurityLevel, prodAgent=prodAgent, omnitronCompliances=omnitronCompliances, snmpTrapType=snmpTrapType, slaveTrapsForward=slaveTrapsForward, ahLocalMode=ahLocalMode, txPausePkts=txPausePkts, ahCriticalEventMode=ahCriticalEventMode, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portmlistcriteria=portmlistcriteria, chassistype=chassistype, prodrev=prodrev, rxDropPkts=rxDropPkts, dhcpIpAddr=dhcpIpAddr, ostProtocolStatusEntry=ostProtocolStatusEntry, chassisEntry=chassisEntry, traphost8=traphost8, ostProtocolStatusType=ostProtocolStatusType, portAHEntry=portAHEntry, txCollisions=txCollisions, txOctets64=txOctets64, rxPackets128to255=rxPackets128to255, portSfpTemperature=portSfpTemperature, port3Membership=port3Membership, telnetpass=telnetpass, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, enableSNMPWrites=enableSNMPWrites, portnum=portnum, userIndex=userIndex, portFwdCpu=portFwdCpu, ahClearStatistics=ahClearStatistics, modnumports=modnumports, txBroadcastPkts=txBroadcastPkts, rxFragments=rxFragments, txMulticastPkts=txMulticastPkts, ahEnabled=ahEnabled, syscon=syscon, validityflag=validityflag, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, sysAdminStatus=sysAdminStatus, ahErroredFrameThreshold=ahErroredFrameThreshold, extended4=extended4, slotnum=slotnum, enhancedchassisTable=enhancedchassisTable, chassisname=chassisname, resetmod=resetmod, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, nmmIpProtocolState=nmmIpProtocolState, cpuVoltageIn=cpuVoltageIn, nmmSecureMode=nmmSecureMode, modExpLedStatus=modExpLedStatus, portSFPstatus=portSFPstatus, cpuTemperature=cpuTemperature, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, traphost1=traphost1, nmmOAMmgmtMode=nmmOAMmgmtMode, moduleVLANTable=moduleVLANTable, omnitronConformance=omnitronConformance, ingressPolicingType=ingressPolicingType, chassisTable=chassisTable, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ftppasswrd=ftppasswrd, omnitronMIB=omnitronMIB, rxOctets=rxOctets, txLateCollision=txLateCollision, portpriority=portpriority, txErrorPkts=txErrorPkts, portAccessType=portAccessType, ahRemoteParserState=ahRemoteParserState, rxMulticastPkts=rxMulticastPkts, modulePortsEntry=modulePortsEntry, gateway2=gateway2, txUnicastPkts=txUnicastPkts, portSfpBiasCurrent=portSfpBiasCurrent, ahLocalLpbkTimeout=ahLocalLpbkTimeout, snmpv3PrivPassword=snmpv3PrivPassword, portStatsEntry=portStatsEntry, ahLocalLinkFlags=ahLocalLinkFlags, modvlanTableClear=modvlanTableClear, modswbuildnum=modswbuildnum, tftpEnable=tftpEnable, rxPackets512to1023=rxPackets512to1023, rxJabbers=rxJabbers, modeType=modeType, snmpv3UserName=snmpv3UserName, ostProtocoManagementPort=ostProtocoManagementPort, modLM80volts=modLM80volts, portSFPTable=portSFPTable, traphost3=traphost3, ahLocalSupportVar=ahLocalSupportVar, ahRemoteLinkFlags=ahRemoteLinkFlags, cnodeCIR=cnodeCIR)
mibBuilder.exportSymbols("OMNITRON-MIB", modname=modname, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxPackets256to511=rxPackets256to511, nmmSecureConnState=nmmSecureConnState, traphost6=traphost6, keepAliveInterval=keepAliveInterval, enableSNMPv3Function=enableSNMPv3Function, modulePortsTable=modulePortsTable, txExcessiveCollision=txExcessiveCollision, rxTotalPkts=rxTotalPkts, rxPackets65to127=rxPackets65to127, cnodeControl=cnodeControl, nmmCfgState=nmmCfgState, modchassname=modchassname, traphost2=traphost2, PYSNMP_MODULE_ID=omnitronMIB, trapSrcIpSelect=trapSrcIpSelect, selfSlot=selfSlot, portvlanidentifier=portvlanidentifier, portIngressRateDropOrPause=portIngressRateDropOrPause, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, txDeferedTransmit=txDeferedTransmit, omnitronSFPGroup=omnitronSFPGroup, prodtype=prodtype, portSfpBitRate=portSfpBitRate, ipaddrEVCassociation=ipaddrEVCassociation, rxCRCAlignErrors=rxCRCAlignErrors, readCommunity=readCommunity, portcanonicalformatIndicator=portcanonicalformatIndicator, modprodtype=modprodtype, modPcbRev=modPcbRev, modchasstype=modchasstype, rxFCSErrors=rxFCSErrors, moduleCount=moduleCount, extended2=extended2, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, macAddr=macAddr, vlanIdOst=vlanIdOst, portMacAddress=portMacAddress, moduleTable=moduleTable, ostProtocolStatusTable=ostProtocolStatusTable, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, gateway=gateway, ostEnvironmentalTemperature=ostEnvironmentalTemperature, modsoftrev=modsoftrev, modulename=modulename, modprodrev=modprodrev, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, serialpass=serialpass, ipAddr2=ipAddr2, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portEgressRate=portEgressRate, ahLocalOUI=ahLocalOUI, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, capsMask=capsMask, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status)
