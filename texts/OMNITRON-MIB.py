...
mibBuilder.exportSymbols("OMNITRON-MIB", traphost5=traphost5, ahCriticalEventMode=ahCriticalEventMode, txMultipleCollision=txMultipleCollision, portEgressQosPolicy=portEgressQosPolicy, dhcpTagVid=dhcpTagVid, ahRemoteLinkPort=ahRemoteLinkPort, modchasstype=modchasstype, modsoftrev=modsoftrev, rxOctets64=rxOctets64, ahLocalLpbkTimeout=ahLocalLpbkTimeout, dhcpSubnetmask=dhcpSubnetmask, rxAlignmentErrors=rxAlignmentErrors, ahRemoteLinkFlags=ahRemoteLinkFlags, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, modextfeaturebits=modextfeaturebits, ostProtocolStatusTable=ostProtocolStatusTable, txLateCollision=txLateCollision, ostProtocolStatusState=ostProtocolStatusState, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, gateway=gateway, ostProtocoManagementPort=ostProtocoManagementPort, port4Membership=port4Membership, rxUndersizePkts=rxUndersizePkts, txMulticastPkts=txMulticastPkts, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modswbuildnum=modswbuildnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, keepAliveInterval=keepAliveInterval, mmname=mmname, modcommitVLANchanges=modcommitVLANchanges, txOctets64=txOctets64, portAccessType=portAccessType, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, rxJabbers=rxJabbers, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, snmpv3SecurityLevel=snmpv3SecurityLevel, modprodrev=modprodrev, rxFragments=rxFragments, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, extended6=extended6, managementModule=managementModule, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ahRemoteMuxState=ahRemoteMuxState, rxPackets65to127=rxPackets65to127, modmanufdate=modmanufdate, portSfpVendorPartNumber=portSfpVendorPartNumber, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, selfSlot=selfSlot, port1Membership=port1Membership, defaultForwardingMap=defaultForwardingMap, ipAddr2=ipAddr2, chassistype=chassistype, snmpv3AuthPassword=snmpv3AuthPassword, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ahLocalLinkFlags=ahLocalLinkFlags, gateway2=gateway2, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, chassisname=chassisname, portDuplex=portDuplex, extended4=extended4, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, snmpv3UserType=snmpv3UserType, traphost2=traphost2, rxPausePkts=rxPausePkts, portSfpRxPower=portSfpRxPower, moduleMgtCfgTable=moduleMgtCfgTable, cpuTemperature=cpuTemperature, portFwdCpu=portFwdCpu, ahEnabled=ahEnabled, ahRemoteMode=ahRemoteMode, modPcbRev=modPcbRev, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, omnitronMIB=omnitronMIB, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, writeCommunity=writeCommunity, sysAdminStatus=sysAdminStatus, traphost1=traphost1, portAHEntry=portAHEntry, modenable802dot1qProcessing=modenable802dot1qProcessing, portSfpDateCode=portSfpDateCode, chassis=chassis, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modchassname=modchassname, coreStatusOnly=coreStatusOnly, portStatsTable=portStatsTable, validityflag=validityflag, rxPackets256to511=rxPackets256to511, ahLocalOUI=ahLocalOUI, servicetag=servicetag, modFpgaRev=modFpgaRev, portSfpTemperature=portSfpTemperature, userIndex=userIndex, rxOversizePkts=rxOversizePkts, port5Membership=port5Membership, omnitronSFPGroup=omnitronSFPGroup, modname=modname, sysDateTime=sysDateTime, port6Membership=port6Membership, traphost4=traphost4, portLinkState=portLinkState, vlanservicetag=vlanservicetag, ostProtocolStatusIndex=ostProtocolStatusIndex, chassisEntry=chassisEntry, rxOctets=rxOctets, cnodeControl=cnodeControl, cnodeCIR=cnodeCIR, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ahLocalParserState=ahLocalParserState, rxMulticastPkts=rxMulticastPkts, manufdate=manufdate, portIngressRateDropOrPause=portIngressRateDropOrPause, nmmSecureSlaveSlot=nmmSecureSlaveSlot, rxCRCAlignErrors=rxCRCAlignErrors, rxDropPkts=rxDropPkts, ahRemoteOUI=ahRemoteOUI, modLM80currents=modLM80currents, modulePortsTable=modulePortsTable, portState=portState, extended3=extended3, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, resetmod=resetmod, dhcpGateway=dhcpGateway, macAddr=macAddr, portSFPpageA0=portSFPpageA0, PYSNMP_MODULE_ID=omnitronMIB, modslotnum=modslotnum, omnitronCompliance=omnitronCompliance, ahLocalMode=ahLocalMode, modprodtype=modprodtype, modnumports=modnumports, txUnicastPkts=txUnicastPkts, moduleMgtCfgEntry=moduleMgtCfgEntry, muxGroupDefaults=muxGroupDefaults, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahErroredFrameWindow=ahErroredFrameWindow, rxErrorPkts=rxErrorPkts, ingressPolicingType=ingressPolicingType, extended2=extended2, ahLocalSupportVar=ahLocalSupportVar, moduleCount=moduleCount, moduleTable=moduleTable, cpuVoltageIn=cpuVoltageIn, dhcpPortNumber=dhcpPortNumber, portvlanidentifier=portvlanidentifier, ahLocalMuxState=ahLocalMuxState, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modreset=modreset, nmmIpDisabled=nmmIpDisabled, traphost6=traphost6, rxPackets512to1023=rxPackets512to1023, partnum=partnum, txBroadcastPkts=txBroadcastPkts, modLM80misc=modLM80misc, modExpLedStatus=modExpLedStatus, rxPackets128to255=rxPackets128to255, vlanidentifier=vlanidentifier, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ahCriticalEventTrapList=ahCriticalEventTrapList, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, portegresspolicy=portegresspolicy, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ipaddrEVCassociation=ipaddrEVCassociation, rxUnicastPkts=rxUnicastPkts, rxBroadcastPkts=rxBroadcastPkts, userEntry=userEntry, txDroppedEvents=txDroppedEvents, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portL2CPmgntProcessing=portL2CPmgntProcessing, telnetpass=telnetpass, nmmSecureMode=nmmSecureMode, txSingleCollision=txSingleCollision, enableSNMPWrites=enableSNMPWrites, txCollisions=txCollisions, modchassnum=modchassnum, tftpEnable=tftpEnable, enableSNMPFunction=enableSNMPFunction, txDeferedTransmit=txDeferedTransmit, enabledFunctions=enabledFunctions, portnum=portnum, portSFPEntry=portSFPEntry, prodrev=prodrev, syscon=syscon, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, modExpSoftwareRev=modExpSoftwareRev, nmmIpProtocolState=nmmIpProtocolState, modtagsubstitution=modtagsubstitution, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, vlanIdOst=vlanIdOst, traphost3=traphost3, sysloc=sysloc, portpriority=portpriority, ahErroredFrameThreshold=ahErroredFrameThreshold, extended1=extended1, chassisnum=chassisnum, ostEnvironmentalTemperature=ostEnvironmentalTemperature, nmmSecureConnState=nmmSecureConnState, customertag=customertag, subnetmask2=subnetmask2, wrswitch=wrswitch, ipaddr2EVCassociation=ipaddr2EVCassociation, rxPackets1024to1518=rxPackets1024to1518, softrev=softrev, portSfpTxPower=portSfpTxPower, userTable=userTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modeType=modeType, modHwRev=modHwRev, portSFPpageA2=portSFPpageA2, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ostProtocolStatusType=ostProtocolStatusType, portmlistcriteria=portmlistcriteria, txDropPkts=txDropPkts, trapSrcIpSelect=trapSrcIpSelect, snmpv3UserName=snmpv3UserName, index=index, ahClearStatistics=ahClearStatistics, ostProtocolStatusEntry=ostProtocolStatusEntry, traphost8=traphost8, subnetmask=subnetmask, modulePortsEntry=modulePortsEntry, moduleVLANEntry=moduleVLANEntry, moduleEntry=moduleEntry, omnitronConformance=omnitronConformance, readCommunity=readCommunity, txGoodPkts=txGoodPkts, modportvlan=modportvlan, omnitronCompliances=omnitronCompliances, prodtype=prodtype, modLM80volts=modLM80volts, enableSNMPv3Function=enableSNMPv3Function, mychassnum=mychassnum, portcanonicalformatIndicator=portcanonicalformatIndicator, rxGoodPkts=rxGoodPkts, vlanPri=vlanPri, slotnum=slotnum, portIngressRateCBS=portIngressRateCBS, prodAgent=prodAgent, ahRemoteParserState=ahRemoteParserState, rxPackets64=rxPackets64, omnitronGroups=omnitronGroups, ahRemoteSupportVar=ahRemoteSupportVar, chassisTable=chassisTable, slaveWrite=slaveWrite, dhcpIpAddr=dhcpIpAddr, portSfpBitRate=portSfpBitRate, snmpTrapType=snmpTrapType, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxTotalPkts=rxTotalPkts, portSfpVendorName=portSfpVendorName, slaveTraps=slaveTraps)
mibBuilder.exportSymbols("OMNITRON-MIB", tftpServerIpAddress=tftpServerIpAddress, nmmOAMmgmtMode=nmmOAMmgmtMode, portSFPstatus=portSFPstatus, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portMacAddress=portMacAddress, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ledstat=ledstat, switchstat=switchstat, ahLpbkMode=ahLpbkMode, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, txOctets=txOctets, txExcessiveCollision=txExcessiveCollision, serialpass=serialpass, serialnum=serialnum, portEgressRate=portEgressRate, omnitronGroup=omnitronGroup, ipAddr=ipAddr, ahTransmissionRate=ahTransmissionRate, portAHTable=portAHTable, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, txErrorPkts=txErrorPkts, rxFCSErrors=rxFCSErrors, portSfpBiasCurrent=portSfpBiasCurrent, ftppasswrd=ftppasswrd, portStatsEntry=portStatsEntry, port2Membership=port2Membership, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portSfpVcc=portSfpVcc, snmpv3PrivPassword=snmpv3PrivPassword, nmmCfgState=nmmCfgState, modpartnum=modpartnum, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, extended5=extended5, bootpEnable=bootpEnable, port3Membership=port3Membership, portStatsClear=portStatsClear, modExpPartNumber=modExpPartNumber, traphost7=traphost7, moduleVLANTable=moduleVLANTable, rxSymbolErrors=rxSymbolErrors, slaveTrapsForward=slaveTrapsForward, modulename=modulename, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portFwdCpuList=portFwdCpuList, capsMask=capsMask, tftpFileName=tftpFileName, omnitronProducts=omnitronProducts, portSFPTable=portSFPTable, portIngressRate=portIngressRate, txPausePkts=txPausePkts, modvlanTableClear=modvlanTableClear, enhancedchassisTable=enhancedchassisTable, cpuVoltageOut=cpuVoltageOut, portingresssecurity=portingresssecurity, modserialnum=modserialnum, portSpeed=portSpeed)
