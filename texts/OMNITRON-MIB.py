...
icAgent, OstPortNumber, OstModeType, OstPortList, omnitron, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstPortNumber", "OstModeType", "OstPortList", "omnitron", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", rxDropPkts=rxDropPkts, rxOctets64=rxOctets64, modLM80misc=modLM80misc, snmpv3AuthPassword=snmpv3AuthPassword, ahErroredFrameWindow=ahErroredFrameWindow, cpuVoltageOut=cpuVoltageOut, portIngressRate=portIngressRate, port3Membership=port3Membership, modextfeaturebits=modextfeaturebits, rxPausePkts=rxPausePkts, ahRemoteSupportVar=ahRemoteSupportVar, portMacAddress=portMacAddress, serialpass=serialpass, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ostEnvironmentalTemperature=ostEnvironmentalTemperature, traphost6=traphost6, ipAddr2=ipAddr2, userTable=userTable, ahClearStatistics=ahClearStatistics, traphost4=traphost4, modcommitVLANchanges=modcommitVLANchanges, extended6=extended6, rxBroadcastPkts=rxBroadcastPkts, portcanonicalformatIndicator=portcanonicalformatIndicator, portingresssecurity=portingresssecurity, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modFpgaRev=modFpgaRev, modulePortsEntry=modulePortsEntry, portSFPpageA0=portSFPpageA0, ahRemoteOUI=ahRemoteOUI, modExpLedStatus=modExpLedStatus, syscon=syscon, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahFramePeriodEventTotal=ahFramePeriodEventTotal, cnodeControl=cnodeControl, muxGroupDefaults=muxGroupDefaults, port2Membership=port2Membership, userEntry=userEntry, ahCriticalEventMode=ahCriticalEventMode, ahRemoteParserState=ahRemoteParserState, modHwRev=modHwRev, telnetpass=telnetpass, nmmCfgState=nmmCfgState, rxPackets512to1023=rxPackets512to1023, modLM80currents=modLM80currents, portAccessType=portAccessType, txOctets64=txOctets64, rxPackets1024to1518=rxPackets1024to1518, modExpSoftwareRev=modExpSoftwareRev, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, capsMask=capsMask, txCollisions=txCollisions, traphost7=traphost7, subnetmask=subnetmask, rxPackets64=rxPackets64, ahRemoteLinkFlags=ahRemoteLinkFlags, traphost8=traphost8, ahLocalParserState=ahLocalParserState, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portvlanidentifier=portvlanidentifier, txSingleCollision=txSingleCollision, ipaddr2EVCassociation=ipaddr2EVCassociation, selfSlot=selfSlot, tftpFileName=tftpFileName, nmmSecureConnState=nmmSecureConnState, modtagsubstitution=modtagsubstitution, rxErrorPkts=rxErrorPkts, ostProtocoManagementPort=ostProtocoManagementPort, snmpv3SecurityLevel=snmpv3SecurityLevel, ostProtocolStatusIndex=ostProtocolStatusIndex, cnodeCIR=cnodeCIR, dhcpGateway=dhcpGateway, manufdate=manufdate, snmpTrapType=snmpTrapType, rxFragments=rxFragments, portEgressRate=portEgressRate, cpuVoltageIn=cpuVoltageIn, customertag=customertag, switchstat=switchstat, portLinkState=portLinkState, traphost3=traphost3, rxPackets128to255=rxPackets128to255, modserialnum=modserialnum, ahRemoteLinkPort=ahRemoteLinkPort, ahErroredFrameThreshold=ahErroredFrameThreshold, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, txBroadcastPkts=txBroadcastPkts, extended4=extended4, defaultForwardingMap=defaultForwardingMap, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, dhcpTagVid=dhcpTagVid, ostProtocolStatusType=ostProtocolStatusType, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, mychassnum=mychassnum, sysloc=sysloc, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, enableSNMPWrites=enableSNMPWrites, chassisTable=chassisTable, partnum=partnum, modprodtype=modprodtype, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ahLpbkMode=ahLpbkMode, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, modportvlan=modportvlan, portSfpRxPower=portSfpRxPower, txUnicastPkts=txUnicastPkts, modulePortsTable=modulePortsTable, extended5=extended5, dhcpIpAddr=dhcpIpAddr, rxSymbolErrors=rxSymbolErrors, omnitronProducts=omnitronProducts, portStatsEntry=portStatsEntry, slaveWrite=slaveWrite, snmpv3PrivPassword=snmpv3PrivPassword, portEgressQosPolicy=portEgressQosPolicy, modLM80volts=modLM80volts, txDeferedTransmit=txDeferedTransmit, portSfpVendorName=portSfpVendorName, gateway=gateway, coreStatusOnly=coreStatusOnly, rxAlignmentErrors=rxAlignmentErrors, trapSrcIpSelect=trapSrcIpSelect, modExpPartNumber=modExpPartNumber, portnum=portnum, modvlanTableClear=modvlanTableClear, moduleMgtCfgTable=moduleMgtCfgTable, sysDateTime=sysDateTime, traphost1=traphost1, ledstat=ledstat, modslotnum=modslotnum, portIngressRateCBS=portIngressRateCBS, moduleTable=moduleTable, txErrorPkts=txErrorPkts, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, writeCommunity=writeCommunity, txLateCollision=txLateCollision, prodtype=prodtype, modswbuildnum=modswbuildnum, txDroppedEvents=txDroppedEvents, txMulticastPkts=txMulticastPkts, slotnum=slotnum, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, rxJabbers=rxJabbers, ahTransmissionRate=ahTransmissionRate, enhancedchassisTable=enhancedchassisTable, port4Membership=port4Membership, portegresspolicy=portegresspolicy, slaveTraps=slaveTraps, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, port1Membership=port1Membership, omnitronGroups=omnitronGroups, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, moduleEntry=moduleEntry, vlanidentifier=vlanidentifier, moduleMgtCfgEntry=moduleMgtCfgEntry, rxTotalPkts=rxTotalPkts, ahRemoteMode=ahRemoteMode, enableSNMPv3Function=enableSNMPv3Function, ahRemoteMuxState=ahRemoteMuxState, ahLocalSupportVar=ahLocalSupportVar, ingressPolicingType=ingressPolicingType, omnitronConformance=omnitronConformance, portSfpBiasCurrent=portSfpBiasCurrent, ahLocalMuxState=ahLocalMuxState, portStatsClear=portStatsClear, portSfpBitRate=portSfpBitRate, chassisnum=chassisnum, txPausePkts=txPausePkts, portIngressRateDropOrPause=portIngressRateDropOrPause, gateway2=gateway2, modchassname=modchassname, vlanPri=vlanPri, validityflag=validityflag, portFwdCpu=portFwdCpu, chassistype=chassistype, port6Membership=port6Membership, dhcpSubnetmask=dhcpSubnetmask, ahFrameErrorEventTotal=ahFrameErrorEventTotal, servicetag=servicetag, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxCRCAlignErrors=rxCRCAlignErrors, moduleCount=moduleCount, extended3=extended3, modname=modname, portSfpTxPower=portSfpTxPower, rxFCSErrors=rxFCSErrors, portAHEntry=portAHEntry, ipaddrEVCassociation=ipaddrEVCassociation, snmpv3UserType=snmpv3UserType, ostProtocolStatusEntry=ostProtocolStatusEntry, portSFPpageA2=portSFPpageA2, modprodrev=modprodrev, modenable802dot1qProcessing=modenable802dot1qProcessing, modulename=modulename, subnetmask2=subnetmask2, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, omnitronGroup=omnitronGroup, portFwdCpuList=portFwdCpuList, ahLocalLpbkTimeout=ahLocalLpbkTimeout, txOctets=txOctets, PYSNMP_MODULE_ID=omnitronMIB, portAHTable=portAHTable, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portState=portState, port5Membership=port5Membership, ahLocalLinkFlags=ahLocalLinkFlags, modchasstype=modchasstype, ahLocalOUI=ahLocalOUI, prodrev=prodrev, chassis=chassis, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, traphost5=traphost5, modeType=modeType, vlanservicetag=vlanservicetag, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, resetmod=resetmod, serialnum=serialnum, nmmSecureSlaveSlot=nmmSecureSlaveSlot, txDropPkts=txDropPkts, nmmIpProtocolState=nmmIpProtocolState, moduleVLANTable=moduleVLANTable, txExcessiveCollision=txExcessiveCollision, modPcbRev=modPcbRev, userIndex=userIndex, modnumports=modnumports, rxPackets256to511=rxPackets256to511, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxOversizePkts=rxOversizePkts, portStatsTable=portStatsTable, portpriority=portpriority, tftpEnable=tftpEnable, modpartnum=modpartnum, ftppasswrd=ftppasswrd, tftpServerIpAddress=tftpServerIpAddress, portSFPEntry=portSFPEntry, rxOctets=rxOctets, portSFPTable=portSFPTable, ahLocalMode=ahLocalMode, portL2CPmgntProcessing=portL2CPmgntProcessing, moduleVLANEntry=moduleVLANEntry, keepAliveInterval=keepAliveInterval, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, softrev=softrev, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, rxGoodPkts=rxGoodPkts, portSfpDateCode=portSfpDateCode, omnitronSFPGroup=omnitronSFPGroup, snmpv3UserName=snmpv3UserName, modsoftrev=modsoftrev)
mibBuilder.exportSymbols("OMNITRON-MIB", ostProtocolStatusTable=ostProtocolStatusTable, omnitronCompliances=omnitronCompliances, nmmIpDisabled=nmmIpDisabled, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, traphost2=traphost2, omnitronCompliance=omnitronCompliance, modreset=modreset, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, slaveTrapsForward=slaveTrapsForward, rxUnicastPkts=rxUnicastPkts, portSfpVendorPartNumber=portSfpVendorPartNumber, chassisname=chassisname, modmanufdate=modmanufdate, macAddr=macAddr, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahCriticalEventTrapList=ahCriticalEventTrapList, vlanIdOst=vlanIdOst, dhcpPortNumber=dhcpPortNumber, enableSNMPFunction=enableSNMPFunction, wrswitch=wrswitch, sysAdminStatus=sysAdminStatus, readCommunity=readCommunity, enabledFunctions=enabledFunctions, extended2=extended2, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, managementModule=managementModule, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, rxPackets65to127=rxPackets65to127, omnitronMIB=omnitronMIB, chassisEntry=chassisEntry, prodAgent=prodAgent, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, mmname=mmname, rxUndersizePkts=rxUndersizePkts, cpuTemperature=cpuTemperature, ostProtocolStatusState=ostProtocolStatusState, nmmSecureMode=nmmSecureMode, txGoodPkts=txGoodPkts, extended1=extended1, portmlistcriteria=portmlistcriteria, ipAddr=ipAddr, portSfpTemperature=portSfpTemperature, txMultipleCollision=txMultipleCollision, nmmOAMmgmtMode=nmmOAMmgmtMode, portSFPstatus=portSFPstatus, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modchassnum=modchassnum, modcommitNMMCfgChanges=modcommitNMMCfgChanges, rxMulticastPkts=rxMulticastPkts, ahEnabled=ahEnabled, index=index, portSpeed=portSpeed, portSfpVcc=portSfpVcc, bootpEnable=bootpEnable, portDuplex=portDuplex)
