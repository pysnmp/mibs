...
OstPortNumber, OstVlanId, omnitron, OstPortList, icAgent, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortNumber", "OstVlanId", "omnitron", "OstPortList", "icAgent", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", enableSNMPFunction=enableSNMPFunction, txDropPkts=txDropPkts, rxErrorPkts=rxErrorPkts, selfSlot=selfSlot, modchassnum=modchassnum, port1Membership=port1Membership, moduleEntry=moduleEntry, dhcpIpAddr=dhcpIpAddr, chassis=chassis, gateway=gateway, portL2CPmgntProcessing=portL2CPmgntProcessing, omnitronCompliances=omnitronCompliances, modHwRev=modHwRev, traphost5=traphost5, portSfpVendorSerialNumber=portSfpVendorSerialNumber, traphost8=traphost8, resetmod=resetmod, serialnum=serialnum, sysloc=sysloc, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, snmpTrapType=snmpTrapType, portEgressQosPolicy=portEgressQosPolicy, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxUnicastPkts=rxUnicastPkts, portIngressRateDropOrPause=portIngressRateDropOrPause, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahFramePeriodEventTotal=ahFramePeriodEventTotal, traphost1=traphost1, partnum=partnum, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modsoftrev=modsoftrev, rxCRCAlignErrors=rxCRCAlignErrors, ostProtocolStatusTable=ostProtocolStatusTable, portStatsClear=portStatsClear, txOctets=txOctets, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portingresssecurity=portingresssecurity, traphost4=traphost4, rxPackets128to255=rxPackets128to255, chassisTable=chassisTable, ledstat=ledstat, snmpv3SecurityLevel=snmpv3SecurityLevel, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portpriority=portpriority, modreset=modreset, txCollisions=txCollisions, nmmIpDisabled=nmmIpDisabled, extended4=extended4, servicetag=servicetag, modmanufdate=modmanufdate, portvlanidentifier=portvlanidentifier, softrev=softrev, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modchassname=modchassname, mmname=mmname, ahRemoteLinkPort=ahRemoteLinkPort, extended1=extended1, writeCommunity=writeCommunity, gateway2=gateway2, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, syscon=syscon, rxOctets64=rxOctets64, portFwdCpuList=portFwdCpuList, PYSNMP_MODULE_ID=omnitronMIB, txMultipleCollision=txMultipleCollision, ahLocalLpbkTimeout=ahLocalLpbkTimeout, rxOctets=rxOctets, chassisname=chassisname, customertag=customertag, snmpv3UserName=snmpv3UserName, modulename=modulename, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, portSFPTable=portSFPTable, modswbuildnum=modswbuildnum, manufdate=manufdate, vlanidentifier=vlanidentifier, port2Membership=port2Membership, rxMulticastPkts=rxMulticastPkts, tftpFileName=tftpFileName, rxSymbolErrors=rxSymbolErrors, nmmOAMmgmtMode=nmmOAMmgmtMode, ostProtocolStatusState=ostProtocolStatusState, ahCriticalEventTrapList=ahCriticalEventTrapList, port6Membership=port6Membership, coreStatusOnly=coreStatusOnly, rxFragments=rxFragments, ostProtocolStatusEntry=ostProtocolStatusEntry, modExpLedStatus=modExpLedStatus, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, txPausePkts=txPausePkts, rxBroadcastPkts=rxBroadcastPkts, ahLocalMuxState=ahLocalMuxState, modenable802dot1qProcessing=modenable802dot1qProcessing, moduleMgtCfgTable=moduleMgtCfgTable, switchstat=switchstat, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, dhcpPortNumber=dhcpPortNumber, snmpv3UserType=snmpv3UserType, portmlistcriteria=portmlistcriteria, ostEnvironmentalTemperature=ostEnvironmentalTemperature, cpuTemperature=cpuTemperature, rxPackets65to127=rxPackets65to127, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, dhcpGateway=dhcpGateway, vlanPri=vlanPri, moduleMgtCfgEntry=moduleMgtCfgEntry, rxOversizePkts=rxOversizePkts, chassisnum=chassisnum, modslotnum=modslotnum, portcanonicalformatIndicator=portcanonicalformatIndicator, portMacAddress=portMacAddress, rxPackets64=rxPackets64, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, omnitronMIB=omnitronMIB, extended5=extended5, portAHEntry=portAHEntry, txLateCollision=txLateCollision, portIngressRate=portIngressRate, ahErroredFrameWindow=ahErroredFrameWindow, defaultForwardingMap=defaultForwardingMap, moduleVLANTable=moduleVLANTable, portSfpTemperature=portSfpTemperature, cnodeControl=cnodeControl, portAccessType=portAccessType, ipAddr=ipAddr, ipaddr2EVCassociation=ipaddr2EVCassociation, modeType=modeType, portegresspolicy=portegresspolicy, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portSfpTxPower=portSfpTxPower, snmpv3AuthPassword=snmpv3AuthPassword, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, keepAliveInterval=keepAliveInterval, rxAlignmentErrors=rxAlignmentErrors, tftpEnable=tftpEnable, txOctets64=txOctets64, traphost3=traphost3, sysAdminStatus=sysAdminStatus, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ipaddrEVCassociation=ipaddrEVCassociation, modulePortsTable=modulePortsTable, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, nmmSecureMode=nmmSecureMode, port3Membership=port3Membership, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portIngressRateCBS=portIngressRateCBS, nmmCfgState=nmmCfgState, moduleCount=moduleCount, txDroppedEvents=txDroppedEvents, ahRemoteMuxState=ahRemoteMuxState, modExpPartNumber=modExpPartNumber, portSfpDateCode=portSfpDateCode, txGoodPkts=txGoodPkts, modvlanTableClear=modvlanTableClear, userIndex=userIndex, ahLocalOUI=ahLocalOUI, ahEnabled=ahEnabled, portStatsEntry=portStatsEntry, rxPackets512to1023=rxPackets512to1023, enableSNMPWrites=enableSNMPWrites, subnetmask2=subnetmask2, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, modLM80volts=modLM80volts, muxGroupDefaults=muxGroupDefaults, ahLocalLinkFlags=ahLocalLinkFlags, modLM80misc=modLM80misc, ahRemoteParserState=ahRemoteParserState, ahClearStatistics=ahClearStatistics, chassisEntry=chassisEntry, extended3=extended3, modportvlan=modportvlan, extended2=extended2, rxPackets1024to1518=rxPackets1024to1518, ostProtocolStatusType=ostProtocolStatusType, portSfpVendorName=portSfpVendorName, omnitronGroup=omnitronGroup, rxGoodPkts=rxGoodPkts, slotnum=slotnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portSFPpageA0=portSFPpageA0, omnitronSFPGroup=omnitronSFPGroup, modcommitVLANchanges=modcommitVLANchanges, moduleTable=moduleTable, port4Membership=port4Membership, portState=portState, ahErroredFrameThreshold=ahErroredFrameThreshold, mychassnum=mychassnum, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSfpVcc=portSfpVcc, portSpeed=portSpeed, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, traphost6=traphost6, portDuplex=portDuplex, enableSNMPv3Function=enableSNMPv3Function, modPcbRev=modPcbRev, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahLocalMode=ahLocalMode, modpartnum=modpartnum, txMulticastPkts=txMulticastPkts, modprodtype=modprodtype, txSingleCollision=txSingleCollision, txDeferedTransmit=txDeferedTransmit, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, omnitronCompliance=omnitronCompliance, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, userEntry=userEntry, ostProtocolStatusIndex=ostProtocolStatusIndex, index=index, ahRemoteLinkFlags=ahRemoteLinkFlags, telnetpass=telnetpass, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, vlanIdOst=vlanIdOst, portAHTable=portAHTable, portEgressRate=portEgressRate, modLM80currents=modLM80currents, slaveTraps=slaveTraps, snmpv3PrivPassword=snmpv3PrivPassword, nmmSecureConnState=nmmSecureConnState, portSFPEntry=portSFPEntry, moduleVLANEntry=moduleVLANEntry, extended6=extended6, modExpSoftwareRev=modExpSoftwareRev, modulePortsEntry=modulePortsEntry, omnitronConformance=omnitronConformance, macAddr=macAddr, rxUndersizePkts=rxUndersizePkts, serialpass=serialpass, portSFPstatus=portSFPstatus, rxDropPkts=rxDropPkts, dhcpTagVid=dhcpTagVid, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, rxPausePkts=rxPausePkts, rxPackets256to511=rxPackets256to511, ahLocalParserState=ahLocalParserState, modserialnum=modserialnum, prodtype=prodtype, enabledFunctions=enabledFunctions, enhancedchassisTable=enhancedchassisTable, modnumports=modnumports, slaveWrite=slaveWrite, ahRemoteOUI=ahRemoteOUI, capsMask=capsMask, portFwdCpu=portFwdCpu, ahCriticalEventMode=ahCriticalEventMode, ostProtocoManagementPort=ostProtocoManagementPort, cnodeCIR=cnodeCIR, txExcessiveCollision=txExcessiveCollision, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, omnitronGroups=omnitronGroups, modextfeaturebits=modextfeaturebits, traphost2=traphost2)
mibBuilder.exportSymbols("OMNITRON-MIB", bootpEnable=bootpEnable, txErrorPkts=txErrorPkts, port5Membership=port5Membership, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, portLinkState=portLinkState, portSfpBitRate=portSfpBitRate, rxTotalPkts=rxTotalPkts, ahRemoteMode=ahRemoteMode, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, readCommunity=readCommunity, vlanservicetag=vlanservicetag, cpuVoltageIn=cpuVoltageIn, modprodrev=modprodrev, sysDateTime=sysDateTime, portSfpBiasCurrent=portSfpBiasCurrent, portnum=portnum, modchasstype=modchasstype, portSfpVendorPartNumber=portSfpVendorPartNumber, modname=modname, ahRemoteSupportVar=ahRemoteSupportVar, trapSrcIpSelect=trapSrcIpSelect, txBroadcastPkts=txBroadcastPkts, portStatsTable=portStatsTable, txUnicastPkts=txUnicastPkts, rxJabbers=rxJabbers, ahTransmissionRate=ahTransmissionRate, prodAgent=prodAgent, ftppasswrd=ftppasswrd, slaveTrapsForward=slaveTrapsForward, ahLpbkMode=ahLpbkMode, modtagsubstitution=modtagsubstitution, portSFPpageA2=portSFPpageA2, portSfpRxPower=portSfpRxPower, subnetmask=subnetmask, rxFCSErrors=rxFCSErrors, modFpgaRev=modFpgaRev, nmmIpProtocolState=nmmIpProtocolState, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, cpuVoltageOut=cpuVoltageOut, dhcpSubnetmask=dhcpSubnetmask, validityflag=validityflag, prodrev=prodrev, traphost7=traphost7, managementModule=managementModule, ingressPolicingType=ingressPolicingType, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, omnitronProducts=omnitronProducts, wrswitch=wrswitch, ipAddr2=ipAddr2, tftpServerIpAddress=tftpServerIpAddress, chassistype=chassistype, userTable=userTable, ahLocalSupportVar=ahLocalSupportVar, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut)
