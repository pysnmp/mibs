...
OstModeType, OstPortNumber, OstPortList, omnitron, icAgent, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstPortNumber", "OstPortList", "omnitron", "icAgent", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", rxMulticastPkts=rxMulticastPkts, moduleVLANTable=moduleVLANTable, managementModule=managementModule, modreset=modreset, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, traphost2=traphost2, nmmIpDisabled=nmmIpDisabled, ahCriticalEventTrapList=ahCriticalEventTrapList, enableSNMPv3Function=enableSNMPv3Function, snmpTrapType=snmpTrapType, modchassname=modchassname, modprodrev=modprodrev, modeType=modeType, softrev=softrev, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, enableSNMPWrites=enableSNMPWrites, modextfeaturebits=modextfeaturebits, omnitronSFPGroup=omnitronSFPGroup, txErrorPkts=txErrorPkts, portmlistcriteria=portmlistcriteria, portSfpRxPower=portSfpRxPower, portSfpTemperature=portSfpTemperature, txLateCollision=txLateCollision, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, txDeferedTransmit=txDeferedTransmit, txOctets64=txOctets64, validityflag=validityflag, portSfpTxPower=portSfpTxPower, rxErrorPkts=rxErrorPkts, portIngressRate=portIngressRate, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, rxDropPkts=rxDropPkts, rxBroadcastPkts=rxBroadcastPkts, snmpv3UserType=snmpv3UserType, traphost7=traphost7, port3Membership=port3Membership, portAHTable=portAHTable, portSFPpageA2=portSFPpageA2, traphost8=traphost8, snmpv3SecurityLevel=snmpv3SecurityLevel, txExcessiveCollision=txExcessiveCollision, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, telnetpass=telnetpass, portStatsClear=portStatsClear, ahTransmissionRate=ahTransmissionRate, ostProtocolStatusState=ostProtocolStatusState, portDuplex=portDuplex, portSfpBitRate=portSfpBitRate, portFwdCpuList=portFwdCpuList, modFpgaRev=modFpgaRev, txSingleCollision=txSingleCollision, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, dhcpSubnetmask=dhcpSubnetmask, modchasstype=modchasstype, ahErroredFrameThreshold=ahErroredFrameThreshold, portEgressRate=portEgressRate, slaveTrapsForward=slaveTrapsForward, txMulticastPkts=txMulticastPkts, defaultForwardingMap=defaultForwardingMap, chassistype=chassistype, enhancedchassisTable=enhancedchassisTable, modvlanTableClear=modvlanTableClear, ahEnabled=ahEnabled, rxUnicastPkts=rxUnicastPkts, ahLocalParserState=ahLocalParserState, modslotnum=modslotnum, rxPackets64=rxPackets64, ahLocalMode=ahLocalMode, ostProtocolStatusIndex=ostProtocolStatusIndex, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, nmmCfgState=nmmCfgState, portnum=portnum, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, prodtype=prodtype, modenable802dot1qProcessing=modenable802dot1qProcessing, sysAdminStatus=sysAdminStatus, modHwRev=modHwRev, rxTotalPkts=rxTotalPkts, rxSymbolErrors=rxSymbolErrors, chassisTable=chassisTable, portStatsEntry=portStatsEntry, moduleMgtCfgEntry=moduleMgtCfgEntry, slaveWrite=slaveWrite, dhcpPortNumber=dhcpPortNumber, sysDateTime=sysDateTime, writeCommunity=writeCommunity, gateway2=gateway2, txCollisions=txCollisions, modulePortsEntry=modulePortsEntry, extended4=extended4, userEntry=userEntry, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ahRemoteLinkFlags=ahRemoteLinkFlags, rxOversizePkts=rxOversizePkts, txUnicastPkts=txUnicastPkts, txMultipleCollision=txMultipleCollision, prodAgent=prodAgent, ahCriticalEventMode=ahCriticalEventMode, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, tftpServerIpAddress=tftpServerIpAddress, keepAliveInterval=keepAliveInterval, ftppasswrd=ftppasswrd, ipAddr=ipAddr, servicetag=servicetag, modLM80misc=modLM80misc, trapSrcIpSelect=trapSrcIpSelect, txPausePkts=txPausePkts, omnitronCompliance=omnitronCompliance, subnetmask2=subnetmask2, portSFPpageA0=portSFPpageA0, rxFCSErrors=rxFCSErrors, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxPackets128to255=rxPackets128to255, ahLocalMuxState=ahLocalMuxState, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ahRemoteOUI=ahRemoteOUI, slotnum=slotnum, port4Membership=port4Membership, portAHEntry=portAHEntry, omnitronConformance=omnitronConformance, extended5=extended5, nmmOAMmgmtMode=nmmOAMmgmtMode, portAccessType=portAccessType, nmmSecureConnState=nmmSecureConnState, portState=portState, snmpv3UserName=snmpv3UserName, txBroadcastPkts=txBroadcastPkts, moduleMgtCfgTable=moduleMgtCfgTable, extended3=extended3, cpuVoltageIn=cpuVoltageIn, rxCRCAlignErrors=rxCRCAlignErrors, vlanservicetag=vlanservicetag, portSFPEntry=portSFPEntry, ostProtocolStatusTable=ostProtocolStatusTable, serialpass=serialpass, modLM80volts=modLM80volts, vlanPri=vlanPri, vlanIdOst=vlanIdOst, portSfpVendorSerialNumber=portSfpVendorSerialNumber, omnitronGroup=omnitronGroup, userTable=userTable, modserialnum=modserialnum, tftpEnable=tftpEnable, modtagsubstitution=modtagsubstitution, modsoftrev=modsoftrev, enableSNMPFunction=enableSNMPFunction, extended1=extended1, portIngressRateDropOrPause=portIngressRateDropOrPause, sysloc=sysloc, rxJabbers=rxJabbers, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, modname=modname, port5Membership=port5Membership, modRestoreFactoryDefaults=modRestoreFactoryDefaults, moduleCount=moduleCount, portvlanidentifier=portvlanidentifier, portStatsTable=portStatsTable, txOctets=txOctets, extended2=extended2, dhcpGateway=dhcpGateway, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ahRemoteSupportVar=ahRemoteSupportVar, modExpSoftwareRev=modExpSoftwareRev, omnitronMIB=omnitronMIB, ahLpbkMode=ahLpbkMode, snmpv3PrivPassword=snmpv3PrivPassword, dhcpTagVid=dhcpTagVid, rxFragments=rxFragments, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portMacAddress=portMacAddress, ostProtocoManagementPort=ostProtocoManagementPort, ahLocalLpbkTimeout=ahLocalLpbkTimeout, cnodeCIR=cnodeCIR, ahRemoteMuxState=ahRemoteMuxState, ahLocalSupportVar=ahLocalSupportVar, vlanidentifier=vlanidentifier, moduleVLANEntry=moduleVLANEntry, ahClearStatistics=ahClearStatistics, port2Membership=port2Membership, ahLocalOUI=ahLocalOUI, ostProtocolStatusEntry=ostProtocolStatusEntry, omnitronCompliances=omnitronCompliances, portSFPTable=portSFPTable, prodrev=prodrev, manufdate=manufdate, modulename=modulename, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, syscon=syscon, moduleEntry=moduleEntry, ahRemoteLinkPort=ahRemoteLinkPort, portIngressRateCBS=portIngressRateCBS, portingresssecurity=portingresssecurity, ingressPolicingType=ingressPolicingType, rxOctets64=rxOctets64, modLM80currents=modLM80currents, dhcpIpAddr=dhcpIpAddr, extended6=extended6, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, modportvlan=modportvlan, cnodeControl=cnodeControl, modnumports=modnumports, tftpFileName=tftpFileName, rxOctets=rxOctets, ahRemoteParserState=ahRemoteParserState, txDropPkts=txDropPkts, nmmSecureMode=nmmSecureMode, modExpPartNumber=modExpPartNumber, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portEgressQosPolicy=portEgressQosPolicy, partnum=partnum, snmpv3AuthPassword=snmpv3AuthPassword, mmname=mmname, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portSfpBiasCurrent=portSfpBiasCurrent, portSfpVendorName=portSfpVendorName, coreStatusOnly=coreStatusOnly, macAddr=macAddr, ipAddr2=ipAddr2, cpuVoltageOut=cpuVoltageOut, traphost5=traphost5, portLinkState=portLinkState, ipaddrEVCassociation=ipaddrEVCassociation, bootpEnable=bootpEnable, ahLocalLinkFlags=ahLocalLinkFlags, modulePortsTable=modulePortsTable, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modcommitVLANchanges=modcommitVLANchanges, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, rxPackets256to511=rxPackets256to511, enabledFunctions=enabledFunctions, chassis=chassis, portSpeed=portSpeed, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, traphost3=traphost3, portegresspolicy=portegresspolicy, wrswitch=wrswitch, traphost6=traphost6, cpuTemperature=cpuTemperature, portSFPstatus=portSFPstatus, omnitronProducts=omnitronProducts, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, rxGoodPkts=rxGoodPkts, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, capsMask=capsMask, rxPackets1024to1518=rxPackets1024to1518, chassisEntry=chassisEntry, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, slaveTraps=slaveTraps)
mibBuilder.exportSymbols("OMNITRON-MIB", resetmod=resetmod, modmanufdate=modmanufdate, chassisname=chassisname, txGoodPkts=txGoodPkts, portpriority=portpriority, selfSlot=selfSlot, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, readCommunity=readCommunity, moduleTable=moduleTable, muxGroupDefaults=muxGroupDefaults, portSfpDateCode=portSfpDateCode, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, port1Membership=port1Membership, ahErroredFrameWindow=ahErroredFrameWindow, portL2CPmgntProcessing=portL2CPmgntProcessing, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, PYSNMP_MODULE_ID=omnitronMIB, subnetmask=subnetmask, dhcptftpServerIpAddress=dhcptftpServerIpAddress, modchassnum=modchassnum, txDroppedEvents=txDroppedEvents, ledstat=ledstat, customertag=customertag, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, omnitronGroups=omnitronGroups, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, chassisnum=chassisnum, serialnum=serialnum, rxPausePkts=rxPausePkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modpartnum=modpartnum, ipaddr2EVCassociation=ipaddr2EVCassociation, port6Membership=port6Membership, ostProtocolStatusType=ostProtocolStatusType, gateway=gateway, userIndex=userIndex, nmmIpProtocolState=nmmIpProtocolState, switchstat=switchstat, modswbuildnum=modswbuildnum, modExpLedStatus=modExpLedStatus, rxPackets512to1023=rxPackets512to1023, ostEnvironmentalTemperature=ostEnvironmentalTemperature, traphost4=traphost4, modPcbRev=modPcbRev, portSfpVcc=portSfpVcc, traphost1=traphost1, portFwdCpu=portFwdCpu, ahRemoteMode=ahRemoteMode, mychassnum=mychassnum, modprodtype=modprodtype, portSfpVendorPartNumber=portSfpVendorPartNumber, rxUndersizePkts=rxUndersizePkts, portcanonicalformatIndicator=portcanonicalformatIndicator, index=index, rxPackets65to127=rxPackets65to127, rxAlignmentErrors=rxAlignmentErrors)
