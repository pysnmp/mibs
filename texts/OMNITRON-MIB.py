...
icAgent, OstVlanId, OstPortList, OstPortNumber, omnitron, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstVlanId", "OstPortList", "OstPortNumber", "omnitron", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ftppasswrd=ftppasswrd, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, rxOctets64=rxOctets64, muxGroupDefaults=muxGroupDefaults, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, traphost5=traphost5, enableSNMPv3Function=enableSNMPv3Function, portvlanidentifier=portvlanidentifier, portFwdCpuList=portFwdCpuList, moduleVLANTable=moduleVLANTable, serialnum=serialnum, prodrev=prodrev, cpuTemperature=cpuTemperature, txPausePkts=txPausePkts, snmpv3PrivPassword=snmpv3PrivPassword, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, txErrorPkts=txErrorPkts, txSingleCollision=txSingleCollision, modenable802dot1qProcessing=modenable802dot1qProcessing, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, traphost1=traphost1, modprodrev=modprodrev, modextfeaturebits=modextfeaturebits, cpuVoltageOut=cpuVoltageOut, capsMask=capsMask, portSfpBitRate=portSfpBitRate, modtagsubstitution=modtagsubstitution, ostProtocolStatusState=ostProtocolStatusState, ingressPolicingType=ingressPolicingType, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, slotnum=slotnum, portegresspolicy=portegresspolicy, ahCriticalEventTrapList=ahCriticalEventTrapList, port6Membership=port6Membership, rxUndersizePkts=rxUndersizePkts, rxOversizePkts=rxOversizePkts, extended5=extended5, ostProtocolStatusIndex=ostProtocolStatusIndex, subnetmask=subnetmask, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, enhancedchassisTable=enhancedchassisTable, modExpSoftwareRev=modExpSoftwareRev, slaveTrapsForward=slaveTrapsForward, portIngressRate=portIngressRate, traphost2=traphost2, ahErroredFrameThreshold=ahErroredFrameThreshold, rxPackets65to127=rxPackets65to127, txBroadcastPkts=txBroadcastPkts, rxPackets1024to1518=rxPackets1024to1518, rxDropPkts=rxDropPkts, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxSymbolErrors=rxSymbolErrors, modchassname=modchassname, port3Membership=port3Membership, moduleVLANEntry=moduleVLANEntry, portSfpVendorName=portSfpVendorName, port2Membership=port2Membership, portSfpBiasCurrent=portSfpBiasCurrent, ahFrameErrorEventTotal=ahFrameErrorEventTotal, switchstat=switchstat, ahFramePeriodEventTotal=ahFramePeriodEventTotal, omnitronMIB=omnitronMIB, vlanidentifier=vlanidentifier, modulePortsEntry=modulePortsEntry, portSfpRxPower=portSfpRxPower, modcommitVLANchanges=modcommitVLANchanges, ahRemoteMuxState=ahRemoteMuxState, ahRemoteMode=ahRemoteMode, modvlanTableClear=modvlanTableClear, PYSNMP_MODULE_ID=omnitronMIB, txGoodPkts=txGoodPkts, tftpEnable=tftpEnable, extended1=extended1, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, prodtype=prodtype, modLM80misc=modLM80misc, tftpServerIpAddress=tftpServerIpAddress, omnitronProducts=omnitronProducts, portL2CPmgntProcessing=portL2CPmgntProcessing, txLateCollision=txLateCollision, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxPausePkts=rxPausePkts, rxPackets64=rxPackets64, modpartnum=modpartnum, dhcpPortNumber=dhcpPortNumber, ahEnabled=ahEnabled, ahLocalMode=ahLocalMode, enabledFunctions=enabledFunctions, portAHTable=portAHTable, userEntry=userEntry, ahLocalMuxState=ahLocalMuxState, ipaddr2EVCassociation=ipaddr2EVCassociation, keepAliveInterval=keepAliveInterval, nmmCfgState=nmmCfgState, portpriority=portpriority, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, modulename=modulename, modPcbRev=modPcbRev, portSFPstatus=portSFPstatus, ahLocalOUI=ahLocalOUI, txDroppedEvents=txDroppedEvents, snmpv3SecurityLevel=snmpv3SecurityLevel, txOctets=txOctets, vlanservicetag=vlanservicetag, dhcpSubnetmask=dhcpSubnetmask, ahCriticalEventMode=ahCriticalEventMode, ahLpbkMode=ahLpbkMode, traphost4=traphost4, rxTotalPkts=rxTotalPkts, chassisname=chassisname, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, trapSrcIpSelect=trapSrcIpSelect, ahRemoteLinkFlags=ahRemoteLinkFlags, modeType=modeType, selfSlot=selfSlot, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, serialpass=serialpass, portStatsTable=portStatsTable, ahRemoteLinkPort=ahRemoteLinkPort, modExpPartNumber=modExpPartNumber, omnitronCompliances=omnitronCompliances, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, slaveTraps=slaveTraps, rxErrorPkts=rxErrorPkts, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, rxBroadcastPkts=rxBroadcastPkts, txCollisions=txCollisions, omnitronSFPGroup=omnitronSFPGroup, rxPackets512to1023=rxPackets512to1023, modprodtype=modprodtype, modserialnum=modserialnum, modulePortsTable=modulePortsTable, portIngressRateDropOrPause=portIngressRateDropOrPause, moduleTable=moduleTable, port1Membership=port1Membership, moduleCount=moduleCount, txExcessiveCollision=txExcessiveCollision, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, validityflag=validityflag, modLM80volts=modLM80volts, txDeferedTransmit=txDeferedTransmit, extended4=extended4, modreset=modreset, partnum=partnum, vlanPri=vlanPri, sysloc=sysloc, customertag=customertag, sysAdminStatus=sysAdminStatus, modnumports=modnumports, txMulticastPkts=txMulticastPkts, macAddr=macAddr, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, wrswitch=wrswitch, readCommunity=readCommunity, subnetmask2=subnetmask2, portSpeed=portSpeed, portStatsClear=portStatsClear, mychassnum=mychassnum, ostProtocolStatusEntry=ostProtocolStatusEntry, portDuplex=portDuplex, rxUnicastPkts=rxUnicastPkts, ahRemoteSupportVar=ahRemoteSupportVar, sysDateTime=sysDateTime, rxFragments=rxFragments, extended2=extended2, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, manufdate=manufdate, nmmIpDisabled=nmmIpDisabled, portIngressRateCBS=portIngressRateCBS, portnum=portnum, portSfpTemperature=portSfpTemperature, modname=modname, rxGoodPkts=rxGoodPkts, snmpv3AuthPassword=snmpv3AuthPassword, portSFPEntry=portSFPEntry, prodAgent=prodAgent, managementModule=managementModule, index=index, gateway=gateway, ostEnvironmentalTemperature=ostEnvironmentalTemperature, gateway2=gateway2, ahLocalParserState=ahLocalParserState, ahErroredFrameWindow=ahErroredFrameWindow, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ipAddr=ipAddr, ahRemoteOUI=ahRemoteOUI, rxMulticastPkts=rxMulticastPkts, portStatsEntry=portStatsEntry, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portMacAddress=portMacAddress, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, snmpv3UserName=snmpv3UserName, omnitronGroup=omnitronGroup, rxFCSErrors=rxFCSErrors, ledstat=ledstat, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, nmmIpProtocolState=nmmIpProtocolState, chassisnum=chassisnum, modExpLedStatus=modExpLedStatus, rxJabbers=rxJabbers, mmname=mmname, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, portSfpVendorPartNumber=portSfpVendorPartNumber, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, bootpEnable=bootpEnable, portFwdCpu=portFwdCpu, portmlistcriteria=portmlistcriteria, cpuVoltageIn=cpuVoltageIn, txUnicastPkts=txUnicastPkts, cnodeControl=cnodeControl, modLM80currents=modLM80currents, ipaddrEVCassociation=ipaddrEVCassociation, modswbuildnum=modswbuildnum, rxPackets256to511=rxPackets256to511, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, resetmod=resetmod, modFpgaRev=modFpgaRev, traphost7=traphost7, ostProtocoManagementPort=ostProtocoManagementPort, omnitronGroups=omnitronGroups, cnodeCIR=cnodeCIR, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, dhcpIpAddr=dhcpIpAddr, modRestoreFactoryDefaults=modRestoreFactoryDefaults, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modmanufdate=modmanufdate, ostProtocolStatusTable=ostProtocolStatusTable, rxPackets128to255=rxPackets128to255, portSFPTable=portSFPTable, enableSNMPFunction=enableSNMPFunction, defaultForwardingMap=defaultForwardingMap, nmmSecureMode=nmmSecureMode, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portSFPpageA2=portSFPpageA2, port5Membership=port5Membership, modsoftrev=modsoftrev, portSfpDateCode=portSfpDateCode, portSfpTxPower=portSfpTxPower, ahLocalLinkFlags=ahLocalLinkFlags, ipAddr2=ipAddr2, moduleMgtCfgTable=moduleMgtCfgTable, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portAccessType=portAccessType, portState=portState, moduleEntry=moduleEntry, omnitronConformance=omnitronConformance, traphost6=traphost6, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portEgressQosPolicy=portEgressQosPolicy, portSfpVcc=portSfpVcc, modchasstype=modchasstype)
mibBuilder.exportSymbols("OMNITRON-MIB", portLinkState=portLinkState, modportvlan=modportvlan, txMultipleCollision=txMultipleCollision, softrev=softrev, dhcpTagVid=dhcpTagVid, txOctets64=txOctets64, snmpv3UserType=snmpv3UserType, userTable=userTable, chassisTable=chassisTable, rxAlignmentErrors=rxAlignmentErrors, extended3=extended3, ostProtocolStatusType=ostProtocolStatusType, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ahLocalSupportVar=ahLocalSupportVar, txDropPkts=txDropPkts, ahClearStatistics=ahClearStatistics, nmmSecureConnState=nmmSecureConnState, traphost3=traphost3, chassis=chassis, ahRemoteParserState=ahRemoteParserState, enableSNMPWrites=enableSNMPWrites, portAHEntry=portAHEntry, vlanIdOst=vlanIdOst, portEgressRate=portEgressRate, nmmSecureSlaveSlot=nmmSecureSlaveSlot, dhcptftpServerIpAddress=dhcptftpServerIpAddress, servicetag=servicetag, chassistype=chassistype, traphost8=traphost8, syscon=syscon, moduleMgtCfgEntry=moduleMgtCfgEntry, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, snmpTrapType=snmpTrapType, ahTransmissionRate=ahTransmissionRate, nmmOAMmgmtMode=nmmOAMmgmtMode, chassisEntry=chassisEntry, tftpFileName=tftpFileName, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, modHwRev=modHwRev, port4Membership=port4Membership, portcanonicalformatIndicator=portcanonicalformatIndicator, portSFPpageA0=portSFPpageA0, rxOctets=rxOctets, slaveWrite=slaveWrite, userIndex=userIndex, portingresssecurity=portingresssecurity, rxCRCAlignErrors=rxCRCAlignErrors, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, telnetpass=telnetpass, writeCommunity=writeCommunity, coreStatusOnly=coreStatusOnly, omnitronCompliance=omnitronCompliance, modslotnum=modslotnum, modchassnum=modchassnum, extended6=extended6, dhcpGateway=dhcpGateway)
