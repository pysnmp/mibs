...
omnitron, icAgent, OstVlanId, OstModeType, OstPortNumber, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "omnitron", "icAgent", "OstVlanId", "OstModeType", "OstPortNumber", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", modsoftrev=modsoftrev, modLM80currents=modLM80currents, ahCriticalEventMode=ahCriticalEventMode, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, subnetmask=subnetmask, rxJabbers=rxJabbers, enabledFunctions=enabledFunctions, moduleVLANTable=moduleVLANTable, extended3=extended3, dhcpIpAddr=dhcpIpAddr, moduleEntry=moduleEntry, rxPackets64=rxPackets64, rxFragments=rxFragments, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portSFPTable=portSFPTable, extended2=extended2, trapSrcIpSelect=trapSrcIpSelect, portSfpTxPower=portSfpTxPower, traphost3=traphost3, writeCommunity=writeCommunity, traphost4=traphost4, modeType=modeType, rxGoodPkts=rxGoodPkts, txDroppedEvents=txDroppedEvents, rxOctets=rxOctets, modulePortsEntry=modulePortsEntry, subnetmask2=subnetmask2, omnitronSFPGroup=omnitronSFPGroup, prodtype=prodtype, portState=portState, port3Membership=port3Membership, partnum=partnum, omnitronProducts=omnitronProducts, ledstat=ledstat, modswbuildnum=modswbuildnum, bootpEnable=bootpEnable, prodAgent=prodAgent, portcanonicalformatIndicator=portcanonicalformatIndicator, portFwdCpu=portFwdCpu, omnitronGroups=omnitronGroups, vlanIdOst=vlanIdOst, ostProtocolStatusState=ostProtocolStatusState, ostEnvironmentalTemperature=ostEnvironmentalTemperature, validityflag=validityflag, chassis=chassis, portStatsTable=portStatsTable, moduleTable=moduleTable, modchassname=modchassname, portEgressRate=portEgressRate, chassisname=chassisname, traphost5=traphost5, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portFwdCpuList=portFwdCpuList, portLinkState=portLinkState, rxAlignmentErrors=rxAlignmentErrors, modportvlan=modportvlan, serialpass=serialpass, rxOversizePkts=rxOversizePkts, ipaddrEVCassociation=ipaddrEVCassociation, traphost7=traphost7, defaultForwardingMap=defaultForwardingMap, portStatsEntry=portStatsEntry, modcommitNMMCfgChanges=modcommitNMMCfgChanges, dhcpGateway=dhcpGateway, ftppasswrd=ftppasswrd, enhancedchassisTable=enhancedchassisTable, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, snmpv3PrivPassword=snmpv3PrivPassword, modname=modname, portegresspolicy=portegresspolicy, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, resetmod=resetmod, gateway=gateway, txMultipleCollision=txMultipleCollision, nmmSecureMode=nmmSecureMode, portvlanidentifier=portvlanidentifier, ostProtocolStatusType=ostProtocolStatusType, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahEnabled=ahEnabled, capsMask=capsMask, txSingleCollision=txSingleCollision, portSfpRxPower=portSfpRxPower, portSfpBitRate=portSfpBitRate, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, omnitronGroup=omnitronGroup, rxPackets512to1023=rxPackets512to1023, traphost2=traphost2, portAccessType=portAccessType, modserialnum=modserialnum, snmpv3AuthPassword=snmpv3AuthPassword, ahRemoteLinkFlags=ahRemoteLinkFlags, modpartnum=modpartnum, port1Membership=port1Membership, txExcessiveCollision=txExcessiveCollision, rxDropPkts=rxDropPkts, switchstat=switchstat, portL2CPmgntProcessing=portL2CPmgntProcessing, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, modulename=modulename, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modvlanTableClear=modvlanTableClear, traphost6=traphost6, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, cpuTemperature=cpuTemperature, ingressPolicingType=ingressPolicingType, manufdate=manufdate, ahRemoteSupportVar=ahRemoteSupportVar, portSfpVendorName=portSfpVendorName, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, portSFPpageA2=portSFPpageA2, ahLocalMuxState=ahLocalMuxState, sysDateTime=sysDateTime, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, enableSNMPWrites=enableSNMPWrites, rxPackets1024to1518=rxPackets1024to1518, modslotnum=modslotnum, modtagsubstitution=modtagsubstitution, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, dhcpPortNumber=dhcpPortNumber, nmmOAMmgmtMode=nmmOAMmgmtMode, ahRemoteLinkPort=ahRemoteLinkPort, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modulePortsTable=modulePortsTable, softrev=softrev, rxErrorPkts=rxErrorPkts, portSfpTemperature=portSfpTemperature, managementModule=managementModule, nmmSecureConnState=nmmSecureConnState, rxPackets65to127=rxPackets65to127, ostProtocoManagementPort=ostProtocoManagementPort, syscon=syscon, txErrorPkts=txErrorPkts, txUnicastPkts=txUnicastPkts, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, txDeferedTransmit=txDeferedTransmit, snmpTrapType=snmpTrapType, ostProtocolStatusIndex=ostProtocolStatusIndex, txDropPkts=txDropPkts, chassistype=chassistype, modRestoreFactoryDefaults=modRestoreFactoryDefaults, moduleMgtCfgTable=moduleMgtCfgTable, rxFCSErrors=rxFCSErrors, portSfpVcc=portSfpVcc, tftpFileName=tftpFileName, macAddr=macAddr, snmpv3UserType=snmpv3UserType, omnitronCompliances=omnitronCompliances, userEntry=userEntry, portSfpVendorPartNumber=portSfpVendorPartNumber, modHwRev=modHwRev, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portDuplex=portDuplex, modcommitVLANchanges=modcommitVLANchanges, extended4=extended4, modchasstype=modchasstype, traphost8=traphost8, index=index, nmmCfgState=nmmCfgState, dhcpSubnetmask=dhcpSubnetmask, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, txBroadcastPkts=txBroadcastPkts, vlanPri=vlanPri, txLateCollision=txLateCollision, telnetpass=telnetpass, extended6=extended6, tftpServerIpAddress=tftpServerIpAddress, keepAliveInterval=keepAliveInterval, ahLocalOUI=ahLocalOUI, portmlistcriteria=portmlistcriteria, modenable802dot1qProcessing=modenable802dot1qProcessing, rxPausePkts=rxPausePkts, modnumports=modnumports, port5Membership=port5Membership, ahRemoteMode=ahRemoteMode, coreStatusOnly=coreStatusOnly, ahErroredFrameThreshold=ahErroredFrameThreshold, omnitronCompliance=omnitronCompliance, vlanidentifier=vlanidentifier, portSFPEntry=portSFPEntry, ipaddr2EVCassociation=ipaddr2EVCassociation, slaveTrapsForward=slaveTrapsForward, port4Membership=port4Membership, ahRemoteOUI=ahRemoteOUI, portIngressRateCBS=portIngressRateCBS, rxPackets256to511=rxPackets256to511, mychassnum=mychassnum, extended5=extended5, modextfeaturebits=modextfeaturebits, portAHEntry=portAHEntry, ahLocalParserState=ahLocalParserState, ahRemoteParserState=ahRemoteParserState, customertag=customertag, rxPackets128to255=rxPackets128to255, portSfpDateCode=portSfpDateCode, txPausePkts=txPausePkts, sysloc=sysloc, ahLocalLinkFlags=ahLocalLinkFlags, modExpPartNumber=modExpPartNumber, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portingresssecurity=portingresssecurity, portSfpBiasCurrent=portSfpBiasCurrent, portAHTable=portAHTable, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, txGoodPkts=txGoodPkts, ahClearStatistics=ahClearStatistics, portStatsClear=portStatsClear, portSpeed=portSpeed, PYSNMP_MODULE_ID=omnitronMIB, rxUndersizePkts=rxUndersizePkts, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, txOctets64=txOctets64, mmname=mmname, modLM80misc=modLM80misc, tftpEnable=tftpEnable, portMacAddress=portMacAddress, ahFrameErrorEventTotal=ahFrameErrorEventTotal, txMulticastPkts=txMulticastPkts, rxUnicastPkts=rxUnicastPkts, portpriority=portpriority, portIngressRate=portIngressRate, modFpgaRev=modFpgaRev, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, txOctets=txOctets, nmmIpDisabled=nmmIpDisabled, cpuVoltageOut=cpuVoltageOut, portSFPpageA0=portSFPpageA0, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, modreset=modreset, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, extended1=extended1, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ipAddr=ipAddr, ahFramePeriodEventTotal=ahFramePeriodEventTotal, rxOctets64=rxOctets64, cpuVoltageIn=cpuVoltageIn, servicetag=servicetag, dhcpTagVid=dhcpTagVid, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxSymbolErrors=rxSymbolErrors, selfSlot=selfSlot, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, traphost1=traphost1, modPcbRev=modPcbRev, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxBroadcastPkts=rxBroadcastPkts, port2Membership=port2Membership, slotnum=slotnum, portIngressRateDropOrPause=portIngressRateDropOrPause)
mibBuilder.exportSymbols("OMNITRON-MIB", modchassnum=modchassnum, ahCriticalEventTrapList=ahCriticalEventTrapList, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxMulticastPkts=rxMulticastPkts, moduleVLANEntry=moduleVLANEntry, txCollisions=txCollisions, ahLocalMode=ahLocalMode, modExpSoftwareRev=modExpSoftwareRev, omnitronMIB=omnitronMIB, cnodeControl=cnodeControl, cnodeCIR=cnodeCIR, enableSNMPv3Function=enableSNMPv3Function, omnitronConformance=omnitronConformance, rxCRCAlignErrors=rxCRCAlignErrors, ahRemoteMuxState=ahRemoteMuxState, modExpLedStatus=modExpLedStatus, vlanservicetag=vlanservicetag, serialnum=serialnum, enableSNMPFunction=enableSNMPFunction, moduleMgtCfgEntry=moduleMgtCfgEntry, chassisnum=chassisnum, modprodtype=modprodtype, slaveWrite=slaveWrite, modLM80volts=modLM80volts, rxTotalPkts=rxTotalPkts, snmpv3UserName=snmpv3UserName, readCommunity=readCommunity, ahErroredFrameWindow=ahErroredFrameWindow, chassisEntry=chassisEntry, portnum=portnum, nmmIpProtocolState=nmmIpProtocolState, prodrev=prodrev, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ostProtocolStatusTable=ostProtocolStatusTable, ahLpbkMode=ahLpbkMode, ipAddr2=ipAddr2, gateway2=gateway2, modprodrev=modprodrev, moduleCount=moduleCount, userTable=userTable, muxGroupDefaults=muxGroupDefaults, ahLocalSupportVar=ahLocalSupportVar, portSFPstatus=portSFPstatus, modmanufdate=modmanufdate, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ahTransmissionRate=ahTransmissionRate, port6Membership=port6Membership, snmpv3SecurityLevel=snmpv3SecurityLevel, ostProtocolStatusEntry=ostProtocolStatusEntry, userIndex=userIndex, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, slaveTraps=slaveTraps, portEgressQosPolicy=portEgressQosPolicy, chassisTable=chassisTable, wrswitch=wrswitch, sysAdminStatus=sysAdminStatus)
