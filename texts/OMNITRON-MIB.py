...
omnitron, icAgent, OstVlanId, OstPortNumber, OstPortList, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "omnitron", "icAgent", "OstVlanId", "OstPortNumber", "OstPortList", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", modvlanTableClear=modvlanTableClear, modulename=modulename, rxAlignmentErrors=rxAlignmentErrors, txDeferedTransmit=txDeferedTransmit, userEntry=userEntry, portSpeed=portSpeed, modnumports=modnumports, modpartnum=modpartnum, portSFPpageA0=portSFPpageA0, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portL2CPmgntProcessing=portL2CPmgntProcessing, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, chassisnum=chassisnum, rxSymbolErrors=rxSymbolErrors, modeType=modeType, rxGoodPkts=rxGoodPkts, modreset=modreset, portIngressRateCBS=portIngressRateCBS, sysAdminStatus=sysAdminStatus, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, modextfeaturebits=modextfeaturebits, traphost6=traphost6, txSingleCollision=txSingleCollision, sysDateTime=sysDateTime, snmpTrapType=snmpTrapType, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, port3Membership=port3Membership, ahLocalMode=ahLocalMode, ahLocalSupportVar=ahLocalSupportVar, portSfpBitRate=portSfpBitRate, customertag=customertag, traphost8=traphost8, portcanonicalformatIndicator=portcanonicalformatIndicator, portSfpVendorPartNumber=portSfpVendorPartNumber, modname=modname, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modLM80currents=modLM80currents, vlanservicetag=vlanservicetag, nmmIpProtocolState=nmmIpProtocolState, moduleVLANEntry=moduleVLANEntry, prodrev=prodrev, modulePortsEntry=modulePortsEntry, modLM80volts=modLM80volts, modchassnum=modchassnum, modLM80misc=modLM80misc, snmpv3PrivPassword=snmpv3PrivPassword, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modenable802dot1qProcessing=modenable802dot1qProcessing, mychassnum=mychassnum, portSfpVendorName=portSfpVendorName, portSFPstatus=portSFPstatus, modcommitVLANchanges=modcommitVLANchanges, macAddr=macAddr, ostProtocolStatusEntry=ostProtocolStatusEntry, softrev=softrev, portEgressQosPolicy=portEgressQosPolicy, omnitronProducts=omnitronProducts, ostProtocolStatusState=ostProtocolStatusState, chassisEntry=chassisEntry, rxPackets512to1023=rxPackets512to1023, partnum=partnum, txGoodPkts=txGoodPkts, snmpv3UserType=snmpv3UserType, omnitronCompliance=omnitronCompliance, nmmOAMmgmtMode=nmmOAMmgmtMode, ahErroredFrameWindow=ahErroredFrameWindow, portMacAddress=portMacAddress, ostEnvironmentalTemperature=ostEnvironmentalTemperature, nmmSecureMode=nmmSecureMode, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, sysloc=sysloc, omnitronConformance=omnitronConformance, modprodrev=modprodrev, vlanIdOst=vlanIdOst, txOctets=txOctets, rxPackets128to255=rxPackets128to255, vlanidentifier=vlanidentifier, ledstat=ledstat, extended5=extended5, vlanPri=vlanPri, serialnum=serialnum, portSFPEntry=portSFPEntry, extended2=extended2, portEgressRate=portEgressRate, ahLocalMuxState=ahLocalMuxState, ahRemoteLinkFlags=ahRemoteLinkFlags, traphost4=traphost4, telnetpass=telnetpass, portStatsEntry=portStatsEntry, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, modportvlan=modportvlan, cpuTemperature=cpuTemperature, cnodeControl=cnodeControl, port4Membership=port4Membership, portFwdCpu=portFwdCpu, rxTotalPkts=rxTotalPkts, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, moduleCount=moduleCount, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portpriority=portpriority, rxFragments=rxFragments, rxDropPkts=rxDropPkts, PYSNMP_MODULE_ID=omnitronMIB, modswbuildnum=modswbuildnum, moduleMgtCfgEntry=moduleMgtCfgEntry, portSFPpageA2=portSFPpageA2, txExcessiveCollision=txExcessiveCollision, gateway=gateway, ahLpbkMode=ahLpbkMode, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, resetmod=resetmod, cpuVoltageOut=cpuVoltageOut, modprodtype=modprodtype, rxErrorPkts=rxErrorPkts, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, enableSNMPv3Function=enableSNMPv3Function, cpuVoltageIn=cpuVoltageIn, ahRemoteOUI=ahRemoteOUI, nmmSecureConnState=nmmSecureConnState, ahRemoteLinkPort=ahRemoteLinkPort, ahRemoteMode=ahRemoteMode, slaveWrite=slaveWrite, trapSrcIpSelect=trapSrcIpSelect, modRestoreFactoryDefaults=modRestoreFactoryDefaults, coreStatusOnly=coreStatusOnly, subnetmask2=subnetmask2, rxFCSErrors=rxFCSErrors, modFpgaRev=modFpgaRev, ostProtocolStatusType=ostProtocolStatusType, portnum=portnum, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, port1Membership=port1Membership, servicetag=servicetag, ahCriticalEventTrapList=ahCriticalEventTrapList, ipaddr2EVCassociation=ipaddr2EVCassociation, ostProtocoManagementPort=ostProtocoManagementPort, portAHTable=portAHTable, moduleEntry=moduleEntry, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, userTable=userTable, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, nmmCfgState=nmmCfgState, snmpv3UserName=snmpv3UserName, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, rxOctets64=rxOctets64, ipAddr=ipAddr, ingressPolicingType=ingressPolicingType, prodtype=prodtype, port5Membership=port5Membership, portState=portState, txMulticastPkts=txMulticastPkts, txMultipleCollision=txMultipleCollision, modtagsubstitution=modtagsubstitution, portSfpTxPower=portSfpTxPower, snmpv3AuthPassword=snmpv3AuthPassword, manufdate=manufdate, moduleTable=moduleTable, index=index, dhcpPortNumber=dhcpPortNumber, omnitronCompliances=omnitronCompliances, capsMask=capsMask, traphost7=traphost7, moduleVLANTable=moduleVLANTable, dhcpGateway=dhcpGateway, tftpServerIpAddress=tftpServerIpAddress, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, dhcpSubnetmask=dhcpSubnetmask, enhancedchassisTable=enhancedchassisTable, txDroppedEvents=txDroppedEvents, mmname=mmname, wrswitch=wrswitch, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, nmmSecureSlaveSlot=nmmSecureSlaveSlot, extended3=extended3, omnitronMIB=omnitronMIB, chassisTable=chassisTable, slotnum=slotnum, dhcpTagVid=dhcpTagVid, modchasstype=modchasstype, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, txOctets64=txOctets64, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modslotnum=modslotnum, portSfpVcc=portSfpVcc, portSfpTemperature=portSfpTemperature, rxOctets=rxOctets, traphost2=traphost2, portSFPTable=portSFPTable, modPcbRev=modPcbRev, ipaddrEVCassociation=ipaddrEVCassociation, ahErroredFrameThreshold=ahErroredFrameThreshold, chassis=chassis, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahFrameErrorEventTotal=ahFrameErrorEventTotal, bootpEnable=bootpEnable, ahLocalOUI=ahLocalOUI, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSfpRxPower=portSfpRxPower, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, dhcptftpServerIpAddress=dhcptftpServerIpAddress, muxGroupDefaults=muxGroupDefaults, ahEnabled=ahEnabled, enableSNMPFunction=enableSNMPFunction, portAHEntry=portAHEntry, userIndex=userIndex, ostProtocolStatusIndex=ostProtocolStatusIndex, portingresssecurity=portingresssecurity, dhcpIpAddr=dhcpIpAddr, extended4=extended4, selfSlot=selfSlot, modmanufdate=modmanufdate, portFwdCpuList=portFwdCpuList, portDuplex=portDuplex, prodAgent=prodAgent, rxPackets256to511=rxPackets256to511, enableSNMPWrites=enableSNMPWrites, ipAddr2=ipAddr2, chassisname=chassisname, ahClearStatistics=ahClearStatistics, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, traphost1=traphost1, txErrorPkts=txErrorPkts, rxPausePkts=rxPausePkts, portLinkState=portLinkState, traphost3=traphost3, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, defaultForwardingMap=defaultForwardingMap, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, modserialnum=modserialnum, portStatsClear=portStatsClear, rxCRCAlignErrors=rxCRCAlignErrors, rxPackets1024to1518=rxPackets1024to1518, txCollisions=txCollisions, portStatsTable=portStatsTable, ahTransmissionRate=ahTransmissionRate, portIngressRateDropOrPause=portIngressRateDropOrPause, extended6=extended6, omnitronGroup=omnitronGroup, moduleMgtCfgTable=moduleMgtCfgTable, modExpLedStatus=modExpLedStatus, txPausePkts=txPausePkts, chassistype=chassistype, serialpass=serialpass, syscon=syscon, txLateCollision=txLateCollision, extended1=extended1, modExpSoftwareRev=modExpSoftwareRev, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, port6Membership=port6Membership, portAccessType=portAccessType, modulePortsTable=modulePortsTable)
mibBuilder.exportSymbols("OMNITRON-MIB", modHwRev=modHwRev, slaveTrapsForward=slaveTrapsForward, validityflag=validityflag, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modExpPartNumber=modExpPartNumber, cnodeCIR=cnodeCIR, rxBroadcastPkts=rxBroadcastPkts, ahRemoteParserState=ahRemoteParserState, subnetmask=subnetmask, portIngressRate=portIngressRate, writeCommunity=writeCommunity, portSfpDateCode=portSfpDateCode, port2Membership=port2Membership, portmlistcriteria=portmlistcriteria, switchstat=switchstat, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, txDropPkts=txDropPkts, ahRemoteSupportVar=ahRemoteSupportVar, omnitronSFPGroup=omnitronSFPGroup, slaveTraps=slaveTraps, enabledFunctions=enabledFunctions, gateway2=gateway2, txUnicastPkts=txUnicastPkts, rxPackets65to127=rxPackets65to127, tftpFileName=tftpFileName, ftppasswrd=ftppasswrd, ahCriticalEventMode=ahCriticalEventMode, rxPackets64=rxPackets64, omnitronGroups=omnitronGroups, readCommunity=readCommunity, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahLocalParserState=ahLocalParserState, rxJabbers=rxJabbers, nmmIpDisabled=nmmIpDisabled, modchassname=modchassname, ahLocalLinkFlags=ahLocalLinkFlags, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portvlanidentifier=portvlanidentifier, portSfpBiasCurrent=portSfpBiasCurrent, txBroadcastPkts=txBroadcastPkts, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, rxMulticastPkts=rxMulticastPkts, ostProtocolStatusTable=ostProtocolStatusTable, snmpv3SecurityLevel=snmpv3SecurityLevel, tftpEnable=tftpEnable, rxUnicastPkts=rxUnicastPkts, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahRemoteMuxState=ahRemoteMuxState, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, portegresspolicy=portegresspolicy, keepAliveInterval=keepAliveInterval, rxOversizePkts=rxOversizePkts, managementModule=managementModule, modsoftrev=modsoftrev, traphost5=traphost5, rxUndersizePkts=rxUndersizePkts)
