...
mibBuilder.exportSymbols("OMNITRON-MIB", slaveWrite=slaveWrite, prodrev=prodrev, chassis=chassis, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, snmpv3PrivPassword=snmpv3PrivPassword, rxGoodPkts=rxGoodPkts, modsoftrev=modsoftrev, ahLocalOUI=ahLocalOUI, enableSNMPFunction=enableSNMPFunction, mychassnum=mychassnum, macAddr=macAddr, portSfpBitRate=portSfpBitRate, defaultForwardingMap=defaultForwardingMap, dhcpIpAddr=dhcpIpAddr, enableSNMPv3Function=enableSNMPv3Function, ostProtocolStatusTable=ostProtocolStatusTable, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, chassisnum=chassisnum, modExpPartNumber=modExpPartNumber, serialnum=serialnum, rxPackets65to127=rxPackets65to127, ahClearStatistics=ahClearStatistics, traphost1=traphost1, traphost5=traphost5, txPausePkts=txPausePkts, traphost6=traphost6, modportvlan=modportvlan, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portnum=portnum, modLM80volts=modLM80volts, portAHEntry=portAHEntry, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, moduleVLANTable=moduleVLANTable, extended3=extended3, modLM80misc=modLM80misc, trapSrcIpSelect=trapSrcIpSelect, rxPausePkts=rxPausePkts, modmanufdate=modmanufdate, subnetmask2=subnetmask2, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ostProtocolStatusState=ostProtocolStatusState, ahLocalParserState=ahLocalParserState, ahErroredFrameWindow=ahErroredFrameWindow, nmmSecureConnState=nmmSecureConnState, snmpv3AuthPassword=snmpv3AuthPassword, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, port2Membership=port2Membership, modname=modname, portSfpRxPower=portSfpRxPower, rxBroadcastPkts=rxBroadcastPkts, serialpass=serialpass, coreStatusOnly=coreStatusOnly, ahLpbkMode=ahLpbkMode, readCommunity=readCommunity, enableSNMPWrites=enableSNMPWrites, snmpv3UserType=snmpv3UserType, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, nmmSecureMode=nmmSecureMode, portStatsTable=portStatsTable, bootpEnable=bootpEnable, rxPackets1024to1518=rxPackets1024to1518, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, cpuVoltageIn=cpuVoltageIn, traphost4=traphost4, rxDropPkts=rxDropPkts, ahLocalMuxState=ahLocalMuxState, port4Membership=port4Membership, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, nmmIpProtocolState=nmmIpProtocolState, modtagsubstitution=modtagsubstitution, portSfpTemperature=portSfpTemperature, modnumports=modnumports, sysAdminStatus=sysAdminStatus, modchassname=modchassname, sysDateTime=sysDateTime, servicetag=servicetag, switchstat=switchstat, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, modreset=modreset, slaveTrapsForward=slaveTrapsForward, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, extended2=extended2, vlanIdOst=vlanIdOst, customertag=customertag, modcommitVLANchanges=modcommitVLANchanges, rxJabbers=rxJabbers, rxOversizePkts=rxOversizePkts, portAHTable=portAHTable, managementModule=managementModule, PYSNMP_MODULE_ID=omnitronMIB, rxFragments=rxFragments, traphost2=traphost2, mmname=mmname, moduleVLANEntry=moduleVLANEntry, modPcbRev=modPcbRev, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, telnetpass=telnetpass, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ostProtocoManagementPort=ostProtocoManagementPort, nmmSecureSlaveSlot=nmmSecureSlaveSlot, slotnum=slotnum, port3Membership=port3Membership, omnitronProducts=omnitronProducts, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, omnitronConformance=omnitronConformance, rxCRCAlignErrors=rxCRCAlignErrors, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ahLocalSupportVar=ahLocalSupportVar, ingressPolicingType=ingressPolicingType, modprodrev=modprodrev, dhcpSubnetmask=dhcpSubnetmask, portIngressRateDropOrPause=portIngressRateDropOrPause, portSpeed=portSpeed, txBroadcastPkts=txBroadcastPkts, port5Membership=port5Membership, portFwdCpuList=portFwdCpuList, vlanPri=vlanPri, modslotnum=modslotnum, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modswbuildnum=modswbuildnum, txDeferedTransmit=txDeferedTransmit, portStatsClear=portStatsClear, ahTransmissionRate=ahTransmissionRate, modchasstype=modchasstype, capsMask=capsMask, txMulticastPkts=txMulticastPkts, ostProtocolStatusEntry=ostProtocolStatusEntry, rxOctets64=rxOctets64, enhancedchassisTable=enhancedchassisTable, modeType=modeType, txGoodPkts=txGoodPkts, moduleCount=moduleCount, moduleMgtCfgEntry=moduleMgtCfgEntry, extended4=extended4, modulename=modulename, omnitronGroups=omnitronGroups, ahLocalLinkFlags=ahLocalLinkFlags, txDroppedEvents=txDroppedEvents, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, portegresspolicy=portegresspolicy, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, softrev=softrev, chassisTable=chassisTable, modLM80currents=modLM80currents, moduleTable=moduleTable, portSfpDateCode=portSfpDateCode, partnum=partnum, modchassnum=modchassnum, nmmIpDisabled=nmmIpDisabled, vlanidentifier=vlanidentifier, ahLocalMode=ahLocalMode, ahRemoteOUI=ahRemoteOUI, rxPackets128to255=rxPackets128to255, ipAddr=ipAddr, chassisname=chassisname, rxPackets256to511=rxPackets256to511, ipaddrEVCassociation=ipaddrEVCassociation, dhcptftpServerIpAddress=dhcptftpServerIpAddress, syscon=syscon, sysloc=sysloc, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portSfpTxPower=portSfpTxPower, modFpgaRev=modFpgaRev, manufdate=manufdate, rxOctets=rxOctets, snmpv3UserName=snmpv3UserName, cpuTemperature=cpuTemperature, ahRemoteParserState=ahRemoteParserState, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, slaveTraps=slaveTraps, portingresssecurity=portingresssecurity, userIndex=userIndex, portIngressRate=portIngressRate, ipaddr2EVCassociation=ipaddr2EVCassociation, omnitronSFPGroup=omnitronSFPGroup, portSfpVendorName=portSfpVendorName, rxErrorPkts=rxErrorPkts, portvlanidentifier=portvlanidentifier, ahRemoteMode=ahRemoteMode, enabledFunctions=enabledFunctions, index=index, txCollisions=txCollisions, modenable802dot1qProcessing=modenable802dot1qProcessing, nmmCfgState=nmmCfgState, tftpFileName=tftpFileName, portAccessType=portAccessType, txOctets64=txOctets64, txErrorPkts=txErrorPkts, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, chassisEntry=chassisEntry, txOctets=txOctets, ahErroredFrameThreshold=ahErroredFrameThreshold, portSfpVcc=portSfpVcc, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portSFPEntry=portSFPEntry, rxTotalPkts=rxTotalPkts, modulePortsTable=modulePortsTable, modserialnum=modserialnum, rxMulticastPkts=rxMulticastPkts, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, prodAgent=prodAgent, portEgressRate=portEgressRate, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modulePortsEntry=modulePortsEntry, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ahRemoteSupportVar=ahRemoteSupportVar, ostProtocolStatusType=ostProtocolStatusType, omnitronGroup=omnitronGroup, portSfpVendorSerialNumber=portSfpVendorSerialNumber, resetmod=resetmod, validityflag=validityflag, tftpServerIpAddress=tftpServerIpAddress, moduleEntry=moduleEntry, portpriority=portpriority, cpuVoltageOut=cpuVoltageOut, userTable=userTable, ahFramePeriodEventTotal=ahFramePeriodEventTotal, snmpTrapType=snmpTrapType, txUnicastPkts=txUnicastPkts, txMultipleCollision=txMultipleCollision, rxUndersizePkts=rxUndersizePkts, prodtype=prodtype, cnodeControl=cnodeControl, modExpSoftwareRev=modExpSoftwareRev, port1Membership=port1Membership, dhcpTagVid=dhcpTagVid, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, selfSlot=selfSlot, portSfpVendorPartNumber=portSfpVendorPartNumber, chassistype=chassistype, portState=portState, txSingleCollision=txSingleCollision, rxPackets512to1023=rxPackets512to1023, muxGroupDefaults=muxGroupDefaults, rxPackets64=rxPackets64, snmpv3SecurityLevel=snmpv3SecurityLevel, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, gateway=gateway, dhcpPortNumber=dhcpPortNumber, portmlistcriteria=portmlistcriteria, extended5=extended5, modprodtype=modprodtype, portMacAddress=portMacAddress, rxSymbolErrors=rxSymbolErrors, ahRemoteLinkPort=ahRemoteLinkPort, ipAddr2=ipAddr2, portEgressQosPolicy=portEgressQosPolicy, vlanservicetag=vlanservicetag, cnodeCIR=cnodeCIR, tftpEnable=tftpEnable, rxUnicastPkts=rxUnicastPkts, portSFPpageA2=portSFPpageA2, omnitronMIB=omnitronMIB)
mibBuilder.exportSymbols("OMNITRON-MIB", portLinkState=portLinkState, ftppasswrd=ftppasswrd, portSFPTable=portSFPTable, ledstat=ledstat, rxFCSErrors=rxFCSErrors, userEntry=userEntry, rxAlignmentErrors=rxAlignmentErrors, gateway2=gateway2, portFwdCpu=portFwdCpu, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahCriticalEventMode=ahCriticalEventMode, portSFPstatus=portSFPstatus, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, keepAliveInterval=keepAliveInterval, modextfeaturebits=modextfeaturebits, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portStatsEntry=portStatsEntry, extended6=extended6, ahCriticalEventTrapList=ahCriticalEventTrapList, nmmOAMmgmtMode=nmmOAMmgmtMode, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, modHwRev=modHwRev, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ostProtocolStatusIndex=ostProtocolStatusIndex, dhcpGateway=dhcpGateway, modvlanTableClear=modvlanTableClear, portDuplex=portDuplex, moduleMgtCfgTable=moduleMgtCfgTable, ahRemoteMuxState=ahRemoteMuxState, traphost7=traphost7, omnitronCompliance=omnitronCompliance, portIngressRateCBS=portIngressRateCBS, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, subnetmask=subnetmask, portcanonicalformatIndicator=portcanonicalformatIndicator, portL2CPmgntProcessing=portL2CPmgntProcessing, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahEnabled=ahEnabled, port6Membership=port6Membership, omnitronCompliances=omnitronCompliances, writeCommunity=writeCommunity, modExpLedStatus=modExpLedStatus, portSfpBiasCurrent=portSfpBiasCurrent, traphost8=traphost8, txExcessiveCollision=txExcessiveCollision, wrswitch=wrswitch, ahRemoteLinkFlags=ahRemoteLinkFlags, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, txLateCollision=txLateCollision, traphost3=traphost3, portSFPpageA0=portSFPpageA0, extended1=extended1, txDropPkts=txDropPkts, modpartnum=modpartnum)
