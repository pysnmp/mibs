...
OstPortNumber, omnitron, icAgent, OstModeType, OstPortList, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortNumber", "omnitron", "icAgent", "OstModeType", "OstPortList", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", chassisnum=chassisnum, portFwdCpu=portFwdCpu, omnitronConformance=omnitronConformance, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portState=portState, modchassname=modchassname, subnetmask=subnetmask, muxGroupDefaults=muxGroupDefaults, modFpgaRev=modFpgaRev, moduleVLANEntry=moduleVLANEntry, nmmCfgState=nmmCfgState, modLM80currents=modLM80currents, modeType=modeType, enhancedchassisTable=enhancedchassisTable, snmpv3AuthPassword=snmpv3AuthPassword, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ostProtocoManagementPort=ostProtocoManagementPort, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ahRemoteMode=ahRemoteMode, modExpSoftwareRev=modExpSoftwareRev, ingressPolicingType=ingressPolicingType, slaveTraps=slaveTraps, rxErrorPkts=rxErrorPkts, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portL2CPmgntProcessing=portL2CPmgntProcessing, portpriority=portpriority, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, selfSlot=selfSlot, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahLocalOUI=ahLocalOUI, snmpv3SecurityLevel=snmpv3SecurityLevel, rxPackets128to255=rxPackets128to255, omnitronProducts=omnitronProducts, traphost6=traphost6, ledstat=ledstat, snmpv3UserType=snmpv3UserType, nmmSecureConnState=nmmSecureConnState, nmmSecureSlaveSlot=nmmSecureSlaveSlot, customertag=customertag, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, defaultForwardingMap=defaultForwardingMap, traphost3=traphost3, portSfpRxPower=portSfpRxPower, rxUnicastPkts=rxUnicastPkts, serialnum=serialnum, txCollisions=txCollisions, ipAddr2=ipAddr2, portStatsTable=portStatsTable, snmpv3UserName=snmpv3UserName, chassis=chassis, omnitronMIB=omnitronMIB, rxPackets512to1023=rxPackets512to1023, rxGoodPkts=rxGoodPkts, txBroadcastPkts=txBroadcastPkts, portLinkState=portLinkState, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, txSingleCollision=txSingleCollision, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, traphost2=traphost2, vlanPri=vlanPri, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, manufdate=manufdate, portSfpVendorName=portSfpVendorName, portnum=portnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, rxOctets64=rxOctets64, resetmod=resetmod, enableSNMPv3Function=enableSNMPv3Function, portSfpVendorPartNumber=portSfpVendorPartNumber, portSfpVcc=portSfpVcc, txErrorPkts=txErrorPkts, portSFPstatus=portSFPstatus, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ahLocalLinkFlags=ahLocalLinkFlags, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, PYSNMP_MODULE_ID=omnitronMIB, portSpeed=portSpeed, ahFrameErrorEventTotal=ahFrameErrorEventTotal, traphost8=traphost8, portStatsClear=portStatsClear, prodtype=prodtype, traphost5=traphost5, modportvlan=modportvlan, modenable802dot1qProcessing=modenable802dot1qProcessing, managementModule=managementModule, switchstat=switchstat, chassistype=chassistype, moduleMgtCfgEntry=moduleMgtCfgEntry, rxMulticastPkts=rxMulticastPkts, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahErroredFrameWindow=ahErroredFrameWindow, txGoodPkts=txGoodPkts, ostProtocolStatusState=ostProtocolStatusState, modvlanTableClear=modvlanTableClear, enableSNMPFunction=enableSNMPFunction, modpartnum=modpartnum, slaveWrite=slaveWrite, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, dhcpIpAddr=dhcpIpAddr, dhcpPortNumber=dhcpPortNumber, softrev=softrev, port3Membership=port3Membership, modLM80misc=modLM80misc, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxPackets1024to1518=rxPackets1024to1518, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, slaveTrapsForward=slaveTrapsForward, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, portmlistcriteria=portmlistcriteria, portSFPpageA0=portSFPpageA0, userEntry=userEntry, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, txOctets=txOctets, ahRemoteLinkPort=ahRemoteLinkPort, extended6=extended6, ahLpbkMode=ahLpbkMode, modulePortsTable=modulePortsTable, prodAgent=prodAgent, portSfpTemperature=portSfpTemperature, subnetmask2=subnetmask2, wrswitch=wrswitch, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, modsoftrev=modsoftrev, tftpFileName=tftpFileName, ahRemoteLinkFlags=ahRemoteLinkFlags, portFwdCpuList=portFwdCpuList, portSFPpageA2=portSFPpageA2, ipAddr=ipAddr, txUnicastPkts=txUnicastPkts, rxSymbolErrors=rxSymbolErrors, traphost1=traphost1, omnitronGroup=omnitronGroup, port4Membership=port4Membership, portEgressQosPolicy=portEgressQosPolicy, rxUndersizePkts=rxUndersizePkts, dhcptftpServerIpAddress=dhcptftpServerIpAddress, chassisTable=chassisTable, prodrev=prodrev, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, portingresssecurity=portingresssecurity, modnumports=modnumports, txMulticastPkts=txMulticastPkts, modtagsubstitution=modtagsubstitution, slotnum=slotnum, ahClearStatistics=ahClearStatistics, portSfpBitRate=portSfpBitRate, txPausePkts=txPausePkts, readCommunity=readCommunity, ahTransmissionRate=ahTransmissionRate, validityflag=validityflag, modname=modname, index=index, ahLocalMode=ahLocalMode, cpuTemperature=cpuTemperature, capsMask=capsMask, port2Membership=port2Membership, rxCRCAlignErrors=rxCRCAlignErrors, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portAHTable=portAHTable, vlanservicetag=vlanservicetag, modchasstype=modchasstype, moduleMgtCfgTable=moduleMgtCfgTable, portIngressRate=portIngressRate, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, telnetpass=telnetpass, modLM80volts=modLM80volts, macAddr=macAddr, rxOctets=rxOctets, moduleVLANTable=moduleVLANTable, partnum=partnum, portAccessType=portAccessType, modprodrev=modprodrev, ipaddrEVCassociation=ipaddrEVCassociation, keepAliveInterval=keepAliveInterval, modmanufdate=modmanufdate, portSfpDateCode=portSfpDateCode, extended4=extended4, snmpTrapType=snmpTrapType, omnitronCompliances=omnitronCompliances, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ahRemoteParserState=ahRemoteParserState, coreStatusOnly=coreStatusOnly, portMacAddress=portMacAddress, modPcbRev=modPcbRev, modExpLedStatus=modExpLedStatus, omnitronCompliance=omnitronCompliance, trapSrcIpSelect=trapSrcIpSelect, enableSNMPWrites=enableSNMPWrites, ahLocalSupportVar=ahLocalSupportVar, ahRemoteOUI=ahRemoteOUI, ahLocalMuxState=ahLocalMuxState, txExcessiveCollision=txExcessiveCollision, moduleTable=moduleTable, nmmSecureMode=nmmSecureMode, ahRemoteSupportVar=ahRemoteSupportVar, ftppasswrd=ftppasswrd, dhcpSubnetmask=dhcpSubnetmask, chassisEntry=chassisEntry, modulename=modulename, cnodeControl=cnodeControl, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahCriticalEventMode=ahCriticalEventMode, gateway2=gateway2, traphost7=traphost7, txMultipleCollision=txMultipleCollision, portEgressRate=portEgressRate, cnodeCIR=cnodeCIR, modulePortsEntry=modulePortsEntry, portDuplex=portDuplex, gateway=gateway, txDeferedTransmit=txDeferedTransmit, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, moduleEntry=moduleEntry, userIndex=userIndex, modprodtype=modprodtype, modserialnum=modserialnum, portvlanidentifier=portvlanidentifier, modchassnum=modchassnum, portegresspolicy=portegresspolicy, extended2=extended2, rxPausePkts=rxPausePkts, rxAlignmentErrors=rxAlignmentErrors, extended1=extended1, portSFPTable=portSFPTable, sysloc=sysloc, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, modreset=modreset, omnitronSFPGroup=omnitronSFPGroup, portIngressRateCBS=portIngressRateCBS, dhcpTagVid=dhcpTagVid, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, port1Membership=port1Membership, modextfeaturebits=modextfeaturebits, userTable=userTable, rxJabbers=rxJabbers, rxPackets256to511=rxPackets256to511, writeCommunity=writeCommunity, sysAdminStatus=sysAdminStatus, ostProtocolStatusEntry=ostProtocolStatusEntry, ahCriticalEventTrapList=ahCriticalEventTrapList, omnitronGroups=omnitronGroups, cpuVoltageOut=cpuVoltageOut, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, txLateCollision=txLateCollision, snmpv3PrivPassword=snmpv3PrivPassword, enabledFunctions=enabledFunctions, tftpServerIpAddress=tftpServerIpAddress, tftpEnable=tftpEnable, rxOversizePkts=rxOversizePkts, extended3=extended3)
mibBuilder.exportSymbols("OMNITRON-MIB", ostProtocolStatusTable=ostProtocolStatusTable, mmname=mmname, traphost4=traphost4, rxFCSErrors=rxFCSErrors, nmmOAMmgmtMode=nmmOAMmgmtMode, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, modExpPartNumber=modExpPartNumber, chassisname=chassisname, txDropPkts=txDropPkts, ahErroredFrameThreshold=ahErroredFrameThreshold, syscon=syscon, nmmIpProtocolState=nmmIpProtocolState, ostProtocolStatusType=ostProtocolStatusType, mychassnum=mychassnum, sysDateTime=sysDateTime, ipaddr2EVCassociation=ipaddr2EVCassociation, dhcpGateway=dhcpGateway, portSfpTxPower=portSfpTxPower, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, cpuVoltageIn=cpuVoltageIn, rxTotalPkts=rxTotalPkts, ahEnabled=ahEnabled, vlanIdOst=vlanIdOst, ahRemoteMuxState=ahRemoteMuxState, modslotnum=modslotnum, port6Membership=port6Membership, rxPackets64=rxPackets64, rxDropPkts=rxDropPkts, modcommitVLANchanges=modcommitVLANchanges, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portAHEntry=portAHEntry, extended5=extended5, ostProtocolStatusIndex=ostProtocolStatusIndex, rxPackets65to127=rxPackets65to127, servicetag=servicetag, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portSfpBiasCurrent=portSfpBiasCurrent, moduleCount=moduleCount, modswbuildnum=modswbuildnum, portStatsEntry=portStatsEntry, bootpEnable=bootpEnable, serialpass=serialpass, port5Membership=port5Membership, rxFragments=rxFragments, rxBroadcastPkts=rxBroadcastPkts, txDroppedEvents=txDroppedEvents, portSFPEntry=portSFPEntry, ahLocalParserState=ahLocalParserState, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portcanonicalformatIndicator=portcanonicalformatIndicator, txOctets64=txOctets64, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modHwRev=modHwRev, nmmIpDisabled=nmmIpDisabled, portIngressRateDropOrPause=portIngressRateDropOrPause, vlanidentifier=vlanidentifier)
