...
icAgent, OstVlanId, omnitron, OstPortList, OstModeType, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstVlanId", "omnitron", "OstPortList", "OstModeType", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", moduleVLANTable=moduleVLANTable, omnitronGroups=omnitronGroups, modLM80misc=modLM80misc, portSfpDateCode=portSfpDateCode, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, extended2=extended2, vlanidentifier=vlanidentifier, omnitronConformance=omnitronConformance, modulePortsEntry=modulePortsEntry, enableSNMPWrites=enableSNMPWrites, txOctets64=txOctets64, dhcpPortNumber=dhcpPortNumber, ahLocalMuxState=ahLocalMuxState, tftpServerIpAddress=tftpServerIpAddress, dhcpIpAddr=dhcpIpAddr, modExpSoftwareRev=modExpSoftwareRev, enabledFunctions=enabledFunctions, gateway2=gateway2, port2Membership=port2Membership, validityflag=validityflag, omnitronMIB=omnitronMIB, portAHEntry=portAHEntry, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, portSfpRxPower=portSfpRxPower, ostProtocolStatusIndex=ostProtocolStatusIndex, txMultipleCollision=txMultipleCollision, prodAgent=prodAgent, portStatsTable=portStatsTable, macAddr=macAddr, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portFwdCpu=portFwdCpu, omnitronProducts=omnitronProducts, selfSlot=selfSlot, resetmod=resetmod, rxMulticastPkts=rxMulticastPkts, port1Membership=port1Membership, ipAddr=ipAddr, ahEnabled=ahEnabled, ftppasswrd=ftppasswrd, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahErroredFrameThreshold=ahErroredFrameThreshold, slaveTrapsForward=slaveTrapsForward, ahClearStatistics=ahClearStatistics, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, slotnum=slotnum, txDeferedTransmit=txDeferedTransmit, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ahTransmissionRate=ahTransmissionRate, modFpgaRev=modFpgaRev, portSfpBitRate=portSfpBitRate, sysAdminStatus=sysAdminStatus, snmpv3PrivPassword=snmpv3PrivPassword, gateway=gateway, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, sysloc=sysloc, servicetag=servicetag, snmpTrapType=snmpTrapType, ostProtocolStatusType=ostProtocolStatusType, ahRemoteOUI=ahRemoteOUI, portpriority=portpriority, omnitronSFPGroup=omnitronSFPGroup, portFwdCpuList=portFwdCpuList, cnodeCIR=cnodeCIR, txGoodPkts=txGoodPkts, portSfpTemperature=portSfpTemperature, traphost7=traphost7, serialpass=serialpass, chassistype=chassistype, rxPackets65to127=rxPackets65to127, portAccessType=portAccessType, snmpv3UserType=snmpv3UserType, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, rxJabbers=rxJabbers, portSfpVendorPartNumber=portSfpVendorPartNumber, portSfpTxPower=portSfpTxPower, portegresspolicy=portegresspolicy, portSfpBiasCurrent=portSfpBiasCurrent, ahFramePeriodEventTotal=ahFramePeriodEventTotal, txPausePkts=txPausePkts, moduleMgtCfgTable=moduleMgtCfgTable, traphost8=traphost8, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, txMulticastPkts=txMulticastPkts, rxOctets64=rxOctets64, portmlistcriteria=portmlistcriteria, manufdate=manufdate, ipAddr2=ipAddr2, rxFragments=rxFragments, portcanonicalformatIndicator=portcanonicalformatIndicator, modname=modname, modchassnum=modchassnum, rxPackets128to255=rxPackets128to255, ahErroredFrameWindow=ahErroredFrameWindow, modpartnum=modpartnum, ahRemoteLinkPort=ahRemoteLinkPort, extended5=extended5, readCommunity=readCommunity, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, capsMask=capsMask, extended1=extended1, port3Membership=port3Membership, modcommitVLANchanges=modcommitVLANchanges, portSFPEntry=portSFPEntry, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, traphost1=traphost1, portStatsClear=portStatsClear, rxUnicastPkts=rxUnicastPkts, portMacAddress=portMacAddress, modLM80volts=modLM80volts, nmmIpDisabled=nmmIpDisabled, nmmSecureMode=nmmSecureMode, prodtype=prodtype, portSfpVcc=portSfpVcc, portEgressRate=portEgressRate, enableSNMPv3Function=enableSNMPv3Function, nmmIpProtocolState=nmmIpProtocolState, txDropPkts=txDropPkts, modRestoreFactoryDefaults=modRestoreFactoryDefaults, serialnum=serialnum, traphost4=traphost4, cpuVoltageIn=cpuVoltageIn, cpuTemperature=cpuTemperature, txErrorPkts=txErrorPkts, rxCRCAlignErrors=rxCRCAlignErrors, modchassname=modchassname, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ahFrameErrorEventTotal=ahFrameErrorEventTotal, telnetpass=telnetpass, mmname=mmname, modmanufdate=modmanufdate, tftpFileName=tftpFileName, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portSfpVendorName=portSfpVendorName, cpuVoltageOut=cpuVoltageOut, userIndex=userIndex, rxOversizePkts=rxOversizePkts, portStatsEntry=portStatsEntry, snmpv3AuthPassword=snmpv3AuthPassword, ahCriticalEventMode=ahCriticalEventMode, chassis=chassis, ahLocalOUI=ahLocalOUI, ledstat=ledstat, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, chassisTable=chassisTable, rxSymbolErrors=rxSymbolErrors, ipaddr2EVCassociation=ipaddr2EVCassociation, mychassnum=mychassnum, customertag=customertag, moduleVLANEntry=moduleVLANEntry, portvlanidentifier=portvlanidentifier, ahLocalMode=ahLocalMode, modreset=modreset, port5Membership=port5Membership, modtagsubstitution=modtagsubstitution, cnodeControl=cnodeControl, switchstat=switchstat, trapSrcIpSelect=trapSrcIpSelect, enhancedchassisTable=enhancedchassisTable, extended4=extended4, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ostProtocolStatusEntry=ostProtocolStatusEntry, nmmSecureConnState=nmmSecureConnState, rxAlignmentErrors=rxAlignmentErrors, omnitronCompliance=omnitronCompliance, txDroppedEvents=txDroppedEvents, coreStatusOnly=coreStatusOnly, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, muxGroupDefaults=muxGroupDefaults, ahRemoteLinkFlags=ahRemoteLinkFlags, portSpeed=portSpeed, ipaddrEVCassociation=ipaddrEVCassociation, prodrev=prodrev, managementModule=managementModule, chassisnum=chassisnum, rxBroadcastPkts=rxBroadcastPkts, subnetmask2=subnetmask2, modExpPartNumber=modExpPartNumber, modnumports=modnumports, rxFCSErrors=rxFCSErrors, modulename=modulename, chassisEntry=chassisEntry, ahCriticalEventTrapList=ahCriticalEventTrapList, moduleTable=moduleTable, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxDropPkts=rxDropPkts, modchasstype=modchasstype, traphost5=traphost5, modeType=modeType, modswbuildnum=modswbuildnum, chassisname=chassisname, modprodrev=modprodrev, modsoftrev=modsoftrev, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modprodtype=modprodtype, nmmOAMmgmtMode=nmmOAMmgmtMode, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, traphost3=traphost3, portIngressRate=portIngressRate, ahLpbkMode=ahLpbkMode, ahRemoteParserState=ahRemoteParserState, modLM80currents=modLM80currents, modExpLedStatus=modExpLedStatus, userEntry=userEntry, dhcpGateway=dhcpGateway, snmpv3UserName=snmpv3UserName, modPcbRev=modPcbRev, txCollisions=txCollisions, moduleEntry=moduleEntry, extended3=extended3, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, defaultForwardingMap=defaultForwardingMap, ostProtocoManagementPort=ostProtocoManagementPort, nmmCfgState=nmmCfgState, modulePortsTable=modulePortsTable, modportvlan=modportvlan, portingresssecurity=portingresssecurity, omnitronGroup=omnitronGroup, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, rxPackets512to1023=rxPackets512to1023, dhcpTagVid=dhcpTagVid, portState=portState, ahRemoteMode=ahRemoteMode, slaveWrite=slaveWrite, ahLocalLinkFlags=ahLocalLinkFlags, extended6=extended6, portSfpVendorSerialNumber=portSfpVendorSerialNumber, moduleMgtCfgEntry=moduleMgtCfgEntry, rxPackets1024to1518=rxPackets1024to1518, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, vlanIdOst=vlanIdOst, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portAHTable=portAHTable, portSFPstatus=portSFPstatus, modenable802dot1qProcessing=modenable802dot1qProcessing, modHwRev=modHwRev, traphost6=traphost6, portLinkState=portLinkState, partnum=partnum, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modvlanTableClear=modvlanTableClear, subnetmask=subnetmask, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, vlanPri=vlanPri, nmmSecureSlaveSlot=nmmSecureSlaveSlot, dhcpSubnetmask=dhcpSubnetmask, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, PYSNMP_MODULE_ID=omnitronMIB, ostProtocolStatusTable=ostProtocolStatusTable, ahLocalSupportVar=ahLocalSupportVar, traphost2=traphost2, portEgressQosPolicy=portEgressQosPolicy)
mibBuilder.exportSymbols("OMNITRON-MIB", txUnicastPkts=txUnicastPkts, rxPackets64=rxPackets64, rxOctets=rxOctets, rxErrorPkts=rxErrorPkts, ostProtocolStatusState=ostProtocolStatusState, rxPausePkts=rxPausePkts, txBroadcastPkts=txBroadcastPkts, ahRemoteMuxState=ahRemoteMuxState, slaveTraps=slaveTraps, txLateCollision=txLateCollision, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portSFPpageA0=portSFPpageA0, wrswitch=wrswitch, modserialnum=modserialnum, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, writeCommunity=writeCommunity, ahRemoteSupportVar=ahRemoteSupportVar, moduleCount=moduleCount, syscon=syscon, rxUndersizePkts=rxUndersizePkts, keepAliveInterval=keepAliveInterval, bootpEnable=bootpEnable, userTable=userTable, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portL2CPmgntProcessing=portL2CPmgntProcessing, enableSNMPFunction=enableSNMPFunction, txExcessiveCollision=txExcessiveCollision, rxTotalPkts=rxTotalPkts, rxGoodPkts=rxGoodPkts, sysDateTime=sysDateTime, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, softrev=softrev, omnitronCompliances=omnitronCompliances, modslotnum=modslotnum, index=index, vlanservicetag=vlanservicetag, portSFPTable=portSFPTable, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portnum=portnum, tftpEnable=tftpEnable, portDuplex=portDuplex, rxPackets256to511=rxPackets256to511, txSingleCollision=txSingleCollision, port4Membership=port4Membership, portIngressRateDropOrPause=portIngressRateDropOrPause, portSFPpageA2=portSFPpageA2, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, txOctets=txOctets, port6Membership=port6Membership, modextfeaturebits=modextfeaturebits, snmpv3SecurityLevel=snmpv3SecurityLevel, ahLocalParserState=ahLocalParserState, portIngressRateCBS=portIngressRateCBS, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ingressPolicingType=ingressPolicingType)
