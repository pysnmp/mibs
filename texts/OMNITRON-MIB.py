...
OstPortList, icAgent, omnitron, OstPortNumber, OstVlanId, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortList", "icAgent", "omnitron", "OstPortNumber", "OstVlanId", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", traphost8=traphost8, ahRemoteLinkPort=ahRemoteLinkPort, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, userEntry=userEntry, rxOctets64=rxOctets64, serialnum=serialnum, modLM80volts=modLM80volts, extended6=extended6, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, moduleMgtCfgEntry=moduleMgtCfgEntry, omnitronCompliance=omnitronCompliance, dhcpTagVid=dhcpTagVid, defaultForwardingMap=defaultForwardingMap, rxPackets512to1023=rxPackets512to1023, sysloc=sysloc, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portState=portState, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, traphost4=traphost4, modcommitVLANchanges=modcommitVLANchanges, portSFPEntry=portSFPEntry, ahClearStatistics=ahClearStatistics, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, omnitronConformance=omnitronConformance, modLM80misc=modLM80misc, switchstat=switchstat, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ahRemoteParserState=ahRemoteParserState, telnetpass=telnetpass, extended1=extended1, traphost3=traphost3, modchasstype=modchasstype, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, rxOctets=rxOctets, ahErroredFrameThreshold=ahErroredFrameThreshold, portSfpBitRate=portSfpBitRate, portSFPpageA0=portSFPpageA0, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portvlanidentifier=portvlanidentifier, ahErroredFrameWindow=ahErroredFrameWindow, portEgressQosPolicy=portEgressQosPolicy, ahCriticalEventMode=ahCriticalEventMode, chassistype=chassistype, portSfpVcc=portSfpVcc, portpriority=portpriority, modFpgaRev=modFpgaRev, rxDropPkts=rxDropPkts, rxCRCAlignErrors=rxCRCAlignErrors, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modslotnum=modslotnum, ahLocalMuxState=ahLocalMuxState, rxPackets64=rxPackets64, rxMulticastPkts=rxMulticastPkts, modPcbRev=modPcbRev, ahLocalParserState=ahLocalParserState, port1Membership=port1Membership, nmmIpDisabled=nmmIpDisabled, moduleVLANTable=moduleVLANTable, modserialnum=modserialnum, omnitronGroups=omnitronGroups, slaveWrite=slaveWrite, nmmCfgState=nmmCfgState, slaveTraps=slaveTraps, dhcpPortNumber=dhcpPortNumber, macAddr=macAddr, txExcessiveCollision=txExcessiveCollision, port2Membership=port2Membership, modulePortsTable=modulePortsTable, modreset=modreset, ostProtocolStatusTable=ostProtocolStatusTable, modprodtype=modprodtype, extended5=extended5, modHwRev=modHwRev, nmmSecureConnState=nmmSecureConnState, enabledFunctions=enabledFunctions, txOctets64=txOctets64, prodAgent=prodAgent, ipAddr=ipAddr, bootpEnable=bootpEnable, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahRemoteOUI=ahRemoteOUI, traphost5=traphost5, enhancedchassisTable=enhancedchassisTable, resetmod=resetmod, portSfpVendorPartNumber=portSfpVendorPartNumber, txMulticastPkts=txMulticastPkts, rxSymbolErrors=rxSymbolErrors, gateway2=gateway2, portFwdCpuList=portFwdCpuList, rxJabbers=rxJabbers, tftpEnable=tftpEnable, rxOversizePkts=rxOversizePkts, portSfpDateCode=portSfpDateCode, chassisname=chassisname, tftpFileName=tftpFileName, moduleMgtCfgTable=moduleMgtCfgTable, moduleVLANEntry=moduleVLANEntry, modportvlan=modportvlan, ahLocalMode=ahLocalMode, tftpServerIpAddress=tftpServerIpAddress, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, txDroppedEvents=txDroppedEvents, subnetmask=subnetmask, cpuVoltageIn=cpuVoltageIn, portAccessType=portAccessType, ftppasswrd=ftppasswrd, omnitronMIB=omnitronMIB, portMacAddress=portMacAddress, txLateCollision=txLateCollision, txOctets=txOctets, rxPausePkts=rxPausePkts, ostProtocolStatusType=ostProtocolStatusType, portingresssecurity=portingresssecurity, dhcpSubnetmask=dhcpSubnetmask, gateway=gateway, cpuTemperature=cpuTemperature, modRestoreFactoryDefaults=modRestoreFactoryDefaults, modchassnum=modchassnum, modname=modname, portSpeed=portSpeed, manufdate=manufdate, txMultipleCollision=txMultipleCollision, slaveTrapsForward=slaveTrapsForward, port4Membership=port4Membership, modmanufdate=modmanufdate, modExpSoftwareRev=modExpSoftwareRev, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, coreStatusOnly=coreStatusOnly, omnitronSFPGroup=omnitronSFPGroup, chassisTable=chassisTable, traphost6=traphost6, partnum=partnum, ostProtocolStatusEntry=ostProtocolStatusEntry, txDropPkts=txDropPkts, chassisnum=chassisnum, traphost7=traphost7, portSfpTemperature=portSfpTemperature, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, snmpv3UserType=snmpv3UserType, chassisEntry=chassisEntry, omnitronCompliances=omnitronCompliances, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, capsMask=capsMask, enableSNMPv3Function=enableSNMPv3Function, snmpv3UserName=snmpv3UserName, port3Membership=port3Membership, modprodrev=modprodrev, portSfpBiasCurrent=portSfpBiasCurrent, vlanPri=vlanPri, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxBroadcastPkts=rxBroadcastPkts, mychassnum=mychassnum, portcanonicalformatIndicator=portcanonicalformatIndicator, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portSfpRxPower=portSfpRxPower, portStatsEntry=portStatsEntry, softrev=softrev, portLinkState=portLinkState, enableSNMPFunction=enableSNMPFunction, extended4=extended4, ahFramePeriodEventTotal=ahFramePeriodEventTotal, rxGoodPkts=rxGoodPkts, writeCommunity=writeCommunity, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, index=index, vlanIdOst=vlanIdOst, port6Membership=port6Membership, traphost2=traphost2, extended3=extended3, txGoodPkts=txGoodPkts, syscon=syscon, txCollisions=txCollisions, validityflag=validityflag, portStatsTable=portStatsTable, vlanidentifier=vlanidentifier, modeType=modeType, modtagsubstitution=modtagsubstitution, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, rxUndersizePkts=rxUndersizePkts, ahRemoteLinkFlags=ahRemoteLinkFlags, modsoftrev=modsoftrev, modulePortsEntry=modulePortsEntry, txUnicastPkts=txUnicastPkts, modextfeaturebits=modextfeaturebits, portSfpTxPower=portSfpTxPower, subnetmask2=subnetmask2, snmpTrapType=snmpTrapType, port5Membership=port5Membership, ahTransmissionRate=ahTransmissionRate, portEgressRate=portEgressRate, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, selfSlot=selfSlot, modulename=modulename, ahLocalOUI=ahLocalOUI, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modnumports=modnumports, portSfpVendorName=portSfpVendorName, nmmSecureMode=nmmSecureMode, portAHEntry=portAHEntry, sysAdminStatus=sysAdminStatus, enableSNMPWrites=enableSNMPWrites, rxErrorPkts=rxErrorPkts, rxFragments=rxFragments, snmpv3PrivPassword=snmpv3PrivPassword, vlanservicetag=vlanservicetag, prodrev=prodrev, ahLocalLpbkTimeout=ahLocalLpbkTimeout, sysDateTime=sysDateTime, snmpv3SecurityLevel=snmpv3SecurityLevel, portIngressRateCBS=portIngressRateCBS, muxGroupDefaults=muxGroupDefaults, rxPackets65to127=rxPackets65to127, portIngressRate=portIngressRate, ahEnabled=ahEnabled, rxPackets128to255=rxPackets128to255, ahRemoteMode=ahRemoteMode, ahLocalSupportVar=ahLocalSupportVar, serialpass=serialpass, modvlanTableClear=modvlanTableClear, ingressPolicingType=ingressPolicingType, userTable=userTable, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portL2CPmgntProcessing=portL2CPmgntProcessing, ahRemoteSupportVar=ahRemoteSupportVar, chassis=chassis, portegresspolicy=portegresspolicy, ostProtocolStatusState=ostProtocolStatusState, snmpv3AuthPassword=snmpv3AuthPassword, ostProtocoManagementPort=ostProtocoManagementPort, ahRemoteMuxState=ahRemoteMuxState, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, rxPackets1024to1518=rxPackets1024to1518, txBroadcastPkts=txBroadcastPkts, portAHTable=portAHTable, userIndex=userIndex, rxTotalPkts=rxTotalPkts, moduleEntry=moduleEntry, portIngressRateDropOrPause=portIngressRateDropOrPause, txErrorPkts=txErrorPkts, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portSFPpageA2=portSFPpageA2, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ledstat=ledstat, rxPackets256to511=rxPackets256to511, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, portmlistcriteria=portmlistcriteria, moduleCount=moduleCount, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, omnitronGroup=omnitronGroup, cnodeCIR=cnodeCIR)
mibBuilder.exportSymbols("OMNITRON-MIB", extended2=extended2, trapSrcIpSelect=trapSrcIpSelect, cpuVoltageOut=cpuVoltageOut, modExpLedStatus=modExpLedStatus, ostProtocolStatusIndex=ostProtocolStatusIndex, modcommitNMMCfgChanges=modcommitNMMCfgChanges, rxAlignmentErrors=rxAlignmentErrors, ahCriticalEventTrapList=ahCriticalEventTrapList, customertag=customertag, portStatsClear=portStatsClear, portFwdCpu=portFwdCpu, wrswitch=wrswitch, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portSFPTable=portSFPTable, modenable802dot1qProcessing=modenable802dot1qProcessing, ipAddr2=ipAddr2, ahLocalLinkFlags=ahLocalLinkFlags, nmmSecureSlaveSlot=nmmSecureSlaveSlot, servicetag=servicetag, ipaddrEVCassociation=ipaddrEVCassociation, dhcpGateway=dhcpGateway, rxFCSErrors=rxFCSErrors, ipaddr2EVCassociation=ipaddr2EVCassociation, omnitronProducts=omnitronProducts, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, managementModule=managementModule, txPausePkts=txPausePkts, portDuplex=portDuplex, modExpPartNumber=modExpPartNumber, mmname=mmname, modLM80currents=modLM80currents, txSingleCollision=txSingleCollision, modswbuildnum=modswbuildnum, modpartnum=modpartnum, slotnum=slotnum, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, moduleTable=moduleTable, keepAliveInterval=keepAliveInterval, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, prodtype=prodtype, dhcpIpAddr=dhcpIpAddr, modchassname=modchassname, portSFPstatus=portSFPstatus, rxUnicastPkts=rxUnicastPkts, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portnum=portnum, readCommunity=readCommunity, cnodeControl=cnodeControl, nmmOAMmgmtMode=nmmOAMmgmtMode, traphost1=traphost1, nmmIpProtocolState=nmmIpProtocolState, txDeferedTransmit=txDeferedTransmit, PYSNMP_MODULE_ID=omnitronMIB, ahLpbkMode=ahLpbkMode)
