...
OstModeType, OstVlanId, OstPortNumber, OstPortList, omnitron, icAgent = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstVlanId", "OstPortNumber", "OstPortList", "omnitron", "icAgent")
...
mibBuilder.exportSymbols("OMNITRON-MIB", txUnicastPkts=txUnicastPkts, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, bootpEnable=bootpEnable, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, modulePortsTable=modulePortsTable, mmname=mmname, modportvlan=modportvlan, traphost1=traphost1, nmmCfgState=nmmCfgState, gateway=gateway, omnitronConformance=omnitronConformance, txMulticastPkts=txMulticastPkts, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, prodtype=prodtype, syscon=syscon, ahEnabled=ahEnabled, rxFragments=rxFragments, port5Membership=port5Membership, modPcbRev=modPcbRev, vlanidentifier=vlanidentifier, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, txSingleCollision=txSingleCollision, rxPackets512to1023=rxPackets512to1023, nmmOAMmgmtMode=nmmOAMmgmtMode, portvlanidentifier=portvlanidentifier, portingresssecurity=portingresssecurity, traphost2=traphost2, vlanIdOst=vlanIdOst, subnetmask=subnetmask, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, prodrev=prodrev, traphost3=traphost3, txDroppedEvents=txDroppedEvents, traphost6=traphost6, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahLocalMode=ahLocalMode, extended2=extended2, modLM80volts=modLM80volts, gateway2=gateway2, ahRemoteMuxState=ahRemoteMuxState, snmpTrapType=snmpTrapType, modswbuildnum=modswbuildnum, dhcpPortNumber=dhcpPortNumber, vlanservicetag=vlanservicetag, portAccessType=portAccessType, modExpSoftwareRev=modExpSoftwareRev, slaveTraps=slaveTraps, nmmSecureMode=nmmSecureMode, ipaddrEVCassociation=ipaddrEVCassociation, modulePortsEntry=modulePortsEntry, ahLpbkMode=ahLpbkMode, txMultipleCollision=txMultipleCollision, txDeferedTransmit=txDeferedTransmit, keepAliveInterval=keepAliveInterval, snmpv3UserType=snmpv3UserType, switchstat=switchstat, modextfeaturebits=modextfeaturebits, snmpv3UserName=snmpv3UserName, portSfpRxPower=portSfpRxPower, rxDropPkts=rxDropPkts, ahRemoteOUI=ahRemoteOUI, portStatsEntry=portStatsEntry, ahLocalLinkFlags=ahLocalLinkFlags, slaveTrapsForward=slaveTrapsForward, moduleMgtCfgEntry=moduleMgtCfgEntry, portIngressRateCBS=portIngressRateCBS, ahCriticalEventTrapList=ahCriticalEventTrapList, ahCriticalEventMode=ahCriticalEventMode, enableSNMPv3Function=enableSNMPv3Function, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, readCommunity=readCommunity, rxMulticastPkts=rxMulticastPkts, omnitronSFPGroup=omnitronSFPGroup, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, chassisname=chassisname, portDuplex=portDuplex, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ipAddr=ipAddr, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, modreset=modreset, portSfpBiasCurrent=portSfpBiasCurrent, modchassname=modchassname, modname=modname, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modExpPartNumber=modExpPartNumber, snmpv3AuthPassword=snmpv3AuthPassword, txOctets=txOctets, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxPackets64=rxPackets64, ostEnvironmentalTemperature=ostEnvironmentalTemperature, resetmod=resetmod, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahFramePeriodEventTotal=ahFramePeriodEventTotal, trapSrcIpSelect=trapSrcIpSelect, snmpv3PrivPassword=snmpv3PrivPassword, portEgressRate=portEgressRate, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, dhcptftpServerIpAddress=dhcptftpServerIpAddress, softrev=softrev, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, servicetag=servicetag, ahClearStatistics=ahClearStatistics, manufdate=manufdate, portStatsClear=portStatsClear, serialpass=serialpass, portL2CPmgntProcessing=portL2CPmgntProcessing, traphost4=traphost4, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portSfpVendorPartNumber=portSfpVendorPartNumber, telnetpass=telnetpass, omnitronCompliances=omnitronCompliances, portAHTable=portAHTable, cnodeCIR=cnodeCIR, index=index, nmmSecureConnState=nmmSecureConnState, portegresspolicy=portegresspolicy, rxGoodPkts=rxGoodPkts, vlanPri=vlanPri, portmlistcriteria=portmlistcriteria, ostProtocolStatusIndex=ostProtocolStatusIndex, txExcessiveCollision=txExcessiveCollision, modFpgaRev=modFpgaRev, dhcpGateway=dhcpGateway, modprodtype=modprodtype, ostProtocolStatusType=ostProtocolStatusType, writeCommunity=writeCommunity, portLinkState=portLinkState, ahRemoteLinkPort=ahRemoteLinkPort, moduleVLANEntry=moduleVLANEntry, traphost7=traphost7, wrswitch=wrswitch, omnitronProducts=omnitronProducts, moduleEntry=moduleEntry, chassisEntry=chassisEntry, modvlanTableClear=modvlanTableClear, modchasstype=modchasstype, PYSNMP_MODULE_ID=omnitronMIB, txDropPkts=txDropPkts, modslotnum=modslotnum, slaveWrite=slaveWrite, txLateCollision=txLateCollision, modtagsubstitution=modtagsubstitution, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portnum=portnum, portSFPstatus=portSFPstatus, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, chassistype=chassistype, defaultForwardingMap=defaultForwardingMap, cpuVoltageIn=cpuVoltageIn, cpuTemperature=cpuTemperature, rxBroadcastPkts=rxBroadcastPkts, modmanufdate=modmanufdate, rxPackets1024to1518=rxPackets1024to1518, ahLocalParserState=ahLocalParserState, modRestoreFactoryDefaults=modRestoreFactoryDefaults, extended4=extended4, portIngressRate=portIngressRate, enhancedchassisTable=enhancedchassisTable, customertag=customertag, portpriority=portpriority, ostProtocolStatusTable=ostProtocolStatusTable, modsoftrev=modsoftrev, modpartnum=modpartnum, txCollisions=txCollisions, subnetmask2=subnetmask2, userTable=userTable, nmmSecureSlaveSlot=nmmSecureSlaveSlot, enableSNMPWrites=enableSNMPWrites, modeType=modeType, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, rxCRCAlignErrors=rxCRCAlignErrors, portState=portState, coreStatusOnly=coreStatusOnly, enabledFunctions=enabledFunctions, omnitronGroups=omnitronGroups, omnitronMIB=omnitronMIB, modLM80currents=modLM80currents, capsMask=capsMask, portSfpTemperature=portSfpTemperature, rxAlignmentErrors=rxAlignmentErrors, muxGroupDefaults=muxGroupDefaults, portSpeed=portSpeed, nmmIpDisabled=nmmIpDisabled, modserialnum=modserialnum, port3Membership=port3Membership, ipaddr2EVCassociation=ipaddr2EVCassociation, portAHEntry=portAHEntry, ahErroredFrameWindow=ahErroredFrameWindow, rxPackets128to255=rxPackets128to255, cpuVoltageOut=cpuVoltageOut, rxFCSErrors=rxFCSErrors, sysloc=sysloc, ostProtocolStatusEntry=ostProtocolStatusEntry, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, rxOctets=rxOctets, rxPausePkts=rxPausePkts, extended5=extended5, traphost8=traphost8, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxUndersizePkts=rxUndersizePkts, ahTransmissionRate=ahTransmissionRate, portStatsTable=portStatsTable, tftpFileName=tftpFileName, ahErroredFrameThreshold=ahErroredFrameThreshold, sysAdminStatus=sysAdminStatus, ahRemoteMode=ahRemoteMode, ostProtocolStatusState=ostProtocolStatusState, portSfpVendorName=portSfpVendorName, port6Membership=port6Membership, tftpServerIpAddress=tftpServerIpAddress, enableSNMPFunction=enableSNMPFunction, managementModule=managementModule, mychassnum=mychassnum, partnum=partnum, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, prodAgent=prodAgent, ingressPolicingType=ingressPolicingType, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, traphost5=traphost5, modnumports=modnumports, rxJabbers=rxJabbers, validityflag=validityflag, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ahRemoteParserState=ahRemoteParserState, ahLocalOUI=ahLocalOUI, portSFPpageA0=portSFPpageA0, omnitronCompliance=omnitronCompliance, ftppasswrd=ftppasswrd, port1Membership=port1Membership, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, moduleTable=moduleTable, portSfpBitRate=portSfpBitRate, serialnum=serialnum, rxOctets64=rxOctets64, portcanonicalformatIndicator=portcanonicalformatIndicator, txGoodPkts=txGoodPkts, txPausePkts=txPausePkts, portMacAddress=portMacAddress, ledstat=ledstat, moduleVLANTable=moduleVLANTable, portFwdCpu=portFwdCpu, portSFPTable=portSFPTable, modLM80misc=modLM80misc, dhcpIpAddr=dhcpIpAddr, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, userIndex=userIndex, rxErrorPkts=rxErrorPkts, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, moduleMgtCfgTable=moduleMgtCfgTable, nmmIpProtocolState=nmmIpProtocolState, extended3=extended3, rxSymbolErrors=rxSymbolErrors, selfSlot=selfSlot)
mibBuilder.exportSymbols("OMNITRON-MIB", modcommitVLANchanges=modcommitVLANchanges, tftpEnable=tftpEnable, ostProtocoManagementPort=ostProtocoManagementPort, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, txErrorPkts=txErrorPkts, modHwRev=modHwRev, rxPackets65to127=rxPackets65to127, modchassnum=modchassnum, rxOversizePkts=rxOversizePkts, cnodeControl=cnodeControl, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portEgressQosPolicy=portEgressQosPolicy, snmpv3SecurityLevel=snmpv3SecurityLevel, ahRemoteLinkFlags=ahRemoteLinkFlags, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, txOctets64=txOctets64, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, extended6=extended6, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, port4Membership=port4Membership, ahLocalMuxState=ahLocalMuxState, modulename=modulename, userEntry=userEntry, chassisTable=chassisTable, ahLocalSupportVar=ahLocalSupportVar, portSfpDateCode=portSfpDateCode, chassisnum=chassisnum, ahRemoteSupportVar=ahRemoteSupportVar, port2Membership=port2Membership, extended1=extended1, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, slotnum=slotnum, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, sysDateTime=sysDateTime, ipAddr2=ipAddr2, portSfpTxPower=portSfpTxPower, txBroadcastPkts=txBroadcastPkts, portSFPEntry=portSFPEntry, omnitronGroup=omnitronGroup, chassis=chassis, moduleCount=moduleCount, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSFPpageA2=portSFPpageA2, portSfpVcc=portSfpVcc, rxTotalPkts=rxTotalPkts, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portIngressRateDropOrPause=portIngressRateDropOrPause, rxUnicastPkts=rxUnicastPkts, modenable802dot1qProcessing=modenable802dot1qProcessing, macAddr=macAddr, rxPackets256to511=rxPackets256to511, portFwdCpuList=portFwdCpuList, modprodrev=modprodrev, dhcpTagVid=dhcpTagVid, modExpLedStatus=modExpLedStatus, dhcpSubnetmask=dhcpSubnetmask)
