...
OstModeType, OstPortNumber, omnitron, icAgent, OstPortList, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstPortNumber", "omnitron", "icAgent", "OstPortList", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", modHwRev=modHwRev, traphost4=traphost4, userEntry=userEntry, snmpv3UserType=snmpv3UserType, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, nmmSecureMode=nmmSecureMode, tftpServerIpAddress=tftpServerIpAddress, userTable=userTable, nmmOAMmgmtMode=nmmOAMmgmtMode, prodtype=prodtype, subnetmask=subnetmask, snmpv3UserName=snmpv3UserName, moduleMgtCfgEntry=moduleMgtCfgEntry, txExcessiveCollision=txExcessiveCollision, softrev=softrev, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, port1Membership=port1Membership, modcommitVLANchanges=modcommitVLANchanges, traphost8=traphost8, modExpSoftwareRev=modExpSoftwareRev, ahRemoteLinkPort=ahRemoteLinkPort, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, nmmSecureSlaveSlot=nmmSecureSlaveSlot, txUnicastPkts=txUnicastPkts, modserialnum=modserialnum, ahFramePeriodEventTotal=ahFramePeriodEventTotal, cnodeCIR=cnodeCIR, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portpriority=portpriority, ahCriticalEventTrapList=ahCriticalEventTrapList, modprodrev=modprodrev, ahLocalParserState=ahLocalParserState, nmmCfgState=nmmCfgState, ahLocalOUI=ahLocalOUI, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, rxFragments=rxFragments, selfSlot=selfSlot, chassisnum=chassisnum, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portSFPpageA0=portSFPpageA0, modFpgaRev=modFpgaRev, portL2CPmgntProcessing=portL2CPmgntProcessing, bootpEnable=bootpEnable, rxPackets65to127=rxPackets65to127, portSFPstatus=portSFPstatus, modswbuildnum=modswbuildnum, modExpPartNumber=modExpPartNumber, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, slaveWrite=slaveWrite, dhcpSubnetmask=dhcpSubnetmask, resetmod=resetmod, muxGroupDefaults=muxGroupDefaults, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portAHEntry=portAHEntry, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxPackets256to511=rxPackets256to511, modulePortsTable=modulePortsTable, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, mmname=mmname, snmpTrapType=snmpTrapType, ostProtocolStatusIndex=ostProtocolStatusIndex, slotnum=slotnum, moduleTable=moduleTable, rxSymbolErrors=rxSymbolErrors, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ipaddrEVCassociation=ipaddrEVCassociation, ahErroredFrameWindow=ahErroredFrameWindow, moduleCount=moduleCount, capsMask=capsMask, txOctets=txOctets, cnodeControl=cnodeControl, portSfpVendorName=portSfpVendorName, omnitronGroup=omnitronGroup, modvlanTableClear=modvlanTableClear, rxPausePkts=rxPausePkts, telnetpass=telnetpass, modextfeaturebits=modextfeaturebits, modExpLedStatus=modExpLedStatus, port5Membership=port5Membership, portState=portState, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, omnitronGroups=omnitronGroups, portSfpVcc=portSfpVcc, extended6=extended6, portSFPEntry=portSFPEntry, rxPackets1024to1518=rxPackets1024to1518, modPcbRev=modPcbRev, rxGoodPkts=rxGoodPkts, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portEgressRate=portEgressRate, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portegresspolicy=portegresspolicy, portDuplex=portDuplex, ingressPolicingType=ingressPolicingType, rxFCSErrors=rxFCSErrors, syscon=syscon, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ahRemoteParserState=ahRemoteParserState, portnum=portnum, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, sysAdminStatus=sysAdminStatus, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ahRemoteSupportVar=ahRemoteSupportVar, txDropPkts=txDropPkts, portSfpVendorPartNumber=portSfpVendorPartNumber, partnum=partnum, rxOctets64=rxOctets64, portEgressQosPolicy=portEgressQosPolicy, ahEnabled=ahEnabled, rxTotalPkts=rxTotalPkts, sysloc=sysloc, snmpv3PrivPassword=snmpv3PrivPassword, extended5=extended5, rxCRCAlignErrors=rxCRCAlignErrors, extended4=extended4, ahErroredFrameThreshold=ahErroredFrameThreshold, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, txPausePkts=txPausePkts, rxErrorPkts=rxErrorPkts, portSfpDateCode=portSfpDateCode, chassisEntry=chassisEntry, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modulename=modulename, omnitronProducts=omnitronProducts, switchstat=switchstat, extended3=extended3, prodAgent=prodAgent, traphost6=traphost6, enableSNMPWrites=enableSNMPWrites, servicetag=servicetag, moduleVLANTable=moduleVLANTable, enableSNMPv3Function=enableSNMPv3Function, modLM80misc=modLM80misc, rxPackets64=rxPackets64, ahFrameErrorEventTotal=ahFrameErrorEventTotal, defaultForwardingMap=defaultForwardingMap, rxJabbers=rxJabbers, snmpv3SecurityLevel=snmpv3SecurityLevel, ipAddr2=ipAddr2, manufdate=manufdate, txLateCollision=txLateCollision, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portcanonicalformatIndicator=portcanonicalformatIndicator, chassisname=chassisname, cpuVoltageOut=cpuVoltageOut, modname=modname, sysDateTime=sysDateTime, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, macAddr=macAddr, txMultipleCollision=txMultipleCollision, modpartnum=modpartnum, portSFPpageA2=portSFPpageA2, portSfpBiasCurrent=portSfpBiasCurrent, txSingleCollision=txSingleCollision, dhcpIpAddr=dhcpIpAddr, modsoftrev=modsoftrev, subnetmask2=subnetmask2, traphost3=traphost3, modcommitNMMCfgChanges=modcommitNMMCfgChanges, chassis=chassis, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, vlanPri=vlanPri, modRestoreFactoryDefaults=modRestoreFactoryDefaults, chassisTable=chassisTable, ftppasswrd=ftppasswrd, traphost1=traphost1, port2Membership=port2Membership, index=index, modchassname=modchassname, omnitronCompliance=omnitronCompliance, userIndex=userIndex, ostProtocolStatusState=ostProtocolStatusState, ahRemoteOUI=ahRemoteOUI, ahLocalMuxState=ahLocalMuxState, modnumports=modnumports, nmmIpDisabled=nmmIpDisabled, enhancedchassisTable=enhancedchassisTable, ahClearStatistics=ahClearStatistics, modportvlan=modportvlan, modchassnum=modchassnum, modtagsubstitution=modtagsubstitution, coreStatusOnly=coreStatusOnly, nmmSecureConnState=nmmSecureConnState, txMulticastPkts=txMulticastPkts, readCommunity=readCommunity, enabledFunctions=enabledFunctions, extended2=extended2, managementModule=managementModule, cpuTemperature=cpuTemperature, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostProtocolStatusType=ostProtocolStatusType, slaveTrapsForward=slaveTrapsForward, writeCommunity=writeCommunity, port4Membership=port4Membership, modulePortsEntry=modulePortsEntry, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, extended1=extended1, dhcpPortNumber=dhcpPortNumber, portSfpTxPower=portSfpTxPower, omnitronConformance=omnitronConformance, ledstat=ledstat, rxOversizePkts=rxOversizePkts, portSfpRxPower=portSfpRxPower, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, txBroadcastPkts=txBroadcastPkts, gateway=gateway, ahTransmissionRate=ahTransmissionRate, gateway2=gateway2, tftpEnable=tftpEnable, modslotnum=modslotnum, moduleMgtCfgTable=moduleMgtCfgTable, ipAddr=ipAddr, traphost5=traphost5, rxUnicastPkts=rxUnicastPkts, modenable802dot1qProcessing=modenable802dot1qProcessing, txCollisions=txCollisions, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, modmanufdate=modmanufdate, vlanservicetag=vlanservicetag, dhcpTagVid=dhcpTagVid, wrswitch=wrswitch, modreset=modreset, slaveTraps=slaveTraps, portIngressRate=portIngressRate, mychassnum=mychassnum, rxUndersizePkts=rxUndersizePkts, ahLocalSupportVar=ahLocalSupportVar, ahLocalLinkFlags=ahLocalLinkFlags, serialpass=serialpass, ipaddr2EVCassociation=ipaddr2EVCassociation, port3Membership=port3Membership, portStatsEntry=portStatsEntry, tftpFileName=tftpFileName, portStatsClear=portStatsClear, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, moduleEntry=moduleEntry, ahRemoteMuxState=ahRemoteMuxState, nmmIpProtocolState=nmmIpProtocolState, keepAliveInterval=keepAliveInterval, modeType=modeType, ostEnvironmentalTemperature=ostEnvironmentalTemperature, moduleVLANEntry=moduleVLANEntry, rxPackets512to1023=rxPackets512to1023, rxDropPkts=rxDropPkts, txDeferedTransmit=txDeferedTransmit, chassistype=chassistype, portFwdCpuList=portFwdCpuList, rxMulticastPkts=rxMulticastPkts, dhcpGateway=dhcpGateway, portStatsTable=portStatsTable, portmlistcriteria=portmlistcriteria)
mibBuilder.exportSymbols("OMNITRON-MIB", portFwdCpu=portFwdCpu, txOctets64=txOctets64, trapSrcIpSelect=trapSrcIpSelect, ahCriticalEventMode=ahCriticalEventMode, omnitronCompliances=omnitronCompliances, validityflag=validityflag, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, enableSNMPFunction=enableSNMPFunction, port6Membership=port6Membership, omnitronSFPGroup=omnitronSFPGroup, vlanidentifier=vlanidentifier, portSpeed=portSpeed, txErrorPkts=txErrorPkts, portSfpBitRate=portSfpBitRate, cpuVoltageIn=cpuVoltageIn, ahRemoteLinkFlags=ahRemoteLinkFlags, portingresssecurity=portingresssecurity, traphost7=traphost7, vlanIdOst=vlanIdOst, txDroppedEvents=txDroppedEvents, modchasstype=modchasstype, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahLocalMode=ahLocalMode, portMacAddress=portMacAddress, ahLpbkMode=ahLpbkMode, modLM80currents=modLM80currents, portIngressRateDropOrPause=portIngressRateDropOrPause, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portvlanidentifier=portvlanidentifier, portIngressRateCBS=portIngressRateCBS, traphost2=traphost2, portAHTable=portAHTable, rxBroadcastPkts=rxBroadcastPkts, omnitronMIB=omnitronMIB, portSfpTemperature=portSfpTemperature, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portSFPTable=portSFPTable, serialnum=serialnum, snmpv3AuthPassword=snmpv3AuthPassword, portAccessType=portAccessType, PYSNMP_MODULE_ID=omnitronMIB, txGoodPkts=txGoodPkts, rxAlignmentErrors=rxAlignmentErrors, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, prodrev=prodrev, portLinkState=portLinkState, rxPackets128to255=rxPackets128to255, ostProtocolStatusTable=ostProtocolStatusTable, customertag=customertag, ostProtocoManagementPort=ostProtocoManagementPort, modprodtype=modprodtype, modLM80volts=modLM80volts, rxOctets=rxOctets, ostProtocolStatusEntry=ostProtocolStatusEntry, ahRemoteMode=ahRemoteMode)
