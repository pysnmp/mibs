...
mibBuilder.exportSymbols("OMNITRON-MIB", modHwRev=modHwRev, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, subnetmask2=subnetmask2, ostProtocolStatusType=ostProtocolStatusType, modtagsubstitution=modtagsubstitution, portpriority=portpriority, modreset=modreset, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modExpPartNumber=modExpPartNumber, enhancedchassisTable=enhancedchassisTable, modLM80currents=modLM80currents, rxMulticastPkts=rxMulticastPkts, ostProtocoManagementPort=ostProtocoManagementPort, keepAliveInterval=keepAliveInterval, rxUnicastPkts=rxUnicastPkts, ahFrameErrorEventTotal=ahFrameErrorEventTotal, cnodeControl=cnodeControl, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxErrorPkts=rxErrorPkts, portEgressQosPolicy=portEgressQosPolicy, prodrev=prodrev, enableSNMPv3Function=enableSNMPv3Function, ahLocalLpbkTimeout=ahLocalLpbkTimeout, sysDateTime=sysDateTime, vlanPri=vlanPri, port5Membership=port5Membership, ahRemoteSupportVar=ahRemoteSupportVar, slaveTraps=slaveTraps, writeCommunity=writeCommunity, modserialnum=modserialnum, portnum=portnum, dhcpIpAddr=dhcpIpAddr, rxUndersizePkts=rxUndersizePkts, rxDropPkts=rxDropPkts, rxPackets64=rxPackets64, port3Membership=port3Membership, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portvlanidentifier=portvlanidentifier, dhcpSubnetmask=dhcpSubnetmask, rxPausePkts=rxPausePkts, ahLocalMuxState=ahLocalMuxState, txPausePkts=txPausePkts, portegresspolicy=portegresspolicy, moduleCount=moduleCount, omnitronMIB=omnitronMIB, txCollisions=txCollisions, snmpv3UserType=snmpv3UserType, ftppasswrd=ftppasswrd, traphost3=traphost3, portEgressRate=portEgressRate, traphost7=traphost7, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, vlanservicetag=vlanservicetag, dhcpTagVid=dhcpTagVid, extended3=extended3, portSFPEntry=portSFPEntry, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, moduleVLANTable=moduleVLANTable, ahErroredFrameThreshold=ahErroredFrameThreshold, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, rxCRCAlignErrors=rxCRCAlignErrors, modextfeaturebits=modextfeaturebits, rxJabbers=rxJabbers, ahLpbkMode=ahLpbkMode, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahLocalMode=ahLocalMode, portSfpRxPower=portSfpRxPower, readCommunity=readCommunity, moduleVLANEntry=moduleVLANEntry, omnitronCompliance=omnitronCompliance, portIngressRateDropOrPause=portIngressRateDropOrPause, modPcbRev=modPcbRev, rxGoodPkts=rxGoodPkts, modulename=modulename, ahCriticalEventMode=ahCriticalEventMode, omnitronGroup=omnitronGroup, manufdate=manufdate, portLinkState=portLinkState, softrev=softrev, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, enableSNMPWrites=enableSNMPWrites, ahErroredFrameWindow=ahErroredFrameWindow, ostProtocolStatusIndex=ostProtocolStatusIndex, modsoftrev=modsoftrev, userTable=userTable, servicetag=servicetag, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, userEntry=userEntry, traphost5=traphost5, rxOctets=rxOctets, txOctets64=txOctets64, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, extended5=extended5, modchassname=modchassname, ipaddr2EVCassociation=ipaddr2EVCassociation, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, extended6=extended6, portStatsClear=portStatsClear, modname=modname, trapSrcIpSelect=trapSrcIpSelect, ahRemoteLinkPort=ahRemoteLinkPort, macAddr=macAddr, modLM80misc=modLM80misc, mychassnum=mychassnum, nmmSecureSlaveSlot=nmmSecureSlaveSlot, cpuVoltageIn=cpuVoltageIn, traphost4=traphost4, moduleMgtCfgTable=moduleMgtCfgTable, dhcpGateway=dhcpGateway, modswbuildnum=modswbuildnum, modLM80volts=modLM80volts, prodtype=prodtype, serialnum=serialnum, traphost1=traphost1, syscon=syscon, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ahLocalOUI=ahLocalOUI, portSfpVendorPartNumber=portSfpVendorPartNumber, customertag=customertag, portIngressRateCBS=portIngressRateCBS, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, txDeferedTransmit=txDeferedTransmit, moduleEntry=moduleEntry, ahRemoteParserState=ahRemoteParserState, enabledFunctions=enabledFunctions, ahLocalSupportVar=ahLocalSupportVar, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, port4Membership=port4Membership, modportvlan=modportvlan, portSpeed=portSpeed, ahRemoteMuxState=ahRemoteMuxState, ahFramePeriodEventTotal=ahFramePeriodEventTotal, snmpv3UserName=snmpv3UserName, ostProtocolStatusState=ostProtocolStatusState, modenable802dot1qProcessing=modenable802dot1qProcessing, ahLocalLinkFlags=ahLocalLinkFlags, resetmod=resetmod, txUnicastPkts=txUnicastPkts, portSfpBitRate=portSfpBitRate, ledstat=ledstat, rxPackets256to511=rxPackets256to511, cpuVoltageOut=cpuVoltageOut, portMacAddress=portMacAddress, portFwdCpu=portFwdCpu, port2Membership=port2Membership, txDropPkts=txDropPkts, traphost2=traphost2, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, omnitronProducts=omnitronProducts, portSFPTable=portSFPTable, portSfpVendorName=portSfpVendorName, enableSNMPFunction=enableSNMPFunction, omnitronCompliances=omnitronCompliances, modExpSoftwareRev=modExpSoftwareRev, modslotnum=modslotnum, ostProtocolStatusEntry=ostProtocolStatusEntry, cnodeCIR=cnodeCIR, portAccessType=portAccessType, chassisname=chassisname, chassisEntry=chassisEntry, managementModule=managementModule, snmpv3PrivPassword=snmpv3PrivPassword, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, txErrorPkts=txErrorPkts, nmmSecureConnState=nmmSecureConnState, tftpFileName=tftpFileName, modulePortsEntry=modulePortsEntry, modchasstype=modchasstype, portSfpTemperature=portSfpTemperature, ahTransmissionRate=ahTransmissionRate, capsMask=capsMask, PYSNMP_MODULE_ID=omnitronMIB, txOctets=txOctets, rxOversizePkts=rxOversizePkts, vlanidentifier=vlanidentifier, extended2=extended2, switchstat=switchstat, portSfpTxPower=portSfpTxPower, moduleTable=moduleTable, modprodtype=modprodtype, ahLocalParserState=ahLocalParserState, portSfpVendorSerialNumber=portSfpVendorSerialNumber, rxPackets1024to1518=rxPackets1024to1518, modchassnum=modchassnum, selfSlot=selfSlot, ahClearStatistics=ahClearStatistics, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ipAddr2=ipAddr2, portSfpDateCode=portSfpDateCode, rxPackets65to127=rxPackets65to127, rxAlignmentErrors=rxAlignmentErrors, port6Membership=port6Membership, telnetpass=telnetpass, ahRemoteOUI=ahRemoteOUI, portDuplex=portDuplex, slotnum=slotnum, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, serialpass=serialpass, sysAdminStatus=sysAdminStatus, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, modExpLedStatus=modExpLedStatus, chassis=chassis, moduleMgtCfgEntry=moduleMgtCfgEntry, modnumports=modnumports, modeType=modeType, txDroppedEvents=txDroppedEvents, validityflag=validityflag, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, rxSymbolErrors=rxSymbolErrors, ostProtocolStatusTable=ostProtocolStatusTable, portmlistcriteria=portmlistcriteria, ahRemoteMode=ahRemoteMode, txBroadcastPkts=txBroadcastPkts, extended4=extended4, portcanonicalformatIndicator=portcanonicalformatIndicator, txGoodPkts=txGoodPkts, ingressPolicingType=ingressPolicingType, nmmIpDisabled=nmmIpDisabled, ipaddrEVCassociation=ipaddrEVCassociation, portSfpVcc=portSfpVcc, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, index=index, coreStatusOnly=coreStatusOnly, portFwdCpuList=portFwdCpuList, portStatsTable=portStatsTable, nmmSecureMode=nmmSecureMode, tftpServerIpAddress=tftpServerIpAddress, portAHEntry=portAHEntry, portAHTable=portAHTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ahRemoteLinkFlags=ahRemoteLinkFlags, sysloc=sysloc, portStatsEntry=portStatsEntry, extended1=extended1, dhcpPortNumber=dhcpPortNumber, snmpv3SecurityLevel=snmpv3SecurityLevel, txMulticastPkts=txMulticastPkts, portState=portState, portSFPpageA0=portSFPpageA0, modcommitNMMCfgChanges=modcommitNMMCfgChanges, omnitronGroups=omnitronGroups, partnum=partnum, modvlanTableClear=modvlanTableClear, prodAgent=prodAgent, chassisnum=chassisnum, rxPackets128to255=rxPackets128to255, snmpTrapType=snmpTrapType, tftpEnable=tftpEnable, muxGroupDefaults=muxGroupDefaults, portSFPpageA2=portSFPpageA2)
mibBuilder.exportSymbols("OMNITRON-MIB", omnitronSFPGroup=omnitronSFPGroup, portIngressRate=portIngressRate, ahEnabled=ahEnabled, chassisTable=chassisTable, modcommitVLANchanges=modcommitVLANchanges, gateway2=gateway2, traphost6=traphost6, modulePortsTable=modulePortsTable, vlanIdOst=vlanIdOst, omnitronConformance=omnitronConformance, portSFPstatus=portSFPstatus, txSingleCollision=txSingleCollision, rxPackets512to1023=rxPackets512to1023, nmmOAMmgmtMode=nmmOAMmgmtMode, cpuTemperature=cpuTemperature, mmname=mmname, nmmIpProtocolState=nmmIpProtocolState, rxTotalPkts=rxTotalPkts, bootpEnable=bootpEnable, rxBroadcastPkts=rxBroadcastPkts, snmpv3AuthPassword=snmpv3AuthPassword, chassistype=chassistype, slaveTrapsForward=slaveTrapsForward, gateway=gateway, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, modmanufdate=modmanufdate, portingresssecurity=portingresssecurity, slaveWrite=slaveWrite, portL2CPmgntProcessing=portL2CPmgntProcessing, rxFCSErrors=rxFCSErrors, nmmCfgState=nmmCfgState, wrswitch=wrswitch, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modpartnum=modpartnum, portSfpBiasCurrent=portSfpBiasCurrent, txExcessiveCollision=txExcessiveCollision, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, port1Membership=port1Membership, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, txLateCollision=txLateCollision, ipAddr=ipAddr, rxOctets64=rxOctets64, modFpgaRev=modFpgaRev, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, traphost8=traphost8, rxFragments=rxFragments, userIndex=userIndex, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, subnetmask=subnetmask, ostEnvironmentalTemperature=ostEnvironmentalTemperature, modprodrev=modprodrev, txMultipleCollision=txMultipleCollision, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahCriticalEventTrapList=ahCriticalEventTrapList, defaultForwardingMap=defaultForwardingMap)
