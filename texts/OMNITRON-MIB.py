...
mibBuilder.exportSymbols("OMNITRON-MIB", portSFPstatus=portSFPstatus, modslotnum=modslotnum, ahCriticalEventMode=ahCriticalEventMode, rxAlignmentErrors=rxAlignmentErrors, snmpv3UserName=snmpv3UserName, omnitronConformance=omnitronConformance, portEgressQosPolicy=portEgressQosPolicy, rxTotalPkts=rxTotalPkts, ahTransmissionRate=ahTransmissionRate, portSfpTxPower=portSfpTxPower, snmpv3AuthPassword=snmpv3AuthPassword, nmmIpDisabled=nmmIpDisabled, portSFPTable=portSFPTable, ftppasswrd=ftppasswrd, chassis=chassis, partnum=partnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ahLocalOUI=ahLocalOUI, ahRemoteSupportVar=ahRemoteSupportVar, portSFPpageA2=portSFPpageA2, modchassname=modchassname, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, sysloc=sysloc, slaveWrite=slaveWrite, traphost4=traphost4, readCommunity=readCommunity, writeCommunity=writeCommunity, modsoftrev=modsoftrev, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, snmpv3SecurityLevel=snmpv3SecurityLevel, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portSfpBitRate=portSfpBitRate, port5Membership=port5Membership, resetmod=resetmod, extended2=extended2, modpartnum=modpartnum, port1Membership=port1Membership, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, extended5=extended5, portmlistcriteria=portmlistcriteria, slaveTrapsForward=slaveTrapsForward, ahRemoteParserState=ahRemoteParserState, rxUnicastPkts=rxUnicastPkts, sysAdminStatus=sysAdminStatus, modeType=modeType, portL2CPmgntProcessing=portL2CPmgntProcessing, modExpPartNumber=modExpPartNumber, moduleVLANEntry=moduleVLANEntry, tftpEnable=tftpEnable, selfSlot=selfSlot, ipAddr2=ipAddr2, portFwdCpu=portFwdCpu, modcommitVLANchanges=modcommitVLANchanges, portIngressRate=portIngressRate, modchasstype=modchasstype, cnodeControl=cnodeControl, omnitronCompliance=omnitronCompliance, rxPackets256to511=rxPackets256to511, moduleMgtCfgTable=moduleMgtCfgTable, slotnum=slotnum, cpuTemperature=cpuTemperature, defaultForwardingMap=defaultForwardingMap, subnetmask=subnetmask, traphost6=traphost6, ahLocalSupportVar=ahLocalSupportVar, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, moduleEntry=moduleEntry, PYSNMP_MODULE_ID=omnitronMIB, moduleVLANTable=moduleVLANTable, trapSrcIpSelect=trapSrcIpSelect, portDuplex=portDuplex, ostProtocolStatusType=ostProtocolStatusType, modExpLedStatus=modExpLedStatus, rxPackets1024to1518=rxPackets1024to1518, cpuVoltageIn=cpuVoltageIn, modportvlan=modportvlan, traphost1=traphost1, cnodeCIR=cnodeCIR, ipAddr=ipAddr, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, txOctets=txOctets, modserialnum=modserialnum, ahCriticalEventTrapList=ahCriticalEventTrapList, ahClearStatistics=ahClearStatistics, capsMask=capsMask, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahLocalParserState=ahLocalParserState, prodrev=prodrev, ahFramePeriodEventTotal=ahFramePeriodEventTotal, coreStatusOnly=coreStatusOnly, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portMacAddress=portMacAddress, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, manufdate=manufdate, extended6=extended6, sysDateTime=sysDateTime, txPausePkts=txPausePkts, enableSNMPv3Function=enableSNMPv3Function, customertag=customertag, dhcpSubnetmask=dhcpSubnetmask, nmmSecureMode=nmmSecureMode, portIngressRateDropOrPause=portIngressRateDropOrPause, prodtype=prodtype, userIndex=userIndex, ingressPolicingType=ingressPolicingType, ahRemoteMuxState=ahRemoteMuxState, extended1=extended1, omnitronSFPGroup=omnitronSFPGroup, macAddr=macAddr, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ahErroredFrameThreshold=ahErroredFrameThreshold, modLM80volts=modLM80volts, vlanPri=vlanPri, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, txCollisions=txCollisions, managementModule=managementModule, modchassnum=modchassnum, rxCRCAlignErrors=rxCRCAlignErrors, syscon=syscon, serialnum=serialnum, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, dhcpGateway=dhcpGateway, ahRemoteLinkFlags=ahRemoteLinkFlags, rxGoodPkts=rxGoodPkts, ostProtocolStatusIndex=ostProtocolStatusIndex, rxOctets=rxOctets, portvlanidentifier=portvlanidentifier, rxErrorPkts=rxErrorPkts, ahRemoteOUI=ahRemoteOUI, dhcpIpAddr=dhcpIpAddr, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portnum=portnum, modname=modname, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, modtagsubstitution=modtagsubstitution, modmanufdate=modmanufdate, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, traphost5=traphost5, rxJabbers=rxJabbers, rxFragments=rxFragments, traphost8=traphost8, enableSNMPFunction=enableSNMPFunction, portSfpVendorName=portSfpVendorName, softrev=softrev, portSpeed=portSpeed, traphost3=traphost3, txGoodPkts=txGoodPkts, modLM80misc=modLM80misc, muxGroupDefaults=muxGroupDefaults, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modextfeaturebits=modextfeaturebits, portLinkState=portLinkState, modHwRev=modHwRev, gateway2=gateway2, modulename=modulename, gateway=gateway, ahRemoteMode=ahRemoteMode, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, snmpv3UserType=snmpv3UserType, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, chassistype=chassistype, modvlanTableClear=modvlanTableClear, serialpass=serialpass, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, index=index, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portSFPEntry=portSFPEntry, ostProtocolStatusTable=ostProtocolStatusTable, portSfpVcc=portSfpVcc, ostProtocolStatusEntry=ostProtocolStatusEntry, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, switchstat=switchstat, txDeferedTransmit=txDeferedTransmit, enhancedchassisTable=enhancedchassisTable, omnitronProducts=omnitronProducts, ostProtocolStatusState=ostProtocolStatusState, portEgressRate=portEgressRate, validityflag=validityflag, port6Membership=port6Membership, portStatsTable=portStatsTable, keepAliveInterval=keepAliveInterval, txUnicastPkts=txUnicastPkts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, omnitronGroup=omnitronGroup, omnitronMIB=omnitronMIB, chassisname=chassisname, rxSymbolErrors=rxSymbolErrors, ahEnabled=ahEnabled, ahErroredFrameWindow=ahErroredFrameWindow, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxOctets64=rxOctets64, portcanonicalformatIndicator=portcanonicalformatIndicator, vlanidentifier=vlanidentifier, modprodrev=modprodrev, port3Membership=port3Membership, modFpgaRev=modFpgaRev, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, txMultipleCollision=txMultipleCollision, portStatsClear=portStatsClear, nmmCfgState=nmmCfgState, ledstat=ledstat, rxDropPkts=rxDropPkts, port4Membership=port4Membership, nmmOAMmgmtMode=nmmOAMmgmtMode, traphost2=traphost2, modswbuildnum=modswbuildnum, portSfpRxPower=portSfpRxPower, txOctets64=txOctets64, ipaddr2EVCassociation=ipaddr2EVCassociation, port2Membership=port2Membership, txLateCollision=txLateCollision, telnetpass=telnetpass, rxPackets65to127=rxPackets65to127, wrswitch=wrswitch, extended3=extended3, traphost7=traphost7, portState=portState, rxPackets512to1023=rxPackets512to1023, portingresssecurity=portingresssecurity, txErrorPkts=txErrorPkts, txBroadcastPkts=txBroadcastPkts, rxFCSErrors=rxFCSErrors, rxOversizePkts=rxOversizePkts, mychassnum=mychassnum, servicetag=servicetag, rxPackets128to255=rxPackets128to255, portStatsEntry=portStatsEntry, chassisnum=chassisnum, subnetmask2=subnetmask2, dhcpPortNumber=dhcpPortNumber, rxUndersizePkts=rxUndersizePkts, cpuVoltageOut=cpuVoltageOut, portSfpVendorSerialNumber=portSfpVendorSerialNumber, enableSNMPWrites=enableSNMPWrites, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ipaddrEVCassociation=ipaddrEVCassociation, chassisTable=chassisTable, moduleCount=moduleCount, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, extended4=extended4, portSfpTemperature=portSfpTemperature, nmmIpProtocolState=nmmIpProtocolState, txDroppedEvents=txDroppedEvents, rxBroadcastPkts=rxBroadcastPkts, ahRemoteLinkPort=ahRemoteLinkPort, rxPackets64=rxPackets64, userEntry=userEntry)
mibBuilder.exportSymbols("OMNITRON-MIB", modreset=modreset, omnitronGroups=omnitronGroups, moduleMgtCfgEntry=moduleMgtCfgEntry, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, portpriority=portpriority, modulePortsTable=modulePortsTable, portAHEntry=portAHEntry, modLM80currents=modLM80currents, portegresspolicy=portegresspolicy, prodAgent=prodAgent, moduleTable=moduleTable, txMulticastPkts=txMulticastPkts, ahLocalMuxState=ahLocalMuxState, portAHTable=portAHTable, bootpEnable=bootpEnable, mmname=mmname, vlanservicetag=vlanservicetag, portSfpBiasCurrent=portSfpBiasCurrent, ahLocalLinkFlags=ahLocalLinkFlags, nmmSecureConnState=nmmSecureConnState, modnumports=modnumports, ahLpbkMode=ahLpbkMode, portSFPpageA0=portSFPpageA0, modenable802dot1qProcessing=modenable802dot1qProcessing, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxMulticastPkts=rxMulticastPkts, portSfpDateCode=portSfpDateCode, omnitronCompliances=omnitronCompliances, chassisEntry=chassisEntry, txSingleCollision=txSingleCollision, ostProtocoManagementPort=ostProtocoManagementPort, snmpTrapType=snmpTrapType, dhcpTagVid=dhcpTagVid, portAccessType=portAccessType, portSfpVendorPartNumber=portSfpVendorPartNumber, modprodtype=modprodtype, portIngressRateCBS=portIngressRateCBS, txExcessiveCollision=txExcessiveCollision, tftpFileName=tftpFileName, modExpSoftwareRev=modExpSoftwareRev, portFwdCpuList=portFwdCpuList, modulePortsEntry=modulePortsEntry, ahFrameErrorEventTotal=ahFrameErrorEventTotal, txDropPkts=txDropPkts, tftpServerIpAddress=tftpServerIpAddress, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, rxPausePkts=rxPausePkts, enabledFunctions=enabledFunctions, snmpv3PrivPassword=snmpv3PrivPassword, modPcbRev=modPcbRev, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, vlanIdOst=vlanIdOst, ahLocalMode=ahLocalMode, userTable=userTable, slaveTraps=slaveTraps)
