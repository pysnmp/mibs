...
OstPortNumber, OstVlanId, OstPortList, omnitron, OstModeType, icAgent = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortNumber", "OstVlanId", "OstPortList", "omnitron", "OstModeType", "icAgent")
...
mibBuilder.exportSymbols("OMNITRON-MIB", readCommunity=readCommunity, omnitronCompliance=omnitronCompliance, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, slaveTraps=slaveTraps, ahClearStatistics=ahClearStatistics, ostProtocolStatusIndex=ostProtocolStatusIndex, index=index, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, snmpTrapType=snmpTrapType, rxCRCAlignErrors=rxCRCAlignErrors, modchasstype=modchasstype, userTable=userTable, chassis=chassis, moduleTable=moduleTable, dhcpPortNumber=dhcpPortNumber, ahLocalSupportVar=ahLocalSupportVar, ahLocalLinkFlags=ahLocalLinkFlags, portEgressQosPolicy=portEgressQosPolicy, txOctets64=txOctets64, ahLpbkMode=ahLpbkMode, modExpLedStatus=modExpLedStatus, portSFPEntry=portSFPEntry, ahEnabled=ahEnabled, defaultForwardingMap=defaultForwardingMap, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, rxFragments=rxFragments, keepAliveInterval=keepAliveInterval, modextfeaturebits=modextfeaturebits, enableSNMPv3Function=enableSNMPv3Function, nmmSecureMode=nmmSecureMode, chassisEntry=chassisEntry, dhcpGateway=dhcpGateway, moduleVLANTable=moduleVLANTable, portStatsEntry=portStatsEntry, modchassname=modchassname, cpuTemperature=cpuTemperature, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portL2CPmgntProcessing=portL2CPmgntProcessing, portSFPstatus=portSFPstatus, modPcbRev=modPcbRev, portAHTable=portAHTable, customertag=customertag, txExcessiveCollision=txExcessiveCollision, ostProtocolStatusEntry=ostProtocolStatusEntry, portcanonicalformatIndicator=portcanonicalformatIndicator, resetmod=resetmod, ahRemoteOUI=ahRemoteOUI, modchassnum=modchassnum, ahErroredFrameWindow=ahErroredFrameWindow, moduleVLANEntry=moduleVLANEntry, slaveTrapsForward=slaveTrapsForward, portMacAddress=portMacAddress, rxGoodPkts=rxGoodPkts, gateway=gateway, selfSlot=selfSlot, sysloc=sysloc, portingresssecurity=portingresssecurity, modRestoreFactoryDefaults=modRestoreFactoryDefaults, traphost6=traphost6, partnum=partnum, moduleMgtCfgEntry=moduleMgtCfgEntry, ostProtocoManagementPort=ostProtocoManagementPort, tftpEnable=tftpEnable, rxJabbers=rxJabbers, modulename=modulename, enableSNMPFunction=enableSNMPFunction, rxOctets=rxOctets, serialnum=serialnum, ahFrameErrorEventTotal=ahFrameErrorEventTotal, tftpFileName=tftpFileName, rxSymbolErrors=rxSymbolErrors, rxPackets512to1023=rxPackets512to1023, telnetpass=telnetpass, validityflag=validityflag, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portmlistcriteria=portmlistcriteria, traphost7=traphost7, rxPackets65to127=rxPackets65to127, vlanIdOst=vlanIdOst, portSfpRxPower=portSfpRxPower, ahFramePeriodEventTotal=ahFramePeriodEventTotal, modreset=modreset, ipaddr2EVCassociation=ipaddr2EVCassociation, rxPackets256to511=rxPackets256to511, portSFPpageA2=portSFPpageA2, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, rxUndersizePkts=rxUndersizePkts, txGoodPkts=txGoodPkts, modprodrev=modprodrev, extended2=extended2, sysDateTime=sysDateTime, port1Membership=port1Membership, snmpv3SecurityLevel=snmpv3SecurityLevel, ahRemoteMuxState=ahRemoteMuxState, portnum=portnum, modnumports=modnumports, modmanufdate=modmanufdate, ostEnvironmentalTemperature=ostEnvironmentalTemperature, rxPackets1024to1518=rxPackets1024to1518, nmmIpProtocolState=nmmIpProtocolState, omnitronSFPGroup=omnitronSFPGroup, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, modExpPartNumber=modExpPartNumber, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, subnetmask=subnetmask, modvlanTableClear=modvlanTableClear, txUnicastPkts=txUnicastPkts, vlanidentifier=vlanidentifier, rxOctets64=rxOctets64, rxErrorPkts=rxErrorPkts, portSfpTxPower=portSfpTxPower, cnodeCIR=cnodeCIR, modulePortsTable=modulePortsTable, rxAlignmentErrors=rxAlignmentErrors, txLateCollision=txLateCollision, snmpv3AuthPassword=snmpv3AuthPassword, gateway2=gateway2, portIngressRate=portIngressRate, ostProtocolStatusTable=ostProtocolStatusTable, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, chassisnum=chassisnum, portFwdCpuList=portFwdCpuList, ahErroredFrameThreshold=ahErroredFrameThreshold, moduleEntry=moduleEntry, portLinkState=portLinkState, modslotnum=modslotnum, ahCriticalEventMode=ahCriticalEventMode, modserialnum=modserialnum, omnitronProducts=omnitronProducts, omnitronGroup=omnitronGroup, ipAddr2=ipAddr2, modprodtype=modprodtype, managementModule=managementModule, ahRemoteParserState=ahRemoteParserState, portSfpVcc=portSfpVcc, capsMask=capsMask, nmmCfgState=nmmCfgState, ledstat=ledstat, ostProtocolStatusType=ostProtocolStatusType, modExpSoftwareRev=modExpSoftwareRev, PYSNMP_MODULE_ID=omnitronMIB, mychassnum=mychassnum, portSfpTemperature=portSfpTemperature, nmmIpDisabled=nmmIpDisabled, portegresspolicy=portegresspolicy, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, slotnum=slotnum, portSfpVendorPartNumber=portSfpVendorPartNumber, modLM80currents=modLM80currents, trapSrcIpSelect=trapSrcIpSelect, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, macAddr=macAddr, ahLocalMode=ahLocalMode, txErrorPkts=txErrorPkts, portEgressRate=portEgressRate, portSpeed=portSpeed, txBroadcastPkts=txBroadcastPkts, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, modname=modname, nmmOAMmgmtMode=nmmOAMmgmtMode, dhcpIpAddr=dhcpIpAddr, modcommitVLANchanges=modcommitVLANchanges, txCollisions=txCollisions, ostProtocolStatusState=ostProtocolStatusState, txDeferedTransmit=txDeferedTransmit, modLM80volts=modLM80volts, ahLocalLpbkTimeout=ahLocalLpbkTimeout, tftpServerIpAddress=tftpServerIpAddress, syscon=syscon, moduleMgtCfgTable=moduleMgtCfgTable, port3Membership=port3Membership, portStatsClear=portStatsClear, omnitronMIB=omnitronMIB, ftppasswrd=ftppasswrd, portFwdCpu=portFwdCpu, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portDuplex=portDuplex, modeType=modeType, ahRemoteMode=ahRemoteMode, omnitronConformance=omnitronConformance, modHwRev=modHwRev, txDroppedEvents=txDroppedEvents, vlanPri=vlanPri, ipaddrEVCassociation=ipaddrEVCassociation, portSfpVendorSerialNumber=portSfpVendorSerialNumber, extended5=extended5, ahLocalMuxState=ahLocalMuxState, snmpv3UserType=snmpv3UserType, cpuVoltageOut=cpuVoltageOut, portpriority=portpriority, userIndex=userIndex, portSfpBiasCurrent=portSfpBiasCurrent, portSfpVendorName=portSfpVendorName, ahLocalOUI=ahLocalOUI, writeCommunity=writeCommunity, modportvlan=modportvlan, enabledFunctions=enabledFunctions, rxFCSErrors=rxFCSErrors, switchstat=switchstat, omnitronGroups=omnitronGroups, rxMulticastPkts=rxMulticastPkts, portIngressRateCBS=portIngressRateCBS, chassisTable=chassisTable, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxBroadcastPkts=rxBroadcastPkts, ipAddr=ipAddr, traphost2=traphost2, txOctets=txOctets, sysAdminStatus=sysAdminStatus, portvlanidentifier=portvlanidentifier, modenable802dot1qProcessing=modenable802dot1qProcessing, userEntry=userEntry, traphost1=traphost1, extended4=extended4, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modtagsubstitution=modtagsubstitution, modswbuildnum=modswbuildnum, rxPackets64=rxPackets64, chassisname=chassisname, modulePortsEntry=modulePortsEntry, traphost4=traphost4, servicetag=servicetag, mmname=mmname, modFpgaRev=modFpgaRev, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, enableSNMPWrites=enableSNMPWrites, portStatsTable=portStatsTable, rxTotalPkts=rxTotalPkts, txMultipleCollision=txMultipleCollision, ahLocalParserState=ahLocalParserState, extended6=extended6, txMulticastPkts=txMulticastPkts, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, enhancedchassisTable=enhancedchassisTable, portAccessType=portAccessType, dhcpSubnetmask=dhcpSubnetmask, cpuVoltageIn=cpuVoltageIn, rxPausePkts=rxPausePkts, port6Membership=port6Membership, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, cnodeControl=cnodeControl, extended1=extended1, extended3=extended3, modsoftrev=modsoftrev)
mibBuilder.exportSymbols("OMNITRON-MIB", traphost3=traphost3, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, port5Membership=port5Membership, portSfpBitRate=portSfpBitRate, portSFPpageA0=portSFPpageA0, rxUnicastPkts=rxUnicastPkts, softrev=softrev, snmpv3UserName=snmpv3UserName, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, moduleCount=moduleCount, ahRemoteLinkFlags=ahRemoteLinkFlags, prodtype=prodtype, rxPackets128to255=rxPackets128to255, vlanservicetag=vlanservicetag, modpartnum=modpartnum, port2Membership=port2Membership, bootpEnable=bootpEnable, modLM80misc=modLM80misc, traphost5=traphost5, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portSfpDateCode=portSfpDateCode, ingressPolicingType=ingressPolicingType, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, serialpass=serialpass, portIngressRateDropOrPause=portIngressRateDropOrPause, ahRemoteSupportVar=ahRemoteSupportVar, prodAgent=prodAgent, txDropPkts=txDropPkts, port4Membership=port4Membership, traphost8=traphost8, ahTransmissionRate=ahTransmissionRate, snmpv3PrivPassword=snmpv3PrivPassword, rxDropPkts=rxDropPkts, muxGroupDefaults=muxGroupDefaults, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, prodrev=prodrev, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portState=portState, subnetmask2=subnetmask2, portAHEntry=portAHEntry, wrswitch=wrswitch, chassistype=chassistype, dhcpTagVid=dhcpTagVid, portSFPTable=portSFPTable, txSingleCollision=txSingleCollision, omnitronCompliances=omnitronCompliances, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, rxOversizePkts=rxOversizePkts, slaveWrite=slaveWrite, manufdate=manufdate, txPausePkts=txPausePkts, coreStatusOnly=coreStatusOnly, ahRemoteLinkPort=ahRemoteLinkPort, nmmSecureConnState=nmmSecureConnState, ahCriticalEventTrapList=ahCriticalEventTrapList)
