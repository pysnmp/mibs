...
OstModeType, omnitron, icAgent, OstPortNumber, OstPortList, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "omnitron", "icAgent", "OstPortNumber", "OstPortList", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, readCommunity=readCommunity, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahLocalMuxState=ahLocalMuxState, userEntry=userEntry, ahClearStatistics=ahClearStatistics, portL2CPmgntProcessing=portL2CPmgntProcessing, subnetmask=subnetmask, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ostProtocolStatusIndex=ostProtocolStatusIndex, rxPackets64=rxPackets64, ostProtocolStatusState=ostProtocolStatusState, partnum=partnum, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, txMulticastPkts=txMulticastPkts, moduleVLANEntry=moduleVLANEntry, capsMask=capsMask, ahCriticalEventMode=ahCriticalEventMode, sysloc=sysloc, portMacAddress=portMacAddress, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, cpuVoltageIn=cpuVoltageIn, modslotnum=modslotnum, rxPackets512to1023=rxPackets512to1023, portnum=portnum, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, traphost3=traphost3, omnitronMIB=omnitronMIB, gateway2=gateway2, wrswitch=wrswitch, ahTransmissionRate=ahTransmissionRate, cnodeCIR=cnodeCIR, txDroppedEvents=txDroppedEvents, PYSNMP_MODULE_ID=omnitronMIB, snmpv3PrivPassword=snmpv3PrivPassword, portvlanidentifier=portvlanidentifier, rxPausePkts=rxPausePkts, portEgressQosPolicy=portEgressQosPolicy, dhcptftpServerIpAddress=dhcptftpServerIpAddress, txCollisions=txCollisions, selfSlot=selfSlot, moduleTable=moduleTable, snmpv3SecurityLevel=snmpv3SecurityLevel, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modLM80misc=modLM80misc, userIndex=userIndex, snmpv3UserName=snmpv3UserName, ingressPolicingType=ingressPolicingType, rxOctets64=rxOctets64, portSfpVendorName=portSfpVendorName, portSfpTxPower=portSfpTxPower, snmpv3UserType=snmpv3UserType, moduleMgtCfgTable=moduleMgtCfgTable, modExpSoftwareRev=modExpSoftwareRev, omnitronCompliance=omnitronCompliance, bootpEnable=bootpEnable, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, chassisEntry=chassisEntry, modcommitVLANchanges=modcommitVLANchanges, userTable=userTable, snmpv3AuthPassword=snmpv3AuthPassword, portingresssecurity=portingresssecurity, rxFragments=rxFragments, portSfpBiasCurrent=portSfpBiasCurrent, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modserialnum=modserialnum, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portEgressRate=portEgressRate, trapSrcIpSelect=trapSrcIpSelect, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, modpartnum=modpartnum, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ostEnvironmentalTemperature=ostEnvironmentalTemperature, modeType=modeType, ahRemoteLinkFlags=ahRemoteLinkFlags, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portStatsClear=portStatsClear, txErrorPkts=txErrorPkts, port5Membership=port5Membership, subnetmask2=subnetmask2, portSfpVendorPartNumber=portSfpVendorPartNumber, slotnum=slotnum, rxJabbers=rxJabbers, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modtagsubstitution=modtagsubstitution, ahLocalOUI=ahLocalOUI, enabledFunctions=enabledFunctions, chassis=chassis, ahLocalParserState=ahLocalParserState, modLM80volts=modLM80volts, port6Membership=port6Membership, portStatsTable=portStatsTable, modenable802dot1qProcessing=modenable802dot1qProcessing, manufdate=manufdate, dhcpPortNumber=dhcpPortNumber, modFpgaRev=modFpgaRev, portDuplex=portDuplex, ahRemoteSupportVar=ahRemoteSupportVar, mychassnum=mychassnum, ostProtocolStatusEntry=ostProtocolStatusEntry, nmmCfgState=nmmCfgState, nmmOAMmgmtMode=nmmOAMmgmtMode, traphost8=traphost8, extended3=extended3, defaultForwardingMap=defaultForwardingMap, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, macAddr=macAddr, extended6=extended6, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, extended2=extended2, snmpTrapType=snmpTrapType, txSingleCollision=txSingleCollision, ahRemoteLinkPort=ahRemoteLinkPort, traphost4=traphost4, ahRemoteParserState=ahRemoteParserState, nmmSecureMode=nmmSecureMode, extended4=extended4, rxMulticastPkts=rxMulticastPkts, modHwRev=modHwRev, vlanIdOst=vlanIdOst, ahLocalSupportVar=ahLocalSupportVar, omnitronSFPGroup=omnitronSFPGroup, sysDateTime=sysDateTime, slaveTrapsForward=slaveTrapsForward, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahRemoteMuxState=ahRemoteMuxState, modchassnum=modchassnum, omnitronConformance=omnitronConformance, portegresspolicy=portegresspolicy, ahErroredFrameThreshold=ahErroredFrameThreshold, txPausePkts=txPausePkts, ahLpbkMode=ahLpbkMode, modnumports=modnumports, moduleEntry=moduleEntry, modswbuildnum=modswbuildnum, ostProtocolStatusTable=ostProtocolStatusTable, rxPackets256to511=rxPackets256to511, mmname=mmname, omnitronGroups=omnitronGroups, ahCriticalEventTrapList=ahCriticalEventTrapList, modLM80currents=modLM80currents, rxOctets=rxOctets, chassistype=chassistype, omnitronGroup=omnitronGroup, switchstat=switchstat, moduleMgtCfgEntry=moduleMgtCfgEntry, rxDropPkts=rxDropPkts, txOctets64=txOctets64, modreset=modreset, servicetag=servicetag, dhcpIpAddr=dhcpIpAddr, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, dhcpGateway=dhcpGateway, slaveTraps=slaveTraps, portStatsEntry=portStatsEntry, portLinkState=portLinkState, rxErrorPkts=rxErrorPkts, modchassname=modchassname, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modportvlan=modportvlan, traphost5=traphost5, ahLocalMode=ahLocalMode, portSfpDateCode=portSfpDateCode, txGoodPkts=txGoodPkts, port4Membership=port4Membership, portSfpTemperature=portSfpTemperature, rxGoodPkts=rxGoodPkts, txMultipleCollision=txMultipleCollision, portSfpVcc=portSfpVcc, enhancedchassisTable=enhancedchassisTable, ahErroredFrameWindow=ahErroredFrameWindow, ipAddr=ipAddr, modulename=modulename, cnodeControl=cnodeControl, cpuTemperature=cpuTemperature, portFwdCpuList=portFwdCpuList, extended5=extended5, slaveWrite=slaveWrite, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modprodrev=modprodrev, portSFPEntry=portSFPEntry, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ahEnabled=ahEnabled, portSFPTable=portSFPTable, rxUnicastPkts=rxUnicastPkts, portSFPpageA0=portSFPpageA0, modchasstype=modchasstype, port2Membership=port2Membership, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portFwdCpu=portFwdCpu, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, omnitronCompliances=omnitronCompliances, traphost7=traphost7, ostProtocoManagementPort=ostProtocoManagementPort, modsoftrev=modsoftrev, txOctets=txOctets, rxPackets65to127=rxPackets65to127, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portIngressRate=portIngressRate, txExcessiveCollision=txExcessiveCollision, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, tftpEnable=tftpEnable, rxBroadcastPkts=rxBroadcastPkts, syscon=syscon, portSFPpageA2=portSFPpageA2, portSFPstatus=portSFPstatus, customertag=customertag, nmmIpDisabled=nmmIpDisabled, ipaddr2EVCassociation=ipaddr2EVCassociation, telnetpass=telnetpass, gateway=gateway, modextfeaturebits=modextfeaturebits, ahLocalLpbkTimeout=ahLocalLpbkTimeout, softrev=softrev, enableSNMPWrites=enableSNMPWrites, traphost6=traphost6, ahLocalLinkFlags=ahLocalLinkFlags, rxPackets128to255=rxPackets128to255, prodtype=prodtype, managementModule=managementModule, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, txUnicastPkts=txUnicastPkts, ftppasswrd=ftppasswrd, rxTotalPkts=rxTotalPkts, vlanPri=vlanPri, ipAddr2=ipAddr2, writeCommunity=writeCommunity, muxGroupDefaults=muxGroupDefaults, serialpass=serialpass, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, serialnum=serialnum, enableSNMPv3Function=enableSNMPv3Function, portAHTable=portAHTable, omnitronProducts=omnitronProducts, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, nmmSecureConnState=nmmSecureConnState, portSpeed=portSpeed, rxPackets1024to1518=rxPackets1024to1518, modExpPartNumber=modExpPartNumber, modExpLedStatus=modExpLedStatus, portState=portState, modPcbRev=modPcbRev, extended1=extended1, portSfpBitRate=portSfpBitRate, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxCRCAlignErrors=rxCRCAlignErrors, portAccessType=portAccessType, prodAgent=prodAgent, tftpServerIpAddress=tftpServerIpAddress, keepAliveInterval=keepAliveInterval, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn)
mibBuilder.exportSymbols("OMNITRON-MIB", modname=modname, moduleVLANTable=moduleVLANTable, index=index, ostProtocolStatusType=ostProtocolStatusType, resetmod=resetmod, nmmIpProtocolState=nmmIpProtocolState, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portcanonicalformatIndicator=portcanonicalformatIndicator, chassisnum=chassisnum, modulePortsTable=modulePortsTable, sysAdminStatus=sysAdminStatus, ahRemoteMode=ahRemoteMode, coreStatusOnly=coreStatusOnly, portAHEntry=portAHEntry, vlanservicetag=vlanservicetag, rxFCSErrors=rxFCSErrors, validityflag=validityflag, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, tftpFileName=tftpFileName, rxSymbolErrors=rxSymbolErrors, port1Membership=port1Membership, rxAlignmentErrors=rxAlignmentErrors, txDeferedTransmit=txDeferedTransmit, chassisTable=chassisTable, ipaddrEVCassociation=ipaddrEVCassociation, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portmlistcriteria=portmlistcriteria, ahRemoteOUI=ahRemoteOUI, enableSNMPFunction=enableSNMPFunction, traphost2=traphost2, vlanidentifier=vlanidentifier, port3Membership=port3Membership, modulePortsEntry=modulePortsEntry, ahFrameErrorEventTotal=ahFrameErrorEventTotal, traphost1=traphost1, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, prodrev=prodrev, ledstat=ledstat, txLateCollision=txLateCollision, dhcpTagVid=dhcpTagVid, txDropPkts=txDropPkts, modprodtype=modprodtype, rxOversizePkts=rxOversizePkts, moduleCount=moduleCount, portIngressRateCBS=portIngressRateCBS, modvlanTableClear=modvlanTableClear, modmanufdate=modmanufdate, chassisname=chassisname, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portIngressRateDropOrPause=portIngressRateDropOrPause, portpriority=portpriority, rxUndersizePkts=rxUndersizePkts, portSfpRxPower=portSfpRxPower, cpuVoltageOut=cpuVoltageOut, dhcpSubnetmask=dhcpSubnetmask, txBroadcastPkts=txBroadcastPkts)
