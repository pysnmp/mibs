...
OstPortList, OstModeType, OstPortNumber, icAgent, omnitron, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortList", "OstModeType", "OstPortNumber", "icAgent", "omnitron", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ostProtocoManagementPort=ostProtocoManagementPort, prodAgent=prodAgent, bootpEnable=bootpEnable, nmmIpDisabled=nmmIpDisabled, portSpeed=portSpeed, ahTransmissionRate=ahTransmissionRate, portSFPstatus=portSFPstatus, extended3=extended3, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portEgressRate=portEgressRate, rxDropPkts=rxDropPkts, rxPackets512to1023=rxPackets512to1023, ostProtocolStatusState=ostProtocolStatusState, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, tftpFileName=tftpFileName, moduleTable=moduleTable, cpuTemperature=cpuTemperature, tftpEnable=tftpEnable, switchstat=switchstat, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, customertag=customertag, enhancedchassisTable=enhancedchassisTable, rxAlignmentErrors=rxAlignmentErrors, prodtype=prodtype, ingressPolicingType=ingressPolicingType, managementModule=managementModule, rxJabbers=rxJabbers, modLM80currents=modLM80currents, nmmCfgState=nmmCfgState, portAHTable=portAHTable, portIngressRate=portIngressRate, ahRemoteParserState=ahRemoteParserState, mmname=mmname, ostProtocolStatusTable=ostProtocolStatusTable, resetmod=resetmod, portpriority=portpriority, modulePortsEntry=modulePortsEntry, userIndex=userIndex, omnitronCompliances=omnitronCompliances, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portAccessType=portAccessType, ostProtocolStatusType=ostProtocolStatusType, modvlanTableClear=modvlanTableClear, rxOctets64=rxOctets64, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, slaveTrapsForward=slaveTrapsForward, rxOctets=rxOctets, rxPackets1024to1518=rxPackets1024to1518, modExpLedStatus=modExpLedStatus, omnitronMIB=omnitronMIB, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modname=modname, rxSymbolErrors=rxSymbolErrors, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, chassis=chassis, wrswitch=wrswitch, moduleCount=moduleCount, modportvlan=modportvlan, modreset=modreset, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, nmmIpProtocolState=nmmIpProtocolState, nmmOAMmgmtMode=nmmOAMmgmtMode, txBroadcastPkts=txBroadcastPkts, modeType=modeType, portIngressRateCBS=portIngressRateCBS, modFpgaRev=modFpgaRev, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, rxGoodPkts=rxGoodPkts, rxPackets128to255=rxPackets128to255, ahLocalMuxState=ahLocalMuxState, cpuVoltageOut=cpuVoltageOut, muxGroupDefaults=muxGroupDefaults, rxFCSErrors=rxFCSErrors, traphost2=traphost2, modprodrev=modprodrev, moduleMgtCfgEntry=moduleMgtCfgEntry, keepAliveInterval=keepAliveInterval, txDroppedEvents=txDroppedEvents, txSingleCollision=txSingleCollision, manufdate=manufdate, modcommitVLANchanges=modcommitVLANchanges, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, traphost1=traphost1, txCollisions=txCollisions, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, enableSNMPFunction=enableSNMPFunction, ahCriticalEventMode=ahCriticalEventMode, portL2CPmgntProcessing=portL2CPmgntProcessing, ipAddr2=ipAddr2, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portSfpBitRate=portSfpBitRate, modprodtype=modprodtype, slaveWrite=slaveWrite, userTable=userTable, portSfpBiasCurrent=portSfpBiasCurrent, modextfeaturebits=modextfeaturebits, rxErrorPkts=rxErrorPkts, snmpv3PrivPassword=snmpv3PrivPassword, modExpSoftwareRev=modExpSoftwareRev, portSFPEntry=portSFPEntry, moduleVLANTable=moduleVLANTable, extended1=extended1, portSfpDateCode=portSfpDateCode, ahRemoteLinkFlags=ahRemoteLinkFlags, cnodeCIR=cnodeCIR, extended6=extended6, ahRemoteSupportVar=ahRemoteSupportVar, extended4=extended4, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, gateway=gateway, omnitronProducts=omnitronProducts, sysDateTime=sysDateTime, portFwdCpu=portFwdCpu, modnumports=modnumports, omnitronSFPGroup=omnitronSFPGroup, ipaddrEVCassociation=ipaddrEVCassociation, portState=portState, txExcessiveCollision=txExcessiveCollision, modsoftrev=modsoftrev, portEgressQosPolicy=portEgressQosPolicy, moduleVLANEntry=moduleVLANEntry, cnodeControl=cnodeControl, tftpServerIpAddress=tftpServerIpAddress, chassisEntry=chassisEntry, portSfpVendorPartNumber=portSfpVendorPartNumber, ipaddr2EVCassociation=ipaddr2EVCassociation, modcommitNMMCfgChanges=modcommitNMMCfgChanges, moduleMgtCfgTable=moduleMgtCfgTable, portIngressRateDropOrPause=portIngressRateDropOrPause, rxPackets64=rxPackets64, modulename=modulename, omnitronGroups=omnitronGroups, rxOversizePkts=rxOversizePkts, modchassnum=modchassnum, moduleEntry=moduleEntry, txDeferedTransmit=txDeferedTransmit, txGoodPkts=txGoodPkts, snmpv3UserType=snmpv3UserType, ostProtocolStatusEntry=ostProtocolStatusEntry, telnetpass=telnetpass, omnitronCompliance=omnitronCompliance, port3Membership=port3Membership, ipAddr=ipAddr, txMulticastPkts=txMulticastPkts, ahLocalLinkFlags=ahLocalLinkFlags, nmmSecureMode=nmmSecureMode, snmpv3UserName=snmpv3UserName, enableSNMPv3Function=enableSNMPv3Function, ahLocalMode=ahLocalMode, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahLocalSupportVar=ahLocalSupportVar, modmanufdate=modmanufdate, port4Membership=port4Membership, portSfpTemperature=portSfpTemperature, chassisnum=chassisnum, ostEnvironmentalTemperature=ostEnvironmentalTemperature, capsMask=capsMask, portnum=portnum, modenable802dot1qProcessing=modenable802dot1qProcessing, modLM80volts=modLM80volts, txOctets=txOctets, sysAdminStatus=sysAdminStatus, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxUndersizePkts=rxUndersizePkts, ahRemoteOUI=ahRemoteOUI, vlanidentifier=vlanidentifier, ahCriticalEventTrapList=ahCriticalEventTrapList, txMultipleCollision=txMultipleCollision, portSFPpageA2=portSFPpageA2, portSFPTable=portSFPTable, rxBroadcastPkts=rxBroadcastPkts, rxFragments=rxFragments, selfSlot=selfSlot, modHwRev=modHwRev, modslotnum=modslotnum, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, servicetag=servicetag, prodrev=prodrev, serialpass=serialpass, ostProtocolStatusIndex=ostProtocolStatusIndex, ahErroredFrameWindow=ahErroredFrameWindow, serialnum=serialnum, ledstat=ledstat, ahLocalParserState=ahLocalParserState, rxUnicastPkts=rxUnicastPkts, portFwdCpuList=portFwdCpuList, txPausePkts=txPausePkts, slaveTraps=slaveTraps, txUnicastPkts=txUnicastPkts, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ahRemoteMode=ahRemoteMode, ahClearStatistics=ahClearStatistics, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, traphost8=traphost8, portMacAddress=portMacAddress, enableSNMPWrites=enableSNMPWrites, modExpPartNumber=modExpPartNumber, ahFrameErrorEventTotal=ahFrameErrorEventTotal, subnetmask=subnetmask, ahLocalOUI=ahLocalOUI, vlanservicetag=vlanservicetag, txOctets64=txOctets64, modswbuildnum=modswbuildnum, vlanPri=vlanPri, omnitronConformance=omnitronConformance, modulePortsTable=modulePortsTable, defaultForwardingMap=defaultForwardingMap, portAHEntry=portAHEntry, traphost3=traphost3, ahRemoteLinkPort=ahRemoteLinkPort, subnetmask2=subnetmask2, modchasstype=modchasstype, rxPackets256to511=rxPackets256to511, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portSfpVcc=portSfpVcc, portLinkState=portLinkState, txDropPkts=txDropPkts, ahEnabled=ahEnabled, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portStatsTable=portStatsTable, portingresssecurity=portingresssecurity, modserialnum=modserialnum, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, macAddr=macAddr, ahErroredFrameThreshold=ahErroredFrameThreshold, chassistype=chassistype, dhcpSubnetmask=dhcpSubnetmask, modchassname=modchassname, softrev=softrev, rxPackets65to127=rxPackets65to127, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, traphost6=traphost6, modtagsubstitution=modtagsubstitution, nmmSecureSlaveSlot=nmmSecureSlaveSlot, readCommunity=readCommunity, ftppasswrd=ftppasswrd, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, traphost7=traphost7, portStatsEntry=portStatsEntry, modPcbRev=modPcbRev, port5Membership=port5Membership, rxCRCAlignErrors=rxCRCAlignErrors, chassisname=chassisname, portcanonicalformatIndicator=portcanonicalformatIndicator, enabledFunctions=enabledFunctions, ahLpbkMode=ahLpbkMode, port1Membership=port1Membership, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, mychassnum=mychassnum, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status)
mibBuilder.exportSymbols("OMNITRON-MIB", dhcpPortNumber=dhcpPortNumber, portvlanidentifier=portvlanidentifier, validityflag=validityflag, omnitronGroup=omnitronGroup, portStatsClear=portStatsClear, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, port2Membership=port2Membership, portmlistcriteria=portmlistcriteria, chassisTable=chassisTable, dhcpTagVid=dhcpTagVid, portegresspolicy=portegresspolicy, userEntry=userEntry, syscon=syscon, rxTotalPkts=rxTotalPkts, writeCommunity=writeCommunity, port6Membership=port6Membership, extended5=extended5, modLM80misc=modLM80misc, portSfpTxPower=portSfpTxPower, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portSfpRxPower=portSfpRxPower, portSFPpageA0=portSFPpageA0, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, snmpv3SecurityLevel=snmpv3SecurityLevel, modpartnum=modpartnum, vlanIdOst=vlanIdOst, partnum=partnum, cpuVoltageIn=cpuVoltageIn, nmmSecureConnState=nmmSecureConnState, traphost5=traphost5, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, snmpv3AuthPassword=snmpv3AuthPassword, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, gateway2=gateway2, traphost4=traphost4, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, txErrorPkts=txErrorPkts, portDuplex=portDuplex, trapSrcIpSelect=trapSrcIpSelect, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ahRemoteMuxState=ahRemoteMuxState, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, sysloc=sysloc, dhcpGateway=dhcpGateway, index=index, slotnum=slotnum, txLateCollision=txLateCollision, rxMulticastPkts=rxMulticastPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, coreStatusOnly=coreStatusOnly, dhcpIpAddr=dhcpIpAddr, rxPausePkts=rxPausePkts, portSfpVendorName=portSfpVendorName, snmpTrapType=snmpTrapType, extended2=extended2, PYSNMP_MODULE_ID=omnitronMIB)
