...
OstModeType, omnitron, OstPortList, OstPortNumber, OstVlanId, icAgent = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "omnitron", "OstPortList", "OstPortNumber", "OstVlanId", "icAgent")
...
mibBuilder.exportSymbols("OMNITRON-MIB", readCommunity=readCommunity, omnitronConformance=omnitronConformance, moduleCount=moduleCount, tftpFileName=tftpFileName, modExpLedStatus=modExpLedStatus, traphost7=traphost7, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portFwdCpuList=portFwdCpuList, portnum=portnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, rxTotalPkts=rxTotalPkts, portIngressRateCBS=portIngressRateCBS, modmanufdate=modmanufdate, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ahFramePeriodEventTotal=ahFramePeriodEventTotal, modFpgaRev=modFpgaRev, rxOctets=rxOctets, portingresssecurity=portingresssecurity, portSfpVcc=portSfpVcc, nmmSecureSlaveSlot=nmmSecureSlaveSlot, slaveTrapsForward=slaveTrapsForward, modnumports=modnumports, txLateCollision=txLateCollision, modExpSoftwareRev=modExpSoftwareRev, txOctets=txOctets, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, modcommitVLANchanges=modcommitVLANchanges, portIngressRate=portIngressRate, snmpv3UserType=snmpv3UserType, nmmOAMmgmtMode=nmmOAMmgmtMode, modsoftrev=modsoftrev, macAddr=macAddr, modswbuildnum=modswbuildnum, cpuVoltageIn=cpuVoltageIn, userIndex=userIndex, cnodeControl=cnodeControl, snmpv3UserName=snmpv3UserName, omnitronSFPGroup=omnitronSFPGroup, traphost8=traphost8, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modLM80volts=modLM80volts, switchstat=switchstat, nmmIpProtocolState=nmmIpProtocolState, subnetmask2=subnetmask2, ahTransmissionRate=ahTransmissionRate, enableSNMPWrites=enableSNMPWrites, omnitronCompliances=omnitronCompliances, txMulticastPkts=txMulticastPkts, rxPackets512to1023=rxPackets512to1023, gateway2=gateway2, portStatsEntry=portStatsEntry, modchassnum=modchassnum, ahEnabled=ahEnabled, rxFCSErrors=rxFCSErrors, txOctets64=txOctets64, portStatsTable=portStatsTable, extended4=extended4, slaveWrite=slaveWrite, rxSymbolErrors=rxSymbolErrors, ahFrameErrorEventTotal=ahFrameErrorEventTotal, vlanPri=vlanPri, enabledFunctions=enabledFunctions, modname=modname, txSingleCollision=txSingleCollision, portpriority=portpriority, rxAlignmentErrors=rxAlignmentErrors, servicetag=servicetag, modslotnum=modslotnum, traphost4=traphost4, txBroadcastPkts=txBroadcastPkts, omnitronGroup=omnitronGroup, rxUnicastPkts=rxUnicastPkts, portSfpVendorPartNumber=portSfpVendorPartNumber, cpuTemperature=cpuTemperature, ahRemoteOUI=ahRemoteOUI, ahRemoteMode=ahRemoteMode, wrswitch=wrswitch, traphost3=traphost3, chassistype=chassistype, txDroppedEvents=txDroppedEvents, rxPausePkts=rxPausePkts, rxMulticastPkts=rxMulticastPkts, portStatsClear=portStatsClear, modtagsubstitution=modtagsubstitution, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahLocalOUI=ahLocalOUI, portSFPpageA0=portSFPpageA0, modExpPartNumber=modExpPartNumber, cnodeCIR=cnodeCIR, extended2=extended2, telnetpass=telnetpass, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, snmpv3PrivPassword=snmpv3PrivPassword, nmmSecureConnState=nmmSecureConnState, txMultipleCollision=txMultipleCollision, ahRemoteSupportVar=ahRemoteSupportVar, enhancedchassisTable=enhancedchassisTable, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modchassname=modchassname, managementModule=managementModule, chassisEntry=chassisEntry, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, txPausePkts=txPausePkts, portSfpTemperature=portSfpTemperature, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, modserialnum=modserialnum, txErrorPkts=txErrorPkts, omnitronGroups=omnitronGroups, enableSNMPv3Function=enableSNMPv3Function, omnitronProducts=omnitronProducts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, txDeferedTransmit=txDeferedTransmit, modeType=modeType, portSFPTable=portSFPTable, modenable802dot1qProcessing=modenable802dot1qProcessing, dhcpSubnetmask=dhcpSubnetmask, port2Membership=port2Membership, rxDropPkts=rxDropPkts, modulename=modulename, moduleVLANTable=moduleVLANTable, defaultForwardingMap=defaultForwardingMap, userTable=userTable, ahLocalSupportVar=ahLocalSupportVar, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, extended1=extended1, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, dhcpIpAddr=dhcpIpAddr, modpartnum=modpartnum, rxPackets65to127=rxPackets65to127, ahCriticalEventMode=ahCriticalEventMode, serialpass=serialpass, port1Membership=port1Membership, ahLocalLinkFlags=ahLocalLinkFlags, traphost5=traphost5, omnitronCompliance=omnitronCompliance, portSfpBitRate=portSfpBitRate, ostProtocolStatusTable=ostProtocolStatusTable, rxUndersizePkts=rxUndersizePkts, dhcpTagVid=dhcpTagVid, modvlanTableClear=modvlanTableClear, serialnum=serialnum, modulePortsTable=modulePortsTable, traphost2=traphost2, ahErroredFrameWindow=ahErroredFrameWindow, port6Membership=port6Membership, softrev=softrev, rxPackets1024to1518=rxPackets1024to1518, portSFPpageA2=portSFPpageA2, rxFragments=rxFragments, ahLocalParserState=ahLocalParserState, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ostProtocolStatusEntry=ostProtocolStatusEntry, rxCRCAlignErrors=rxCRCAlignErrors, nmmIpDisabled=nmmIpDisabled, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modcommitNMMCfgChanges=modcommitNMMCfgChanges, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, portSfpDateCode=portSfpDateCode, manufdate=manufdate, userEntry=userEntry, sysDateTime=sysDateTime, omnitronMIB=omnitronMIB, sysloc=sysloc, ipAddr=ipAddr, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, moduleEntry=moduleEntry, keepAliveInterval=keepAliveInterval, txDropPkts=txDropPkts, nmmCfgState=nmmCfgState, portegresspolicy=portegresspolicy, modLM80currents=modLM80currents, modportvlan=modportvlan, mmname=mmname, portFwdCpu=portFwdCpu, txUnicastPkts=txUnicastPkts, rxPackets128to255=rxPackets128to255, vlanIdOst=vlanIdOst, rxGoodPkts=rxGoodPkts, portmlistcriteria=portmlistcriteria, coreStatusOnly=coreStatusOnly, dhcpGateway=dhcpGateway, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, writeCommunity=writeCommunity, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, partnum=partnum, traphost1=traphost1, syscon=syscon, tftpEnable=tftpEnable, resetmod=resetmod, extended5=extended5, enableSNMPFunction=enableSNMPFunction, portLinkState=portLinkState, muxGroupDefaults=muxGroupDefaults, ostProtocolStatusType=ostProtocolStatusType, port3Membership=port3Membership, rxPackets64=rxPackets64, dhcptftpServerIpAddress=dhcptftpServerIpAddress, prodrev=prodrev, portEgressRate=portEgressRate, index=index, ahRemoteMuxState=ahRemoteMuxState, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, portvlanidentifier=portvlanidentifier, moduleVLANEntry=moduleVLANEntry, ahErroredFrameThreshold=ahErroredFrameThreshold, modulePortsEntry=modulePortsEntry, bootpEnable=bootpEnable, customertag=customertag, portIngressRateDropOrPause=portIngressRateDropOrPause, gateway=gateway, ostProtocolStatusIndex=ostProtocolStatusIndex, modLM80misc=modLM80misc, prodAgent=prodAgent, modextfeaturebits=modextfeaturebits, chassisTable=chassisTable, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ingressPolicingType=ingressPolicingType, slaveTraps=slaveTraps, portSfpBiasCurrent=portSfpBiasCurrent, nmmSecureMode=nmmSecureMode, ahLocalMode=ahLocalMode, ledstat=ledstat, trapSrcIpSelect=trapSrcIpSelect, ahRemoteParserState=ahRemoteParserState, ahRemoteLinkFlags=ahRemoteLinkFlags, ostProtocoManagementPort=ostProtocoManagementPort, chassisnum=chassisnum, txExcessiveCollision=txExcessiveCollision, modchasstype=modchasstype, portAHEntry=portAHEntry, portSfpVendorName=portSfpVendorName, rxPackets256to511=rxPackets256to511, portEgressQosPolicy=portEgressQosPolicy, rxJabbers=rxJabbers, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portL2CPmgntProcessing=portL2CPmgntProcessing, moduleMgtCfgEntry=moduleMgtCfgEntry, port4Membership=port4Membership, portSFPstatus=portSFPstatus, capsMask=capsMask, modHwRev=modHwRev, portState=portState, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, prodtype=prodtype, cpuVoltageOut=cpuVoltageOut, portDuplex=portDuplex, ahCriticalEventTrapList=ahCriticalEventTrapList, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, extended6=extended6, snmpv3AuthPassword=snmpv3AuthPassword)
mibBuilder.exportSymbols("OMNITRON-MIB", ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, sysAdminStatus=sysAdminStatus, vlanidentifier=vlanidentifier, moduleTable=moduleTable, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, port5Membership=port5Membership, moduleMgtCfgTable=moduleMgtCfgTable, portSfpTxPower=portSfpTxPower, tftpServerIpAddress=tftpServerIpAddress, chassis=chassis, rxOversizePkts=rxOversizePkts, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ftppasswrd=ftppasswrd, ipAddr2=ipAddr2, modprodrev=modprodrev, portAccessType=portAccessType, snmpv3SecurityLevel=snmpv3SecurityLevel, portMacAddress=portMacAddress, portSfpRxPower=portSfpRxPower, mychassnum=mychassnum, txCollisions=txCollisions, vlanservicetag=vlanservicetag, selfSlot=selfSlot, portSFPEntry=portSFPEntry, modPcbRev=modPcbRev, ipaddrEVCassociation=ipaddrEVCassociation, ahRemoteLinkPort=ahRemoteLinkPort, portAHTable=portAHTable, PYSNMP_MODULE_ID=omnitronMIB, ahClearStatistics=ahClearStatistics, slotnum=slotnum, rxBroadcastPkts=rxBroadcastPkts, portSpeed=portSpeed, txGoodPkts=txGoodPkts, traphost6=traphost6, rxErrorPkts=rxErrorPkts, rxOctets64=rxOctets64, extended3=extended3, subnetmask=subnetmask, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostProtocolStatusState=ostProtocolStatusState, modprodtype=modprodtype, ipaddr2EVCassociation=ipaddr2EVCassociation, modreset=modreset, validityflag=validityflag, ostEnvironmentalTemperature=ostEnvironmentalTemperature, chassisname=chassisname, ahLocalMuxState=ahLocalMuxState, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahLpbkMode=ahLpbkMode, portcanonicalformatIndicator=portcanonicalformatIndicator, snmpTrapType=snmpTrapType, dhcpPortNumber=dhcpPortNumber, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold)
