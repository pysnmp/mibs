...
OstModeType, omnitron, OstPortList, OstVlanId, OstPortNumber, icAgent = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "omnitron", "OstPortList", "OstVlanId", "OstPortNumber", "icAgent")
...
mibBuilder.exportSymbols("OMNITRON-MIB", port6Membership=port6Membership, ipAddr=ipAddr, vlanPri=vlanPri, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, keepAliveInterval=keepAliveInterval, omnitronCompliance=omnitronCompliance, omnitronProducts=omnitronProducts, extended3=extended3, ahRemoteLinkFlags=ahRemoteLinkFlags, rxPackets512to1023=rxPackets512to1023, snmpv3AuthPassword=snmpv3AuthPassword, modulename=modulename, modnumports=modnumports, extended1=extended1, ipaddrEVCassociation=ipaddrEVCassociation, modExpSoftwareRev=modExpSoftwareRev, bootpEnable=bootpEnable, portSfpBitRate=portSfpBitRate, cpuVoltageIn=cpuVoltageIn, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portLinkState=portLinkState, selfSlot=selfSlot, snmpv3SecurityLevel=snmpv3SecurityLevel, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portState=portState, moduleEntry=moduleEntry, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, txDroppedEvents=txDroppedEvents, cnodeCIR=cnodeCIR, ahErroredFrameThreshold=ahErroredFrameThreshold, txExcessiveCollision=txExcessiveCollision, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, txMultipleCollision=txMultipleCollision, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, nmmSecureConnState=nmmSecureConnState, dhcpGateway=dhcpGateway, vlanidentifier=vlanidentifier, enableSNMPv3Function=enableSNMPv3Function, snmpv3PrivPassword=snmpv3PrivPassword, rxDropPkts=rxDropPkts, ahErroredFrameWindow=ahErroredFrameWindow, txCollisions=txCollisions, ahRemoteSupportVar=ahRemoteSupportVar, ahLpbkMode=ahLpbkMode, slaveWrite=slaveWrite, rxSymbolErrors=rxSymbolErrors, modchasstype=modchasstype, enabledFunctions=enabledFunctions, snmpv3UserType=snmpv3UserType, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portSfpRxPower=portSfpRxPower, txDeferedTransmit=txDeferedTransmit, chassisnum=chassisnum, portSfpTemperature=portSfpTemperature, enhancedchassisTable=enhancedchassisTable, muxGroupDefaults=muxGroupDefaults, txDropPkts=txDropPkts, modHwRev=modHwRev, userTable=userTable, dhcpPortNumber=dhcpPortNumber, modportvlan=modportvlan, rxFCSErrors=rxFCSErrors, nmmIpDisabled=nmmIpDisabled, ledstat=ledstat, rxPackets128to255=rxPackets128to255, modcommitNMMCfgChanges=modcommitNMMCfgChanges, txSingleCollision=txSingleCollision, traphost7=traphost7, subnetmask=subnetmask, traphost3=traphost3, txOctets64=txOctets64, txUnicastPkts=txUnicastPkts, rxJabbers=rxJabbers, traphost8=traphost8, moduleMgtCfgEntry=moduleMgtCfgEntry, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, vlanservicetag=vlanservicetag, portAHEntry=portAHEntry, omnitronGroups=omnitronGroups, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portFwdCpuList=portFwdCpuList, modpartnum=modpartnum, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxMulticastPkts=rxMulticastPkts, modprodtype=modprodtype, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, managementModule=managementModule, ostProtocolStatusEntry=ostProtocolStatusEntry, rxUndersizePkts=rxUndersizePkts, modRestoreFactoryDefaults=modRestoreFactoryDefaults, slaveTraps=slaveTraps, portSFPpageA0=portSFPpageA0, omnitronCompliances=omnitronCompliances, modvlanTableClear=modvlanTableClear, rxOctets=rxOctets, ahRemoteOUI=ahRemoteOUI, chassisname=chassisname, extended4=extended4, omnitronConformance=omnitronConformance, rxPackets65to127=rxPackets65to127, txPausePkts=txPausePkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, serialnum=serialnum, modsoftrev=modsoftrev, subnetmask2=subnetmask2, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, manufdate=manufdate, enableSNMPFunction=enableSNMPFunction, moduleTable=moduleTable, cpuTemperature=cpuTemperature, ahEnabled=ahEnabled, portSFPTable=portSFPTable, portingresssecurity=portingresssecurity, gateway=gateway, ipAddr2=ipAddr2, macAddr=macAddr, portL2CPmgntProcessing=portL2CPmgntProcessing, chassistype=chassistype, dhcpSubnetmask=dhcpSubnetmask, portnum=portnum, tftpEnable=tftpEnable, ahRemoteMuxState=ahRemoteMuxState, portEgressQosPolicy=portEgressQosPolicy, txMulticastPkts=txMulticastPkts, modtagsubstitution=modtagsubstitution, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, modeType=modeType, extended5=extended5, modExpLedStatus=modExpLedStatus, portegresspolicy=portegresspolicy, rxUnicastPkts=rxUnicastPkts, omnitronSFPGroup=omnitronSFPGroup, portSfpVendorSerialNumber=portSfpVendorSerialNumber, rxErrorPkts=rxErrorPkts, snmpTrapType=snmpTrapType, rxOversizePkts=rxOversizePkts, userIndex=userIndex, vlanIdOst=vlanIdOst, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portSFPstatus=portSFPstatus, portMacAddress=portMacAddress, modLM80currents=modLM80currents, port5Membership=port5Membership, sysAdminStatus=sysAdminStatus, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, prodAgent=prodAgent, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portEgressRate=portEgressRate, portSpeed=portSpeed, traphost6=traphost6, rxFragments=rxFragments, defaultForwardingMap=defaultForwardingMap, portSfpVendorPartNumber=portSfpVendorPartNumber, port2Membership=port2Membership, coreStatusOnly=coreStatusOnly, modextfeaturebits=modextfeaturebits, customertag=customertag, ahLocalOUI=ahLocalOUI, resetmod=resetmod, portStatsEntry=portStatsEntry, dhcpTagVid=dhcpTagVid, modmanufdate=modmanufdate, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, rxAlignmentErrors=rxAlignmentErrors, ahLocalParserState=ahLocalParserState, traphost2=traphost2, nmmOAMmgmtMode=nmmOAMmgmtMode, chassis=chassis, rxPackets1024to1518=rxPackets1024to1518, PYSNMP_MODULE_ID=omnitronMIB, modenable802dot1qProcessing=modenable802dot1qProcessing, portSfpTxPower=portSfpTxPower, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, writeCommunity=writeCommunity, txGoodPkts=txGoodPkts, ahLocalMode=ahLocalMode, nmmSecureSlaveSlot=nmmSecureSlaveSlot, extended6=extended6, moduleMgtCfgTable=moduleMgtCfgTable, mmname=mmname, portDuplex=portDuplex, modchassnum=modchassnum, gateway2=gateway2, ahFrameErrorEventTotal=ahFrameErrorEventTotal, modFpgaRev=modFpgaRev, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahLocalLinkFlags=ahLocalLinkFlags, modserialnum=modserialnum, portmlistcriteria=portmlistcriteria, modExpPartNumber=modExpPartNumber, validityflag=validityflag, readCommunity=readCommunity, capsMask=capsMask, slotnum=slotnum, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, rxTotalPkts=rxTotalPkts, modslotnum=modslotnum, modPcbRev=modPcbRev, rxCRCAlignErrors=rxCRCAlignErrors, portSfpDateCode=portSfpDateCode, portIngressRateDropOrPause=portIngressRateDropOrPause, portSFPEntry=portSFPEntry, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahRemoteMode=ahRemoteMode, portAHTable=portAHTable, tftpFileName=tftpFileName, modulePortsEntry=modulePortsEntry, ahTransmissionRate=ahTransmissionRate, portAccessType=portAccessType, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modchassname=modchassname, ahLocalSupportVar=ahLocalSupportVar, txOctets=txOctets, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, switchstat=switchstat, modLM80misc=modLM80misc, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, chassisEntry=chassisEntry, userEntry=userEntry, portFwdCpu=portFwdCpu, rxPausePkts=rxPausePkts, omnitronMIB=omnitronMIB, sysDateTime=sysDateTime, nmmIpProtocolState=nmmIpProtocolState, cpuVoltageOut=cpuVoltageOut, rxPackets256to511=rxPackets256to511, ostProtocolStatusIndex=ostProtocolStatusIndex, tftpServerIpAddress=tftpServerIpAddress, rxPackets64=rxPackets64, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, nmmSecureMode=nmmSecureMode, ahRemoteLinkPort=ahRemoteLinkPort, txLateCollision=txLateCollision, portIngressRate=portIngressRate, portStatsTable=portStatsTable, traphost1=traphost1, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ostProtocoManagementPort=ostProtocoManagementPort, cnodeControl=cnodeControl, portSfpVcc=portSfpVcc, traphost4=traphost4, modLM80volts=modLM80volts, ahLocalLpbkTimeout=ahLocalLpbkTimeout, omnitronGroup=omnitronGroup, syscon=syscon, portSfpBiasCurrent=portSfpBiasCurrent, prodrev=prodrev, modulePortsTable=modulePortsTable, rxGoodPkts=rxGoodPkts, slaveTrapsForward=slaveTrapsForward)
mibBuilder.exportSymbols("OMNITRON-MIB", ahCriticalEventMode=ahCriticalEventMode, portvlanidentifier=portvlanidentifier, trapSrcIpSelect=trapSrcIpSelect, index=index, partnum=partnum, extended2=extended2, traphost5=traphost5, ostProtocolStatusType=ostProtocolStatusType, moduleCount=moduleCount, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, portcanonicalformatIndicator=portcanonicalformatIndicator, port4Membership=port4Membership, sysloc=sysloc, ostProtocolStatusTable=ostProtocolStatusTable, chassisTable=chassisTable, portStatsClear=portStatsClear, rxOctets64=rxOctets64, modcommitVLANchanges=modcommitVLANchanges, portSfpVendorName=portSfpVendorName, serialpass=serialpass, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, enableSNMPWrites=enableSNMPWrites, dhcpIpAddr=dhcpIpAddr, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portpriority=portpriority, port1Membership=port1Membership, modname=modname, mychassnum=mychassnum, portIngressRateCBS=portIngressRateCBS, txBroadcastPkts=txBroadcastPkts, txErrorPkts=txErrorPkts, moduleVLANEntry=moduleVLANEntry, ahRemoteParserState=ahRemoteParserState, port3Membership=port3Membership, ipaddr2EVCassociation=ipaddr2EVCassociation, ostProtocolStatusState=ostProtocolStatusState, modreset=modreset, servicetag=servicetag, modprodrev=modprodrev, ahClearStatistics=ahClearStatistics, telnetpass=telnetpass, ingressPolicingType=ingressPolicingType, ahCriticalEventTrapList=ahCriticalEventTrapList, wrswitch=wrswitch, softrev=softrev, ahLocalMuxState=ahLocalMuxState, portSFPpageA2=portSFPpageA2, ftppasswrd=ftppasswrd, prodtype=prodtype, moduleVLANTable=moduleVLANTable, snmpv3UserName=snmpv3UserName, rxBroadcastPkts=rxBroadcastPkts, nmmCfgState=nmmCfgState, modswbuildnum=modswbuildnum, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed)
