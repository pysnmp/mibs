...
mibBuilder.exportSymbols("OMNITRON-MIB", managementModule=managementModule, txBroadcastPkts=txBroadcastPkts, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, modExpSoftwareRev=modExpSoftwareRev, ahRemoteLinkFlags=ahRemoteLinkFlags, mychassnum=mychassnum, vlanservicetag=vlanservicetag, snmpv3AuthPassword=snmpv3AuthPassword, modExpLedStatus=modExpLedStatus, chassisTable=chassisTable, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, cpuVoltageOut=cpuVoltageOut, ahLpbkMode=ahLpbkMode, txGoodPkts=txGoodPkts, port6Membership=port6Membership, modname=modname, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ahLocalParserState=ahLocalParserState, subnetmask=subnetmask, modslotnum=modslotnum, ahErroredFrameWindow=ahErroredFrameWindow, txPausePkts=txPausePkts, omnitronCompliance=omnitronCompliance, tftpEnable=tftpEnable, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, traphost4=traphost4, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, nmmIpProtocolState=nmmIpProtocolState, ipaddrEVCassociation=ipaddrEVCassociation, nmmSecureMode=nmmSecureMode, index=index, txLateCollision=txLateCollision, telnetpass=telnetpass, servicetag=servicetag, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ahTransmissionRate=ahTransmissionRate, ahRemoteLinkPort=ahRemoteLinkPort, extended6=extended6, omnitronConformance=omnitronConformance, modchassnum=modchassnum, sysDateTime=sysDateTime, snmpv3UserType=snmpv3UserType, modsoftrev=modsoftrev, coreStatusOnly=coreStatusOnly, portLinkState=portLinkState, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, traphost1=traphost1, portSfpBiasCurrent=portSfpBiasCurrent, txOctets=txOctets, txUnicastPkts=txUnicastPkts, snmpTrapType=snmpTrapType, rxTotalPkts=rxTotalPkts, selfSlot=selfSlot, rxUndersizePkts=rxUndersizePkts, defaultForwardingMap=defaultForwardingMap, mmname=mmname, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, portSFPstatus=portSFPstatus, ostProtocolStatusIndex=ostProtocolStatusIndex, modswbuildnum=modswbuildnum, rxPackets65to127=rxPackets65to127, modPcbRev=modPcbRev, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ostProtocolStatusState=ostProtocolStatusState, portIngressRateCBS=portIngressRateCBS, modRestoreFactoryDefaults=modRestoreFactoryDefaults, dhcptftpServerIpAddress=dhcptftpServerIpAddress, modtagsubstitution=modtagsubstitution, modulePortsEntry=modulePortsEntry, PYSNMP_MODULE_ID=omnitronMIB, ahRemoteOUI=ahRemoteOUI, switchstat=switchstat, omnitronSFPGroup=omnitronSFPGroup, modLM80currents=modLM80currents, ostProtocolStatusEntry=ostProtocolStatusEntry, ipAddr=ipAddr, portStatsClear=portStatsClear, slaveTrapsForward=slaveTrapsForward, portSfpTxPower=portSfpTxPower, port1Membership=port1Membership, ostProtocoManagementPort=ostProtocoManagementPort, nmmSecureSlaveSlot=nmmSecureSlaveSlot, slaveTraps=slaveTraps, moduleCount=moduleCount, chassistype=chassistype, modextfeaturebits=modextfeaturebits, chassisname=chassisname, rxPausePkts=rxPausePkts, resetmod=resetmod, portegresspolicy=portegresspolicy, modserialnum=modserialnum, txCollisions=txCollisions, ostEnvironmentalTemperature=ostEnvironmentalTemperature, enhancedchassisTable=enhancedchassisTable, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portSpeed=portSpeed, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, writeCommunity=writeCommunity, ahLocalOUI=ahLocalOUI, rxMulticastPkts=rxMulticastPkts, snmpv3PrivPassword=snmpv3PrivPassword, portpriority=portpriority, macAddr=macAddr, rxFCSErrors=rxFCSErrors, userEntry=userEntry, portAHTable=portAHTable, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, snmpv3SecurityLevel=snmpv3SecurityLevel, rxPackets64=rxPackets64, port5Membership=port5Membership, userIndex=userIndex, portSFPTable=portSFPTable, portSfpBitRate=portSfpBitRate, nmmIpDisabled=nmmIpDisabled, portMacAddress=portMacAddress, customertag=customertag, portSfpRxPower=portSfpRxPower, snmpv3UserName=snmpv3UserName, gateway=gateway, tftpFileName=tftpFileName, muxGroupDefaults=muxGroupDefaults, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, sysloc=sysloc, portFwdCpu=portFwdCpu, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, traphost3=traphost3, ahRemoteParserState=ahRemoteParserState, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSfpVendorName=portSfpVendorName, ostProtocolStatusTable=ostProtocolStatusTable, softrev=softrev, omnitronGroup=omnitronGroup, modreset=modreset, portIngressRate=portIngressRate, dhcpGateway=dhcpGateway, ahCriticalEventMode=ahCriticalEventMode, ingressPolicingType=ingressPolicingType, portL2CPmgntProcessing=portL2CPmgntProcessing, rxPackets128to255=rxPackets128to255, modpartnum=modpartnum, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portmlistcriteria=portmlistcriteria, portDuplex=portDuplex, modnumports=modnumports, manufdate=manufdate, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, extended3=extended3, omnitronMIB=omnitronMIB, portSfpVcc=portSfpVcc, portingresssecurity=portingresssecurity, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, rxGoodPkts=rxGoodPkts, bootpEnable=bootpEnable, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, syscon=syscon, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portSfpVendorPartNumber=portSfpVendorPartNumber, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, sysAdminStatus=sysAdminStatus, traphost5=traphost5, txMulticastPkts=txMulticastPkts, rxOversizePkts=rxOversizePkts, port2Membership=port2Membership, moduleEntry=moduleEntry, cnodeCIR=cnodeCIR, prodtype=prodtype, rxErrorPkts=rxErrorPkts, nmmOAMmgmtMode=nmmOAMmgmtMode, portAccessType=portAccessType, slaveWrite=slaveWrite, dhcpPortNumber=dhcpPortNumber, portSFPpageA2=portSFPpageA2, portEgressRate=portEgressRate, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahRemoteMode=ahRemoteMode, modchassname=modchassname, extended5=extended5, traphost2=traphost2, modulePortsTable=modulePortsTable, modeType=modeType, omnitronCompliances=omnitronCompliances, modulename=modulename, ahErroredFrameThreshold=ahErroredFrameThreshold, portcanonicalformatIndicator=portcanonicalformatIndicator, txErrorPkts=txErrorPkts, tftpServerIpAddress=tftpServerIpAddress, port3Membership=port3Membership, portSfpDateCode=portSfpDateCode, portStatsTable=portStatsTable, modmanufdate=modmanufdate, ahLocalMode=ahLocalMode, dhcpIpAddr=dhcpIpAddr, portIngressRateDropOrPause=portIngressRateDropOrPause, portSFPEntry=portSFPEntry, rxFragments=rxFragments, cnodeControl=cnodeControl, cpuTemperature=cpuTemperature, port4Membership=port4Membership, ftppasswrd=ftppasswrd, txMultipleCollision=txMultipleCollision, traphost6=traphost6, portState=portState, chassisEntry=chassisEntry, vlanPri=vlanPri, enableSNMPFunction=enableSNMPFunction, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, rxJabbers=rxJabbers, enabledFunctions=enabledFunctions, modprodrev=modprodrev, portEgressQosPolicy=portEgressQosPolicy, rxDropPkts=rxDropPkts, ahRemoteSupportVar=ahRemoteSupportVar, chassis=chassis, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, prodrev=prodrev, extended1=extended1, portAHEntry=portAHEntry, portStatsEntry=portStatsEntry, ledstat=ledstat, ipaddr2EVCassociation=ipaddr2EVCassociation, modportvlan=modportvlan, rxUnicastPkts=rxUnicastPkts, nmmCfgState=nmmCfgState, txExcessiveCollision=txExcessiveCollision, txOctets64=txOctets64, modenable802dot1qProcessing=modenable802dot1qProcessing, enableSNMPWrites=enableSNMPWrites, traphost7=traphost7, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portnum=portnum, rxBroadcastPkts=rxBroadcastPkts, moduleTable=moduleTable, prodAgent=prodAgent, ahLocalMuxState=ahLocalMuxState, moduleMgtCfgTable=moduleMgtCfgTable, rxCRCAlignErrors=rxCRCAlignErrors, portvlanidentifier=portvlanidentifier, slotnum=slotnum, ahEnabled=ahEnabled, portSFPpageA0=portSFPpageA0, modprodtype=modprodtype, modchasstype=modchasstype, omnitronProducts=omnitronProducts, gateway2=gateway2, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxPackets512to1023=rxPackets512to1023, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, chassisnum=chassisnum, moduleVLANTable=moduleVLANTable, extended4=extended4)
mibBuilder.exportSymbols("OMNITRON-MIB", ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modLM80misc=modLM80misc, partnum=partnum, txDropPkts=txDropPkts, moduleVLANEntry=moduleVLANEntry, portFwdCpuList=portFwdCpuList, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modLM80volts=modLM80volts, ahRemoteMuxState=ahRemoteMuxState, ahClearStatistics=ahClearStatistics, serialnum=serialnum, modHwRev=modHwRev, traphost8=traphost8, rxAlignmentErrors=rxAlignmentErrors, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, rxOctets=rxOctets, modExpPartNumber=modExpPartNumber, subnetmask2=subnetmask2, modvlanTableClear=modvlanTableClear, dhcpSubnetmask=dhcpSubnetmask, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modFpgaRev=modFpgaRev, dhcpTagVid=dhcpTagVid, userTable=userTable, modcommitVLANchanges=modcommitVLANchanges, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, rxPackets1024to1518=rxPackets1024to1518, validityflag=validityflag, ahLocalSupportVar=ahLocalSupportVar, vlanIdOst=vlanIdOst, rxOctets64=rxOctets64, portSfpTemperature=portSfpTemperature, readCommunity=readCommunity, ipAddr2=ipAddr2, txDeferedTransmit=txDeferedTransmit, ahLocalLinkFlags=ahLocalLinkFlags, ostProtocolStatusType=ostProtocolStatusType, omnitronGroups=omnitronGroups, cpuVoltageIn=cpuVoltageIn, vlanidentifier=vlanidentifier, txDroppedEvents=txDroppedEvents, serialpass=serialpass, moduleMgtCfgEntry=moduleMgtCfgEntry, rxSymbolErrors=rxSymbolErrors, keepAliveInterval=keepAliveInterval, ahCriticalEventTrapList=ahCriticalEventTrapList, rxPackets256to511=rxPackets256to511, extended2=extended2, wrswitch=wrswitch, nmmSecureConnState=nmmSecureConnState, txSingleCollision=txSingleCollision, capsMask=capsMask, ahFramePeriodEventTotal=ahFramePeriodEventTotal, enableSNMPv3Function=enableSNMPv3Function, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, trapSrcIpSelect=trapSrcIpSelect)
