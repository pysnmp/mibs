...
mibBuilder.exportSymbols("OMNITRON-MIB", slotnum=slotnum, modprodtype=modprodtype, writeCommunity=writeCommunity, rxGoodPkts=rxGoodPkts, vlanIdOst=vlanIdOst, ahRemoteSupportVar=ahRemoteSupportVar, txGoodPkts=txGoodPkts, enableSNMPv3Function=enableSNMPv3Function, coreStatusOnly=coreStatusOnly, portpriority=portpriority, ahRemoteMuxState=ahRemoteMuxState, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, validityflag=validityflag, txDeferedTransmit=txDeferedTransmit, snmpv3SecurityLevel=snmpv3SecurityLevel, ahRemoteMode=ahRemoteMode, extended1=extended1, modchasstype=modchasstype, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostProtocolStatusIndex=ostProtocolStatusIndex, ahFrameErrorEventTotal=ahFrameErrorEventTotal, dhcptftpServerIpAddress=dhcptftpServerIpAddress, macAddr=macAddr, portSFPpageA2=portSFPpageA2, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, omnitronMIB=omnitronMIB, rxFragments=rxFragments, nmmCfgState=nmmCfgState, rxMulticastPkts=rxMulticastPkts, modportvlan=modportvlan, modulePortsTable=modulePortsTable, snmpv3AuthPassword=snmpv3AuthPassword, rxUndersizePkts=rxUndersizePkts, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, extended3=extended3, rxPackets512to1023=rxPackets512to1023, dhcpSubnetmask=dhcpSubnetmask, ipaddr2EVCassociation=ipaddr2EVCassociation, dhcpGateway=dhcpGateway, txDroppedEvents=txDroppedEvents, subnetmask=subnetmask, modLM80currents=modLM80currents, ostProtocoManagementPort=ostProtocoManagementPort, ahErroredFrameThreshold=ahErroredFrameThreshold, ahRemoteLinkPort=ahRemoteLinkPort, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, moduleMgtCfgEntry=moduleMgtCfgEntry, portFwdCpuList=portFwdCpuList, rxTotalPkts=rxTotalPkts, trapSrcIpSelect=trapSrcIpSelect, txOctets64=txOctets64, modulePortsEntry=modulePortsEntry, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, cpuVoltageOut=cpuVoltageOut, portSfpVcc=portSfpVcc, portFwdCpu=portFwdCpu, mmname=mmname, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portIngressRateDropOrPause=portIngressRateDropOrPause, ahLocalSupportVar=ahLocalSupportVar, snmpTrapType=snmpTrapType, ingressPolicingType=ingressPolicingType, traphost8=traphost8, dhcpTagVid=dhcpTagVid, userIndex=userIndex, rxPackets64=rxPackets64, selfSlot=selfSlot, slaveTrapsForward=slaveTrapsForward, modswbuildnum=modswbuildnum, ahErroredFrameWindow=ahErroredFrameWindow, PYSNMP_MODULE_ID=omnitronMIB, rxFCSErrors=rxFCSErrors, wrswitch=wrswitch, modFpgaRev=modFpgaRev, modPcbRev=modPcbRev, chassisname=chassisname, ahLocalParserState=ahLocalParserState, portSFPEntry=portSFPEntry, moduleVLANTable=moduleVLANTable, portAHTable=portAHTable, dhcpPortNumber=dhcpPortNumber, tftpEnable=tftpEnable, subnetmask2=subnetmask2, txSingleCollision=txSingleCollision, mychassnum=mychassnum, cpuTemperature=cpuTemperature, rxPackets1024to1518=rxPackets1024to1518, ipAddr2=ipAddr2, portL2CPmgntProcessing=portL2CPmgntProcessing, syscon=syscon, txLateCollision=txLateCollision, modreset=modreset, portDuplex=portDuplex, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, slaveWrite=slaveWrite, dhcpIpAddr=dhcpIpAddr, nmmIpDisabled=nmmIpDisabled, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, nmmSecureSlaveSlot=nmmSecureSlaveSlot, omnitronCompliance=omnitronCompliance, readCommunity=readCommunity, rxOctets64=rxOctets64, vlanservicetag=vlanservicetag, enableSNMPWrites=enableSNMPWrites, managementModule=managementModule, portState=portState, ahCriticalEventTrapList=ahCriticalEventTrapList, modHwRev=modHwRev, ahFramePeriodEventTotal=ahFramePeriodEventTotal, cnodeCIR=cnodeCIR, sysDateTime=sysDateTime, moduleVLANEntry=moduleVLANEntry, rxPackets65to127=rxPackets65to127, portSfpBitRate=portSfpBitRate, ostProtocolStatusType=ostProtocolStatusType, serialpass=serialpass, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, chassisnum=chassisnum, ostProtocolStatusTable=ostProtocolStatusTable, tftpServerIpAddress=tftpServerIpAddress, portLinkState=portLinkState, rxDropPkts=rxDropPkts, portStatsTable=portStatsTable, portIngressRateCBS=portIngressRateCBS, chassisTable=chassisTable, ahLocalOUI=ahLocalOUI, manufdate=manufdate, ostProtocolStatusState=ostProtocolStatusState, sysAdminStatus=sysAdminStatus, port5Membership=port5Membership, portingresssecurity=portingresssecurity, rxJabbers=rxJabbers, traphost4=traphost4, omnitronGroup=omnitronGroup, portmlistcriteria=portmlistcriteria, modvlanTableClear=modvlanTableClear, portStatsEntry=portStatsEntry, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, port1Membership=port1Membership, omnitronGroups=omnitronGroups, extended5=extended5, index=index, portSFPstatus=portSFPstatus, portegresspolicy=portegresspolicy, rxAlignmentErrors=rxAlignmentErrors, slaveTraps=slaveTraps, cpuVoltageIn=cpuVoltageIn, modmanufdate=modmanufdate, modExpSoftwareRev=modExpSoftwareRev, ipAddr=ipAddr, ahLocalMuxState=ahLocalMuxState, userEntry=userEntry, txBroadcastPkts=txBroadcastPkts, ahLpbkMode=ahLpbkMode, modprodrev=modprodrev, txOctets=txOctets, chassis=chassis, ahCriticalEventMode=ahCriticalEventMode, traphost5=traphost5, portSfpRxPower=portSfpRxPower, modenable802dot1qProcessing=modenable802dot1qProcessing, modulename=modulename, txErrorPkts=txErrorPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, customertag=customertag, extended2=extended2, switchstat=switchstat, portAHEntry=portAHEntry, snmpv3PrivPassword=snmpv3PrivPassword, txMulticastPkts=txMulticastPkts, portAccessType=portAccessType, port4Membership=port4Membership, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ostProtocolStatusEntry=ostProtocolStatusEntry, moduleEntry=moduleEntry, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portnum=portnum, ipaddrEVCassociation=ipaddrEVCassociation, capsMask=capsMask, muxGroupDefaults=muxGroupDefaults, snmpv3UserType=snmpv3UserType, portSpeed=portSpeed, rxOctets=rxOctets, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, rxCRCAlignErrors=rxCRCAlignErrors, ahEnabled=ahEnabled, sysloc=sysloc, omnitronProducts=omnitronProducts, rxPausePkts=rxPausePkts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portSfpTxPower=portSfpTxPower, cnodeControl=cnodeControl, modeType=modeType, portSFPpageA0=portSFPpageA0, portSfpVendorPartNumber=portSfpVendorPartNumber, txCollisions=txCollisions, enableSNMPFunction=enableSNMPFunction, gateway=gateway, rxOversizePkts=rxOversizePkts, extended6=extended6, portvlanidentifier=portvlanidentifier, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ahRemoteOUI=ahRemoteOUI, port6Membership=port6Membership, nmmSecureMode=nmmSecureMode, omnitronCompliances=omnitronCompliances, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, modtagsubstitution=modtagsubstitution, modcommitVLANchanges=modcommitVLANchanges, ahClearStatistics=ahClearStatistics, ledstat=ledstat, modname=modname, rxPackets128to255=rxPackets128to255, prodrev=prodrev, txDropPkts=txDropPkts, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, modExpLedStatus=modExpLedStatus, omnitronSFPGroup=omnitronSFPGroup, txExcessiveCollision=txExcessiveCollision, txMultipleCollision=txMultipleCollision, portEgressRate=portEgressRate, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, traphost7=traphost7, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, vlanPri=vlanPri, modslotnum=modslotnum, modchassname=modchassname, prodAgent=prodAgent, serialnum=serialnum, modsoftrev=modsoftrev, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portSfpBiasCurrent=portSfpBiasCurrent, modExpPartNumber=modExpPartNumber, rxBroadcastPkts=rxBroadcastPkts, ahRemoteLinkFlags=ahRemoteLinkFlags, portEgressQosPolicy=portEgressQosPolicy, rxSymbolErrors=rxSymbolErrors, portSFPTable=portSFPTable, port3Membership=port3Membership, extended4=extended4, userTable=userTable, resetmod=resetmod, rxErrorPkts=rxErrorPkts, ahLocalMode=ahLocalMode, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, chassistype=chassistype, portcanonicalformatIndicator=portcanonicalformatIndicator, modLM80volts=modLM80volts, ahRemoteParserState=ahRemoteParserState, portStatsClear=portStatsClear)
mibBuilder.exportSymbols("OMNITRON-MIB", ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, servicetag=servicetag, moduleTable=moduleTable, ftppasswrd=ftppasswrd, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, traphost3=traphost3, defaultForwardingMap=defaultForwardingMap, portIngressRate=portIngressRate, txPausePkts=txPausePkts, snmpv3UserName=snmpv3UserName, modserialnum=modserialnum, rxPackets256to511=rxPackets256to511, moduleMgtCfgTable=moduleMgtCfgTable, tftpFileName=tftpFileName, portSfpVendorName=portSfpVendorName, prodtype=prodtype, modLM80misc=modLM80misc, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, gateway2=gateway2, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, moduleCount=moduleCount, chassisEntry=chassisEntry, vlanidentifier=vlanidentifier, enhancedchassisTable=enhancedchassisTable, nmmOAMmgmtMode=nmmOAMmgmtMode, txUnicastPkts=txUnicastPkts, rxUnicastPkts=rxUnicastPkts, portSfpTemperature=portSfpTemperature, modextfeaturebits=modextfeaturebits, modchassnum=modchassnum, nmmIpProtocolState=nmmIpProtocolState, ahLocalLpbkTimeout=ahLocalLpbkTimeout, traphost2=traphost2, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modnumports=modnumports, port2Membership=port2Membership, modcommitNMMCfgChanges=modcommitNMMCfgChanges, bootpEnable=bootpEnable, portMacAddress=portMacAddress, traphost6=traphost6, enabledFunctions=enabledFunctions, telnetpass=telnetpass, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahLocalLinkFlags=ahLocalLinkFlags, partnum=partnum, modpartnum=modpartnum, keepAliveInterval=keepAliveInterval, omnitronConformance=omnitronConformance, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, traphost1=traphost1, ahTransmissionRate=ahTransmissionRate, softrev=softrev, portSfpDateCode=portSfpDateCode, nmmSecureConnState=nmmSecureConnState, ostEnvironmentalTemperature=ostEnvironmentalTemperature)
