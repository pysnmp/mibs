...
OstPortNumber, OstPortList, icAgent, omnitron, OstModeType, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortNumber", "OstPortList", "icAgent", "omnitron", "OstModeType", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", subnetmask2=subnetmask2, modprodrev=modprodrev, rxSymbolErrors=rxSymbolErrors, portSFPpageA0=portSFPpageA0, ipAddr2=ipAddr2, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ostEnvironmentalTemperature=ostEnvironmentalTemperature, gateway2=gateway2, rxJabbers=rxJabbers, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, nmmIpDisabled=nmmIpDisabled, wrswitch=wrswitch, moduleMgtCfgTable=moduleMgtCfgTable, managementModule=managementModule, rxPackets65to127=rxPackets65to127, dhcpGateway=dhcpGateway, moduleVLANEntry=moduleVLANEntry, rxMulticastPkts=rxMulticastPkts, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, enabledFunctions=enabledFunctions, rxDropPkts=rxDropPkts, moduleTable=moduleTable, modPcbRev=modPcbRev, ahCriticalEventTrapList=ahCriticalEventTrapList, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, nmmSecureMode=nmmSecureMode, prodtype=prodtype, modExpSoftwareRev=modExpSoftwareRev, modLM80misc=modLM80misc, rxAlignmentErrors=rxAlignmentErrors, rxOctets=rxOctets, port6Membership=port6Membership, txErrorPkts=txErrorPkts, modvlanTableClear=modvlanTableClear, index=index, modsoftrev=modsoftrev, chassisTable=chassisTable, vlanservicetag=vlanservicetag, txGoodPkts=txGoodPkts, rxBroadcastPkts=rxBroadcastPkts, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, port2Membership=port2Membership, ostProtocolStatusState=ostProtocolStatusState, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ipaddrEVCassociation=ipaddrEVCassociation, snmpv3SecurityLevel=snmpv3SecurityLevel, moduleMgtCfgEntry=moduleMgtCfgEntry, mmname=mmname, portmlistcriteria=portmlistcriteria, traphost1=traphost1, rxErrorPkts=rxErrorPkts, sysloc=sysloc, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modchasstype=modchasstype, portDuplex=portDuplex, extended2=extended2, rxUnicastPkts=rxUnicastPkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, port1Membership=port1Membership, ahLocalMuxState=ahLocalMuxState, ahRemoteMuxState=ahRemoteMuxState, partnum=partnum, ahErroredFrameThreshold=ahErroredFrameThreshold, coreStatusOnly=coreStatusOnly, portSfpBiasCurrent=portSfpBiasCurrent, omnitronConformance=omnitronConformance, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, rxOctets64=rxOctets64, portSfpBitRate=portSfpBitRate, enableSNMPWrites=enableSNMPWrites, txLateCollision=txLateCollision, portSfpTemperature=portSfpTemperature, extended1=extended1, prodrev=prodrev, chassistype=chassistype, modExpLedStatus=modExpLedStatus, userIndex=userIndex, slaveTrapsForward=slaveTrapsForward, ahLocalSupportVar=ahLocalSupportVar, portSFPstatus=portSFPstatus, portSfpVendorPartNumber=portSfpVendorPartNumber, chassisEntry=chassisEntry, omnitronCompliances=omnitronCompliances, modprodtype=modprodtype, rxPackets512to1023=rxPackets512to1023, chassisname=chassisname, ftppasswrd=ftppasswrd, cnodeControl=cnodeControl, modserialnum=modserialnum, enhancedchassisTable=enhancedchassisTable, ahLocalParserState=ahLocalParserState, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portEgressQosPolicy=portEgressQosPolicy, modulename=modulename, subnetmask=subnetmask, syscon=syscon, telnetpass=telnetpass, omnitronCompliance=omnitronCompliance, txMulticastPkts=txMulticastPkts, snmpv3UserName=snmpv3UserName, ahRemoteMode=ahRemoteMode, switchstat=switchstat, cpuVoltageIn=cpuVoltageIn, modLM80volts=modLM80volts, portpriority=portpriority, txDroppedEvents=txDroppedEvents, port3Membership=port3Membership, servicetag=servicetag, PYSNMP_MODULE_ID=omnitronMIB, chassisnum=chassisnum, nmmOAMmgmtMode=nmmOAMmgmtMode, txSingleCollision=txSingleCollision, portAHTable=portAHTable, traphost4=traphost4, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portSFPTable=portSFPTable, dhcptftpServerIpAddress=dhcptftpServerIpAddress, cnodeCIR=cnodeCIR, rxPackets128to255=rxPackets128to255, modchassnum=modchassnum, portStatsTable=portStatsTable, txCollisions=txCollisions, ledstat=ledstat, modmanufdate=modmanufdate, portcanonicalformatIndicator=portcanonicalformatIndicator, portvlanidentifier=portvlanidentifier, readCommunity=readCommunity, txDeferedTransmit=txDeferedTransmit, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, extended3=extended3, ahLocalOUI=ahLocalOUI, modFpgaRev=modFpgaRev, resetmod=resetmod, ipaddr2EVCassociation=ipaddr2EVCassociation, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, dhcpPortNumber=dhcpPortNumber, rxPackets1024to1518=rxPackets1024to1518, portSfpVendorName=portSfpVendorName, modslotnum=modslotnum, keepAliveInterval=keepAliveInterval, portLinkState=portLinkState, sysDateTime=sysDateTime, slotnum=slotnum, ahRemoteLinkFlags=ahRemoteLinkFlags, ostProtocoManagementPort=ostProtocoManagementPort, rxOversizePkts=rxOversizePkts, modportvlan=modportvlan, traphost5=traphost5, validityflag=validityflag, enableSNMPv3Function=enableSNMPv3Function, portAccessType=portAccessType, portSFPpageA2=portSFPpageA2, omnitronGroups=omnitronGroups, rxGoodPkts=rxGoodPkts, portnum=portnum, nmmSecureConnState=nmmSecureConnState, portSFPEntry=portSFPEntry, portSfpTxPower=portSfpTxPower, rxFCSErrors=rxFCSErrors, portState=portState, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, rxFragments=rxFragments, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portingresssecurity=portingresssecurity, portAHEntry=portAHEntry, txDropPkts=txDropPkts, omnitronSFPGroup=omnitronSFPGroup, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, traphost8=traphost8, port4Membership=port4Membership, ahCriticalEventMode=ahCriticalEventMode, txMultipleCollision=txMultipleCollision, rxUndersizePkts=rxUndersizePkts, ostProtocolStatusTable=ostProtocolStatusTable, rxCRCAlignErrors=rxCRCAlignErrors, modpartnum=modpartnum, portFwdCpuList=portFwdCpuList, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ahFrameErrorEventTotal=ahFrameErrorEventTotal, dhcpSubnetmask=dhcpSubnetmask, userEntry=userEntry, extended5=extended5, traphost7=traphost7, moduleEntry=moduleEntry, userTable=userTable, modulePortsTable=modulePortsTable, rxTotalPkts=rxTotalPkts, portIngressRateDropOrPause=portIngressRateDropOrPause, modtagsubstitution=modtagsubstitution, tftpServerIpAddress=tftpServerIpAddress, ipAddr=ipAddr, traphost6=traphost6, snmpv3AuthPassword=snmpv3AuthPassword, serialnum=serialnum, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, defaultForwardingMap=defaultForwardingMap, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, txBroadcastPkts=txBroadcastPkts, enableSNMPFunction=enableSNMPFunction, ahEnabled=ahEnabled, modchassname=modchassname, writeCommunity=writeCommunity, cpuTemperature=cpuTemperature, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, sysAdminStatus=sysAdminStatus, ostProtocolStatusEntry=ostProtocolStatusEntry, nmmIpProtocolState=nmmIpProtocolState, selfSlot=selfSlot, txExcessiveCollision=txExcessiveCollision, portIngressRateCBS=portIngressRateCBS, portSfpDateCode=portSfpDateCode, prodAgent=prodAgent, modextfeaturebits=modextfeaturebits, nmmSecureSlaveSlot=nmmSecureSlaveSlot, gateway=gateway, ahTransmissionRate=ahTransmissionRate, extended4=extended4, mychassnum=mychassnum, ahRemoteParserState=ahRemoteParserState, snmpTrapType=snmpTrapType, modulePortsEntry=modulePortsEntry, rxPackets256to511=rxPackets256to511, txOctets=txOctets, vlanidentifier=vlanidentifier, modcommitVLANchanges=modcommitVLANchanges, portegresspolicy=portegresspolicy, capsMask=capsMask, ahErroredFrameWindow=ahErroredFrameWindow, omnitronMIB=omnitronMIB, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, vlanIdOst=vlanIdOst, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, slaveTraps=slaveTraps, trapSrcIpSelect=trapSrcIpSelect, txOctets64=txOctets64, ahRemoteSupportVar=ahRemoteSupportVar, modreset=modreset, ostProtocolStatusType=ostProtocolStatusType, rxPausePkts=rxPausePkts, ingressPolicingType=ingressPolicingType, nmmCfgState=nmmCfgState, ahLocalLinkFlags=ahLocalLinkFlags, omnitronProducts=omnitronProducts, modnumports=modnumports, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ostProtocolStatusIndex=ostProtocolStatusIndex, txUnicastPkts=txUnicastPkts, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, dhcpTagVid=dhcpTagVid, bootpEnable=bootpEnable, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow)
mibBuilder.exportSymbols("OMNITRON-MIB", ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, vlanPri=vlanPri, snmpv3UserType=snmpv3UserType, dhcpIpAddr=dhcpIpAddr, modeType=modeType, port5Membership=port5Membership, portSfpVcc=portSfpVcc, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portL2CPmgntProcessing=portL2CPmgntProcessing, modExpPartNumber=modExpPartNumber, modLM80currents=modLM80currents, extended6=extended6, ahLpbkMode=ahLpbkMode, modname=modname, portStatsClear=portStatsClear, modenable802dot1qProcessing=modenable802dot1qProcessing, omnitronGroup=omnitronGroup, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, tftpEnable=tftpEnable, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, softrev=softrev, portFwdCpu=portFwdCpu, portIngressRate=portIngressRate, ahLocalMode=ahLocalMode, chassis=chassis, moduleVLANTable=moduleVLANTable, customertag=customertag, portMacAddress=portMacAddress, traphost3=traphost3, portEgressRate=portEgressRate, portStatsEntry=portStatsEntry, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, moduleCount=moduleCount, tftpFileName=tftpFileName, txPausePkts=txPausePkts, ahRemoteOUI=ahRemoteOUI, ahClearStatistics=ahClearStatistics, rxPackets64=rxPackets64, portSpeed=portSpeed, slaveWrite=slaveWrite, cpuVoltageOut=cpuVoltageOut, serialpass=serialpass, modswbuildnum=modswbuildnum, modHwRev=modHwRev, portSfpRxPower=portSfpRxPower, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ahRemoteLinkPort=ahRemoteLinkPort, snmpv3PrivPassword=snmpv3PrivPassword, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, macAddr=macAddr, traphost2=traphost2, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, muxGroupDefaults=muxGroupDefaults, manufdate=manufdate)
