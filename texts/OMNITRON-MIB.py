...
OstVlanId, omnitron, icAgent, OstPortList, OstPortNumber, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "omnitron", "icAgent", "OstPortList", "OstPortNumber", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", nmmSecureMode=nmmSecureMode, moduleCount=moduleCount, writeCommunity=writeCommunity, portFwdCpu=portFwdCpu, ipaddrEVCassociation=ipaddrEVCassociation, txGoodPkts=txGoodPkts, rxErrorPkts=rxErrorPkts, gateway=gateway, ahRemoteLinkPort=ahRemoteLinkPort, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, txUnicastPkts=txUnicastPkts, nmmSecureConnState=nmmSecureConnState, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modcommitVLANchanges=modcommitVLANchanges, portMacAddress=portMacAddress, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, port4Membership=port4Membership, modLM80currents=modLM80currents, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, moduleVLANEntry=moduleVLANEntry, index=index, omnitronSFPGroup=omnitronSFPGroup, modsoftrev=modsoftrev, modHwRev=modHwRev, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modvlanTableClear=modvlanTableClear, nmmIpDisabled=nmmIpDisabled, omnitronGroup=omnitronGroup, moduleVLANTable=moduleVLANTable, enableSNMPv3Function=enableSNMPv3Function, portIngressRate=portIngressRate, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahRemoteMuxState=ahRemoteMuxState, ftppasswrd=ftppasswrd, traphost6=traphost6, ostProtocolStatusEntry=ostProtocolStatusEntry, servicetag=servicetag, rxGoodPkts=rxGoodPkts, ahEnabled=ahEnabled, omnitronMIB=omnitronMIB, telnetpass=telnetpass, portIngressRateDropOrPause=portIngressRateDropOrPause, portAHEntry=portAHEntry, portSfpVendorPartNumber=portSfpVendorPartNumber, ipAddr2=ipAddr2, softrev=softrev, ahLpbkMode=ahLpbkMode, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portAHTable=portAHTable, chassisnum=chassisnum, resetmod=resetmod, ahRemoteLinkFlags=ahRemoteLinkFlags, portDuplex=portDuplex, serialnum=serialnum, ipaddr2EVCassociation=ipaddr2EVCassociation, port3Membership=port3Membership, modulePortsTable=modulePortsTable, modenable802dot1qProcessing=modenable802dot1qProcessing, traphost8=traphost8, rxAlignmentErrors=rxAlignmentErrors, extended6=extended6, modExpPartNumber=modExpPartNumber, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modRestoreFactoryDefaults=modRestoreFactoryDefaults, txDroppedEvents=txDroppedEvents, txOctets=txOctets, txErrorPkts=txErrorPkts, vlanIdOst=vlanIdOst, port1Membership=port1Membership, modLM80volts=modLM80volts, port6Membership=port6Membership, portSpeed=portSpeed, capsMask=capsMask, prodrev=prodrev, gateway2=gateway2, port2Membership=port2Membership, portEgressRate=portEgressRate, vlanPri=vlanPri, omnitronProducts=omnitronProducts, rxFragments=rxFragments, portSFPpageA0=portSFPpageA0, chassisname=chassisname, nmmIpProtocolState=nmmIpProtocolState, portStatsClear=portStatsClear, portIngressRateCBS=portIngressRateCBS, portSfpBitRate=portSfpBitRate, txMultipleCollision=txMultipleCollision, txExcessiveCollision=txExcessiveCollision, modmanufdate=modmanufdate, defaultForwardingMap=defaultForwardingMap, bootpEnable=bootpEnable, enabledFunctions=enabledFunctions, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, chassisTable=chassisTable, dhcpGateway=dhcpGateway, ahLocalLinkFlags=ahLocalLinkFlags, modulename=modulename, traphost1=traphost1, serialpass=serialpass, snmpv3SecurityLevel=snmpv3SecurityLevel, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, switchstat=switchstat, extended3=extended3, chassistype=chassistype, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, nmmOAMmgmtMode=nmmOAMmgmtMode, modportvlan=modportvlan, chassisEntry=chassisEntry, ostProtocolStatusType=ostProtocolStatusType, wrswitch=wrswitch, ahRemoteParserState=ahRemoteParserState, subnetmask=subnetmask, cpuVoltageOut=cpuVoltageOut, rxOctets=rxOctets, portSfpTxPower=portSfpTxPower, sysAdminStatus=sysAdminStatus, enableSNMPWrites=enableSNMPWrites, portSfpVendorName=portSfpVendorName, modExpSoftwareRev=modExpSoftwareRev, nmmCfgState=nmmCfgState, muxGroupDefaults=muxGroupDefaults, rxBroadcastPkts=rxBroadcastPkts, vlanservicetag=vlanservicetag, cpuTemperature=cpuTemperature, txDeferedTransmit=txDeferedTransmit, rxFCSErrors=rxFCSErrors, customertag=customertag, extended4=extended4, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portegresspolicy=portegresspolicy, snmpv3UserName=snmpv3UserName, modnumports=modnumports, syscon=syscon, txLateCollision=txLateCollision, traphost7=traphost7, cnodeCIR=cnodeCIR, portState=portState, portSFPpageA2=portSFPpageA2, validityflag=validityflag, ahClearStatistics=ahClearStatistics, ahRemoteSupportVar=ahRemoteSupportVar, portSfpVcc=portSfpVcc, userIndex=userIndex, portnum=portnum, modreset=modreset, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, enhancedchassisTable=enhancedchassisTable, modeType=modeType, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, extended5=extended5, traphost3=traphost3, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, rxDropPkts=rxDropPkts, moduleEntry=moduleEntry, tftpServerIpAddress=tftpServerIpAddress, ipAddr=ipAddr, sysloc=sysloc, slaveTraps=slaveTraps, moduleTable=moduleTable, traphost5=traphost5, enableSNMPFunction=enableSNMPFunction, txBroadcastPkts=txBroadcastPkts, modtagsubstitution=modtagsubstitution, portAccessType=portAccessType, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, omnitronCompliance=omnitronCompliance, ahRemoteMode=ahRemoteMode, vlanidentifier=vlanidentifier, traphost4=traphost4, modprodtype=modprodtype, portFwdCpuList=portFwdCpuList, modchassnum=modchassnum, txSingleCollision=txSingleCollision, manufdate=manufdate, moduleMgtCfgTable=moduleMgtCfgTable, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modname=modname, portSFPstatus=portSFPstatus, coreStatusOnly=coreStatusOnly, omnitronGroups=omnitronGroups, rxOversizePkts=rxOversizePkts, ahLocalMode=ahLocalMode, txPausePkts=txPausePkts, ahCriticalEventTrapList=ahCriticalEventTrapList, dhcpTagVid=dhcpTagVid, modulePortsEntry=modulePortsEntry, ingressPolicingType=ingressPolicingType, tftpEnable=tftpEnable, portSfpTemperature=portSfpTemperature, modExpLedStatus=modExpLedStatus, selfSlot=selfSlot, port5Membership=port5Membership, portingresssecurity=portingresssecurity, rxPackets128to255=rxPackets128to255, modswbuildnum=modswbuildnum, snmpv3AuthPassword=snmpv3AuthPassword, portcanonicalformatIndicator=portcanonicalformatIndicator, moduleMgtCfgEntry=moduleMgtCfgEntry, snmpTrapType=snmpTrapType, rxPackets64=rxPackets64, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ahCriticalEventMode=ahCriticalEventMode, modPcbRev=modPcbRev, slaveWrite=slaveWrite, cpuVoltageIn=cpuVoltageIn, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modextfeaturebits=modextfeaturebits, portSfpRxPower=portSfpRxPower, ostProtocolStatusTable=ostProtocolStatusTable, snmpv3UserType=snmpv3UserType, txCollisions=txCollisions, ahLocalSupportVar=ahLocalSupportVar, ostProtocoManagementPort=ostProtocoManagementPort, rxPackets1024to1518=rxPackets1024to1518, modchasstype=modchasstype, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, txDropPkts=txDropPkts, modLM80misc=modLM80misc, rxSymbolErrors=rxSymbolErrors, prodAgent=prodAgent, portvlanidentifier=portvlanidentifier, modchassname=modchassname, ahLocalMuxState=ahLocalMuxState, macAddr=macAddr, modslotnum=modslotnum, txMulticastPkts=txMulticastPkts, userEntry=userEntry, portSfpDateCode=portSfpDateCode, nmmSecureSlaveSlot=nmmSecureSlaveSlot, rxPackets65to127=rxPackets65to127, rxMulticastPkts=rxMulticastPkts, rxTotalPkts=rxTotalPkts, subnetmask2=subnetmask2, ahLocalParserState=ahLocalParserState, managementModule=managementModule, omnitronCompliances=omnitronCompliances, portmlistcriteria=portmlistcriteria, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portSFPTable=portSFPTable, trapSrcIpSelect=trapSrcIpSelect, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, dhcpSubnetmask=dhcpSubnetmask, ostProtocolStatusState=ostProtocolStatusState, ahErroredFrameThreshold=ahErroredFrameThreshold, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portStatsEntry=portStatsEntry, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, snmpv3PrivPassword=snmpv3PrivPassword, modpartnum=modpartnum)
mibBuilder.exportSymbols("OMNITRON-MIB", ostProtocolStatusIndex=ostProtocolStatusIndex, extended2=extended2, extended1=extended1, modserialnum=modserialnum, modFpgaRev=modFpgaRev, sysDateTime=sysDateTime, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portpriority=portpriority, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, slotnum=slotnum, txOctets64=txOctets64, rxUndersizePkts=rxUndersizePkts, rxPausePkts=rxPausePkts, keepAliveInterval=keepAliveInterval, rxPackets512to1023=rxPackets512to1023, prodtype=prodtype, portSfpBiasCurrent=portSfpBiasCurrent, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ahTransmissionRate=ahTransmissionRate, slaveTrapsForward=slaveTrapsForward, modprodrev=modprodrev, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portEgressQosPolicy=portEgressQosPolicy, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, userTable=userTable, portStatsTable=portStatsTable, portSFPEntry=portSFPEntry, rxUnicastPkts=rxUnicastPkts, chassis=chassis, mychassnum=mychassnum, portLinkState=portLinkState, dhcpPortNumber=dhcpPortNumber, tftpFileName=tftpFileName, traphost2=traphost2, PYSNMP_MODULE_ID=omnitronMIB, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ahErroredFrameWindow=ahErroredFrameWindow, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, rxPackets256to511=rxPackets256to511, portSfpVendorSerialNumber=portSfpVendorSerialNumber, omnitronConformance=omnitronConformance, rxCRCAlignErrors=rxCRCAlignErrors, cnodeControl=cnodeControl, ahLocalOUI=ahLocalOUI, dhcpIpAddr=dhcpIpAddr, readCommunity=readCommunity, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxOctets64=rxOctets64, rxJabbers=rxJabbers, portL2CPmgntProcessing=portL2CPmgntProcessing, partnum=partnum, ahRemoteOUI=ahRemoteOUI, mmname=mmname, ledstat=ledstat)
