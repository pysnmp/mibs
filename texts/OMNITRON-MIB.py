...
OstModeType, OstPortNumber, OstPortList, icAgent, OstVlanId, omnitron = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstModeType", "OstPortNumber", "OstPortList", "icAgent", "OstVlanId", "omnitron")
...
mibBuilder.exportSymbols("OMNITRON-MIB", rxPausePkts=rxPausePkts, portSfpBiasCurrent=portSfpBiasCurrent, ostProtocolStatusType=ostProtocolStatusType, modLM80volts=modLM80volts, portSfpVendorName=portSfpVendorName, moduleMgtCfgTable=moduleMgtCfgTable, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modpartnum=modpartnum, modextfeaturebits=modextfeaturebits, dhcpIpAddr=dhcpIpAddr, chassisname=chassisname, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, txBroadcastPkts=txBroadcastPkts, slaveTrapsForward=slaveTrapsForward, rxFragments=rxFragments, slotnum=slotnum, cnodeControl=cnodeControl, modulePortsEntry=modulePortsEntry, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ingressPolicingType=ingressPolicingType, portSFPpageA0=portSFPpageA0, modnumports=modnumports, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, validityflag=validityflag, tftpServerIpAddress=tftpServerIpAddress, portEgressQosPolicy=portEgressQosPolicy, enhancedchassisTable=enhancedchassisTable, ahEnabled=ahEnabled, ahTransmissionRate=ahTransmissionRate, rxPackets64=rxPackets64, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, defaultForwardingMap=defaultForwardingMap, writeCommunity=writeCommunity, moduleTable=moduleTable, ahClearStatistics=ahClearStatistics, portFwdCpu=portFwdCpu, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portingresssecurity=portingresssecurity, capsMask=capsMask, portSfpDateCode=portSfpDateCode, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, muxGroupDefaults=muxGroupDefaults, ahRemoteSupportVar=ahRemoteSupportVar, modtagsubstitution=modtagsubstitution, modprodtype=modprodtype, portpriority=portpriority, modExpPartNumber=modExpPartNumber, rxPackets128to255=rxPackets128to255, traphost6=traphost6, modmanufdate=modmanufdate, portvlanidentifier=portvlanidentifier, portFwdCpuList=portFwdCpuList, ipaddrEVCassociation=ipaddrEVCassociation, sysDateTime=sysDateTime, txErrorPkts=txErrorPkts, ahErroredFrameWindow=ahErroredFrameWindow, txUnicastPkts=txUnicastPkts, portIngressRate=portIngressRate, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, dhcpGateway=dhcpGateway, modchasstype=modchasstype, chassistype=chassistype, enableSNMPFunction=enableSNMPFunction, modserialnum=modserialnum, macAddr=macAddr, enabledFunctions=enabledFunctions, portStatsClear=portStatsClear, extended5=extended5, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, moduleMgtCfgEntry=moduleMgtCfgEntry, telnetpass=telnetpass, portStatsTable=portStatsTable, readCommunity=readCommunity, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, sysAdminStatus=sysAdminStatus, ahRemoteOUI=ahRemoteOUI, userEntry=userEntry, omnitronGroup=omnitronGroup, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ftppasswrd=ftppasswrd, dhcpTagVid=dhcpTagVid, cnodeCIR=cnodeCIR, modsoftrev=modsoftrev, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, extended4=extended4, portSFPstatus=portSFPstatus, port3Membership=port3Membership, extended2=extended2, txLateCollision=txLateCollision, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, vlanidentifier=vlanidentifier, portcanonicalformatIndicator=portcanonicalformatIndicator, PYSNMP_MODULE_ID=omnitronMIB, modvlanTableClear=modvlanTableClear, portegresspolicy=portegresspolicy, modcommitVLANchanges=modcommitVLANchanges, omnitronCompliance=omnitronCompliance, txOctets=txOctets, port5Membership=port5Membership, omnitronMIB=omnitronMIB, moduleVLANEntry=moduleVLANEntry, partnum=partnum, ahFrameErrorEventTotal=ahFrameErrorEventTotal, switchstat=switchstat, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modname=modname, ahCriticalEventTrapList=ahCriticalEventTrapList, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, syscon=syscon, enableSNMPWrites=enableSNMPWrites, portIngressRateDropOrPause=portIngressRateDropOrPause, traphost7=traphost7, ahRemoteMuxState=ahRemoteMuxState, ahLocalLpbkTimeout=ahLocalLpbkTimeout, rxBroadcastPkts=rxBroadcastPkts, enableSNMPv3Function=enableSNMPv3Function, moduleCount=moduleCount, servicetag=servicetag, txCollisions=txCollisions, slaveTraps=slaveTraps, softrev=softrev, customertag=customertag, subnetmask2=subnetmask2, ipAddr=ipAddr, txDroppedEvents=txDroppedEvents, nmmOAMmgmtMode=nmmOAMmgmtMode, slaveWrite=slaveWrite, cpuVoltageOut=cpuVoltageOut, rxDropPkts=rxDropPkts, portSfpTemperature=portSfpTemperature, nmmSecureMode=nmmSecureMode, snmpv3PrivPassword=snmpv3PrivPassword, modprodrev=modprodrev, dhcptftpServerIpAddress=dhcptftpServerIpAddress, prodAgent=prodAgent, rxAlignmentErrors=rxAlignmentErrors, ahLocalMuxState=ahLocalMuxState, ostProtocolStatusEntry=ostProtocolStatusEntry, portnum=portnum, ahLocalMode=ahLocalMode, nmmCfgState=nmmCfgState, moduleVLANTable=moduleVLANTable, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, txDeferedTransmit=txDeferedTransmit, ahRemoteMode=ahRemoteMode, trapSrcIpSelect=trapSrcIpSelect, ahErroredFrameThreshold=ahErroredFrameThreshold, managementModule=managementModule, portSfpRxPower=portSfpRxPower, coreStatusOnly=coreStatusOnly, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, portSfpTxPower=portSfpTxPower, ostProtocolStatusState=ostProtocolStatusState, omnitronProducts=omnitronProducts, ahLocalOUI=ahLocalOUI, portLinkState=portLinkState, portState=portState, serialnum=serialnum, ostProtocolStatusTable=ostProtocolStatusTable, keepAliveInterval=keepAliveInterval, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, chassisnum=chassisnum, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portmlistcriteria=portmlistcriteria, modRestoreFactoryDefaults=modRestoreFactoryDefaults, modeType=modeType, portAHEntry=portAHEntry, portDuplex=portDuplex, sysloc=sysloc, moduleEntry=moduleEntry, dhcpPortNumber=dhcpPortNumber, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, tftpFileName=tftpFileName, snmpv3UserType=snmpv3UserType, userTable=userTable, cpuVoltageIn=cpuVoltageIn, ahCriticalEventMode=ahCriticalEventMode, txSingleCollision=txSingleCollision, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxOctets64=rxOctets64, ahLocalLinkFlags=ahLocalLinkFlags, traphost8=traphost8, rxSymbolErrors=rxSymbolErrors, portSfpBitRate=portSfpBitRate, omnitronConformance=omnitronConformance, txPausePkts=txPausePkts, selfSlot=selfSlot, modHwRev=modHwRev, portStatsEntry=portStatsEntry, modExpLedStatus=modExpLedStatus, wrswitch=wrswitch, serialpass=serialpass, rxPackets65to127=rxPackets65to127, rxCRCAlignErrors=rxCRCAlignErrors, modLM80currents=modLM80currents, portMacAddress=portMacAddress, chassisTable=chassisTable, txMulticastPkts=txMulticastPkts, portSFPpageA2=portSFPpageA2, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, traphost1=traphost1, omnitronCompliances=omnitronCompliances, traphost2=traphost2, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, txGoodPkts=txGoodPkts, portSpeed=portSpeed, modswbuildnum=modswbuildnum, port4Membership=port4Membership, chassisEntry=chassisEntry, modFpgaRev=modFpgaRev, ahRemoteParserState=ahRemoteParserState, modchassnum=modchassnum, txExcessiveCollision=txExcessiveCollision, ostProtocoManagementPort=ostProtocoManagementPort, omnitronGroups=omnitronGroups, userIndex=userIndex, nmmSecureConnState=nmmSecureConnState, rxOctets=rxOctets, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ledstat=ledstat, portSfpVendorPartNumber=portSfpVendorPartNumber, modPcbRev=modPcbRev, extended3=extended3, portSfpVcc=portSfpVcc, ipAddr2=ipAddr2, ahRemoteLinkFlags=ahRemoteLinkFlags, omnitronSFPGroup=omnitronSFPGroup, ahLocalSupportVar=ahLocalSupportVar, extended1=extended1, snmpv3UserName=snmpv3UserName, index=index, rxFCSErrors=rxFCSErrors, dhcpSubnetmask=dhcpSubnetmask, portAHTable=portAHTable, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, traphost3=traphost3, ahLpbkMode=ahLpbkMode, traphost5=traphost5, nmmIpProtocolState=nmmIpProtocolState, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modulename=modulename, extended6=extended6, portSFPTable=portSFPTable, resetmod=resetmod, txMultipleCollision=txMultipleCollision, snmpv3SecurityLevel=snmpv3SecurityLevel, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portEgressRate=portEgressRate, modenable802dot1qProcessing=modenable802dot1qProcessing, port1Membership=port1Membership)
mibBuilder.exportSymbols("OMNITRON-MIB", rxPackets512to1023=rxPackets512to1023, rxMulticastPkts=rxMulticastPkts, modslotnum=modslotnum, modchassname=modchassname, bootpEnable=bootpEnable, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, traphost4=traphost4, modLM80misc=modLM80misc, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ipaddr2EVCassociation=ipaddr2EVCassociation, snmpv3AuthPassword=snmpv3AuthPassword, port2Membership=port2Membership, nmmIpDisabled=nmmIpDisabled, modulePortsTable=modulePortsTable, rxJabbers=rxJabbers, gateway=gateway, rxErrorPkts=rxErrorPkts, mmname=mmname, vlanservicetag=vlanservicetag, portIngressRateCBS=portIngressRateCBS, nmmSecureSlaveSlot=nmmSecureSlaveSlot, rxTotalPkts=rxTotalPkts, txOctets64=txOctets64, vlanIdOst=vlanIdOst, modreset=modreset, subnetmask=subnetmask, tftpEnable=tftpEnable, ahLocalParserState=ahLocalParserState, mychassnum=mychassnum, rxPackets1024to1518=rxPackets1024to1518, manufdate=manufdate, gateway2=gateway2, prodrev=prodrev, chassis=chassis, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahFramePeriodEventTotal=ahFramePeriodEventTotal, rxUndersizePkts=rxUndersizePkts, ahRemoteLinkPort=ahRemoteLinkPort, port6Membership=port6Membership, modportvlan=modportvlan, portL2CPmgntProcessing=portL2CPmgntProcessing, ostProtocolStatusIndex=ostProtocolStatusIndex, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, portAccessType=portAccessType, modExpSoftwareRev=modExpSoftwareRev, rxUnicastPkts=rxUnicastPkts, prodtype=prodtype, txDropPkts=txDropPkts, vlanPri=vlanPri, snmpTrapType=snmpTrapType, rxPackets256to511=rxPackets256to511, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portSFPEntry=portSFPEntry, cpuTemperature=cpuTemperature, rxGoodPkts=rxGoodPkts, rxOversizePkts=rxOversizePkts)
