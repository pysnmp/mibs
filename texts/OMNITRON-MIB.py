...
mibBuilder.exportSymbols("OMNITRON-MIB", selfSlot=selfSlot, cnodeCIR=cnodeCIR, prodAgent=prodAgent, txPausePkts=txPausePkts, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, tftpFileName=tftpFileName, portIngressRateCBS=portIngressRateCBS, rxBroadcastPkts=rxBroadcastPkts, omnitronGroups=omnitronGroups, defaultForwardingMap=defaultForwardingMap, ostProtocolStatusEntry=ostProtocolStatusEntry, modcommitVLANchanges=modcommitVLANchanges, slaveTrapsForward=slaveTrapsForward, userTable=userTable, rxJabbers=rxJabbers, ahEnabled=ahEnabled, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portcanonicalformatIndicator=portcanonicalformatIndicator, index=index, nmmCfgState=nmmCfgState, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, rxGoodPkts=rxGoodPkts, vlanPri=vlanPri, vlanidentifier=vlanidentifier, ahCriticalEventMode=ahCriticalEventMode, modLM80currents=modLM80currents, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, sysDateTime=sysDateTime, modportvlan=modportvlan, modeType=modeType, muxGroupDefaults=muxGroupDefaults, modextfeaturebits=modextfeaturebits, prodtype=prodtype, modExpPartNumber=modExpPartNumber, slaveTraps=slaveTraps, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, modLM80volts=modLM80volts, resetmod=resetmod, rxErrorPkts=rxErrorPkts, modulename=modulename, portSpeed=portSpeed, modname=modname, portvlanidentifier=portvlanidentifier, omnitronGroup=omnitronGroup, portSFPstatus=portSFPstatus, txSingleCollision=txSingleCollision, enableSNMPv3Function=enableSNMPv3Function, portIngressRateDropOrPause=portIngressRateDropOrPause, ahLocalParserState=ahLocalParserState, extended6=extended6, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, cpuTemperature=cpuTemperature, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, extended3=extended3, modchasstype=modchasstype, portAHEntry=portAHEntry, txExcessiveCollision=txExcessiveCollision, ahLpbkMode=ahLpbkMode, portFwdCpuList=portFwdCpuList, ostProtocoManagementPort=ostProtocoManagementPort, modLM80misc=modLM80misc, txGoodPkts=txGoodPkts, chassisEntry=chassisEntry, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, extended4=extended4, moduleEntry=moduleEntry, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, partnum=partnum, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, modpartnum=modpartnum, traphost5=traphost5, omnitronMIB=omnitronMIB, cpuVoltageOut=cpuVoltageOut, vlanservicetag=vlanservicetag, rxPackets1024to1518=rxPackets1024to1518, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahRemoteLinkFlags=ahRemoteLinkFlags, bootpEnable=bootpEnable, validityflag=validityflag, nmmSecureConnState=nmmSecureConnState, telnetpass=telnetpass, traphost6=traphost6, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, modswbuildnum=modswbuildnum, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxUnicastPkts=rxUnicastPkts, cnodeControl=cnodeControl, modvlanTableClear=modvlanTableClear, dhcpTagVid=dhcpTagVid, portSfpVendorName=portSfpVendorName, omnitronConformance=omnitronConformance, port2Membership=port2Membership, managementModule=managementModule, traphost1=traphost1, modenable802dot1qProcessing=modenable802dot1qProcessing, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, slaveWrite=slaveWrite, ahLocalLinkFlags=ahLocalLinkFlags, snmpv3AuthPassword=snmpv3AuthPassword, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, txCollisions=txCollisions, txLateCollision=txLateCollision, portIngressRate=portIngressRate, txMultipleCollision=txMultipleCollision, enabledFunctions=enabledFunctions, ftppasswrd=ftppasswrd, dhcpSubnetmask=dhcpSubnetmask, portSfpBitRate=portSfpBitRate, traphost8=traphost8, modchassnum=modchassnum, rxPackets256to511=rxPackets256to511, ipaddr2EVCassociation=ipaddr2EVCassociation, modchassname=modchassname, subnetmask=subnetmask, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, port5Membership=port5Membership, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, rxCRCAlignErrors=rxCRCAlignErrors, txDropPkts=txDropPkts, txUnicastPkts=txUnicastPkts, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahLocalMode=ahLocalMode, slotnum=slotnum, portEgressQosPolicy=portEgressQosPolicy, ahCriticalEventTrapList=ahCriticalEventTrapList, modulePortsEntry=modulePortsEntry, modFpgaRev=modFpgaRev, trapSrcIpSelect=trapSrcIpSelect, keepAliveInterval=keepAliveInterval, portStatsEntry=portStatsEntry, ahFramePeriodEventTotal=ahFramePeriodEventTotal, extended1=extended1, vlanIdOst=vlanIdOst, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, chassis=chassis, txMulticastPkts=txMulticastPkts, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, modnumports=modnumports, capsMask=capsMask, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portSfpTxPower=portSfpTxPower, ahLocalLpbkTimeout=ahLocalLpbkTimeout, servicetag=servicetag, portegresspolicy=portegresspolicy, dhcpPortNumber=dhcpPortNumber, gateway2=gateway2, modcommitNMMCfgChanges=modcommitNMMCfgChanges, readCommunity=readCommunity, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, chassisname=chassisname, userEntry=userEntry, ahLocalOUI=ahLocalOUI, dhcpGateway=dhcpGateway, nmmSecureMode=nmmSecureMode, portSfpBiasCurrent=portSfpBiasCurrent, portnum=portnum, rxOversizePkts=rxOversizePkts, rxSymbolErrors=rxSymbolErrors, ahLocalSupportVar=ahLocalSupportVar, rxMulticastPkts=rxMulticastPkts, moduleVLANTable=moduleVLANTable, dhcpIpAddr=dhcpIpAddr, portAHTable=portAHTable, ahRemoteSupportVar=ahRemoteSupportVar, traphost2=traphost2, modExpLedStatus=modExpLedStatus, portSFPpageA2=portSFPpageA2, mmname=mmname, omnitronSFPGroup=omnitronSFPGroup, ipAddr2=ipAddr2, enableSNMPFunction=enableSNMPFunction, traphost3=traphost3, customertag=customertag, modRestoreFactoryDefaults=modRestoreFactoryDefaults, omnitronCompliance=omnitronCompliance, traphost4=traphost4, chassistype=chassistype, ostProtocolStatusIndex=ostProtocolStatusIndex, ostProtocolStatusState=ostProtocolStatusState, modserialnum=modserialnum, rxPackets65to127=rxPackets65to127, portFwdCpu=portFwdCpu, modreset=modreset, rxPackets128to255=rxPackets128to255, portSFPTable=portSFPTable, portmlistcriteria=portmlistcriteria, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ipaddrEVCassociation=ipaddrEVCassociation, userIndex=userIndex, nmmOAMmgmtMode=nmmOAMmgmtMode, ahErroredFrameThreshold=ahErroredFrameThreshold, portSfpRxPower=portSfpRxPower, rxTotalPkts=rxTotalPkts, macAddr=macAddr, modtagsubstitution=modtagsubstitution, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ahLocalMuxState=ahLocalMuxState, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostProtocolStatusTable=ostProtocolStatusTable, sysloc=sysloc, modsoftrev=modsoftrev, switchstat=switchstat, rxAlignmentErrors=rxAlignmentErrors, subnetmask2=subnetmask2, ahErroredFrameWindow=ahErroredFrameWindow, modulePortsTable=modulePortsTable, enhancedchassisTable=enhancedchassisTable, tftpEnable=tftpEnable, modslotnum=modslotnum, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, moduleVLANEntry=moduleVLANEntry, extended2=extended2, portDuplex=portDuplex, serialnum=serialnum, port3Membership=port3Membership, txOctets64=txOctets64, portSFPEntry=portSFPEntry, mychassnum=mychassnum, manufdate=manufdate, chassisTable=chassisTable, ahRemoteMode=ahRemoteMode, ostEnvironmentalTemperature=ostEnvironmentalTemperature, PYSNMP_MODULE_ID=omnitronMIB, sysAdminStatus=sysAdminStatus, portSfpVcc=portSfpVcc, rxOctets=rxOctets, omnitronCompliances=omnitronCompliances, portAccessType=portAccessType, snmpv3UserType=snmpv3UserType, modExpSoftwareRev=modExpSoftwareRev, omnitronProducts=omnitronProducts, ipAddr=ipAddr, port4Membership=port4Membership, rxFCSErrors=rxFCSErrors, portLinkState=portLinkState, ingressPolicingType=ingressPolicingType, ahClearStatistics=ahClearStatistics, portSfpDateCode=portSfpDateCode, chassisnum=chassisnum, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, gateway=gateway, coreStatusOnly=coreStatusOnly, portMacAddress=portMacAddress, port1Membership=port1Membership, rxFragments=rxFragments, snmpv3UserName=snmpv3UserName, rxDropPkts=rxDropPkts, prodrev=prodrev, txErrorPkts=txErrorPkts, portSfpVendorPartNumber=portSfpVendorPartNumber, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate)
mibBuilder.exportSymbols("OMNITRON-MIB", cpuVoltageIn=cpuVoltageIn, rxPackets64=rxPackets64, writeCommunity=writeCommunity, ahRemoteLinkPort=ahRemoteLinkPort, nmmIpProtocolState=nmmIpProtocolState, rxPackets512to1023=rxPackets512to1023, portingresssecurity=portingresssecurity, modmanufdate=modmanufdate, ahTransmissionRate=ahTransmissionRate, modHwRev=modHwRev, ahRemoteMuxState=ahRemoteMuxState, portStatsClear=portStatsClear, snmpTrapType=snmpTrapType, syscon=syscon, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, txBroadcastPkts=txBroadcastPkts, ostProtocolStatusType=ostProtocolStatusType, portEgressRate=portEgressRate, txOctets=txOctets, traphost7=traphost7, moduleMgtCfgTable=moduleMgtCfgTable, snmpv3PrivPassword=snmpv3PrivPassword, rxPausePkts=rxPausePkts, wrswitch=wrswitch, txDroppedEvents=txDroppedEvents, snmpv3SecurityLevel=snmpv3SecurityLevel, extended5=extended5, nmmIpDisabled=nmmIpDisabled, rxUndersizePkts=rxUndersizePkts, ahRemoteOUI=ahRemoteOUI, port6Membership=port6Membership, portL2CPmgntProcessing=portL2CPmgntProcessing, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, enableSNMPWrites=enableSNMPWrites, portSFPpageA0=portSFPpageA0, portpriority=portpriority, modprodrev=modprodrev, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, portSfpTemperature=portSfpTemperature, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahRemoteParserState=ahRemoteParserState, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modPcbRev=modPcbRev, rxOctets64=rxOctets64, moduleTable=moduleTable, serialpass=serialpass, moduleCount=moduleCount, portStatsTable=portStatsTable, softrev=softrev, moduleMgtCfgEntry=moduleMgtCfgEntry, portState=portState, modprodtype=modprodtype, txDeferedTransmit=txDeferedTransmit, ledstat=ledstat, tftpServerIpAddress=tftpServerIpAddress)
