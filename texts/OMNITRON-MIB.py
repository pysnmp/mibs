...
omnitron, OstModeType, OstPortNumber, icAgent, OstVlanId, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "omnitron", "OstModeType", "OstPortNumber", "icAgent", "OstVlanId", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", rxFragments=rxFragments, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modextfeaturebits=modextfeaturebits, traphost6=traphost6, extended2=extended2, rxUndersizePkts=rxUndersizePkts, userEntry=userEntry, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, omnitronMIB=omnitronMIB, portSfpBitRate=portSfpBitRate, portSFPEntry=portSFPEntry, portSFPTable=portSFPTable, userIndex=userIndex, txDroppedEvents=txDroppedEvents, port1Membership=port1Membership, snmpv3PrivPassword=snmpv3PrivPassword, modulePortsEntry=modulePortsEntry, vlanIdOst=vlanIdOst, sysAdminStatus=sysAdminStatus, modmanufdate=modmanufdate, extended4=extended4, portvlanidentifier=portvlanidentifier, defaultForwardingMap=defaultForwardingMap, nmmSecureMode=nmmSecureMode, modtagsubstitution=modtagsubstitution, ahEnabled=ahEnabled, modExpLedStatus=modExpLedStatus, portStatsClear=portStatsClear, rxPackets128to255=rxPackets128to255, ahTransmissionRate=ahTransmissionRate, portingresssecurity=portingresssecurity, modserialnum=modserialnum, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahCriticalEventTrapList=ahCriticalEventTrapList, serialnum=serialnum, portEgressQosPolicy=portEgressQosPolicy, portSFPpageA2=portSFPpageA2, capsMask=capsMask, omnitronGroups=omnitronGroups, subnetmask2=subnetmask2, rxDropPkts=rxDropPkts, selfSlot=selfSlot, modprodrev=modprodrev, portSfpVendorName=portSfpVendorName, manufdate=manufdate, portIngressRate=portIngressRate, txDeferedTransmit=txDeferedTransmit, moduleVLANTable=moduleVLANTable, chassis=chassis, extended3=extended3, ledstat=ledstat, ahFramePeriodEventTotal=ahFramePeriodEventTotal, prodAgent=prodAgent, ahLocalMuxState=ahLocalMuxState, portLinkState=portLinkState, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, gateway=gateway, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, traphost1=traphost1, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahFrameErrorEventTotal=ahFrameErrorEventTotal, userTable=userTable, ingressPolicingType=ingressPolicingType, telnetpass=telnetpass, portpriority=portpriority, portEgressRate=portEgressRate, txMulticastPkts=txMulticastPkts, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portSFPpageA0=portSFPpageA0, ahLocalLinkFlags=ahLocalLinkFlags, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, tftpFileName=tftpFileName, moduleMgtCfgEntry=moduleMgtCfgEntry, managementModule=managementModule, vlanPri=vlanPri, modreset=modreset, portFwdCpuList=portFwdCpuList, extended1=extended1, rxOversizePkts=rxOversizePkts, modslotnum=modslotnum, modenable802dot1qProcessing=modenable802dot1qProcessing, portFwdCpu=portFwdCpu, modnumports=modnumports, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, nmmIpProtocolState=nmmIpProtocolState, prodrev=prodrev, modPcbRev=modPcbRev, ahErroredFrameThreshold=ahErroredFrameThreshold, rxBroadcastPkts=rxBroadcastPkts, ahLocalMode=ahLocalMode, snmpv3AuthPassword=snmpv3AuthPassword, rxSymbolErrors=rxSymbolErrors, modeType=modeType, port2Membership=port2Membership, modExpPartNumber=modExpPartNumber, slaveTrapsForward=slaveTrapsForward, rxJabbers=rxJabbers, omnitronCompliance=omnitronCompliance, mmname=mmname, txOctets=txOctets, rxErrorPkts=rxErrorPkts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, rxUnicastPkts=rxUnicastPkts, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portSfpRxPower=portSfpRxPower, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, slaveWrite=slaveWrite, modLM80volts=modLM80volts, nmmSecureConnState=nmmSecureConnState, ahLocalParserState=ahLocalParserState, nmmOAMmgmtMode=nmmOAMmgmtMode, readCommunity=readCommunity, rxOctets=rxOctets, portSfpBiasCurrent=portSfpBiasCurrent, port5Membership=port5Membership, portIngressRateCBS=portIngressRateCBS, snmpTrapType=snmpTrapType, txLateCollision=txLateCollision, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, syscon=syscon, ahRemoteMuxState=ahRemoteMuxState, moduleEntry=moduleEntry, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portSfpVcc=portSfpVcc, portAccessType=portAccessType, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ahLpbkMode=ahLpbkMode, ahLocalOUI=ahLocalOUI, rxFCSErrors=rxFCSErrors, txDropPkts=txDropPkts, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modExpSoftwareRev=modExpSoftwareRev, omnitronConformance=omnitronConformance, enableSNMPWrites=enableSNMPWrites, sysloc=sysloc, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, tftpServerIpAddress=tftpServerIpAddress, portStatsEntry=portStatsEntry, portMacAddress=portMacAddress, rxGoodPkts=rxGoodPkts, moduleMgtCfgTable=moduleMgtCfgTable, ostProtocolStatusType=ostProtocolStatusType, rxPackets64=rxPackets64, rxAlignmentErrors=rxAlignmentErrors, extended6=extended6, portSfpVendorPartNumber=portSfpVendorPartNumber, rxPausePkts=rxPausePkts, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxTotalPkts=rxTotalPkts, traphost4=traphost4, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, sysDateTime=sysDateTime, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, rxPackets512to1023=rxPackets512to1023, moduleTable=moduleTable, snmpv3UserType=snmpv3UserType, ostProtocolStatusState=ostProtocolStatusState, txExcessiveCollision=txExcessiveCollision, rxMulticastPkts=rxMulticastPkts, port4Membership=port4Membership, ipAddr=ipAddr, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, chassisname=chassisname, resetmod=resetmod, txPausePkts=txPausePkts, portIngressRateDropOrPause=portIngressRateDropOrPause, portSfpTemperature=portSfpTemperature, ostProtocolStatusIndex=ostProtocolStatusIndex, tftpEnable=tftpEnable, portSpeed=portSpeed, traphost8=traphost8, txUnicastPkts=txUnicastPkts, traphost3=traphost3, dhcptftpServerIpAddress=dhcptftpServerIpAddress, modulename=modulename, subnetmask=subnetmask, PYSNMP_MODULE_ID=omnitronMIB, modHwRev=modHwRev, index=index, portcanonicalformatIndicator=portcanonicalformatIndicator, portmlistcriteria=portmlistcriteria, modportvlan=modportvlan, chassistype=chassistype, moduleVLANEntry=moduleVLANEntry, mychassnum=mychassnum, omnitronProducts=omnitronProducts, modsoftrev=modsoftrev, modchassnum=modchassnum, enableSNMPv3Function=enableSNMPv3Function, chassisEntry=chassisEntry, traphost2=traphost2, portSfpDateCode=portSfpDateCode, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, cpuTemperature=cpuTemperature, portSFPstatus=portSFPstatus, enhancedchassisTable=enhancedchassisTable, portDuplex=portDuplex, txMultipleCollision=txMultipleCollision, portState=portState, dhcpPortNumber=dhcpPortNumber, slaveTraps=slaveTraps, moduleCount=moduleCount, ostProtocoManagementPort=ostProtocoManagementPort, cnodeCIR=cnodeCIR, ahRemoteOUI=ahRemoteOUI, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahErroredFrameWindow=ahErroredFrameWindow, muxGroupDefaults=muxGroupDefaults, modswbuildnum=modswbuildnum, slotnum=slotnum, ahCriticalEventMode=ahCriticalEventMode, modcommitVLANchanges=modcommitVLANchanges, portSfpTxPower=portSfpTxPower, nmmIpDisabled=nmmIpDisabled, softrev=softrev, bootpEnable=bootpEnable, wrswitch=wrswitch, rxPackets1024to1518=rxPackets1024to1518, cnodeControl=cnodeControl, modLM80misc=modLM80misc, modname=modname, macAddr=macAddr, portnum=portnum, modprodtype=modprodtype, rxCRCAlignErrors=rxCRCAlignErrors, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, keepAliveInterval=keepAliveInterval, txOctets64=txOctets64, port3Membership=port3Membership, dhcpIpAddr=dhcpIpAddr, customertag=customertag, ahLocalSupportVar=ahLocalSupportVar, portL2CPmgntProcessing=portL2CPmgntProcessing, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modchassname=modchassname, dhcpGateway=dhcpGateway, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modpartnum=modpartnum, chassisnum=chassisnum, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, portegresspolicy=portegresspolicy, portStatsTable=portStatsTable, ahClearStatistics=ahClearStatistics, ahRemoteLinkFlags=ahRemoteLinkFlags, extended5=extended5, ipaddr2EVCassociation=ipaddr2EVCassociation, vlanservicetag=vlanservicetag, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, rxPackets256to511=rxPackets256to511, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, nmmCfgState=nmmCfgState, writeCommunity=writeCommunity)
mibBuilder.exportSymbols("OMNITRON-MIB", modRestoreFactoryDefaults=modRestoreFactoryDefaults, cpuVoltageIn=cpuVoltageIn, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahRemoteSupportVar=ahRemoteSupportVar, ahRemoteParserState=ahRemoteParserState, cpuVoltageOut=cpuVoltageOut, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, traphost7=traphost7, traphost5=traphost5, txBroadcastPkts=txBroadcastPkts, rxPackets65to127=rxPackets65to127, modulePortsTable=modulePortsTable, modchasstype=modchasstype, partnum=partnum, port6Membership=port6Membership, rxOctets64=rxOctets64, dhcpTagVid=dhcpTagVid, txErrorPkts=txErrorPkts, ostProtocolStatusTable=ostProtocolStatusTable, ipaddrEVCassociation=ipaddrEVCassociation, prodtype=prodtype, servicetag=servicetag, ostProtocolStatusEntry=ostProtocolStatusEntry, switchstat=switchstat, ostEnvironmentalTemperature=ostEnvironmentalTemperature, snmpv3SecurityLevel=snmpv3SecurityLevel, txSingleCollision=txSingleCollision, ahRemoteMode=ahRemoteMode, omnitronSFPGroup=omnitronSFPGroup, portAHTable=portAHTable, vlanidentifier=vlanidentifier, coreStatusOnly=coreStatusOnly, portAHEntry=portAHEntry, omnitronGroup=omnitronGroup, validityflag=validityflag, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahRemoteLinkPort=ahRemoteLinkPort, serialpass=serialpass, trapSrcIpSelect=trapSrcIpSelect, dhcpSubnetmask=dhcpSubnetmask, ftppasswrd=ftppasswrd, modLM80currents=modLM80currents, modFpgaRev=modFpgaRev, snmpv3UserName=snmpv3UserName, txCollisions=txCollisions, modvlanTableClear=modvlanTableClear, ipAddr2=ipAddr2, enableSNMPFunction=enableSNMPFunction, omnitronCompliances=omnitronCompliances, txGoodPkts=txGoodPkts, chassisTable=chassisTable, enabledFunctions=enabledFunctions, gateway2=gateway2)
