...
OstPortList, omnitron, OstVlanId, icAgent, OstPortNumber, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortList", "omnitron", "OstVlanId", "icAgent", "OstPortNumber", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", traphost5=traphost5, serialpass=serialpass, traphost4=traphost4, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, txSingleCollision=txSingleCollision, portSFPEntry=portSFPEntry, portStatsClear=portStatsClear, omnitronCompliance=omnitronCompliance, resetmod=resetmod, ahLocalSupportVar=ahLocalSupportVar, tftpEnable=tftpEnable, ahLocalMuxState=ahLocalMuxState, portSfpRxPower=portSfpRxPower, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, vlanPri=vlanPri, rxOctets64=rxOctets64, enableSNMPv3Function=enableSNMPv3Function, modnumports=modnumports, modExpPartNumber=modExpPartNumber, portpriority=portpriority, snmpv3UserType=snmpv3UserType, rxPackets64=rxPackets64, portAccessType=portAccessType, subnetmask=subnetmask, ahRemoteMuxState=ahRemoteMuxState, portSFPpageA0=portSFPpageA0, wrswitch=wrswitch, modtagsubstitution=modtagsubstitution, modpartnum=modpartnum, modsoftrev=modsoftrev, port1Membership=port1Membership, txExcessiveCollision=txExcessiveCollision, portSfpBiasCurrent=portSfpBiasCurrent, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxTotalPkts=rxTotalPkts, manufdate=manufdate, portSfpVendorName=portSfpVendorName, chassistype=chassistype, txDroppedEvents=txDroppedEvents, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ftppasswrd=ftppasswrd, modHwRev=modHwRev, portSFPpageA2=portSFPpageA2, macAddr=macAddr, ahTransmissionRate=ahTransmissionRate, ostProtocolStatusTable=ostProtocolStatusTable, ahLocalParserState=ahLocalParserState, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, mmname=mmname, omnitronCompliances=omnitronCompliances, rxFragments=rxFragments, switchstat=switchstat, modulename=modulename, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portFwdCpuList=portFwdCpuList, txUnicastPkts=txUnicastPkts, ostProtocolStatusState=ostProtocolStatusState, ahLocalMode=ahLocalMode, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, extended4=extended4, portLinkState=portLinkState, ostEnvironmentalTemperature=ostEnvironmentalTemperature, userEntry=userEntry, enabledFunctions=enabledFunctions, ahCriticalEventMode=ahCriticalEventMode, nmmSecureConnState=nmmSecureConnState, chassisname=chassisname, portStatsTable=portStatsTable, txDeferedTransmit=txDeferedTransmit, portSfpDateCode=portSfpDateCode, rxUnicastPkts=rxUnicastPkts, slotnum=slotnum, capsMask=capsMask, servicetag=servicetag, portSfpBitRate=portSfpBitRate, PYSNMP_MODULE_ID=omnitronMIB, snmpv3SecurityLevel=snmpv3SecurityLevel, dhcpPortNumber=dhcpPortNumber, slaveTrapsForward=slaveTrapsForward, portingresssecurity=portingresssecurity, portSFPstatus=portSFPstatus, omnitronSFPGroup=omnitronSFPGroup, modenable802dot1qProcessing=modenable802dot1qProcessing, portIngressRateCBS=portIngressRateCBS, gateway2=gateway2, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, slaveWrite=slaveWrite, partnum=partnum, moduleMgtCfgTable=moduleMgtCfgTable, txOctets64=txOctets64, extended1=extended1, modportvlan=modportvlan, chassisEntry=chassisEntry, moduleTable=moduleTable, rxFCSErrors=rxFCSErrors, rxUndersizePkts=rxUndersizePkts, ahLocalOUI=ahLocalOUI, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahRemoteLinkPort=ahRemoteLinkPort, snmpv3PrivPassword=snmpv3PrivPassword, rxPausePkts=rxPausePkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, extended2=extended2, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modswbuildnum=modswbuildnum, moduleEntry=moduleEntry, moduleMgtCfgEntry=moduleMgtCfgEntry, modeType=modeType, cpuTemperature=cpuTemperature, portegresspolicy=portegresspolicy, traphost3=traphost3, rxDropPkts=rxDropPkts, ipAddr=ipAddr, modprodtype=modprodtype, ahRemoteOUI=ahRemoteOUI, modreset=modreset, txDropPkts=txDropPkts, modFpgaRev=modFpgaRev, enableSNMPFunction=enableSNMPFunction, index=index, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modchasstype=modchasstype, portIngressRate=portIngressRate, port5Membership=port5Membership, nmmIpProtocolState=nmmIpProtocolState, dhcpGateway=dhcpGateway, portFwdCpu=portFwdCpu, traphost2=traphost2, snmpv3UserName=snmpv3UserName, txMulticastPkts=txMulticastPkts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, syscon=syscon, ostProtocolStatusEntry=ostProtocolStatusEntry, ahCriticalEventTrapList=ahCriticalEventTrapList, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, nmmSecureMode=nmmSecureMode, ahErroredFrameWindow=ahErroredFrameWindow, rxOctets=rxOctets, ahRemoteMode=ahRemoteMode, txMultipleCollision=txMultipleCollision, modExpLedStatus=modExpLedStatus, extended3=extended3, modLM80currents=modLM80currents, nmmCfgState=nmmCfgState, rxPackets256to511=rxPackets256to511, ahRemoteParserState=ahRemoteParserState, modextfeaturebits=modextfeaturebits, portStatsEntry=portStatsEntry, managementModule=managementModule, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, nmmOAMmgmtMode=nmmOAMmgmtMode, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portState=portState, modulePortsEntry=modulePortsEntry, modchassnum=modchassnum, defaultForwardingMap=defaultForwardingMap, rxAlignmentErrors=rxAlignmentErrors, portSfpTxPower=portSfpTxPower, ostProtocolStatusType=ostProtocolStatusType, gateway=gateway, modulePortsTable=modulePortsTable, txGoodPkts=txGoodPkts, dhcpSubnetmask=dhcpSubnetmask, omnitronGroup=omnitronGroup, sysDateTime=sysDateTime, mychassnum=mychassnum, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ostProtocolStatusIndex=ostProtocolStatusIndex, enhancedchassisTable=enhancedchassisTable, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, userIndex=userIndex, modserialnum=modserialnum, chassisnum=chassisnum, portSFPTable=portSFPTable, ahClearStatistics=ahClearStatistics, ahErroredFrameThreshold=ahErroredFrameThreshold, rxOversizePkts=rxOversizePkts, traphost8=traphost8, port6Membership=port6Membership, validityflag=validityflag, moduleVLANEntry=moduleVLANEntry, ipaddr2EVCassociation=ipaddr2EVCassociation, portSfpTemperature=portSfpTemperature, modcommitVLANchanges=modcommitVLANchanges, portL2CPmgntProcessing=portL2CPmgntProcessing, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, portvlanidentifier=portvlanidentifier, rxJabbers=rxJabbers, telnetpass=telnetpass, modLM80volts=modLM80volts, customertag=customertag, traphost6=traphost6, chassisTable=chassisTable, modmanufdate=modmanufdate, modslotnum=modslotnum, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, prodtype=prodtype, snmpv3AuthPassword=snmpv3AuthPassword, portSpeed=portSpeed, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, rxPackets512to1023=rxPackets512to1023, portIngressRateDropOrPause=portIngressRateDropOrPause, modchassname=modchassname, omnitronGroups=omnitronGroups, omnitronConformance=omnitronConformance, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portDuplex=portDuplex, muxGroupDefaults=muxGroupDefaults, ahEnabled=ahEnabled, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, extended5=extended5, portnum=portnum, rxBroadcastPkts=rxBroadcastPkts, omnitronMIB=omnitronMIB, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ipAddr2=ipAddr2, trapSrcIpSelect=trapSrcIpSelect, dhcpTagVid=dhcpTagVid, ahRemoteLinkFlags=ahRemoteLinkFlags, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modvlanTableClear=modvlanTableClear, softrev=softrev, cpuVoltageIn=cpuVoltageIn, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ledstat=ledstat, rxPackets128to255=rxPackets128to255, snmpTrapType=snmpTrapType, portSfpVendorPartNumber=portSfpVendorPartNumber, ahFrameErrorEventTotal=ahFrameErrorEventTotal, sysloc=sysloc, modname=modname, sysAdminStatus=sysAdminStatus, readCommunity=readCommunity, ostProtocoManagementPort=ostProtocoManagementPort, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, portAHEntry=portAHEntry, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, port4Membership=port4Membership, portAHTable=portAHTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, txOctets=txOctets, portEgressRate=portEgressRate, vlanidentifier=vlanidentifier, portEgressQosPolicy=portEgressQosPolicy, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, subnetmask2=subnetmask2, txLateCollision=txLateCollision, serialnum=serialnum, txErrorPkts=txErrorPkts, rxCRCAlignErrors=rxCRCAlignErrors, modPcbRev=modPcbRev)
mibBuilder.exportSymbols("OMNITRON-MIB", modLM80misc=modLM80misc, txCollisions=txCollisions, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portcanonicalformatIndicator=portcanonicalformatIndicator, ahLocalLinkFlags=ahLocalLinkFlags, chassis=chassis, rxGoodPkts=rxGoodPkts, rxPackets65to127=rxPackets65to127, txPausePkts=txPausePkts, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, extended6=extended6, tftpServerIpAddress=tftpServerIpAddress, rxErrorPkts=rxErrorPkts, prodrev=prodrev, vlanIdOst=vlanIdOst, portSfpVcc=portSfpVcc, traphost7=traphost7, cpuVoltageOut=cpuVoltageOut, ahLpbkMode=ahLpbkMode, modprodrev=modprodrev, keepAliveInterval=keepAliveInterval, ingressPolicingType=ingressPolicingType, rxMulticastPkts=rxMulticastPkts, tftpFileName=tftpFileName, ahRemoteSupportVar=ahRemoteSupportVar, txBroadcastPkts=txBroadcastPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, selfSlot=selfSlot, cnodeCIR=cnodeCIR, cnodeControl=cnodeControl, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, slaveTraps=slaveTraps, ipaddrEVCassociation=ipaddrEVCassociation, moduleCount=moduleCount, coreStatusOnly=coreStatusOnly, vlanservicetag=vlanservicetag, userTable=userTable, rxSymbolErrors=rxSymbolErrors, nmmIpDisabled=nmmIpDisabled, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, writeCommunity=writeCommunity, bootpEnable=bootpEnable, moduleVLANTable=moduleVLANTable, modExpSoftwareRev=modExpSoftwareRev, port2Membership=port2Membership, prodAgent=prodAgent, traphost1=traphost1, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portMacAddress=portMacAddress, port3Membership=port3Membership, portmlistcriteria=portmlistcriteria, rxPackets1024to1518=rxPackets1024to1518, dhcpIpAddr=dhcpIpAddr, omnitronProducts=omnitronProducts, enableSNMPWrites=enableSNMPWrites)
