...
OstPortList, OstVlanId, omnitron, OstPortNumber, OstModeType, icAgent = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortList", "OstVlanId", "omnitron", "OstPortNumber", "OstModeType", "icAgent")
...
mibBuilder.exportSymbols("OMNITRON-MIB", keepAliveInterval=keepAliveInterval, prodtype=prodtype, portSfpDateCode=portSfpDateCode, partnum=partnum, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portFwdCpu=portFwdCpu, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, rxAlignmentErrors=rxAlignmentErrors, snmpv3AuthPassword=snmpv3AuthPassword, readCommunity=readCommunity, ahLocalOUI=ahLocalOUI, modportvlan=modportvlan, subnetmask2=subnetmask2, muxGroupDefaults=muxGroupDefaults, rxJabbers=rxJabbers, portL2CPmgntProcessing=portL2CPmgntProcessing, txGoodPkts=txGoodPkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ahCriticalEventTrapList=ahCriticalEventTrapList, port6Membership=port6Membership, ahRemoteSupportVar=ahRemoteSupportVar, modenable802dot1qProcessing=modenable802dot1qProcessing, omnitronGroup=omnitronGroup, omnitronProducts=omnitronProducts, txDroppedEvents=txDroppedEvents, serialnum=serialnum, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modulename=modulename, bootpEnable=bootpEnable, rxFragments=rxFragments, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, txDropPkts=txDropPkts, snmpv3UserName=snmpv3UserName, vlanPri=vlanPri, vlanidentifier=vlanidentifier, portSfpBiasCurrent=portSfpBiasCurrent, prodrev=prodrev, omnitronConformance=omnitronConformance, nmmIpProtocolState=nmmIpProtocolState, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostProtocolStatusType=ostProtocolStatusType, traphost4=traphost4, mychassnum=mychassnum, rxPackets65to127=rxPackets65to127, syscon=syscon, txOctets64=txOctets64, userIndex=userIndex, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ahLocalMode=ahLocalMode, ostProtocolStatusTable=ostProtocolStatusTable, portmlistcriteria=portmlistcriteria, portIngressRateCBS=portIngressRateCBS, ahRemoteOUI=ahRemoteOUI, rxGoodPkts=rxGoodPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, trapSrcIpSelect=trapSrcIpSelect, moduleCount=moduleCount, moduleTable=moduleTable, subnetmask=subnetmask, capsMask=capsMask, ahErroredFrameThreshold=ahErroredFrameThreshold, ahTransmissionRate=ahTransmissionRate, enhancedchassisTable=enhancedchassisTable, portSfpVendorPartNumber=portSfpVendorPartNumber, chassisEntry=chassisEntry, ahRemoteMode=ahRemoteMode, moduleEntry=moduleEntry, gateway2=gateway2, portingresssecurity=portingresssecurity, ahRemoteParserState=ahRemoteParserState, chassisnum=chassisnum, modulePortsTable=modulePortsTable, prodAgent=prodAgent, nmmCfgState=nmmCfgState, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modswbuildnum=modswbuildnum, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, telnetpass=telnetpass, rxCRCAlignErrors=rxCRCAlignErrors, txSingleCollision=txSingleCollision, txMulticastPkts=txMulticastPkts, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxUndersizePkts=rxUndersizePkts, moduleMgtCfgTable=moduleMgtCfgTable, userTable=userTable, portSFPpageA2=portSFPpageA2, omnitronMIB=omnitronMIB, extended5=extended5, omnitronCompliance=omnitronCompliance, txOctets=txOctets, mmname=mmname, modslotnum=modslotnum, ahClearStatistics=ahClearStatistics, omnitronSFPGroup=omnitronSFPGroup, port3Membership=port3Membership, modmanufdate=modmanufdate, snmpTrapType=snmpTrapType, portSfpVendorName=portSfpVendorName, rxBroadcastPkts=rxBroadcastPkts, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, cnodeCIR=cnodeCIR, modExpLedStatus=modExpLedStatus, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portStatsClear=portStatsClear, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modFpgaRev=modFpgaRev, modchassname=modchassname, gateway=gateway, port2Membership=port2Membership, modprodtype=modprodtype, snmpv3PrivPassword=snmpv3PrivPassword, cpuTemperature=cpuTemperature, enableSNMPv3Function=enableSNMPv3Function, ahLocalParserState=ahLocalParserState, rxUnicastPkts=rxUnicastPkts, userEntry=userEntry, ahLpbkMode=ahLpbkMode, txCollisions=txCollisions, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, rxMulticastPkts=rxMulticastPkts, extended3=extended3, modchasstype=modchasstype, extended1=extended1, modHwRev=modHwRev, modulePortsEntry=modulePortsEntry, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, txExcessiveCollision=txExcessiveCollision, omnitronGroups=omnitronGroups, traphost6=traphost6, slotnum=slotnum, dhcpSubnetmask=dhcpSubnetmask, traphost8=traphost8, ipaddr2EVCassociation=ipaddr2EVCassociation, ostProtocolStatusEntry=ostProtocolStatusEntry, modLM80volts=modLM80volts, modextfeaturebits=modextfeaturebits, portMacAddress=portMacAddress, extended2=extended2, ostProtocolStatusIndex=ostProtocolStatusIndex, vlanservicetag=vlanservicetag, txDeferedTransmit=txDeferedTransmit, rxPackets128to255=rxPackets128to255, rxFCSErrors=rxFCSErrors, macAddr=macAddr, portSFPstatus=portSFPstatus, portFwdCpuList=portFwdCpuList, rxSymbolErrors=rxSymbolErrors, moduleVLANEntry=moduleVLANEntry, port1Membership=port1Membership, ahRemoteLinkFlags=ahRemoteLinkFlags, portSfpVcc=portSfpVcc, portSFPTable=portSFPTable, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portAHEntry=portAHEntry, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, manufdate=manufdate, ahLocalMuxState=ahLocalMuxState, portSfpRxPower=portSfpRxPower, modtagsubstitution=modtagsubstitution, ahCriticalEventMode=ahCriticalEventMode, ipAddr=ipAddr, modchassnum=modchassnum, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, moduleVLANTable=moduleVLANTable, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, nmmSecureConnState=nmmSecureConnState, portSFPEntry=portSFPEntry, rxPausePkts=rxPausePkts, ahEnabled=ahEnabled, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, enableSNMPWrites=enableSNMPWrites, portnum=portnum, snmpv3SecurityLevel=snmpv3SecurityLevel, defaultForwardingMap=defaultForwardingMap, ahErroredFrameWindow=ahErroredFrameWindow, ahRemoteMuxState=ahRemoteMuxState, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modpartnum=modpartnum, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modLM80misc=modLM80misc, ipaddrEVCassociation=ipaddrEVCassociation, modcommitVLANchanges=modcommitVLANchanges, sysDateTime=sysDateTime, ostProtocoManagementPort=ostProtocoManagementPort, tftpFileName=tftpFileName, omnitronCompliances=omnitronCompliances, txMultipleCollision=txMultipleCollision, txLateCollision=txLateCollision, portAHTable=portAHTable, dhcpIpAddr=dhcpIpAddr, nmmSecureMode=nmmSecureMode, portAccessType=portAccessType, rxOctets=rxOctets, modserialnum=modserialnum, cpuVoltageOut=cpuVoltageOut, vlanIdOst=vlanIdOst, portpriority=portpriority, softrev=softrev, snmpv3UserType=snmpv3UserType, extended6=extended6, portSfpTemperature=portSfpTemperature, modname=modname, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, portegresspolicy=portegresspolicy, modExpSoftwareRev=modExpSoftwareRev, portEgressRate=portEgressRate, txUnicastPkts=txUnicastPkts, traphost2=traphost2, extended4=extended4, traphost1=traphost1, nmmSecureSlaveSlot=nmmSecureSlaveSlot, serialpass=serialpass, traphost5=traphost5, portDuplex=portDuplex, portState=portState, enableSNMPFunction=enableSNMPFunction, modsoftrev=modsoftrev, portStatsTable=portStatsTable, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, rxOctets64=rxOctets64, rxPackets1024to1518=rxPackets1024to1518, validityflag=validityflag, port5Membership=port5Membership, sysloc=sysloc, rxTotalPkts=rxTotalPkts, modvlanTableClear=modvlanTableClear, index=index, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modreset=modreset, chassisname=chassisname, portSfpBitRate=portSfpBitRate, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portSfpTxPower=portSfpTxPower, managementModule=managementModule, port4Membership=port4Membership, rxPackets512to1023=rxPackets512to1023, slaveTrapsForward=slaveTrapsForward, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxPackets64=rxPackets64, slaveTraps=slaveTraps, txErrorPkts=txErrorPkts, ipAddr2=ipAddr2, ahLocalLpbkTimeout=ahLocalLpbkTimeout, nmmIpDisabled=nmmIpDisabled, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, chassistype=chassistype, portvlanidentifier=portvlanidentifier, moduleMgtCfgEntry=moduleMgtCfgEntry, rxOversizePkts=rxOversizePkts, ledstat=ledstat, switchstat=switchstat)
mibBuilder.exportSymbols("OMNITRON-MIB", traphost3=traphost3, customertag=customertag, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, portSFPpageA0=portSFPpageA0, nmmOAMmgmtMode=nmmOAMmgmtMode, sysAdminStatus=sysAdminStatus, modLM80currents=modLM80currents, modRestoreFactoryDefaults=modRestoreFactoryDefaults, chassisTable=chassisTable, servicetag=servicetag, modnumports=modnumports, selfSlot=selfSlot, rxDropPkts=rxDropPkts, ftppasswrd=ftppasswrd, modeType=modeType, modPcbRev=modPcbRev, portSpeed=portSpeed, ostProtocolStatusState=ostProtocolStatusState, portEgressQosPolicy=portEgressQosPolicy, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, modExpPartNumber=modExpPartNumber, traphost7=traphost7, ahRemoteLinkPort=ahRemoteLinkPort, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, enabledFunctions=enabledFunctions, ahLocalSupportVar=ahLocalSupportVar, rxErrorPkts=rxErrorPkts, chassis=chassis, modprodrev=modprodrev, cpuVoltageIn=cpuVoltageIn, cnodeControl=cnodeControl, tftpEnable=tftpEnable, tftpServerIpAddress=tftpServerIpAddress, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ingressPolicingType=ingressPolicingType, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, txPausePkts=txPausePkts, dhcpTagVid=dhcpTagVid, dhcpGateway=dhcpGateway, portLinkState=portLinkState, wrswitch=wrswitch, writeCommunity=writeCommunity, PYSNMP_MODULE_ID=omnitronMIB, coreStatusOnly=coreStatusOnly, slaveWrite=slaveWrite, portStatsEntry=portStatsEntry, portIngressRate=portIngressRate, ahLocalLinkFlags=ahLocalLinkFlags, portIngressRateDropOrPause=portIngressRateDropOrPause, rxPackets256to511=rxPackets256to511, resetmod=resetmod, portcanonicalformatIndicator=portcanonicalformatIndicator, txBroadcastPkts=txBroadcastPkts, dhcpPortNumber=dhcpPortNumber, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahFrameErrorEventTotal=ahFrameErrorEventTotal)
