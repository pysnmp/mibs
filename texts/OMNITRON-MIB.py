...
OstVlanId, omnitron, OstPortList, OstModeType, icAgent, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "omnitron", "OstPortList", "OstModeType", "icAgent", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", dhcpTagVid=dhcpTagVid, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, moduleVLANTable=moduleVLANTable, traphost2=traphost2, telnetpass=telnetpass, enabledFunctions=enabledFunctions, rxPackets1024to1518=rxPackets1024to1518, modtagsubstitution=modtagsubstitution, moduleVLANEntry=moduleVLANEntry, rxFragments=rxFragments, portSFPEntry=portSFPEntry, modcommitVLANchanges=modcommitVLANchanges, chassisnum=chassisnum, extended4=extended4, rxPackets64=rxPackets64, portmlistcriteria=portmlistcriteria, chassisEntry=chassisEntry, txMultipleCollision=txMultipleCollision, port3Membership=port3Membership, userIndex=userIndex, dhcpIpAddr=dhcpIpAddr, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modmanufdate=modmanufdate, txUnicastPkts=txUnicastPkts, portSfpTemperature=portSfpTemperature, ahLocalParserState=ahLocalParserState, enableSNMPv3Function=enableSNMPv3Function, ostEnvironmentalTemperature=ostEnvironmentalTemperature, subnetmask2=subnetmask2, serialnum=serialnum, ipAddr=ipAddr, modreset=modreset, serialpass=serialpass, sysAdminStatus=sysAdminStatus, softrev=softrev, servicetag=servicetag, ahFramePeriodEventTotal=ahFramePeriodEventTotal, switchstat=switchstat, chassis=chassis, validityflag=validityflag, dhcptftpServerIpAddress=dhcptftpServerIpAddress, txLateCollision=txLateCollision, trapSrcIpSelect=trapSrcIpSelect, rxFCSErrors=rxFCSErrors, extended2=extended2, chassisTable=chassisTable, ostProtocoManagementPort=ostProtocoManagementPort, modchasstype=modchasstype, cnodeControl=cnodeControl, modulename=modulename, rxDropPkts=rxDropPkts, customertag=customertag, txPausePkts=txPausePkts, txOctets=txOctets, enhancedchassisTable=enhancedchassisTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, portStatsEntry=portStatsEntry, portEgressQosPolicy=portEgressQosPolicy, snmpv3AuthPassword=snmpv3AuthPassword, extended3=extended3, modname=modname, dhcpPortNumber=dhcpPortNumber, omnitronGroup=omnitronGroup, port4Membership=port4Membership, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxPackets256to511=rxPackets256to511, syscon=syscon, sysDateTime=sysDateTime, modExpSoftwareRev=modExpSoftwareRev, ipaddr2EVCassociation=ipaddr2EVCassociation, cnodeCIR=cnodeCIR, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostProtocolStatusState=ostProtocolStatusState, portSfpDateCode=portSfpDateCode, portEgressRate=portEgressRate, slaveTraps=slaveTraps, mychassnum=mychassnum, cpuVoltageOut=cpuVoltageOut, resetmod=resetmod, portLinkState=portLinkState, dhcpGateway=dhcpGateway, port6Membership=port6Membership, modPcbRev=modPcbRev, txGoodPkts=txGoodPkts, portSfpTxPower=portSfpTxPower, txSingleCollision=txSingleCollision, modLM80misc=modLM80misc, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, modextfeaturebits=modextfeaturebits, tftpFileName=tftpFileName, modulePortsTable=modulePortsTable, portSfpVendorName=portSfpVendorName, ipaddrEVCassociation=ipaddrEVCassociation, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, txOctets64=txOctets64, ahRemoteParserState=ahRemoteParserState, portAHTable=portAHTable, readCommunity=readCommunity, modulePortsEntry=modulePortsEntry, rxTotalPkts=rxTotalPkts, cpuTemperature=cpuTemperature, ahRemoteSupportVar=ahRemoteSupportVar, portvlanidentifier=portvlanidentifier, chassisname=chassisname, ahErroredFrameWindow=ahErroredFrameWindow, omnitronProducts=omnitronProducts, nmmIpProtocolState=nmmIpProtocolState, modFpgaRev=modFpgaRev, port2Membership=port2Membership, txBroadcastPkts=txBroadcastPkts, tftpServerIpAddress=tftpServerIpAddress, dhcpSubnetmask=dhcpSubnetmask, enableSNMPFunction=enableSNMPFunction, rxPackets512to1023=rxPackets512to1023, nmmSecureMode=nmmSecureMode, moduleCount=moduleCount, portpriority=portpriority, modHwRev=modHwRev, portSfpBitRate=portSfpBitRate, ostProtocolStatusTable=ostProtocolStatusTable, txCollisions=txCollisions, portegresspolicy=portegresspolicy, vlanidentifier=vlanidentifier, portSFPpageA0=portSFPpageA0, ahLocalMode=ahLocalMode, modLM80volts=modLM80volts, selfSlot=selfSlot, portIngressRate=portIngressRate, sysloc=sysloc, portSfpVcc=portSfpVcc, traphost3=traphost3, capsMask=capsMask, tftpEnable=tftpEnable, traphost7=traphost7, rxUndersizePkts=rxUndersizePkts, gateway=gateway, modRestoreFactoryDefaults=modRestoreFactoryDefaults, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, omnitronGroups=omnitronGroups, ahLocalSupportVar=ahLocalSupportVar, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portState=portState, ahErroredFrameThreshold=ahErroredFrameThreshold, modLM80currents=modLM80currents, nmmSecureSlaveSlot=nmmSecureSlaveSlot, index=index, ahRemoteLinkPort=ahRemoteLinkPort, txMulticastPkts=txMulticastPkts, moduleTable=moduleTable, ahEnabled=ahEnabled, txErrorPkts=txErrorPkts, modExpLedStatus=modExpLedStatus, portFwdCpu=portFwdCpu, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ahLocalLpbkTimeout=ahLocalLpbkTimeout, txExcessiveCollision=txExcessiveCollision, portSpeed=portSpeed, writeCommunity=writeCommunity, rxOversizePkts=rxOversizePkts, modserialnum=modserialnum, rxCRCAlignErrors=rxCRCAlignErrors, ahTransmissionRate=ahTransmissionRate, userEntry=userEntry, ahClearStatistics=ahClearStatistics, portcanonicalformatIndicator=portcanonicalformatIndicator, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, rxAlignmentErrors=rxAlignmentErrors, nmmSecureConnState=nmmSecureConnState, ahLocalOUI=ahLocalOUI, macAddr=macAddr, prodAgent=prodAgent, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, port1Membership=port1Membership, ahCriticalEventMode=ahCriticalEventMode, ahRemoteOUI=ahRemoteOUI, rxOctets64=rxOctets64, ahRemoteMuxState=ahRemoteMuxState, vlanIdOst=vlanIdOst, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, extended5=extended5, coreStatusOnly=coreStatusOnly, portSfpRxPower=portSfpRxPower, rxErrorPkts=rxErrorPkts, snmpv3PrivPassword=snmpv3PrivPassword, portStatsClear=portStatsClear, defaultForwardingMap=defaultForwardingMap, chassistype=chassistype, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, rxPausePkts=rxPausePkts, portStatsTable=portStatsTable, prodtype=prodtype, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portSFPpageA2=portSFPpageA2, rxOctets=rxOctets, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, mmname=mmname, ostProtocolStatusType=ostProtocolStatusType, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, snmpTrapType=snmpTrapType, modpartnum=modpartnum, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahFrameErrorEventTotal=ahFrameErrorEventTotal, rxSymbolErrors=rxSymbolErrors, extended1=extended1, omnitronSFPGroup=omnitronSFPGroup, slaveTrapsForward=slaveTrapsForward, moduleEntry=moduleEntry, txDroppedEvents=txDroppedEvents, portAccessType=portAccessType, snmpv3UserName=snmpv3UserName, omnitronConformance=omnitronConformance, ahRemoteMode=ahRemoteMode, traphost4=traphost4, omnitronCompliances=omnitronCompliances, cpuVoltageIn=cpuVoltageIn, modprodrev=modprodrev, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modportvlan=modportvlan, ostProtocolStatusEntry=ostProtocolStatusEntry, keepAliveInterval=keepAliveInterval, ahLpbkMode=ahLpbkMode, traphost6=traphost6, portMacAddress=portMacAddress, portSFPstatus=portSFPstatus, PYSNMP_MODULE_ID=omnitronMIB, ostProtocolStatusIndex=ostProtocolStatusIndex, port5Membership=port5Membership, ipAddr2=ipAddr2, ftppasswrd=ftppasswrd, portnum=portnum, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, moduleMgtCfgEntry=moduleMgtCfgEntry, omnitronCompliance=omnitronCompliance, extended6=extended6, portL2CPmgntProcessing=portL2CPmgntProcessing, portSfpBiasCurrent=portSfpBiasCurrent, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxMulticastPkts=rxMulticastPkts, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modnumports=modnumports, rxBroadcastPkts=rxBroadcastPkts, gateway2=gateway2, portSFPTable=portSFPTable, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ingressPolicingType=ingressPolicingType, portingresssecurity=portingresssecurity, managementModule=managementModule, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, rxPackets65to127=rxPackets65to127, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, txDeferedTransmit=txDeferedTransmit, portIngressRateDropOrPause=portIngressRateDropOrPause)
mibBuilder.exportSymbols("OMNITRON-MIB", nmmCfgState=nmmCfgState, subnetmask=subnetmask, rxJabbers=rxJabbers, traphost5=traphost5, snmpv3SecurityLevel=snmpv3SecurityLevel, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, modeType=modeType, ledstat=ledstat, ahRemoteLinkFlags=ahRemoteLinkFlags, rxUnicastPkts=rxUnicastPkts, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, bootpEnable=bootpEnable, modchassname=modchassname, portDuplex=portDuplex, ahLocalLinkFlags=ahLocalLinkFlags, rxPackets128to255=rxPackets128to255, txDropPkts=txDropPkts, portAHEntry=portAHEntry, ahLocalMuxState=ahLocalMuxState, portIngressRateCBS=portIngressRateCBS, rxGoodPkts=rxGoodPkts, nmmOAMmgmtMode=nmmOAMmgmtMode, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portFwdCpuList=portFwdCpuList, ahCriticalEventTrapList=ahCriticalEventTrapList, partnum=partnum, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, moduleMgtCfgTable=moduleMgtCfgTable, userTable=userTable, modprodtype=modprodtype, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, muxGroupDefaults=muxGroupDefaults, modvlanTableClear=modvlanTableClear, traphost1=traphost1, vlanservicetag=vlanservicetag, portSfpVendorPartNumber=portSfpVendorPartNumber, snmpv3UserType=snmpv3UserType, modslotnum=modslotnum, manufdate=manufdate, modenable802dot1qProcessing=modenable802dot1qProcessing, modsoftrev=modsoftrev, prodrev=prodrev, modExpPartNumber=modExpPartNumber, slotnum=slotnum, modswbuildnum=modswbuildnum, vlanPri=vlanPri, omnitronMIB=omnitronMIB, traphost8=traphost8, nmmIpDisabled=nmmIpDisabled, enableSNMPWrites=enableSNMPWrites, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, slaveWrite=slaveWrite, wrswitch=wrswitch, modchassnum=modchassnum)
