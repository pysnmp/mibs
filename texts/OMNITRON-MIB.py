...
OstVlanId, icAgent, OstModeType, OstPortNumber, omnitron, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "icAgent", "OstModeType", "OstPortNumber", "omnitron", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", serialpass=serialpass, snmpv3AuthPassword=snmpv3AuthPassword, resetmod=resetmod, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ostProtocolStatusTable=ostProtocolStatusTable, portL2CPmgntProcessing=portL2CPmgntProcessing, dhcptftpServerIpAddress=dhcptftpServerIpAddress, chassisEntry=chassisEntry, cpuTemperature=cpuTemperature, ahLocalParserState=ahLocalParserState, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modslotnum=modslotnum, ftppasswrd=ftppasswrd, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ostEnvironmentalTemperature=ostEnvironmentalTemperature, omnitronProducts=omnitronProducts, portMacAddress=portMacAddress, traphost4=traphost4, traphost7=traphost7, ahRemoteSupportVar=ahRemoteSupportVar, ipAddr=ipAddr, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portSfpDateCode=portSfpDateCode, rxOctets=rxOctets, moduleTable=moduleTable, userTable=userTable, rxBroadcastPkts=rxBroadcastPkts, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, modulePortsTable=modulePortsTable, txDroppedEvents=txDroppedEvents, gateway=gateway, extended5=extended5, slaveTrapsForward=slaveTrapsForward, mmname=mmname, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, omnitronGroup=omnitronGroup, moduleEntry=moduleEntry, traphost3=traphost3, ahErroredFrameWindow=ahErroredFrameWindow, modnumports=modnumports, modserialnum=modserialnum, modreset=modreset, rxAlignmentErrors=rxAlignmentErrors, extended3=extended3, dhcpTagVid=dhcpTagVid, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, chassistype=chassistype, ahLocalMode=ahLocalMode, rxPausePkts=rxPausePkts, slaveWrite=slaveWrite, manufdate=manufdate, muxGroupDefaults=muxGroupDefaults, ostProtocolStatusIndex=ostProtocolStatusIndex, portSfpVendorName=portSfpVendorName, portIngressRateCBS=portIngressRateCBS, customertag=customertag, portLinkState=portLinkState, enableSNMPFunction=enableSNMPFunction, portSfpBitRate=portSfpBitRate, port2Membership=port2Membership, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, subnetmask2=subnetmask2, portStatsClear=portStatsClear, modtagsubstitution=modtagsubstitution, portSFPpageA2=portSFPpageA2, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, defaultForwardingMap=defaultForwardingMap, portegresspolicy=portegresspolicy, ledstat=ledstat, ahClearStatistics=ahClearStatistics, ahRemoteMuxState=ahRemoteMuxState, extended6=extended6, rxPackets128to255=rxPackets128to255, txExcessiveCollision=txExcessiveCollision, modname=modname, modmanufdate=modmanufdate, portnum=portnum, rxJabbers=rxJabbers, rxPackets256to511=rxPackets256to511, portIngressRate=portIngressRate, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, vlanservicetag=vlanservicetag, index=index, omnitronCompliances=omnitronCompliances, snmpv3PrivPassword=snmpv3PrivPassword, omnitronGroups=omnitronGroups, tftpServerIpAddress=tftpServerIpAddress, port1Membership=port1Membership, modExpSoftwareRev=modExpSoftwareRev, rxPackets512to1023=rxPackets512to1023, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portSFPpageA0=portSFPpageA0, ipaddr2EVCassociation=ipaddr2EVCassociation, txBroadcastPkts=txBroadcastPkts, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, traphost6=traphost6, ahRemoteMode=ahRemoteMode, managementModule=managementModule, rxFragments=rxFragments, sysDateTime=sysDateTime, vlanidentifier=vlanidentifier, ingressPolicingType=ingressPolicingType, txUnicastPkts=txUnicastPkts, rxTotalPkts=rxTotalPkts, chassisTable=chassisTable, nmmSecureSlaveSlot=nmmSecureSlaveSlot, omnitronConformance=omnitronConformance, portDuplex=portDuplex, modvlanTableClear=modvlanTableClear, portAHTable=portAHTable, portSfpTxPower=portSfpTxPower, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, serialnum=serialnum, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, modeType=modeType, portmlistcriteria=portmlistcriteria, validityflag=validityflag, prodAgent=prodAgent, rxFCSErrors=rxFCSErrors, rxDropPkts=rxDropPkts, port5Membership=port5Membership, softrev=softrev, modchasstype=modchasstype, enabledFunctions=enabledFunctions, ahRemoteLinkPort=ahRemoteLinkPort, ostProtocolStatusState=ostProtocolStatusState, chassisname=chassisname, modPcbRev=modPcbRev, servicetag=servicetag, omnitronMIB=omnitronMIB, portIngressRateDropOrPause=portIngressRateDropOrPause, enableSNMPWrites=enableSNMPWrites, traphost1=traphost1, nmmSecureConnState=nmmSecureConnState, ahCriticalEventMode=ahCriticalEventMode, modenable802dot1qProcessing=modenable802dot1qProcessing, modLM80misc=modLM80misc, portState=portState, snmpv3SecurityLevel=snmpv3SecurityLevel, port3Membership=port3Membership, txErrorPkts=txErrorPkts, extended2=extended2, gateway2=gateway2, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, snmpv3UserType=snmpv3UserType, nmmOAMmgmtMode=nmmOAMmgmtMode, nmmIpDisabled=nmmIpDisabled, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, rxUnicastPkts=rxUnicastPkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, nmmCfgState=nmmCfgState, portcanonicalformatIndicator=portcanonicalformatIndicator, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, cpuVoltageIn=cpuVoltageIn, modprodtype=modprodtype, rxOctets64=rxOctets64, enhancedchassisTable=enhancedchassisTable, slotnum=slotnum, portpriority=portpriority, portFwdCpu=portFwdCpu, capsMask=capsMask, modextfeaturebits=modextfeaturebits, ahRemoteLinkFlags=ahRemoteLinkFlags, ahRemoteOUI=ahRemoteOUI, modulePortsEntry=modulePortsEntry, ahTransmissionRate=ahTransmissionRate, portSfpVcc=portSfpVcc, sysloc=sysloc, tftpFileName=tftpFileName, tftpEnable=tftpEnable, dhcpSubnetmask=dhcpSubnetmask, portSpeed=portSpeed, rxPackets1024to1518=rxPackets1024to1518, chassisnum=chassisnum, rxMulticastPkts=rxMulticastPkts, chassis=chassis, dhcpGateway=dhcpGateway, portAHEntry=portAHEntry, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ahLocalSupportVar=ahLocalSupportVar, telnetpass=telnetpass, ahCriticalEventTrapList=ahCriticalEventTrapList, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modchassname=modchassname, modportvlan=modportvlan, txCollisions=txCollisions, ahLocalLpbkTimeout=ahLocalLpbkTimeout, txMultipleCollision=txMultipleCollision, portSfpBiasCurrent=portSfpBiasCurrent, trapSrcIpSelect=trapSrcIpSelect, ahEnabled=ahEnabled, prodtype=prodtype, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ostProtocolStatusType=ostProtocolStatusType, vlanPri=vlanPri, ahErroredFrameThreshold=ahErroredFrameThreshold, traphost8=traphost8, cnodeCIR=cnodeCIR, modprodrev=modprodrev, ahRemoteParserState=ahRemoteParserState, portSfpTemperature=portSfpTemperature, slaveTraps=slaveTraps, syscon=syscon, rxUndersizePkts=rxUndersizePkts, rxCRCAlignErrors=rxCRCAlignErrors, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, cnodeControl=cnodeControl, rxPackets65to127=rxPackets65to127, omnitronSFPGroup=omnitronSFPGroup, rxPackets64=rxPackets64, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portStatsEntry=portStatsEntry, keepAliveInterval=keepAliveInterval, cpuVoltageOut=cpuVoltageOut, moduleMgtCfgTable=moduleMgtCfgTable, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, portvlanidentifier=portvlanidentifier, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, writeCommunity=writeCommunity, modsoftrev=modsoftrev, switchstat=switchstat, ostProtocolStatusEntry=ostProtocolStatusEntry, traphost2=traphost2, modLM80volts=modLM80volts, moduleMgtCfgEntry=moduleMgtCfgEntry, txDeferedTransmit=txDeferedTransmit, portSfpRxPower=portSfpRxPower, modswbuildnum=modswbuildnum, modRestoreFactoryDefaults=modRestoreFactoryDefaults, readCommunity=readCommunity, portSFPEntry=portSFPEntry, sysAdminStatus=sysAdminStatus, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, port6Membership=port6Membership, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, portSFPstatus=portSFPstatus, PYSNMP_MODULE_ID=omnitronMIB, port4Membership=port4Membership, subnetmask=subnetmask, txOctets64=txOctets64, portEgressQosPolicy=portEgressQosPolicy, partnum=partnum, rxSymbolErrors=rxSymbolErrors, modHwRev=modHwRev, wrswitch=wrswitch, ahLocalOUI=ahLocalOUI, modExpPartNumber=modExpPartNumber, rxGoodPkts=rxGoodPkts, portFwdCpuList=portFwdCpuList)
mibBuilder.exportSymbols("OMNITRON-MIB", extended1=extended1, coreStatusOnly=coreStatusOnly, portStatsTable=portStatsTable, ahLocalLinkFlags=ahLocalLinkFlags, bootpEnable=bootpEnable, ostProtocoManagementPort=ostProtocoManagementPort, txDropPkts=txDropPkts, traphost5=traphost5, modLM80currents=modLM80currents, moduleVLANEntry=moduleVLANEntry, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, snmpv3UserName=snmpv3UserName, modchassnum=modchassnum, userEntry=userEntry, snmpTrapType=snmpTrapType, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, enableSNMPv3Function=enableSNMPv3Function, omnitronCompliance=omnitronCompliance, rxOversizePkts=rxOversizePkts, macAddr=macAddr, dhcpPortNumber=dhcpPortNumber, dhcpIpAddr=dhcpIpAddr, ipaddrEVCassociation=ipaddrEVCassociation, extended4=extended4, rxErrorPkts=rxErrorPkts, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, txLateCollision=txLateCollision, nmmSecureMode=nmmSecureMode, moduleCount=moduleCount, modpartnum=modpartnum, modFpgaRev=modFpgaRev, portAccessType=portAccessType, txMulticastPkts=txMulticastPkts, portEgressRate=portEgressRate, selfSlot=selfSlot, modExpLedStatus=modExpLedStatus, modulename=modulename, ahLpbkMode=ahLpbkMode, txGoodPkts=txGoodPkts, moduleVLANTable=moduleVLANTable, portSFPTable=portSFPTable, ahLocalMuxState=ahLocalMuxState, mychassnum=mychassnum, modcommitVLANchanges=modcommitVLANchanges, vlanIdOst=vlanIdOst, txPausePkts=txPausePkts, nmmIpProtocolState=nmmIpProtocolState, userIndex=userIndex, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, ipAddr2=ipAddr2, txSingleCollision=txSingleCollision, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portSfpVendorPartNumber=portSfpVendorPartNumber, portingresssecurity=portingresssecurity, prodrev=prodrev, txOctets=txOctets)
