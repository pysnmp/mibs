...
icAgent, omnitron, OstPortList, OstModeType, OstVlanId, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "omnitron", "OstPortList", "OstModeType", "OstVlanId", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", txErrorPkts=txErrorPkts, modenable802dot1qProcessing=modenable802dot1qProcessing, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ahRemoteOUI=ahRemoteOUI, slaveWrite=slaveWrite, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahRemoteMuxState=ahRemoteMuxState, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portSfpVendorPartNumber=portSfpVendorPartNumber, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ahRemoteSupportVar=ahRemoteSupportVar, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, dhcpGateway=dhcpGateway, chassisnum=chassisnum, rxDropPkts=rxDropPkts, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, extended6=extended6, sysDateTime=sysDateTime, port1Membership=port1Membership, nmmCfgState=nmmCfgState, portSfpBiasCurrent=portSfpBiasCurrent, serialpass=serialpass, ledstat=ledstat, txOctets=txOctets, txOctets64=txOctets64, nmmIpProtocolState=nmmIpProtocolState, modExpLedStatus=modExpLedStatus, rxFCSErrors=rxFCSErrors, portpriority=portpriority, nmmIpDisabled=nmmIpDisabled, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portSfpVendorName=portSfpVendorName, portSfpRxPower=portSfpRxPower, switchstat=switchstat, ostProtocoManagementPort=ostProtocoManagementPort, ahErroredFrameWindow=ahErroredFrameWindow, portSfpTxPower=portSfpTxPower, portDuplex=portDuplex, rxPausePkts=rxPausePkts, modchasstype=modchasstype, chassistype=chassistype, snmpv3AuthPassword=snmpv3AuthPassword, modPcbRev=modPcbRev, portmlistcriteria=portmlistcriteria, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, syscon=syscon, serialnum=serialnum, rxPackets64=rxPackets64, modpartnum=modpartnum, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, port6Membership=port6Membership, manufdate=manufdate, modcommitVLANchanges=modcommitVLANchanges, nmmSecureMode=nmmSecureMode, mmname=mmname, ahCriticalEventTrapList=ahCriticalEventTrapList, subnetmask2=subnetmask2, cpuTemperature=cpuTemperature, ipaddrEVCassociation=ipaddrEVCassociation, portLinkState=portLinkState, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, sysloc=sysloc, portSFPpageA0=portSFPpageA0, readCommunity=readCommunity, portSFPstatus=portSFPstatus, vlanservicetag=vlanservicetag, modExpPartNumber=modExpPartNumber, userTable=userTable, subnetmask=subnetmask, modchassname=modchassname, ahErroredFrameThreshold=ahErroredFrameThreshold, portEgressQosPolicy=portEgressQosPolicy, omnitronCompliance=omnitronCompliance, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portnum=portnum, modRestoreFactoryDefaults=modRestoreFactoryDefaults, snmpv3SecurityLevel=snmpv3SecurityLevel, snmpv3PrivPassword=snmpv3PrivPassword, ipAddr2=ipAddr2, rxErrorPkts=rxErrorPkts, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, omnitronProducts=omnitronProducts, rxOctets=rxOctets, portSfpBitRate=portSfpBitRate, tftpFileName=tftpFileName, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, customertag=customertag, portegresspolicy=portegresspolicy, traphost7=traphost7, macAddr=macAddr, rxPackets128to255=rxPackets128to255, chassisTable=chassisTable, modserialnum=modserialnum, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, cnodeCIR=cnodeCIR, modulePortsEntry=modulePortsEntry, portStatsClear=portStatsClear, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modLM80currents=modLM80currents, modportvlan=modportvlan, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, index=index, omnitronGroup=omnitronGroup, portFwdCpuList=portFwdCpuList, portvlanidentifier=portvlanidentifier, modprodtype=modprodtype, portAHTable=portAHTable, dhcpTagVid=dhcpTagVid, prodrev=prodrev, omnitronGroups=omnitronGroups, cpuVoltageIn=cpuVoltageIn, txExcessiveCollision=txExcessiveCollision, extended3=extended3, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, keepAliveInterval=keepAliveInterval, traphost4=traphost4, ahLocalLinkFlags=ahLocalLinkFlags, ostProtocolStatusTable=ostProtocolStatusTable, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, ipaddr2EVCassociation=ipaddr2EVCassociation, txDeferedTransmit=txDeferedTransmit, portIngressRate=portIngressRate, ahRemoteParserState=ahRemoteParserState, portSFPpageA2=portSFPpageA2, ahLocalParserState=ahLocalParserState, txSingleCollision=txSingleCollision, moduleMgtCfgEntry=moduleMgtCfgEntry, partnum=partnum, modnumports=modnumports, ipAddr=ipAddr, ingressPolicingType=ingressPolicingType, traphost8=traphost8, portAccessType=portAccessType, portState=portState, snmpv3UserType=snmpv3UserType, port3Membership=port3Membership, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portIngressRateDropOrPause=portIngressRateDropOrPause, traphost6=traphost6, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ostProtocolStatusIndex=ostProtocolStatusIndex, traphost2=traphost2, ahLocalSupportVar=ahLocalSupportVar, rxTotalPkts=rxTotalPkts, ahLocalMuxState=ahLocalMuxState, cpuVoltageOut=cpuVoltageOut, rxPackets1024to1518=rxPackets1024to1518, modswbuildnum=modswbuildnum, rxJabbers=rxJabbers, rxMulticastPkts=rxMulticastPkts, portFwdCpu=portFwdCpu, moduleVLANTable=moduleVLANTable, enableSNMPv3Function=enableSNMPv3Function, port4Membership=port4Membership, extended4=extended4, ostProtocolStatusEntry=ostProtocolStatusEntry, omnitronCompliances=omnitronCompliances, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, vlanPri=vlanPri, modulePortsTable=modulePortsTable, coreStatusOnly=coreStatusOnly, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, slotnum=slotnum, chassisEntry=chassisEntry, moduleTable=moduleTable, modprodrev=modprodrev, ahRemoteLinkFlags=ahRemoteLinkFlags, enhancedchassisTable=enhancedchassisTable, traphost1=traphost1, muxGroupDefaults=muxGroupDefaults, moduleVLANEntry=moduleVLANEntry, gateway=gateway, tftpServerIpAddress=tftpServerIpAddress, omnitronConformance=omnitronConformance, txDropPkts=txDropPkts, moduleMgtCfgTable=moduleMgtCfgTable, ostProtocolStatusType=ostProtocolStatusType, txLateCollision=txLateCollision, ahCriticalEventMode=ahCriticalEventMode, ostProtocolStatusState=ostProtocolStatusState, ahRemoteMode=ahRemoteMode, tftpEnable=tftpEnable, enableSNMPWrites=enableSNMPWrites, modLM80misc=modLM80misc, ahLocalLpbkTimeout=ahLocalLpbkTimeout, vlanIdOst=vlanIdOst, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modslotnum=modslotnum, txGoodPkts=txGoodPkts, ahLocalMode=ahLocalMode, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, gateway2=gateway2, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, txDroppedEvents=txDroppedEvents, snmpv3UserName=snmpv3UserName, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, rxUnicastPkts=rxUnicastPkts, txBroadcastPkts=txBroadcastPkts, extended2=extended2, extended5=extended5, txMulticastPkts=txMulticastPkts, telnetpass=telnetpass, ahLocalOUI=ahLocalOUI, servicetag=servicetag, portL2CPmgntProcessing=portL2CPmgntProcessing, mychassnum=mychassnum, port2Membership=port2Membership, prodAgent=prodAgent, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, vlanidentifier=vlanidentifier, nmmOAMmgmtMode=nmmOAMmgmtMode, snmpTrapType=snmpTrapType, rxPackets512to1023=rxPackets512to1023, modeType=modeType, ahLpbkMode=ahLpbkMode, portSfpDateCode=portSfpDateCode, prodtype=prodtype, rxUndersizePkts=rxUndersizePkts, traphost5=traphost5, traphost3=traphost3, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, rxPackets65to127=rxPackets65to127, rxCRCAlignErrors=rxCRCAlignErrors, portAHEntry=portAHEntry, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, rxBroadcastPkts=rxBroadcastPkts, defaultForwardingMap=defaultForwardingMap, modtagsubstitution=modtagsubstitution, portSFPEntry=portSFPEntry, modFpgaRev=modFpgaRev, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, rxSymbolErrors=rxSymbolErrors, ahEnabled=ahEnabled, extended1=extended1, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, wrswitch=wrswitch, softrev=softrev, dhcpPortNumber=dhcpPortNumber, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modHwRev=modHwRev, modchassnum=modchassnum, portStatsTable=portStatsTable, omnitronMIB=omnitronMIB, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, modextfeaturebits=modextfeaturebits, nmmSecureConnState=nmmSecureConnState, portStatsEntry=portStatsEntry, enableSNMPFunction=enableSNMPFunction, modmanufdate=modmanufdate, cnodeControl=cnodeControl)
mibBuilder.exportSymbols("OMNITRON-MIB", bootpEnable=bootpEnable, omnitronSFPGroup=omnitronSFPGroup, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, portSFPTable=portSFPTable, portcanonicalformatIndicator=portcanonicalformatIndicator, txPausePkts=txPausePkts, modulename=modulename, port5Membership=port5Membership, modLM80volts=modLM80volts, txMultipleCollision=txMultipleCollision, capsMask=capsMask, enabledFunctions=enabledFunctions, managementModule=managementModule, modvlanTableClear=modvlanTableClear, dhcpIpAddr=dhcpIpAddr, ahRemoteLinkPort=ahRemoteLinkPort, txCollisions=txCollisions, slaveTrapsForward=slaveTrapsForward, rxPackets256to511=rxPackets256to511, portMacAddress=portMacAddress, writeCommunity=writeCommunity, modsoftrev=modsoftrev, ftppasswrd=ftppasswrd, portSfpVcc=portSfpVcc, ahTransmissionRate=ahTransmissionRate, selfSlot=selfSlot, PYSNMP_MODULE_ID=omnitronMIB, portEgressRate=portEgressRate, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ahClearStatistics=ahClearStatistics, moduleCount=moduleCount, chassisname=chassisname, modExpSoftwareRev=modExpSoftwareRev, userEntry=userEntry, validityflag=validityflag, modname=modname, nmmSecureSlaveSlot=nmmSecureSlaveSlot, rxGoodPkts=rxGoodPkts, portingresssecurity=portingresssecurity, rxOctets64=rxOctets64, slaveTraps=slaveTraps, resetmod=resetmod, modreset=modreset, chassis=chassis, txUnicastPkts=txUnicastPkts, rxAlignmentErrors=rxAlignmentErrors, rxFragments=rxFragments, portSfpTemperature=portSfpTemperature, trapSrcIpSelect=trapSrcIpSelect, moduleEntry=moduleEntry, sysAdminStatus=sysAdminStatus, portIngressRateCBS=portIngressRateCBS, dhcpSubnetmask=dhcpSubnetmask, userIndex=userIndex, rxOversizePkts=rxOversizePkts, portSpeed=portSpeed)
