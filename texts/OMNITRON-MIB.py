...
OstVlanId, omnitron, icAgent, OstPortNumber, OstModeType, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "omnitron", "icAgent", "OstPortNumber", "OstModeType", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", modnumports=modnumports, ahTransmissionRate=ahTransmissionRate, extended1=extended1, slaveTraps=slaveTraps, enabledFunctions=enabledFunctions, nmmIpDisabled=nmmIpDisabled, modprodtype=modprodtype, portvlanidentifier=portvlanidentifier, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, txUnicastPkts=txUnicastPkts, prodAgent=prodAgent, portAHEntry=portAHEntry, ostProtocoManagementPort=ostProtocoManagementPort, ahCriticalEventMode=ahCriticalEventMode, portnum=portnum, portpriority=portpriority, modulename=modulename, ahRemoteMode=ahRemoteMode, ftppasswrd=ftppasswrd, prodrev=prodrev, cpuVoltageIn=cpuVoltageIn, resetmod=resetmod, portSFPEntry=portSFPEntry, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, macAddr=macAddr, tftpServerIpAddress=tftpServerIpAddress, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, traphost6=traphost6, omnitronConformance=omnitronConformance, txGoodPkts=txGoodPkts, rxOversizePkts=rxOversizePkts, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portingresssecurity=portingresssecurity, snmpv3AuthPassword=snmpv3AuthPassword, rxPausePkts=rxPausePkts, ahRemoteParserState=ahRemoteParserState, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, chassisnum=chassisnum, modextfeaturebits=modextfeaturebits, ahClearStatistics=ahClearStatistics, modeType=modeType, portSFPpageA2=portSFPpageA2, ostEnvironmentalTemperature=ostEnvironmentalTemperature, ostProtocolStatusTable=ostProtocolStatusTable, dhcpGateway=dhcpGateway, txOctets64=txOctets64, txSingleCollision=txSingleCollision, partnum=partnum, extended3=extended3, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxCRCAlignErrors=rxCRCAlignErrors, switchstat=switchstat, modtagsubstitution=modtagsubstitution, portIngressRateDropOrPause=portIngressRateDropOrPause, ahLocalLpbkTimeout=ahLocalLpbkTimeout, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, customertag=customertag, modHwRev=modHwRev, enableSNMPv3Function=enableSNMPv3Function, omnitronGroups=omnitronGroups, portAccessType=portAccessType, trapSrcIpSelect=trapSrcIpSelect, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, defaultForwardingMap=defaultForwardingMap, dhcpPortNumber=dhcpPortNumber, ahErroredFrameThreshold=ahErroredFrameThreshold, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modname=modname, txPausePkts=txPausePkts, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, nmmSecureSlaveSlot=nmmSecureSlaveSlot, txMultipleCollision=txMultipleCollision, omnitronSFPGroup=omnitronSFPGroup, txErrorPkts=txErrorPkts, traphost4=traphost4, snmpv3PrivPassword=snmpv3PrivPassword, chassisname=chassisname, nmmOAMmgmtMode=nmmOAMmgmtMode, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, nmmCfgState=nmmCfgState, capsMask=capsMask, enableSNMPWrites=enableSNMPWrites, moduleTable=moduleTable, vlanPri=vlanPri, coreStatusOnly=coreStatusOnly, portSFPpageA0=portSFPpageA0, portSfpTemperature=portSfpTemperature, port6Membership=port6Membership, portSfpBitRate=portSfpBitRate, ahCriticalEventTrapList=ahCriticalEventTrapList, ostProtocolStatusIndex=ostProtocolStatusIndex, txExcessiveCollision=txExcessiveCollision, dhcpSubnetmask=dhcpSubnetmask, ingressPolicingType=ingressPolicingType, ahRemoteMuxState=ahRemoteMuxState, txMulticastPkts=txMulticastPkts, ahLpbkMode=ahLpbkMode, traphost8=traphost8, nmmIpProtocolState=nmmIpProtocolState, manufdate=manufdate, traphost2=traphost2, chassistype=chassistype, dhcpTagVid=dhcpTagVid, portLinkState=portLinkState, slaveWrite=slaveWrite, txDeferedTransmit=txDeferedTransmit, ipAddr2=ipAddr2, traphost3=traphost3, tftpFileName=tftpFileName, portSfpVendorPartNumber=portSfpVendorPartNumber, snmpv3UserType=snmpv3UserType, portSpeed=portSpeed, moduleMgtCfgTable=moduleMgtCfgTable, dhcpIpAddr=dhcpIpAddr, rxDropPkts=rxDropPkts, ostProtocolStatusType=ostProtocolStatusType, modExpPartNumber=modExpPartNumber, modslotnum=modslotnum, portmlistcriteria=portmlistcriteria, modserialnum=modserialnum, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, bootpEnable=bootpEnable, portSFPstatus=portSFPstatus, subnetmask2=subnetmask2, portDuplex=portDuplex, traphost5=traphost5, omnitronProducts=omnitronProducts, portStatsTable=portStatsTable, rxPackets65to127=rxPackets65to127, portSfpVendorName=portSfpVendorName, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, port1Membership=port1Membership, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, txLateCollision=txLateCollision, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ostProtocolStatusEntry=ostProtocolStatusEntry, chassisTable=chassisTable, nmmSecureMode=nmmSecureMode, moduleCount=moduleCount, portSfpRxPower=portSfpRxPower, readCommunity=readCommunity, ipaddr2EVCassociation=ipaddr2EVCassociation, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, txBroadcastPkts=txBroadcastPkts, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, servicetag=servicetag, modswbuildnum=modswbuildnum, ahLocalSupportVar=ahLocalSupportVar, modchassname=modchassname, rxPackets512to1023=rxPackets512to1023, modcommitVLANchanges=modcommitVLANchanges, modLM80volts=modLM80volts, cpuTemperature=cpuTemperature, sysDateTime=sysDateTime, rxFCSErrors=rxFCSErrors, ahLocalMode=ahLocalMode, wrswitch=wrswitch, modsoftrev=modsoftrev, rxOctets64=rxOctets64, vlanservicetag=vlanservicetag, moduleVLANTable=moduleVLANTable, ostProtocolStatusState=ostProtocolStatusState, muxGroupDefaults=muxGroupDefaults, modchassnum=modchassnum, ahLocalMuxState=ahLocalMuxState, ahFrameErrorEventTotal=ahFrameErrorEventTotal, extended6=extended6, ahLocalLinkFlags=ahLocalLinkFlags, modcommitNMMCfgChanges=modcommitNMMCfgChanges, rxErrorPkts=rxErrorPkts, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxFragments=rxFragments, rxPackets1024to1518=rxPackets1024to1518, ahEnabled=ahEnabled, modLM80misc=modLM80misc, extended2=extended2, userEntry=userEntry, modreset=modreset, omnitronCompliance=omnitronCompliance, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, writeCommunity=writeCommunity, port3Membership=port3Membership, modchasstype=modchasstype, portState=portState, modpartnum=modpartnum, vlanIdOst=vlanIdOst, sysAdminStatus=sysAdminStatus, userTable=userTable, mychassnum=mychassnum, validityflag=validityflag, ahRemoteLinkPort=ahRemoteLinkPort, softrev=softrev, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxTotalPkts=rxTotalPkts, modLM80currents=modLM80currents, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, portFwdCpuList=portFwdCpuList, txOctets=txOctets, enhancedchassisTable=enhancedchassisTable, ahLocalParserState=ahLocalParserState, portSfpDateCode=portSfpDateCode, omnitronGroup=omnitronGroup, enableSNMPFunction=enableSNMPFunction, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portL2CPmgntProcessing=portL2CPmgntProcessing, modmanufdate=modmanufdate, port4Membership=port4Membership, portMacAddress=portMacAddress, portcanonicalformatIndicator=portcanonicalformatIndicator, managementModule=managementModule, mmname=mmname, portEgressRate=portEgressRate, rxBroadcastPkts=rxBroadcastPkts, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, rxPackets64=rxPackets64, portStatsClear=portStatsClear, portSfpTxPower=portSfpTxPower, portFwdCpu=portFwdCpu, extended5=extended5, rxAlignmentErrors=rxAlignmentErrors, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, subnetmask=subnetmask, vlanidentifier=vlanidentifier, ahErroredFrameWindow=ahErroredFrameWindow, PYSNMP_MODULE_ID=omnitronMIB, moduleMgtCfgEntry=moduleMgtCfgEntry, modvlanTableClear=modvlanTableClear, nmmSecureConnState=nmmSecureConnState, rxPackets256to511=rxPackets256to511, selfSlot=selfSlot, portIngressRateCBS=portIngressRateCBS, ledstat=ledstat, txDropPkts=txDropPkts, portStatsEntry=portStatsEntry, omnitronMIB=omnitronMIB, rxMulticastPkts=rxMulticastPkts, portSfpVcc=portSfpVcc, ahRemoteOUI=ahRemoteOUI, portSFPTable=portSFPTable, rxGoodPkts=rxGoodPkts, modPcbRev=modPcbRev, portSfpBiasCurrent=portSfpBiasCurrent, syscon=syscon, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, extended4=extended4, modenable802dot1qProcessing=modenable802dot1qProcessing, ipAddr=ipAddr, modprodrev=modprodrev, omnitronCompliances=omnitronCompliances, index=index, modulePortsEntry=modulePortsEntry, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, snmpTrapType=snmpTrapType, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold)
mibBuilder.exportSymbols("OMNITRON-MIB", ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, sysloc=sysloc, ahLocalOUI=ahLocalOUI, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, cnodeControl=cnodeControl, userIndex=userIndex, chassisEntry=chassisEntry, rxSymbolErrors=rxSymbolErrors, traphost7=traphost7, port5Membership=port5Membership, port2Membership=port2Membership, ahRemoteLinkFlags=ahRemoteLinkFlags, snmpv3SecurityLevel=snmpv3SecurityLevel, chassis=chassis, modExpLedStatus=modExpLedStatus, serialpass=serialpass, moduleVLANEntry=moduleVLANEntry, txCollisions=txCollisions, moduleEntry=moduleEntry, modExpSoftwareRev=modExpSoftwareRev, gateway=gateway, rxJabbers=rxJabbers, slaveTrapsForward=slaveTrapsForward, modulePortsTable=modulePortsTable, portEgressQosPolicy=portEgressQosPolicy, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portSfpVendorSerialNumber=portSfpVendorSerialNumber, rxPackets128to255=rxPackets128to255, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ahRemoteSupportVar=ahRemoteSupportVar, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, serialnum=serialnum, telnetpass=telnetpass, portIngressRate=portIngressRate, portegresspolicy=portegresspolicy, tftpEnable=tftpEnable, keepAliveInterval=keepAliveInterval, rxUnicastPkts=rxUnicastPkts, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, cpuVoltageOut=cpuVoltageOut, modFpgaRev=modFpgaRev, txDroppedEvents=txDroppedEvents, rxUndersizePkts=rxUndersizePkts, traphost1=traphost1, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, prodtype=prodtype, slotnum=slotnum, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portAHTable=portAHTable, cnodeCIR=cnodeCIR, snmpv3UserName=snmpv3UserName, ipaddrEVCassociation=ipaddrEVCassociation, rxOctets=rxOctets, gateway2=gateway2, modportvlan=modportvlan)
