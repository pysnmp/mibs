...
mibBuilder.exportSymbols("OMNITRON-MIB", modtagsubstitution=modtagsubstitution, manufdate=manufdate, extended5=extended5, moduleVLANTable=moduleVLANTable, modportvlan=modportvlan, txDeferedTransmit=txDeferedTransmit, ahLpbkMode=ahLpbkMode, softrev=softrev, traphost4=traphost4, resetmod=resetmod, dhcpSubnetmask=dhcpSubnetmask, txErrorPkts=txErrorPkts, txUnicastPkts=txUnicastPkts, modserialnum=modserialnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, keepAliveInterval=keepAliveInterval, rxFCSErrors=rxFCSErrors, modLM80misc=modLM80misc, gateway2=gateway2, port3Membership=port3Membership, cnodeControl=cnodeControl, omnitronConformance=omnitronConformance, modpartnum=modpartnum, txMulticastPkts=txMulticastPkts, ahLocalParserState=ahLocalParserState, userTable=userTable, portSfpVcc=portSfpVcc, rxJabbers=rxJabbers, port4Membership=port4Membership, modExpLedStatus=modExpLedStatus, portIngressRateCBS=portIngressRateCBS, rxAlignmentErrors=rxAlignmentErrors, txLateCollision=txLateCollision, port2Membership=port2Membership, modchasstype=modchasstype, mmname=mmname, ipaddrEVCassociation=ipaddrEVCassociation, userIndex=userIndex, enableSNMPv3Function=enableSNMPv3Function, rxUndersizePkts=rxUndersizePkts, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, nmmIpDisabled=nmmIpDisabled, portStatsClear=portStatsClear, portSfpBiasCurrent=portSfpBiasCurrent, PYSNMP_MODULE_ID=omnitronMIB, ostEnvironmentalTemperature=ostEnvironmentalTemperature, portnum=portnum, ahTransmissionRate=ahTransmissionRate, portStatsEntry=portStatsEntry, omnitronMIB=omnitronMIB, rxSymbolErrors=rxSymbolErrors, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, snmpv3UserName=snmpv3UserName, serialpass=serialpass, portSFPpageA2=portSFPpageA2, port1Membership=port1Membership, dhcpGateway=dhcpGateway, portSfpRxPower=portSfpRxPower, validityflag=validityflag, nmmOAMmgmtMode=nmmOAMmgmtMode, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modHwRev=modHwRev, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portSfpTemperature=portSfpTemperature, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, txSingleCollision=txSingleCollision, ahRemoteSupportVar=ahRemoteSupportVar, omnitronGroup=omnitronGroup, tftpFileName=tftpFileName, txDroppedEvents=txDroppedEvents, userEntry=userEntry, modLM80volts=modLM80volts, ingressPolicingType=ingressPolicingType, chassistype=chassistype, writeCommunity=writeCommunity, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, rxOctets=rxOctets, modenable802dot1qProcessing=modenable802dot1qProcessing, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, omnitronCompliances=omnitronCompliances, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, traphost8=traphost8, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, omnitronSFPGroup=omnitronSFPGroup, moduleMgtCfgEntry=moduleMgtCfgEntry, txExcessiveCollision=txExcessiveCollision, ahClearStatistics=ahClearStatistics, snmpv3UserType=snmpv3UserType, modprodtype=modprodtype, portSfpVendorPartNumber=portSfpVendorPartNumber, modmanufdate=modmanufdate, modPcbRev=modPcbRev, chassisTable=chassisTable, switchstat=switchstat, portSfpTxPower=portSfpTxPower, extended6=extended6, macAddr=macAddr, rxOctets64=rxOctets64, nmmSecureConnState=nmmSecureConnState, ahRemoteOUI=ahRemoteOUI, cpuVoltageOut=cpuVoltageOut, txGoodPkts=txGoodPkts, subnetmask=subnetmask, slaveTraps=slaveTraps, traphost5=traphost5, enhancedchassisTable=enhancedchassisTable, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, moduleTable=moduleTable, modslotnum=modslotnum, selfSlot=selfSlot, ipAddr=ipAddr, ahEnabled=ahEnabled, enabledFunctions=enabledFunctions, managementModule=managementModule, portAHTable=portAHTable, chassis=chassis, dhcpTagVid=dhcpTagVid, ostProtocolStatusType=ostProtocolStatusType, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, modulename=modulename, modnumports=modnumports, ahRemoteLinkFlags=ahRemoteLinkFlags, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, rxPackets256to511=rxPackets256to511, port5Membership=port5Membership, modulePortsEntry=modulePortsEntry, ledstat=ledstat, defaultForwardingMap=defaultForwardingMap, partnum=partnum, sysDateTime=sysDateTime, vlanidentifier=vlanidentifier, rxCRCAlignErrors=rxCRCAlignErrors, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, rxPackets128to255=rxPackets128to255, modchassnum=modchassnum, extended2=extended2, traphost6=traphost6, rxPackets65to127=rxPackets65to127, index=index, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portSpeed=portSpeed, subnetmask2=subnetmask2, modcommitNMMCfgChanges=modcommitNMMCfgChanges, modeType=modeType, tftpEnable=tftpEnable, omnitronCompliance=omnitronCompliance, txBroadcastPkts=txBroadcastPkts, bootpEnable=bootpEnable, ostProtocolStatusIndex=ostProtocolStatusIndex, ftppasswrd=ftppasswrd, snmpTrapType=snmpTrapType, modExpSoftwareRev=modExpSoftwareRev, ahLocalSupportVar=ahLocalSupportVar, ahRemoteMuxState=ahRemoteMuxState, ahErroredFrameWindow=ahErroredFrameWindow, traphost2=traphost2, rxPackets1024to1518=rxPackets1024to1518, dhcpIpAddr=dhcpIpAddr, ahRemoteMode=ahRemoteMode, ahErroredFrameThreshold=ahErroredFrameThreshold, portAccessType=portAccessType, ahRemoteParserState=ahRemoteParserState, serialnum=serialnum, mychassnum=mychassnum, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modvlanTableClear=modvlanTableClear, portvlanidentifier=portvlanidentifier, rxTotalPkts=rxTotalPkts, txCollisions=txCollisions, ahLocalMuxState=ahLocalMuxState, omnitronGroups=omnitronGroups, telnetpass=telnetpass, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modExpPartNumber=modExpPartNumber, txOctets64=txOctets64, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modsoftrev=modsoftrev, rxFragments=rxFragments, cpuTemperature=cpuTemperature, snmpv3SecurityLevel=snmpv3SecurityLevel, vlanIdOst=vlanIdOst, slaveTrapsForward=slaveTrapsForward, ipaddr2EVCassociation=ipaddr2EVCassociation, portSfpBitRate=portSfpBitRate, portSFPpageA0=portSFPpageA0, ahCriticalEventMode=ahCriticalEventMode, trapSrcIpSelect=trapSrcIpSelect, syscon=syscon, portEgressRate=portEgressRate, moduleVLANEntry=moduleVLANEntry, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, enableSNMPFunction=enableSNMPFunction, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, rxGoodPkts=rxGoodPkts, tftpServerIpAddress=tftpServerIpAddress, portState=portState, prodtype=prodtype, modname=modname, sysAdminStatus=sysAdminStatus, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, rxPackets64=rxPackets64, ostProtocolStatusState=ostProtocolStatusState, portIngressRate=portIngressRate, txOctets=txOctets, txMultipleCollision=txMultipleCollision, ahCriticalEventTrapList=ahCriticalEventTrapList, traphost7=traphost7, ostProtocoManagementPort=ostProtocoManagementPort, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portingresssecurity=portingresssecurity, snmpv3PrivPassword=snmpv3PrivPassword, portFwdCpu=portFwdCpu, portegresspolicy=portegresspolicy, ahLocalLinkFlags=ahLocalLinkFlags, rxOversizePkts=rxOversizePkts, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, gateway=gateway, portFwdCpuList=portFwdCpuList, customertag=customertag, ostProtocolStatusEntry=ostProtocolStatusEntry, portStatsTable=portStatsTable, ipAddr2=ipAddr2, slaveWrite=slaveWrite, chassisnum=chassisnum, sysloc=sysloc, dhcpPortNumber=dhcpPortNumber, portSFPEntry=portSFPEntry, nmmSecureMode=nmmSecureMode, modulePortsTable=modulePortsTable, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modchassname=modchassname, readCommunity=readCommunity, slotnum=slotnum, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahLocalMode=ahLocalMode, chassisname=chassisname, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, extended3=extended3, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, traphost3=traphost3, ostProtocolStatusTable=ostProtocolStatusTable, snmpv3AuthPassword=snmpv3AuthPassword, portAHEntry=portAHEntry, rxPackets512to1023=rxPackets512to1023, portLinkState=portLinkState, portDuplex=portDuplex, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, capsMask=capsMask, rxPausePkts=rxPausePkts)
mibBuilder.exportSymbols("OMNITRON-MIB", rxUnicastPkts=rxUnicastPkts, txDropPkts=txDropPkts, prodrev=prodrev, extended4=extended4, nmmIpProtocolState=nmmIpProtocolState, portSFPTable=portSFPTable, wrswitch=wrswitch, portSfpDateCode=portSfpDateCode, portMacAddress=portMacAddress, portSFPstatus=portSFPstatus, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, rxBroadcastPkts=rxBroadcastPkts, moduleCount=moduleCount, portEgressQosPolicy=portEgressQosPolicy, moduleMgtCfgTable=moduleMgtCfgTable, enableSNMPWrites=enableSNMPWrites, modswbuildnum=modswbuildnum, ahFramePeriodEventTotal=ahFramePeriodEventTotal, extended1=extended1, chassisEntry=chassisEntry, modreset=modreset, rxErrorPkts=rxErrorPkts, ahLocalOUI=ahLocalOUI, muxGroupDefaults=muxGroupDefaults, prodAgent=prodAgent, coreStatusOnly=coreStatusOnly, cpuVoltageIn=cpuVoltageIn, traphost1=traphost1, portcanonicalformatIndicator=portcanonicalformatIndicator, modprodrev=modprodrev, portIngressRateDropOrPause=portIngressRateDropOrPause, modLM80currents=modLM80currents, ahRemoteLinkPort=ahRemoteLinkPort, moduleEntry=moduleEntry, rxMulticastPkts=rxMulticastPkts, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modcommitVLANchanges=modcommitVLANchanges, txPausePkts=txPausePkts, cnodeCIR=cnodeCIR, vlanservicetag=vlanservicetag, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, modextfeaturebits=modextfeaturebits, omnitronProducts=omnitronProducts, nmmCfgState=nmmCfgState, servicetag=servicetag, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portSfpVendorName=portSfpVendorName, port6Membership=port6Membership, vlanPri=vlanPri, modRestoreFactoryDefaults=modRestoreFactoryDefaults, modFpgaRev=modFpgaRev, portpriority=portpriority, portmlistcriteria=portmlistcriteria, portL2CPmgntProcessing=portL2CPmgntProcessing, rxDropPkts=rxDropPkts)
