...
OstPortNumber, OstModeType, icAgent, omnitron, OstVlanId, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortNumber", "OstModeType", "icAgent", "omnitron", "OstVlanId", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", readCommunity=readCommunity, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, txUnicastPkts=txUnicastPkts, rxSymbolErrors=rxSymbolErrors, txExcessiveCollision=txExcessiveCollision, extended6=extended6, rxAlignmentErrors=rxAlignmentErrors, portmlistcriteria=portmlistcriteria, modslotnum=modslotnum, traphost2=traphost2, servicetag=servicetag, ahLocalLinkFlags=ahLocalLinkFlags, prodrev=prodrev, defaultForwardingMap=defaultForwardingMap, modpartnum=modpartnum, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, rxCRCAlignErrors=rxCRCAlignErrors, ipAddr2=ipAddr2, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portSfpBiasCurrent=portSfpBiasCurrent, vlanPri=vlanPri, txDeferedTransmit=txDeferedTransmit, enableSNMPFunction=enableSNMPFunction, snmpTrapType=snmpTrapType, macAddr=macAddr, rxGoodPkts=rxGoodPkts, rxPackets128to255=rxPackets128to255, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portMacAddress=portMacAddress, modprodrev=modprodrev, txGoodPkts=txGoodPkts, modExpPartNumber=modExpPartNumber, dhcpIpAddr=dhcpIpAddr, txOctets=txOctets, rxMulticastPkts=rxMulticastPkts, rxPausePkts=rxPausePkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, extended2=extended2, modextfeaturebits=modextfeaturebits, portSfpTemperature=portSfpTemperature, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modcommitVLANchanges=modcommitVLANchanges, portSfpRxPower=portSfpRxPower, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portSfpTxPower=portSfpTxPower, modsoftrev=modsoftrev, nmmSecureMode=nmmSecureMode, modRestoreFactoryDefaults=modRestoreFactoryDefaults, txPausePkts=txPausePkts, vlanservicetag=vlanservicetag, tftpServerIpAddress=tftpServerIpAddress, ahRemoteMode=ahRemoteMode, portDuplex=portDuplex, modulename=modulename, rxOctets64=rxOctets64, modHwRev=modHwRev, muxGroupDefaults=muxGroupDefaults, cnodeControl=cnodeControl, ostProtocolStatusType=ostProtocolStatusType, sysAdminStatus=sysAdminStatus, portegresspolicy=portegresspolicy, port5Membership=port5Membership, portIngressRate=portIngressRate, portStatsEntry=portStatsEntry, sysloc=sysloc, rxFCSErrors=rxFCSErrors, traphost1=traphost1, omnitronSFPGroup=omnitronSFPGroup, omnitronGroups=omnitronGroups, omnitronCompliances=omnitronCompliances, traphost3=traphost3, port6Membership=port6Membership, dhcpPortNumber=dhcpPortNumber, serialpass=serialpass, softrev=softrev, modulePortsEntry=modulePortsEntry, extended5=extended5, portSfpBitRate=portSfpBitRate, ahLocalMode=ahLocalMode, modname=modname, syscon=syscon, modExpSoftwareRev=modExpSoftwareRev, validityflag=validityflag, extended3=extended3, txDroppedEvents=txDroppedEvents, moduleEntry=moduleEntry, rxFragments=rxFragments, portFwdCpu=portFwdCpu, modchassname=modchassname, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, moduleTable=moduleTable, ahErroredFrameWindow=ahErroredFrameWindow, gateway=gateway, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, extended4=extended4, modprodtype=modprodtype, portSFPTable=portSFPTable, rxErrorPkts=rxErrorPkts, ostProtocolStatusIndex=ostProtocolStatusIndex, traphost8=traphost8, telnetpass=telnetpass, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, portSfpVendorPartNumber=portSfpVendorPartNumber, chassis=chassis, txMulticastPkts=txMulticastPkts, rxTotalPkts=rxTotalPkts, portIngressRateCBS=portIngressRateCBS, ahRemoteOUI=ahRemoteOUI, ipaddr2EVCassociation=ipaddr2EVCassociation, ostEnvironmentalTemperature=ostEnvironmentalTemperature, slotnum=slotnum, portcanonicalformatIndicator=portcanonicalformatIndicator, cpuVoltageIn=cpuVoltageIn, ostProtocoManagementPort=ostProtocoManagementPort, chassisname=chassisname, modvlanTableClear=modvlanTableClear, modLM80currents=modLM80currents, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portLinkState=portLinkState, ahRemoteParserState=ahRemoteParserState, enhancedchassisTable=enhancedchassisTable, modeType=modeType, modLM80volts=modLM80volts, modPcbRev=modPcbRev, nmmIpProtocolState=nmmIpProtocolState, port1Membership=port1Membership, portSfpDateCode=portSfpDateCode, slaveWrite=slaveWrite, moduleVLANEntry=moduleVLANEntry, portSFPpageA2=portSFPpageA2, portAccessType=portAccessType, portEgressRate=portEgressRate, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, managementModule=managementModule, prodAgent=prodAgent, rxPackets512to1023=rxPackets512to1023, cpuVoltageOut=cpuVoltageOut, tftpFileName=tftpFileName, portEgressQosPolicy=portEgressQosPolicy, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahRemoteSupportVar=ahRemoteSupportVar, userEntry=userEntry, txLateCollision=txLateCollision, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, mmname=mmname, ahRemoteLinkFlags=ahRemoteLinkFlags, gateway2=gateway2, PYSNMP_MODULE_ID=omnitronMIB, selfSlot=selfSlot, ostProtocolStatusTable=ostProtocolStatusTable, txDropPkts=txDropPkts, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, writeCommunity=writeCommunity, chassisnum=chassisnum, ahEnabled=ahEnabled, portState=portState, vlanidentifier=vlanidentifier, traphost4=traphost4, dhcpSubnetmask=dhcpSubnetmask, wrswitch=wrswitch, slaveTraps=slaveTraps, ahTransmissionRate=ahTransmissionRate, omnitronProducts=omnitronProducts, dhcpGateway=dhcpGateway, enableSNMPv3Function=enableSNMPv3Function, portSpeed=portSpeed, sysDateTime=sysDateTime, portL2CPmgntProcessing=portL2CPmgntProcessing, ahLocalSupportVar=ahLocalSupportVar, ftppasswrd=ftppasswrd, portIngressRateDropOrPause=portIngressRateDropOrPause, port3Membership=port3Membership, ahCriticalEventMode=ahCriticalEventMode, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, portpriority=portpriority, rxPackets65to127=rxPackets65to127, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, traphost7=traphost7, portStatsClear=portStatsClear, modserialnum=modserialnum, txMultipleCollision=txMultipleCollision, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ipAddr=ipAddr, portAHTable=portAHTable, modcommitNMMCfgChanges=modcommitNMMCfgChanges, nmmIpDisabled=nmmIpDisabled, portSFPEntry=portSFPEntry, portSFPstatus=portSFPstatus, rxPackets64=rxPackets64, portFwdCpuList=portFwdCpuList, ahLocalParserState=ahLocalParserState, ledstat=ledstat, moduleCount=moduleCount, dhcptftpServerIpAddress=dhcptftpServerIpAddress, portSfpVcc=portSfpVcc, ostProtocolStatusEntry=ostProtocolStatusEntry, rxJabbers=rxJabbers, snmpv3SecurityLevel=snmpv3SecurityLevel, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, chassistype=chassistype, portSFPpageA0=portSFPpageA0, moduleVLANTable=moduleVLANTable, traphost6=traphost6, vlanIdOst=vlanIdOst, userTable=userTable, port4Membership=port4Membership, rxUnicastPkts=rxUnicastPkts, modFpgaRev=modFpgaRev, modreset=modreset, modenable802dot1qProcessing=modenable802dot1qProcessing, txOctets64=txOctets64, extended1=extended1, rxDropPkts=rxDropPkts, modchasstype=modchasstype, ipaddrEVCassociation=ipaddrEVCassociation, mychassnum=mychassnum, customertag=customertag, slaveTrapsForward=slaveTrapsForward, omnitronCompliance=omnitronCompliance, partnum=partnum, rxPackets256to511=rxPackets256to511, portSfpVendorName=portSfpVendorName, txBroadcastPkts=txBroadcastPkts, modmanufdate=modmanufdate, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, capsMask=capsMask, index=index, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portnum=portnum, omnitronMIB=omnitronMIB, omnitronGroup=omnitronGroup, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, tftpEnable=tftpEnable, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahFrameErrorEventTotal=ahFrameErrorEventTotal, subnetmask=subnetmask, portvlanidentifier=portvlanidentifier, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, ahCriticalEventTrapList=ahCriticalEventTrapList, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, snmpv3UserName=snmpv3UserName, portStatsTable=portStatsTable, keepAliveInterval=keepAliveInterval, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, modchassnum=modchassnum, rxOctets=rxOctets, manufdate=manufdate, prodtype=prodtype, rxPackets1024to1518=rxPackets1024to1518, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxUndersizePkts=rxUndersizePkts)
mibBuilder.exportSymbols("OMNITRON-MIB", userIndex=userIndex, modtagsubstitution=modtagsubstitution, ahLpbkMode=ahLpbkMode, ahLocalMuxState=ahLocalMuxState, port2Membership=port2Membership, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, cpuTemperature=cpuTemperature, switchstat=switchstat, snmpv3UserType=snmpv3UserType, bootpEnable=bootpEnable, portSfpVendorSerialNumber=portSfpVendorSerialNumber, moduleMgtCfgTable=moduleMgtCfgTable, ahLocalOUI=ahLocalOUI, coreStatusOnly=coreStatusOnly, enableSNMPWrites=enableSNMPWrites, modLM80misc=modLM80misc, modnumports=modnumports, nmmCfgState=nmmCfgState, rxBroadcastPkts=rxBroadcastPkts, ahClearStatistics=ahClearStatistics, enabledFunctions=enabledFunctions, chassisTable=chassisTable, traphost5=traphost5, ahRemoteLinkPort=ahRemoteLinkPort, resetmod=resetmod, modswbuildnum=modswbuildnum, chassisEntry=chassisEntry, moduleMgtCfgEntry=moduleMgtCfgEntry, modportvlan=modportvlan, omnitronConformance=omnitronConformance, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, snmpv3PrivPassword=snmpv3PrivPassword, modExpLedStatus=modExpLedStatus, modulePortsTable=modulePortsTable, portAHEntry=portAHEntry, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, ingressPolicingType=ingressPolicingType, ahErroredFrameThreshold=ahErroredFrameThreshold, trapSrcIpSelect=trapSrcIpSelect, ostProtocolStatusState=ostProtocolStatusState, dhcpTagVid=dhcpTagVid, txCollisions=txCollisions, txSingleCollision=txSingleCollision, snmpv3AuthPassword=snmpv3AuthPassword, nmmSecureConnState=nmmSecureConnState, portingresssecurity=portingresssecurity, nmmOAMmgmtMode=nmmOAMmgmtMode, serialnum=serialnum, cnodeCIR=cnodeCIR, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, rxOversizePkts=rxOversizePkts, ahRemoteMuxState=ahRemoteMuxState, subnetmask2=subnetmask2, txErrorPkts=txErrorPkts)
