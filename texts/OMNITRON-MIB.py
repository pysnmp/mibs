...
OstPortList, omnitron, icAgent, OstModeType, OstPortNumber, OstVlanId = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortList", "omnitron", "icAgent", "OstModeType", "OstPortNumber", "OstVlanId")
...
mibBuilder.exportSymbols("OMNITRON-MIB", rxDropPkts=rxDropPkts, switchstat=switchstat, port6Membership=port6Membership, omnitronGroup=omnitronGroup, txDeferedTransmit=txDeferedTransmit, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portpriority=portpriority, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, rxSymbolErrors=rxSymbolErrors, telnetpass=telnetpass, ahLocalSupportVar=ahLocalSupportVar, dhcpGateway=dhcpGateway, traphost5=traphost5, tftpServerIpAddress=tftpServerIpAddress, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portSfpDateCode=portSfpDateCode, portvlanidentifier=portvlanidentifier, bootpEnable=bootpEnable, vlanPri=vlanPri, modportvlan=modportvlan, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, PYSNMP_MODULE_ID=omnitronMIB, rxTotalPkts=rxTotalPkts, txOctets=txOctets, txErrorPkts=txErrorPkts, snmpv3UserType=snmpv3UserType, modprodtype=modprodtype, ostProtocolStatusType=ostProtocolStatusType, modHwRev=modHwRev, modulePortsTable=modulePortsTable, modchassnum=modchassnum, ahFramePeriodEventTotal=ahFramePeriodEventTotal, modchassname=modchassname, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, portSfpVendorPartNumber=portSfpVendorPartNumber, ahRemoteOUI=ahRemoteOUI, chassisname=chassisname, modLM80volts=modLM80volts, portFwdCpu=portFwdCpu, ahRemoteMode=ahRemoteMode, traphost3=traphost3, txGoodPkts=txGoodPkts, rxFragments=rxFragments, gateway=gateway, cpuTemperature=cpuTemperature, enabledFunctions=enabledFunctions, modtagsubstitution=modtagsubstitution, rxPausePkts=rxPausePkts, dhcpIpAddr=dhcpIpAddr, userTable=userTable, port5Membership=port5Membership, portIngressRateDropOrPause=portIngressRateDropOrPause, modswbuildnum=modswbuildnum, prodtype=prodtype, nmmIpProtocolState=nmmIpProtocolState, omnitronConformance=omnitronConformance, ftppasswrd=ftppasswrd, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, txMultipleCollision=txMultipleCollision, snmpv3AuthPassword=snmpv3AuthPassword, portingresssecurity=portingresssecurity, moduleVLANEntry=moduleVLANEntry, modextfeaturebits=modextfeaturebits, omnitronProducts=omnitronProducts, extended5=extended5, ahRemoteParserState=ahRemoteParserState, muxGroupDefaults=muxGroupDefaults, ahErroredFrameWindow=ahErroredFrameWindow, traphost6=traphost6, portSFPpageA0=portSFPpageA0, selfSlot=selfSlot, portStatsEntry=portStatsEntry, ipAddr=ipAddr, portIngressRate=portIngressRate, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, portSfpVcc=portSfpVcc, rxPackets64=rxPackets64, moduleVLANTable=moduleVLANTable, modcommitVLANchanges=modcommitVLANchanges, manufdate=manufdate, mychassnum=mychassnum, ahLocalLinkFlags=ahLocalLinkFlags, traphost1=traphost1, traphost2=traphost2, rxErrorPkts=rxErrorPkts, userEntry=userEntry, modsoftrev=modsoftrev, mmname=mmname, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, port1Membership=port1Membership, txCollisions=txCollisions, ahLocalMuxState=ahLocalMuxState, omnitronCompliance=omnitronCompliance, extended3=extended3, portSfpBiasCurrent=portSfpBiasCurrent, modcommitNMMCfgChanges=modcommitNMMCfgChanges, extended2=extended2, modPcbRev=modPcbRev, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, dhcptftpServerIpAddress=dhcptftpServerIpAddress, extended1=extended1, serialnum=serialnum, modFpgaRev=modFpgaRev, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, sysDateTime=sysDateTime, portState=portState, vlanidentifier=vlanidentifier, portSfpBitRate=portSfpBitRate, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, modLM80misc=modLM80misc, traphost4=traphost4, resetmod=resetmod, portnum=portnum, slaveTraps=slaveTraps, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, rxOctets=rxOctets, txOctets64=txOctets64, portAHEntry=portAHEntry, txPausePkts=txPausePkts, txDropPkts=txDropPkts, rxPackets512to1023=rxPackets512to1023, ahLocalParserState=ahLocalParserState, snmpv3UserName=snmpv3UserName, modchasstype=modchasstype, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, cnodeControl=cnodeControl, enhancedchassisTable=enhancedchassisTable, ahRemoteLinkFlags=ahRemoteLinkFlags, ipaddrEVCassociation=ipaddrEVCassociation, rxPackets1024to1518=rxPackets1024to1518, tftpEnable=tftpEnable, omnitronSFPGroup=omnitronSFPGroup, rxFCSErrors=rxFCSErrors, dhcpTagVid=dhcpTagVid, txSingleCollision=txSingleCollision, modenable802dot1qProcessing=modenable802dot1qProcessing, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, snmpv3PrivPassword=snmpv3PrivPassword, portLinkState=portLinkState, macAddr=macAddr, dhcpPortNumber=dhcpPortNumber, modvlanTableClear=modvlanTableClear, ahRemoteSupportVar=ahRemoteSupportVar, customertag=customertag, modname=modname, chassis=chassis, modExpSoftwareRev=modExpSoftwareRev, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, userIndex=userIndex, modLM80currents=modLM80currents, traphost8=traphost8, cpuVoltageOut=cpuVoltageOut, nmmSecureMode=nmmSecureMode, writeCommunity=writeCommunity, ostProtocolStatusIndex=ostProtocolStatusIndex, wrswitch=wrswitch, cnodeCIR=cnodeCIR, tftpFileName=tftpFileName, ostProtocolStatusEntry=ostProtocolStatusEntry, modExpPartNumber=modExpPartNumber, index=index, ahLocalLpbkTimeout=ahLocalLpbkTimeout, cpuVoltageIn=cpuVoltageIn, rxOctets64=rxOctets64, modpartnum=modpartnum, coreStatusOnly=coreStatusOnly, portAccessType=portAccessType, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portSFPEntry=portSFPEntry, ostEnvironmentalTemperature=ostEnvironmentalTemperature, modreset=modreset, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portSFPTable=portSFPTable, portSfpTemperature=portSfpTemperature, readCommunity=readCommunity, vlanIdOst=vlanIdOst, chassisTable=chassisTable, ipAddr2=ipAddr2, portIngressRateCBS=portIngressRateCBS, rxPackets128to255=rxPackets128to255, prodrev=prodrev, portStatsTable=portStatsTable, ahTransmissionRate=ahTransmissionRate, dhcpSubnetmask=dhcpSubnetmask, extended4=extended4, modserialnum=modserialnum, prodAgent=prodAgent, ahRemoteLinkPort=ahRemoteLinkPort, slaveTrapsForward=slaveTrapsForward, moduleEntry=moduleEntry, ahRemoteMuxState=ahRemoteMuxState, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, slotnum=slotnum, serialpass=serialpass, rxUndersizePkts=rxUndersizePkts, txLateCollision=txLateCollision, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modulePortsEntry=modulePortsEntry, nmmSecureConnState=nmmSecureConnState, rxCRCAlignErrors=rxCRCAlignErrors, rxPackets65to127=rxPackets65to127, portSpeed=portSpeed, modeType=modeType, enableSNMPv3Function=enableSNMPv3Function, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modprodrev=modprodrev, sysloc=sysloc, rxUnicastPkts=rxUnicastPkts, rxOversizePkts=rxOversizePkts, rxMulticastPkts=rxMulticastPkts, ostProtocolStatusTable=ostProtocolStatusTable, ingressPolicingType=ingressPolicingType, ahLocalMode=ahLocalMode, nmmCfgState=nmmCfgState, extended6=extended6, moduleMgtCfgEntry=moduleMgtCfgEntry, subnetmask=subnetmask, txMulticastPkts=txMulticastPkts, trapSrcIpSelect=trapSrcIpSelect, rxBroadcastPkts=rxBroadcastPkts, snmpv3SecurityLevel=snmpv3SecurityLevel, syscon=syscon, defaultForwardingMap=defaultForwardingMap, ahErroredFrameThreshold=ahErroredFrameThreshold, rxJabbers=rxJabbers, moduleMgtCfgTable=moduleMgtCfgTable, enableSNMPWrites=enableSNMPWrites, ahLocalOUI=ahLocalOUI, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ahLpbkMode=ahLpbkMode, modmanufdate=modmanufdate, modslotnum=modslotnum, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, keepAliveInterval=keepAliveInterval, portmlistcriteria=portmlistcriteria, chassisnum=chassisnum, ostProtocolStatusState=ostProtocolStatusState, portEgressQosPolicy=portEgressQosPolicy, txUnicastPkts=txUnicastPkts, partnum=partnum, portAHTable=portAHTable, port2Membership=port2Membership, chassisEntry=chassisEntry, ledstat=ledstat, ahClearStatistics=ahClearStatistics, port4Membership=port4Membership, portDuplex=portDuplex, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, rxAlignmentErrors=rxAlignmentErrors, ahEnabled=ahEnabled, enableSNMPFunction=enableSNMPFunction, portL2CPmgntProcessing=portL2CPmgntProcessing)
mibBuilder.exportSymbols("OMNITRON-MIB", modRestoreFactoryDefaults=modRestoreFactoryDefaults, capsMask=capsMask, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, omnitronGroups=omnitronGroups, ipaddr2EVCassociation=ipaddr2EVCassociation, ahCriticalEventTrapList=ahCriticalEventTrapList, modnumports=modnumports, portEgressRate=portEgressRate, chassistype=chassistype, traphost7=traphost7, subnetmask2=subnetmask2, vlanservicetag=vlanservicetag, sysAdminStatus=sysAdminStatus, txExcessiveCollision=txExcessiveCollision, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, rxGoodPkts=rxGoodPkts, omnitronCompliances=omnitronCompliances, gateway2=gateway2, softrev=softrev, port3Membership=port3Membership, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, moduleCount=moduleCount, nmmSecureSlaveSlot=nmmSecureSlaveSlot, managementModule=managementModule, portSfpVendorSerialNumber=portSfpVendorSerialNumber, omnitronMIB=omnitronMIB, snmpTrapType=snmpTrapType, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, portcanonicalformatIndicator=portcanonicalformatIndicator, portMacAddress=portMacAddress, portSfpTxPower=portSfpTxPower, portSfpRxPower=portSfpRxPower, modulename=modulename, portSFPstatus=portSFPstatus, portSfpVendorName=portSfpVendorName, portFwdCpuList=portFwdCpuList, servicetag=servicetag, slaveWrite=slaveWrite, ahCriticalEventMode=ahCriticalEventMode, txBroadcastPkts=txBroadcastPkts, portegresspolicy=portegresspolicy, nmmOAMmgmtMode=nmmOAMmgmtMode, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, nmmIpDisabled=nmmIpDisabled, rxPackets256to511=rxPackets256to511, moduleTable=moduleTable, portSFPpageA2=portSFPpageA2, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ostProtocoManagementPort=ostProtocoManagementPort, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, validityflag=validityflag, portStatsClear=portStatsClear, txDroppedEvents=txDroppedEvents, modExpLedStatus=modExpLedStatus)
