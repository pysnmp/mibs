...
icAgent, OstPortList, OstPortNumber, OstVlanId, OstModeType, omnitron = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstPortList", "OstPortNumber", "OstVlanId", "OstModeType", "omnitron")
...
mibBuilder.exportSymbols("OMNITRON-MIB", serialnum=serialnum, ahErroredFrameWindow=ahErroredFrameWindow, chassisTable=chassisTable, ahLocalMode=ahLocalMode, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, rxErrorPkts=rxErrorPkts, enableSNMPFunction=enableSNMPFunction, modmanufdate=modmanufdate, nmmCfgState=nmmCfgState, mmname=mmname, userTable=userTable, trapSrcIpSelect=trapSrcIpSelect, enableSNMPWrites=enableSNMPWrites, moduleMgtCfgTable=moduleMgtCfgTable, modchassname=modchassname, portSFPpageA0=portSFPpageA0, traphost3=traphost3, ostProtocolStatusIndex=ostProtocolStatusIndex, moduleVLANEntry=moduleVLANEntry, modulename=modulename, omnitronCompliance=omnitronCompliance, modExpSoftwareRev=modExpSoftwareRev, rxPackets1024to1518=rxPackets1024to1518, managementModule=managementModule, syscon=syscon, portnum=portnum, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ipaddrEVCassociation=ipaddrEVCassociation, tftpServerIpAddress=tftpServerIpAddress, chassisEntry=chassisEntry, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, omnitronCompliances=omnitronCompliances, sysAdminStatus=sysAdminStatus, chassisnum=chassisnum, modprodrev=modprodrev, modtagsubstitution=modtagsubstitution, portSfpBiasCurrent=portSfpBiasCurrent, portDuplex=portDuplex, keepAliveInterval=keepAliveInterval, enabledFunctions=enabledFunctions, partnum=partnum, rxJabbers=rxJabbers, extended3=extended3, txSingleCollision=txSingleCollision, coreStatusOnly=coreStatusOnly, rxOversizePkts=rxOversizePkts, txOctets=txOctets, modenable802dot1qProcessing=modenable802dot1qProcessing, selfSlot=selfSlot, vlanPri=vlanPri, moduleCount=moduleCount, txOctets64=txOctets64, macAddr=macAddr, modsoftrev=modsoftrev, omnitronProducts=omnitronProducts, ahRemoteSupportVar=ahRemoteSupportVar, userEntry=userEntry, txPausePkts=txPausePkts, portSfpTxPower=portSfpTxPower, snmpv3PrivPassword=snmpv3PrivPassword, ahTransmissionRate=ahTransmissionRate, ostProtocolStatusTable=ostProtocolStatusTable, chassistype=chassistype, modchassnum=modchassnum, portIngressRate=portIngressRate, userIndex=userIndex, ahLocalParserState=ahLocalParserState, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modHwRev=modHwRev, vlanservicetag=vlanservicetag, moduleVLANTable=moduleVLANTable, rxUnicastPkts=rxUnicastPkts, modchasstype=modchasstype, portEgressRate=portEgressRate, rxMulticastPkts=rxMulticastPkts, dhcpIpAddr=dhcpIpAddr, txBroadcastPkts=txBroadcastPkts, traphost6=traphost6, txErrorPkts=txErrorPkts, snmpv3SecurityLevel=snmpv3SecurityLevel, snmpv3AuthPassword=snmpv3AuthPassword, portEgressQosPolicy=portEgressQosPolicy, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modLM80currents=modLM80currents, extended4=extended4, omnitronGroup=omnitronGroup, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portSfpVcc=portSfpVcc, snmpTrapType=snmpTrapType, serialpass=serialpass, portFwdCpu=portFwdCpu, validityflag=validityflag, chassisname=chassisname, portAHTable=portAHTable, ledstat=ledstat, modextfeaturebits=modextfeaturebits, moduleMgtCfgEntry=moduleMgtCfgEntry, sysDateTime=sysDateTime, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxAlignmentErrors=rxAlignmentErrors, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, vlanIdOst=vlanIdOst, extended1=extended1, dhcptftpServerIpAddress=dhcptftpServerIpAddress, rxFragments=rxFragments, mychassnum=mychassnum, snmpv3UserType=snmpv3UserType, modulePortsTable=modulePortsTable, portvlanidentifier=portvlanidentifier, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, cnodeControl=cnodeControl, ahErroredFrameThreshold=ahErroredFrameThreshold, tftpEnable=tftpEnable, portSFPstatus=portSFPstatus, portSfpVendorName=portSfpVendorName, slaveWrite=slaveWrite, rxPackets512to1023=rxPackets512to1023, softrev=softrev, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portAccessType=portAccessType, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ostProtocoManagementPort=ostProtocoManagementPort, rxUndersizePkts=rxUndersizePkts, PYSNMP_MODULE_ID=omnitronMIB, dhcpPortNumber=dhcpPortNumber, dhcpGateway=dhcpGateway, traphost4=traphost4, enableSNMPv3Function=enableSNMPv3Function, modExpLedStatus=modExpLedStatus, ftppasswrd=ftppasswrd, capsMask=capsMask, port5Membership=port5Membership, rxTotalPkts=rxTotalPkts, rxSymbolErrors=rxSymbolErrors, omnitronMIB=omnitronMIB, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modswbuildnum=modswbuildnum, traphost7=traphost7, modLM80misc=modLM80misc, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portAHEntry=portAHEntry, extended5=extended5, txLateCollision=txLateCollision, modcommitNMMCfgChanges=modcommitNMMCfgChanges, nmmIpDisabled=nmmIpDisabled, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, nmmSecureMode=nmmSecureMode, modFpgaRev=modFpgaRev, ostEnvironmentalTemperature=ostEnvironmentalTemperature, chassis=chassis, modserialnum=modserialnum, ahRemoteLinkPort=ahRemoteLinkPort, modExpPartNumber=modExpPartNumber, txDropPkts=txDropPkts, ipaddr2EVCassociation=ipaddr2EVCassociation, portSFPTable=portSFPTable, rxOctets64=rxOctets64, dhcpTagVid=dhcpTagVid, ahRemoteLinkFlags=ahRemoteLinkFlags, port4Membership=port4Membership, ahLocalMuxState=ahLocalMuxState, rxPausePkts=rxPausePkts, ahRemoteOUI=ahRemoteOUI, enhancedchassisTable=enhancedchassisTable, muxGroupDefaults=muxGroupDefaults, ahRemoteMode=ahRemoteMode, slotnum=slotnum, resetmod=resetmod, rxFCSErrors=rxFCSErrors, ahEnabled=ahEnabled, portState=portState, portIngressRateCBS=portIngressRateCBS, ahLpbkMode=ahLpbkMode, ipAddr2=ipAddr2, txDroppedEvents=txDroppedEvents, rxPackets64=rxPackets64, txDeferedTransmit=txDeferedTransmit, rxPackets65to127=rxPackets65to127, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, portStatsEntry=portStatsEntry, defaultForwardingMap=defaultForwardingMap, tftpFileName=tftpFileName, omnitronSFPGroup=omnitronSFPGroup, txUnicastPkts=txUnicastPkts, ingressPolicingType=ingressPolicingType, sysloc=sysloc, portL2CPmgntProcessing=portL2CPmgntProcessing, portSFPpageA2=portSFPpageA2, txMulticastPkts=txMulticastPkts, ahFramePeriodEventTotal=ahFramePeriodEventTotal, modPcbRev=modPcbRev, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, manufdate=manufdate, portMacAddress=portMacAddress, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, port2Membership=port2Membership, ostProtocolStatusState=ostProtocolStatusState, modname=modname, txMultipleCollision=txMultipleCollision, portcanonicalformatIndicator=portcanonicalformatIndicator, ipAddr=ipAddr, port3Membership=port3Membership, switchstat=switchstat, wrswitch=wrswitch, omnitronGroups=omnitronGroups, snmpv3UserName=snmpv3UserName, ahRemoteParserState=ahRemoteParserState, modportvlan=modportvlan, gateway=gateway, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, ostProtocolStatusEntry=ostProtocolStatusEntry, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ahCriticalEventMode=ahCriticalEventMode, txGoodPkts=txGoodPkts, rxCRCAlignErrors=rxCRCAlignErrors, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, portmlistcriteria=portmlistcriteria, cpuTemperature=cpuTemperature, port6Membership=port6Membership, portSFPEntry=portSFPEntry, prodrev=prodrev, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, prodAgent=prodAgent, nmmOAMmgmtMode=nmmOAMmgmtMode, modnumports=modnumports, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modslotnum=modslotnum, moduleEntry=moduleEntry, modLM80volts=modLM80volts, cpuVoltageOut=cpuVoltageOut, portFwdCpuList=portFwdCpuList, modpartnum=modpartnum, vlanidentifier=vlanidentifier, modulePortsEntry=modulePortsEntry, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portSfpDateCode=portSfpDateCode, bootpEnable=bootpEnable, extended2=extended2, modeType=modeType, modvlanTableClear=modvlanTableClear, servicetag=servicetag, rxPackets128to255=rxPackets128to255, portStatsTable=portStatsTable, traphost5=traphost5, port1Membership=port1Membership, readCommunity=readCommunity, portSfpVendorPartNumber=portSfpVendorPartNumber, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, subnetmask2=subnetmask2, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold)
mibBuilder.exportSymbols("OMNITRON-MIB", traphost1=traphost1, writeCommunity=writeCommunity, nmmIpProtocolState=nmmIpProtocolState, subnetmask=subnetmask, ahCriticalEventTrapList=ahCriticalEventTrapList, nmmSecureConnState=nmmSecureConnState, prodtype=prodtype, slaveTraps=slaveTraps, portSpeed=portSpeed, portIngressRateDropOrPause=portIngressRateDropOrPause, omnitronConformance=omnitronConformance, rxPackets256to511=rxPackets256to511, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, traphost8=traphost8, portLinkState=portLinkState, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, extended6=extended6, cnodeCIR=cnodeCIR, rxOctets=rxOctets, index=index, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, txExcessiveCollision=txExcessiveCollision, rxBroadcastPkts=rxBroadcastPkts, telnetpass=telnetpass, modprodtype=modprodtype, portegresspolicy=portegresspolicy, txCollisions=txCollisions, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, portSfpBitRate=portSfpBitRate, traphost2=traphost2, portpriority=portpriority, ahLocalLinkFlags=ahLocalLinkFlags, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, modcommitVLANchanges=modcommitVLANchanges, portSfpRxPower=portSfpRxPower, customertag=customertag, ostProtocolStatusType=ostProtocolStatusType, ahRemoteMuxState=ahRemoteMuxState, cpuVoltageIn=cpuVoltageIn, dhcpSubnetmask=dhcpSubnetmask, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, ahClearStatistics=ahClearStatistics, modreset=modreset, rxGoodPkts=rxGoodPkts, ahLocalSupportVar=ahLocalSupportVar, moduleTable=moduleTable, slaveTrapsForward=slaveTrapsForward, portSfpTemperature=portSfpTemperature, ahLocalOUI=ahLocalOUI, gateway2=gateway2, portingresssecurity=portingresssecurity, rxDropPkts=rxDropPkts, portStatsClear=portStatsClear, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow)
