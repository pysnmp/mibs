...
OstVlanId, OstModeType, OstPortList, omnitron, icAgent, OstPortNumber = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstVlanId", "OstModeType", "OstPortList", "omnitron", "icAgent", "OstPortNumber")
...
mibBuilder.exportSymbols("OMNITRON-MIB", writeCommunity=writeCommunity, switchstat=switchstat, defaultForwardingMap=defaultForwardingMap, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, port6Membership=port6Membership, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, trapSrcIpSelect=trapSrcIpSelect, ahLocalOUI=ahLocalOUI, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, chassistype=chassistype, modmanufdate=modmanufdate, portnum=portnum, portSfpVendorSerialNumber=portSfpVendorSerialNumber, userEntry=userEntry, rxSymbolErrors=rxSymbolErrors, rxGoodPkts=rxGoodPkts, cnodeControl=cnodeControl, modchassnum=modchassnum, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, enhancedchassisTable=enhancedchassisTable, validityflag=validityflag, ahRemoteMode=ahRemoteMode, portSpeed=portSpeed, serialpass=serialpass, traphost4=traphost4, portSFPstatus=portSFPstatus, ahRemoteLinkPort=ahRemoteLinkPort, gateway2=gateway2, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, modchasstype=modchasstype, snmpTrapType=snmpTrapType, omnitronProducts=omnitronProducts, txOctets=txOctets, sysAdminStatus=sysAdminStatus, portSfpDateCode=portSfpDateCode, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ftppasswrd=ftppasswrd, portegresspolicy=portegresspolicy, syscon=syscon, omnitronMIB=omnitronMIB, portSfpVendorPartNumber=portSfpVendorPartNumber, servicetag=servicetag, prodrev=prodrev, txDroppedEvents=txDroppedEvents, txLateCollision=txLateCollision, chassisTable=chassisTable, rxUnicastPkts=rxUnicastPkts, modLM80volts=modLM80volts, ahErroredFrameWindow=ahErroredFrameWindow, moduleVLANTable=moduleVLANTable, modenable802dot1qProcessing=modenable802dot1qProcessing, ahEnabled=ahEnabled, extended6=extended6, portSFPpageA0=portSFPpageA0, modcommitNMMCfgChanges=modcommitNMMCfgChanges, ahTransmissionRate=ahTransmissionRate, ostProtocolStatusTable=ostProtocolStatusTable, modExpPartNumber=modExpPartNumber, ahLocalLinkFlags=ahLocalLinkFlags, portSfpTxPower=portSfpTxPower, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, muxGroupDefaults=muxGroupDefaults, modextfeaturebits=modextfeaturebits, macAddr=macAddr, chassisname=chassisname, traphost2=traphost2, modeType=modeType, port4Membership=port4Membership, ahRemoteMuxState=ahRemoteMuxState, nmmCfgState=nmmCfgState, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ahLocalMode=ahLocalMode, prodtype=prodtype, mmname=mmname, customertag=customertag, ahLocalParserState=ahLocalParserState, ahRemoteSupportVar=ahRemoteSupportVar, capsMask=capsMask, moduleMgtCfgEntry=moduleMgtCfgEntry, coreStatusOnly=coreStatusOnly, dhcpGateway=dhcpGateway, portcanonicalformatIndicator=portcanonicalformatIndicator, modpartnum=modpartnum, portLinkState=portLinkState, omnitronSFPGroup=omnitronSFPGroup, omnitronGroups=omnitronGroups, ipAddr=ipAddr, traphost7=traphost7, portState=portState, ahFrameErrorEventTotal=ahFrameErrorEventTotal, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, moduleCount=moduleCount, modtagsubstitution=modtagsubstitution, ahLocalSupportVar=ahLocalSupportVar, dhcptftpServerIpAddress=dhcptftpServerIpAddress, txPausePkts=txPausePkts, subnetmask=subnetmask, traphost1=traphost1, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, portpriority=portpriority, modLM80currents=modLM80currents, rxTotalPkts=rxTotalPkts, portSfpRxPower=portSfpRxPower, PYSNMP_MODULE_ID=omnitronMIB, ahRemoteParserState=ahRemoteParserState, slaveWrite=slaveWrite, ostProtocolStatusState=ostProtocolStatusState, managementModule=managementModule, extended2=extended2, modulename=modulename, ingressPolicingType=ingressPolicingType, slaveTrapsForward=slaveTrapsForward, portL2CPmgntProcessing=portL2CPmgntProcessing, rxAlignmentErrors=rxAlignmentErrors, extended1=extended1, modswbuildnum=modswbuildnum, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portAHTable=portAHTable, dhcpTagVid=dhcpTagVid, modFpgaRev=modFpgaRev, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, rxFragments=rxFragments, cpuTemperature=cpuTemperature, mychassnum=mychassnum, portvlanidentifier=portvlanidentifier, ostEnvironmentalTemperature=ostEnvironmentalTemperature, modchassname=modchassname, ostProtocolStatusEntry=ostProtocolStatusEntry, txDropPkts=txDropPkts, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modPcbRev=modPcbRev, chassisEntry=chassisEntry, modname=modname, moduleVLANEntry=moduleVLANEntry, nmmIpProtocolState=nmmIpProtocolState, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, cpuVoltageIn=cpuVoltageIn, subnetmask2=subnetmask2, modserialnum=modserialnum, modreset=modreset, extended4=extended4, snmpv3PrivPassword=snmpv3PrivPassword, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, modprodtype=modprodtype, traphost3=traphost3, nmmOAMmgmtMode=nmmOAMmgmtMode, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, snmpv3SecurityLevel=snmpv3SecurityLevel, partnum=partnum, nmmSecureSlaveSlot=nmmSecureSlaveSlot, traphost6=traphost6, dhcpPortNumber=dhcpPortNumber, modLM80misc=modLM80misc, moduleEntry=moduleEntry, nmmIpDisabled=nmmIpDisabled, rxOctets=rxOctets, rxPackets128to255=rxPackets128to255, cnodeCIR=cnodeCIR, tftpFileName=tftpFileName, rxDropPkts=rxDropPkts, portSfpVendorName=portSfpVendorName, enableSNMPWrites=enableSNMPWrites, rxJabbers=rxJabbers, txErrorPkts=txErrorPkts, txExcessiveCollision=txExcessiveCollision, ostProtocolStatusIndex=ostProtocolStatusIndex, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, prodAgent=prodAgent, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, userTable=userTable, serialnum=serialnum, portSfpTemperature=portSfpTemperature, portSfpVcc=portSfpVcc, sysDateTime=sysDateTime, nmmSecureConnState=nmmSecureConnState, portAHEntry=portAHEntry, portStatsClear=portStatsClear, softrev=softrev, modprodrev=modprodrev, port1Membership=port1Membership, modHwRev=modHwRev, traphost5=traphost5, txUnicastPkts=txUnicastPkts, vlanidentifier=vlanidentifier, portSfpBitRate=portSfpBitRate, ahRemoteLinkFlags=ahRemoteLinkFlags, tftpServerIpAddress=tftpServerIpAddress, cpuVoltageOut=cpuVoltageOut, rxBroadcastPkts=rxBroadcastPkts, ahCriticalEventMode=ahCriticalEventMode, txSingleCollision=txSingleCollision, port3Membership=port3Membership, ipaddr2EVCassociation=ipaddr2EVCassociation, portIngressRateCBS=portIngressRateCBS, ahLocalMuxState=ahLocalMuxState, ostProtocolStatusType=ostProtocolStatusType, rxPackets64=rxPackets64, modcommitVLANchanges=modcommitVLANchanges, ahLocalLpbkTimeout=ahLocalLpbkTimeout, modsoftrev=modsoftrev, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portMacAddress=portMacAddress, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, portSFPEntry=portSFPEntry, portFwdCpu=portFwdCpu, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modnumports=modnumports, modulePortsEntry=modulePortsEntry, ipaddrEVCassociation=ipaddrEVCassociation, vlanservicetag=vlanservicetag, portIngressRateDropOrPause=portIngressRateDropOrPause, rxMulticastPkts=rxMulticastPkts, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, extended5=extended5, port5Membership=port5Membership, txGoodPkts=txGoodPkts, enableSNMPv3Function=enableSNMPv3Function, rxPausePkts=rxPausePkts, nmmSecureMode=nmmSecureMode, txDeferedTransmit=txDeferedTransmit, modslotnum=modslotnum, ledstat=ledstat, rxUndersizePkts=rxUndersizePkts, rxCRCAlignErrors=rxCRCAlignErrors, vlanIdOst=vlanIdOst, manufdate=manufdate, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, portFwdCpuList=portFwdCpuList, chassis=chassis, extended3=extended3, resetmod=resetmod, enabledFunctions=enabledFunctions, selfSlot=selfSlot, portingresssecurity=portingresssecurity, rxOversizePkts=rxOversizePkts, vlanPri=vlanPri, ahCriticalEventTrapList=ahCriticalEventTrapList, modExpSoftwareRev=modExpSoftwareRev, portSFPTable=portSFPTable, txMulticastPkts=txMulticastPkts, ahLpbkMode=ahLpbkMode, bootpEnable=bootpEnable, gateway=gateway, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ipAddr2=ipAddr2, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, snmpv3UserType=snmpv3UserType, modvlanTableClear=modvlanTableClear, txBroadcastPkts=txBroadcastPkts, telnetpass=telnetpass, txCollisions=txCollisions, rxFCSErrors=rxFCSErrors)
mibBuilder.exportSymbols("OMNITRON-MIB", ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahRemoteOUI=ahRemoteOUI, ahFramePeriodEventTotal=ahFramePeriodEventTotal, tftpEnable=tftpEnable, portDuplex=portDuplex, moduleMgtCfgTable=moduleMgtCfgTable, rxPackets1024to1518=rxPackets1024to1518, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, rxPackets256to511=rxPackets256to511, ahErroredFrameThreshold=ahErroredFrameThreshold, snmpv3AuthPassword=snmpv3AuthPassword, omnitronCompliance=omnitronCompliance, portStatsTable=portStatsTable, dhcpSubnetmask=dhcpSubnetmask, modRestoreFactoryDefaults=modRestoreFactoryDefaults, portmlistcriteria=portmlistcriteria, rxPackets65to127=rxPackets65to127, modportvlan=modportvlan, modulePortsTable=modulePortsTable, omnitronConformance=omnitronConformance, slaveTraps=slaveTraps, txOctets64=txOctets64, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, snmpv3UserName=snmpv3UserName, modExpLedStatus=modExpLedStatus, ahClearStatistics=ahClearStatistics, txMultipleCollision=txMultipleCollision, rxPackets512to1023=rxPackets512to1023, portSfpBiasCurrent=portSfpBiasCurrent, rxOctets64=rxOctets64, sysloc=sysloc, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, slotnum=slotnum, readCommunity=readCommunity, portAccessType=portAccessType, keepAliveInterval=keepAliveInterval, portStatsEntry=portStatsEntry, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ostProtocoManagementPort=ostProtocoManagementPort, rxErrorPkts=rxErrorPkts, omnitronCompliances=omnitronCompliances, portEgressQosPolicy=portEgressQosPolicy, portSFPpageA2=portSFPpageA2, chassisnum=chassisnum, index=index, enableSNMPFunction=enableSNMPFunction, portIngressRate=portIngressRate, port2Membership=port2Membership, portEgressRate=portEgressRate, omnitronGroup=omnitronGroup, dhcpIpAddr=dhcpIpAddr, moduleTable=moduleTable, userIndex=userIndex, traphost8=traphost8, wrswitch=wrswitch)
