...
mibBuilder.exportSymbols("OMNITRON-MIB", slaveWrite=slaveWrite, ahFramePeriodEventTotal=ahFramePeriodEventTotal, keepAliveInterval=keepAliveInterval, port4Membership=port4Membership, nmmCfgState=nmmCfgState, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portSfpVcc=portSfpVcc, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, mmname=mmname, chassisEntry=chassisEntry, moduleCount=moduleCount, ipAddr=ipAddr, portSfpRxPower=portSfpRxPower, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, portmlistcriteria=portmlistcriteria, modPcbRev=modPcbRev, rxPackets256to511=rxPackets256to511, rxOctets=rxOctets, partnum=partnum, serialnum=serialnum, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, modprodrev=modprodrev, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, chassis=chassis, port3Membership=port3Membership, nmmSecureMode=nmmSecureMode, dhcpGateway=dhcpGateway, dhcptftpServerIpAddress=dhcptftpServerIpAddress, sysAdminStatus=sysAdminStatus, PYSNMP_MODULE_ID=omnitronMIB, moduleVLANEntry=moduleVLANEntry, portSfpTemperature=portSfpTemperature, modcommitVLANchanges=modcommitVLANchanges, mychassnum=mychassnum, ostProtocoManagementPort=ostProtocoManagementPort, modname=modname, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, rxBroadcastPkts=rxBroadcastPkts, snmpv3PrivPassword=snmpv3PrivPassword, portL2CPmgntProcessing=portL2CPmgntProcessing, modeType=modeType, prodtype=prodtype, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, chassisTable=chassisTable, portDuplex=portDuplex, ahErroredFrameWindow=ahErroredFrameWindow, prodrev=prodrev, omnitronConformance=omnitronConformance, modvlanTableClear=modvlanTableClear, capsMask=capsMask, ahRemoteOUI=ahRemoteOUI, modextfeaturebits=modextfeaturebits, ipaddr2EVCassociation=ipaddr2EVCassociation, coreStatusOnly=coreStatusOnly, modFpgaRev=modFpgaRev, txLateCollision=txLateCollision, portMacAddress=portMacAddress, modnumports=modnumports, userTable=userTable, serialpass=serialpass, ipaddrEVCassociation=ipaddrEVCassociation, rxGoodPkts=rxGoodPkts, selfSlot=selfSlot, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, omnitronGroup=omnitronGroup, ahLocalMuxState=ahLocalMuxState, telnetpass=telnetpass, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, managementModule=managementModule, omnitronProducts=omnitronProducts, modchassname=modchassname, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, enhancedchassisTable=enhancedchassisTable, cpuVoltageOut=cpuVoltageOut, dhcpSubnetmask=dhcpSubnetmask, slaveTraps=slaveTraps, ahLocalLinkFlags=ahLocalLinkFlags, modenable802dot1qProcessing=modenable802dot1qProcessing, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, syscon=syscon, vlanservicetag=vlanservicetag, subnetmask2=subnetmask2, rxCRCAlignErrors=rxCRCAlignErrors, tftpFileName=tftpFileName, modulePortsEntry=modulePortsEntry, extended3=extended3, ipAddr2=ipAddr2, ostProtocolStatusState=ostProtocolStatusState, extended6=extended6, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, enabledFunctions=enabledFunctions, gateway=gateway, port6Membership=port6Membership, ahClearStatistics=ahClearStatistics, sysDateTime=sysDateTime, portIngressRateCBS=portIngressRateCBS, txDroppedEvents=txDroppedEvents, modpartnum=modpartnum, ftppasswrd=ftppasswrd, slaveTrapsForward=slaveTrapsForward, rxPackets1024to1518=rxPackets1024to1518, portState=portState, portIngressRateDropOrPause=portIngressRateDropOrPause, ahLpbkMode=ahLpbkMode, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, extended1=extended1, modcommitNMMCfgChanges=modcommitNMMCfgChanges, trapSrcIpSelect=trapSrcIpSelect, portFwdCpuList=portFwdCpuList, slotnum=slotnum, sysloc=sysloc, moduleTable=moduleTable, txBroadcastPkts=txBroadcastPkts, traphost4=traphost4, portnum=portnum, extended5=extended5, omnitronGroups=omnitronGroups, portvlanidentifier=portvlanidentifier, omnitronMIB=omnitronMIB, moduleVLANTable=moduleVLANTable, prodAgent=prodAgent, extended4=extended4, ahEnabled=ahEnabled, traphost7=traphost7, txUnicastPkts=txUnicastPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, modRestoreFactoryDefaults=modRestoreFactoryDefaults, chassisname=chassisname, rxJabbers=rxJabbers, port2Membership=port2Membership, modLM80currents=modLM80currents, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, modulename=modulename, portIngressRate=portIngressRate, servicetag=servicetag, dhcpIpAddr=dhcpIpAddr, readCommunity=readCommunity, rxTotalPkts=rxTotalPkts, ingressPolicingType=ingressPolicingType, omnitronCompliances=omnitronCompliances, rxOversizePkts=rxOversizePkts, snmpv3UserType=snmpv3UserType, portSpeed=portSpeed, txSingleCollision=txSingleCollision, omnitronCompliance=omnitronCompliance, macAddr=macAddr, defaultForwardingMap=defaultForwardingMap, portegresspolicy=portegresspolicy, portSFPstatus=portSFPstatus, portcanonicalformatIndicator=portcanonicalformatIndicator, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, traphost2=traphost2, modchasstype=modchasstype, modchassnum=modchassnum, tftpServerIpAddress=tftpServerIpAddress, traphost8=traphost8, customertag=customertag, dhcpTagVid=dhcpTagVid, ahLocalParserState=ahLocalParserState, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portSFPEntry=portSFPEntry, manufdate=manufdate, cpuTemperature=cpuTemperature, rxFCSErrors=rxFCSErrors, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portEgressRate=portEgressRate, portSfpBitRate=portSfpBitRate, muxGroupDefaults=muxGroupDefaults, rxOctets64=rxOctets64, modLM80misc=modLM80misc, ahRemoteParserState=ahRemoteParserState, snmpv3AuthPassword=snmpv3AuthPassword, userEntry=userEntry, txErrorPkts=txErrorPkts, ahLocalSupportVar=ahLocalSupportVar, chassisnum=chassisnum, portSfpTxPower=portSfpTxPower, nmmIpProtocolState=nmmIpProtocolState, vlanidentifier=vlanidentifier, portLinkState=portLinkState, ahCriticalEventMode=ahCriticalEventMode, rxPackets512to1023=rxPackets512to1023, snmpv3UserName=snmpv3UserName, ostProtocolStatusEntry=ostProtocolStatusEntry, rxUnicastPkts=rxUnicastPkts, writeCommunity=writeCommunity, portFwdCpu=portFwdCpu, ostProtocolStatusIndex=ostProtocolStatusIndex, moduleEntry=moduleEntry, cnodeControl=cnodeControl, omnitronSFPGroup=omnitronSFPGroup, subnetmask=subnetmask, portSfpBiasCurrent=portSfpBiasCurrent, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, wrswitch=wrswitch, rxUndersizePkts=rxUndersizePkts, rxFragments=rxFragments, nmmSecureSlaveSlot=nmmSecureSlaveSlot, rxPackets64=rxPackets64, traphost6=traphost6, snmpTrapType=snmpTrapType, moduleMgtCfgEntry=moduleMgtCfgEntry, vlanIdOst=vlanIdOst, ahLocalOUI=ahLocalOUI, portStatsEntry=portStatsEntry, txOctets=txOctets, traphost3=traphost3, txGoodPkts=txGoodPkts, txMultipleCollision=txMultipleCollision, portSfpVendorPartNumber=portSfpVendorPartNumber, modsoftrev=modsoftrev, modmanufdate=modmanufdate, tftpEnable=tftpEnable, rxDropPkts=rxDropPkts, txDeferedTransmit=txDeferedTransmit, txExcessiveCollision=txExcessiveCollision, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, rxPackets65to127=rxPackets65to127, portingresssecurity=portingresssecurity, switchstat=switchstat, rxSymbolErrors=rxSymbolErrors, modExpLedStatus=modExpLedStatus, modswbuildnum=modswbuildnum, enableSNMPv3Function=enableSNMPv3Function, cpuVoltageIn=cpuVoltageIn, vlanPri=vlanPri, index=index, userIndex=userIndex, portAccessType=portAccessType, modtagsubstitution=modtagsubstitution, portSFPTable=portSFPTable, ahLocalMode=ahLocalMode, ostEnvironmentalTemperature=ostEnvironmentalTemperature, rxPausePkts=rxPausePkts, portStatsClear=portStatsClear, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, modExpPartNumber=modExpPartNumber, extended2=extended2, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahRemoteSupportVar=ahRemoteSupportVar, bootpEnable=bootpEnable, softrev=softrev, enableSNMPFunction=enableSNMPFunction, ostProtocolStatusType=ostProtocolStatusType, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, nmmSecureConnState=nmmSecureConnState, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, portAHTable=portAHTable, ahRemoteLinkPort=ahRemoteLinkPort, portAHEntry=portAHEntry, traphost1=traphost1)
mibBuilder.exportSymbols("OMNITRON-MIB", snmpv3SecurityLevel=snmpv3SecurityLevel, portSFPpageA0=portSFPpageA0, enableSNMPWrites=enableSNMPWrites, chassistype=chassistype, txCollisions=txCollisions, ostProtocolStatusTable=ostProtocolStatusTable, modHwRev=modHwRev, txDropPkts=txDropPkts, ahFrameErrorEventTotal=ahFrameErrorEventTotal, validityflag=validityflag, portpriority=portpriority, ahErroredFrameThreshold=ahErroredFrameThreshold, ledstat=ledstat, rxAlignmentErrors=rxAlignmentErrors, ahRemoteMode=ahRemoteMode, modserialnum=modserialnum, modreset=modreset, portSfpDateCode=portSfpDateCode, modLM80volts=modLM80volts, nmmOAMmgmtMode=nmmOAMmgmtMode, modportvlan=modportvlan, portSFPpageA2=portSFPpageA2, portStatsTable=portStatsTable, ahTransmissionRate=ahTransmissionRate, ahLocalLpbkTimeout=ahLocalLpbkTimeout, cnodeCIR=cnodeCIR, gateway2=gateway2, txOctets64=txOctets64, modprodtype=modprodtype, resetmod=resetmod, portSfpVendorName=portSfpVendorName, rxPackets128to255=rxPackets128to255, port5Membership=port5Membership, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modulePortsTable=modulePortsTable, ahRemoteLinkFlags=ahRemoteLinkFlags, port1Membership=port1Membership, txMulticastPkts=txMulticastPkts, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, rxMulticastPkts=rxMulticastPkts, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, traphost5=traphost5, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, ahCriticalEventTrapList=ahCriticalEventTrapList, modExpSoftwareRev=modExpSoftwareRev, txPausePkts=txPausePkts, modslotnum=modslotnum, dhcpPortNumber=dhcpPortNumber, ahRemoteMuxState=ahRemoteMuxState, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, nmmIpDisabled=nmmIpDisabled, moduleMgtCfgTable=moduleMgtCfgTable, rxErrorPkts=rxErrorPkts, portEgressQosPolicy=portEgressQosPolicy)
