...
icAgent, OstModeType, OstVlanId, OstPortNumber, omnitron, OstPortList = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstModeType", "OstVlanId", "OstPortNumber", "omnitron", "OstPortList")
...
mibBuilder.exportSymbols("OMNITRON-MIB", ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, traphost8=traphost8, traphost3=traphost3, prodAgent=prodAgent, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, ledstat=ledstat, readCommunity=readCommunity, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, portEgressQosPolicy=portEgressQosPolicy, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, portLinkState=portLinkState, txPausePkts=txPausePkts, txMulticastPkts=txMulticastPkts, servicetag=servicetag, port5Membership=port5Membership, portMacAddress=portMacAddress, mmname=mmname, userIndex=userIndex, sysAdminStatus=sysAdminStatus, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, rxPackets128to255=rxPackets128to255, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, ipAddr=ipAddr, traphost1=traphost1, wrswitch=wrswitch, chassisnum=chassisnum, portDuplex=portDuplex, txMultipleCollision=txMultipleCollision, snmpv3SecurityLevel=snmpv3SecurityLevel, rxPackets64=rxPackets64, rxPackets256to511=rxPackets256to511, prodtype=prodtype, modreset=modreset, portIngressRate=portIngressRate, modchassname=modchassname, txDroppedEvents=txDroppedEvents, ahRemoteMuxState=ahRemoteMuxState, ahRemoteLinkFlags=ahRemoteLinkFlags, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, rxAlignmentErrors=rxAlignmentErrors, dhcpGateway=dhcpGateway, txExcessiveCollision=txExcessiveCollision, tftpServerIpAddress=tftpServerIpAddress, syscon=syscon, portSFPTable=portSFPTable, nmmSecureMode=nmmSecureMode, txCollisions=txCollisions, selfSlot=selfSlot, enableSNMPWrites=enableSNMPWrites, rxOctets64=rxOctets64, snmpv3UserType=snmpv3UserType, serialpass=serialpass, vlanIdOst=vlanIdOst, portSFPstatus=portSFPstatus, txUnicastPkts=txUnicastPkts, portSfpRxPower=portSfpRxPower, rxUndersizePkts=rxUndersizePkts, tftpFileName=tftpFileName, ostProtocolStatusTable=ostProtocolStatusTable, traphost6=traphost6, modchassnum=modchassnum, port4Membership=port4Membership, moduleVLANTable=moduleVLANTable, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, dhcpSubnetmask=dhcpSubnetmask, moduleMgtCfgTable=moduleMgtCfgTable, omnitronMIB=omnitronMIB, cpuVoltageOut=cpuVoltageOut, port2Membership=port2Membership, slaveTrapsForward=slaveTrapsForward, rxPackets512to1023=rxPackets512to1023, muxGroupDefaults=muxGroupDefaults, modLM80volts=modLM80volts, telnetpass=telnetpass, portSfpTemperature=portSfpTemperature, modtagsubstitution=modtagsubstitution, omnitronConformance=omnitronConformance, modenable802dot1qProcessing=modenable802dot1qProcessing, rxBroadcastPkts=rxBroadcastPkts, port6Membership=port6Membership, ahLocalLpbkTimeout=ahLocalLpbkTimeout, rxTotalPkts=rxTotalPkts, omnitronSFPGroup=omnitronSFPGroup, ahRemoteLinkPort=ahRemoteLinkPort, traphost5=traphost5, moduleTable=moduleTable, prodrev=prodrev, portpriority=portpriority, ahRemoteOUI=ahRemoteOUI, portAHEntry=portAHEntry, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, ahEnabled=ahEnabled, portSfpBiasCurrent=portSfpBiasCurrent, customertag=customertag, subnetmask=subnetmask, traphost2=traphost2, modHwRev=modHwRev, rxFragments=rxFragments, portingresssecurity=portingresssecurity, ahRemoteSupportVar=ahRemoteSupportVar, resetmod=resetmod, modchasstype=modchasstype, index=index, ostProtocolStatusIndex=ostProtocolStatusIndex, ahLocalSupportVar=ahLocalSupportVar, nmmSecureConnState=nmmSecureConnState, portSfpTxPower=portSfpTxPower, modslotnum=modslotnum, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, portFwdCpu=portFwdCpu, ostProtocolStatusState=ostProtocolStatusState, moduleEntry=moduleEntry, nmmOAMmgmtMode=nmmOAMmgmtMode, ahCriticalEventTrapList=ahCriticalEventTrapList, sysloc=sysloc, ahErroredFrameThreshold=ahErroredFrameThreshold, rxJabbers=rxJabbers, moduleVLANEntry=moduleVLANEntry, gateway=gateway, extended4=extended4, modvlanTableClear=modvlanTableClear, gateway2=gateway2, rxPausePkts=rxPausePkts, modulePortsTable=modulePortsTable, enhancedchassisTable=enhancedchassisTable, managementModule=managementModule, nmmIpDisabled=nmmIpDisabled, portnum=portnum, ipAddr2=ipAddr2, portSfpVcc=portSfpVcc, rxGoodPkts=rxGoodPkts, macAddr=macAddr, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahLocalLinkFlags=ahLocalLinkFlags, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, rxPackets1024to1518=rxPackets1024to1518, modmanufdate=modmanufdate, portAccessType=portAccessType, ftppasswrd=ftppasswrd, ahRemoteParserState=ahRemoteParserState, txOctets64=txOctets64, modulePortsEntry=modulePortsEntry, cnodeControl=cnodeControl, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxSymbolErrors=rxSymbolErrors, modprodrev=modprodrev, ahRemoteMode=ahRemoteMode, portSFPpageA0=portSFPpageA0, txDeferedTransmit=txDeferedTransmit, txOctets=txOctets, rxMulticastPkts=rxMulticastPkts, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, chassistype=chassistype, keepAliveInterval=keepAliveInterval, modExpLedStatus=modExpLedStatus, portState=portState, sysDateTime=sysDateTime, modLM80misc=modLM80misc, chassisTable=chassisTable, modsoftrev=modsoftrev, defaultForwardingMap=defaultForwardingMap, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, snmpv3AuthPassword=snmpv3AuthPassword, snmpv3UserName=snmpv3UserName, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ahLocalParserState=ahLocalParserState, ahErroredFrameWindow=ahErroredFrameWindow, port3Membership=port3Membership, slaveTraps=slaveTraps, traphost7=traphost7, modRestoreFactoryDefaults=modRestoreFactoryDefaults, manufdate=manufdate, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, ahFrameErrorEventTotal=ahFrameErrorEventTotal, dhcpIpAddr=dhcpIpAddr, ahCriticalEventMode=ahCriticalEventMode, txDropPkts=txDropPkts, dhcpTagVid=dhcpTagVid, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, vlanservicetag=vlanservicetag, portSpeed=portSpeed, vlanPri=vlanPri, txGoodPkts=txGoodPkts, nmmSecureSlaveSlot=nmmSecureSlaveSlot, omnitronGroup=omnitronGroup, chassisname=chassisname, cpuVoltageIn=cpuVoltageIn, rxUnicastPkts=rxUnicastPkts, rxCRCAlignErrors=rxCRCAlignErrors, extended6=extended6, modPcbRev=modPcbRev, enableSNMPFunction=enableSNMPFunction, ostProtocoManagementPort=ostProtocoManagementPort, ipaddrEVCassociation=ipaddrEVCassociation, modFpgaRev=modFpgaRev, portegresspolicy=portegresspolicy, extended2=extended2, writeCommunity=writeCommunity, txSingleCollision=txSingleCollision, subnetmask2=subnetmask2, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ahLocalOUI=ahLocalOUI, portSFPpageA2=portSFPpageA2, portIngressRateCBS=portIngressRateCBS, cnodeCIR=cnodeCIR, traphost4=traphost4, nmmIpProtocolState=nmmIpProtocolState, portmlistcriteria=portmlistcriteria, port1Membership=port1Membership, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, slotnum=slotnum, extended1=extended1, omnitronGroups=omnitronGroups, cpuTemperature=cpuTemperature, snmpv3PrivPassword=snmpv3PrivPassword, chassis=chassis, dhcpPortNumber=dhcpPortNumber, bootpEnable=bootpEnable, tftpEnable=tftpEnable, rxPackets65to127=rxPackets65to127, portAHTable=portAHTable, portStatsClear=portStatsClear, extended5=extended5, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, mychassnum=mychassnum, ahTransmissionRate=ahTransmissionRate, txLateCollision=txLateCollision, ostProtocolStatusType=ostProtocolStatusType, modserialnum=modserialnum, snmpTrapType=snmpTrapType, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, vlanidentifier=vlanidentifier, ostProtocolStatusEntry=ostProtocolStatusEntry, portvlanidentifier=portvlanidentifier, softrev=softrev, trapSrcIpSelect=trapSrcIpSelect, enabledFunctions=enabledFunctions, txErrorPkts=txErrorPkts, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, modExpPartNumber=modExpPartNumber, ingressPolicingType=ingressPolicingType, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, enableSNMPv3Function=enableSNMPv3Function, PYSNMP_MODULE_ID=omnitronMIB, portFwdCpuList=portFwdCpuList, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, modextfeaturebits=modextfeaturebits, portIngressRateDropOrPause=portIngressRateDropOrPause, ahClearStatistics=ahClearStatistics, modprodtype=modprodtype, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, rxErrorPkts=rxErrorPkts)
mibBuilder.exportSymbols("OMNITRON-MIB", coreStatusOnly=coreStatusOnly, portSFPEntry=portSFPEntry, rxOversizePkts=rxOversizePkts, chassisEntry=chassisEntry, portStatsTable=portStatsTable, portSfpBitRate=portSfpBitRate, serialnum=serialnum, ahLpbkMode=ahLpbkMode, modLM80currents=modLM80currents, modcommitNMMCfgChanges=modcommitNMMCfgChanges, portSfpVendorPartNumber=portSfpVendorPartNumber, portSfpVendorSerialNumber=portSfpVendorSerialNumber, portSfpDateCode=portSfpDateCode, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modulename=modulename, validityflag=validityflag, userTable=userTable, modportvlan=modportvlan, omnitronProducts=omnitronProducts, modpartnum=modpartnum, portEgressRate=portEgressRate, capsMask=capsMask, moduleCount=moduleCount, modswbuildnum=modswbuildnum, portcanonicalformatIndicator=portcanonicalformatIndicator, omnitronCompliance=omnitronCompliance, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modExpSoftwareRev=modExpSoftwareRev, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, userEntry=userEntry, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, modeType=modeType, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, ahLocalMode=ahLocalMode, moduleMgtCfgEntry=moduleMgtCfgEntry, modname=modname, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, ostEnvironmentalTemperature=ostEnvironmentalTemperature, rxOctets=rxOctets, ipaddr2EVCassociation=ipaddr2EVCassociation, rxDropPkts=rxDropPkts, rxFCSErrors=rxFCSErrors, slaveWrite=slaveWrite, nmmCfgState=nmmCfgState, partnum=partnum, omnitronCompliances=omnitronCompliances, portStatsEntry=portStatsEntry, portSfpVendorName=portSfpVendorName, switchstat=switchstat, modcommitVLANchanges=modcommitVLANchanges, txBroadcastPkts=txBroadcastPkts, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, modnumports=modnumports, extended3=extended3, ahLocalMuxState=ahLocalMuxState, portL2CPmgntProcessing=portL2CPmgntProcessing)
