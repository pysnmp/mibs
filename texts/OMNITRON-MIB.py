...
icAgent, OstPortNumber, omnitron, OstPortList, OstVlanId, OstModeType = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstPortNumber", "omnitron", "OstPortList", "OstVlanId", "OstModeType")
...
mibBuilder.exportSymbols("OMNITRON-MIB", portSFPpageA2=portSFPpageA2, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, modExpSoftwareRev=modExpSoftwareRev, modeType=modeType, omnitronGroups=omnitronGroups, ahLpbkMode=ahLpbkMode, ostProtocolStatusState=ostProtocolStatusState, txOctets64=txOctets64, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, modname=modname, prodAgent=prodAgent, ahTransmissionRate=ahTransmissionRate, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, portSfpBitRate=portSfpBitRate, extended4=extended4, portcanonicalformatIndicator=portcanonicalformatIndicator, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, vlanidentifier=vlanidentifier, macAddr=macAddr, ostProtocolStatusEntry=ostProtocolStatusEntry, portAHTable=portAHTable, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, modportvlan=modportvlan, rxPackets65to127=rxPackets65to127, modchassnum=modchassnum, nmmIpDisabled=nmmIpDisabled, slaveTraps=slaveTraps, portFwdCpu=portFwdCpu, traphost7=traphost7, mychassnum=mychassnum, ahClearStatistics=ahClearStatistics, portingresssecurity=portingresssecurity, ftppasswrd=ftppasswrd, ahLocalOUI=ahLocalOUI, moduleMgtCfgTable=moduleMgtCfgTable, writeCommunity=writeCommunity, enableSNMPWrites=enableSNMPWrites, portpriority=portpriority, extended2=extended2, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, portSfpVendorPartNumber=portSfpVendorPartNumber, portmlistcriteria=portmlistcriteria, portSFPTable=portSFPTable, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, portDuplex=portDuplex, ahLocalParserState=ahLocalParserState, rxFCSErrors=rxFCSErrors, ipAddr2=ipAddr2, partnum=partnum, portEgressQosPolicy=portEgressQosPolicy, modprodrev=modprodrev, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, portSfpBiasCurrent=portSfpBiasCurrent, omnitronCompliances=omnitronCompliances, vlanPri=vlanPri, portegresspolicy=portegresspolicy, portSFPEntry=portSFPEntry, prodrev=prodrev, rxMulticastPkts=rxMulticastPkts, sysAdminStatus=sysAdminStatus, modLM80volts=modLM80volts, snmpv3SecurityLevel=snmpv3SecurityLevel, txOctets=txOctets, wrswitch=wrswitch, slotnum=slotnum, modulePortsTable=modulePortsTable, txErrorPkts=txErrorPkts, traphost1=traphost1, rxPackets64=rxPackets64, dhcptftpServerIpAddress=dhcptftpServerIpAddress, cpuVoltageIn=cpuVoltageIn, ahErroredFrameWindow=ahErroredFrameWindow, rxSymbolErrors=rxSymbolErrors, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, customertag=customertag, rxTotalPkts=rxTotalPkts, nmmSecureMode=nmmSecureMode, portMacAddress=portMacAddress, enabledFunctions=enabledFunctions, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, rxDropPkts=rxDropPkts, chassistype=chassistype, modvlanTableClear=modvlanTableClear, extended3=extended3, modmanufdate=modmanufdate, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, subnetmask=subnetmask, portSFPpageA0=portSFPpageA0, portnum=portnum, ledstat=ledstat, slaveWrite=slaveWrite, txExcessiveCollision=txExcessiveCollision, rxPackets256to511=rxPackets256to511, rxOctets64=rxOctets64, rxJabbers=rxJabbers, moduleEntry=moduleEntry, portSfpDateCode=portSfpDateCode, ipAddr=ipAddr, portSfpRxPower=portSfpRxPower, modulename=modulename, chassisTable=chassisTable, chassisname=chassisname, index=index, portStatsClear=portStatsClear, manufdate=manufdate, trapSrcIpSelect=trapSrcIpSelect, rxFragments=rxFragments, nmmCfgState=nmmCfgState, enhancedchassisTable=enhancedchassisTable, txPausePkts=txPausePkts, ahRemoteLinkFlags=ahRemoteLinkFlags, modHwRev=modHwRev, rxUnicastPkts=rxUnicastPkts, softrev=softrev, modcommitVLANchanges=modcommitVLANchanges, tftpEnable=tftpEnable, moduleTable=moduleTable, ostProtocolStatusIndex=ostProtocolStatusIndex, cnodeControl=cnodeControl, modchasstype=modchasstype, rxOversizePkts=rxOversizePkts, sysDateTime=sysDateTime, traphost5=traphost5, modextfeaturebits=modextfeaturebits, ingressPolicingType=ingressPolicingType, enableSNMPv3Function=enableSNMPv3Function, portState=portState, rxAlignmentErrors=rxAlignmentErrors, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, txDroppedEvents=txDroppedEvents, ahLocalLinkFlags=ahLocalLinkFlags, portvlanidentifier=portvlanidentifier, gateway2=gateway2, ahCriticalEventMode=ahCriticalEventMode, omnitronConformance=omnitronConformance, ipaddrEVCassociation=ipaddrEVCassociation, enableSNMPFunction=enableSNMPFunction, ahFrameErrorEventTotal=ahFrameErrorEventTotal, cpuTemperature=cpuTemperature, portSfpVendorSerialNumber=portSfpVendorSerialNumber, ostProtocolStatusType=ostProtocolStatusType, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, managementModule=managementModule, port2Membership=port2Membership, keepAliveInterval=keepAliveInterval, txSingleCollision=txSingleCollision, nmmSecureConnState=nmmSecureConnState, txGoodPkts=txGoodPkts, portStatsTable=portStatsTable, portAHEntry=portAHEntry, snmpTrapType=snmpTrapType, cnodeCIR=cnodeCIR, vlanIdOst=vlanIdOst, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, omnitronCompliance=omnitronCompliance, chassisnum=chassisnum, txBroadcastPkts=txBroadcastPkts, portSpeed=portSpeed, modswbuildnum=modswbuildnum, ipaddr2EVCassociation=ipaddr2EVCassociation, modPcbRev=modPcbRev, capsMask=capsMask, txMultipleCollision=txMultipleCollision, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, sysloc=sysloc, ahCriticalEventTrapList=ahCriticalEventTrapList, dhcpPortNumber=dhcpPortNumber, validityflag=validityflag, dhcpGateway=dhcpGateway, resetmod=resetmod, txMulticastPkts=txMulticastPkts, ostProtocolStatusTable=ostProtocolStatusTable, ahLocalLpbkTimeout=ahLocalLpbkTimeout, moduleMgtCfgEntry=moduleMgtCfgEntry, dhcpTagVid=dhcpTagVid, extended6=extended6, modchassname=modchassname, traphost6=traphost6, rxPackets128to255=rxPackets128to255, moduleVLANTable=moduleVLANTable, txDeferedTransmit=txDeferedTransmit, extended1=extended1, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, rxPackets512to1023=rxPackets512to1023, modnumports=modnumports, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, port4Membership=port4Membership, traphost8=traphost8, coreStatusOnly=coreStatusOnly, omnitronMIB=omnitronMIB, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ahRemoteMode=ahRemoteMode, mmname=mmname, modsoftrev=modsoftrev, ahFramePeriodEventTotal=ahFramePeriodEventTotal, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, extended5=extended5, ahLocalMode=ahLocalMode, portAccessType=portAccessType, rxCRCAlignErrors=rxCRCAlignErrors, modulePortsEntry=modulePortsEntry, modLM80misc=modLM80misc, portFwdCpuList=portFwdCpuList, vlanservicetag=vlanservicetag, traphost3=traphost3, portStatsEntry=portStatsEntry, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, port3Membership=port3Membership, port6Membership=port6Membership, portL2CPmgntProcessing=portL2CPmgntProcessing, rxPackets1024to1518=rxPackets1024to1518, moduleVLANEntry=moduleVLANEntry, portIngressRateDropOrPause=portIngressRateDropOrPause, userTable=userTable, rxGoodPkts=rxGoodPkts, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, chassis=chassis, modreset=modreset, tftpServerIpAddress=tftpServerIpAddress, omnitronProducts=omnitronProducts, subnetmask2=subnetmask2, switchstat=switchstat, txUnicastPkts=txUnicastPkts, portSfpVcc=portSfpVcc, syscon=syscon, txCollisions=txCollisions, modserialnum=modserialnum, modslotnum=modslotnum, ahLocalMuxState=ahLocalMuxState, snmpv3PrivPassword=snmpv3PrivPassword, portSfpVendorName=portSfpVendorName, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, snmpv3AuthPassword=snmpv3AuthPassword, ahRemoteSupportVar=ahRemoteSupportVar, rxOctets=rxOctets, dhcpSubnetmask=dhcpSubnetmask, modLM80currents=modLM80currents, modExpLedStatus=modExpLedStatus, rxUndersizePkts=rxUndersizePkts, portSFPstatus=portSFPstatus, slaveTrapsForward=slaveTrapsForward, rxBroadcastPkts=rxBroadcastPkts, dhcpIpAddr=dhcpIpAddr, ahRemoteMuxState=ahRemoteMuxState, serialpass=serialpass, rxErrorPkts=rxErrorPkts, portEgressRate=portEgressRate, ostProtocoManagementPort=ostProtocoManagementPort, portLinkState=portLinkState, userIndex=userIndex, portIngressRateCBS=portIngressRateCBS)
mibBuilder.exportSymbols("OMNITRON-MIB", traphost2=traphost2, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahErroredFrameThreshold=ahErroredFrameThreshold, snmpv3UserType=snmpv3UserType, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, readCommunity=readCommunity, moduleCount=moduleCount, modFpgaRev=modFpgaRev, PYSNMP_MODULE_ID=omnitronMIB, telnetpass=telnetpass, ahRemoteLinkPort=ahRemoteLinkPort, userEntry=userEntry, tftpFileName=tftpFileName, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, nmmIpProtocolState=nmmIpProtocolState, selfSlot=selfSlot, modcommitNMMCfgChanges=modcommitNMMCfgChanges, chassisEntry=chassisEntry, prodtype=prodtype, ahLocalSupportVar=ahLocalSupportVar, snmpv3UserName=snmpv3UserName, muxGroupDefaults=muxGroupDefaults, ahRemoteParserState=ahRemoteParserState, omnitronSFPGroup=omnitronSFPGroup, modRestoreFactoryDefaults=modRestoreFactoryDefaults, portIngressRate=portIngressRate, txLateCollision=txLateCollision, ostEnvironmentalTemperature=ostEnvironmentalTemperature, modenable802dot1qProcessing=modenable802dot1qProcessing, servicetag=servicetag, port5Membership=port5Membership, modprodtype=modprodtype, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, modExpPartNumber=modExpPartNumber, rxPausePkts=rxPausePkts, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, txDropPkts=txDropPkts, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, cpuVoltageOut=cpuVoltageOut, defaultForwardingMap=defaultForwardingMap, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, modtagsubstitution=modtagsubstitution, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portSfpTxPower=portSfpTxPower, nmmOAMmgmtMode=nmmOAMmgmtMode, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, port1Membership=port1Membership, gateway=gateway, ahEnabled=ahEnabled, serialnum=serialnum, bootpEnable=bootpEnable, portSfpTemperature=portSfpTemperature, ahRemoteOUI=ahRemoteOUI, traphost4=traphost4, omnitronGroup=omnitronGroup, modpartnum=modpartnum)
