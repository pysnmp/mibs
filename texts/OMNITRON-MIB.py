...
OstPortNumber, OstVlanId, OstModeType, OstPortList, omnitron, icAgent = mibBuilder.importSymbols("OMNITRON-TC-MIB", "OstPortNumber", "OstVlanId", "OstModeType", "OstPortList", "omnitron", "icAgent")
...
mibBuilder.exportSymbols("OMNITRON-MIB", tftpEnable=tftpEnable, rxUndersizePkts=rxUndersizePkts, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, ipaddr2EVCassociation=ipaddr2EVCassociation, ahTransmissionRate=ahTransmissionRate, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, portIngressRateCBS=portIngressRateCBS, ahFrameErrorEventTotal=ahFrameErrorEventTotal, moduleVLANTable=moduleVLANTable, traphost4=traphost4, slaveTrapsForward=slaveTrapsForward, rxUnicastPkts=rxUnicastPkts, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, userEntry=userEntry, rxTotalPkts=rxTotalPkts, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, portegresspolicy=portegresspolicy, nmmSecureSlaveSlot=nmmSecureSlaveSlot, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ahLocalMode=ahLocalMode, mychassnum=mychassnum, txMulticastPkts=txMulticastPkts, nmmCfgState=nmmCfgState, moduleCount=moduleCount, cnodeControl=cnodeControl, modswbuildnum=modswbuildnum, portState=portState, traphost6=traphost6, ahCriticalEventMode=ahCriticalEventMode, traphost1=traphost1, txBroadcastPkts=txBroadcastPkts, portStatsClear=portStatsClear, omnitronGroups=omnitronGroups, txDropPkts=txDropPkts, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, extended6=extended6, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, rxFragments=rxFragments, port1Membership=port1Membership, customertag=customertag, ahErroredFrameWindow=ahErroredFrameWindow, modpartnum=modpartnum, keepAliveInterval=keepAliveInterval, traphost3=traphost3, snmpTrapType=snmpTrapType, modulePortsEntry=modulePortsEntry, rxAlignmentErrors=rxAlignmentErrors, ipaddrEVCassociation=ipaddrEVCassociation, traphost2=traphost2, enableSNMPWrites=enableSNMPWrites, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, ahFramePeriodEventTotal=ahFramePeriodEventTotal, rxFCSErrors=rxFCSErrors, vlanPri=vlanPri, ostProtocolStatusState=ostProtocolStatusState, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, rxMulticastPkts=rxMulticastPkts, wrswitch=wrswitch, portAccessType=portAccessType, txCollisions=txCollisions, portingresssecurity=portingresssecurity, port4Membership=port4Membership, rxPackets128to255=rxPackets128to255, portSFPpageA2=portSFPpageA2, modExpSoftwareRev=modExpSoftwareRev, telnetpass=telnetpass, ostEnvironmentalTemperature=ostEnvironmentalTemperature, extended3=extended3, ahRemoteSupportVar=ahRemoteSupportVar, ostProtocolStatusTable=ostProtocolStatusTable, gateway2=gateway2, syscon=syscon, portFwdCpuList=portFwdCpuList, portEgressRate=portEgressRate, chassistype=chassistype, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, ahClearStatistics=ahClearStatistics, dhcpGateway=dhcpGateway, portSpeed=portSpeed, chassisTable=chassisTable, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, portSfpVcc=portSfpVcc, slotnum=slotnum, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, modprodrev=modprodrev, moduleVLANEntry=moduleVLANEntry, dhcpPortNumber=dhcpPortNumber, moduleEntry=moduleEntry, index=index, omnitronConformance=omnitronConformance, ahRemoteMuxState=ahRemoteMuxState, txMultipleCollision=txMultipleCollision, ostProtocolStatusIndex=ostProtocolStatusIndex, omnitronProducts=omnitronProducts, txExcessiveCollision=txExcessiveCollision, slaveTraps=slaveTraps, nmmOAMmgmtMode=nmmOAMmgmtMode, switchstat=switchstat, serialnum=serialnum, modmanufdate=modmanufdate, cpuVoltageOut=cpuVoltageOut, chassisEntry=chassisEntry, port5Membership=port5Membership, rxBroadcastPkts=rxBroadcastPkts, sysAdminStatus=sysAdminStatus, portcanonicalformatIndicator=portcanonicalformatIndicator, rxPausePkts=rxPausePkts, portnum=portnum, rxOctets64=rxOctets64, cpuTemperature=cpuTemperature, modreset=modreset, portMacAddress=portMacAddress, portSfpTxPower=portSfpTxPower, muxGroupDefaults=muxGroupDefaults, ledstat=ledstat, nmmSecureConnState=nmmSecureConnState, snmpv3PrivPassword=snmpv3PrivPassword, sysDateTime=sysDateTime, txPausePkts=txPausePkts, nmmIpDisabled=nmmIpDisabled, modFpgaRev=modFpgaRev, rxGoodPkts=rxGoodPkts, modchassnum=modchassnum, vlanservicetag=vlanservicetag, rxErrorPkts=rxErrorPkts, enabledFunctions=enabledFunctions, defaultForwardingMap=defaultForwardingMap, portLinkState=portLinkState, ahRemoteLinkPort=ahRemoteLinkPort, ahLocalOUI=ahLocalOUI, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, portSFPTable=portSFPTable, ipAddr2=ipAddr2, ahRemoteMode=ahRemoteMode, modchassname=modchassname, omnitronCompliance=omnitronCompliance, portAHTable=portAHTable, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, dhcpTagVid=dhcpTagVid, portSfpBitRate=portSfpBitRate, tftpFileName=tftpFileName, chassisname=chassisname, moduleMgtCfgTable=moduleMgtCfgTable, validityflag=validityflag, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, portSfpVendorPartNumber=portSfpVendorPartNumber, ahLocalSupportVar=ahLocalSupportVar, modenable802dot1qProcessing=modenable802dot1qProcessing, ahCriticalEventTrapList=ahCriticalEventTrapList, dhcpSubnetmask=dhcpSubnetmask, txSingleCollision=txSingleCollision, subnetmask2=subnetmask2, enableSNMPv3Function=enableSNMPv3Function, portSfpBiasCurrent=portSfpBiasCurrent, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, snmpv3UserType=snmpv3UserType, rxOversizePkts=rxOversizePkts, servicetag=servicetag, writeCommunity=writeCommunity, ahRemoteParserState=ahRemoteParserState, userIndex=userIndex, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, omnitronSFPGroup=omnitronSFPGroup, portAHEntry=portAHEntry, gateway=gateway, txErrorPkts=txErrorPkts, modslotnum=modslotnum, portSfpDateCode=portSfpDateCode, prodtype=prodtype, txUnicastPkts=txUnicastPkts, ftppasswrd=ftppasswrd, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, prodrev=prodrev, txGoodPkts=txGoodPkts, portFwdCpu=portFwdCpu, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, coreStatusOnly=coreStatusOnly, rxOctets=rxOctets, txLateCollision=txLateCollision, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, partnum=partnum, modLM80currents=modLM80currents, modHwRev=modHwRev, rxPackets256to511=rxPackets256to511, portStatsTable=portStatsTable, modsoftrev=modsoftrev, portSFPstatus=portSFPstatus, ostProtocolStatusEntry=ostProtocolStatusEntry, port6Membership=port6Membership, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portIngressRate=portIngressRate, modextfeaturebits=modextfeaturebits, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxJabbers=rxJabbers, moduleTable=moduleTable, resetmod=resetmod, rxPackets64=rxPackets64, vlanIdOst=vlanIdOst, traphost7=traphost7, bootpEnable=bootpEnable, port2Membership=port2Membership, portSFPEntry=portSFPEntry, sysloc=sysloc, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, snmpv3SecurityLevel=snmpv3SecurityLevel, traphost5=traphost5, ahLocalParserState=ahLocalParserState, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, omnitronMIB=omnitronMIB, txOctets64=txOctets64, ahLocalLinkFlags=ahLocalLinkFlags, port3Membership=port3Membership, portStatsEntry=portStatsEntry, modchasstype=modchasstype, vlanidentifier=vlanidentifier, PYSNMP_MODULE_ID=omnitronMIB, extended4=extended4, rxSymbolErrors=rxSymbolErrors, nmmIpProtocolState=nmmIpProtocolState, cpuVoltageIn=cpuVoltageIn, modulename=modulename, slaveWrite=slaveWrite, rxPackets512to1023=rxPackets512to1023, ostProtocolStatusType=ostProtocolStatusType, ahLocalMuxState=ahLocalMuxState, rxDropPkts=rxDropPkts, selfSlot=selfSlot, txDeferedTransmit=txDeferedTransmit, rxPackets1024to1518=rxPackets1024to1518, portEgressQosPolicy=portEgressQosPolicy, ahLocalLpbkTimeout=ahLocalLpbkTimeout, ingressPolicingType=ingressPolicingType, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, nmmSecureMode=nmmSecureMode, portDuplex=portDuplex, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, extended2=extended2, macAddr=macAddr, portIngressRateDropOrPause=portIngressRateDropOrPause, ahLpbkMode=ahLpbkMode, snmpv3UserName=snmpv3UserName, dhcpIpAddr=dhcpIpAddr, rxPackets65to127=rxPackets65to127, manufdate=manufdate, modname=modname, portSfpVendorSerialNumber=portSfpVendorSerialNumber, snmpv3AuthPassword=snmpv3AuthPassword, tftpServerIpAddress=tftpServerIpAddress, modnumports=modnumports, omnitronCompliances=omnitronCompliances, trapSrcIpSelect=trapSrcIpSelect, modvlanTableClear=modvlanTableClear, portSfpTemperature=portSfpTemperature, dhcptftpServerIpAddress=dhcptftpServerIpAddress)
mibBuilder.exportSymbols("OMNITRON-MIB", mmname=mmname, ahRemoteOUI=ahRemoteOUI, userTable=userTable, softrev=softrev, modtagsubstitution=modtagsubstitution, modprodtype=modprodtype, serialpass=serialpass, portL2CPmgntProcessing=portL2CPmgntProcessing, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, enableSNMPFunction=enableSNMPFunction, modExpPartNumber=modExpPartNumber, chassis=chassis, ostProtocoManagementPort=ostProtocoManagementPort, portpriority=portpriority, ahErroredFrameThreshold=ahErroredFrameThreshold, txDroppedEvents=txDroppedEvents, modportvlan=modportvlan, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, modeType=modeType, rxCRCAlignErrors=rxCRCAlignErrors, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, ahRemoteLinkFlags=ahRemoteLinkFlags, capsMask=capsMask, modulePortsTable=modulePortsTable, ipAddr=ipAddr, txOctets=txOctets, omnitronGroup=omnitronGroup, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modcommitVLANchanges=modcommitVLANchanges, prodAgent=prodAgent, traphost8=traphost8, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ahEnabled=ahEnabled, modExpLedStatus=modExpLedStatus, extended1=extended1, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, extended5=extended5, moduleMgtCfgEntry=moduleMgtCfgEntry, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, portSfpRxPower=portSfpRxPower, chassisnum=chassisnum, enhancedchassisTable=enhancedchassisTable, managementModule=managementModule, subnetmask=subnetmask, portSfpVendorName=portSfpVendorName, modcommitNMMCfgChanges=modcommitNMMCfgChanges, readCommunity=readCommunity, cnodeCIR=cnodeCIR, portSFPpageA0=portSFPpageA0, modLM80volts=modLM80volts, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, modserialnum=modserialnum, modPcbRev=modPcbRev, portmlistcriteria=portmlistcriteria, modLM80misc=modLM80misc, portvlanidentifier=portvlanidentifier)
