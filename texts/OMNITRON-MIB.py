...
icAgent, OstVlanId, OstModeType, OstPortList, OstPortNumber, omnitron = mibBuilder.importSymbols("OMNITRON-TC-MIB", "icAgent", "OstVlanId", "OstModeType", "OstPortList", "OstPortNumber", "omnitron")
...
mibBuilder.exportSymbols("OMNITRON-MIB", dhcpSubnetmask=dhcpSubnetmask, omnitronGroups=omnitronGroups, ahTransmissionRate=ahTransmissionRate, ahRemoteLinkPort=ahRemoteLinkPort, serialnum=serialnum, customertag=customertag, coreStatusOnly=coreStatusOnly, prodrev=prodrev, moduleVLANEntry=moduleVLANEntry, rxFCSErrors=rxFCSErrors, txDeferedTransmit=txDeferedTransmit, rxOversizePkts=rxOversizePkts, ostEnvironmentalPs2VoltageIn=ostEnvironmentalPs2VoltageIn, prodtype=prodtype, portStatsClear=portStatsClear, modchassnum=modchassnum, port2Membership=port2Membership, mychassnum=mychassnum, rxJabbers=rxJabbers, txPausePkts=txPausePkts, ostProtocolStatusIndex=ostProtocolStatusIndex, txDropPkts=txDropPkts, ostProtocolStatusType=ostProtocolStatusType, modulePortsEntry=modulePortsEntry, modLM80currents=modLM80currents, ahSymbolErrorEventTotal=ahSymbolErrorEventTotal, ostEnvironmentalStatusEntry=ostEnvironmentalStatusEntry, servicetag=servicetag, ostProtocolStatusTable=ostProtocolStatusTable, ahErroredSymbolPeriodWindow=ahErroredSymbolPeriodWindow, rxMulticastPkts=rxMulticastPkts, txCollisions=txCollisions, dhcpGateway=dhcpGateway, modnumports=modnumports, modHwRev=modHwRev, ahFramePeriodRunningTotal=ahFramePeriodRunningTotal, sysloc=sysloc, portStatsEntry=portStatsEntry, ostEnvironmentalTemperature=ostEnvironmentalTemperature, resetmod=resetmod, extended1=extended1, readCommunity=readCommunity, portcanonicalformatIndicator=portcanonicalformatIndicator, ahClearStatistics=ahClearStatistics, moduleMgtCfgEntry=moduleMgtCfgEntry, txMultipleCollision=txMultipleCollision, ostEnvironmentalPs1CurrentOut=ostEnvironmentalPs1CurrentOut, capsMask=capsMask, txOctets64=txOctets64, rxBroadcastPkts=rxBroadcastPkts, ostProtocolStatusEntry=ostProtocolStatusEntry, snmpv3PrivPassword=snmpv3PrivPassword, modenable802dot1qProcessing=modenable802dot1qProcessing, enabledFunctions=enabledFunctions, nmmIpProtocolState=nmmIpProtocolState, snmpv3SecurityLevel=snmpv3SecurityLevel, chassisTable=chassisTable, PYSNMP_MODULE_ID=omnitronMIB, ahFrameSecondsSummaryEventTotal=ahFrameSecondsSummaryEventTotal, userIndex=userIndex, ahErroredFramePeriodWindow=ahErroredFramePeriodWindow, sysDateTime=sysDateTime, nmmSecureMode=nmmSecureMode, ahCriticalEventTrapList=ahCriticalEventTrapList, extended6=extended6, modvlanTableClear=modvlanTableClear, chassisname=chassisname, chassisnum=chassisnum, ostEnvironmentalPs1VoltageIn=ostEnvironmentalPs1VoltageIn, portAHTable=portAHTable, modmanufdate=modmanufdate, txBroadcastPkts=txBroadcastPkts, serialpass=serialpass, ahLpbkMode=ahLpbkMode, portLinkState=portLinkState, portAHEntry=portAHEntry, portingresssecurity=portingresssecurity, modpartnum=modpartnum, ipaddr2EVCassociation=ipaddr2EVCassociation, modserialnum=modserialnum, traphost7=traphost7, ipAddr=ipAddr, macAddr=macAddr, rxDropPkts=rxDropPkts, portSfpVendorSerialNumber=portSfpVendorSerialNumber, tftpFileName=tftpFileName, portSfpVendorPartNumber=portSfpVendorPartNumber, moduleEntry=moduleEntry, portSfpDateCode=portSfpDateCode, modcommitVLANchanges=modcommitVLANchanges, rxFragments=rxFragments, portSfpVcc=portSfpVcc, portSfpRxPower=portSfpRxPower, traphost6=traphost6, omnitronCompliances=omnitronCompliances, slotnum=slotnum, chassisEntry=chassisEntry, traphost8=traphost8, subnetmask=subnetmask, cpuTemperature=cpuTemperature, portSfpBiasCurrent=portSfpBiasCurrent, portIngressRateCBS=portIngressRateCBS, portSFPpageA2=portSFPpageA2, txErrorPkts=txErrorPkts, traphost1=traphost1, trapSrcIpSelect=trapSrcIpSelect, writeCommunity=writeCommunity, traphost3=traphost3, ostEnvironmentalFan3Status=ostEnvironmentalFan3Status, ostEnvironmentalStatusTable=ostEnvironmentalStatusTable, modExpSoftwareRev=modExpSoftwareRev, enableSNMPv3Function=enableSNMPv3Function, chassistype=chassistype, txDroppedEvents=txDroppedEvents, ahErroredFrameWindow=ahErroredFrameWindow, ahFramePeriodEventTotal=ahFramePeriodEventTotal, portSfpBitRate=portSfpBitRate, omnitronSFPGroup=omnitronSFPGroup, portIngressRateDropOrPause=portIngressRateDropOrPause, portAccessType=portAccessType, snmpv3UserType=snmpv3UserType, modRestoreFactoryDefaults=modRestoreFactoryDefaults, rxPackets64=rxPackets64, ahLocalMuxState=ahLocalMuxState, dhcpTagVid=dhcpTagVid, rxAlignmentErrors=rxAlignmentErrors, portState=portState, portSfpTemperature=portSfpTemperature, ostEnvironmentalPs2CurrentOut=ostEnvironmentalPs2CurrentOut, rxUndersizePkts=rxUndersizePkts, modslotnum=modslotnum, portvlanidentifier=portvlanidentifier, extended3=extended3, modportvlan=modportvlan, portEgressQosPolicy=portEgressQosPolicy, txUnicastPkts=txUnicastPkts, traphost2=traphost2, manufdate=manufdate, ahRemoteSupportVar=ahRemoteSupportVar, ahSymbolErrorRunningTotal=ahSymbolErrorRunningTotal, ahLocalSupportVar=ahLocalSupportVar, gateway=gateway, ahCriticalEventMode=ahCriticalEventMode, softrev=softrev, rxPackets65to127=rxPackets65to127, enhancedchassisTable=enhancedchassisTable, port3Membership=port3Membership, portSFPpageA0=portSFPpageA0, snmpv3AuthPassword=snmpv3AuthPassword, portSpeed=portSpeed, nmmCfgSerialBaudrate=nmmCfgSerialBaudrate, modprodtype=modprodtype, txSingleCollision=txSingleCollision, nmmOAMmgmtMode=nmmOAMmgmtMode, switchstat=switchstat, gateway2=gateway2, ahLocalParserState=ahLocalParserState, ahLocalLpbkTimeout=ahLocalLpbkTimeout, bootpEnable=bootpEnable, txGoodPkts=txGoodPkts, portSFPTable=portSFPTable, traphost4=traphost4, tftpEnable=tftpEnable, slaveTrapsForward=slaveTrapsForward, moduleTable=moduleTable, ftppasswrd=ftppasswrd, modeType=modeType, dhcpPortNumber=dhcpPortNumber, cpuVoltageOut=cpuVoltageOut, ahRemoteMode=ahRemoteMode, nmmIpDisabled=nmmIpDisabled, modreset=modreset, slaveWrite=slaveWrite, tftpServerIpAddress=tftpServerIpAddress, omnitronCompliance=omnitronCompliance, nmmCfgState=nmmCfgState, ostEnvironmentalFan3Speed=ostEnvironmentalFan3Speed, modchassname=modchassname, ipAddr2=ipAddr2, vlanservicetag=vlanservicetag, validityflag=validityflag, ahRemoteLinkFlags=ahRemoteLinkFlags, modulePortsTable=modulePortsTable, txExcessiveCollision=txExcessiveCollision, rxPackets512to1023=rxPackets512to1023, vlanPri=vlanPri, extended4=extended4, portL2CPmgntProcessing=portL2CPmgntProcessing, muxGroupDefaults=muxGroupDefaults, modcommitNMMCfgChanges=modcommitNMMCfgChanges, rxUnicastPkts=rxUnicastPkts, ahEnabled=ahEnabled, enableSNMPWrites=enableSNMPWrites, txLateCollision=txLateCollision, rxGoodPkts=rxGoodPkts, ostEnvironmentalFan2Status=ostEnvironmentalFan2Status, modFpgaRev=modFpgaRev, sysAdminStatus=sysAdminStatus, vlanIdOst=vlanIdOst, portMacAddress=portMacAddress, portFwdCpu=portFwdCpu, partnum=partnum, dhcpIpAddr=dhcpIpAddr, ostEnvironmentalPs2Status=ostEnvironmentalPs2Status, index=index, modsoftrev=modsoftrev, port1Membership=port1Membership, modLM80misc=modLM80misc, portSfpTxPower=portSfpTxPower, cpuVoltageIn=cpuVoltageIn, omnitronConformance=omnitronConformance, moduleVLANTable=moduleVLANTable, keepAliveInterval=keepAliveInterval, nmmSecureSlaveSlot=nmmSecureSlaveSlot, portegresspolicy=portegresspolicy, portIngressRate=portIngressRate, txOctets=txOctets, userTable=userTable, portUnidirectionalAhOamEnable=portUnidirectionalAhOamEnable, port6Membership=port6Membership, modLM80volts=modLM80volts, ostProtocoManagementPort=ostProtocoManagementPort, chassis=chassis, port4Membership=port4Membership, ledstat=ledstat, ostProtocolStatusIpAddress=ostProtocolStatusIpAddress, subnetmask2=subnetmask2, rxTotalPkts=rxTotalPkts, ahRemoteLpbkTimeout=ahRemoteLpbkTimeout, ahErroredFramePeriodThreshold=ahErroredFramePeriodThreshold, ahFrameErrorRunningTotal=ahFrameErrorRunningTotal, syscon=syscon, rxOctets64=rxOctets64, ostEnvironmentalFan1Status=ostEnvironmentalFan1Status, ahRemoteOUI=ahRemoteOUI, ostEnvironmentalPs1Status=ostEnvironmentalPs1Status, modextfeaturebits=modextfeaturebits, portpriority=portpriority, ahErroredFrameSecondsWindow=ahErroredFrameSecondsWindow, portEgressRate=portEgressRate, rxPausePkts=rxPausePkts, ingressPolicingType=ingressPolicingType, portStatsTable=portStatsTable, nmmSecureConnState=nmmSecureConnState, portSFPstatus=portSFPstatus, selfSlot=selfSlot, portnum=portnum, modchasstype=modchasstype, portSfpVendorName=portSfpVendorName, modprodrev=modprodrev, enableSNMPFunction=enableSNMPFunction, modtagsubstitution=modtagsubstitution, portDuplex=portDuplex, ahLocalLinkFlags=ahLocalLinkFlags)
mibBuilder.exportSymbols("OMNITRON-MIB", extended5=extended5, moduleCount=moduleCount, rxPackets256to511=rxPackets256to511, dhcptftpServerIpAddress=dhcptftpServerIpAddress, ostProtocolStatusSessionOpenLockTime=ostProtocolStatusSessionOpenLockTime, ostEnvironmentalPs1VoltageOut=ostEnvironmentalPs1VoltageOut, ostEnvironmentalPs2VoltageOut=ostEnvironmentalPs2VoltageOut, modPcbRev=modPcbRev, omnitronGroup=omnitronGroup, modExpPartNumber=modExpPartNumber, rxErrorPkts=rxErrorPkts, ahRemoteParserState=ahRemoteParserState, rxSymbolErrors=rxSymbolErrors, ahErroredFrameSecondsThreshold=ahErroredFrameSecondsThreshold, ahRemoteMuxState=ahRemoteMuxState, slaveTraps=slaveTraps, ostEnvironmentalFan2Speed=ostEnvironmentalFan2Speed, portFwdCpuList=portFwdCpuList, userEntry=userEntry, prodAgent=prodAgent, snmpv3UserName=snmpv3UserName, port5Membership=port5Membership, extended2=extended2, portmlistcriteria=portmlistcriteria, vlanidentifier=vlanidentifier, ostProtocolStatusState=ostProtocolStatusState, moduleMgtCfgTable=moduleMgtCfgTable, rxPackets128to255=rxPackets128to255, omnitronProducts=omnitronProducts, mmname=mmname, snmpTrapType=snmpTrapType, cnodeControl=cnodeControl, rxPackets1024to1518=rxPackets1024to1518, traphost5=traphost5, ahFrameSecondsSummaryRunningTotal=ahFrameSecondsSummaryRunningTotal, omnitronMIB=omnitronMIB, cnodeCIR=cnodeCIR, ahErroredSymbolPeriodThreshold=ahErroredSymbolPeriodThreshold, rxCRCAlignErrors=rxCRCAlignErrors, ahLocalOUI=ahLocalOUI, modswbuildnum=modswbuildnum, ahLocalMode=ahLocalMode, ahErroredFrameThreshold=ahErroredFrameThreshold, modulename=modulename, txMulticastPkts=txMulticastPkts, ahFrameErrorEventTotal=ahFrameErrorEventTotal, portSFPEntry=portSFPEntry, modname=modname, ostEnvironmentalFan1Speed=ostEnvironmentalFan1Speed, managementModule=managementModule, modExpLedStatus=modExpLedStatus, wrswitch=wrswitch, telnetpass=telnetpass, defaultForwardingMap=defaultForwardingMap, ipaddrEVCassociation=ipaddrEVCassociation, rxOctets=rxOctets)
