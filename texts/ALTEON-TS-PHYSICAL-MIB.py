...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, port_info=port_info, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoIndx=portInfoIndx, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portStatsIndx=portStatsIndx, vlanMaxEnt=vlanMaxEnt, pmCurCfgState=pmCurCfgState, portCpuStats=portCpuStats, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgTable=agPortCurCfgTable, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgPorts=vlanNewCfgPorts, vlanCurCfgPorts=vlanCurCfgPorts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, vlans=vlans, portStatsTableEntry=portStatsTableEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgPortIndex=stgCurCfgPortIndex, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgPortTable=stgNewCfgPortTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgCurCfgState=stgCurCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgNewCfgPortState=stgNewCfgPortState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgTable=stgNewCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgPortState=stgCurCfgPortState, trunkgroup=trunkgroup, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgIndex=stgCurCfgIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanNewCfgState=vlanNewCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portmirroring=portmirroring, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, stgNewCfgState=stgNewCfgState, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoLink=portInfoLink, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portInfoTable=portInfoTable, mirrOperState=mirrOperState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, mirrOperMirroredPort=mirrOperMirroredPort, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgAddVlan=stgNewCfgAddVlan, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgState=agPortCurCfgState, agPortNewCfgStp=agPortNewCfgStp, mirrOperTimeout=mirrOperTimeout, mirrPortMirr=mirrPortMirr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortConfig=agPortConfig, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirrOperType=mirrOperType, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, port_stats=port_stats, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgDelete=vlanNewCfgDelete, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortTableMaxEnt=agPortTableMaxEnt, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOper=mirrOper, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoSpeed=portInfoSpeed, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoTableEntry=portInfoTableEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgPortName=agPortNewCfgPortName, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgState=pmNewCfgState, portStatsTable=portStatsTable, mirroring=mirroring, mirrVlanMirr=mirrVlanMirr, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortNewCfgState=agPortNewCfgState, stgNewCfgIndex=stgNewCfgIndex, portInfoMode=portInfoMode, vlanCurCfgJumbo=vlanCurCfgJumbo)
