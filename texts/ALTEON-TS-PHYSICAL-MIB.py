...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portInfoSpeed=portInfoSpeed, portStatsTable=portStatsTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgTimeout=pmCurCfgTimeout, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgTableEntry=stgCurCfgTableEntry, port_stats=port_stats, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgBackLink=agPortCurCfgBackLink, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgAddVlan=stgNewCfgAddVlan, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, vlanNewCfgStg=vlanNewCfgStg, portInfoLink=portInfoLink, stgCurCfgPortState=stgCurCfgPortState, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoMode=portInfoMode, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portmirroring=portmirroring, portInfoPhyIfType=portInfoPhyIfType, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgStp=agPortCurCfgStp, stgNewCfgPortState=stgNewCfgPortState, portInfoTableEntry=portInfoTableEntry, agPortCurCfgState=agPortCurCfgState, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortCurCfgIndx=agPortCurCfgIndx, mirrOperState=mirrOperState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoIndx=portInfoIndx, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOper=mirrOper, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgState=stgNewCfgState, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgState=pmNewCfgState, mirrOperType=mirrOperType, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgTable=stgNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortNewCfgTable=agPortNewCfgTable, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoTable=portInfoTable, agPortNewCfgState=agPortNewCfgState, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortTable=stgCurCfgPortTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgCurCfgIndex=stgCurCfgIndex, mirrOperTimeout=mirrOperTimeout, vlanCurCfgStg=vlanCurCfgStg, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgPVID=agPortCurCfgPVID, portCpuStats=portCpuStats, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanCurCfgState=vlanCurCfgState, portStatsIndx=portStatsIndx, mirrOperMirroredPort=mirrOperMirroredPort, port_info=port_info, mirrVlanMirr=mirrVlanMirr, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanNewCfgTable=vlanNewCfgTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortNewCfgVlanTag=agPortNewCfgVlanTag, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portStatsTableEntry=portStatsTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortConfig=agPortConfig, pmNewCfgPortMirrState=pmNewCfgPortMirrState, vlanMaxEnt=vlanMaxEnt, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlans=vlans, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgCurCfgState=stgCurCfgState, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirroring=mirroring, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgState=pmCurCfgState, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkgroup=trunkgroup, agPortCurCfgPrefLink=agPortCurCfgPrefLink, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex)
