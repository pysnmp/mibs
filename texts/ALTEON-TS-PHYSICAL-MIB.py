...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:18:40 2022
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgVlanName=vlanNewCfgVlanName, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsTableEntry=portStatsTableEntry, portInfoIndx=portInfoIndx, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirrOperType=mirrOperType, portCpuStatsUtilTable=portCpuStatsUtilTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoTableEntry=portInfoTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgState=agPortNewCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrPortMirr=mirrPortMirr, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgPortTable=stgNewCfgPortTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, port_stats=port_stats, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrOperTimeout=mirrOperTimeout, portStatsPhyIfInOctets=portStatsPhyIfInOctets, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsIndx=portStatsIndx, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgCurCfgTable=stgCurCfgTable, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgRmon=agPortCurCfgRmon, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgTableEntry=vlanCurCfgTableEntry, port_info=port_info, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mirrOperState=mirrOperState, portStatsTable=portStatsTable, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanNewCfgState=vlanNewCfgState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoSpeed=portInfoSpeed, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmCurCfgState=pmCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, portInfoTable=portInfoTable, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgTable=agPortNewCfgTable, trunkgroup=trunkgroup, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgTable=vlanNewCfgTable, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portInfoLink=portInfoLink, agPortNewCfgPVID=agPortNewCfgPVID, portmirroring=portmirroring, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, vlanMaxEnt=vlanMaxEnt, stgNewCfgState=stgNewCfgState, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgState=agPortCurCfgState, agPortConfig=agPortConfig, agPortNewCfgStp=agPortNewCfgStp, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortTableMaxEnt=agPortTableMaxEnt, mirrOper=mirrOper, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoMode=portInfoMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlans=vlans, stgCurCfgState=stgCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgState=vlanCurCfgState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portCpuStatsUtilIndx=portCpuStatsUtilIndx, mirroring=mirroring, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgTableEntry=agPortCurCfgTableEntry, mirrOperMirroredPort=mirrOperMirroredPort, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portCpuStats=portCpuStats, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgState=pmNewCfgState, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgTable=stgNewCfgTable)
