...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", mirroring=mirroring, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgTable=stgNewCfgTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portmirroring=portmirroring, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgState=stgCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoIndx=portInfoIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanMaxEnt=vlanMaxEnt, mirrOperMirroredPort=mirrOperMirroredPort, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoMode=portInfoMode, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgState=agPortCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoFlowCtrl=portInfoFlowCtrl, mirrVlanMirr=mirrVlanMirr, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, portInfoPhyIfType=portInfoPhyIfType, mirrOper=mirrOper, vlanNewCfgDelete=vlanNewCfgDelete, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, mirrOperTimeout=mirrOperTimeout, portStatsTableEntry=portStatsTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoTable=portInfoTable, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgCurCfgIndex=stgCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, port_stats=port_stats, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgState=pmNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, mirrPortMirr=mirrPortMirr, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgIndx=agPortCurCfgIndx, portStatsTable=portStatsTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgPortState=stgCurCfgPortState, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, port_info=port_info, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, portCpuStats=portCpuStats, agPortNewCfgBackLink=agPortNewCfgBackLink, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortConfig=agPortConfig, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanCurCfgJumbo=vlanCurCfgJumbo, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, stgNewCfgIndex=stgNewCfgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirrOperState=mirrOperState, vlans=vlans, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoSpeed=portInfoSpeed, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgCurCfgTable=stgCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPVID=agPortNewCfgPVID, stgNewCfgState=stgNewCfgState, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortNewCfgState=agPortNewCfgState, portInfoLink=portInfoLink, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortCurCfgPVID=agPortCurCfgPVID, vlanNewCfgState=vlanNewCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, trunkgroup=trunkgroup, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsIndx=portStatsIndx, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgStp=agPortCurCfgStp, portInfoTableEntry=portInfoTableEntry, vlanCurCfgState=vlanCurCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgState=pmCurCfgState, mirrOperType=mirrOperType, trunkGroupNewCfgTable=trunkGroupNewCfgTable)
