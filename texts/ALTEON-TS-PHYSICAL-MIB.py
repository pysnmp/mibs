...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoTableEntry=portInfoTableEntry, trunkGroupTableMaxSize=trunkGroupTableMaxSize, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, portStatsTable=portStatsTable, mirrOperType=mirrOperType, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, mirrOperTimeout=mirrOperTimeout, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgStp=agPortCurCfgStp, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgVlanId=vlanNewCfgVlanId, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlans=vlans, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgTable=stgNewCfgTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, stgNewCfgPortState=stgNewCfgPortState, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortCurCfgState=agPortCurCfgState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgState=pmNewCfgState, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, port_info=port_info, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgCurCfgState=stgCurCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgIndx=agPortCurCfgIndx, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgPortName=agPortNewCfgPortName, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgCurCfgTable=stgCurCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoSpeed=portInfoSpeed, vlanNewCfgState=vlanNewCfgState, agPortNewCfgStp=agPortNewCfgStp, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanCurCfgVlanName=vlanCurCfgVlanName, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgIndx=agPortNewCfgIndx, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoPhyIfType=portInfoPhyIfType, portInfoTable=portInfoTable, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanMaxEnt=vlanMaxEnt, pmCurCfgPortMirrState=pmCurCfgPortMirrState, mirrOper=mirrOper, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgBwmContract=agPortNewCfgBwmContract, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portmirroring=portmirroring, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoLink=portInfoLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, mirrOperMonitoringPort=mirrOperMonitoringPort, port_stats=port_stats, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperState=mirrOperState, agPortNewCfgPVID=agPortNewCfgPVID, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortNewCfgRmon=agPortNewCfgRmon, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkgroup=trunkgroup, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgState=pmCurCfgState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsTableEntry=portStatsTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgJumbo=vlanCurCfgJumbo, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuStats=portCpuStats, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgStg=vlanNewCfgStg, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgTable=agPortCurCfgTable, portInfoIndx=portInfoIndx, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsIndx=portStatsIndx, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgTimeout=pmNewCfgTimeout, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoFlowCtrl=portInfoFlowCtrl, mirroring=mirroring, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanNewCfgRemovePort=vlanNewCfgRemovePort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortConfig=agPortConfig, pmCurCfgTimeout=pmCurCfgTimeout, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, agPortNewCfgState=agPortNewCfgState, portInfoMode=portInfoMode, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgCurCfgTableEntry=stgCurCfgTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry)
