...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgTableEntry=vlanCurCfgTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgPorts=vlanNewCfgPorts, stgNewCfgAddVlan=stgNewCfgAddVlan, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgState=pmCurCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgTable=agPortCurCfgTable, vlans=vlans, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgState=stgCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsIndx=portStatsIndx, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgJumbo=vlanCurCfgJumbo, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoMode=portInfoMode, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, mirrOperState=mirrOperState, mirroring=mirroring, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmNewCfgTimeout=pmNewCfgTimeout, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrOperTimeout=mirrOperTimeout, agPortTableMaxEnt=agPortTableMaxEnt, portStatsTable=portStatsTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgPortName=agPortNewCfgPortName, agPortNewCfgRmon=agPortNewCfgRmon, mirrOperMirroredPort=mirrOperMirroredPort, portInfoTableEntry=portInfoTableEntry, mirrOper=mirrOper, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsTableEntry=portStatsTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, port_stats=port_stats, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portmirroring=portmirroring, trunkGroupCurCfgState=trunkGroupCurCfgState, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgState=vlanNewCfgState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, spannTreeGrpCfg=spannTreeGrpCfg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portInfoLink=portInfoLink, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgStg=vlanCurCfgStg, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortCurCfgState=agPortCurCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgAddPort=vlanNewCfgAddPort, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInErrors=portStatsPhyIfInErrors, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, port_info=port_info, agPortCurCfgIndx=agPortCurCfgIndx, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portInfoTable=portInfoTable, pmNewCfgState=pmNewCfgState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, trunkgroup=trunkgroup, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrOperType=mirrOperType, vlanCurCfgState=vlanCurCfgState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, mirrVlanMirr=mirrVlanMirr, pmCurCfgTimeout=pmCurCfgTimeout, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portInfoSpeed=portInfoSpeed, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoIndx=portInfoIndx, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoPhyIfType=portInfoPhyIfType, agPortConfig=agPortConfig, stgNewCfgState=stgNewCfgState, agPortNewCfgState=agPortNewCfgState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portCpuStats=portCpuStats, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, mirrPortMirr=mirrPortMirr, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoPhyIfMtu=portInfoPhyIfMtu, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry)
