...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmCurCfgPortMirrState=pmCurCfgPortMirrState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgStgIndex=stgNewCfgStgIndex, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgStg=vlanNewCfgStg, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOperType=mirrOperType, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgJumbo=vlanCurCfgJumbo, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portInfoPhyIfType=portInfoPhyIfType, mirrPortMirr=mirrPortMirr, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portCpuStats=portCpuStats, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgState=pmCurCfgState, stgNewCfgTable=stgNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, port_info=port_info, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgPVID=agPortNewCfgPVID, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgBackLink=agPortNewCfgBackLink, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlans=vlans, vlanCurCfgPorts=vlanCurCfgPorts, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgAddPort=vlanNewCfgAddPort, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrVlanMirr=mirrVlanMirr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlanNewCfgTable=vlanNewCfgTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, trunkgroup=trunkgroup, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgPortName=agPortNewCfgPortName, agPortTableMaxEnt=agPortTableMaxEnt, portInfoSpeed=portInfoSpeed, stgNewCfgPortTable=stgNewCfgPortTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrOperMirroredPort=mirrOperMirroredPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, port_stats=port_stats, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgState=vlanNewCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgState=stgNewCfgState, stgNewCfgIndex=stgNewCfgIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgPortState=stgNewCfgPortState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, stgCurCfgPortState=stgCurCfgPortState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgPorts=vlanNewCfgPorts, mirrOper=mirrOper, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsTable=portStatsTable, agPortNewCfgState=agPortNewCfgState, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, spannTreeGrpCfg=spannTreeGrpCfg, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgNewCfgAddVlan=stgNewCfgAddVlan, agPortCurCfgState=agPortCurCfgState, stgCurCfgState=stgCurCfgState, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoTableEntry=portInfoTableEntry, portInfoTable=portInfoTable, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgState=vlanCurCfgState, trunkGroupCurCfgState=trunkGroupCurCfgState, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrOperState=mirrOperState, vlanNewCfgDelete=vlanNewCfgDelete, portInfoFlowCtrl=portInfoFlowCtrl, vlanMaxEnt=vlanMaxEnt, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgStg=vlanCurCfgStg, mirroring=mirroring, portStatsIndx=portStatsIndx, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, stgNewCfgPortIndex=stgNewCfgPortIndex, pmNewCfgState=pmNewCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgVlanId=vlanNewCfgVlanId, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgIndx=agPortCurCfgIndx, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanCurCfgVlanName=vlanCurCfgVlanName, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsTableEntry=portStatsTableEntry, portmirroring=portmirroring, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortConfig=agPortConfig, agPortNewCfgRmon=agPortNewCfgRmon, portInfoMode=portInfoMode, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoIndx=portInfoIndx, mirrOperTimeout=mirrOperTimeout, portInfoLink=portInfoLink)
