...
# Produced by pysmi-1.1.8 at Sat Jan 15 20:08:34 2022
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoTableEntry=portInfoTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portInfoTable=portInfoTable, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgTimeout=pmNewCfgTimeout, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, trunkgroup=trunkgroup, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlans=vlans, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgIndex=stgCurCfgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoFlowCtrl=portInfoFlowCtrl, mirrOper=mirrOper, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgState=vlanNewCfgState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgVlanName=vlanNewCfgVlanName, portInfoIndx=portInfoIndx, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, mirrVlanMirr=mirrVlanMirr, agPortCurCfgPVID=agPortCurCfgPVID, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgBwmContract=agPortCurCfgBwmContract, stgNewCfgPortState=stgNewCfgPortState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, mirrOperType=mirrOperType, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portInfoLink=portInfoLink, stgCurCfgPortState=stgCurCfgPortState, port_info=port_info, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortCurCfgPortName=agPortCurCfgPortName, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgPortName=agPortNewCfgPortName, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgAddPort=vlanNewCfgAddPort, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgState=vlanCurCfgState, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgDelete=vlanNewCfgDelete, pmNewCfgState=pmNewCfgState, portInfoMode=portInfoMode, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgStgIndex=stgCurCfgStgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, stgCurCfgPortTable=stgCurCfgPortTable, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, port_stats=port_stats, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, mirrOperMirroredPort=mirrOperMirroredPort, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgPortIndex=stgNewCfgPortIndex, portInfoPhyIfMtu=portInfoPhyIfMtu, portCpuStats=portCpuStats, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgState=pmCurCfgState, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsTable=portStatsTable, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgTable=vlanCurCfgTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portmirroring=portmirroring, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirroring=mirroring, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portStatsIndx=portStatsIndx, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanCurCfgStg=vlanCurCfgStg, vlanMaxEnt=vlanMaxEnt, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgCurCfgState=stgCurCfgState, stgNewCfgTable=stgNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, stgNewCfgState=stgNewCfgState, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgNewCfgPortTable=stgNewCfgPortTable, portInfoPhyIfType=portInfoPhyIfType, mirrOperState=mirrOperState, agPortConfig=agPortConfig, portStatsPhyIfInOctets=portStatsPhyIfInOctets, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgIndex=stgNewCfgIndex, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, mirrOperTimeout=mirrOperTimeout, vlanCurCfgBwmContract=vlanCurCfgBwmContract, mirrPortMirr=mirrPortMirr, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgTimeout=pmCurCfgTimeout, agPortCurCfgState=agPortCurCfgState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanNewCfgTableEntry=vlanNewCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex)
