...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, agPortNewCfgPortName=agPortNewCfgPortName, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsTableEntry=portStatsTableEntry, agPortCurCfgState=agPortCurCfgState, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkgroup=trunkgroup, vlanNewCfgTableEntry=vlanNewCfgTableEntry, port_info=port_info, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgState=stgCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, mirrOperTimeout=mirrOperTimeout, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portStatsIndx=portStatsIndx, portmirroring=portmirroring, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgRmon=agPortNewCfgRmon, vlans=vlans, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, vlanCurCfgTable=vlanCurCfgTable, mirroring=mirroring, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgTable=vlanNewCfgTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortNewCfgState=agPortNewCfgState, stgNewCfgTable=stgNewCfgTable, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsTable=portStatsTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, vlanCurCfgState=vlanCurCfgState, vlanCurCfgVlanName=vlanCurCfgVlanName, port_stats=port_stats, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanMaxEnt=vlanMaxEnt, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgIndx=agPortNewCfgIndx, mirrOperState=mirrOperState, vlanNewCfgPorts=vlanNewCfgPorts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, pmCurCfgTimeout=pmCurCfgTimeout, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanNewCfgStg=vlanNewCfgStg, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgTable=agPortCurCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, mirrOper=mirrOper, stgCurCfgPortTable=stgCurCfgPortTable, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortNewCfgBackLink=agPortNewCfgBackLink, portInfoLink=portInfoLink, agPortNewCfgTable=agPortNewCfgTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgIndex=stgCurCfgIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortState=stgNewCfgPortState, portInfoPhyIfType=portInfoPhyIfType, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoTable=portInfoTable, portInfoTableEntry=portInfoTableEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, stgNewCfgState=stgNewCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portInfoFlowCtrl=portInfoFlowCtrl, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgTableEntry=stgNewCfgTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgPVID=agPortCurCfgPVID, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portInfoSpeed=portInfoSpeed, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgVlanId=vlanNewCfgVlanId, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, stgCurCfgTable=stgCurCfgTable, pmCurCfgState=pmCurCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mirrOperMirroredPort=mirrOperMirroredPort, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, portInfoMode=portInfoMode, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanCurCfgStg=vlanCurCfgStg, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgStp=agPortCurCfgStp, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrVlanMirr=mirrVlanMirr, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgPVID=agPortNewCfgPVID, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, stgNewCfgIndex=stgNewCfgIndex, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgState=pmNewCfgState, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgVlanName=vlanNewCfgVlanName, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortCurCfgBackLink=agPortCurCfgBackLink, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, agPortCurCfgPortName=agPortCurCfgPortName, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portInfoIndx=portInfoIndx, mirrOperType=mirrOperType, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortConfig=agPortConfig, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portCpuStats=portCpuStats, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgTableEntry=agPortNewCfgTableEntry, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgAddPort=vlanNewCfgAddPort, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs)
