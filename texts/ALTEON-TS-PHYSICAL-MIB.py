...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, vlanCurCfgState=vlanCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoPhyIfType=portInfoPhyIfType, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortIndex=stgNewCfgPortIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgNewCfgState=stgNewCfgState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, vlanCurCfgTable=vlanCurCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrPortMirr=mirrPortMirr, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgState=agPortCurCfgState, agPortNewCfgRmon=agPortNewCfgRmon, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgState=agPortNewCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgBwmContract=agPortNewCfgBwmContract, mirrVlanMirr=mirrVlanMirr, mirroring=mirroring, portInfoTableEntry=portInfoTableEntry, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, mirrOperTimeout=mirrOperTimeout, portCpuStats=portCpuStats, portInfoIndx=portInfoIndx, vlanCurCfgStg=vlanCurCfgStg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoSpeed=portInfoSpeed, agPortCurCfgPortName=agPortCurCfgPortName, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, portStatsTableEntry=portStatsTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, mirrOperMonitoringPort=mirrOperMonitoringPort, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portCpuStatsUtilIndx=portCpuStatsUtilIndx, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, portStatsTable=portStatsTable, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgTable=stgNewCfgTable, agPortCurCfgRmon=agPortCurCfgRmon, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgJumbo=vlanNewCfgJumbo, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgVlanId=vlanNewCfgVlanId, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, mirrOper=mirrOper, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgCurCfgTable=stgCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, trunkgroup=trunkgroup, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgState=pmCurCfgState, pmNewCfgTimeout=pmNewCfgTimeout, vlans=vlans, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortTableMaxEnt=agPortTableMaxEnt, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgState=pmNewCfgState, port_info=port_info, stgCurCfgState=stgCurCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgPrefLink=agPortCurCfgPrefLink, mirrOperType=mirrOperType, port_stats=port_stats, portInfoMode=portInfoMode, agPortNewCfgPortName=agPortNewCfgPortName, agPortCurCfgStp=agPortCurCfgStp, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortConfig=agPortConfig, mirrOperState=mirrOperState, portInfoLink=portInfoLink, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsIndx=portStatsIndx, portCpuStatsUtilTable=portCpuStatsUtilTable, spannTreeGrpCfg=spannTreeGrpCfg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, portInfoTable=portInfoTable, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfLastChange=portInfoPhyIfLastChange, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgStp=agPortNewCfgStp, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgTable=agPortCurCfgTable, vlanNewCfgState=vlanNewCfgState, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portmirroring=portmirroring, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgTable=vlanNewCfgTable, agPortCurCfgPVID=agPortCurCfgPVID, stgCurCfgPortTable=stgCurCfgPortTable, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgStgIndex=stgNewCfgStgIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry)
