...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portInfoFlowCtrl=portInfoFlowCtrl, agPortConfig=agPortConfig, agPortCurCfgPVID=agPortCurCfgPVID, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, mirrOper=mirrOper, vlanCurCfgStg=vlanCurCfgStg, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsTableEntry=portStatsTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupTableMaxSize=trunkGroupTableMaxSize, vlanCurCfgBwmContract=vlanCurCfgBwmContract, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgIndx=agPortCurCfgIndx, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgPortTable=stgCurCfgPortTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, portStatsTable=portStatsTable, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, stgNewCfgState=stgNewCfgState, agPortCurCfgState=agPortCurCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgPorts=vlanCurCfgPorts, portInfoLink=portInfoLink, mirroring=mirroring, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portInfoIndx=portInfoIndx, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgPortState=stgCurCfgPortState, portmirroring=portmirroring, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, mirrOperMonitoringPort=mirrOperMonitoringPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgStgIndex=stgNewCfgStgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgRmon=agPortNewCfgRmon, vlanMaxEnt=vlanMaxEnt, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, port_stats=port_stats, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, vlanNewCfgState=vlanNewCfgState, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgPorts=vlanNewCfgPorts, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanCurCfgState=vlanCurCfgState, stgCurCfgIndex=stgCurCfgIndex, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portCpuStats=portCpuStats, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupNewCfgState=trunkGroupNewCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgStp=agPortCurCfgStp, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, mirrOperMirroredPort=mirrOperMirroredPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlans=vlans, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, stgCurCfgState=stgCurCfgState, port_info=port_info, pmNewCfgState=pmNewCfgState, spannTreeGrpCfg=spannTreeGrpCfg, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrOperTimeout=mirrOperTimeout, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgState=pmCurCfgState, stgCurCfgTable=stgCurCfgTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgTable=stgNewCfgTable, portInfoTable=portInfoTable, agPortCurCfgPortName=agPortCurCfgPortName, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portInfoTableEntry=portInfoTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, pmCurCfgTimeout=pmCurCfgTimeout, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrOperType=mirrOperType, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portInfoSpeed=portInfoSpeed, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portInfoPhyIfLastChange=portInfoPhyIfLastChange, mirrVlanMirr=mirrVlanMirr, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, mirrOperState=mirrOperState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgTableEntry=agPortNewCfgTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortTableMaxEnt=agPortTableMaxEnt, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgPVID=agPortNewCfgPVID, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgState=agPortNewCfgState, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsIndx=portStatsIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, trunkGroupCurCfgState=trunkGroupCurCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkgroup=trunkgroup, vlanCurCfgJumbo=vlanCurCfgJumbo, mirrPortMirr=mirrPortMirr, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portStatsPhyIfInErrors=portStatsPhyIfInErrors, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portInfoMode=portInfoMode, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgDelete=vlanNewCfgDelete, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgJumbo=vlanNewCfgJumbo)
