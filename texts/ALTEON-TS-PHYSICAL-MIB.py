...
# Produced by pysmi-1.1.8 at Thu Feb  3 20:58:31 2022
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgNewCfgAddVlan=stgNewCfgAddVlan, portCpuStats=portCpuStats, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portStatsTable=portStatsTable, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgBwmContract=agPortNewCfgBwmContract, agPortNewCfgStp=agPortNewCfgStp, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgState=stgCurCfgState, agPortCurCfgIndx=agPortCurCfgIndx, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portInfoFlowCtrl=portInfoFlowCtrl, mirroring=mirroring, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoTable=portInfoTable, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoLink=portInfoLink, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, mirrOperMonitoringPort=mirrOperMonitoringPort, mirrOperState=mirrOperState, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgNewCfgStgIndex=stgNewCfgStgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgCurCfgIndex=stgCurCfgIndex, portInfoIndx=portInfoIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortCurCfgPVID=agPortCurCfgPVID, agPortNewCfgState=agPortNewCfgState, agPortNewCfgIndx=agPortNewCfgIndx, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsTableEntry=portStatsTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portStatsPhyIfInOctets=portStatsPhyIfInOctets, mirrOper=mirrOper, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoSpeed=portInfoSpeed, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortCurCfgTable=agPortCurCfgTable, agPortConfig=agPortConfig, portStatsPhyIfInErrors=portStatsPhyIfInErrors, portInfoTableEntry=portInfoTableEntry, agPortNewCfgRmon=agPortNewCfgRmon, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, trunkGroupNewCfgTable=trunkGroupNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portInfoPhyIfDescr=portInfoPhyIfDescr, pmNewCfgState=pmNewCfgState, vlanMaxEnt=vlanMaxEnt, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, trunkGroupCurCfgState=trunkGroupCurCfgState, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgTable=stgCurCfgTable, vlanCurCfgPorts=vlanCurCfgPorts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTableEntry=stgNewCfgTableEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portmirroring=portmirroring, portStatsIndx=portStatsIndx, port_info=port_info, portCpuStatsUtilIndx=portCpuStatsUtilIndx, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgPortTable=stgCurCfgPortTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, vlans=vlans, vlanNewCfgJumbo=vlanNewCfgJumbo, mirrOperType=mirrOperType, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgTimeout=pmNewCfgTimeout, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, port_stats=port_stats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortCurCfgRmon=agPortCurCfgRmon, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupCurCfgTable=trunkGroupCurCfgTable, mirrPortMirr=mirrPortMirr, agPortNewCfgTable=agPortNewCfgTable, spannTreeGrpCfg=spannTreeGrpCfg, trunkgroup=trunkgroup, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgStg=vlanNewCfgStg, portInfoPhyIfLastChange=portInfoPhyIfLastChange, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperTimeout=mirrOperTimeout, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgState=stgNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanCurCfgVlanId=vlanCurCfgVlanId, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mirrVlanMirr=mirrVlanMirr, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, agPortNewCfgVlanTag=agPortNewCfgVlanTag, agPortCurCfgPortName=agPortCurCfgPortName, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, mirrOperMirroredPort=mirrOperMirroredPort, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgStgIndex=stgCurCfgStgIndex, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgState=agPortCurCfgState, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portInfoPhyIfType=portInfoPhyIfType, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanNewCfgVlanName=vlanNewCfgVlanName, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanNewCfgPorts=vlanNewCfgPorts, agPortCurCfgStp=agPortCurCfgStp, portInfoMode=portInfoMode, stgNewCfgIndex=stgNewCfgIndex, pmCurCfgState=pmCurCfgState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgDelete=vlanNewCfgDelete, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanNewCfgState=vlanNewCfgState, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, stgCurCfgTableEntry=stgCurCfgTableEntry, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgTable=vlanCurCfgTable, vlanCurCfgState=vlanCurCfgState, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable)
