...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:34:25 2022
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortCurCfgBackLink=agPortCurCfgBackLink, stgCurCfgState=stgCurCfgState, stgCurCfgPortTable=stgCurCfgPortTable, port_info=port_info, portCpuStats=portCpuStats, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, vlanCurCfgPorts=vlanCurCfgPorts, mirrOperMonitoringPort=mirrOperMonitoringPort, portStatsTable=portStatsTable, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgStp=agPortCurCfgStp, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgState=trunkGroupNewCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgRmon=agPortCurCfgRmon, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, vlanNewCfgTable=vlanNewCfgTable, stgNewCfgPortIndex=stgNewCfgPortIndex, stgNewCfgState=stgNewCfgState, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, trunkGroupCurCfgState=trunkGroupCurCfgState, agPortNewCfgPrefLink=agPortNewCfgPrefLink, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portInfoTable=portInfoTable, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgNewCfgStgIndex=stgNewCfgStgIndex, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, trunkgroup=trunkgroup, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfInOctets=portStatsPhyIfInOctets, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, mirrOperMirroredPort=mirrOperMirroredPort, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portInfoPhyIfDescr=portInfoPhyIfDescr, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgStp=agPortNewCfgStp, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgTimeout=pmNewCfgTimeout, pmCurCfgTimeout=pmCurCfgTimeout, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, portmirroring=portmirroring, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgBwmContract=agPortNewCfgBwmContract, stgNewCfgPortTable=stgNewCfgPortTable, stgNewCfgPortState=stgNewCfgPortState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, port_stats=port_stats, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoLink=portInfoLink, agPortNewCfgTableEntry=agPortNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, vlanMaxEnt=vlanMaxEnt, stgNewCfgTableEntry=stgNewCfgTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoTableEntry=portInfoTableEntry, portStatsTableEntry=portStatsTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgPVID=agPortCurCfgPVID, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortConfig=agPortConfig, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOper=mirrOper, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, mirrOperState=mirrOperState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, vlanNewCfgVlanId=vlanNewCfgVlanId, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, mirroring=mirroring, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, mirrVlanMirr=mirrVlanMirr, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portInfoIndx=portInfoIndx, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgTableEntry=agPortCurCfgTableEntry, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgState=vlanNewCfgState, spannTreeGrpCfg=spannTreeGrpCfg, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgPrefLink=agPortCurCfgPrefLink, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stgCurCfgTableEntry=stgCurCfgTableEntry, mirrOperTimeout=mirrOperTimeout, agPortNewCfgIndx=agPortNewCfgIndx, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgCurCfgStgIndex=stgCurCfgStgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mirrOperType=mirrOperType, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgState=pmNewCfgState, vlanNewCfgPorts=vlanNewCfgPorts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgTable=stgCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portInfoSpeed=portInfoSpeed, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, trunkGroupCurCfgTable=trunkGroupCurCfgTable, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgState=agPortNewCfgState, portInfoMode=portInfoMode, portStatsIndx=portStatsIndx, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, agPortCurCfgTable=agPortCurCfgTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, portInfoPhyIfLastChange=portInfoPhyIfLastChange, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanNewCfgJumbo=vlanNewCfgJumbo, pmCurCfgState=pmCurCfgState, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgVlanId=vlanCurCfgVlanId, vlanNewCfgDelete=vlanNewCfgDelete, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanNewCfgStg=vlanNewCfgStg, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, vlanCurCfgTable=vlanCurCfgTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgMirroredPort=pmNewCfgMirroredPort, vlanCurCfgStg=vlanCurCfgStg, agPortNewCfgRmon=agPortNewCfgRmon, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlans=vlans, agPortCurCfgState=agPortCurCfgState, agPortNewCfgPortName=agPortNewCfgPortName)
