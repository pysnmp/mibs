...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:03:33 2022
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", vlanNewCfgPorts=vlanNewCfgPorts, pmNewCfgState=pmNewCfgState, agPortNewCfgStp=agPortNewCfgStp, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortNewCfgPVID=agPortNewCfgPVID, stgCurCfgPortState=stgCurCfgPortState, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgMirroredPort=pmNewCfgMirroredPort, stgNewCfgTableEntry=stgNewCfgTableEntry, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, stgNewCfgIndex=stgNewCfgIndex, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgTable=trunkGroupNewCfgTable, spannTreeGrpCfg=spannTreeGrpCfg, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanMaxEnt=vlanMaxEnt, agPortNewCfgState=agPortNewCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, agPortCurCfgState=agPortCurCfgState, pmCurCfgTimeout=pmCurCfgTimeout, portCpuStats=portCpuStats, vlanCurCfgVlanName=vlanCurCfgVlanName, trunkgroup=trunkgroup, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgState=pmCurCfgState, agPortConfig=agPortConfig, agPortNewCfgPortName=agPortNewCfgPortName, vlanNewCfgJumbo=vlanNewCfgJumbo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoTableEntry=portInfoTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgMirroredPort=pmCurCfgMirroredPort, mirroring=mirroring, vlanNewCfgStg=vlanNewCfgStg, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlanNewCfgTableEntry=vlanNewCfgTableEntry, vlans=vlans, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoMode=portInfoMode, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoPhyIfType=portInfoPhyIfType, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, stgCurCfgIndex=stgCurCfgIndex, portStatsTable=portStatsTable, portInfoIndx=portInfoIndx, stgCurCfgTable=stgCurCfgTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, vlanCurCfgTableEntry=vlanCurCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortCurCfgBwmContract=agPortCurCfgBwmContract, vlanCurCfgPorts=vlanCurCfgPorts, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, mirrOper=mirrOper, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, mirrOperTimeout=mirrOperTimeout, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portInfoPhyIfDescr=portInfoPhyIfDescr, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanCurCfgTable=vlanCurCfgTable, portInfoSpeed=portInfoSpeed, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgPortState=stgNewCfgPortState, portInfoTable=portInfoTable, mirrOperMirroredPort=mirrOperMirroredPort, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, trunkGroupNewCfgState=trunkGroupNewCfgState, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrOperType=mirrOperType, mirrVlanMirr=mirrVlanMirr, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, vlanNewCfgAddPort=vlanNewCfgAddPort, portmirroring=portmirroring, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsTableEntry=portStatsTableEntry, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, portInfoLink=portInfoLink, agPortTableMaxEnt=agPortTableMaxEnt, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgTable=stgNewCfgTable, vlanCurCfgVlanId=vlanCurCfgVlanId, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgPortIndex=stgCurCfgPortIndex, port_info=port_info, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portInfoFlowCtrl=portInfoFlowCtrl, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, stgNewCfgState=stgNewCfgState, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortTable=stgCurCfgPortTable, mirrPortMirr=mirrPortMirr, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgIndx=agPortNewCfgIndx, mirrOperState=mirrOperState, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgPortName=agPortCurCfgPortName, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgTimeout=pmNewCfgTimeout, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, vlanNewCfgTable=vlanNewCfgTable, port_stats=port_stats, vlanCurCfgStg=vlanCurCfgStg, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgTable=agPortNewCfgTable, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, agPortCurCfgRmon=agPortCurCfgRmon, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortCurCfgIndx=agPortCurCfgIndx, portStatsIndx=portStatsIndx, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, stgCurCfgState=stgCurCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete)
