...
# Produced by pysmi-1.1.12 at Wed Dec  4 17:51:11 2024
...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portmirroring=portmirroring, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgVlanId=vlanCurCfgVlanId, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgCurCfgStgIndex=stgCurCfgStgIndex, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanNewCfgState=vlanNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, agPortCurCfgState=agPortCurCfgState, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portStatsTable=portStatsTable, agPortCurCfgIndx=agPortCurCfgIndx, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortCurCfgTable=agPortCurCfgTable, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, mirrOper=mirrOper, vlanNewCfgBwmContract=vlanNewCfgBwmContract, vlanNewCfgStg=vlanNewCfgStg, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortTableMaxEnt=agPortTableMaxEnt, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupTableMaxSize=trunkGroupTableMaxSize, pmCurCfgState=pmCurCfgState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, pmCurCfgTimeout=pmCurCfgTimeout, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgState=stgCurCfgState, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, vlanCurCfgTable=vlanCurCfgTable, stgNewCfgIndex=stgNewCfgIndex, vlanMaxEnt=vlanMaxEnt, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsIndx=portStatsIndx, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgCurCfgTable=stgCurCfgTable, vlanNewCfgTable=vlanNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, spannTreeGrpCfg=spannTreeGrpCfg, vlanNewCfgPorts=vlanNewCfgPorts, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanCurCfgJumbo=vlanCurCfgJumbo, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, mirroring=mirroring, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfInOctets=portStatsPhyIfInOctets, portInfoPhyIfMtu=portInfoPhyIfMtu, agPortNewCfgStp=agPortNewCfgStp, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, agPortCurCfgVlanTag=agPortCurCfgVlanTag, stgNewCfgPortState=stgNewCfgPortState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portInfoTableEntry=portInfoTableEntry, portInfoMode=portInfoMode, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortNewCfgPortName=agPortNewCfgPortName, pmNewCfgTimeout=pmNewCfgTimeout, mirrOperMonitoringPort=mirrOperMonitoringPort, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgBackLink=agPortNewCfgBackLink, agPortNewCfgTableEntry=agPortNewCfgTableEntry, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkgroup=trunkgroup, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirrVlanMirr=mirrVlanMirr, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, portCpuStats=portCpuStats, port_info=port_info, agPortCurCfgBackLink=agPortCurCfgBackLink, mirrOperTimeout=mirrOperTimeout, stgNewCfgTable=stgNewCfgTable, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, portStatsTableEntry=portStatsTableEntry, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgDelete=vlanNewCfgDelete, vlanCurCfgVlanName=vlanCurCfgVlanName, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, stgCurCfgPortIndex=stgCurCfgPortIndex, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, pmNewCfgMirroredPort=pmNewCfgMirroredPort, mirrPortMirr=mirrPortMirr, agPortCurCfgTableEntry=agPortCurCfgTableEntry, portInfoLink=portInfoLink, stgNewCfgAddVlan=stgNewCfgAddVlan, mirrOperMirroredPort=mirrOperMirroredPort, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortConfig=agPortConfig, agPortNewCfgTable=agPortNewCfgTable, mirrOperState=mirrOperState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgState=agPortNewCfgState, agPortCurCfgStp=agPortCurCfgStp, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, vlanCurCfgStg=vlanCurCfgStg, portInfoIndx=portInfoIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, vlans=vlans, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgVlanName=vlanNewCfgVlanName, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, vlanCurCfgPorts=vlanCurCfgPorts, stgCurCfgIndex=stgCurCfgIndex, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmNewCfgState=pmNewCfgState, stgNewCfgState=stgNewCfgState, vlanCurCfgState=vlanCurCfgState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgBwmContract=agPortNewCfgBwmContract, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portInfoTable=portInfoTable, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, stgNewCfgPortTable=stgNewCfgPortTable, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, mirrOperType=mirrOperType, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, portCpuStatsUtilIndx=portCpuStatsUtilIndx, vlanNewCfgVlanId=vlanNewCfgVlanId, port_stats=port_stats, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portInfoSpeed=portInfoSpeed, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgPortName=agPortCurCfgPortName, portInfoFlowCtrl=portInfoFlowCtrl, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, agPortCurCfgPrefLink=agPortCurCfgPrefLink)
