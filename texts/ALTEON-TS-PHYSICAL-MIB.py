...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgTableEntry=agPortCurCfgTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgTable=agPortNewCfgTable, portInfoIndx=portInfoIndx, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, portInfoPhyIfType=portInfoPhyIfType, stgCurCfgPortIndex=stgCurCfgPortIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, mirrOper=mirrOper, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, mirrPortMirr=mirrPortMirr, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portInfoPhyIfMtu=portInfoPhyIfMtu, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortCurCfgIndx=agPortCurCfgIndx, portInfoSpeed=portInfoSpeed, pmCurCfgPortMirrState=pmCurCfgPortMirrState, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, pmNewCfgMirroredPort=pmNewCfgMirroredPort, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgTable=vlanNewCfgTable, pmNewCfgState=pmNewCfgState, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, agPortNewCfgState=agPortNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgNewCfgState=stgNewCfgState, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgState=agPortCurCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgAddVlan=stgNewCfgAddVlan, vlanCurCfgPorts=vlanCurCfgPorts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, vlanNewCfgRemovePort=vlanNewCfgRemovePort, stgCurCfgPortTable=stgCurCfgPortTable, portInfoTableEntry=portInfoTableEntry, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, agPortNewCfgIndx=agPortNewCfgIndx, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, mirrOperMirroredPort=mirrOperMirroredPort, mirrVlanMirr=mirrVlanMirr, pmCurCfgState=pmCurCfgState, stgNewCfgPortState=stgNewCfgPortState, vlanCurCfgVlanName=vlanCurCfgVlanName, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoMode=portInfoMode, portInfoLink=portInfoLink, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, mirrOperType=mirrOperType, stgCurCfgTable=stgCurCfgTable, agPortNewCfgPortName=agPortNewCfgPortName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgTable=stgNewCfgTable, stgNewCfgTableEntry=stgNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmNewCfgPortMirrState=pmNewCfgPortMirrState, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, pmCurCfgTimeout=pmCurCfgTimeout, vlanNewCfgPorts=vlanNewCfgPorts, portInfoTable=portInfoTable, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portmirroring=portmirroring, agPortNewCfgVlanTag=agPortNewCfgVlanTag, vlanCurCfgJumbo=vlanCurCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgStp=agPortNewCfgStp, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, spannTreeGrpCfg=spannTreeGrpCfg, portStatsTable=portStatsTable, vlanCurCfgState=vlanCurCfgState, agPortCurCfgPortName=agPortCurCfgPortName, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsIndx=portStatsIndx, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgTable=agPortCurCfgTable, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, vlanCurCfgTable=vlanCurCfgTable, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mirroring=mirroring, vlanCurCfgTableEntry=vlanCurCfgTableEntry, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, agPortCurCfgPrefLink=agPortCurCfgPrefLink, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, mirrOperState=mirrOperState, port_info=port_info, agPortTableMaxEnt=agPortTableMaxEnt, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, stgCurCfgTableEntry=stgCurCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, mirrOperTimeout=mirrOperTimeout, agPortNewCfgRmon=agPortNewCfgRmon, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortCurCfgBwmContract=agPortCurCfgBwmContract, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, agPortNewCfgPrefLink=agPortNewCfgPrefLink, pmNewCfgTimeout=pmNewCfgTimeout, stgNewCfgIndex=stgNewCfgIndex, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupTableMaxSize=trunkGroupTableMaxSize, agPortConfig=agPortConfig, port_stats=port_stats, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortNewCfgPVID=agPortNewCfgPVID, vlanNewCfgBwmContract=vlanNewCfgBwmContract, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, trunkgroup=trunkgroup, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, vlans=vlans, portInfoPhyIfDescr=portInfoPhyIfDescr, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, vlanNewCfgJumbo=vlanNewCfgJumbo, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, stgCurCfgState=stgCurCfgState, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInErrors=portStatsPhyIfInErrors, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, portInfoFlowCtrl=portInfoFlowCtrl, trunkGroupCurCfgTable=trunkGroupCurCfgTable, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgPortIndex=stgNewCfgPortIndex, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, vlanNewCfgAddPort=vlanNewCfgAddPort, portStatsTableEntry=portStatsTableEntry, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanNewCfgDelete=vlanNewCfgDelete, agPortCurCfgBackLink=agPortCurCfgBackLink, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuStats=portCpuStats, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, trunkGroupNewCfgTable=trunkGroupNewCfgTable, vlanNewCfgTableEntry=vlanNewCfgTableEntry, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgStgIndex=stgCurCfgStgIndex, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, agPortCurCfgRmon=agPortCurCfgRmon, vlanMaxEnt=vlanMaxEnt, portCpuStatsUtilTable=portCpuStatsUtilTable, vlanNewCfgVlanId=vlanNewCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, vlanCurCfgStg=vlanCurCfgStg)
