...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, portInfoTable=portInfoTable, portInfoPhyIfDescr=portInfoPhyIfDescr, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortNewCfgVlanTag=agPortNewCfgVlanTag, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgNewCfgStgIndex=stgNewCfgStgIndex, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, vlanNewCfgState=vlanNewCfgState, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, vlans=vlans, stgCurCfgPortState=stgCurCfgPortState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, portInfoMode=portInfoMode, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, stgCurCfgIndex=stgCurCfgIndex, agPortNewCfgIndx=agPortNewCfgIndx, stgCurCfgState=stgCurCfgState, agPortTableMaxEnt=agPortTableMaxEnt, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, vlanCurCfgState=vlanCurCfgState, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, port_stats=port_stats, agPortCurCfgTableEntry=agPortCurCfgTableEntry, vlanNewCfgJumbo=vlanNewCfgJumbo, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portCpuStatsUtilIndx=portCpuStatsUtilIndx, trunkGroupNewCfgTable=trunkGroupNewCfgTable, mirrOperMirroredPort=mirrOperMirroredPort, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkgroup=trunkgroup, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portmirroring=portmirroring, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, agPortConfig=agPortConfig, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, mirrOperState=mirrOperState, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgNewCfgState=stgNewCfgState, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, portCpuStatsUtilTable=portCpuStatsUtilTable, agPortCurCfgPrefLink=agPortCurCfgPrefLink, vlanNewCfgTable=vlanNewCfgTable, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, agPortCurCfgRmon=agPortCurCfgRmon, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, mirrOperType=mirrOperType, vlanCurCfgPorts=vlanCurCfgPorts, stgNewCfgPortIndex=stgNewCfgPortIndex, agPortCurCfgBackLink=agPortCurCfgBackLink, vlanNewCfgAddPort=vlanNewCfgAddPort, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, stgCurCfgPortIndex=stgCurCfgPortIndex, mirrOperMonitoringPort=mirrOperMonitoringPort, agPortNewCfgState=agPortNewCfgState, agPortNewCfgStp=agPortNewCfgStp, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgTimeout=pmNewCfgTimeout, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, agPortCurCfgTable=agPortCurCfgTable, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuStats=portCpuStats, portInfoLink=portInfoLink, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsIndx=portStatsIndx, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, pmNewCfgMirroredPort=pmNewCfgMirroredPort, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, vlanCurCfgVlanName=vlanCurCfgVlanName, mirrVlanMirr=mirrVlanMirr, agPortNewCfgTable=agPortNewCfgTable, vlanNewCfgVlanName=vlanNewCfgVlanName, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgTimeout=pmCurCfgTimeout, portInfoSpeed=portInfoSpeed, agPortCurCfgState=agPortCurCfgState, agPortCurCfgPVID=agPortCurCfgPVID, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgPortName=agPortCurCfgPortName, stgNewCfgTable=stgNewCfgTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgStp=agPortCurCfgStp, vlanNewCfgPorts=vlanNewCfgPorts, port_info=port_info, vlanCurCfgBwmContract=vlanCurCfgBwmContract, portInfoIndx=portInfoIndx, agPortNewCfgBackLink=agPortNewCfgBackLink, pmNewCfgState=pmNewCfgState, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, vlanCurCfgTableEntry=vlanCurCfgTableEntry, mirroring=mirroring, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgNewCfgAddVlan=stgNewCfgAddVlan, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, mirrOper=mirrOper, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, mirrPortMirr=mirrPortMirr, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, portStatsTable=portStatsTable, agPortNewCfgPVID=agPortNewCfgPVID, pmCurCfgState=pmCurCfgState, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, vlanCurCfgVlanId=vlanCurCfgVlanId, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, spannTreeGrpCfg=spannTreeGrpCfg, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgVlanTag=agPortCurCfgVlanTag, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgPortName=agPortNewCfgPortName, stgNewCfgIndex=stgNewCfgIndex, portInfoPhyIfType=portInfoPhyIfType, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, pmCurCfgPortMirrState=pmCurCfgPortMirrState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, stgCurCfgTableEntry=stgCurCfgTableEntry, vlanCurCfgStg=vlanCurCfgStg, agPortCurCfgIndx=agPortCurCfgIndx, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, mirrOperTimeout=mirrOperTimeout, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, agPortNewCfgRmon=agPortNewCfgRmon, stgNewCfgPortTable=stgNewCfgPortTable, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, trunkGroupNewCfgState=trunkGroupNewCfgState, stgCurCfgTable=stgCurCfgTable, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortNewCfgPrefLink=agPortNewCfgPrefLink, portInfoTableEntry=portInfoTableEntry, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupCurCfgState=trunkGroupCurCfgState, portInfoPhyIfMtu=portInfoPhyIfMtu, vlanNewCfgStg=vlanNewCfgStg, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanMaxEnt=vlanMaxEnt, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, portStatsTableEntry=portStatsTableEntry, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgTable=vlanCurCfgTable, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg)
