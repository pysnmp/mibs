...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, vlanCurCfgVlanId=vlanCurCfgVlanId, portInfoPhyIfType=portInfoPhyIfType, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, agPortCurCfgTableEntry=agPortCurCfgTableEntry, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, agPortConfig=agPortConfig, portInfoLink=portInfoLink, stgNewCfgIndex=stgNewCfgIndex, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOperState=mirrOperState, stgNewCfgState=stgNewCfgState, vlanNewCfgVlanId=vlanNewCfgVlanId, vlanCurCfgJumbo=vlanCurCfgJumbo, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgCurCfgTableEntry=stgCurCfgTableEntry, portStatsTable=portStatsTable, agPortNewCfgStp=agPortNewCfgStp, stgCurCfgPortTable=stgCurCfgPortTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, stgCurCfgStgIndex=stgCurCfgStgIndex, stgNewCfgTableEntry=stgNewCfgTableEntry, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, agPortCurCfgState=agPortCurCfgState, vlanNewCfgDelete=vlanNewCfgDelete, port_info=port_info, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, vlanCurCfgTable=vlanCurCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, pmCurCfgMirroredPort=pmCurCfgMirroredPort, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, mirrOperTimeout=mirrOperTimeout, pmCurCfgState=pmCurCfgState, mirrOperMirroredPort=mirrOperMirroredPort, stgNewCfgAddVlan=stgNewCfgAddVlan, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, agPortNewCfgTable=agPortNewCfgTable, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoIndx=portInfoIndx, stgCurCfgIndex=stgCurCfgIndex, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, vlanMaxEnt=vlanMaxEnt, pmNewCfgTimeout=pmNewCfgTimeout, agPortNewCfgPortName=agPortNewCfgPortName, stgCurCfgTable=stgCurCfgTable, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, portStatsIndx=portStatsIndx, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, vlanCurCfgState=vlanCurCfgState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgState=pmNewCfgState, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, vlanCurCfgVlanName=vlanCurCfgVlanName, vlans=vlans, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgPortName=agPortCurCfgPortName, portInfoFlowCtrl=portInfoFlowCtrl, vlanNewCfgStg=vlanNewCfgStg, mirrOper=mirrOper, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, portInfoPhyIfMtu=portInfoPhyIfMtu, pmNewCfgPortMirrState=pmNewCfgPortMirrState, trunkgroup=trunkgroup, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, portInfoPhyIfDescr=portInfoPhyIfDescr, vlanCurCfgBwmContract=vlanCurCfgBwmContract, vlanNewCfgPorts=vlanNewCfgPorts, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, agPortNewCfgPVID=agPortNewCfgPVID, vlanCurCfgTableEntry=vlanCurCfgTableEntry, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, vlanNewCfgTableEntry=vlanNewCfgTableEntry, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, agPortNewCfgIndx=agPortNewCfgIndx, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, stgCurCfgPortState=stgCurCfgPortState, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portInfoMode=portInfoMode, agPortNewCfgTableEntry=agPortNewCfgTableEntry, portStatsTableEntry=portStatsTableEntry, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, vlanCurCfgPorts=vlanCurCfgPorts, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, stgNewCfgTable=stgNewCfgTable, stgNewCfgPortTable=stgNewCfgPortTable, port_stats=port_stats, mirrPortMirr=mirrPortMirr, mirrOperType=mirrOperType, agPortCurCfgRmon=agPortCurCfgRmon, spannTreeGrpCfg=spannTreeGrpCfg, agPortNewCfgRmon=agPortNewCfgRmon, agPortCurCfgVlanTag=agPortCurCfgVlanTag, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, agPortCurCfgPVID=agPortCurCfgPVID, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, trunkGroupCurCfgState=trunkGroupCurCfgState, mirroring=mirroring, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, mirrVlanMirr=mirrVlanMirr, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, mirrOperMonitoringPort=mirrOperMonitoringPort, portInfoTableEntry=portInfoTableEntry, agPortNewCfgState=agPortNewCfgState, portInfoPhyIfLastChange=portInfoPhyIfLastChange, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanCurCfgStg=vlanCurCfgStg, vlanNewCfgTable=vlanNewCfgTable, trunkGroupCurCfgTable=trunkGroupCurCfgTable, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, vlanNewCfgVlanName=vlanNewCfgVlanName, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortNewCfgBwmContract=agPortNewCfgBwmContract, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, portmirroring=portmirroring, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, vlanNewCfgRemovePort=vlanNewCfgRemovePort, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgJumbo=vlanNewCfgJumbo, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, trunkGroupTableMaxSize=trunkGroupTableMaxSize, stgNewCfgStgIndex=stgNewCfgStgIndex, trunkGroupNewCfgState=trunkGroupNewCfgState, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, agPortCurCfgBackLink=agPortCurCfgBackLink, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgPrefLink=agPortCurCfgPrefLink, agPortNewCfgBackLink=agPortNewCfgBackLink, stgCurCfgState=stgCurCfgState, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, pmNewCfgMirroredPort=pmNewCfgMirroredPort, portInfoSpeed=portInfoSpeed, portInfoTable=portInfoTable, agPortCurCfgStp=agPortCurCfgStp, portCpuStatsUtilIndx=portCpuStatsUtilIndx, agPortCurCfgTable=agPortCurCfgTable, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, agPortNewCfgPrefLink=agPortNewCfgPrefLink, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgBwmContract=agPortCurCfgBwmContract, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuStatsUtilTable=portCpuStatsUtilTable, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, portCpuStats=portCpuStats, vlanNewCfgAddPort=vlanNewCfgAddPort, agPortTableMaxEnt=agPortTableMaxEnt, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, vlanNewCfgState=vlanNewCfgState, trunkGroupNewCfgTable=trunkGroupNewCfgTable, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets)
