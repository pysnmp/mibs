...
mibBuilder.exportSymbols("ALTEON-TS-PHYSICAL-MIB", agPortNewCfgRmon=agPortNewCfgRmon, stgCurCfgTable=stgCurCfgTable, vlanCurCfgTableEntry=vlanCurCfgTableEntry, vlanNewCfgVlanId=vlanNewCfgVlanId, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, vlans=vlans, portStatsPhyIfInOctets=portStatsPhyIfInOctets, agPortTableMaxEnt=agPortTableMaxEnt, vlanMaxEnt=vlanMaxEnt, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, agPortCurCfgPVID=agPortCurCfgPVID, pmNewCfgMirroredPort=pmNewCfgMirroredPort, pmNewCfgTimeout=pmNewCfgTimeout, vlanNewCfgDelete=vlanNewCfgDelete, pmCurCfgVmirrDirection=pmCurCfgVmirrDirection, agPortConfig=agPortConfig, vlanCurCfgVlanName=vlanCurCfgVlanName, agPortCurCfgBwmContract=agPortCurCfgBwmContract, agPortCurCfgLinkTrap=agPortCurCfgLinkTrap, stgNewCfgState=stgNewCfgState, trunkgroup=trunkgroup, spannTreeGrpCfg=spannTreeGrpCfg, portStatsTable=portStatsTable, portInfoTableEntry=portInfoTableEntry, agPortCurCfgRmon=agPortCurCfgRmon, agPortNewCfgTableEntry=agPortNewCfgTableEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, portStatsPhyIfInUnknownProtos=portStatsPhyIfInUnknownProtos, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, stgNewCfgIndex=stgNewCfgIndex, portStatsIndx=portStatsIndx, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex, pmCurCfgVmirrMoniPortIndex=pmCurCfgVmirrMoniPortIndex, portInfoPhyIfDescr=portInfoPhyIfDescr, portCpuBStatsUtil1Second=portCpuBStatsUtil1Second, portCpuAStatsUtil4Seconds=portCpuAStatsUtil4Seconds, agPortNewCfgFastEthAutoNeg=agPortNewCfgFastEthAutoNeg, agPortNewCfgBwmContract=agPortNewCfgBwmContract, portInfoPhyIfType=portInfoPhyIfType, pmCurCfgMirroredPort=pmCurCfgMirroredPort, stgCurCfgPortTable=stgCurCfgPortTable, mirrOperMirroredPort=mirrOperMirroredPort, portInfoFlowCtrl=portInfoFlowCtrl, portStatsPhyIfOutNUcastPkts=portStatsPhyIfOutNUcastPkts, mirrOperType=mirrOperType, portmirroring=portmirroring, agPortNewCfgGigEthAutoNeg=agPortNewCfgGigEthAutoNeg, trunkGroupTableMaxSize=trunkGroupTableMaxSize, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, portInfoPhyIfLastChange=portInfoPhyIfLastChange, pmCurCfgMonitoredTraffic=pmCurCfgMonitoredTraffic, portStatsPhyIfInNUcastPkts=portStatsPhyIfInNUcastPkts, stgCurCfgIndex=stgCurCfgIndex, vlanCurCfgState=vlanCurCfgState, pmNewCfgVmirrMoniPortIndex=pmNewCfgVmirrMoniPortIndex, trunkGroupNewCfgTable=trunkGroupNewCfgTable, agPortNewCfgTable=agPortNewCfgTable, pmNewCfgMonitoringPort=pmNewCfgMonitoringPort, pmNewCfgVlanMonitorTable=pmNewCfgVlanMonitorTable, agPortNewCfgGigEthFctl=agPortNewCfgGigEthFctl, stgNewCfgStgIndex=stgNewCfgStgIndex, agPortCurCfgTable=agPortCurCfgTable, stgCurCfgVlanBmap2=stgCurCfgVlanBmap2, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, stgNewCfgVlanBmap1=stgNewCfgVlanBmap1, portInfoPhyIfOperStatus=portInfoPhyIfOperStatus, vlanCurCfgVlanId=vlanCurCfgVlanId, agPortCurCfgPrefLink=agPortCurCfgPrefLink, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, portCpuBStatsUtil64Seconds=portCpuBStatsUtil64Seconds, trunkGroupCurCfgTable=trunkGroupCurCfgTable, pmNewCfgVmirrDelete=pmNewCfgVmirrDelete, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, vlanCurCfgJumbo=vlanCurCfgJumbo, portInfoTable=portInfoTable, stgNewCfgPortState=stgNewCfgPortState, agPortCurCfgVlanTag=agPortCurCfgVlanTag, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, agPortCurCfgState=agPortCurCfgState, portCpuStatsUtilTable=portCpuStatsUtilTable, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mirrOperTimeout=mirrOperTimeout, portCpuStats=portCpuStats, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, pmNewCfgPortMirrState=pmNewCfgPortMirrState, agPortNewCfgPortName=agPortNewCfgPortName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, agPortNewCfgBackLink=agPortNewCfgBackLink, vlanCurCfgStg=vlanCurCfgStg, portInfoLink=portInfoLink, agPortCurCfgBackLink=agPortCurCfgBackLink, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, vlanNewCfgVlanName=vlanNewCfgVlanName, portStatsPhyIfOutBroadcastPkts=portStatsPhyIfOutBroadcastPkts, agPortCurCfgFastEthMode=agPortCurCfgFastEthMode, stgCurCfgState=stgCurCfgState, vlanNewCfgJumbo=vlanNewCfgJumbo, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, pmNewCfgMonitoredTraffic=pmNewCfgMonitoredTraffic, portStatsPhyIfInBroadcastPkts=portStatsPhyIfInBroadcastPkts, mirroring=mirroring, stgCurCfgTableEntry=stgCurCfgTableEntry, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, port_stats=port_stats, agPortCurCfgFastEthAutoNeg=agPortCurCfgFastEthAutoNeg, agPortNewCfgIndx=agPortNewCfgIndx, vlanCurCfgPorts=vlanCurCfgPorts, vlanNewCfgPorts=vlanNewCfgPorts, portStatsPhyIfOutQLen=portStatsPhyIfOutQLen, portStatsPhyIfInDiscards=portStatsPhyIfInDiscards, stgNewCfgPortTable=stgNewCfgPortTable, agPortCurCfgFastEthSpeed=agPortCurCfgFastEthSpeed, portStatsPhyIfOutDiscards=portStatsPhyIfOutDiscards, portStatsTableEntry=portStatsTableEntry, portInfoMode=portInfoMode, portInfoPhyIfMtu=portInfoPhyIfMtu, portStatsPhyIfOutUcastPkts=portStatsPhyIfOutUcastPkts, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, port_info=port_info, vlanNewCfgAddPort=vlanNewCfgAddPort, pmCurCfgPortMirrState=pmCurCfgPortMirrState, stgNewCfgVlanBmap2=stgNewCfgVlanBmap2, agPortCurCfgStp=agPortCurCfgStp, pmCurCfgVmirrMirrVlanIndex=pmCurCfgVmirrMirrVlanIndex, mirrPortMirr=mirrPortMirr, pmCurCfgVlanMonitorTable=pmCurCfgVlanMonitorTable, pmCurCfgTimeout=pmCurCfgTimeout, stgCurCfgPortState=stgCurCfgPortState, pmCurCfgState=pmCurCfgState, agPortNewCfgDiscardNonIPs=agPortNewCfgDiscardNonIPs, portStatsPhyIfOutOctets=portStatsPhyIfOutOctets, agPortCurCfgTableEntry=agPortCurCfgTableEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, portInfoIndx=portInfoIndx, trunkGroupCurCfgState=trunkGroupCurCfgState, portCpuAStatsUtil1Second=portCpuAStatsUtil1Second, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, stgNewCfgAddVlan=stgNewCfgAddVlan, portStatsPhyIfInErrors=portStatsPhyIfInErrors, vlanNewCfgState=vlanNewCfgState, stgCurCfgStgIndex=stgCurCfgStgIndex, agPortCurCfgDiscardNonIPs=agPortCurCfgDiscardNonIPs, vlanCurCfgTable=vlanCurCfgTable, portStatsPhyIfInUcastPkts=portStatsPhyIfInUcastPkts, agPortNewCfgFastEthMode=agPortNewCfgFastEthMode, pmCurCfgMonitoringPort=pmCurCfgMonitoringPort, portStatsPhyIfOutErrors=portStatsPhyIfOutErrors, agPortCurCfgFastEthFctl=agPortCurCfgFastEthFctl, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, vlanNewCfgTable=vlanNewCfgTable, vlanNewCfgBwmContract=vlanNewCfgBwmContract, agPortNewCfgFastEthFctl=agPortNewCfgFastEthFctl, mirrOperMonitoringPort=mirrOperMonitoringPort, trunkGroupNewCfgState=trunkGroupNewCfgState, vlanNewCfgStg=vlanNewCfgStg, stgNewCfgPortIndex=stgNewCfgPortIndex, vlanNewCfgTableEntry=vlanNewCfgTableEntry, agPortNewCfgLinkTrap=agPortNewCfgLinkTrap, pmCurCfgVlanMirrState=pmCurCfgVlanMirrState, mirrVlanMirr=mirrVlanMirr, pmNewCfgVmirrMirrVlanIndex=pmNewCfgVmirrMirrVlanIndex, vlanNewCfgRemovePort=vlanNewCfgRemovePort, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, portInfoSpeed=portInfoSpeed, portCpuStatsUtilTableEntry=portCpuStatsUtilTableEntry, stgNewCfgTable=stgNewCfgTable, stgCurCfgVlanBmap1=stgCurCfgVlanBmap1, pmNewCfgVlanMirrState=pmNewCfgVlanMirrState, mirrOper=mirrOper, mirrOperState=mirrOperState, agPortNewCfgFastEthSpeed=agPortNewCfgFastEthSpeed, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, pmNewCfgState=pmNewCfgState, agPortNewCfgState=agPortNewCfgState, pmCurCfgVlanMonitorEntry=pmCurCfgVlanMonitorEntry, agPortCurCfgGigEthFctl=agPortCurCfgGigEthFctl, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, pmNewCfgVmirrDirection=pmNewCfgVmirrDirection, agPortNewCfgVlanTag=agPortNewCfgVlanTag, portCpuBStatsUtil4Seconds=portCpuBStatsUtil4Seconds, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, agPortCurCfgGigEthAutoNeg=agPortCurCfgGigEthAutoNeg, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, portCpuStatsUtilIndx=portCpuStatsUtilIndx, pmNewCfgVlanMonitorEntry=pmNewCfgVlanMonitorEntry, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, portCpuAStatsUtil64Seconds=portCpuAStatsUtil64Seconds, agPortNewCfgPrefLink=agPortNewCfgPrefLink, agPortCurCfgIndx=agPortCurCfgIndx, agPortCurCfgPortName=agPortCurCfgPortName, portInfoPhyIfPhysAddress=portInfoPhyIfPhysAddress, vlanCurCfgBwmContract=vlanCurCfgBwmContract, agPortNewCfgPVID=agPortNewCfgPVID, agPortNewCfgStp=agPortNewCfgStp)
