...
mibBuilder.exportSymbols("LLDP-MIB", lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysDesc=lldpLocSysDesc, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpNotificationPrefix=lldpNotificationPrefix, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocChassisId=lldpLocChassisId, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatistics=lldpStatistics, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpObjects=lldpObjects, lldpMIB=lldpMIB, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocSysName=lldpLocSysName, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpPortList=LldpPortList, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemSysDesc=lldpRemSysDesc, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpPortConfigTable=lldpPortConfigTable, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpConfigGroup=lldpConfigGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemSysName=lldpRemSysName, lldpCompliance=lldpCompliance, lldpExtensions=lldpExtensions, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpLocSysGroup=lldpLocSysGroup, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpNotificationInterval=lldpNotificationInterval, lldpLocPortTable=lldpLocPortTable, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemTable=lldpRemTable, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortNum=lldpLocPortNum, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemChassisId=lldpRemChassisId, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemPortId=lldpRemPortId, lldpRemIndex=lldpRemIndex, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpConformance=lldpConformance, lldpGroups=lldpGroups, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemManAddr=lldpRemManAddr, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpConfiguration=lldpConfiguration, lldpReinitDelay=lldpReinitDelay, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpNotifications=lldpNotifications, lldpRemPortDesc=lldpRemPortDesc, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpStatsTxPortNum=lldpStatsTxPortNum, PYSNMP_MODULE_ID=lldpMIB, lldpRemTimeMark=lldpRemTimeMark, LldpChassisId=LldpChassisId, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, LldpManAddress=LldpManAddress, lldpRemSysCapEnabled=lldpRemSysCapEnabled, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocalSystemData=lldpLocalSystemData, lldpLocPortId=lldpLocPortId, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemEntry=lldpRemEntry, LldpPortId=LldpPortId, LldpPortNumber=LldpPortNumber, lldpTxDelay=lldpTxDelay, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpCompliances=lldpCompliances, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsRxPortTable=lldpStatsRxPortTable)
