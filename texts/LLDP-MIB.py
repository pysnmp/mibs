...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:11:42 2023
...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocPortDesc=lldpLocPortDesc, LldpPortNumber=LldpPortNumber, lldpStatistics=lldpStatistics, lldpObjects=lldpObjects, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemSysName=lldpRemSysName, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocSysDesc=lldpLocSysDesc, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocChassisId=lldpLocChassisId, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpConfigRxGroup=lldpConfigRxGroup, lldpNotificationPrefix=lldpNotificationPrefix, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpExtensions=lldpExtensions, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsTxGroup=lldpStatsTxGroup, LldpPortId=LldpPortId, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpConfigTxGroup=lldpConfigTxGroup, lldpConfigGroup=lldpConfigGroup, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpCompliances=lldpCompliances, LldpPortList=LldpPortList, lldpRemTable=lldpRemTable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemTimeMark=lldpRemTimeMark, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpNotifications=lldpNotifications, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpMIB=lldpMIB, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemLocalPortNum=lldpRemLocalPortNum, LldpChassisId=LldpChassisId, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocPortTable=lldpLocPortTable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocSysName=lldpLocSysName, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemSysDesc=lldpRemSysDesc, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpGroups=lldpGroups, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpNotificationInterval=lldpNotificationInterval, lldpLocalSystemData=lldpLocalSystemData, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemManAddr=lldpRemManAddr, lldpLocSysGroup=lldpLocSysGroup, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocPortId=lldpLocPortId, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, LldpManAddress=LldpManAddress, lldpRemIndex=lldpRemIndex, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxGroup=lldpStatsRxGroup, lldpConformance=lldpConformance, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemChassisId=lldpRemChassisId, lldpReinitDelay=lldpReinitDelay, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpTxDelay=lldpTxDelay, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpPortConfigTable=lldpPortConfigTable, lldpRemEntry=lldpRemEntry, lldpLocPortNum=lldpLocPortNum, lldpRemTablesChange=lldpRemTablesChange, lldpRemPortId=lldpRemPortId, lldpRemPortDesc=lldpRemPortDesc, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocManAddr=lldpLocManAddr, PYSNMP_MODULE_ID=lldpMIB, lldpConfiguration=lldpConfiguration, LldpPortIdSubtype=LldpPortIdSubtype, lldpLocPortEntry=lldpLocPortEntry, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpCompliance=lldpCompliance, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemSysGroup=lldpRemSysGroup)
