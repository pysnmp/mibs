...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpConformance=lldpConformance, lldpNotificationInterval=lldpNotificationInterval, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocSysGroup=lldpLocSysGroup, lldpRemEntry=lldpRemEntry, lldpPortConfigTable=lldpPortConfigTable, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRxGroup=lldpStatsRxGroup, lldpReinitDelay=lldpReinitDelay, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpLocSysName=lldpLocSysName, lldpLocPortNum=lldpLocPortNum, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpConfiguration=lldpConfiguration, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemUnknownTLVType=lldpRemUnknownTLVType, LldpChassisId=LldpChassisId, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocManAddrOID=lldpLocManAddrOID, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpTxDelay=lldpTxDelay, lldpLocPortDesc=lldpLocPortDesc, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemChassisId=lldpRemChassisId, lldpLocChassisId=lldpLocChassisId, lldpRemPortId=lldpRemPortId, lldpRemSysName=lldpRemSysName, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemPortDesc=lldpRemPortDesc, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpNotificationPrefix=lldpNotificationPrefix, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpExtensions=lldpExtensions, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemManAddr=lldpRemManAddr, PYSNMP_MODULE_ID=lldpMIB, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpPortNumber=LldpPortNumber, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpGroups=lldpGroups, lldpLocalSystemData=lldpLocalSystemData, lldpStatistics=lldpStatistics, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemSysDesc=lldpRemSysDesc, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpRemManAddrIfId=lldpRemManAddrIfId, LldpManAddress=LldpManAddress, lldpMIB=lldpMIB, lldpRemTable=lldpRemTable, lldpLocSysDesc=lldpLocSysDesc, LldpPortId=LldpPortId, lldpRemManAddrTable=lldpRemManAddrTable, lldpCompliance=lldpCompliance, lldpObjects=lldpObjects, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemIndex=lldpRemIndex, lldpNotifications=lldpNotifications, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocPortEntry=lldpLocPortEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocPortId=lldpLocPortId, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemTimeMark=lldpRemTimeMark, lldpLocManAddr=lldpLocManAddr, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemManAddrEntry=lldpRemManAddrEntry, LldpPortList=LldpPortList, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpConfigGroup=lldpConfigGroup, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpCompliances=lldpCompliances, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocPortTable=lldpLocPortTable, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype)
