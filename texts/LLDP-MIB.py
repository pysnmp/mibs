...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxGroup=lldpStatsRxGroup, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocPortTable=lldpLocPortTable, lldpRemOrgDefInfo=lldpRemOrgDefInfo, LldpManAddress=LldpManAddress, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpObjects=lldpObjects, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocPortDesc=lldpLocPortDesc, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpExtensions=lldpExtensions, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocPortId=lldpLocPortId, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemEntry=lldpRemEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpNotifications=lldpNotifications, lldpLocSysName=lldpLocSysName, lldpCompliances=lldpCompliances, lldpLocalSystemData=lldpLocalSystemData, lldpNotificationInterval=lldpNotificationInterval, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpGroups=lldpGroups, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpStatsTxGroup=lldpStatsTxGroup, LldpPortNumber=LldpPortNumber, lldpLocManAddr=lldpLocManAddr, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpConfiguration=lldpConfiguration, lldpTxDelay=lldpTxDelay, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpPortConfigTable=lldpPortConfigTable, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemTable=lldpRemTable, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemSysName=lldpRemSysName, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpNotificationsGroup=lldpNotificationsGroup, LldpPortId=LldpPortId, lldpLocPortNum=lldpLocPortNum, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocManAddrLen=lldpLocManAddrLen, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocChassisId=lldpLocChassisId, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatistics=lldpStatistics, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpChassisId=LldpChassisId, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemTablesChange=lldpRemTablesChange, lldpRemManAddr=lldpRemManAddr, lldpRemChassisId=lldpRemChassisId, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemPortDesc=lldpRemPortDesc, lldpRemSysDesc=lldpRemSysDesc, lldpRemIndex=lldpRemIndex, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemSysGroup=lldpRemSysGroup, PYSNMP_MODULE_ID=lldpMIB, lldpLocPortEntry=lldpLocPortEntry, lldpRemPortId=lldpRemPortId, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpCompliance=lldpCompliance, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpReinitDelay=lldpReinitDelay, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpConfigGroup=lldpConfigGroup, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpMIB=lldpMIB, lldpLocSysGroup=lldpLocSysGroup, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, LldpPortIdSubtype=LldpPortIdSubtype, LldpPortList=LldpPortList, lldpConformance=lldpConformance, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpLocManAddrEntry=lldpLocManAddrEntry, LldpManAddrIfSubtype=LldpManAddrIfSubtype)
