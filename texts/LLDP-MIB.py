...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocManAddrEntry=lldpLocManAddrEntry, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpExtensions=lldpExtensions, lldpConfigGroup=lldpConfigGroup, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpReinitDelay=lldpReinitDelay, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocManAddrSubtype=lldpLocManAddrSubtype, LldpManAddress=LldpManAddress, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocChassisId=lldpLocChassisId, lldpLocSysDesc=lldpLocSysDesc, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpPortConfigEntry=lldpPortConfigEntry, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpConfiguration=lldpConfiguration, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocManAddr=lldpLocManAddr, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemPortId=lldpRemPortId, LldpPortNumber=LldpPortNumber, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemChassisId=lldpRemChassisId, lldpLocPortNum=lldpLocPortNum, LldpPortList=LldpPortList, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemTablesChange=lldpRemTablesChange, LldpPortId=LldpPortId, lldpCompliance=lldpCompliance, lldpNotifications=lldpNotifications, lldpRemEntry=lldpRemEntry, lldpStatistics=lldpStatistics, lldpRemPortDesc=lldpRemPortDesc, lldpLocSysGroup=lldpLocSysGroup, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemManAddrTable=lldpRemManAddrTable, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemSysName=lldpRemSysName, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocPortDesc=lldpLocPortDesc, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsTxGroup=lldpStatsTxGroup, LldpChassisId=LldpChassisId, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, PYSNMP_MODULE_ID=lldpMIB, lldpObjects=lldpObjects, lldpGroups=lldpGroups, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpLocSysName=lldpLocSysName, lldpMIB=lldpMIB, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemTable=lldpRemTable, lldpPortConfigTable=lldpPortConfigTable, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocPortTable=lldpLocPortTable, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemSysGroup=lldpRemSysGroup, lldpTxDelay=lldpTxDelay, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpCompliances=lldpCompliances, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocalSystemData=lldpLocalSystemData, lldpRemSysDesc=lldpRemSysDesc, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpConformance=lldpConformance, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemIndex=lldpRemIndex, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemManAddr=lldpRemManAddr, lldpLocPortEntry=lldpLocPortEntry, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpNotificationInterval=lldpNotificationInterval, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpMessageTxInterval=lldpMessageTxInterval, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocPortId=lldpLocPortId, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemTimeMark=lldpRemTimeMark, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype)
