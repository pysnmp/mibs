...
mibBuilder.exportSymbols("LLDP-MIB", lldpNotificationInterval=lldpNotificationInterval, lldpPortConfigEntry=lldpPortConfigEntry, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocSysName=lldpLocSysName, lldpStatistics=lldpStatistics, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemEntry=lldpRemEntry, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpPortConfigTable=lldpPortConfigTable, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpGroups=lldpGroups, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemChassisId=lldpRemChassisId, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpConfigRxGroup=lldpConfigRxGroup, LldpPortId=LldpPortId, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpNotificationPrefix=lldpNotificationPrefix, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocPortDesc=lldpLocPortDesc, lldpRemOrgDefInfo=lldpRemOrgDefInfo, LldpPortList=LldpPortList, LldpChassisId=LldpChassisId, lldpRemTimeMark=lldpRemTimeMark, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemSysGroup=lldpRemSysGroup, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemSysDesc=lldpRemSysDesc, LldpChassisIdSubtype=LldpChassisIdSubtype, LldpManAddress=LldpManAddress, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpReinitDelay=lldpReinitDelay, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemTablesChange=lldpRemTablesChange, lldpConformance=lldpConformance, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpLocSysDesc=lldpLocSysDesc, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocalSystemData=lldpLocalSystemData, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemIndex=lldpRemIndex, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpPortIdSubtype=LldpPortIdSubtype, lldpCompliances=lldpCompliances, lldpLocPortId=lldpLocPortId, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpConfigGroup=lldpConfigGroup, lldpLocChassisId=lldpLocChassisId, lldpMIB=lldpMIB, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpRemManAddr=lldpRemManAddr, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocManAddrOID=lldpLocManAddrOID, lldpTxDelay=lldpTxDelay, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpConfiguration=lldpConfiguration, lldpCompliance=lldpCompliance, lldpObjects=lldpObjects, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemPortId=lldpRemPortId, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpPortNumber=LldpPortNumber, lldpRemTable=lldpRemTable, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocPortEntry=lldpLocPortEntry, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocPortIdSubtype=lldpLocPortIdSubtype, PYSNMP_MODULE_ID=lldpMIB, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocManAddr=lldpLocManAddr, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpNotifications=lldpNotifications, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocPortTable=lldpLocPortTable, lldpLocPortNum=lldpLocPortNum, lldpRemSysName=lldpRemSysName, lldpExtensions=lldpExtensions, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocSysGroup=lldpLocSysGroup)
