...
mibBuilder.exportSymbols("LLDP-MIB", LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpNotificationsGroup=lldpNotificationsGroup, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpConformance=lldpConformance, lldpTxDelay=lldpTxDelay, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemSysGroup=lldpRemSysGroup, LldpPortId=LldpPortId, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocSysGroup=lldpLocSysGroup, lldpLocalSystemData=lldpLocalSystemData, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpExtensions=lldpExtensions, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatistics=lldpStatistics, lldpLocPortDesc=lldpLocPortDesc, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, PYSNMP_MODULE_ID=lldpMIB, lldpRemTable=lldpRemTable, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpConfiguration=lldpConfiguration, LldpManAddress=LldpManAddress, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemManAddr=lldpRemManAddr, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocPortId=lldpLocPortId, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemManAddrOID=lldpRemManAddrOID, lldpConfigManAddrEntry=lldpConfigManAddrEntry, LldpPortNumber=LldpPortNumber, LldpPortIdSubtype=LldpPortIdSubtype, lldpLocSysDesc=lldpLocSysDesc, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpNotificationPrefix=lldpNotificationPrefix, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpNotificationInterval=lldpNotificationInterval, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemChassisId=lldpRemChassisId, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemSysName=lldpRemSysName, LldpPortList=LldpPortList, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemTimeMark=lldpRemTimeMark, lldpRemSysDesc=lldpRemSysDesc, lldpRemPortId=lldpRemPortId, lldpReinitDelay=lldpReinitDelay, lldpCompliances=lldpCompliances, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemEntry=lldpRemEntry, lldpLocManAddrLen=lldpLocManAddrLen, lldpMIB=lldpMIB, lldpRemManAddrTable=lldpRemManAddrTable, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocChassisId=lldpLocChassisId, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocManAddr=lldpLocManAddr, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpPortConfigTable=lldpPortConfigTable, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpChassisId=LldpChassisId, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemTablesChange=lldpRemTablesChange, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemPortDesc=lldpRemPortDesc, lldpStatsRxGroup=lldpStatsRxGroup, lldpCompliance=lldpCompliance, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpGroups=lldpGroups, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocPortEntry=lldpLocPortEntry, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocPortTable=lldpLocPortTable, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpObjects=lldpObjects, lldpConfigGroup=lldpConfigGroup, lldpNotifications=lldpNotifications, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpLocPortNum=lldpLocPortNum, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocSysName=lldpLocSysName, lldpRemIndex=lldpRemIndex)
