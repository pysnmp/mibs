...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemTable=lldpRemTable, lldpLocPortTable=lldpLocPortTable, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotificationInterval=lldpNotificationInterval, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpConfigGroup=lldpConfigGroup, lldpRemChassisId=lldpRemChassisId, lldpReinitDelay=lldpReinitDelay, lldpRemManAddrTable=lldpRemManAddrTable, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemSysDesc=lldpRemSysDesc, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpConfiguration=lldpConfiguration, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpNotifications=lldpNotifications, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocSysDesc=lldpLocSysDesc, lldpStatistics=lldpStatistics, PYSNMP_MODULE_ID=lldpMIB, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemSysGroup=lldpRemSysGroup, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemIndex=lldpRemIndex, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemPortId=lldpRemPortId, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpNotificationsGroup=lldpNotificationsGroup, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpLocPortEntry=lldpLocPortEntry, lldpRemPortDesc=lldpRemPortDesc, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocSysGroup=lldpLocSysGroup, lldpCompliances=lldpCompliances, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, LldpPortId=LldpPortId, lldpLocManAddr=lldpLocManAddr, lldpRemManAddr=lldpRemManAddr, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpPortList=LldpPortList, lldpTxDelay=lldpTxDelay, lldpObjects=lldpObjects, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemSysName=lldpRemSysName, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemManAddrOID=lldpRemManAddrOID, LldpChassisId=LldpChassisId, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemTimeMark=lldpRemTimeMark, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocPortNum=lldpLocPortNum, lldpExtensions=lldpExtensions, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpLocalSystemData=lldpLocalSystemData, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpPortConfigTable=lldpPortConfigTable, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocChassisId=lldpLocChassisId, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpConformance=lldpConformance, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemEntry=lldpRemEntry, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocManAddrOID=lldpLocManAddrOID, lldpGroups=lldpGroups, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocPortId=lldpLocPortId, LldpManAddress=LldpManAddress, lldpRemTablesChange=lldpRemTablesChange, lldpLocPortIdSubtype=lldpLocPortIdSubtype, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocSysName=lldpLocSysName, lldpStatsRxPortTable=lldpStatsRxPortTable, LldpPortNumber=LldpPortNumber, lldpMIB=lldpMIB, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpConfigRxGroup=lldpConfigRxGroup, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpCompliance=lldpCompliance, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpMessageTxInterval=lldpMessageTxInterval)
