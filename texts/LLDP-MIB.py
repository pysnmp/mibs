...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemManAddrTable=lldpRemManAddrTable, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpConfigRxGroup=lldpConfigRxGroup, lldpNotificationInterval=lldpNotificationInterval, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpExtensions=lldpExtensions, lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpCompliance=lldpCompliance, lldpRemSysGroup=lldpRemSysGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpLocManAddr=lldpLocManAddr, lldpConfigGroup=lldpConfigGroup, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, LldpChassisId=LldpChassisId, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpConfigManAddrTable=lldpConfigManAddrTable, LldpPortIdSubtype=LldpPortIdSubtype, lldpObjects=lldpObjects, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, LldpPortId=LldpPortId, LldpManAddress=LldpManAddress, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpLocPortNum=lldpLocPortNum, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemTable=lldpRemTable, lldpTxDelay=lldpTxDelay, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemIndex=lldpRemIndex, lldpLocChassisId=lldpLocChassisId, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemManAddrIfId=lldpRemManAddrIfId, LldpPortList=LldpPortList, lldpLocPortId=lldpLocPortId, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, PYSNMP_MODULE_ID=lldpMIB, lldpGroups=lldpGroups, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemManAddr=lldpRemManAddr, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocSysGroup=lldpLocSysGroup, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsRxGroup=lldpStatsRxGroup, lldpReinitDelay=lldpReinitDelay, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemSysDesc=lldpRemSysDesc, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocSysName=lldpLocSysName, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemEntry=lldpRemEntry, lldpRemTimeMark=lldpRemTimeMark, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemSysName=lldpRemSysName, lldpCompliances=lldpCompliances, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpConfiguration=lldpConfiguration, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpMIB=lldpMIB, lldpRemPortId=lldpRemPortId, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpNotificationPrefix=lldpNotificationPrefix, lldpConformance=lldpConformance, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocSysDesc=lldpLocSysDesc, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocSysCapSupported=lldpLocSysCapSupported, LldpPortNumber=LldpPortNumber, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocPortDesc=lldpLocPortDesc, lldpStatsTxGroup=lldpStatsTxGroup, lldpPortConfigTable=lldpPortConfigTable, lldpLocalSystemData=lldpLocalSystemData, lldpRemPortDesc=lldpRemPortDesc, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemTablesChange=lldpRemTablesChange, lldpNotifications=lldpNotifications, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocPortTable=lldpLocPortTable, lldpRemChassisId=lldpRemChassisId, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpStatistics=lldpStatistics, lldpStatsTxPortNum=lldpStatsTxPortNum)
