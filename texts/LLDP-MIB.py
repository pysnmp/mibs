...
mibBuilder.exportSymbols("LLDP-MIB", lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemSysGroup=lldpRemSysGroup, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocManAddrLen=lldpLocManAddrLen, lldpConfiguration=lldpConfiguration, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocSysName=lldpLocSysName, lldpReinitDelay=lldpReinitDelay, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpNotifications=lldpNotifications, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatistics=lldpStatistics, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddr=lldpRemManAddr, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemTimeMark=lldpRemTimeMark, lldpRemChassisId=lldpRemChassisId, LldpPortNumber=LldpPortNumber, lldpExtensions=lldpExtensions, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemManAddrTable=lldpRemManAddrTable, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemTable=lldpRemTable, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemEntry=lldpRemEntry, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemSysName=lldpRemSysName, LldpChassisId=LldpChassisId, lldpRemIndex=lldpRemIndex, lldpNotificationPrefix=lldpNotificationPrefix, lldpConfigGroup=lldpConfigGroup, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpCompliance=lldpCompliance, lldpStatsRxPortEntry=lldpStatsRxPortEntry, PYSNMP_MODULE_ID=lldpMIB, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocSysCapSupported=lldpLocSysCapSupported, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpManAddress=LldpManAddress, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpGroups=lldpGroups, lldpPortConfigTable=lldpPortConfigTable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocManAddrOID=lldpLocManAddrOID, lldpConfigManAddrTable=lldpConfigManAddrTable, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpObjects=lldpObjects, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocPortTable=lldpLocPortTable, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocalSystemData=lldpLocalSystemData, LldpPortIdSubtype=LldpPortIdSubtype, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpMessageTxInterval=lldpMessageTxInterval, lldpNotificationInterval=lldpNotificationInterval, LldpPortId=LldpPortId, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemPortDesc=lldpRemPortDesc, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemSysDesc=lldpRemSysDesc, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpPortList=LldpPortList, lldpLocPortId=lldpLocPortId, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocPortNum=lldpLocPortNum, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpMIB=lldpMIB, lldpLocSysDesc=lldpLocSysDesc, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocPortDesc=lldpLocPortDesc, lldpCompliances=lldpCompliances, lldpLocSysGroup=lldpLocSysGroup, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpConformance=lldpConformance, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemPortId=lldpRemPortId, lldpTxDelay=lldpTxDelay, lldpLocChassisId=lldpLocChassisId, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemManAddrSubtype=lldpRemManAddrSubtype)
