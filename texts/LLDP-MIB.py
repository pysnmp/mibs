...
mibBuilder.exportSymbols("LLDP-MIB", LldpChassisId=LldpChassisId, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemTimeMark=lldpRemTimeMark, lldpNotifications=lldpNotifications, lldpRemSysName=lldpRemSysName, lldpNotificationPrefix=lldpNotificationPrefix, lldpLocManAddrIfId=lldpLocManAddrIfId, PYSNMP_MODULE_ID=lldpMIB, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpPortConfigTable=lldpPortConfigTable, lldpRemTablesChange=lldpRemTablesChange, lldpLocManAddrOID=lldpLocManAddrOID, LldpChassisIdSubtype=LldpChassisIdSubtype, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocSysName=lldpLocSysName, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocSysGroup=lldpLocSysGroup, lldpRemSysDesc=lldpRemSysDesc, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpPortId=LldpPortId, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemEntry=lldpRemEntry, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocPortNum=lldpLocPortNum, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpConfigRxGroup=lldpConfigRxGroup, lldpConfiguration=lldpConfiguration, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpConformance=lldpConformance, lldpLocPortTable=lldpLocPortTable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpLocalSystemData=lldpLocalSystemData, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpTxDelay=lldpTxDelay, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemChassisId=lldpRemChassisId, lldpRemTable=lldpRemTable, lldpRemPortId=lldpRemPortId, lldpStatistics=lldpStatistics, lldpLocPortId=lldpLocPortId, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocManAddr=lldpLocManAddr, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpPortConfigEntry=lldpPortConfigEntry, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddr=lldpRemManAddr, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpCompliance=lldpCompliance, lldpReinitDelay=lldpReinitDelay, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocSysDesc=lldpLocSysDesc, lldpLocPortEntry=lldpLocPortEntry, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocChassisId=lldpLocChassisId, lldpStatsRxGroup=lldpStatsRxGroup, LldpPortNumber=LldpPortNumber, lldpObjects=lldpObjects, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, LldpPortList=LldpPortList, lldpExtensions=lldpExtensions, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpCompliances=lldpCompliances, LldpManAddress=LldpManAddress, lldpGroups=lldpGroups, lldpConfigGroup=lldpConfigGroup, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpNotificationInterval=lldpNotificationInterval, lldpRemPortDesc=lldpRemPortDesc, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemIndex=lldpRemIndex, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpMIB=lldpMIB, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemSysGroup=lldpRemSysGroup)
