...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocalSystemData=lldpLocalSystemData, lldpLocPortId=lldpLocPortId, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocSysName=lldpLocSysName, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpPortConfigTable=lldpPortConfigTable, lldpRemSysDesc=lldpRemSysDesc, lldpRemPortDesc=lldpRemPortDesc, lldpLocSysDesc=lldpLocSysDesc, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemIndex=lldpRemIndex, LldpManAddress=LldpManAddress, lldpLocPortDesc=lldpLocPortDesc, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocPortEntry=lldpLocPortEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpNotificationPrefix=lldpNotificationPrefix, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemChassisId=lldpRemChassisId, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemEntry=lldpRemEntry, lldpMIB=lldpMIB, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatistics=lldpStatistics, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, LldpChassisId=LldpChassisId, lldpRemSysName=lldpRemSysName, lldpNotifications=lldpNotifications, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpNotificationsGroup=lldpNotificationsGroup, lldpConfiguration=lldpConfiguration, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocPortTable=lldpLocPortTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocPortNum=lldpLocPortNum, lldpTxDelay=lldpTxDelay, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddrOID=lldpRemManAddrOID, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpCompliance=lldpCompliance, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemLocalPortNum=lldpRemLocalPortNum, LldpPortId=LldpPortId, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpCompliances=lldpCompliances, PYSNMP_MODULE_ID=lldpMIB, lldpConformance=lldpConformance, lldpRemTablesChange=lldpRemTablesChange, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpExtensions=lldpExtensions, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemTable=lldpRemTable, lldpReinitDelay=lldpReinitDelay, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocChassisId=lldpLocChassisId, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpGroups=lldpGroups, lldpLocManAddrTable=lldpLocManAddrTable, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemPortId=lldpRemPortId, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpNotificationInterval=lldpNotificationInterval, lldpObjects=lldpObjects, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, LldpPortList=LldpPortList, lldpLocSysGroup=lldpLocSysGroup, lldpLocManAddr=lldpLocManAddr, lldpRemManAddr=lldpRemManAddr, LldpPortNumber=LldpPortNumber, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpConfigGroup=lldpConfigGroup)
