...
mibBuilder.exportSymbols("LLDP-MIB", lldpExtensions=lldpExtensions, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysGroup=lldpRemSysGroup, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocPortDesc=lldpLocPortDesc, lldpStatsRxPortNum=lldpStatsRxPortNum, LldpPortNumber=LldpPortNumber, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpConfigTxGroup=lldpConfigTxGroup, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpObjects=lldpObjects, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemChassisId=lldpRemChassisId, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpMessageTxInterval=lldpMessageTxInterval, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatistics=lldpStatistics, lldpLocalSystemData=lldpLocalSystemData, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpPortConfigEntry=lldpPortConfigEntry, LldpManAddress=LldpManAddress, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocSysGroup=lldpLocSysGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemManAddr=lldpRemManAddr, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpNotificationInterval=lldpNotificationInterval, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpLocPortTable=lldpLocPortTable, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemIndex=lldpRemIndex, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpConfigGroup=lldpConfigGroup, lldpRemTable=lldpRemTable, lldpMIB=lldpMIB, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemSysName=lldpRemSysName, LldpChassisId=LldpChassisId, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemTablesChange=lldpRemTablesChange, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocChassisId=lldpLocChassisId, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemPortId=lldpRemPortId, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, LldpPortIdSubtype=LldpPortIdSubtype, PYSNMP_MODULE_ID=lldpMIB, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpConfiguration=lldpConfiguration, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocPortId=lldpLocPortId, lldpCompliance=lldpCompliance, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, LldpPortList=LldpPortList, lldpLocPortEntry=lldpLocPortEntry, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocManAddrOID=lldpLocManAddrOID, lldpPortConfigTable=lldpPortConfigTable, lldpRemEntry=lldpRemEntry, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemSysDesc=lldpRemSysDesc, lldpConfigRxGroup=lldpConfigRxGroup, lldpCompliances=lldpCompliances, lldpLocPortNum=lldpLocPortNum, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, LldpPortId=LldpPortId, lldpConformance=lldpConformance, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpGroups=lldpGroups, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpNotifications=lldpNotifications, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocManAddr=lldpLocManAddr, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocSysName=lldpLocSysName, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpNotificationsGroup=lldpNotificationsGroup, lldpReinitDelay=lldpReinitDelay, lldpTxDelay=lldpTxDelay)
