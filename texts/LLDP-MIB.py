...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemEntry=lldpRemEntry, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocPortTable=lldpLocPortTable, lldpExtensions=lldpExtensions, lldpRemChassisId=lldpRemChassisId, lldpRemManAddr=lldpRemManAddr, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemPortId=lldpRemPortId, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocPortNum=lldpLocPortNum, lldpLocSysGroup=lldpLocSysGroup, lldpRemManAddrSubtype=lldpRemManAddrSubtype, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemSysGroup=lldpRemSysGroup, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocSysName=lldpLocSysName, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocManAddr=lldpLocManAddr, lldpPortConfigTable=lldpPortConfigTable, lldpConfigTxGroup=lldpConfigTxGroup, LldpPortIdSubtype=LldpPortIdSubtype, LldpPortList=LldpPortList, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpConfiguration=lldpConfiguration, lldpStatistics=lldpStatistics, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpConformance=lldpConformance, lldpCompliance=lldpCompliance, lldpGroups=lldpGroups, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigGroup=lldpConfigGroup, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemSysDesc=lldpRemSysDesc, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemSysName=lldpRemSysName, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocChassisId=lldpLocChassisId, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemTimeMark=lldpRemTimeMark, LldpChassisId=LldpChassisId, lldpLocSysDesc=lldpLocSysDesc, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpConfigRxGroup=lldpConfigRxGroup, lldpPortConfigEntry=lldpPortConfigEntry, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemPortDesc=lldpRemPortDesc, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpNotifications=lldpNotifications, lldpLocPortDesc=lldpLocPortDesc, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpPortNumber=LldpPortNumber, lldpTxDelay=lldpTxDelay, lldpObjects=lldpObjects, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpLocPortId=lldpLocPortId, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocalSystemData=lldpLocalSystemData, LldpChassisIdSubtype=LldpChassisIdSubtype, LldpPortId=LldpPortId, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpManAddress=LldpManAddress, lldpRemoteSystemsData=lldpRemoteSystemsData, PYSNMP_MODULE_ID=lldpMIB, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpNotificationInterval=lldpNotificationInterval, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemTablesChange=lldpRemTablesChange, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpMIB=lldpMIB, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemManAddrTable=lldpRemManAddrTable, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemTable=lldpRemTable, lldpReinitDelay=lldpReinitDelay, lldpCompliances=lldpCompliances, lldpRemIndex=lldpRemIndex, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI)
