...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemTable=lldpRemTable, lldpRemPortDesc=lldpRemPortDesc, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpTxDelay=lldpTxDelay, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpReinitDelay=lldpReinitDelay, lldpRemSysDesc=lldpRemSysDesc, lldpLocManAddrOID=lldpLocManAddrOID, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemChassisId=lldpRemChassisId, LldpPortNumber=LldpPortNumber, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsTxPortEntry=lldpStatsTxPortEntry, LldpChassisId=LldpChassisId, lldpStatsTxGroup=lldpStatsTxGroup, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpConformance=lldpConformance, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, PYSNMP_MODULE_ID=lldpMIB, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpStatistics=lldpStatistics, LldpPortIdSubtype=LldpPortIdSubtype, lldpNotifications=lldpNotifications, lldpExtensions=lldpExtensions, lldpRemEntry=lldpRemEntry, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpRemTimeMark=lldpRemTimeMark, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocPortId=lldpLocPortId, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemSysName=lldpRemSysName, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpPortConfigTable=lldpPortConfigTable, lldpRemTablesChange=lldpRemTablesChange, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpCompliance=lldpCompliance, lldpMIB=lldpMIB, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpLocPortDesc=lldpLocPortDesc, lldpLocPortNum=lldpLocPortNum, lldpConfigGroup=lldpConfigGroup, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocChassisId=lldpLocChassisId, lldpRemPortId=lldpRemPortId, lldpLocSysGroup=lldpLocSysGroup, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocManAddrSubtype=lldpLocManAddrSubtype, LldpPortList=LldpPortList, lldpConfiguration=lldpConfiguration, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpConfigManAddrTable=lldpConfigManAddrTable, LldpPortId=LldpPortId, lldpGroups=lldpGroups, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemManAddr=lldpRemManAddr, lldpLocSysCapSupported=lldpLocSysCapSupported, LldpManAddress=LldpManAddress, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocPortEntry=lldpLocPortEntry, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocPortTable=lldpLocPortTable, lldpConfigTxGroup=lldpConfigTxGroup, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocManAddr=lldpLocManAddr, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocalSystemData=lldpLocalSystemData, lldpLocSysName=lldpLocSysName, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemIndex=lldpRemIndex, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocSysDesc=lldpLocSysDesc, lldpNotificationInterval=lldpNotificationInterval, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpCompliances=lldpCompliances, lldpObjects=lldpObjects, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocManAddrEntry=lldpLocManAddrEntry)
