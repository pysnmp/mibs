...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemPortDesc=lldpRemPortDesc, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpConfigGroup=lldpConfigGroup, lldpLocManAddrOID=lldpLocManAddrOID, PYSNMP_MODULE_ID=lldpMIB, lldpRemManAddr=lldpRemManAddr, lldpRemPortId=lldpRemPortId, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxGroup=lldpStatsRxGroup, lldpReinitDelay=lldpReinitDelay, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocalSystemData=lldpLocalSystemData, lldpExtensions=lldpExtensions, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpObjects=lldpObjects, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocSysName=lldpLocSysName, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpConformance=lldpConformance, lldpRemChassisId=lldpRemChassisId, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemSysGroup=lldpRemSysGroup, lldpGroups=lldpGroups, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocManAddr=lldpLocManAddr, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortNum=lldpLocPortNum, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocChassisId=lldpLocChassisId, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpCompliance=lldpCompliance, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpLocSysGroup=lldpLocSysGroup, lldpLocPortEntry=lldpLocPortEntry, lldpConfigManAddrTable=lldpConfigManAddrTable, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpCompliances=lldpCompliances, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemoteSystemsData=lldpRemoteSystemsData, LldpPortList=LldpPortList, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpNotificationInterval=lldpNotificationInterval, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpConfiguration=lldpConfiguration, lldpLocPortTable=lldpLocPortTable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpNotifications=lldpNotifications, lldpTxDelay=lldpTxDelay, lldpStatsRxPortNum=lldpStatsRxPortNum, LldpManAddress=LldpManAddress, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocPortDesc=lldpLocPortDesc, lldpRemTimeMark=lldpRemTimeMark, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocPortId=lldpLocPortId, lldpRemTable=lldpRemTable, lldpMessageTxInterval=lldpMessageTxInterval, lldpPortConfigTable=lldpPortConfigTable, lldpRemIndex=lldpRemIndex, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemSysDesc=lldpRemSysDesc, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemSysCapSupported=lldpRemSysCapSupported, LldpPortIdSubtype=LldpPortIdSubtype, LldpPortNumber=LldpPortNumber, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpChassisId=LldpChassisId, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemEntry=lldpRemEntry, LldpPortId=LldpPortId, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemSysName=lldpRemSysName, lldpMIB=lldpMIB, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpStatistics=lldpStatistics, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocSysDesc=lldpLocSysDesc, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex)
