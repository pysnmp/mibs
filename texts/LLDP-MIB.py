...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocManAddrOID=lldpLocManAddrOID, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemManAddrOID=lldpRemManAddrOID, lldpNotificationPrefix=lldpNotificationPrefix, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocManAddr=lldpLocManAddr, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemTablesChange=lldpRemTablesChange, lldpObjects=lldpObjects, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpGroups=lldpGroups, lldpRemSysName=lldpRemSysName, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotifications=lldpNotifications, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortNum=lldpLocPortNum, lldpLocPortId=lldpLocPortId, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocSysDesc=lldpLocSysDesc, LldpPortNumber=LldpPortNumber, lldpMIB=lldpMIB, LldpManAddress=LldpManAddress, lldpRemPortId=lldpRemPortId, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemIndex=lldpRemIndex, lldpConfigTxGroup=lldpConfigTxGroup, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocPortEntry=lldpLocPortEntry, lldpExtensions=lldpExtensions, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemManAddrTable=lldpRemManAddrTable, lldpConfiguration=lldpConfiguration, lldpLocSysGroup=lldpLocSysGroup, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocPortDesc=lldpLocPortDesc, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, PYSNMP_MODULE_ID=lldpMIB, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemEntry=lldpRemEntry, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocChassisId=lldpLocChassisId, lldpConfigRxGroup=lldpConfigRxGroup, lldpReinitDelay=lldpReinitDelay, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpLocalSystemData=lldpLocalSystemData, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocSysName=lldpLocSysName, lldpLocManAddrEntry=lldpLocManAddrEntry, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemManAddr=lldpRemManAddr, lldpCompliance=lldpCompliance, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConformance=lldpConformance, lldpRemChassisId=lldpRemChassisId, lldpNotificationsGroup=lldpNotificationsGroup, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, LldpPortList=LldpPortList, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpNotificationInterval=lldpNotificationInterval, LldpPortId=LldpPortId, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpPortConfigTable=lldpPortConfigTable, LldpChassisId=LldpChassisId, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemSysDesc=lldpRemSysDesc, lldpTxDelay=lldpTxDelay, lldpLocPortTable=lldpLocPortTable, lldpRemPortDesc=lldpRemPortDesc, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpConfigGroup=lldpConfigGroup, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemTable=lldpRemTable, lldpStatistics=lldpStatistics, lldpCompliances=lldpCompliances)
