...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpObjects=lldpObjects, lldpPortConfigTable=lldpPortConfigTable, LldpPortNumber=LldpPortNumber, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpConfigGroup=lldpConfigGroup, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpConfiguration=lldpConfiguration, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpLocPortId=lldpLocPortId, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpPortIdSubtype=LldpPortIdSubtype, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpGroups=lldpGroups, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpTxDelay=lldpTxDelay, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemTablesChange=lldpRemTablesChange, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpReinitDelay=lldpReinitDelay, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpCompliances=lldpCompliances, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemEntry=lldpRemEntry, PYSNMP_MODULE_ID=lldpMIB, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemTimeMark=lldpRemTimeMark, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocPortNum=lldpLocPortNum, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemPortDesc=lldpRemPortDesc, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpConformance=lldpConformance, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemTable=lldpRemTable, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, LldpPortId=LldpPortId, lldpMIB=lldpMIB, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpCompliance=lldpCompliance, lldpNotificationInterval=lldpNotificationInterval, lldpRemManAddr=lldpRemManAddr, lldpLocalSystemData=lldpLocalSystemData, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocSysDesc=lldpLocSysDesc, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpLocSysGroup=lldpLocSysGroup, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsTxPortTable=lldpStatsTxPortTable, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemManAddrOID=lldpRemManAddrOID, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocPortEntry=lldpLocPortEntry, lldpExtensions=lldpExtensions, lldpLocChassisId=lldpLocChassisId, lldpLocSysName=lldpLocSysName, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocManAddr=lldpLocManAddr, LldpChassisId=LldpChassisId, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemSysDesc=lldpRemSysDesc, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemSysName=lldpRemSysName, lldpRemSysGroup=lldpRemSysGroup, LldpPortList=LldpPortList, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemIndex=lldpRemIndex, lldpNotifications=lldpNotifications, lldpMessageTxInterval=lldpMessageTxInterval, lldpConfigManAddrEntry=lldpConfigManAddrEntry, LldpManAddress=LldpManAddress, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocPortTable=lldpLocPortTable, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocPortDesc=lldpLocPortDesc, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemChassisId=lldpRemChassisId, lldpStatistics=lldpStatistics, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemPortId=lldpRemPortId)
