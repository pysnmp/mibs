...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsTxGroup=lldpStatsTxGroup, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocPortEntry=lldpLocPortEntry, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemSysGroup=lldpRemSysGroup, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpExtensions=lldpExtensions, lldpCompliances=lldpCompliances, lldpRemTable=lldpRemTable, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatistics=lldpStatistics, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocalSystemData=lldpLocalSystemData, PYSNMP_MODULE_ID=lldpMIB, lldpNotificationPrefix=lldpNotificationPrefix, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpNotifications=lldpNotifications, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocPortNum=lldpLocPortNum, lldpGroups=lldpGroups, lldpRemIndex=lldpRemIndex, lldpConfiguration=lldpConfiguration, lldpConfigGroup=lldpConfigGroup, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpNotificationInterval=lldpNotificationInterval, lldpRemTablesChange=lldpRemTablesChange, lldpLocChassisId=lldpLocChassisId, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemSysName=lldpRemSysName, LldpPortIdSubtype=LldpPortIdSubtype, lldpLocPortTable=lldpLocPortTable, lldpRemChassisId=lldpRemChassisId, lldpObjects=lldpObjects, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocPortId=lldpLocPortId, lldpPortConfigTable=lldpPortConfigTable, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpMIB=lldpMIB, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, LldpPortList=LldpPortList, lldpReinitDelay=lldpReinitDelay, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, LldpChassisIdSubtype=LldpChassisIdSubtype, LldpManAddress=LldpManAddress, lldpRemManAddr=lldpRemManAddr, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocSysName=lldpLocSysName, lldpRemPortDesc=lldpRemPortDesc, lldpLocSysGroup=lldpLocSysGroup, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemManAddrTable=lldpRemManAddrTable, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemPortId=lldpRemPortId, lldpLocManAddr=lldpLocManAddr, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemEntry=lldpRemEntry, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemSysDesc=lldpRemSysDesc, LldpPortId=LldpPortId, lldpConformance=lldpConformance, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocManAddrOID=lldpLocManAddrOID, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpCompliance=lldpCompliance, LldpChassisId=LldpChassisId, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, LldpPortNumber=LldpPortNumber, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpTxDelay=lldpTxDelay, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype)
