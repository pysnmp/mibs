...
mibBuilder.exportSymbols("LLDP-MIB", lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemPortDesc=lldpRemPortDesc, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemManAddrOID=lldpRemManAddrOID, lldpNotifications=lldpNotifications, LldpPortId=LldpPortId, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpConformance=lldpConformance, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemSysDesc=lldpRemSysDesc, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpLocSysName=lldpLocSysName, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, LldpPortIdSubtype=LldpPortIdSubtype, lldpPortConfigTable=lldpPortConfigTable, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocSysGroup=lldpLocSysGroup, lldpRemIndex=lldpRemIndex, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpObjects=lldpObjects, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddrTable=lldpRemManAddrTable, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpCompliances=lldpCompliances, lldpCompliance=lldpCompliance, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemTablesChange=lldpRemTablesChange, lldpConfigGroup=lldpConfigGroup, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocChassisId=lldpLocChassisId, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemSysName=lldpRemSysName, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemPortId=lldpRemPortId, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocalSystemData=lldpLocalSystemData, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxPortEntry=lldpStatsRxPortEntry, PYSNMP_MODULE_ID=lldpMIB, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpLocPortEntry=lldpLocPortEntry, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpNotificationInterval=lldpNotificationInterval, lldpMessageTxInterval=lldpMessageTxInterval, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemEntry=lldpRemEntry, lldpTxDelay=lldpTxDelay, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpExtensions=lldpExtensions, LldpChassisId=LldpChassisId, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatistics=lldpStatistics, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpManAddress=LldpManAddress, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemTable=lldpRemTable, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpMIB=lldpMIB, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocPortId=lldpLocPortId, lldpLocSysDesc=lldpLocSysDesc, lldpLocPortTable=lldpLocPortTable, lldpLocPortDesc=lldpLocPortDesc, lldpRemManAddr=lldpRemManAddr, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpLocPortNum=lldpLocPortNum, lldpRemoteSystemsData=lldpRemoteSystemsData, LldpChassisIdSubtype=LldpChassisIdSubtype, LldpPortNumber=LldpPortNumber, lldpGroups=lldpGroups, LldpPortList=LldpPortList, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpReinitDelay=lldpReinitDelay, lldpConfiguration=lldpConfiguration, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemSysGroup=lldpRemSysGroup, lldpLocManAddrOID=lldpLocManAddrOID, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemChassisId=lldpRemChassisId, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemUnknownTLVType=lldpRemUnknownTLVType)
