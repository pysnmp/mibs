...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsTxGroup=lldpStatsTxGroup, lldpReinitDelay=lldpReinitDelay, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocPortEntry=lldpLocPortEntry, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpCompliances=lldpCompliances, lldpPortConfigTable=lldpPortConfigTable, lldpStatistics=lldpStatistics, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemIndex=lldpRemIndex, lldpNotificationInterval=lldpNotificationInterval, lldpNotificationPrefix=lldpNotificationPrefix, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpCompliance=lldpCompliance, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatsRxGroup=lldpStatsRxGroup, lldpConfigGroup=lldpConfigGroup, lldpLocSysName=lldpLocSysName, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpGroups=lldpGroups, lldpLocSysGroup=lldpLocSysGroup, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpPortConfigPortNum=lldpPortConfigPortNum, LldpPortNumber=LldpPortNumber, lldpNotificationsGroup=lldpNotificationsGroup, lldpConformance=lldpConformance, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocManAddrEntry=lldpLocManAddrEntry, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemPortId=lldpRemPortId, lldpRemTable=lldpRemTable, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocPortTable=lldpLocPortTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemTimeMark=lldpRemTimeMark, lldpLocManAddrIfId=lldpLocManAddrIfId, LldpPortList=LldpPortList, lldpPortConfigEntry=lldpPortConfigEntry, lldpTxDelay=lldpTxDelay, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpObjects=lldpObjects, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemSysCapEnabled=lldpRemSysCapEnabled, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocChassisId=lldpLocChassisId, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocPortNum=lldpLocPortNum, lldpMIB=lldpMIB, lldpExtensions=lldpExtensions, LldpManAddress=LldpManAddress, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, LldpChassisId=LldpChassisId, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemSysName=lldpRemSysName, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsTxPortEntry=lldpStatsTxPortEntry, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocPortId=lldpLocPortId, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemManAddrOID=lldpRemManAddrOID, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocPortDesc=lldpLocPortDesc, lldpLocSysDesc=lldpLocSysDesc, lldpLocalSystemData=lldpLocalSystemData, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemEntry=lldpRemEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpPortId=LldpPortId, lldpRemPortDesc=lldpRemPortDesc, PYSNMP_MODULE_ID=lldpMIB, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemChassisId=lldpRemChassisId, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemSysGroup=lldpRemSysGroup, lldpNotifications=lldpNotifications, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemTablesChange=lldpRemTablesChange, lldpRemManAddr=lldpRemManAddr, lldpRemSysDesc=lldpRemSysDesc, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfiguration=lldpConfiguration, lldpMessageTxInterval=lldpMessageTxInterval)
