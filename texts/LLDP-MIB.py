...
mibBuilder.exportSymbols("LLDP-MIB", LldpManAddress=LldpManAddress, lldpPortConfigTable=lldpPortConfigTable, lldpRemIndex=lldpRemIndex, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpLocPortDesc=lldpLocPortDesc, lldpObjects=lldpObjects, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocManAddrTable=lldpLocManAddrTable, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpNotificationsGroup=lldpNotificationsGroup, LldpPortList=LldpPortList, lldpLocPortEntry=lldpLocPortEntry, lldpRemChassisId=lldpRemChassisId, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocPortTable=lldpLocPortTable, lldpRemSysDesc=lldpRemSysDesc, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpReinitDelay=lldpReinitDelay, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemManAddrTable=lldpRemManAddrTable, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemLocalPortNum=lldpRemLocalPortNum, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpLocManAddr=lldpLocManAddr, lldpRemSysName=lldpRemSysName, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocSysGroup=lldpLocSysGroup, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpLocChassisId=lldpLocChassisId, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocManAddrOID=lldpLocManAddrOID, lldpNotificationInterval=lldpNotificationInterval, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocPortId=lldpLocPortId, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemManAddr=lldpRemManAddr, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpExtensions=lldpExtensions, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpConfigGroup=lldpConfigGroup, lldpLocSysName=lldpLocSysName, lldpConfiguration=lldpConfiguration, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpGroups=lldpGroups, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatistics=lldpStatistics, lldpLocPortNum=lldpLocPortNum, lldpNotificationPrefix=lldpNotificationPrefix, PYSNMP_MODULE_ID=lldpMIB, lldpRemSysGroup=lldpRemSysGroup, lldpConfigRxGroup=lldpConfigRxGroup, lldpNotifications=lldpNotifications, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemPortId=lldpRemPortId, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, LldpPortIdSubtype=LldpPortIdSubtype, lldpTxDelay=lldpTxDelay, lldpConformance=lldpConformance, lldpLocalSystemData=lldpLocalSystemData, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, LldpPortNumber=LldpPortNumber, LldpPortId=LldpPortId, lldpConfigTxGroup=lldpConfigTxGroup, lldpCompliance=lldpCompliance, lldpMIB=lldpMIB, LldpChassisId=LldpChassisId, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpCompliances=lldpCompliances, lldpRemTable=lldpRemTable, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemEntry=lldpRemEntry, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsTxPortEntry=lldpStatsTxPortEntry)
