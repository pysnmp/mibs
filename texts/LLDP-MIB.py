...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocManAddr=lldpLocManAddr, lldpRemTable=lldpRemTable, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpConformance=lldpConformance, lldpRemChassisId=lldpRemChassisId, lldpExtensions=lldpExtensions, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, LldpChassisId=LldpChassisId, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpNotificationsGroup=lldpNotificationsGroup, PYSNMP_MODULE_ID=lldpMIB, lldpStatsRxPortNum=lldpStatsRxPortNum, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpReinitDelay=lldpReinitDelay, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemIndex=lldpRemIndex, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemTablesChange=lldpRemTablesChange, lldpLocPortDesc=lldpLocPortDesc, lldpStatistics=lldpStatistics, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpConfigGroup=lldpConfigGroup, lldpNotificationInterval=lldpNotificationInterval, lldpLocPortNum=lldpLocPortNum, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemTimeMark=lldpRemTimeMark, lldpMIB=lldpMIB, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocChassisId=lldpLocChassisId, lldpTxDelay=lldpTxDelay, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocPortEntry=lldpLocPortEntry, lldpRemSysDesc=lldpRemSysDesc, lldpRemSysName=lldpRemSysName, lldpCompliances=lldpCompliances, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpCompliance=lldpCompliance, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocalSystemData=lldpLocalSystemData, lldpMessageTxInterval=lldpMessageTxInterval, LldpPortNumber=LldpPortNumber, lldpLocSysGroup=lldpLocSysGroup, lldpNotifications=lldpNotifications, LldpPortId=LldpPortId, lldpConfiguration=lldpConfiguration, lldpRemoteSystemsData=lldpRemoteSystemsData, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocSysName=lldpLocSysName, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysGroup=lldpRemSysGroup, LldpPortList=LldpPortList, lldpRemEntry=lldpRemEntry, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpPortConfigTable=lldpPortConfigTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpLocSysDesc=lldpLocSysDesc, lldpObjects=lldpObjects, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsRxGroup=lldpStatsRxGroup, LldpManAddress=LldpManAddress, lldpLocManAddrTable=lldpLocManAddrTable, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocPortId=lldpLocPortId, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocPortTable=lldpLocPortTable, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpGroups=lldpGroups, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocManAddrOID=lldpLocManAddrOID, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemPortId=lldpRemPortId, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemPortDesc=lldpRemPortDesc, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemManAddr=lldpRemManAddr, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocManAddrLen=lldpLocManAddrLen, lldpNotificationPrefix=lldpNotificationPrefix)
