...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemPortId=lldpRemPortId, LldpPortNumber=LldpPortNumber, lldpConformance=lldpConformance, lldpLocPortId=lldpLocPortId, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpLocPortNum=lldpLocPortNum, lldpRemTimeMark=lldpRemTimeMark, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsRxGroup=lldpStatsRxGroup, LldpPortIdSubtype=LldpPortIdSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpLocalSystemData=lldpLocalSystemData, PYSNMP_MODULE_ID=lldpMIB, lldpCompliances=lldpCompliances, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemManAddr=lldpRemManAddr, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpTxDelay=lldpTxDelay, lldpMIB=lldpMIB, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemSysDesc=lldpRemSysDesc, lldpRemSysGroup=lldpRemSysGroup, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemSysName=lldpRemSysName, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemIndex=lldpRemIndex, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocChassisId=lldpLocChassisId, lldpLocManAddrOID=lldpLocManAddrOID, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpObjects=lldpObjects, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysGroup=lldpLocSysGroup, lldpLocPortTable=lldpLocPortTable, lldpRemChassisId=lldpRemChassisId, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemEntry=lldpRemEntry, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpConfigGroup=lldpConfigGroup, LldpChassisId=LldpChassisId, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpCompliance=lldpCompliance, lldpRemTablesChange=lldpRemTablesChange, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpConfigTxGroup=lldpConfigTxGroup, lldpGroups=lldpGroups, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemPortDesc=lldpRemPortDesc, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRxPortNum=lldpStatsRxPortNum, LldpPortId=LldpPortId, lldpStatistics=lldpStatistics, lldpLocManAddr=lldpLocManAddr, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocPortEntry=lldpLocPortEntry, lldpLocSysName=lldpLocSysName, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpReinitDelay=lldpReinitDelay, lldpLocSysDesc=lldpLocSysDesc, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpManAddress=LldpManAddress, LldpPortList=LldpPortList, lldpExtensions=lldpExtensions, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpPortConfigTable=lldpPortConfigTable, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemTable=lldpRemTable, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpNotifications=lldpNotifications, lldpConfiguration=lldpConfiguration, lldpNotificationInterval=lldpNotificationInterval)
