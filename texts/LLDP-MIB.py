...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpNotificationsGroup=lldpNotificationsGroup, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemTimeMark=lldpRemTimeMark, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocPortEntry=lldpLocPortEntry, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpGroups=lldpGroups, lldpLocPortId=lldpLocPortId, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpTxDelay=lldpTxDelay, lldpRemIndex=lldpRemIndex, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemSysDesc=lldpRemSysDesc, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpConfigGroup=lldpConfigGroup, lldpObjects=lldpObjects, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, LldpPortNumber=LldpPortNumber, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemTable=lldpRemTable, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpLocManAddr=lldpLocManAddr, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocPortNum=lldpLocPortNum, lldpStatistics=lldpStatistics, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemSysName=lldpRemSysName, PYSNMP_MODULE_ID=lldpMIB, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpNotificationInterval=lldpNotificationInterval, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemPortId=lldpRemPortId, lldpExtensions=lldpExtensions, LldpPortId=LldpPortId, lldpRemEntry=lldpRemEntry, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocChassisId=lldpLocChassisId, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpMIB=lldpMIB, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocalSystemData=lldpLocalSystemData, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpNotifications=lldpNotifications, LldpChassisId=LldpChassisId, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemManAddr=lldpRemManAddr, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpCompliance=lldpCompliance, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocManAddrTable=lldpLocManAddrTable, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocPortDesc=lldpLocPortDesc, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpLocSysGroup=lldpLocSysGroup, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpConfiguration=lldpConfiguration, LldpPortList=LldpPortList, lldpStatsTxGroup=lldpStatsTxGroup, lldpCompliances=lldpCompliances, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemChassisId=lldpRemChassisId, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocPortTable=lldpLocPortTable, lldpRemManAddrTable=lldpRemManAddrTable, lldpReinitDelay=lldpReinitDelay, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemPortDesc=lldpRemPortDesc, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, LldpManAddress=LldpManAddress, lldpRemSysGroup=lldpRemSysGroup, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpConformance=lldpConformance, lldpLocSysDesc=lldpLocSysDesc, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpMessageTxInterval=lldpMessageTxInterval, lldpPortConfigTable=lldpPortConfigTable, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpLocSysName=lldpLocSysName)
