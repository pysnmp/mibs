...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemPortId=lldpRemPortId, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsTxPortTable=lldpStatsTxPortTable, LldpManAddress=LldpManAddress, lldpMIB=lldpMIB, lldpStatsTxGroup=lldpStatsTxGroup, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsTxPortNum=lldpStatsTxPortNum, LldpPortNumber=LldpPortNumber, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemTablesChange=lldpRemTablesChange, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocSysGroup=lldpLocSysGroup, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemSysName=lldpRemSysName, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemChassisId=lldpRemChassisId, lldpLocalSystemData=lldpLocalSystemData, lldpCompliances=lldpCompliances, lldpStatistics=lldpStatistics, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpObjects=lldpObjects, LldpPortList=LldpPortList, lldpLocSysName=lldpLocSysName, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocPortTable=lldpLocPortTable, lldpLocChassisId=lldpLocChassisId, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocPortId=lldpLocPortId, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocPortNum=lldpLocPortNum, lldpTxDelay=lldpTxDelay, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemIndex=lldpRemIndex, lldpLocPortEntry=lldpLocPortEntry, lldpRemSysGroup=lldpRemSysGroup, lldpRemEntry=lldpRemEntry, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemTimeMark=lldpRemTimeMark, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfigGroup=lldpConfigGroup, lldpReinitDelay=lldpReinitDelay, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemPortDesc=lldpRemPortDesc, lldpNotifications=lldpNotifications, lldpExtensions=lldpExtensions, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpGroups=lldpGroups, lldpConformance=lldpConformance, lldpPortConfigTable=lldpPortConfigTable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpNotificationsGroup=lldpNotificationsGroup, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConfiguration=lldpConfiguration, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, LldpChassisId=LldpChassisId, lldpLocPortDesc=lldpLocPortDesc, LldpPortId=LldpPortId, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocManAddrTable=lldpLocManAddrTable, lldpNotificationInterval=lldpNotificationInterval, PYSNMP_MODULE_ID=lldpMIB, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemSysDesc=lldpRemSysDesc, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocManAddr=lldpLocManAddr, lldpCompliance=lldpCompliance, lldpLocSysDesc=lldpLocSysDesc, lldpRemTable=lldpRemTable, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemManAddr=lldpRemManAddr, lldpLocManAddrSubtype=lldpLocManAddrSubtype)
