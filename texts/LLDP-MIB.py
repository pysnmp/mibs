...
mibBuilder.exportSymbols("LLDP-MIB", LldpChassisIdSubtype=LldpChassisIdSubtype, LldpPortNumber=LldpPortNumber, lldpRemPortDesc=lldpRemPortDesc, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpObjects=lldpObjects, PYSNMP_MODULE_ID=lldpMIB, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocPortDesc=lldpLocPortDesc, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocalSystemData=lldpLocalSystemData, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemSysCapSupported=lldpRemSysCapSupported, LldpPortId=LldpPortId, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocPortNum=lldpLocPortNum, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocSysDesc=lldpLocSysDesc, lldpRemSysName=lldpRemSysName, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemSysGroup=lldpRemSysGroup, LldpPortList=LldpPortList, lldpNotifications=lldpNotifications, lldpLocManAddr=lldpLocManAddr, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemSysDesc=lldpRemSysDesc, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocPortTable=lldpLocPortTable, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpCompliances=lldpCompliances, lldpStatistics=lldpStatistics, lldpLocSysGroup=lldpLocSysGroup, lldpConformance=lldpConformance, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemManAddr=lldpRemManAddr, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemEntry=lldpRemEntry, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemIndex=lldpRemIndex, lldpTxDelay=lldpTxDelay, lldpPortConfigEntry=lldpPortConfigEntry, lldpExtensions=lldpExtensions, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpPortConfigTable=lldpPortConfigTable, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocSysName=lldpLocSysName, LldpManAddress=LldpManAddress, lldpLocManAddrTable=lldpLocManAddrTable, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpConfiguration=lldpConfiguration, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocChassisId=lldpLocChassisId, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemChassisId=lldpRemChassisId, lldpNotificationPrefix=lldpNotificationPrefix, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpCompliance=lldpCompliance, lldpLocPortId=lldpLocPortId, lldpNotificationInterval=lldpNotificationInterval, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpMIB=lldpMIB, lldpRemTimeMark=lldpRemTimeMark, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddrOID=lldpLocManAddrOID, lldpReinitDelay=lldpReinitDelay, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpStatsRxGroup=lldpStatsRxGroup, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemTable=lldpRemTable, lldpGroups=lldpGroups, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemPortId=lldpRemPortId, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemTablesChange=lldpRemTablesChange, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigGroup=lldpConfigGroup, LldpChassisId=LldpChassisId)
