...
mibBuilder.exportSymbols("LLDP-MIB", PYSNMP_MODULE_ID=lldpMIB, lldpLocPortId=lldpLocPortId, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpStatsRxGroup=lldpStatsRxGroup, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpPortConfigTable=lldpPortConfigTable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrOID=lldpLocManAddrOID, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocManAddrLen=lldpLocManAddrLen, lldpCompliances=lldpCompliances, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysName=lldpLocSysName, lldpObjects=lldpObjects, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, LldpManAddress=LldpManAddress, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemPortId=lldpRemPortId, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemTimeMark=lldpRemTimeMark, lldpExtensions=lldpExtensions, lldpLocSysGroup=lldpLocSysGroup, lldpReinitDelay=lldpReinitDelay, lldpLocChassisId=lldpLocChassisId, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpLocPortNum=lldpLocPortNum, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, LldpPortId=LldpPortId, lldpRemManAddr=lldpRemManAddr, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpConformance=lldpConformance, lldpLocSysDesc=lldpLocSysDesc, lldpRemTablesChange=lldpRemTablesChange, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemEntry=lldpRemEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsTxGroup=lldpStatsTxGroup, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, LldpPortNumber=LldpPortNumber, lldpNotifications=lldpNotifications, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpStatistics=lldpStatistics, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemPortDesc=lldpRemPortDesc, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpNotificationInterval=lldpNotificationInterval, lldpConfigGroup=lldpConfigGroup, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpMIB=lldpMIB, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocManAddr=lldpLocManAddr, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpNotificationsGroup=lldpNotificationsGroup, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, LldpChassisId=LldpChassisId, lldpRemChassisId=lldpRemChassisId, LldpPortList=LldpPortList, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocPortTable=lldpLocPortTable, lldpConfiguration=lldpConfiguration, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemManAddrTable=lldpRemManAddrTable, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemIndex=lldpRemIndex, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemSysName=lldpRemSysName, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemSysDesc=lldpRemSysDesc, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemSysGroup=lldpRemSysGroup, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpGroups=lldpGroups, lldpLocPortDesc=lldpLocPortDesc, lldpCompliance=lldpCompliance, lldpLocalSystemData=lldpLocalSystemData, lldpRemTable=lldpRemTable, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpTxDelay=lldpTxDelay)
