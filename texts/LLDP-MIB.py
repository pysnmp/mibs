...
mibBuilder.exportSymbols("LLDP-MIB", PYSNMP_MODULE_ID=lldpMIB, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemSysDesc=lldpRemSysDesc, lldpMIB=lldpMIB, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocPortId=lldpLocPortId, lldpRemTablesChange=lldpRemTablesChange, lldpLocSysDesc=lldpLocSysDesc, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocPortNum=lldpLocPortNum, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocalSystemData=lldpLocalSystemData, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpNotificationInterval=lldpNotificationInterval, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemIndex=lldpRemIndex, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpObjects=lldpObjects, lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpReinitDelay=lldpReinitDelay, LldpPortId=LldpPortId, lldpConfiguration=lldpConfiguration, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemSysName=lldpRemSysName, LldpPortList=LldpPortList, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocSysCapSupported=lldpLocSysCapSupported, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpStatistics=lldpStatistics, lldpPortConfigPortNum=lldpPortConfigPortNum, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemEntry=lldpRemEntry, lldpRemChassisId=lldpRemChassisId, lldpPortConfigEntry=lldpPortConfigEntry, lldpCompliances=lldpCompliances, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemPortId=lldpRemPortId, LldpManAddress=LldpManAddress, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpConfigTxGroup=lldpConfigTxGroup, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocPortTable=lldpLocPortTable, lldpLocPortEntry=lldpLocPortEntry, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemTable=lldpRemTable, lldpGroups=lldpGroups, lldpLocManAddr=lldpLocManAddr, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpChassisId=LldpChassisId, lldpRemSysGroup=lldpRemSysGroup, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemPortDesc=lldpRemPortDesc, lldpRemManAddr=lldpRemManAddr, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocManAddrOID=lldpLocManAddrOID, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysGroup=lldpLocSysGroup, lldpCompliance=lldpCompliance, lldpConfigGroup=lldpConfigGroup, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpPortConfigTable=lldpPortConfigTable, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocChassisId=lldpLocChassisId, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, LldpPortNumber=LldpPortNumber, lldpNotifications=lldpNotifications, lldpTxDelay=lldpTxDelay, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpConformance=lldpConformance, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpExtensions=lldpExtensions, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocSysName=lldpLocSysName, lldpRemManAddrTable=lldpRemManAddrTable)
