...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsTxGroup=lldpStatsTxGroup, lldpNotifications=lldpNotifications, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemIndex=lldpRemIndex, lldpGroups=lldpGroups, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatistics=lldpStatistics, LldpManAddress=LldpManAddress, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemSysGroup=lldpRemSysGroup, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocPortDesc=lldpLocPortDesc, lldpRemTimeMark=lldpRemTimeMark, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxGroup=lldpStatsRxGroup, lldpConformance=lldpConformance, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpCompliance=lldpCompliance, lldpLocSysName=lldpLocSysName, lldpRemPortDesc=lldpRemPortDesc, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpReinitDelay=lldpReinitDelay, lldpRemChassisId=lldpRemChassisId, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpCompliances=lldpCompliances, lldpConfigGroup=lldpConfigGroup, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpNotificationInterval=lldpNotificationInterval, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocPortTable=lldpLocPortTable, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemSysName=lldpRemSysName, lldpObjects=lldpObjects, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocManAddrOID=lldpLocManAddrOID, LldpPortList=LldpPortList, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpTxDelay=lldpTxDelay, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddr=lldpRemManAddr, lldpPortConfigTable=lldpPortConfigTable, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocSysGroup=lldpLocSysGroup, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpExtensions=lldpExtensions, PYSNMP_MODULE_ID=lldpMIB, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocSysDesc=lldpLocSysDesc, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortNum=lldpLocPortNum, lldpLocChassisId=lldpLocChassisId, lldpConfigTxGroup=lldpConfigTxGroup, LldpPortIdSubtype=LldpPortIdSubtype, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemTable=lldpRemTable, LldpChassisId=LldpChassisId, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpConfiguration=lldpConfiguration, LldpPortNumber=LldpPortNumber, lldpRemEntry=lldpRemEntry, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpMIB=lldpMIB, LldpPortId=LldpPortId, lldpLocalSystemData=lldpLocalSystemData, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocPortId=lldpLocPortId, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemPortId=lldpRemPortId, lldpRemSysDesc=lldpRemSysDesc)
