...
mibBuilder.exportSymbols("LLDP-MIB", lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpConfigGroup=lldpConfigGroup, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemTable=lldpRemTable, lldpLocalSystemData=lldpLocalSystemData, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpGroups=lldpGroups, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpNotificationsGroup=lldpNotificationsGroup, LldpPortNumber=LldpPortNumber, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocPortTable=lldpLocPortTable, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpNotifications=lldpNotifications, LldpManAddress=LldpManAddress, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpConformance=lldpConformance, lldpTxDelay=lldpTxDelay, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpPortList=LldpPortList, lldpLocSysGroup=lldpLocSysGroup, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotificationInterval=lldpNotificationInterval, lldpStatsTxPortTable=lldpStatsTxPortTable, LldpChassisId=LldpChassisId, lldpCompliances=lldpCompliances, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocChassisId=lldpLocChassisId, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpExtensions=lldpExtensions, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocPortEntry=lldpLocPortEntry, lldpLocPortId=lldpLocPortId, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpLocSysName=lldpLocSysName, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpObjects=lldpObjects, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocPortNum=lldpLocPortNum, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpConfiguration=lldpConfiguration, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemIndex=lldpRemIndex, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpPortConfigTable=lldpPortConfigTable, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemTimeMark=lldpRemTimeMark, lldpReinitDelay=lldpReinitDelay, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemManAddr=lldpRemManAddr, lldpRemPortId=lldpRemPortId, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, LldpPortId=LldpPortId, PYSNMP_MODULE_ID=lldpMIB, lldpRemSysName=lldpRemSysName, lldpStatsRxGroup=lldpStatsRxGroup, lldpCompliance=lldpCompliance, lldpRemTablesChange=lldpRemTablesChange, lldpRemSysGroup=lldpRemSysGroup, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemChassisId=lldpRemChassisId, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortDesc=lldpLocPortDesc, lldpRemEntry=lldpRemEntry, lldpStatistics=lldpStatistics, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemSysDesc=lldpRemSysDesc, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpMIB=lldpMIB, lldpLocManAddrLen=lldpLocManAddrLen, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemManAddrOID=lldpRemManAddrOID, lldpPortConfigPortNum=lldpPortConfigPortNum)
