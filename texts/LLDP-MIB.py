...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocManAddrOID=lldpLocManAddrOID, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemTable=lldpRemTable, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocSysGroup=lldpLocSysGroup, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemPortId=lldpRemPortId, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocManAddr=lldpLocManAddr, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpCompliance=lldpCompliance, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemSysDesc=lldpRemSysDesc, lldpLocChassisId=lldpLocChassisId, lldpLocPortId=lldpLocPortId, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpObjects=lldpObjects, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpConfigGroup=lldpConfigGroup, lldpLocPortDesc=lldpLocPortDesc, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocSysName=lldpLocSysName, lldpRemManAddrTable=lldpRemManAddrTable, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpConfigTxGroup=lldpConfigTxGroup, lldpNotificationPrefix=lldpNotificationPrefix, lldpGroups=lldpGroups, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocalSystemData=lldpLocalSystemData, lldpLocManAddrLen=lldpLocManAddrLen, lldpConformance=lldpConformance, lldpLocPortEntry=lldpLocPortEntry, lldpLocSysDesc=lldpLocSysDesc, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemChassisId=lldpRemChassisId, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatistics=lldpStatistics, lldpRemIndex=lldpRemIndex, lldpMIB=lldpMIB, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpManAddress=LldpManAddress, lldpNotificationInterval=lldpNotificationInterval, lldpCompliances=lldpCompliances, lldpConfiguration=lldpConfiguration, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpPortConfigTable=lldpPortConfigTable, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpTxDelay=lldpTxDelay, lldpRemManAddr=lldpRemManAddr, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysName=lldpRemSysName, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpExtensions=lldpExtensions, lldpConfigManAddrEntry=lldpConfigManAddrEntry, PYSNMP_MODULE_ID=lldpMIB, lldpLocPortTable=lldpLocPortTable, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemEntry=lldpRemEntry, lldpReinitDelay=lldpReinitDelay, lldpLocPortNum=lldpLocPortNum, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemOrgDefInfo=lldpRemOrgDefInfo, LldpPortList=LldpPortList, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, LldpPortNumber=LldpPortNumber, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemTablesChange=lldpRemTablesChange, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpNotifications=lldpNotifications, lldpRemManAddrIfId=lldpRemManAddrIfId, LldpChassisId=LldpChassisId, lldpConfigRxGroup=lldpConfigRxGroup, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpPortId=LldpPortId, lldpRemPortDesc=lldpRemPortDesc, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpMessageTxInterval=lldpMessageTxInterval, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal)
