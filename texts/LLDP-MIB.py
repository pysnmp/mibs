...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocPortId=lldpLocPortId, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, LldpManAddress=LldpManAddress, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocManAddrLen=lldpLocManAddrLen, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemTablesChange=lldpRemTablesChange, lldpRemSysCapSupported=lldpRemSysCapSupported, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpConfiguration=lldpConfiguration, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemSysGroup=lldpRemSysGroup, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemTimeMark=lldpRemTimeMark, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpNotificationsGroup=lldpNotificationsGroup, PYSNMP_MODULE_ID=lldpMIB, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemEntry=lldpRemEntry, LldpPortId=LldpPortId, lldpRemPortId=lldpRemPortId, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpObjects=lldpObjects, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpTxDelay=lldpTxDelay, LldpPortList=LldpPortList, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpGroups=lldpGroups, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatistics=lldpStatistics, lldpPortConfigTable=lldpPortConfigTable, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocSysDesc=lldpLocSysDesc, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpConformance=lldpConformance, lldpRemSysDesc=lldpRemSysDesc, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocChassisId=lldpLocChassisId, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemTable=lldpRemTable, lldpRemManAddr=lldpRemManAddr, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocManAddr=lldpLocManAddr, lldpLocPortNum=lldpLocPortNum, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocPortDesc=lldpLocPortDesc, lldpRemSysName=lldpRemSysName, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocPortEntry=lldpLocPortEntry, lldpCompliance=lldpCompliance, LldpPortNumber=LldpPortNumber, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemPortDesc=lldpRemPortDesc, lldpNotifications=lldpNotifications, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemManAddrIfId=lldpRemManAddrIfId, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpLocSysGroup=lldpLocSysGroup, LldpChassisId=LldpChassisId, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocalSystemData=lldpLocalSystemData, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpNotificationInterval=lldpNotificationInterval, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocManAddrOID=lldpLocManAddrOID, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpReinitDelay=lldpReinitDelay, lldpLocPortTable=lldpLocPortTable, lldpRemIndex=lldpRemIndex, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfigGroup=lldpConfigGroup, lldpExtensions=lldpExtensions, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocSysName=lldpLocSysName, lldpRemChassisId=lldpRemChassisId, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpConfigRxGroup=lldpConfigRxGroup, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpCompliances=lldpCompliances, lldpMIB=lldpMIB)
