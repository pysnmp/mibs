...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemTable=lldpRemTable, lldpLocChassisId=lldpLocChassisId, lldpExtensions=lldpExtensions, lldpCompliances=lldpCompliances, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, LldpPortNumber=LldpPortNumber, lldpConfigManAddrEntry=lldpConfigManAddrEntry, LldpPortId=LldpPortId, lldpRemTimeMark=lldpRemTimeMark, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpConfiguration=lldpConfiguration, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocPortId=lldpLocPortId, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpConfigGroup=lldpConfigGroup, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpLocManAddrOID=lldpLocManAddrOID, lldpMessageTxInterval=lldpMessageTxInterval, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpPortConfigTable=lldpPortConfigTable, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemSysName=lldpRemSysName, lldpRemManAddr=lldpRemManAddr, lldpLocManAddr=lldpLocManAddr, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpObjects=lldpObjects, lldpLocPortTable=lldpLocPortTable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpCompliance=lldpCompliance, lldpLocSysDesc=lldpLocSysDesc, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemPortDesc=lldpRemPortDesc, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpTxDelay=lldpTxDelay, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocPortDesc=lldpLocPortDesc, lldpConformance=lldpConformance, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpNotificationInterval=lldpNotificationInterval, lldpRemPortId=lldpRemPortId, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocManAddrEntry=lldpLocManAddrEntry, PYSNMP_MODULE_ID=lldpMIB, lldpLocSysGroup=lldpLocSysGroup, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocPortIdSubtype=lldpLocPortIdSubtype, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemTablesChange=lldpRemTablesChange, LldpPortList=LldpPortList, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpConfigTxGroup=lldpConfigTxGroup, lldpPortConfigEntry=lldpPortConfigEntry, lldpNotifications=lldpNotifications, lldpLocSysName=lldpLocSysName, lldpRemManAddrTable=lldpRemManAddrTable, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemChassisId=lldpRemChassisId, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpReinitDelay=lldpReinitDelay, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemEntry=lldpRemEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpGroups=lldpGroups, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocPortNum=lldpLocPortNum, lldpRemIndex=lldpRemIndex, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysGroup=lldpRemSysGroup, lldpMIB=lldpMIB, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemSysDesc=lldpRemSysDesc, lldpRemManAddrOID=lldpRemManAddrOID, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocPortEntry=lldpLocPortEntry, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpStatistics=lldpStatistics, LldpChassisId=LldpChassisId, LldpManAddress=LldpManAddress, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocalSystemData=lldpLocalSystemData, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype)
