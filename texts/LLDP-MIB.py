...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemIndex=lldpRemIndex, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpNotificationInterval=lldpNotificationInterval, lldpRemPortId=lldpRemPortId, lldpLocPortEntry=lldpLocPortEntry, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemChassisId=lldpRemChassisId, LldpPortId=LldpPortId, lldpRemManAddrOID=lldpRemManAddrOID, lldpCompliances=lldpCompliances, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, LldpPortNumber=LldpPortNumber, lldpObjects=lldpObjects, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpCompliance=lldpCompliance, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, PYSNMP_MODULE_ID=lldpMIB, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpConfigGroup=lldpConfigGroup, lldpLocChassisId=lldpLocChassisId, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpPortConfigEntry=lldpPortConfigEntry, lldpMIB=lldpMIB, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpGroups=lldpGroups, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocManAddrLen=lldpLocManAddrLen, LldpPortIdSubtype=LldpPortIdSubtype, lldpLocPortNum=lldpLocPortNum, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpLocManAddrTable=lldpLocManAddrTable, lldpNotificationPrefix=lldpNotificationPrefix, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemSysDesc=lldpRemSysDesc, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfiguration=lldpConfiguration, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpLocSysDesc=lldpLocSysDesc, lldpLocSysGroup=lldpLocSysGroup, lldpRemTablesChange=lldpRemTablesChange, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddr=lldpRemManAddr, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocSysName=lldpLocSysName, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemPortDesc=lldpRemPortDesc, lldpLocPortId=lldpLocPortId, lldpReinitDelay=lldpReinitDelay, lldpLocPortTable=lldpLocPortTable, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocPortDesc=lldpLocPortDesc, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemTable=lldpRemTable, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemSysGroup=lldpRemSysGroup, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, LldpManAddress=LldpManAddress, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpTxDelay=lldpTxDelay, lldpLocalSystemData=lldpLocalSystemData, lldpRemTimeMark=lldpRemTimeMark, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpConformance=lldpConformance, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpNotifications=lldpNotifications, lldpMessageTxInterval=lldpMessageTxInterval, lldpExtensions=lldpExtensions, lldpConfigTxGroup=lldpConfigTxGroup, LldpPortList=LldpPortList, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxPortEntry=lldpStatsRxPortEntry, LldpChassisId=LldpChassisId, lldpRemSysName=lldpRemSysName, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatistics=lldpStatistics, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpPortConfigTable=lldpPortConfigTable, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemEntry=lldpRemEntry, lldpRemManAddrTable=lldpRemManAddrTable)
