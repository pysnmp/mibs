...
mibBuilder.exportSymbols("LLDP-MIB", lldpConfiguration=lldpConfiguration, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, LldpPortId=LldpPortId, lldpExtensions=lldpExtensions, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysDesc=lldpLocSysDesc, lldpRemSysDesc=lldpRemSysDesc, lldpRemIndex=lldpRemIndex, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocalSystemData=lldpLocalSystemData, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocManAddrLen=lldpLocManAddrLen, LldpPortList=LldpPortList, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemSysName=lldpRemSysName, lldpConfigGroup=lldpConfigGroup, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemPortId=lldpRemPortId, lldpRemEntry=lldpRemEntry, lldpLocPortTable=lldpLocPortTable, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpNotificationPrefix=lldpNotificationPrefix, lldpStatistics=lldpStatistics, lldpConfigTxGroup=lldpConfigTxGroup, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocPortId=lldpLocPortId, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemPortDesc=lldpRemPortDesc, lldpNotificationsGroup=lldpNotificationsGroup, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpReinitDelay=lldpReinitDelay, LldpPortIdSubtype=LldpPortIdSubtype, lldpMIB=lldpMIB, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpPortConfigTable=lldpPortConfigTable, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpPortNumber=LldpPortNumber, lldpRemManAddr=lldpRemManAddr, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemTimeMark=lldpRemTimeMark, lldpLocPortEntry=lldpLocPortEntry, lldpRemChassisId=lldpRemChassisId, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpGroups=lldpGroups, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpCompliances=lldpCompliances, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpCompliance=lldpCompliance, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemManAddrOID=lldpRemManAddrOID, PYSNMP_MODULE_ID=lldpMIB, LldpChassisId=LldpChassisId, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortDesc=lldpLocPortDesc, LldpManAddress=LldpManAddress, lldpLocSysName=lldpLocSysName, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocPortNum=lldpLocPortNum, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocSysGroup=lldpLocSysGroup, lldpRemTable=lldpRemTable, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocChassisId=lldpLocChassisId, lldpNotifications=lldpNotifications, lldpRemSysGroup=lldpRemSysGroup, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpTxDelay=lldpTxDelay, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpConformance=lldpConformance, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddr=lldpLocManAddr, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpObjects=lldpObjects, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpNotificationInterval=lldpNotificationInterval, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes)
