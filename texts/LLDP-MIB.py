...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpReinitDelay=lldpReinitDelay, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpObjects=lldpObjects, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemManAddr=lldpRemManAddr, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpConfigGroup=lldpConfigGroup, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemPortDesc=lldpRemPortDesc, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemPortId=lldpRemPortId, lldpNotificationPrefix=lldpNotificationPrefix, lldpGroups=lldpGroups, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemChassisId=lldpRemChassisId, lldpLocManAddrOID=lldpLocManAddrOID, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocSysName=lldpLocSysName, lldpLocPortNum=lldpLocPortNum, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocManAddr=lldpLocManAddr, lldpTxDelay=lldpTxDelay, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemTimeMark=lldpRemTimeMark, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocSysCapEnabled=lldpLocSysCapEnabled, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, LldpChassisId=LldpChassisId, lldpLocPortId=lldpLocPortId, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigTxGroup=lldpConfigTxGroup, LldpPortId=LldpPortId, lldpRemSysGroup=lldpRemSysGroup, lldpRemTable=lldpRemTable, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocalSystemData=lldpLocalSystemData, lldpStatistics=lldpStatistics, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocPortEntry=lldpLocPortEntry, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpConfiguration=lldpConfiguration, lldpLocSysGroup=lldpLocSysGroup, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpPortConfigTable=lldpPortConfigTable, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemManAddrOID=lldpRemManAddrOID, lldpCompliances=lldpCompliances, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemSysName=lldpRemSysName, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpMIB=lldpMIB, LldpManAddress=LldpManAddress, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpConformance=lldpConformance, lldpCompliance=lldpCompliance, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocPortTable=lldpLocPortTable, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemIndex=lldpRemIndex, PYSNMP_MODULE_ID=lldpMIB, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, LldpPortNumber=LldpPortNumber, lldpNotificationInterval=lldpNotificationInterval, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocSysDesc=lldpLocSysDesc, lldpLocChassisId=lldpLocChassisId, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemEntry=lldpRemEntry, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpRemSysDesc=lldpRemSysDesc, lldpRemLocalPortNum=lldpRemLocalPortNum, LldpPortList=LldpPortList, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemTablesChange=lldpRemTablesChange, lldpNotifications=lldpNotifications, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocPortDesc=lldpLocPortDesc, lldpExtensions=lldpExtensions)
