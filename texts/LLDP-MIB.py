...
mibBuilder.exportSymbols("LLDP-MIB", lldpReinitDelay=lldpReinitDelay, lldpStatsRxGroup=lldpStatsRxGroup, lldpCompliances=lldpCompliances, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemSysCapEnabled=lldpRemSysCapEnabled, LldpManAddrIfSubtype=LldpManAddrIfSubtype, LldpPortList=LldpPortList, lldpLocChassisId=lldpLocChassisId, lldpLocPortNum=lldpLocPortNum, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, PYSNMP_MODULE_ID=lldpMIB, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemSysGroup=lldpRemSysGroup, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemTablesChange=lldpRemTablesChange, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocalSystemData=lldpLocalSystemData, lldpRemPortId=lldpRemPortId, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpObjects=lldpObjects, lldpRemManAddrOID=lldpRemManAddrOID, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpStatsTxGroup=lldpStatsTxGroup, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemEntry=lldpRemEntry, LldpPortId=LldpPortId, LldpPortNumber=LldpPortNumber, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemChassisId=lldpRemChassisId, lldpTxDelay=lldpTxDelay, lldpLocManAddrLen=lldpLocManAddrLen, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpNotifications=lldpNotifications, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, LldpChassisId=LldpChassisId, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemTimeMark=lldpRemTimeMark, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatistics=lldpStatistics, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocSysName=lldpLocSysName, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocManAddrTable=lldpLocManAddrTable, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpExtensions=lldpExtensions, lldpRemSysName=lldpRemSysName, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpMIB=lldpMIB, lldpConfigGroup=lldpConfigGroup, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemSysDesc=lldpRemSysDesc, lldpConfiguration=lldpConfiguration, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemTable=lldpRemTable, LldpManAddress=LldpManAddress, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpConformance=lldpConformance, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocPortDesc=lldpLocPortDesc, lldpLocPortTable=lldpLocPortTable, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpPortConfigTable=lldpPortConfigTable, lldpLocManAddr=lldpLocManAddr, lldpNotificationInterval=lldpNotificationInterval, lldpRemIndex=lldpRemIndex, lldpCompliance=lldpCompliance, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocPortId=lldpLocPortId, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpMessageTxInterval=lldpMessageTxInterval, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocPortEntry=lldpLocPortEntry, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysGroup=lldpLocSysGroup, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemManAddr=lldpRemManAddr, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpGroups=lldpGroups, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal)
