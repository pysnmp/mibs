...
mibBuilder.exportSymbols("LLDP-MIB", lldpConfiguration=lldpConfiguration, lldpRemManAddrIfId=lldpRemManAddrIfId, LldpPortId=LldpPortId, lldpRemManAddr=lldpRemManAddr, lldpReinitDelay=lldpReinitDelay, lldpExtensions=lldpExtensions, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpRemManAddrOID=lldpRemManAddrOID, lldpNotifications=lldpNotifications, LldpManAddress=LldpManAddress, lldpRemSysName=lldpRemSysName, lldpMessageTxInterval=lldpMessageTxInterval, lldpCompliances=lldpCompliances, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemOrgDefInfo=lldpRemOrgDefInfo, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpTxDelay=lldpTxDelay, lldpLocPortId=lldpLocPortId, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpRemTimeMark=lldpRemTimeMark, lldpPortConfigEntry=lldpPortConfigEntry, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, PYSNMP_MODULE_ID=lldpMIB, lldpObjects=lldpObjects, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpPortConfigTable=lldpPortConfigTable, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpCompliance=lldpCompliance, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocSysName=lldpLocSysName, lldpRemSysGroup=lldpRemSysGroup, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpRemChassisId=lldpRemChassisId, lldpRemIndex=lldpRemIndex, lldpStatistics=lldpStatistics, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocSysGroup=lldpLocSysGroup, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocPortTable=lldpLocPortTable, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemManAddrTable=lldpRemManAddrTable, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpLocalSystemData=lldpLocalSystemData, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpLocPortNum=lldpLocPortNum, lldpNotificationsGroup=lldpNotificationsGroup, lldpRemEntry=lldpRemEntry, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocManAddrOID=lldpLocManAddrOID, LldpPortList=LldpPortList, lldpRemPortDesc=lldpRemPortDesc, lldpConformance=lldpConformance, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpLocManAddrLen=lldpLocManAddrLen, lldpConfigGroup=lldpConfigGroup, lldpRemTable=lldpRemTable, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpLocPortEntry=lldpLocPortEntry, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocSysDesc=lldpLocSysDesc, lldpLocChassisId=lldpLocChassisId, lldpRemPortId=lldpRemPortId, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpMIB=lldpMIB, LldpChassisId=LldpChassisId, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpNotificationPrefix=lldpNotificationPrefix, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigRxGroup=lldpConfigRxGroup, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpGroups=lldpGroups, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpRemTablesChange=lldpRemTablesChange, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocManAddr=lldpLocManAddr, lldpLocPortDesc=lldpLocPortDesc, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsTxPortEntry=lldpStatsTxPortEntry, LldpPortNumber=LldpPortNumber, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpNotificationInterval=lldpNotificationInterval, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysDesc=lldpRemSysDesc)
