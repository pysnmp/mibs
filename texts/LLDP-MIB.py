...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemTablesChange=lldpRemTablesChange, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConfigGroup=lldpConfigGroup, LldpManAddress=LldpManAddress, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocChassisId=lldpLocChassisId, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemPortId=lldpRemPortId, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpReinitDelay=lldpReinitDelay, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpPortConfigEntry=lldpPortConfigEntry, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpLocManAddrOID=lldpLocManAddrOID, lldpStatsTxPortTable=lldpStatsTxPortTable, LldpPortNumber=LldpPortNumber, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocPortNum=lldpLocPortNum, lldpExtensions=lldpExtensions, LldpPortId=LldpPortId, lldpRemManAddr=lldpRemManAddr, lldpLocPortTable=lldpLocPortTable, lldpRemIndex=lldpRemIndex, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemPortDesc=lldpRemPortDesc, lldpRemSysName=lldpRemSysName, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpGroups=lldpGroups, lldpLocPortId=lldpLocPortId, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpConfiguration=lldpConfiguration, lldpLocSysDesc=lldpLocSysDesc, LldpChassisId=LldpChassisId, lldpNotificationInterval=lldpNotificationInterval, PYSNMP_MODULE_ID=lldpMIB, lldpLocManAddr=lldpLocManAddr, lldpRemTimeMark=lldpRemTimeMark, lldpTxDelay=lldpTxDelay, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpConformance=lldpConformance, lldpRemLocalPortNum=lldpRemLocalPortNum, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocalSystemData=lldpLocalSystemData, lldpPortConfigTable=lldpPortConfigTable, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemSysDesc=lldpRemSysDesc, lldpLocSysName=lldpLocSysName, lldpStatistics=lldpStatistics, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemChassisId=lldpRemChassisId, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpConfigRxGroup=lldpConfigRxGroup, lldpCompliances=lldpCompliances, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemTable=lldpRemTable, lldpMIB=lldpMIB, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemSysGroup=lldpRemSysGroup, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpCompliance=lldpCompliance, lldpConfigTxGroup=lldpConfigTxGroup, LldpPortList=LldpPortList, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotifications=lldpNotifications, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpObjects=lldpObjects, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpLocPortDesc=lldpLocPortDesc, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocManAddrLen=lldpLocManAddrLen, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemEntry=lldpRemEntry, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpLocSysGroup=lldpLocSysGroup, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype)
