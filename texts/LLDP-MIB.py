...
mibBuilder.exportSymbols("LLDP-MIB", lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocPortNum=lldpLocPortNum, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpPortConfigTable=lldpPortConfigTable, lldpConfigGroup=lldpConfigGroup, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpCompliance=lldpCompliance, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpLocSysGroup=lldpLocSysGroup, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemManAddrTable=lldpRemManAddrTable, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpNotificationInterval=lldpNotificationInterval, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpConfiguration=lldpConfiguration, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemSysDesc=lldpRemSysDesc, lldpNotificationsGroup=lldpNotificationsGroup, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocalSystemData=lldpLocalSystemData, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocManAddr=lldpLocManAddr, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpStatsRxPortEntry=lldpStatsRxPortEntry, LldpChassisId=LldpChassisId, lldpNotificationPrefix=lldpNotificationPrefix, LldpPortNumber=LldpPortNumber, lldpLocSysName=lldpLocSysName, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpStatsRxGroup=lldpStatsRxGroup, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemIndex=lldpRemIndex, lldpRemChassisId=lldpRemChassisId, lldpLocManAddrOID=lldpLocManAddrOID, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpLocChassisId=lldpLocChassisId, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemEntry=lldpRemEntry, lldpConformance=lldpConformance, lldpLocPortId=lldpLocPortId, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpTxDelay=lldpTxDelay, lldpRemTimeMark=lldpRemTimeMark, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, LldpPortIdSubtype=LldpPortIdSubtype, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemTable=lldpRemTable, lldpRemManAddrEntry=lldpRemManAddrEntry, LldpPortId=LldpPortId, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemPortId=lldpRemPortId, lldpRemPortDesc=lldpRemPortDesc, lldpMessageTxInterval=lldpMessageTxInterval, lldpRemManAddr=lldpRemManAddr, lldpCompliances=lldpCompliances, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemSysName=lldpRemSysName, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpGroups=lldpGroups, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpReinitDelay=lldpReinitDelay, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpLocPortTable=lldpLocPortTable, lldpLocSysDesc=lldpLocSysDesc, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpLocManAddrLen=lldpLocManAddrLen, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemSysGroup=lldpRemSysGroup, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, LldpPortList=LldpPortList, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocPortDesc=lldpLocPortDesc, PYSNMP_MODULE_ID=lldpMIB, lldpMIB=lldpMIB, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpNotifications=lldpNotifications, lldpRemManAddrOID=lldpRemManAddrOID, lldpObjects=lldpObjects, LldpManAddress=LldpManAddress, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpStatistics=lldpStatistics, lldpRemTablesChange=lldpRemTablesChange, lldpExtensions=lldpExtensions, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatsRxPortTable=lldpStatsRxPortTable)
