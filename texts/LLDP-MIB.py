...
mibBuilder.exportSymbols("LLDP-MIB", lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpMIB=lldpMIB, lldpRemIndex=lldpRemIndex, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocChassisId=lldpLocChassisId, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpExtensions=lldpExtensions, lldpRemPortIdSubtype=lldpRemPortIdSubtype, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpPortConfigTable=lldpPortConfigTable, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpConfigGroup=lldpConfigGroup, lldpLocManAddrEntry=lldpLocManAddrEntry, LldpChassisId=LldpChassisId, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpReinitDelay=lldpReinitDelay, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpCompliances=lldpCompliances, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, LldpPortList=LldpPortList, lldpStatsRxPortEntry=lldpStatsRxPortEntry, LldpManAddress=LldpManAddress, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocalSystemData=lldpLocalSystemData, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpNotificationsGroup=lldpNotificationsGroup, lldpObjects=lldpObjects, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpCompliance=lldpCompliance, lldpNotificationInterval=lldpNotificationInterval, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocSysDesc=lldpLocSysDesc, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemManAddr=lldpRemManAddr, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocSysGroup=lldpLocSysGroup, lldpNotifications=lldpNotifications, LldpPortNumber=LldpPortNumber, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemTimeMark=lldpRemTimeMark, lldpPortConfigEntry=lldpPortConfigEntry, lldpNotificationPrefix=lldpNotificationPrefix, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemSysDesc=lldpRemSysDesc, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpConfigRxGroup=lldpConfigRxGroup, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpGroups=lldpGroups, lldpRemSysName=lldpRemSysName, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpRemSysGroup=lldpRemSysGroup, lldpTxDelay=lldpTxDelay, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpConformance=lldpConformance, lldpLocManAddrOID=lldpLocManAddrOID, lldpLocPortNum=lldpLocPortNum, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemEntry=lldpRemEntry, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocPortEntry=lldpLocPortEntry, LldpPortId=LldpPortId, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpLocPortTable=lldpLocPortTable, lldpLocManAddrLen=lldpLocManAddrLen, PYSNMP_MODULE_ID=lldpMIB, lldpRemPortId=lldpRemPortId, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpLocPortDesc=lldpLocPortDesc, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemChassisId=lldpRemChassisId, lldpLocManAddrTable=lldpLocManAddrTable, lldpRemManAddrTable=lldpRemManAddrTable, lldpConfiguration=lldpConfiguration, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocManAddr=lldpLocManAddr, lldpStatsRxGroup=lldpStatsRxGroup, lldpRemTable=lldpRemTable, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpRemTablesChange=lldpRemTablesChange, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemManAddrOID=lldpRemManAddrOID, lldpStatistics=lldpStatistics, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpLocSysName=lldpLocSysName, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpLocPortId=lldpLocPortId)
