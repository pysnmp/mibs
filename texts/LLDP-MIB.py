...
mibBuilder.exportSymbols("LLDP-MIB", lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpLocPortNum=lldpLocPortNum, lldpRemSysDesc=lldpRemSysDesc, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpLocSysName=lldpLocSysName, lldpRemManAddr=lldpRemManAddr, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpLocalSystemData=lldpLocalSystemData, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemManAddrOID=lldpRemManAddrOID, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpLocSysGroup=lldpLocSysGroup, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpCompliance=lldpCompliance, lldpConformance=lldpConformance, lldpGroups=lldpGroups, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpConfiguration=lldpConfiguration, lldpStatsRxGroup=lldpStatsRxGroup, lldpLocChassisId=lldpLocChassisId, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpLocPortDesc=lldpLocPortDesc, lldpRemPortDesc=lldpRemPortDesc, lldpRemTablesChange=lldpRemTablesChange, lldpStatsTxPortNum=lldpStatsTxPortNum, LldpPortList=LldpPortList, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemChassisId=lldpRemChassisId, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpRemTable=lldpRemTable, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpNotifications=lldpNotifications, lldpRemSysGroup=lldpRemSysGroup, lldpNotificationsGroup=lldpNotificationsGroup, lldpNotificationInterval=lldpNotificationInterval, lldpConfigGroup=lldpConfigGroup, lldpPortConfigTable=lldpPortConfigTable, lldpLocPortTable=lldpLocPortTable, LldpPortNumber=LldpPortNumber, lldpStatsTxPortTable=lldpStatsTxPortTable, LldpChassisId=LldpChassisId, lldpLocSysDesc=lldpLocSysDesc, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, LldpPortId=LldpPortId, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemTimeMark=lldpRemTimeMark, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsTxGroup=lldpStatsTxGroup, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocPortId=lldpLocPortId, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemIndex=lldpRemIndex, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocPortEntry=lldpLocPortEntry, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, PYSNMP_MODULE_ID=lldpMIB, lldpMIB=lldpMIB, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpPortConfigEntry=lldpPortConfigEntry, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpConfigRxGroup=lldpConfigRxGroup, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpRemSysName=lldpRemSysName, lldpReinitDelay=lldpReinitDelay, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpObjects=lldpObjects, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocManAddrLen=lldpLocManAddrLen, lldpMessageTxInterval=lldpMessageTxInterval, lldpTxDelay=lldpTxDelay, lldpCompliances=lldpCompliances, LldpManAddress=LldpManAddress, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpExtensions=lldpExtensions, lldpLocManAddr=lldpLocManAddr, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatistics=lldpStatistics, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpRemPortId=lldpRemPortId, lldpRemEntry=lldpRemEntry, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts)
