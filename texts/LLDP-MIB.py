...
mibBuilder.exportSymbols("LLDP-MIB", lldpRemSysCapSupported=lldpRemSysCapSupported, lldpReinitDelay=lldpReinitDelay, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpNotificationPrefix=lldpNotificationPrefix, lldpRemEntry=lldpRemEntry, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpRemManAddr=lldpRemManAddr, lldpLocChassisId=lldpLocChassisId, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpRemTablesChange=lldpRemTablesChange, lldpRemManAddrTable=lldpRemManAddrTable, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpRemSysName=lldpRemSysName, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpPortConfigPortNum=lldpPortConfigPortNum, lldpStatsTxGroup=lldpStatsTxGroup, lldpLocPortTable=lldpLocPortTable, lldpRemPortDesc=lldpRemPortDesc, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpPortConfigEntry=lldpPortConfigEntry, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocPortId=lldpLocPortId, lldpLocSysName=lldpLocSysName, lldpNotificationsGroup=lldpNotificationsGroup, LldpPortList=LldpPortList, lldpNotificationInterval=lldpNotificationInterval, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRxPortEntry=lldpStatsRxPortEntry, LldpManAddress=LldpManAddress, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpLocManAddrSubtype=lldpLocManAddrSubtype, LldpManAddrIfSubtype=LldpManAddrIfSubtype, PYSNMP_MODULE_ID=lldpMIB, lldpConformance=lldpConformance, lldpConfiguration=lldpConfiguration, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpMIB=lldpMIB, lldpLocPortEntry=lldpLocPortEntry, LldpChassisId=LldpChassisId, lldpLocManAddrTable=lldpLocManAddrTable, lldpStatistics=lldpStatistics, lldpLocManAddrOID=lldpLocManAddrOID, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemTable=lldpRemTable, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpRemChassisId=lldpRemChassisId, LldpPortNumber=LldpPortNumber, lldpNotifications=lldpNotifications, LldpPortId=LldpPortId, lldpTxDelay=lldpTxDelay, lldpRemManAddrOID=lldpRemManAddrOID, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpLocalSystemData=lldpLocalSystemData, LldpPortIdSubtype=LldpPortIdSubtype, lldpRemPortId=lldpRemPortId, lldpLocPortNum=lldpLocPortNum, lldpPortConfigTable=lldpPortConfigTable, lldpObjects=lldpObjects, lldpMessageTxInterval=lldpMessageTxInterval, lldpLocManAddr=lldpLocManAddr, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpConfigTxGroup=lldpConfigTxGroup, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpRemoteSystemsData=lldpRemoteSystemsData, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, lldpRemSysDesc=lldpRemSysDesc, lldpLocSysDesc=lldpLocSysDesc, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpConfigGroup=lldpConfigGroup, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpRemIndex=lldpRemIndex, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpLocPortDesc=lldpLocPortDesc, lldpLocSysGroup=lldpLocSysGroup, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpCompliances=lldpCompliances, LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpRemSysGroup=lldpRemSysGroup, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, lldpGroups=lldpGroups, lldpCompliance=lldpCompliance, lldpExtensions=lldpExtensions, lldpRemTimeMark=lldpRemTimeMark)
