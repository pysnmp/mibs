...
mibBuilder.exportSymbols("LLDP-MIB", LldpSystemCapabilitiesMap=LldpSystemCapabilitiesMap, lldpLocSysCapEnabled=lldpLocSysCapEnabled, lldpConfigManAddrEntry=lldpConfigManAddrEntry, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, lldpLocManAddrIfId=lldpLocManAddrIfId, lldpConfigManAddrPortsTxEnable=lldpConfigManAddrPortsTxEnable, PYSNMP_MODULE_ID=lldpMIB, lldpRemTimeMark=lldpRemTimeMark, lldpRemPortIdSubtype=lldpRemPortIdSubtype, lldpLocPortIdSubtype=lldpLocPortIdSubtype, lldpExtensions=lldpExtensions, lldpPortConfigNotificationEnable=lldpPortConfigNotificationEnable, lldpRemTablesChange=lldpRemTablesChange, lldpStatsRemTablesDeletes=lldpStatsRemTablesDeletes, lldpRemoteSystemsData=lldpRemoteSystemsData, LldpChassisId=LldpChassisId, lldpStatsRemTablesLastChangeTime=lldpStatsRemTablesLastChangeTime, lldpStatistics=lldpStatistics, lldpLocPortTable=lldpLocPortTable, lldpConfiguration=lldpConfiguration, lldpLocManAddrIfSubtype=lldpLocManAddrIfSubtype, lldpPortConfigPortNum=lldpPortConfigPortNum, LldpChassisIdSubtype=LldpChassisIdSubtype, lldpMessageTxInterval=lldpMessageTxInterval, lldpStatsRxPortNum=lldpStatsRxPortNum, lldpLocManAddrLen=lldpLocManAddrLen, lldpStatsRxGroup=lldpStatsRxGroup, lldpStatsRemTablesInserts=lldpStatsRemTablesInserts, lldpRemOrgDefInfoIndex=lldpRemOrgDefInfoIndex, lldpConfigRxGroup=lldpConfigRxGroup, lldpLocSysGroup=lldpLocSysGroup, lldpRemManAddr=lldpRemManAddr, LldpPortId=LldpPortId, lldpPortConfigEntry=lldpPortConfigEntry, lldpStatsRxPortFramesErrors=lldpStatsRxPortFramesErrors, lldpStatsTxPortFramesTotal=lldpStatsTxPortFramesTotal, lldpRemSysCapEnabled=lldpRemSysCapEnabled, lldpRemPortId=lldpRemPortId, lldpStatsRemTablesAgeouts=lldpStatsRemTablesAgeouts, lldpRemChassisId=lldpRemChassisId, lldpCompliances=lldpCompliances, lldpStatsTxGroup=lldpStatsTxGroup, lldpPortConfigTable=lldpPortConfigTable, lldpRemManAddrOID=lldpRemManAddrOID, lldpLocManAddrTable=lldpLocManAddrTable, lldpPortConfigAdminStatus=lldpPortConfigAdminStatus, lldpStatsRxPortFramesTotal=lldpStatsRxPortFramesTotal, lldpObjects=lldpObjects, lldpRemManAddrIfId=lldpRemManAddrIfId, lldpLocPortEntry=lldpLocPortEntry, LldpManAddress=LldpManAddress, lldpRemUnknownTLVEntry=lldpRemUnknownTLVEntry, lldpRemUnknownTLVType=lldpRemUnknownTLVType, lldpStatsRxPortTLVsDiscardedTotal=lldpStatsRxPortTLVsDiscardedTotal, lldpRemLocalPortNum=lldpRemLocalPortNum, lldpLocPortDesc=lldpLocPortDesc, lldpStatsRxPortFramesDiscardedTotal=lldpStatsRxPortFramesDiscardedTotal, lldpRemSysCapSupported=lldpRemSysCapSupported, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI, lldpNotificationPrefix=lldpNotificationPrefix, lldpNotificationInterval=lldpNotificationInterval, lldpLocSysName=lldpLocSysName, lldpReinitDelay=lldpReinitDelay, lldpRemSysGroup=lldpRemSysGroup, lldpGroups=lldpGroups, lldpRemChassisIdSubtype=lldpRemChassisIdSubtype, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, LldpPortIdSubtype=LldpPortIdSubtype, lldpStatsRxPortTable=lldpStatsRxPortTable, lldpLocSysDesc=lldpLocSysDesc, lldpLocManAddrEntry=lldpLocManAddrEntry, lldpMessageTxHoldMultiplier=lldpMessageTxHoldMultiplier, lldpConfigManAddrTable=lldpConfigManAddrTable, lldpRemSysDesc=lldpRemSysDesc, lldpNotifications=lldpNotifications, lldpMIB=lldpMIB, lldpConfigGroup=lldpConfigGroup, LldpPortList=LldpPortList, lldpStatsRxPortAgeoutsTotal=lldpStatsRxPortAgeoutsTotal, LldpPortNumber=LldpPortNumber, lldpPortConfigTLVsTxEnable=lldpPortConfigTLVsTxEnable, lldpCompliance=lldpCompliance, lldpRemManAddrIfSubtype=lldpRemManAddrIfSubtype, lldpLocManAddr=lldpLocManAddr, lldpLocalSystemData=lldpLocalSystemData, lldpTxDelay=lldpTxDelay, lldpStatsRxPortTLVsUnrecognizedTotal=lldpStatsRxPortTLVsUnrecognizedTotal, lldpConfigTxGroup=lldpConfigTxGroup, lldpRemUnknownTLVTable=lldpRemUnknownTLVTable, lldpStatsTxPortNum=lldpStatsTxPortNum, lldpRemUnknownTLVInfo=lldpRemUnknownTLVInfo, lldpStatsRemTablesDrops=lldpStatsRemTablesDrops, lldpRemManAddrSubtype=lldpRemManAddrSubtype, lldpRemPortDesc=lldpRemPortDesc, lldpRemOrgDefInfoSubtype=lldpRemOrgDefInfoSubtype, lldpLocManAddrOID=lldpLocManAddrOID, lldpLocPortNum=lldpLocPortNum, LldpManAddrIfSubtype=LldpManAddrIfSubtype, lldpLocChassisIdSubtype=lldpLocChassisIdSubtype, lldpRemEntry=lldpRemEntry, lldpStatsTxPortEntry=lldpStatsTxPortEntry, lldpLocChassisId=lldpLocChassisId, lldpStatsTxPortTable=lldpStatsTxPortTable, lldpNotificationsGroup=lldpNotificationsGroup, lldpStatsRxPortEntry=lldpStatsRxPortEntry, lldpLocSysCapSupported=lldpLocSysCapSupported, lldpRemManAddrEntry=lldpRemManAddrEntry, lldpRemOrgDefInfo=lldpRemOrgDefInfo, lldpRemIndex=lldpRemIndex, lldpLocManAddrSubtype=lldpLocManAddrSubtype, lldpConformance=lldpConformance, lldpRemManAddrTable=lldpRemManAddrTable, lldpLocPortId=lldpLocPortId, lldpRemSysName=lldpRemSysName, lldpRemTable=lldpRemTable)
