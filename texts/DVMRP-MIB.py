...
Gauge32, experimental, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, MibIdentifier, Counter32, Integer32, ObjectIdentity, Counter64, Bits, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "experimental", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "MibIdentifier", "Counter32", "Integer32", "ObjectIdentity", "Counter64", "Bits", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("DVMRP-MIB", dvmrpRouteUpTime=dvmrpRouteUpTime, dvmrpRouteNextHopTable=dvmrpRouteNextHopTable, dvmrp=dvmrp, dvmrpInterfaceType=dvmrpInterfaceType, dvmrpVersionString=dvmrpVersionString, dvmrpInterfaceEntry=dvmrpInterfaceEntry, dvmrpNeighborRcvBadRoutes=dvmrpNeighborRcvBadRoutes, dvmrpRouteTable=dvmrpRouteTable, dvmrpRouteNextHopSource=dvmrpRouteNextHopSource, dvmrpAltNetStatus=dvmrpAltNetStatus, dvmrpNeighborCapabilities=dvmrpNeighborCapabilities, dvmrpMIBConformance=dvmrpMIBConformance, dvmrpNeighborUpTime=dvmrpNeighborUpTime, dvmrpAltNetTable=dvmrpAltNetTable, dvmrpNeighborGroup=dvmrpNeighborGroup, dvmrpReachableRoutes=dvmrpReachableRoutes, dvmrpNumRoutes=dvmrpNumRoutes, dvmrpRouteSource=dvmrpRouteSource, dvmrpRouteNextHopEntry=dvmrpRouteNextHopEntry, dvmrpNeighborMinorVersion=dvmrpNeighborMinorVersion, dvmrpRouteIfIndex=dvmrpRouteIfIndex, dvmrpNeighborIfIndex=dvmrpNeighborIfIndex, dvmrpInterfaceInOctets=dvmrpInterfaceInOctets, dvmrpAltNetAddress=dvmrpAltNetAddress, dvmrpTraps=dvmrpTraps, dvmrpRouteEntry=dvmrpRouteEntry, dvmrpNeighborEntry=dvmrpNeighborEntry, dvmrpInterfaceSentRoutes=dvmrpInterfaceSentRoutes, dvmrpInterfaceRemoteAddress=dvmrpInterfaceRemoteAddress, dvmrpInterfaceRateLimit=dvmrpInterfaceRateLimit, dvmrpNeighborTable=dvmrpNeighborTable, PYSNMP_MODULE_ID=dvmrpMIB, dvmrpRouteSourceMask=dvmrpRouteSourceMask, dvmrpSecurityGroup=dvmrpSecurityGroup, dvmrpRouteNextHopType=dvmrpRouteNextHopType, dvmrpRouteUpstreamNeighbor=dvmrpRouteUpstreamNeighbor, dvmrpInterfaceOperState=dvmrpInterfaceOperState, dvmrpInterfaceRcvBadPkts=dvmrpInterfaceRcvBadPkts, dvmrpInterfaceMetric=dvmrpInterfaceMetric, dvmrpGeneralGroup=dvmrpGeneralGroup, dvmrpNeighborRcvRoutes=dvmrpNeighborRcvRoutes, dvmrpInterfaceGroup=dvmrpInterfaceGroup, dvmrpInterfaceIfIndex=dvmrpInterfaceIfIndex, dvmrpMIBCompliances=dvmrpMIBCompliances, dvmrpInterfaceInPkts=dvmrpInterfaceInPkts, dvmrpInterfaceLocalAddress=dvmrpInterfaceLocalAddress, dvmrpNeighborLoss=dvmrpNeighborLoss, dvmrpNeighborAddress=dvmrpNeighborAddress, dvmrpInterfaceTable=dvmrpInterfaceTable, dvmrpGenerationId=dvmrpGenerationId, dvmrpInterfaceRcvBadRoutes=dvmrpInterfaceRcvBadRoutes, dvmrpAltNetIfIndex=dvmrpAltNetIfIndex, dvmrpMIBGroups=dvmrpMIBGroups, dvmrpMIBGroup=dvmrpMIBGroup, dvmrpNeighborMajorVersion=dvmrpNeighborMajorVersion, dvmrpRouteNextHopIfIndex=dvmrpRouteNextHopIfIndex, dvmrpInterfaceMasterKeyVersion=dvmrpInterfaceMasterKeyVersion, dvmrpNeighborGenerationId=dvmrpNeighborGenerationId, dvmrpAltNetEntry=dvmrpAltNetEntry, dvmrpRouteMetric=dvmrpRouteMetric, dvmrpRouteNextHopSourceMask=dvmrpRouteNextHopSourceMask, dvmrpRoutingGroup=dvmrpRoutingGroup, dvmrpMIB=dvmrpMIB, dvmrpInterfaceRemoteSubnetMask=dvmrpInterfaceRemoteSubnetMask, dvmrpNeighborRcvBadPkts=dvmrpNeighborRcvBadPkts, dvmrpNeighborExpiryTime=dvmrpNeighborExpiryTime, dvmrpInterfaceOutPkts=dvmrpInterfaceOutPkts, dvmrpNeighborState=dvmrpNeighborState, dvmrpRouteExpiryTime=dvmrpRouteExpiryTime, dvmrpInterfaceOutOctets=dvmrpInterfaceOutOctets, dvmrpAltNetMask=dvmrpAltNetMask, dvmrpNeighborNotPruning=dvmrpNeighborNotPruning, dvmrpInterfaceStatus=dvmrpInterfaceStatus, dvmrpInterfaceMasterKey=dvmrpInterfaceMasterKey, dvmrpMIBCompliance=dvmrpMIBCompliance, dvmrpMIBObjects=dvmrpMIBObjects)
